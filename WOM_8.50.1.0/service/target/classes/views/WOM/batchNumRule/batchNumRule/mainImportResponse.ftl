...
<script type="text/javascript">
	...
	function download(){
		//var url = "/WOM/batchNumRule/batchNumRule/downLoad.action?viewCode=WOM_7.5.0.0_batchNumRule_batchRuleList&orgName=WOM_7.5.0.0_batchNumRule_batchRuleList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/WOM/batchNumRule/batchNumRule/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
