...
<#assign viewCode = 'WOM_7.5.0.0_manulOrder_ManulOrderMain' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="hasManualNumber">
	  			<NumberFormat ss:Format="0.00"/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="isFinshed">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="manulOrderNum">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="manulStaff.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="orderNumber">
	  			<NumberFormat ss:Format="0.00"/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="orderTyep">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		...
	  		<Style ss:ID="saleOrderNum">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="saleOrderProject">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'orderNumber' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'orderTyep' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											...
											<#if item == 'hasManualNumber' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'manulStaff.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											...
											<#if item == 'saleOrderNum' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'saleOrderProject' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'remarks' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isFinshed' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1565937058910')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'product.productCode' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'orderTyep' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563193249848')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'edition' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563193270725')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'planStartTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563193285800')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'planEndTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563193313630')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'hasManualNumber' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563254276051')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'manulStaff.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertyshowName.randon1563267309469.flag')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'ware.wareName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertyshowName.randon1563267335957.flag')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'saleOrderNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563193334953')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'saleOrderProject' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563193344677')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'remarks' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563267783528')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												<#if item == 'manulOrderNum' || item == '*'>
													<Cell>
														...
														<#if data.manulOrderNum??><Data ss:Type="String"><![CDATA[${(data.manulOrderNum)!}]]></Data></#if>
												...
												<#if item == 'isFinshed' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.isFinshed?? && data.isFinshed>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'unit.name' || item == '*'>
													<Cell>
														...
														<#if data.unit.name??><Data ss:Type="String"><![CDATA[${(data.unit.name)!}]]></Data></#if>
												...
												<#if item == 'orderNumber' || item == '*'>
													<Cell>
														...
														<#if (data.orderNumber)?has_content><Data ss:Type="Number">#{(data.orderNumber)!; m2M2}</Data></#if>
												...
												<#if item == 'orderTyep' || item == '*'>
													<Cell>
														...
														<#if data.orderTyep??><Data ss:Type="String"><![CDATA[${(data.orderTyep)!}]]></Data></#if>
												...
												<#if item == 'edition' || item == '*'>
													<Cell>
														...
														<#if data.edition??><Data ss:Type="String"><![CDATA[${(data.edition)!}]]></Data></#if>
												...
												<#if item == 'hasManualNumber' || item == '*'>
													<Cell>
														...
														<#if (data.hasManualNumber)?has_content><Data ss:Type="Number">#{(data.hasManualNumber)!; m2M2}</Data></#if>
												...
												<#if item == 'manulStaff.name' || item == '*'>
													<Cell>
														...
														<#if data.manulStaff.name??><Data ss:Type="String"><![CDATA[${(data.manulStaff.name)!}]]></Data></#if>
												...
												<#if item == 'saleOrderNum' || item == '*'>
													<Cell>
														...
														<#if data.saleOrderNum??><Data ss:Type="String"><![CDATA[${(data.saleOrderNum)!}]]></Data></#if>
												...
												<#if item == 'saleOrderProject' || item == '*'>
													<Cell>
														...
														<#if data.saleOrderProject??><Data ss:Type="String"><![CDATA[${(data.saleOrderProject)!}]]></Data></#if>
												...
												<#if item == 'remarks' || item == '*'>
													<Cell>
														...
														<#if data.remarks??><Data ss:Type="String"><![CDATA[${(data.remarks)!}]]></Data></#if>
