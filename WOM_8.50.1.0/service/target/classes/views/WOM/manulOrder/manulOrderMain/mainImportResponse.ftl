...
<script type="text/javascript">
	...
	function download(){
		//var url = "/WOM/manulOrder/manulOrderMain/downLoad.action?viewCode=WOM_7.5.0.0_manulOrder_manulOrderList&orgName=WOM_7.5.0.0_manulOrder_manulOrderList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/WOM/manulOrder/manulOrderMain/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
