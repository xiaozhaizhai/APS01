...
<GridData DefaultNodeExpanded="false"   dgName="dg1568964886993" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<material.productCode
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(ManulOrderMaterial_dg1568964886993Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(ManulOrderMaterial_dg1568964886993Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/product/product/productRef.action','dg1568964886993material.productCode','${getText("MESBasic.viewtitle.radion1415773613713")}',sPTGridID,nRow,sFieldName,ManulOrderMaterial_dg1568964886993Widget,null,false,false,'','MESBasic_1_product_productRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="ManulOrderMaterial_dg1568964886993Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<ware.wareName
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(ManulOrderMaterial_dg1568964886993Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(ManulOrderMaterial_dg1568964886993Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/wareMan/ware/wareRef.action','dg1568964886993ware.wareName','${getText("MESBasic.viewtitle.randon1484031981880")}',sPTGridID,nRow,sFieldName,ManulOrderMaterial_dg1568964886993Widget,null,false,false,'','MESBasic_1_wareMan_wareRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="ManulOrderMaterial_dg1568964886993Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<unit.name
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(ManulOrderMaterial_dg1568964886993Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(ManulOrderMaterial_dg1568964886993Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/X6Basic/unitGroup/baseUnit/unitRef.action','dg1568964886993unit.name','${getText("X6Basic.viewtitle.radion1398240433147")}',sPTGridID,nRow,sFieldName,ManulOrderMaterial_dg1568964886993Widget,null,false,false,'','X6Basic_1.0_unitGroup_unitRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="ManulOrderMaterial_dg1568964886993Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
