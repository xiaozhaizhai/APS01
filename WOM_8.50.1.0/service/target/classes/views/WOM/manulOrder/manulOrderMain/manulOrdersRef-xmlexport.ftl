...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="product.unitGroup.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'product.unitGroup.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'ware.wareAddress' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertyshowName.randon1563350400953.flag')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'orderNumber' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'product.unitGroup.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1398234617226')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'product.productSpecif' || item == '*'>
									...
									<#if item?length gt 0>
												...
												<#if item == 'ware.wareAddress' || item == '*'>
													<Cell>
														...
														<#if data.ware.wareAddress??><Data ss:Type="String"><![CDATA[${(data.ware.wareAddress)!}]]></Data></#if>
												...
												<#if item == 'product.unitGroup.name' || item == '*'>
													<Cell>
														...
														<#if data.product.unitGroup.name??><Data ss:Type="String"><![CDATA[${(data.product.unitGroup.name)!}]]></Data></#if>
