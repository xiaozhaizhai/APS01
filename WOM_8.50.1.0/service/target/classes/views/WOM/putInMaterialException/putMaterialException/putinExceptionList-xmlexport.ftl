...
<#assign viewCode = 'WOM_7.5.0.0_putInMaterialException_PutMaterialException' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="oldBatchNumStr">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="oldLossNum">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="oldUseNum">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="putinID.tableNo">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="putinPartID.productId.productCode">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="putinPartID.productId.productName">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="remark">
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'putinID.tableNo' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'putinPartID.productId.productCode' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'putinPartID.productId.productName' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'oldBatchNumStr' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'batchNumStr' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'oldUseNum' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'useNum' || item == '*'>
											...
											<#if item == 'createTime' || item == '*'>
			 						        ...
			 						        <#assign customGeneratedFlag=false />
												<#if item == 'createTime' && !customGeneratedFlag >
												</#if>
											<#if item == 'remark' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'tableNo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.tlyctableNo')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'putinID.tableNo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.tableNo1122')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'putinPartID.productId.productCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1502677102798')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'putinPartID.productId.productName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.radion1415772740737455')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'oldBatchNumStr' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1495524777954')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchNumStr' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1494896691508')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'oldUseNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1495524215377')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'useNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1494818656207')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'oldLossNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1495524277382')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'lossNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1494818693335')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'createTime' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'remark' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1494814438997')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												...
												<#if item == 'putinID.tableNo' || item == '*'>
													<Cell>
														...
														<#if data.putinID.tableNo??><Data ss:Type="String"><![CDATA[${(data.putinID.tableNo)!}]]></Data></#if>
												...
												<#if item == 'putinPartID.productId.productCode' || item == '*'>
													<Cell>
														...
														<#if data.putinPartID.productId.productCode??><Data ss:Type="String"><![CDATA[${(data.putinPartID.productId.productCode)!}]]></Data></#if>
												...
												<#if item == 'putinPartID.productId.productName' || item == '*'>
													<Cell>
														...
														<#if data.putinPartID.productId.productName??><Data ss:Type="String"><![CDATA[${(data.putinPartID.productId.productName)!}]]></Data></#if>
												...
												<#if item == 'oldBatchNumStr' || item == '*'>
													<Cell>
														...
														<#if data.oldBatchNumStr??><Data ss:Type="String"><![CDATA[${(data.oldBatchNumStr)!}]]></Data></#if>
												...
												<#if item == 'batchNumStr' || item == '*'>
													<Cell>
														...
														<#if data.batchNumStr??><Data ss:Type="String"><![CDATA[${(data.batchNumStr)!}]]></Data></#if>
												...
												<#if item == 'oldUseNum' || item == '*'>
													<Cell>
														...
														<#if data.oldUseNum??><Data ss:Type="String"><![CDATA[${(data.oldUseNum)!}]]></Data></#if>
												...
												<#if item == 'oldLossNum' || item == '*'>
													<Cell>
														...
														<#if data.oldLossNum??><Data ss:Type="String"><![CDATA[${(data.oldLossNum)!}]]></Data></#if>
