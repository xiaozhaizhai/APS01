...
<#assign viewCode = 'WOM_7.5.0.0_inventoryRecords_InventoryRecord' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'inventoryDate' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1566888295198')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'inFlag' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertyshowName.randon1566888875982.flag')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'outFlag' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertyshowName.randon1566888883594.flag')}</Data></Cell>
											</#if>
									...
									<#if item?length gt 0>
												<#if item == 'inventoryDate' || item == '*'>
													<Cell ss:StyleID="s7">
														...
														<#if data.inventoryDate??><Data ss:Type="DateTime">${(data.inventoryDate)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
												...
												<#if item == 'inFlag' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.inFlag?? && data.inFlag>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'outFlag' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.outFlag?? && data.outFlag>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
