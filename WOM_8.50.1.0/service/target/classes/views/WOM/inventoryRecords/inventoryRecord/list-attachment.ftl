...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=WOM_7.5.0.0_inventoryRecords";
	openExportFrame(url);
}
...
<div id="WOM_inventoryRecords_inventoryRecord_inventoryList_attachment">	
