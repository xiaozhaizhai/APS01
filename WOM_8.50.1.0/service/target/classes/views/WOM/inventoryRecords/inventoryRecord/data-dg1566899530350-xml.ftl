...
<GridData DefaultNodeExpanded="false"   dgName="dg1566899530350" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<manulOrder.manulOrderNum
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(InventoryDetail_dg1566899530350Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(InventoryDetail_dg1566899530350Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/WOM/manulOrder/manulOrderMain/manulOrdersRef.action','dg1566899530350manulOrder.manulOrderNum','${getText("WOM.viewtitle.randon1563350015905")}',sPTGridID,nRow,sFieldName,InventoryDetail_dg1566899530350Widget,null,false,false,'','WOM_7.5.0.0_manulOrder_manulOrdersRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="InventoryDetail_dg1566899530350Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<material.productCode
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(InventoryDetail_dg1566899530350Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(InventoryDetail_dg1566899530350Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/product/product/customRef.action','dg1566899530350material.productCode','${getText("MESBasic.viewtitle.randon1506341311049")}',sPTGridID,nRow,sFieldName,InventoryDetail_dg1566899530350Widget,null,false,false,'','MESBasic_1_product_customRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="InventoryDetail_dg1566899530350Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<wareID.wareName
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(InventoryDetail_dg1566899530350Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(InventoryDetail_dg1566899530350Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/wareMan/ware/wareRef.action','dg1566899530350wareID.wareName','${getText("MESBasic.viewtitle.randon1484031981880")}',sPTGridID,nRow,sFieldName,InventoryDetail_dg1566899530350Widget,null,false,false,'','MESBasic_1_wareMan_wareRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="InventoryDetail_dg1566899530350Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
