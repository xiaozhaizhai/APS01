 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								<#if item == 'manulOrder.manulOrderNum' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563193157341')}</Data>
										</Cell>
								</#if>
								<#if item == 'material.productName' || item == '*'>
										<Cell>
								...
								<#if item == 'batchText' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1566888429426')}</Data>
										</Cell>
								</#if>
								<#if item == 'wareID.wareName' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertyshowName.randon1566899675218.flag')}</Data>
										</Cell>
								</#if>
								<#if item == 'onhand' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1566888673309')}</Data>
										</Cell>
								</#if>
								<#if item == 'material.storeUnit.name' || item == '*'>
										<Cell>
					...
					<#if item?length gt 0>
								<#if item == 'manulOrder.manulOrderNum' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.manulOrder.manulOrderNum)??>${(data.manulOrder.manulOrderNum)!}</#if></Data>
								...
								<#if item == 'batchText' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.batchText)??>${(data.batchText)!}</#if></Data>
								...
								<#if item == 'material.storeUnit.name' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.material.storeUnit.name)??>${(data.material.storeUnit.name)!}</#if></Data>
