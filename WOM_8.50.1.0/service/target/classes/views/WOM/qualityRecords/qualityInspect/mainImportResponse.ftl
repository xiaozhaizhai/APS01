...
<script type="text/javascript">
	...
	function download(){
		//var url = "/WOM/qualityRecords/qualityInspect/downLoad.action?viewCode=WOM_7.5.0.0_qualityRecords_qualityInspectList&orgName=WOM_7.5.0.0_qualityRecords_qualityInspectList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/WOM/qualityRecords/qualityInspect/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
