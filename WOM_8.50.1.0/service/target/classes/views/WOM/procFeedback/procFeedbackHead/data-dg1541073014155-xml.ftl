...
<GridData DefaultNodeExpanded="false"  MultiSelect="checkbox"  dgName="dg1541073014155" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<good.productCode
						style="font-color:0303B3"
							onBlur="document.body.click()"
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchCharge_dg1541073014155Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchCharge_dg1541073014155Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/product/product/refProductLayout.action','dg1541073014155good.productCode','${getText("MESBasic.viewtitle.randon1450085069587")}',sPTGridID,nRow,sFieldName,BatchCharge_dg1541073014155Widget,null,false,false,'','MESBasic_1_product_refProductLayout')"
								onKeyUp="WOM.procFeedback.procFeedbackHead.procFeedBatchEdit.initMnemonic_DG_IE({
										'keyCode':Key,
										'oGrid':BatchCharge_dg1541073014155Widget,
										'sGridName':'BatchCharge_dg1541073014155Widget',
										'value':sParam,
										'nRow':nRow,
										...
										'funcname':'WOM.procFeedback.procFeedbackHead.procFeedBatchEdit.getcallBackInfo_DG_IE(obj)',
										'conditionfunc':'WOM.procFeedback.procFeedbackHead.procFeedBatchEdit._querycustomFunc(\'dg1541073014155good.productCode\'.replace(/\./g, \'_\'))'
										
									})"
					sort="false"  onPropertyChange="BatchCharge_dg1541073014155Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<wareID.wareCode
						style="font-color:0303B3"
							onBlur="document.body.click()"
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchCharge_dg1541073014155Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchCharge_dg1541073014155Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/wareMan/ware/wareRef.action','dg1541073014155wareID.wareCode','${getText("MESBasic.viewtitle.randon1484031981880")}',sPTGridID,nRow,sFieldName,BatchCharge_dg1541073014155Widget,null,false,false,'','MESBasic_1_wareMan_wareRef')"
								onKeyUp="WOM.procFeedback.procFeedbackHead.procFeedBatchEdit.initMnemonic_DG_IE({
										'keyCode':Key,
										'oGrid':BatchCharge_dg1541073014155Widget,
										'sGridName':'BatchCharge_dg1541073014155Widget',
										...
										'isCrossCompany':'false',
										'funcname':'WOM.procFeedback.procFeedbackHead.procFeedBatchEdit.getcallBackInfo_DG_IE(obj)',
										'conditionfunc':'WOM.procFeedback.procFeedbackHead.procFeedBatchEdit._querycustomFunc(\'dg1541073014155wareID.wareCode\'.replace(/\./g, \'_\'))'
				...
				<#assign standingCrop_manulOrder_manulOrderNum_defaultText=''>
				<standingCrop.manulOrder.manulOrderNum
						style="font-color:0303B3"
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchCharge_dg1541073014155Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchCharge_dg1541073014155Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/WOM/standingcropRef/standingcropRef/prepareNumRef.action','dg1541073014155standingCrop.manulOrder.manulOrderNum','${getText("WOM.viewtitle.randon1566541491979")}',sPTGridID,nRow,sFieldName,BatchCharge_dg1541073014155Widget,'callbackPosition(obj)',false,false,'','WOM_7.5.0.0_standingcropRef_prepareNumRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="BatchCharge_dg1541073014155Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
						...
						<#if (standingCrop_manulOrder_manulOrderNum_defaultValue)?? &&(standingCrop_manulOrder_manulOrderNum_defaultValue)?has_content>
							defaultValue='${(standingCrop_manulOrder_manulOrderNum_defaultValue!)?string}'
						</#if>
						<#if (standingCrop_manulOrder_manulOrderNum_defaultText)?? &&(standingCrop_manulOrder_manulOrderNum_defaultText)?has_content>
							defaultText='${(standingCrop_manulOrder_manulOrderNum_defaultText!)?string}'
						</#if>
						
					align="left" 
					showFormat="SELECTCOMP" 
						type="SELECTCOMP" 
					width="100">领用记录</standingCrop.manulOrder.manulOrderNum>
				<#assign isRef = false >
				...
				<putinEndDate
					sort="false"  onPropertyChange="BatchCharge_dg1541073014155Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
									  ...
									  onBlur="document.body.click()" 
									   buttonImg="Calendar" onClick="initCalender(BatchCharge_dg1541073014155Widget,'BatchCharge_dg1541073014155Widget',nRow,sFieldName,'datetime')" 
									   onBtnClick="showCalender(BatchCharge_dg1541073014155Widget,'BatchCharge_dg1541073014155Widget',nRow,sFieldName,'datetime')" 
									  			 control="Text" 
				...
				<placeSet.placeSetCode
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchCharge_dg1541073014155Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchCharge_dg1541073014155Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/storeSet/storeSet/pubStoreRef.action','dg1541073014155placeSet.placeSetCode','${getText("MESBasic.viewtitle.randon1514434358343")}',sPTGridID,nRow,sFieldName,BatchCharge_dg1541073014155Widget,null,false,false,'','MESBasic_1_storeSet_pubStoreRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="BatchCharge_dg1541073014155Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<standingCrop.availiQuantity
					sort="false"  onPropertyChange="BatchCharge_dg1541073014155Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
						...
						<#if (standingCrop_availiQuantity_defaultValue)?? &&(standingCrop_availiQuantity_defaultValue)?has_content>
							defaultValue='${(standingCrop_availiQuantity_defaultValue!)?string}'
						</#if>
						<#if (standingCrop_availiQuantity_defaultText)?? &&(standingCrop_availiQuantity_defaultText)?has_content>
							defaultText='${(standingCrop_availiQuantity_defaultText!)?string}'
						</#if>
	...
	<tbody>
		...
		<row  onClick="BatchCharge_dg1541073014155Widget._DT._autoAddNewRow(nRow)" >
					<c>${(row.id)!}</c>
					<c>${(row.version)!}</c>
					<c>${(row.good.id)!}</c>
					<c>${(row.wareID.id)!}</c>
