...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=WOM_7.5.0.0_proActiveAndBatchState";
	openExportFrame(url);
}
...
<div id="WOM_proActiveAndBatchState_proActAndBatState_stateList_attachment">	
