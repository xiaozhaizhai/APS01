...
<script type="text/javascript">
	...
	function download(){
		//var url = "/WOM/taskReporting/taskReporting/downLoad.action?viewCode=WOM_7.5.0.0_taskReporting_taskReportingList&orgName=WOM_7.5.0.0_taskReporting_taskReportingList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/WOM/taskReporting/taskReporting/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
