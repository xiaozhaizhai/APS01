...
<#assign viewCode = 'WOM_7.5.0.0_taskReporting_TaskReportingPart' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="reportStaff.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="reportType">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'proBatchNum' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'headId.inputCode' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											...
											<#if item == 'reportStaff.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'reportDate' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'reportType.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'headId.tableNo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.menuName.randon1490785542610')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskID.tableNo' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'proBatchNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1492078507544')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'headId.inputCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1565061995937')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'content' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1565060960816')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'reportNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1492079279822858252')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'reportStaff.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1492078600032')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'reportDate' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1492078626890')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'reportType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1492078645437')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'wareId.wareCode' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490773190433')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
												<#if item == 'batchNum' && !customGeneratedFlag >
												</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'remark' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490773225991')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												...
												<#if item == 'proBatchNum' || item == '*'>
													<Cell>
														...
														<#if data.proBatchNum??><Data ss:Type="String"><![CDATA[${(data.proBatchNum)!}]]></Data></#if>
												...
												<#if item == 'headId.inputCode' || item == '*'>
													<Cell>
														...
														<#if data.headId.inputCode??><Data ss:Type="String"><![CDATA[${(data.headId.inputCode)!}]]></Data></#if>
												...
												<#if item == 'reportStaff.name' || item == '*'>
													<Cell>
														...
														<#if data.reportStaff.name??><Data ss:Type="String"><![CDATA[${(data.reportStaff.name)!}]]></Data></#if>
												...
												<#if item == 'reportDate' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.reportDate??><Data ss:Type="DateTime">${(data.reportDate)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
												...
												<#if item == 'reportType.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.reportType.value)!}')}</Data>
