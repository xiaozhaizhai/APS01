...
<script type="text/javascript">
	CUI.ns("WOM.standingcropRef.standingcropRef","WOM.standingcropRef.standingcropRef.batchNumBatchRef");
</script>
<div class="container"  style="padding-top:10px;">
	...
	<div id="ec_WOM_standingcropRef_standingcropRef_batchNumBatchRef_queryForm_inputValue">
	...
	<form onsubmit="return false" id="ec_WOM_standingcropRef_standingcropRef_batchNumBatchRef_queryForm" exportUrl="/WOM/standingcropRef/standingcropRef/batchNumBatchRef-query.action">
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
											...
											<#if (batchText_defaultValue)?has_content>
												<@mneclient formId="ec_WOM_standingcropRef_standingcropRef_batchNumBatchRef_queryForm" isPrecise=true isCrossCompany=isCrossCompany value="${batchText_defaultValue!}" deValue="${batchText_defaultValue!}"   conditionfunc="WOM.standingcropRef.standingcropRef.batchNumBatchRef._querycustomFunc('batchText')" name="batchText" id="ec_WOM_standingcropRef_standingcropRef_batchNumBatchRef_queryForm_batchText" displayFieldName="batchText" exp="like" classStyle="form-control"  url="/WOM/standingcropRef/standingcropRef/mneClient.action" multiple=false mnewidth=260 searchClick="WOM.standingcropRef.standingcropRef.batchNumBatchRef.commonQuery('query')" />
											<#else>
												<@mneclient formId="ec_WOM_standingcropRef_standingcropRef_batchNumBatchRef_queryForm" isPrecise=true isCrossCompany=isCrossCompany  conditionfunc="WOM.standingcropRef.standingcropRef.batchNumBatchRef._querycustomFunc('batchText')" name="batchText" id="ec_WOM_standingcropRef_standingcropRef_batchNumBatchRef_queryForm_batchText" displayFieldName="batchText" exp="like" classStyle="form-control"  url="/WOM/standingcropRef/standingcropRef/mneClient.action" multiple=false mnewidth=260 searchClick="WOM.standingcropRef.standingcropRef.batchNumBatchRef.commonQuery('query')" />
											</#if>
...
<script>
	$(function(){
		var buttons = $( 'button.btn-list', '#ec_WOM_standingcropRef_standingcropRef_batchNumBatchRef_queryForm' );
		if( buttons.length > 0 ){
			// 去掉按钮间的空格
...
<@datatable id="ec_WOM_standingcropRef_standingcropRef_batchNumBatchRef_query" renderOverEvent="ec_WOM_standingcropRef_standingcropRef_batchNumBatchRef_RenderOverEvent"  modelCode="WOM_7.5.0.0_standingcropRef_StandingcropRef" noPermissionKeys="batchText,good.productCode,good.productName,wareID.wareCode,wareID.wareName,placeSet.placeSetCode,placeSet.placeSetName,onhand,frozenQuantity,availiQuantity" hidekeyPrefix="ec_WOM_standingcropRef_standingcropRef_batchNumBatchRef_query" orderMode="backstage" queryFunc=datatable_queryFunc formId="ec_WOM_standingcropRef_standingcropRef_batchNumBatchRef_queryForm" firstLoad=datatable_firstLoad  exportExcel=true style="margin-left:13px;margin-right:4px;" editable=false dtPage="page" dataUrl=datatable_dataUrl transMethod="post" hidekey="['id','version','good.id','wareID.id','placeSet.id']" postData="&${(condition!'')}&permissionCode=${permissionCode!''}">
...
<script type="text/javascript">
	...
	foundation.common.${requestUri!}__callbackFunction = function(){
		...
		var oRows = datatable_ec_WOM_standingcropRef_standingcropRef_batchNumBatchRef_query.getSelectedRow();
		if(oRows.length == 0){
		...
		try{
			if(CUI("#WOM_standingcropRef_standingcropRef_batchNumBatchRef_callBackFuncName").val() != ""){
				eval(CUI("#WOM_standingcropRef_standingcropRef_batchNumBatchRef_callBackFuncName").val() + "(arrObj)");
			}
		}catch(e){
		}
	};
...
WOM.standingcropRef.standingcropRef.batchNumBatchRef.showLinkView = function(url,propertyId,row,formId,title,width,height,dialogType){
	...
	if(formId) {
		WOM.standingcropRef.standingcropRef.batchNumBatchRef.showDialog(url,formId,title,width,height);
	}else {
		openFullScreen(url);
	}
};
