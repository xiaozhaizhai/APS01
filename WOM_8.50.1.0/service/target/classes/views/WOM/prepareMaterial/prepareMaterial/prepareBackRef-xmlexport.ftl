									...
									<#if item?length gt 0>
												...
												<#if item == 'backFlag' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.backFlag?? && data.backFlag>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
