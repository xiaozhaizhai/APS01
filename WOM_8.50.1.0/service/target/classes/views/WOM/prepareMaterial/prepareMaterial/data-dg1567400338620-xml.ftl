...
<GridData DefaultNodeExpanded="false"   dgName="dg1567400338620" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<productId.productCode
						style="font-color:0303B3"
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(PrepareMaterialPart_dg1567400338620Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(PrepareMaterialPart_dg1567400338620Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/product/product/refProductLayout_kc.action','dg1567400338620productId.productCode','${getText("MESBasic.viewtitle.randon1478746948423")}',sPTGridID,nRow,sFieldName,PrepareMaterialPart_dg1567400338620Widget,null,false,false,'','MESBasic_1_product_refProductLayout_kc')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="PrepareMaterialPart_dg1567400338620Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<productId.productName
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(PrepareMaterialPart_dg1567400338620Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(PrepareMaterialPart_dg1567400338620Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/product/product/productRefNew.action','dg1567400338620productId.productName','${getText("MESBasic.viewtitle.randon1475137145215")}',sPTGridID,nRow,sFieldName,PrepareMaterialPart_dg1567400338620Widget,null,false,false,'','MESBasic_1_product_productRefNew')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="PrepareMaterialPart_dg1567400338620Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<ware.wareCode
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(PrepareMaterialPart_dg1567400338620Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(PrepareMaterialPart_dg1567400338620Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/wareMan/ware/wareRef.action','dg1567400338620ware.wareCode','${getText("MESBasic.viewtitle.randon1484031981880")}',sPTGridID,nRow,sFieldName,PrepareMaterialPart_dg1567400338620Widget,null,false,false,'','MESBasic_1_wareMan_wareRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="PrepareMaterialPart_dg1567400338620Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
