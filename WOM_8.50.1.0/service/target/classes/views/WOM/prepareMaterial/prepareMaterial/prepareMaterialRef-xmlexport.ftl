...
<#assign viewCode = 'WOM_7.5.0.0_prepareMaterial_PrepareMaterial' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="manulOrderMain.manulOrderNum">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="manulOrderMain.saleOrderNum">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="outCode">
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'manulOrderMain.manulOrderNum' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'manulOrderMain.saleOrderNum' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'effectiveState' || item == '*'>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'effectiveState' || item == '*'>
													<Cell><Data ss:Type="String">${getText('ec.common.effectiveState')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'createTime' || item == '*'>
									...
									<#if item?length gt 0>
												...
												<#if item == 'manulOrderMain.manulOrderNum' || item == '*'>
													<Cell>
														...
														<#if data.manulOrderMain.manulOrderNum??><Data ss:Type="String"><![CDATA[${(data.manulOrderMain.manulOrderNum)!}]]></Data></#if>
												...
												<#if item == 'manulOrderMain.saleOrderNum' || item == '*'>
													<Cell>
														...
														<#if data.manulOrderMain.saleOrderNum??><Data ss:Type="String"><![CDATA[${(data.manulOrderMain.saleOrderNum)!}]]></Data></#if>
												...
												<#if item == 'effectiveState' || item == '*'>
													<Cell>
														...
														<#if data.effectiveState??><Data ss:Type="Number"><![CDATA[${(data.effectiveState)!}]]></Data></#if>
												...
												<#if item == 'outCode' || item == '*'>
													<Cell>
														...
														<#if data.outCode??><Data ss:Type="String"><![CDATA[${(data.outCode)!}]]></Data></#if>
												...
												<#if item == 'incode' || item == '*'>
													<Cell>
														...
														<#if data.incode??><Data ss:Type="String"><![CDATA[${(data.incode)!}]]></Data></#if>
