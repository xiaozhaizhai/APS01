...
<#assign showCusProps =  dgPage.showCusProps />
	...
	<Styles>
 		...
 		<Style ss:ID="s8">
  		...
  		<Style ss:ID="manuOrder.materialBatchNum">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
  		...
  		<Style ss:ID="useNeedRef.batchText">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
  		<Style ss:ID="useNum">
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0 && item != "checkbox">
									...
									<#if item == 'useNeedRef.batchText' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'useNum' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									...
									<#if item == 'manuOrder.materialBatchNum' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								...
								<#if item == 'hasDoneNum' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertyshowName.randon1567750893064.flag')}</Data>
										</Cell>
								</#if>
								<#if item == 'useNeedRef.batchText' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertyshowName.randon1568684615360.flag')}</Data>
										</Cell>
								</#if>
								<#if item == 'useNum' || item == '*'>
										<Cell>
								...
								<#if item == 'materialBatchNum' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1564106174112')}</Data>
										</Cell>
								</#if>
								<#if item == 'wareCode' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1564106235521')}</Data>
										</Cell>
								</#if>
								<#if item == 'ware.wareCode' || item == '*'>
										<Cell>
								...
								<#if item == 'remark' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489977145770')}</Data>
										</Cell>
								</#if>
								<#if item == 'edition' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1565059780909')}</Data>
										</Cell>
								</#if>
								<#if item == 'manuOrder.materialBatchNum' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertyshowName.randon1564548003456.flag')}</Data>
										</Cell>
								</#if>
								<#if item == 'storeID.placeSetName' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489731677163')}</Data>
										</Cell>
								</#if>
								<#if item == 'storeID.placeSetCode' || item == '*'>
										<Cell>
					...
					<#if item?length gt 0>
								...
								<#if item == 'useNeedRef.batchText' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.useNeedRef.batchText)??>${(data.useNeedRef.batchText)!}</#if></Data>
								...
								<#if item == 'wareCode' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.wareCode)??>${(data.wareCode)!}</#if></Data>
								...
								<#if item == 'manuOrder.materialBatchNum' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.manuOrder.materialBatchNum)??>${(data.manuOrder.materialBatchNum)!}</#if></Data>
