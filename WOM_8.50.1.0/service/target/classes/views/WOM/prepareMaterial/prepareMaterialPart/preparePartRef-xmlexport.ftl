...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="formulaId.backFlag">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="formulaId.incode">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="formulaId.manulOrderMain.manulOrderNum">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="formulaId.outCode">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'formulaId.manulOrderMain.manulOrderNum' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											...
											<#if item == 'formulaId.incode' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'formulaId.outCode' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'rspos' || item == '*'>
											...
											<#if item == 'formulaId.backFlag' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'useNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertyshowName.randon1568773663536.flag')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productId.productBaseUnit.name' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'hasDoneNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertyshowName.randon1568773562769.flag')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489977087708')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formulaId.incode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1565059320966')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formulaId.outCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1565059377008')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'rspos' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563871077780')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'rsnum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563871065994')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formulaId.backFlag' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1566464583222')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												...
												<#if item == 'formulaId.manulOrderMain.manulOrderNum' || item == '*'>
													<Cell>
														...
														<#if data.formulaId.manulOrderMain.manulOrderNum??><Data ss:Type="String"><![CDATA[${(data.formulaId.manulOrderMain.manulOrderNum)!}]]></Data></#if>
												...
												<#if item == 'formulaId.incode' || item == '*'>
													<Cell>
														...
														<#if data.formulaId.incode??><Data ss:Type="String"><![CDATA[${(data.formulaId.incode)!}]]></Data></#if>
												...
												<#if item == 'formulaId.outCode' || item == '*'>
													<Cell>
														...
														<#if data.formulaId.outCode??><Data ss:Type="String"><![CDATA[${(data.formulaId.outCode)!}]]></Data></#if>
												...
												<#if item == 'rspos' || item == '*'>
													<Cell>
														...
														<#if data.rspos??><Data ss:Type="String"><![CDATA[${(data.rspos)!}]]></Data></#if>
												...
												<#if item == 'rsnum' || item == '*'>
													<Cell>
														...
														<#if data.rsnum??><Data ss:Type="String"><![CDATA[${(data.rsnum)!}]]></Data></#if>
												...
												<#if item == 'formulaId.backFlag' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.formulaId.backFlag?? && data.formulaId.backFlag>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
