...
<#assign viewCode = 'WOM_7.5.0.0_produceTask_ProduceTaskActive' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="headID.factoryId.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="headID.productId.productCode">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="headID.productId.productName">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'headID.factoryId.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'headID.productId.productName' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'headID.productId.productCode' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'headID.tableNo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.zldh.tableNohdcz')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'orderProcessId.name' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'activeType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489726359628')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'headID.factoryId.name' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isReplace' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489726453862')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isMixQuality' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489729935738')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'minQuality' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489729953842')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'maxQuality' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489729974625')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'standardNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489730105405')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'planNum' || item == '*'>
									...
									<#if item?length gt 0>
												...
												<#if item == 'orderProcessId.name' || item == '*'>
													<Cell>
														...
														<#if data.orderProcessId.name??><Data ss:Type="String"><![CDATA[${(data.orderProcessId.name)!}]]></Data></#if>
												...
												<#if item == 'headID.factoryId.name' || item == '*'>
													<Cell>
														...
														<#if data.headID.factoryId.name??><Data ss:Type="String"><![CDATA[${(data.headID.factoryId.name)!}]]></Data></#if>
												...
												<#if item == 'headID.productId.productName' || item == '*'>
													<Cell>
														...
														<#if data.headID.productId.productName??><Data ss:Type="String"><![CDATA[${(data.headID.productId.productName)!}]]></Data></#if>
												...
												<#if item == 'headID.productId.productCode' || item == '*'>
													<Cell>
														...
														<#if data.headID.productId.productCode??><Data ss:Type="String"><![CDATA[${(data.headID.productId.productCode)!}]]></Data></#if>
