	...
	<form <#if useInBusiness?? && useInBusiness == 'yes'>style="position:relative;*z-index:1;zoom:1;"</#if> onsubmit="return false" id="ec_WOM_produceTask_produceTaskActive_taskActiveRef_queryForm" exportUrl="/WOM/produceTask/produceTaskActive/taskActiveRef-query.action">
		...
		<div id="ec_WOM_produceTask_produceTaskActive_taskActiveRef_queryForm_btn_toggle" class="quick-query-btn-toggle quick-query-btn-expand" style="display:none;" title="${getText('ec.view.expandTip')}" onclick="ec_WOM_produceTask_produceTaskActive_taskActiveRef_queryForm_expandAllCondition()" ></div>
		<#assign advFlag = getAdvClassific('WOM_7.5.0.0_produceTask_taskActiveRef')>
		<#if advFlag?? && advFlag>
		<@dataclassific id="dataClassific" viewCode="WOM_7.5.0.0_produceTask_taskActiveRef" formId="ec_WOM_produceTask_produceTaskActive_taskActiveRef_queryForm" dataTableId="ec_WOM_produceTask_produceTaskActive_taskActiveRef_query"   />
		</#if>
					<@quickquery unique="LAST_QUERY_ec_WOM_produceTask_produceTaskActive_taskActiveRef_queryForm" isExpandAll=true formId="ec_WOM_produceTask_produceTaskActive_taskActiveRef_queryForm" idprefix="ec_WOM_produceTask_produceTaskActive_taskActiveRef" expandType="all"  fieldcodes="WOM_7.5.0.0_produceTask_ProduceTaskProcess_name_orderProcessId_name:WOM.propertydisplayName.randon1489720649125||WOM_7.5.0.0_produceTask_ProduceTaskActive_name_name:WOM.propertydisplayName.randon1490683872072||WOM_7.5.0.0_produceTask_ProduceTaskActive_activeType_activeType:WOM.propertydisplayName.randon1489726359628" > 
							<#assign orderProcessId_name_defaultValue  = ''>
									<#assign orderProcessId_name_defaultValue  = ''>
							<@queryfield formId="ec_WOM_produceTask_produceTaskActive_taskActiveRef_queryForm" code="WOM_7.5.0.0_produceTask_ProduceTaskProcess_name" showFormat="SELECTCOMP" defaultValue=orderProcessId_name_defaultValue  divCode="WOM_7.5.0.0_produceTask_ProduceTaskProcess_name_orderProcessId_name" isCustomize=true style="" > 
										<input type="hidden" id="orderProcessId.id" name="orderProcessId.id" value="" />
												<@mneclient iframe=true mneenable=false isCrossCompany=isCrossCompany isPrecise=true deValue="${orderProcessId_name_defaultValue!}" reftitle="${getText('WOM.viewtitle.randon1490685207348')}"  conditionfunc="WOM.produceTask.produceTaskActive.taskActiveRef._querycustomFunc('orderProcessId_name')" name="orderProcessId.name" id="ec_WOM_produceTask_produceTaskActive_taskActiveRef_queryForm_orderProcessId_name" displayFieldName="name" type="other" exp="like" classStyle="cui-noborder-input" url="/WOM/produceTask/produceTaskProcess/taskProcessRef.action"   refViewCode="WOM_7.5.0.0_produceTask_taskProcessRef"  clicked=true multiple=false mnewidth=260 formId="ec_WOM_produceTask_produceTaskActive_taskActiveRef_queryForm" searchClick="WOM.produceTask.produceTaskActive.taskActiveRef.commonQuery('query')"   />
							</@queryfield>
							<#assign name_defaultValue  = ''>
									<#assign name_defaultValue  = ''>
							<@queryfield formId="ec_WOM_produceTask_produceTaskActive_taskActiveRef_queryForm" code="WOM_7.5.0.0_produceTask_ProduceTaskActive_name" showFormat="TEXT" defaultValue=name_defaultValue  divCode="WOM_7.5.0.0_produceTask_ProduceTaskActive_name_name" isCustomize=true style="" > 
											<div class="fix-input">
							...
							<#assign activeType_defaultValue  = ''>
									<#assign activeType_defaultValue  = ''>
							<@queryfield formId="ec_WOM_produceTask_produceTaskActive_taskActiveRef_queryForm" code="WOM_7.5.0.0_produceTask_ProduceTaskActive_activeType" showFormat="SELECTCOMP" defaultValue=activeType_defaultValue  divCode="WOM_7.5.0.0_produceTask_ProduceTaskActive_activeType_activeType" isCustomize=true style="" > 
							...
							<div class="quick-query-buttonbar" style="margin-bottom:6px;margin-right:12px;">
						       	<@querybutton formId="ec_WOM_produceTask_produceTaskActive_taskActiveRef_queryForm" type="adv" onclick="WOM.produceTask.produceTaskActive.taskActiveRef.commonQuery('query')" onadvancedclick="advQuery('WOM.produceTask.produceTaskActive.taskActiveRef.advquery')" /> 
...
ec_WOM_produceTask_produceTaskActive_taskActiveRef_quickquery_info["MainTableName"]="WOM_PRODUCE_TASK_ACTIVES";
...
<script>
 $(function(){
 	var advRemainDialog = $('[id="WOM.produceTask.produceTaskActive.taskActiveRef.advquery"]');
...
<div style="position:relative;z-index:10;display:none;" id="WOM.produceTask.produceTaskActive.taskActiveRef.advquery">
    <@errorbar id="adv_query_edit_bar"></@errorbar>
    <div class="advConContent">
    <form <#if useInBusiness?? && useInBusiness == 'yes'>style="position:relative;*z-index:1;zoom:1;"</#if> onsubmit="return false" id="ec_WOM_produceTask_produceTaskActive_taskActiveRef_adv_queryForm" exportUrl="/WOM/produceTask/produceTaskActive/taskActiveRef-query.action">
							<#assign orderProcessId_name_defaultValue  = ''>
									<#assign orderProcessId_name_defaultValue  = ''>
								<@advsqueryfield formId="ec_WOM_produceTask_produceTaskActive_taskActiveRef_adv_queryForm" code="WOM_7.5.0.0_produceTask_ProduceTaskProcess_name" showFormat="SELECTCOMP" defaultValue=orderProcessId_name_defaultValue  divCode="WOM_7.5.0.0_produceTask_ProduceTaskProcess_name_orderProcessId_name" isCustomize=true > 
							...
							<div class="quick_query_content advQuery_content">
								...
								<input type="hidden" id="modelCode" modelcode="WOM_7.5.0.0_produceTask_ProduceTaskProcess" />
										<input type="hidden" id="adv_orderProcessId.id" name="orderProcessId.id" value="" />
												<@mneclient iframe=true mneenable=false advresume="adv_orderProcessId.id" isCrossCompany=isCrossCompany isPrecise=true deValue="${orderProcessId_name_defaultValue!}" reftitle="${getText('WOM.viewtitle.randon1490685207348')}"  conditionfunc="WOM.produceTask.produceTaskActive.taskActiveRef._querycustomFunc('orderProcessId_name')" name="orderProcessId.name" id="adv_ec_WOM_produceTask_produceTaskActive_taskActiveRef_queryForm_orderProcessId_name" displayFieldName="name" type="other" exp="like"  classStyle="cui-noborder-input" url="/WOM/produceTask/produceTaskProcess/taskProcessRef.action"   refViewCode="WOM_7.5.0.0_produceTask_taskProcessRef"  clicked=true multiple=false mnewidth=260 formId="ec_WOM_produceTask_produceTaskActive_taskActiveRef_adv_queryForm"   />
							...
							<#assign name_defaultValue  = ''>
									<#assign name_defaultValue  = ''>
								<@advsqueryfield formId="ec_WOM_produceTask_produceTaskActive_taskActiveRef_adv_queryForm" code="WOM_7.5.0.0_produceTask_ProduceTaskActive_name" showFormat="TEXT" defaultValue=name_defaultValue  divCode="WOM_7.5.0.0_produceTask_ProduceTaskActive_name_name" isCustomize=true > 
							...
							<#assign activeType_defaultValue  = ''>
									<#assign activeType_defaultValue  = ''>
								<@advsqueryfield formId="ec_WOM_produceTask_produceTaskActive_taskActiveRef_adv_queryForm" code="WOM_7.5.0.0_produceTask_ProduceTaskActive_activeType" showFormat="SELECTCOMP" defaultValue=activeType_defaultValue  divCode="WOM_7.5.0.0_produceTask_ProduceTaskActive_activeType_activeType" isCustomize=true > 
...
ec.view.newAdvQuery._initNewAdvQuery=function(values){
		ec.advQuery.query = new CUI.NewAdvQuery({
			...
			env: 'runtime',
			viewCode: 'WOM_7.5.0.0_produceTask_taskActiveRef',
			...
			olddiv: 'WOM.produceTask.produceTaskActive.taskActiveRef.advquery',
			values: values,
...
ec.view.newAdvQuery._customQuery= function(){
	$("[id='WOM.produceTask.produceTaskActive.taskActiveRef.advquery'] #advQueryLoading").show();
	var url="/ec/advQuery/advconfig.action?view.code="+'WOM_7.5.0.0_produceTask_taskActiveRef'+"&entity.code="+'WOM_7.5.0.0_produceTask';
		 $.ajax({
		 url: url, 
		 cache: false,
		 async: false,
		 success:function(html){ 
		 	$("[id='WOM.produceTask.produceTaskActive.taskActiveRef.advquery'] #customquContent").html(html);
		 	$("[id='WOM.produceTask.produceTaskActive.taskActiveRef.advquery'] #advQueryLoading").hide();
		 }
	});
	onceOpen = true;
...
function changeCustomQuery(){
	if(showType == "up"){
		$('[id="WOM.produceTask.produceTaskActive.taskActiveRef.advquery"] div.customqu-content').css('display','none');
		$('[id="WOM.produceTask.produceTaskActive.taskActiveRef.advquery"] div.move-grade').css('display','none');
		// $('[id="WOM.produceTask.produceTaskActive.taskActiveRef.advquery"] span.customQuery').css('background','url("/bap/struts/css/icon_adv.png") 0 -61px no-repeat');
		$('[id="WOM.produceTask.produceTaskActive.taskActiveRef.advquery"] span.customQuery').removeClass("customQuery_down").addClass("customQuery_up");											
		$('[id="WOM.produceTask.produceTaskActive.taskActiveRef.advquery"] div.advConContent').css('height','400px');		
		showType = "down";
	}else{
		$('[id="WOM.produceTask.produceTaskActive.taskActiveRef.advquery"] div.customqu-content').css('display','block');
		$('[id="WOM.produceTask.produceTaskActive.taskActiveRef.advquery"] div.move-grade').css('display','block');
		// $('[id="WOM.produceTask.produceTaskActive.taskActiveRef.advquery"] span.customQuery').css('background','url("/bap/struts/css/icon_adv.png") 0 -144px no-repeat');
		$('[id="WOM.produceTask.produceTaskActive.taskActiveRef.advquery"] span.customQuery').removeClass("customQuery_up").addClass("customQuery_down");						
		$('[id="WOM.produceTask.produceTaskActive.taskActiveRef.advquery"] div.advConContent').css('height','130px');
		if(!onceOpen){
			customQuery();
			onceOpen = true;
		}
...
<@datatable  colAdminFlag=colAdmFlag  superChecked=superChecked superCheckedName=superCheckedName superCheckedId=superCheckedId checkedRowsMap=checkedRowsMap id="ec_WOM_produceTask_produceTaskActive_taskActiveRef_query" renderOverEvent="ec_WOM_produceTask_produceTaskActive_taskActiveRef_RenderOverEvent" pageInitMethod="ec_WOM_produceTask_produceTaskActive_taskActiveRef_PageInitMethod" modelCode="WOM_7.5.0.0_produceTask_ProduceTaskActive" noPermissionKeys="orderProcessId.name,name,activeType,factoryId.name,productId.productCode,productId.productName,isReplace,isMixQuality,minQuality,maxQuality,standardNum,planNum" hidekeyPrefix="ec_WOM_produceTask_produceTaskActive_taskActiveRef_query" orderMode="backstage" queryFunc=datatable_queryFunc formId="ec_WOM_produceTask_produceTaskActive_taskActiveRef_queryForm" firstLoad=datatable_firstLoad  lockColumnCount="" dblclick="WOM.produceTask.produceTaskActive.taskActiveRef.sendBacktaskActiveRef" style="margin-left:13px;margin-right:4px;" editable=false dtPage="page" dataUrl=datatable_dataUrl transMethod="post" hidekey="['id','version','layRec','valid','cid','activeType.id','orderProcessId.id','factoryId.id','productId.id','id','id']" postData="&${(condition!'')}&permissionCode=${permissionCode!''}" throwError="WOM.produceTask.produceTaskActive.taskActiveRef.showErrorMsg"   >
			...
			<@datacolumn columnName="NODENAME"    showFormat="TEXT" defaultDisplay="${factoryId_name_displayDefaultType!}"  key="factoryId.name"   label="${getText('WOM.propertydisplayName.randon1489720709421')}" textalign="left"  width=80   type="textfield"    showFormatFunc="" cssstyle="" />
			...
			<@datacolumn columnName="PLAN_NUM"    showFormat="TEXT" defaultDisplay="${planNum_displayDefaultType!}"  key="planNum"   label="${getText('WOM.propertydisplayName.randon1489730174515')}" textalign="right" decimal="2" width=80   type="decimal"    showFormatFunc="" cssstyle="" />
				<#assign customPropList = getShowCustomProps("WOM_7.5.0.0_produceTask_ProduceTaskActive", "WOM_7.5.0.0_produceTask_taskActiveRef", "LIST", "produceTaskActive")>
				<#-- 排布自定义字段 -->
...
function ec_WOM_produceTask_produceTaskActive_taskActiveRef_PageInitMethod(){
}
