 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0 && item != "checkbox">
									...
									<#if item == 'processState.value' || item == 'processState.id' || item == '*'>
									...
									<#assign customGeneratedFlag=false />
										<#if item == 'exeOrder' && !customGeneratedFlag >
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								...
								<#if item == 'processState.value' || item == 'processState.id' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1540798261838')}</Data>
										</Cell>
								</#if>
								<#if item == 'startTime' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1541653857030')}</Data>
										</Cell>
								</#if>
								<#if item == 'endTime' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1541653874550')}</Data>
										</Cell>
								</#if>
								<#if item == 'isFirstProcess' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1540787967189')}</Data>
										</Cell>
								</#if>
								<#if item == 'isLastProcess' || item == '*'>
										<Cell>
								...
								<#if item == 'afterRatio' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1506304526619')}</Data>
										</Cell>
								</#if>
								<#if item == 'exeOrder' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1539844454637')}</Data>
										</Cell>
								</#if>
								<#assign customGeneratedFlag=false />
									<#if item == 'exeOrder' && !customGeneratedFlag >
					...
					<#if item?length gt 0>
								...
								<#if item == 'processState.value' || item == 'processState.id' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String">${getText('${(data.processState.value)!}')}</Data>
								...
								<#if item == 'afterRatio' || item == '*'>
									<Cell>
										...
										<#if (data.afterRatio)?has_content><Data ss:Type="Number">#{(data.afterRatio)!; m6M6}</Data></#if>
