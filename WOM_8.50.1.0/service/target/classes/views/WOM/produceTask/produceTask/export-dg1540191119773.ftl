...
<#assign showCusProps =  dgPage.showCusProps />
	...
	<Styles>
 		...
 		<Style ss:ID="s8">
  		...
  		<Style ss:ID="activeBatchState.name">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0 && item != "checkbox">
									...
									<#if item == 'activeState.value' || item == 'activeState.id' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item?split('.')[0]}"/>
									</#if>
									...
									<#if item == 'activeBatchState.name' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									...
									<#assign customGeneratedFlag=false />
										<#if item == 'activeId.isAnaly' && !customGeneratedFlag >
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								<#if item == 'oprate' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1540867940473')}</Data>
										</Cell>
								</#if>
								<#if item == 'orderProcessId.name' || item == '*'>
										<Cell>
								...
								<#if item == 'startTime' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1540953385761')}</Data>
										</Cell>
								</#if>
								<#if item == 'endTime' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1540953443908')}</Data>
										</Cell>
								</#if>
								<#if item == 'isBackMix' || item == '*'>
										<Cell>
								...
								<#if item == 'actualNum' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1541652731567')}</Data>
										</Cell>
								</#if>
								<#if item == 'outputNum' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1541654816823')}</Data>
										</Cell>
								</#if>
								<#if item == 'lossRate' || item == '*'>
										<Cell>
								...
								<#if item == 'inspectResult' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1555056940027')}</Data>
										</Cell>
								</#if>
								<#if item == 'activeBatchState.name' || item == '*'>
										<Cell>
								...
								<#if item == 'rejectsDeal' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1541652712653')}</Data>
										</Cell>
								</#if>
								<#if item == 'activeId.testProduct.name' || item == '*'>
										<Cell>
					...
					<#if item?length gt 0>
								<#if item == 'oprate' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.oprate)??>${(data.oprate)!}</#if></Data>
								...
								<#if item == 'activeState.value' || item == 'activeState.id' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String">${getText('${(data.activeState.value)!}')}</Data>
								...
								<#if item == 'outputNum' || item == '*'>
									<Cell>
										...
										<#if (data.outputNum)?has_content><Data ss:Type="Number">#{(data.outputNum)!; m6M6}</Data></#if>
								...
								<#if item == 'activeBatchState.name' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.activeBatchState.name)??>${(data.activeBatchState.name)!}</#if></Data>
