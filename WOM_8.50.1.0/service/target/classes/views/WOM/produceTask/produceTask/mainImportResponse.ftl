...
<script type="text/javascript">
	...
	function download(){
		//var url = "/WOM/produceTask/produceTask/downLoad.action?viewCode=WOM_7.5.0.0_produceTask_reWorkList&orgName=WOM_7.5.0.0_produceTask_reWorkList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/WOM/produceTask/produceTask/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
