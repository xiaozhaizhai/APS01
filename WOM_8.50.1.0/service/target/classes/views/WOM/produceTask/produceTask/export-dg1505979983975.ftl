...
<#assign showCusProps =  dgPage.showCusProps />
	...
	<Styles>
 		...
 		<Style ss:ID="s8">
  		...
  		<Style ss:ID="formulaBom.id">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
  		<Style ss:ID="formulaBom.productId.id">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0 && item != "checkbox">
									...
									<#if item == 'formulaBom.productId.id' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'formulaBom.id' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
			...
			<Row ss:AutoFitHeight="0">
				<#list exportFieldList as item>
					<#if item?length gt 0>
								...
								<#if item == 'formulaBom.productId.id' || item == '*'>
									<Cell>
									<#if checkFieldPermission('formulaBom.productId.id','WOM_7.5.0.0_produceTask_ProduceTaskActive','WOM_7.5.0.0_produceTask_ProduceTaskActive_formulaBom||RM_7.5.0.0_formula_FormulaBom_productId||MESBasic_1_product_Product_id') != 0>
										<Data ss:Type="Number"><#if (data.formulaBom.productId.id)??>${(data.formulaBom.productId.id)!}</#if></Data>
									</#if>
									</Cell>
								</#if>
								<#if item == 'formulaBom.id' || item == '*'>
									<Cell>
									<#if checkFieldPermission('formulaBom.id','WOM_7.5.0.0_produceTask_ProduceTaskActive','WOM_7.5.0.0_produceTask_ProduceTaskActive_formulaBom||RM_7.5.0.0_formula_FormulaBom_id') != 0>
										<Data ss:Type="Number"><#if (data.formulaBom.id)??>${(data.formulaBom.id)!}</#if></Data>
									</#if>
									</Cell>
								</#if>
