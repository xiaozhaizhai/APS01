								...
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'manuOrderMain.manulOrderNum' || item == '*'>
			 						        ...
			 						        <#assign customGeneratedFlag=false />
												<#if item == 'manuOrderMain.manulOrderNum' && !customGeneratedFlag >
												</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'workType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1491448830140')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formularId.code' || item == '*'>
									...
									<#if item?length gt 0>
												...
												<#if item == 'workType.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.workType.value)!}')}</Data>
