...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="formularId.setProcess">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="planParId.dayPlanInfo.tableNo">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'planParId.dayPlanInfo.tableNo' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											...
											<#if item == 'formularId.setProcess.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
															<Column ss:Index="${count}" ss:StyleID="${item?substring(0,item?last_index_of('.'))}"  ss:Width="140"/>
														 <#else>
														    <Column ss:Index="${count}" ss:StyleID="${item}"  ss:Width="140" />
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'planParId.dayPlanInfo.tableNo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.common.tableNo1113')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productId.productCode' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productId.productName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.radion1415772740737333344666')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productId.productBaseUnit.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.radion1398235640483')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productBatchNum' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1503897133347')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formularId.code' || item == '*'>
									...
									<#if item?length gt 0>
												...
												<#if item == 'planParId.dayPlanInfo.tableNo' || item == '*'>
													<Cell>
														...
														<#if data.planParId.dayPlanInfo.tableNo??><Data ss:Type="String"><![CDATA[${(data.planParId.dayPlanInfo.tableNo)!}]]></Data></#if>
												...
												<#if item == 'productId.productBaseUnit.name' || item == '*'>
													<Cell>
														...
														<#if data.productId.productBaseUnit.name??><Data ss:Type="String"><![CDATA[${(data.productId.productBaseUnit.name)!}]]></Data></#if>
												...
												<#if item == 'taskType.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.taskType.value)!}')}</Data>
												...
												<#if item == 'formularId.setProcess.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.formularId.setProcess.value)!}')}</Data>
