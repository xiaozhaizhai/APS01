								...
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'isAnaly' || item == '*'>
			 						        ...
			 						        <#assign customGeneratedFlag=false />
												<#if item == 'isAnaly' && !customGeneratedFlag >
												</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon150389713334722')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formularId.code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1495090488729')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchContral' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'factoryId.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489669356969')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskState.value' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isAnaly' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1543321897236')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
												<#if item == 'isAnaly' && !customGeneratedFlag >
												</#if>
