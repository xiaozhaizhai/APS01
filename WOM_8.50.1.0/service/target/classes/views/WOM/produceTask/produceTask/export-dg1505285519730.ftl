			...
			<Row ss:AutoFitHeight="0">
				<#list exportFieldList as item>
					<#if item?length gt 0>
								...
								<#if item == 'offerOrder' || item == '*'>
									<Cell>
									<#if checkFieldPermission('offerOrder','WOM_7.5.0.0_produceTask_ProduceTaskActive','WOM_7.5.0.0_produceTask_ProduceTaskActive_offerOrder') != 0>
								...
								<#if item == 'mobileTerminal' || item == '*'>
									<Cell>
									<#if checkFieldPermission('mobileTerminal','WOM_7.5.0.0_produceTask_ProduceTaskActive','WOM_7.5.0.0_produceTask_ProduceTaskActive_mobileTerminal') != 0>
								...
								<#if item == 'activeId.qualityStandard.name' || item == '*'>
									<Cell>
									<#if checkFieldPermission('activeId.qualityStandard.name','WOM_7.5.0.0_produceTask_ProduceTaskActive','WOM_7.5.0.0_produceTask_ProduceTaskActive_activeId||RM_7.5.0.0_formula_FormulaProcessActive_qualityStandard||RM_7.5.0.0_qualityStandard_Stand_name') != 0>
								...
								<#if item == 'activeId.testProduct.name' || item == '*'>
									<Cell>
									<#if checkFieldPermission('activeId.testProduct.name','WOM_7.5.0.0_produceTask_ProduceTaskActive','WOM_7.5.0.0_produceTask_ProduceTaskActive_activeId||RM_7.5.0.0_formula_FormulaProcessActive_testProduct||RM_7.5.0.0_sampleProj_SampleProj_name') != 0>
								...
								<#if item == 'activeId.pickSite.name' || item == '*'>
									<Cell>
									<#if checkFieldPermission('activeId.pickSite.name','WOM_7.5.0.0_produceTask_ProduceTaskActive','WOM_7.5.0.0_produceTask_ProduceTaskActive_activeId||RM_7.5.0.0_formula_FormulaProcessActive_pickSite||RM_7.5.0.0_pickSite_PickSite_name') != 0>
								...
								<#if item == 'activeId.finalInspection' || item == '*'>
									<Cell>
									<#if checkFieldPermission('activeId.finalInspection','WOM_7.5.0.0_produceTask_ProduceTaskActive','WOM_7.5.0.0_produceTask_ProduceTaskActive_activeId||RM_7.5.0.0_formula_FormulaProcessActive_finalInspection') != 0>
