...
<GridData DefaultNodeExpanded="false"   dgName="dg1542351151648" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<processId.name
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(AdjustOrTempHead_dg1542351151648Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(AdjustOrTempHead_dg1542351151648Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/WOM/produceTask/produceTaskProcess/taskProcessExelogRef.action','dg1542351151648processId.name','${getText("WOM.viewtitle.randon1495700893633")}',sPTGridID,nRow,sFieldName,AdjustOrTempHead_dg1542351151648Widget,null,false,false,'','WOM_7.5.0.0_produceTask_taskProcessExelogRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="AdjustOrTempHead_dg1542351151648Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<product.productName
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(AdjustOrTempHead_dg1542351151648Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(AdjustOrTempHead_dg1542351151648Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/product/product/customRef.action','dg1542351151648product.productName','${getText("MESBasic.viewtitle.randon1506341311049")}',sPTGridID,nRow,sFieldName,AdjustOrTempHead_dg1542351151648Widget,null,false,false,'','MESBasic_1_product_customRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="AdjustOrTempHead_dg1542351151648Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<qualityStandard.name
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(AdjustOrTempHead_dg1542351151648Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(AdjustOrTempHead_dg1542351151648Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/RM/qualityStandard/stand/standRef.action','dg1542351151648qualityStandard.name','${getText("RM.viewtitle.randon1487596068024")}',sPTGridID,nRow,sFieldName,AdjustOrTempHead_dg1542351151648Widget,null,false,false,'','RM_7.5.0.0_qualityStandard_standRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="AdjustOrTempHead_dg1542351151648Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
