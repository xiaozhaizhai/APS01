								...
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'actEndTime' || item == '*'>
			 						        ...
			 						        <#assign customGeneratedFlag=false />
												<#if item == 'actEndTime' && !customGeneratedFlag >
												</#if>
											<#if item == 'remark' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productId.productCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.radion14157726448332327888')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productId.productName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.radion141577264483343322')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productBatchNum' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'bulkProduct.productCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.radion4434356222')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'bulkProduct.productName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.radion141572452740737')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'bulkBatchNum.batchText' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1495853982459')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'bulkNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1495854016913')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'finishNum' || item == '*'>
									...
									<#if item?length gt 0>
												...
												<#if item == 'bulkProduct.productCode' || item == '*'>
													<Cell>
														...
														<#if data.bulkProduct.productCode??><Data ss:Type="String"><![CDATA[${(data.bulkProduct.productCode)!}]]></Data></#if>
												...
												<#if item == 'bulkProduct.productName' || item == '*'>
													<Cell>
														...
														<#if data.bulkProduct.productName??><Data ss:Type="String"><![CDATA[${(data.bulkProduct.productName)!}]]></Data></#if>
												...
												<#if item == 'bulkBatchNum.batchText' || item == '*'>
													<Cell>
														...
														<#if data.bulkBatchNum.batchText??><Data ss:Type="String"><![CDATA[${(data.bulkBatchNum.batchText)!}]]></Data></#if>
