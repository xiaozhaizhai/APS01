...
<script type="text/javascript">
	CUI.ns("WOM.produceTask.produceTaskProcess","WOM.produceTask.produceTaskProcess.taskProcessExelogRef");
</script>
<div class="container"  style="padding-top:10px;">
	...
	<div id="ec_WOM_produceTask_produceTaskProcess_taskProcessExelogRef_queryForm_inputValue">
	...
	<form onsubmit="return false" id="ec_WOM_produceTask_produceTaskProcess_taskProcessExelogRef_queryForm" exportUrl="/WOM/produceTask/produceTaskProcess/taskProcessExelogRef-query.action">
		...
		<input type="hidden" id="dataTableSortColOrder" name="dataTableSortColOrder" />
						<@quickquery unique="LAST_QUERY_ec_WOM_produceTask_produceTaskProcess_taskProcessExelogRef_queryForm" formId="ec_WOM_produceTask_produceTaskProcess_taskProcessExelogRef_queryForm" idprefix="ec_WOM_produceTask_produceTaskProcess_taskProcessExelogRef" expandType="all" expand=true fieldcodes="WOM_7_5_0_0_produceTask_ProduceTaskProcess_name_name:WOM.propertydisplayName.randon1489720649125||WOM_7_5_0_0_produceTask_ProduceTaskProcess_longTime_longTime:WOM.propertydisplayName.randon1489720689233" >
						...
						<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 margin-bottom-5">						
				       	<@querybutton formId="ec_WOM_produceTask_produceTaskProcess_taskProcessExelogRef_queryForm" type="search" onclick="WOM.produceTask.produceTaskProcess.taskProcessExelogRef.commonQuery('query')" /> 
...
<script>
	$(function(){
		var buttons = $( 'button.btn-list', '#ec_WOM_produceTask_produceTaskProcess_taskProcessExelogRef_queryForm' );
		if( buttons.length > 0 ){
			// 去掉按钮间的空格
...
<script type="text/javascript">
	 ...
	 */
	WOM.produceTask.produceTaskProcess.taskProcessExelogRef.query = function(type,pageNo){
		...
		if(!checkListValid("ec_WOM_produceTask_produceTaskProcess_taskProcessExelogRef_queryForm")) {
				return false;
		}
		var dataPost = "";
		...
		url += "&crossCompanyFlag=${Parameters.crossCompanyFlag!}";
	 	datatable_ec_WOM_produceTask_produceTaskProcess_taskProcessExelogRef_query.setRequestDataUrl(url,dataPost);
		return false;
	};
	...
	foundation.common.${requestUri!}__callbackFunction = function(){
		...
		var oRows = datatable_ec_WOM_produceTask_produceTaskProcess_taskProcessExelogRef_query.getSelectedRow();
		if(oRows.length == 0){
		...
		try{
			if(CUI("#WOM_produceTask_produceTaskProcess_taskProcessExelogRef_callBackFuncName").val() != ""){
				eval(CUI("#WOM_produceTask_produceTaskProcess_taskProcessExelogRef_callBackFuncName").val() + "(arrObj)");
			}
		}catch(e){
		}
	};
...
WOM_produceTask_produceTaskProcess_taskProcessExelogRef_refresh = function(node){
	//var url = "/WOM/produceTask/produceTaskProcess/taskProcessExelogRef-query.action";
	//if(node.layRec){
	//	datatable_ec_WOM_produceTask_produceTaskProcess_taskProcessExelogRef_query.setRequestDataUrl(url,'&'+node.modelName+'.layRec=' + node.layRec,false);
	//}else{
	//	datatable_ec_WOM_produceTask_produceTaskProcess_taskProcessExelogRef_query.setRequestDataUrl(url,'',false);
	//}
...
WOM.produceTask.produceTaskProcess.taskProcessExelogRef.showLinkView = function(url,propertyId,row,formId,title,width,height,dialogType){
	...
	if(formId) {
		WOM.produceTask.produceTaskProcess.taskProcessExelogRef.showDialog(url,formId,title,width,height);
	}else {
		openFullScreen(url);
	}
};
...
function checkListValid(formId){if($('#' + formId + ' input[name^="longTime_start"]').val()!= null && $('#' + formId + ' input[name^="longTime_start"]').val()!= ''){if(!isDecimal($('#' + formId + ' input[name^="longTime_start"]').val())){workbenchErrorBarWidget.showMessage("${getText('WOM.propertydisplayName.randon1489720689233')}${getText('ec.list.validate.decimal')}");return false;}}if($('#' + formId + ' input[name^="longTime_end"]').val()!= null && $('#' + formId + ' input[name^="longTime_end"]').val()!= ''){if(!isDecimal($('#' + formId + ' input[name^="longTime_end"]').val())){workbenchErrorBarWidget.showMessage("${getText('WOM.propertydisplayName.randon1489720689233')}${getText('ec.list.validate.decimal')}");return false;}}if($('#' + formId + ' input[name="longTime_start"]').val()!='' && $('#' + formId + ' input[name="longTime_end"]').val()!=''){if(parseInt($('#' + formId + ' input[name="longTime_start"]').val()) > parseInt($('#' + formId + ' input[name="longTime_end"]').val())){workbenchErrorBarWidget.showMessage("${getText('WOM.propertydisplayName.randon1489720689233')}${getText('ec.list.validate.end')}${getText('ec.list.validate.compare')}${getText('WOM.propertydisplayName.randon1489720689233')}${getText('ec.list.validate.start')}");return false;}}return true;};
	...
	/* CUSTOM CODE START(view-REFERENCE-WOM_7.5.0.0_produceTask_taskProcessExelogRef,js,WOM_7.5.0.0_produceTask_ProduceTaskProcess,WOM_7.5.0.0) */
// 自定义代码
/* CUSTOM CODE END */
	</script>
  </body>
