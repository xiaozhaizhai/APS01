...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=WOM_7.5.0.0_materialReject";
	openExportFrame(url);
}
...
<div id="WOM_materialReject_rejectReason_rejectReasonList_attachment">	
