...
<#assign viewCode = 'WOM_7.5.0.0_activeExelog_ActiveExelog' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="taskID.productId.productCode">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		...
	  		<Style ss:ID="taskProcessID.formulaId.code">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="taskProcessID.formulaId.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'taskID.productId.productCode' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											...
											<#if item == 'taskProcessID.formulaId.code' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'taskProcessID.formulaId.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											...
											<#if item == 'staffID.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'exeState.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskID.tableNo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.sczl.common.tableNo')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskID.productId.productName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.radion1415772740737333344')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskID.productId.productCode' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'factoryId.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1495765785738')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskID.factoryId.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.radion1419232393782efe')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskActiveID.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490683872072')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'startTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1495537900705')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'endTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1495537941473')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'staffID.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1495778802161')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'exeState.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1495538316491')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'remark' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1495538348499')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												...
												<#if item == 'taskID.productId.productCode' || item == '*'>
													<Cell>
														...
														<#if data.taskID.productId.productCode??><Data ss:Type="String"><![CDATA[${(data.taskID.productId.productCode)!}]]></Data></#if>
												...
												<#if item == 'taskProcessID.formulaId.code' || item == '*'>
													<Cell>
														...
														<#if data.taskProcessID.formulaId.code??><Data ss:Type="String"><![CDATA[${(data.taskProcessID.formulaId.code)!}]]></Data></#if>
												...
												<#if item == 'taskProcessID.formulaId.name' || item == '*'>
													<Cell>
														...
														<#if data.taskProcessID.formulaId.name??><Data ss:Type="String"><![CDATA[${(data.taskProcessID.formulaId.name)!}]]></Data></#if>
												...
												<#if item == 'staffID.name' || item == '*'>
													<Cell>
														...
														<#if data.staffID.name??><Data ss:Type="String"><![CDATA[${(data.staffID.name)!}]]></Data></#if>
												...
												<#if item == 'exeState.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.exeState.value)!}')}</Data>
