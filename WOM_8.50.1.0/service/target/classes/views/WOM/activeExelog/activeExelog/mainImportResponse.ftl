...
<script type="text/javascript">
	...
	function download(){
		//var url = "/WOM/activeExelog/activeExelog/downLoad.action?viewCode=WOM_7.5.0.0_activeExelog_activeExelogList&orgName=WOM_7.5.0.0_activeExelog_activeExelogList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/WOM/activeExelog/activeExelog/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
