...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=WOM_7.5.0.0_putInMaterial";
	openExportFrame(url);
}
...
<div id="WOM_putInMaterial_putInMaterialPart_putInPartList_attachment">	
