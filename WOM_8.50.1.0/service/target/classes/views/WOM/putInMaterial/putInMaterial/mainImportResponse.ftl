...
<script type="text/javascript">
	...
	function download(){
		//var url = "/WOM/putInMaterial/putInMaterial/downLoad.action?viewCode=WOM_7.5.0.0_putInMaterial_putinList&orgName=WOM_7.5.0.0_putInMaterial_putinList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/WOM/putInMaterial/putInMaterial/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
