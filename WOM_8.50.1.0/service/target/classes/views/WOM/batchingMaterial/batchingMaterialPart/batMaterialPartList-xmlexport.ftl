...
<#assign viewCode = 'WOM_7.5.0.0_batchingMaterial_BatchingMaterialPart' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="headId.tableNo">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="offerSystem">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		...
	  		<Style ss:ID="receiveDate">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="receiveStaff.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="remark">
	  		...
	  		<Style ss:ID="taskID.productBatchNum">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="taskID.productId.productName">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="taskID.tableNo">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											<#if item == 'headId.tableNo' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'taskID.tableNo' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'taskID.productBatchNum' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											...
											<#if item == 'taskID.productId.productName' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											...
											<#if item == 'wareID.cargoStatue.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
											...
											<#if item == 'offerSystem.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
															<Column ss:Index="${count}" ss:StyleID="${item?substring(0,item?last_index_of('.'))}"  ss:Width="140"/>
														 <#else>
														    <Column ss:Index="${count}" ss:StyleID="${item}"  ss:Width="140" />
											...
											<#if item == 'batchDate' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'receiveStaff.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'receiveDate' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											...
											<#if item == 'state.value' || item == '*'>
			 						        ...
			 						        <#assign customGeneratedFlag=false />
												<#if item == 'state.value' && !customGeneratedFlag >
												</#if>
			 						        <#assign customGeneratedFlag=false />
												<#if item == 'state.value' && !customGeneratedFlag >
												</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'headId.tableNo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.menuName.randon1491793946236')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskID.tableNo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490613814833')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskID.productBatchNum' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskID.factoryId.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.201811281643')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'factoryId.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertyshowName.randon1553677424312.flag')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskID.productId.productName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.201811281644')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productId.productCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.radion1415772644833222')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productId.productName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.radion1415772740737334')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1491790594009')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'doneNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1491790683313')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'wareID.wareCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1484031239867')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'wareID.wareName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1484031316283')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'wareID.cargoStatue.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1484031944240')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'storeID.placeSetCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489731651448')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'storeID.placeSetName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489731677164')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'offerSystem.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1491978940082')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'exeStaff.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1491790473893')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'exeDate' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1491790496670')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchDate' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1495509702187')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'receiveStaff.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1491790518494')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'receiveDate' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1491790546754')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'printCount' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1505884945744')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'state.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1491790699395')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
												<#if item == 'state.value' && !customGeneratedFlag >
												</#if>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'remark' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1491790724898')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskBatch' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1497426812197')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												<#if item == 'headId.tableNo' || item == '*'>
													<Cell>
														...
														<#if data.headId.tableNo??><Data ss:Type="String"><![CDATA[${(data.headId.tableNo)!}]]></Data></#if>
												...
												<#if item == 'taskID.tableNo' || item == '*'>
													<Cell>
														...
														<#if data.taskID.tableNo??><Data ss:Type="String"><![CDATA[${(data.taskID.tableNo)!}]]></Data></#if>
												...
												<#if item == 'taskID.productBatchNum' || item == '*'>
													<Cell>
														...
														<#if data.taskID.productBatchNum??><Data ss:Type="String"><![CDATA[${(data.taskID.productBatchNum)!}]]></Data></#if>
												...
												<#if item == 'taskID.factoryId.name' || item == '*'>
													<Cell>
														...
														<#if data.taskID.factoryId.name??><Data ss:Type="String"><![CDATA[${(data.taskID.factoryId.name)!}]]></Data></#if>
												...
												<#if item == 'taskID.productId.productName' || item == '*'>
													<Cell>
														...
														<#if data.taskID.productId.productName??><Data ss:Type="String"><![CDATA[${(data.taskID.productId.productName)!}]]></Data></#if>
												...
												<#if item == 'batchNum' || item == '*'>
													<Cell>
														...
														<#if data.batchNum??><Data ss:Type="String"><![CDATA[${(data.batchNum)!}]]></Data></#if>
												...
												<#if item == 'offerSystem.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.offerSystem.value)!}')}</Data>
												...
												<#if item == 'exeStaff.name' || item == '*'>
													<Cell>
														...
														<#if data.exeStaff.name??><Data ss:Type="String"><![CDATA[${(data.exeStaff.name)!}]]></Data></#if>
												...
												<#if item == 'exeDate' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.exeDate??><Data ss:Type="DateTime">${(data.exeDate)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
												...
												<#if item == 'batchDate' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.batchDate??><Data ss:Type="DateTime">${(data.batchDate)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
												...
												<#if item == 'receiveStaff.name' || item == '*'>
													<Cell>
														...
														<#if data.receiveStaff.name??><Data ss:Type="String"><![CDATA[${(data.receiveStaff.name)!}]]></Data></#if>
												...
												<#if item == 'receiveDate' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.receiveDate??><Data ss:Type="DateTime">${(data.receiveDate)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
												...
												<#if item == 'printCount' || item == '*'>
													<Cell>
														...
														<#if data.printCount??><Data ss:Type="Number"><![CDATA[${(data.printCount)!}]]></Data></#if>
												...
												<#if item == 'taskBatch' || item == '*'>
													<Cell>
														...
														<#if data.taskBatch??><Data ss:Type="String"><![CDATA[${(data.taskBatch)!}]]></Data></#if>
