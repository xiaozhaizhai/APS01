...
<GridData DefaultNodeExpanded="false"   dgName="dg1543470616564" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<batchNum
					sort="false"  onPropertyChange="BatchingRejectParts_dg1543470616564Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<rejectProduct.productCode
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchingRejectParts_dg1543470616564Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchingRejectParts_dg1543470616564Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/product/product/customRef.action','dg1543470616564rejectProduct.productCode','${getText("MESBasic.viewtitle.randon1506341311049")}',sPTGridID,nRow,sFieldName,BatchingRejectParts_dg1543470616564Widget,null,false,false,'','MESBasic_1_product_customRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="BatchingRejectParts_dg1543470616564Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<rejectReasonId.rejectReson
						style="font-color:0303B3"
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchingRejectParts_dg1543470616564Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchingRejectParts_dg1543470616564Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/WOM/materialReject/rejectReason/rejectReasonRef.action','dg1543470616564rejectReasonId.rejectReson','${getText("WOM.viewtitle.randon1543219942185")}',sPTGridID,nRow,sFieldName,BatchingRejectParts_dg1543470616564Widget,null,false,false,'','WOM_7.5.0.0_materialReject_rejectReasonRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="BatchingRejectParts_dg1543470616564Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<ware.wareCode
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchingRejectParts_dg1543470616564Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchingRejectParts_dg1543470616564Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/wareMan/ware/wareRef.action','dg1543470616564ware.wareCode','${getText("MESBasic.viewtitle.randon1484031981880")}',sPTGridID,nRow,sFieldName,BatchingRejectParts_dg1543470616564Widget,null,false,false,'','MESBasic_1_wareMan_wareRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="BatchingRejectParts_dg1543470616564Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<ware.cargoStatue.id
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchingRejectParts_dg1543470616564Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchingRejectParts_dg1543470616564Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/wareMan/ware/wareRef.action','dg1543470616564ware.cargoStatue','${getText("MESBasic.viewtitle.randon1484031981880")}',sPTGridID,nRow,sFieldName,BatchingRejectParts_dg1543470616564Widget,null,false,false,'','MESBasic_1_wareMan_wareRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="BatchingRejectParts_dg1543470616564Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
						...
						<#if (ware_cargoStatue_defaultValue)?? &&(ware_cargoStatue_defaultValue)?has_content>
							defaultValue='${(ware_cargoStatue_defaultValue!)?string}'
						</#if>
						<#if (ware_cargoStatue_defaultText)?? &&(ware_cargoStatue_defaultText)?has_content>
							defaultText='${(ware_cargoStatue_defaultText!)?string}'
						</#if>
				...
				<store.placeSetCode
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchingRejectParts_dg1543470616564Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchingRejectParts_dg1543470616564Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/storeSet/storeSet/pubStoreRef.action','dg1543470616564store.placeSetCode','${getText("MESBasic.viewtitle.randon1514434358343")}',sPTGridID,nRow,sFieldName,BatchingRejectParts_dg1543470616564Widget,null,false,false,'','MESBasic_1_storeSet_pubStoreRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="BatchingRejectParts_dg1543470616564Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<produceTaskId.tableNo
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchingRejectParts_dg1543470616564Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchingRejectParts_dg1543470616564Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/WOM/produceTask/produceTask/maketaskRef.action','dg1543470616564produceTaskId.tableNo','${getText("WOM.viewtitle.randon1490145723075")}',sPTGridID,nRow,sFieldName,BatchingRejectParts_dg1543470616564Widget,null,false,false,'','WOM_7.5.0.0_produceTask_maketaskRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="BatchingRejectParts_dg1543470616564Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<batchingId.id
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchingRejectParts_dg1543470616564Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchingRejectParts_dg1543470616564Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/WOM/batchingMaterial/batchingMaterial/batMaterialRef.action','dg1543470616564batchingId.id','${getText("WOM.viewtitle.randon1491984336543")}',sPTGridID,nRow,sFieldName,BatchingRejectParts_dg1543470616564Widget,null,false,false,'','WOM_7.5.0.0_batchingMaterial_batMaterialRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="BatchingRejectParts_dg1543470616564Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<batchingPartId.id
					sort="false"  onPropertyChange="BatchingRejectParts_dg1543470616564Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
						...
						<#if (batchingPartId_id_defaultValue)?? &&(batchingPartId_id_defaultValue)?has_content>
							defaultValue='${(batchingPartId_id_defaultValue!)?string}'
						</#if>
						<#if (batchingPartId_id_defaultText)?? &&(batchingPartId_id_defaultText)?has_content>
							defaultText='${(batchingPartId_id_defaultText!)?string}'
						</#if>
				...
				<rejectExeStaff.name
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchingRejectParts_dg1543470616564Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchingRejectParts_dg1543470616564Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/foundation/staff/common/staffListFrameset.action','dg1543470616564rejectExeStaff.name','${getText("foundation.ec.entity.view.reference")}',sPTGridID,nRow,sFieldName,BatchingRejectParts_dg1543470616564Widget,null,false,false,'','sysbase_1.0_staff_ref')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="BatchingRejectParts_dg1543470616564Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<rejectTime
					sort="false"  onPropertyChange="BatchingRejectParts_dg1543470616564Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
									  ...
									  onBlur="document.body.click()" 
									   buttonImg="Calendar" onClick="initCalender(BatchingRejectParts_dg1543470616564Widget,'BatchingRejectParts_dg1543470616564Widget',nRow,sFieldName,'datetime')" 
									   onBtnClick="showCalender(BatchingRejectParts_dg1543470616564Widget,'BatchingRejectParts_dg1543470616564Widget',nRow,sFieldName,'datetime')" 
									  			 control="Text" 
	...
	<tbody>
		...
		<row  onClick="BatchingRejectParts_dg1543470616564Widget._DT._autoAddNewRow(nRow)" >
					<c>${(row.id)!}</c>
					<c>${(row.version)!}</c>
