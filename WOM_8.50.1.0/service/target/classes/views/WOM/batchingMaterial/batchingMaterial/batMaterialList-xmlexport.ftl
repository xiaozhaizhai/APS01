...
<#assign viewCode = 'WOM_7.5.0.0_batchingMaterial_BatchingMaterial' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="needPartId.offerSystem">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="orderStaff.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'needPartId.offerSystem.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'orderStaff.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.staff.dimissionStaff_xls.staffName334')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'createTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.common.createTime324567')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskID.tableNo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490605002360')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskID.productBatchNum' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'needNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon14917899223367')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'doneNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1491789944047')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'arriveTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1491789966310')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'state.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1491790319028')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
												<#if item == 'state.value' && !customGeneratedFlag >
												</#if>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'remark' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1491790056696')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												...
												<#if item == 'orderStaff.name' || item == '*'>
													<Cell>
														...
														<#if data.orderStaff.name??><Data ss:Type="String"><![CDATA[${(data.orderStaff.name)!}]]></Data></#if>
												...
												<#if item == 'needPartId.offerSystem.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.needPartId.offerSystem.value)!}')}</Data>
												...
												<#if item == 'needNum' || item == '*'>
													<Cell>
														...
														<#if (data.needNum)?has_content><Data ss:Type="Number">#{(data.needNum)!; m6M6}</Data></#if>
												...
												<#if item == 'arriveTime' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.arriveTime??><Data ss:Type="DateTime">${(data.arriveTime)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
