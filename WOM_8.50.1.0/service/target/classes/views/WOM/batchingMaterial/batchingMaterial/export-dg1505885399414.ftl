 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0 && item != "checkbox">
									...
									<#if item == 'dataSourceID' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'headId.needNum' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								<#if item == 'headId.tableNo' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1496991038915')}</Data>
										</Cell>
								</#if>
								<#if item == 'factoryId.name' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1496884766283')}</Data>
										</Cell>
								</#if>
								<#if item == 'dataSourceID' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1498184231264')}</Data>
										</Cell>
								</#if>
								<#if item == 'headId.needNum' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1491789922336')}</Data>
										</Cell>
								</#if>
								<#if item == 'productId.productCode' || item == '*'>
										<Cell>
			...
			<Row ss:AutoFitHeight="0">
				<#list exportFieldList as item>
					<#if item?length gt 0>
								<#if item == 'headId.tableNo' || item == '*'>
									<Cell>
									<#if checkFieldPermission('headId.tableNo','WOM_7.5.0.0_batchingMaterial_BatchingMaterialPart','WOM_7.5.0.0_batchingMaterial_BatchingMaterialPart_headId||WOM_7.5.0.0_batchingMaterial_BatchingMaterial_tableNo') != 0>
										<Data ss:Type="String"><#if (data.headId.tableNo)??>${(data.headId.tableNo)!}</#if></Data>
									</#if>
									</Cell>
								</#if>
								<#if item == 'factoryId.name' || item == '*'>
									<Cell>
									<#if checkFieldPermission('factoryId.name','WOM_7.5.0.0_batchingMaterial_BatchingMaterialPart','WOM_7.5.0.0_batchingMaterial_BatchingMaterialPart_factoryId||MESBasic_1_factoryModel_FactoryModel_name') != 0>
								...
								<#if item == 'dataSourceID' || item == '*'>
									<Cell>
									<#if checkFieldPermission('dataSourceID','WOM_7.5.0.0_batchingMaterial_BatchingMaterialPart','WOM_7.5.0.0_batchingMaterial_BatchingMaterialPart_dataSourceID') != 0>
										<Data ss:Type="String"><#if (data.dataSourceID)??>${(data.dataSourceID)!}</#if></Data>
									</#if>
									</Cell>
								</#if>
								<#if item == 'headId.needNum' || item == '*'>
									<Cell>
									<#if checkFieldPermission('headId.needNum','WOM_7.5.0.0_batchingMaterial_BatchingMaterialPart','WOM_7.5.0.0_batchingMaterial_BatchingMaterialPart_headId||WOM_7.5.0.0_batchingMaterial_BatchingMaterial_needNum') != 0>
										<#if (data.headId.needNum)?has_content><Data ss:Type="Number">#{(data.headId.needNum)!; m6M6}</Data></#if>
									</#if>
									</Cell>
								</#if>
								<#if item == 'productId.productCode' || item == '*'>
								...
								<#if item == 'batchNumObj.batchText' || item == '*'>
									<Cell>
									<#if checkFieldPermission('batchNumObj.batchText','WOM_7.5.0.0_batchingMaterial_BatchingMaterialPart','WOM_7.5.0.0_batchingMaterial_BatchingMaterialPart_batchNumObj||WOM_7.5.0.0_standingcropRef_StandingcropRef_batchText') != 0>
								...
								<#if item == 'printCount' || item == '*'>
									<Cell>
									<#if checkFieldPermission('printCount','WOM_7.5.0.0_batchingMaterial_BatchingMaterialPart','WOM_7.5.0.0_batchingMaterial_BatchingMaterialPart_printCount') != 0>
