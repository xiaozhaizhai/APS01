...
<script type="text/javascript">
	...
	function download(){
		//var url = "/WOM/batchingMaterial/batchingMaterial/downLoad.action?viewCode=WOM_7.5.0.0_batchingMaterial_batMaterialList&orgName=WOM_7.5.0.0_batchingMaterial_batMaterialList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/WOM/batchingMaterial/batchingMaterial/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
