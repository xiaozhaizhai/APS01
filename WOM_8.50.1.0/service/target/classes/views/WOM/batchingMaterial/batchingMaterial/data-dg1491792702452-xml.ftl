...
<GridData DefaultNodeExpanded="false"   dgName="dg1491792702452" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<productId.productCode
						style="font-color:0303B3"
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchingMaterialPart_dg1491792702452Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchingMaterialPart_dg1491792702452Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/product/product/productRefNew.action','dg1491792702452productId.productCode','${getText("MESBasic.viewtitle.randon1475137145215")}',sPTGridID,nRow,sFieldName,BatchingMaterialPart_dg1491792702452Widget,null,false,false,'','MESBasic_1_product_productRefNew')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="BatchingMaterialPart_dg1491792702452Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<batchNumObj.batchText
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchingMaterialPart_dg1491792702452Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchingMaterialPart_dg1491792702452Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/WOM/standingcropRef/standingcropRef/batchNumOneBatRef.action','dg1491792702452batchNumObj.batchText','${getText("WOM.viewtitle.randon1502607384728")}',sPTGridID,nRow,sFieldName,BatchingMaterialPart_dg1491792702452Widget,'batchObjCallback(obj)',false,false,'','WOM_7.5.0.0_standingcropRef_batchNumOneBatRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="BatchingMaterialPart_dg1491792702452Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<doneNum
						style="font-color:0303B3"
					sort="false"  onPropertyChange="BatchingMaterialPart_dg1491792702452Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				    onChange="BatchingMaterialPart_dg1491792702452Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);BatchingMaterialPart_dg1491792702452Widget.evalCustomFunction(nRow,sFieldName,'doneNumChang()');"
				...
				<wareID.wareCode
						style="font-color:0303B3"
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchingMaterialPart_dg1491792702452Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchingMaterialPart_dg1491792702452Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/wareMan/ware/wareRef.action','dg1491792702452wareID.wareCode','${getText("MESBasic.viewtitle.randon1484031981880")}',sPTGridID,nRow,sFieldName,BatchingMaterialPart_dg1491792702452Widget,null,false,false,'','MESBasic_1_wareMan_wareRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="BatchingMaterialPart_dg1491792702452Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<storeID.placeSetCode
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchingMaterialPart_dg1491792702452Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchingMaterialPart_dg1491792702452Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/storeSet/storeSet/storeRef.action','dg1491792702452storeID.placeSetCode','${getText("MESBasic.viewtitle.randon1489735291062")}',sPTGridID,nRow,sFieldName,BatchingMaterialPart_dg1491792702452Widget,null,false,false,'','MESBasic_1_storeSet_storeRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="BatchingMaterialPart_dg1491792702452Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<exeStaff.name
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchingMaterialPart_dg1491792702452Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchingMaterialPart_dg1491792702452Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/foundation/staff/common/staffListFrameset.action','dg1491792702452exeStaff.name','${getText("foundation.ec.entity.view.reference")}',sPTGridID,nRow,sFieldName,BatchingMaterialPart_dg1491792702452Widget,null,false,false,'','sysbase_1.0_staff_ref')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="BatchingMaterialPart_dg1491792702452Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
					...
					sort="false"  onPropertyChange="BatchingMaterialPart_dg1491792702452Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
						...
						hideButtonsOnReadOnly="true"
									  onBlur="document.body.click()" 
									   buttonImg="Calendar" onClick="initCalender(BatchingMaterialPart_dg1491792702452Widget,'BatchingMaterialPart_dg1491792702452Widget',nRow,sFieldName,'datetime')" 
									   onBtnClick="showCalender(BatchingMaterialPart_dg1491792702452Widget,'BatchingMaterialPart_dg1491792702452Widget',nRow,sFieldName,'datetime')" 
				...
				<#list customPropViewMappings as cpvm>
					...
					<#if cpvm.property.type == 'OBJECT'>
						...
						<#if cpvm.refView??>
							...
							onFocus="CUI.toggleClearBtn_DG_IE(BatchingMaterialPart_dg1491792702452Widget,nRow,sFieldName)"
							onBtnClick="CUI.clearCellValue_DG_IE(BatchingMaterialPart_dg1491792702452Widget,nRow,sFieldName,true)"
							subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('${viewUrl!}','dg1491792702452${cpvm.propertyLayRec}','${getText("${viewTitle}")}',sPTGridID,nRow,'${cpvm.propertyLayRec}',BatchingMaterialPart_dg1491792702452Widget,null,false,true,'${mainDisplayName},${pkName}','${viewCode}')"
							hideEditOnReadOnly="true"
						</#if>
					</#if>
						sort="false"
						onPropertyChange="BatchingMaterialPart_dg1491792702452Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
					...
					<#elseif cpvm.property.type == 'DATETIME'>
						...
						onClick="initCalender(BatchingMaterialPart_dg1491792702452Widget,'BatchingMaterialPart_dg1491792702452Widget',nRow,sFieldName,<#if cpvm.format == 'YMD_H'>'dateTimeHour'<#elseif cpvm.format == 'YMD_HM'>'dateTimeMin'<#else>'datetime'</#if>)"
						onBtnClick="showCalender(BatchingMaterialPart_dg1491792702452Widget,'BatchingMaterialPart_dg1491792702452Widget',nRow,sFieldName,<#if cpvm.format == 'YMD_H'>'dateTimeHour'<#elseif cpvm.format == 'YMD_HM'>'dateTimeMin'<#else>'datetime'</#if>)"
						control="Text"
				...
				<factoryId.name
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchingMaterialPart_dg1491792702452Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchingMaterialPart_dg1491792702452Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/factoryModel/factoryModel/factoryProductRef.action','dg1491792702452factoryId.name','${getText("MESBasic.viewtitle.randon1490322427886")}',sPTGridID,nRow,sFieldName,BatchingMaterialPart_dg1491792702452Widget,null,false,false,'','MESBasic_1_factoryModel_factoryProductRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="BatchingMaterialPart_dg1491792702452Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
					...
					showFormat="SELECTCOMP" 
						type="SELECTCOMP" 
					width="100">节点名称</factoryId.name>
	</thead>
	<tbody>
		<#list dgPage.result as row>
		<row  onClick="BatchingMaterialPart_dg1491792702452Widget._DT._autoAddNewRow(nRow)" >
					<c>${(row.id)!}</c>
					<c>${(row.version)!}</c>
