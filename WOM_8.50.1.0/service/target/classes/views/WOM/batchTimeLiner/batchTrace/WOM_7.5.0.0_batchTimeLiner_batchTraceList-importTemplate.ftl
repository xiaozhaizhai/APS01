...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
	...
	<Style ss:ID="WOM_7.5.0.0_batchTimeLiner_BatchTrace_prodTaskId">
  			<NumberFormat/>
  			<Protection/>
	</Style>
...
<Worksheet ss:Name="sheet1">
	<Table ss:ExpandedColumnCount="256" ss:ExpandedRowCount="3" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="16.5">
			<Column ss:Index="1" ss:Width="100"  ss:StyleID="WOM_7.5.0.0_batchTimeLiner_BatchTrace_prodTaskId"/>
	<#assign secondCount=2/>
	<#if customStyleCodes??>
						...
						<Cell >
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										WOM_7.5.0.0_batchTimeLiner_BatchTrace_prodTaskId||WOM_7.5.0.0_produceTask_ProduceTask_tableNo
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
