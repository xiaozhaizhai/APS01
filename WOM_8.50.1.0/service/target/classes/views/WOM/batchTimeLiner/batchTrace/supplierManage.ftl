<!-- WOM_7.5.0.0/batchTimeLiner/supplierManage -->
...
<#-- 命名空间 -->
<#assign editPageNs = "WOM.batchTimeLiner.batchTrace.supplierManage">
<#-- 模型名称-->
<#assign modelName = "batchTrace">
<#-- 视图编码-->
<#assign viewCode = "WOM_7.5.0.0_batchTimeLiner_supplierManage">
<#-- 实体编码-->
<#assign entity_code = "WOM_7.5.0.0_batchTimeLiner">
<#-- 视图名称-->
<#assign viewName = "supplierManage">
<#-- datagrid编码-->
<#assign datagridCode = "WOM_batchTimeLiner_batchTrace_supplierManage_datagrids">
<#-- 首字母大写的模型名称-->
...
<#-- formid -->
<#assign editFormId = "WOM_batchTimeLiner_batchTrace_supplierManage_form">
<#-- 待办状态 -->
                                ...
                                <div class="full-height-scroll">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover">
                                            <tbody>
                                            <tr>
                                                <td class="client-avatar"><img alt="image" src="/bap/static/WOM/hAdmin/hAdmin/img/a2.jpg"> </td>
                                            ...
                                            <tr>
                                                <td class="client-avatar"><img alt="image" src="/bap/static/WOM/hAdmin/hAdmin/img/a3.jpg"> </td>
                                            ...
                                            <tr>
                                                <td class="client-avatar"><img alt="image" src="/bap/static/WOM/hAdmin/hAdmin/img/a4.jpg"> </td>
                                            ...
                                            <tr>
                                                <td class="client-avatar">
                                                    <a href=""><img alt="image" src="/bap/static/WOM/hAdmin/hAdmin/img/a5.jpg">
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="client-avatar">
                                                    <a href=""><img alt="image" src="/bap/static/WOM/hAdmin/hAdmin/img/a6.jpg">
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="client-avatar">
                                                    <a href=""><img alt="image" src="/bap/static/WOM/hAdmin/hAdmin/img/a7.jpg">
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="client-avatar">
                                                    <a href=""><img alt="image" src="/bap/static/WOM/hAdmin/hAdmin/img/a1.jpg">
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="client-avatar">
                                                    <a href=""><img alt="image" src="/bap/static/WOM/hAdmin/hAdmin/img/a3.jpg">
                                                    </a>
                                                </td>
                                                <td><a data-toggle="tab" href="#contact-2" class="client-link">王利锋</a>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="client-avatar">
                                                    <a href=""><img alt="image" src="/bap/static/WOM/hAdmin/hAdmin/img/a4.jpg">
                                                    </a>
                                                </td>
                                                <td><a data-toggle="tab" href="#contact-3" class="client-link">张有为 </a>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="client-avatar">
                                                    <a href=""><img alt="image" src="/bap/static/WOM/hAdmin/hAdmin/img/a2.jpg">
                                                    </a>
                                                </td>
                                                <td><a data-toggle="tab" href="#contact-1" class="client-link">袁岳</a>
                                                </td>
                        ...
                        <div id="contact-1" class="tab-pane active">
                            <div class="row m-b-lg">
                                <div class="col-lg-4 text-center">
                                    ...
                                    <div class="m-b-sm">
                                        <img alt="image" class="img-circle" src="/bap/static/WOM/hAdmin/hAdmin/img/a2.jpg" style="width: 62px">
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    <h3>
...
<script src="/bap/static/WOM/hAdmin/hAdmin/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
