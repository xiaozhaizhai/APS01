...
<#assign viewCode = 'WOM_7.5.0.0_batchTimeLiner_BatchTrace' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		<Style ss:ID="prodTaskId.factoryId.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="prodTaskId.productBatchNum">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="prodTaskId.productId.productCode">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="prodTaskId.productId.productName">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											<#if item == 'prodTaskId.productBatchNum' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'prodTaskId.factoryId.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'prodTaskId.productId.productCode' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'prodTaskId.productId.productName' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'prodTaskId.factoryId.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.treeRootName.radion1419491099876111')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'prodTaskId.productId.productCode' || item == '*'>
									...
									<#if item?length gt 0>
												<#if item == 'prodTaskId.productBatchNum' || item == '*'>
													<Cell>
														...
														<#if data.prodTaskId.productBatchNum??><Data ss:Type="String"><![CDATA[${(data.prodTaskId.productBatchNum)!}]]></Data></#if>
												...
												<#if item == 'prodTaskId.factoryId.name' || item == '*'>
													<Cell>
														...
														<#if data.prodTaskId.factoryId.name??><Data ss:Type="String"><![CDATA[${(data.prodTaskId.factoryId.name)!}]]></Data></#if>
												...
												<#if item == 'prodTaskId.productId.productCode' || item == '*'>
													<Cell>
														...
														<#if data.prodTaskId.productId.productCode??><Data ss:Type="String"><![CDATA[${(data.prodTaskId.productId.productCode)!}]]></Data></#if>
												...
												<#if item == 'prodTaskId.productId.productName' || item == '*'>
													<Cell>
														...
														<#if data.prodTaskId.productId.productName??><Data ss:Type="String"><![CDATA[${(data.prodTaskId.productId.productName)!}]]></Data></#if>
