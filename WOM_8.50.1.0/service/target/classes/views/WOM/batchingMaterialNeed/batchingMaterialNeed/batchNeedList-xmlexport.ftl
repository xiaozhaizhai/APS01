...
<#assign viewCode = 'WOM_7.5.0.0_batchingMaterialNeed_BatchingMaterialNeed' />
<#assign propertyCode = '' />
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskID.tableNo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.common.tableNo436457')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskID.productBatchNum' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'factoryId.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490605067247')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskActive.name' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'actOrder' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1498050691527')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'offerOrder' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490614138387')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchSite.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1497507426071')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'offerSystem.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490614163532')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'container' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1497507453613')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'planNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon14906142534274345')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'hasOrderNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490616453276')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'useNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490614271670')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'actualNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1546824986338')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'state.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490614632524')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
												<#if item == 'state.value' && !customGeneratedFlag >
												</#if>
									...
									<#if item?length gt 0>
												...
												<#if item == 'taskProcess.name' || item == '*'>
													<Cell>
														...
														<#if data.taskProcess.name??><Data ss:Type="String"><![CDATA[${(data.taskProcess.name)!}]]></Data></#if>
												...
												<#if item == 'taskActive.name' || item == '*'>
													<Cell>
														...
														<#if data.taskActive.name??><Data ss:Type="String"><![CDATA[${(data.taskActive.name)!}]]></Data></#if>
												...
												<#if item == 'actOrder' || item == '*'>
													<Cell>
														...
														<#if data.actOrder??><Data ss:Type="Number"><![CDATA[${(data.actOrder)!}]]></Data></#if>
												...
												<#if item == 'offerOrder' || item == '*'>
													<Cell>
														...
														<#if data.offerOrder??><Data ss:Type="Number"><![CDATA[${(data.offerOrder)!}]]></Data></#if>
												...
												<#if item == 'container' || item == '*'>
													<Cell>
														...
														<#if data.container??><Data ss:Type="String"><![CDATA[${(data.container)!}]]></Data></#if>
												...
												<#if item == 'hasOrderNum' || item == '*'>
													<Cell>
														...
														<#if (data.hasOrderNum)?has_content><Data ss:Type="Number">#{(data.hasOrderNum)!; m6M6}</Data></#if>
