...
<#assign showCusProps =  dgPage.showCusProps />
	...
	<Styles>
 		...
 		<Style ss:ID="s8">
  		...
  		<Style ss:ID="craftStandards.loweMxLimit">
  			<NumberFormat ss:Format="0.000000"/>
  			<Protection/>
  		</Style>
  		<Style ss:ID="craftStandards.lowerLimit">
  			<NumberFormat ss:Format="0.000000"/>
  			<Protection/>
  		</Style>
  		<Style ss:ID="craftStandards.maxLimit">
  			<NumberFormat ss:Format="0.000000"/>
  			<Protection/>
  		</Style>
  		<Style ss:ID="craftStandards.quota">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
  		<Style ss:ID="craftStandards.stValue">
  			<NumberFormat ss:Format="0.000000"/>
  			<Protection/>
  		</Style>
  		<Style ss:ID="craftStandards.upperLimit">
  			<NumberFormat ss:Format="0.000000"/>
  			<Protection/>
  		</Style>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0 && item != "checkbox">
									<#if item == 'craftStandards.quota' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'craftStandards.stValue' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'craftStandards.loweMxLimit' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'craftStandards.lowerLimit' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'craftStandards.upperLimit' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'craftStandards.maxLimit' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
					...
					<#if item?length gt 0>
								<#if item == 'craftStandards.quota' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.craftStandards.quota)??>${(data.craftStandards.quota)!}</#if></Data>
								...
								<#if item == 'craftStandards.stValue' || item == '*'>
									<Cell>
										...
										<#if (data.craftStandards.stValue)?has_content><Data ss:Type="Number">#{(data.craftStandards.stValue)!; m6M6}</Data></#if>
								...
								<#if item == 'craftStandards.loweMxLimit' || item == '*'>
									<Cell>
										...
										<#if (data.craftStandards.loweMxLimit)?has_content><Data ss:Type="Number">#{(data.craftStandards.loweMxLimit)!; m6M6}</Data></#if>
								...
								<#if item == 'craftStandards.lowerLimit' || item == '*'>
									<Cell>
										...
										<#if (data.craftStandards.lowerLimit)?has_content><Data ss:Type="Number">#{(data.craftStandards.lowerLimit)!; m6M6}</Data></#if>
								...
								<#if item == 'craftStandards.upperLimit' || item == '*'>
									<Cell>
										...
										<#if (data.craftStandards.upperLimit)?has_content><Data ss:Type="Number">#{(data.craftStandards.upperLimit)!; m6M6}</Data></#if>
								...
								<#if item == 'craftStandards.maxLimit' || item == '*'>
									<Cell>
										...
										<#if (data.craftStandards.maxLimit)?has_content><Data ss:Type="Number">#{(data.craftStandards.maxLimit)!; m6M6}</Data></#if>
