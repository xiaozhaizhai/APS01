...
<GridData DefaultNodeExpanded="false"   dgName="dg1542248606236" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<good.productCode
							onBlur="document.body.click()"
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchCharge_dg1542248606236Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchCharge_dg1542248606236Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/product/product/refProductLayout.action','dg1542248606236good.productCode','${getText("MESBasic.viewtitle.randon1450085069587")}',sPTGridID,nRow,sFieldName,BatchCharge_dg1542248606236Widget,null,false,false,'','MESBasic_1_product_refProductLayout')"
								onKeyUp="WOM.procFeedback.procFeedbackHead.adjustBatchView.initMnemonic_DG_IE({
										'keyCode':Key,
										'oGrid':BatchCharge_dg1542248606236Widget,
										'sGridName':'BatchCharge_dg1542248606236Widget',
										'value':sParam,
										'nRow':nRow,
										...
										'funcname':'WOM.procFeedback.procFeedbackHead.adjustBatchView.getcallBackInfo_DG_IE(obj)',
										'conditionfunc':'WOM.procFeedback.procFeedbackHead.adjustBatchView._querycustomFunc(\'dg1542248606236good.productCode\'.replace(/\./g, \'_\'))'
										
									})"
					sort="true"  onPropertyChange="BatchCharge_dg1542248606236Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<wareID.wareCode
							onBlur="document.body.click()"
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchCharge_dg1542248606236Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchCharge_dg1542248606236Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/wareMan/ware/wareRef.action','dg1542248606236wareID.wareCode','${getText("MESBasic.viewtitle.randon1484031981880")}',sPTGridID,nRow,sFieldName,BatchCharge_dg1542248606236Widget,null,false,false,'','MESBasic_1_wareMan_wareRef')"
								onKeyUp="WOM.procFeedback.procFeedbackHead.adjustBatchView.initMnemonic_DG_IE({
										'keyCode':Key,
										'oGrid':BatchCharge_dg1542248606236Widget,
										'sGridName':'BatchCharge_dg1542248606236Widget',
										...
										'isCrossCompany':'false',
										'funcname':'WOM.procFeedback.procFeedbackHead.adjustBatchView.getcallBackInfo_DG_IE(obj)',
										'conditionfunc':'WOM.procFeedback.procFeedbackHead.adjustBatchView._querycustomFunc(\'dg1542248606236wareID.wareCode\'.replace(/\./g, \'_\'))'
				...
				<putinDate
					sort="true"  onPropertyChange="BatchCharge_dg1542248606236Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
						...
						hideButtonsOnReadOnly="true"
									  onBlur="document.body.click()" 
									   buttonImg="Calendar" onClick="initCalender(BatchCharge_dg1542248606236Widget,'BatchCharge_dg1542248606236Widget',nRow,sFieldName,'datetime')" 
									   onBtnClick="showCalender(BatchCharge_dg1542248606236Widget,'BatchCharge_dg1542248606236Widget',nRow,sFieldName,'datetime')" 
