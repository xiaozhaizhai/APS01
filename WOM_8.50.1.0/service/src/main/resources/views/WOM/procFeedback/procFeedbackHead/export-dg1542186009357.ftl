...
<#assign showCusProps =  dgPage.showCusProps />
	...
	<Styles>
 		...
 		<Style ss:ID="s8">
  		...
  		<Style ss:ID="standingCrop.availiQuantity">
  			<NumberFormat ss:Format="0.000000"/>
  			<Protection/>
  		</Style>
  		<Style ss:ID="standingCrop.batchText">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
  		<Style ss:ID="standingCrop.onhand">
  			<NumberFormat ss:Format="0.000000"/>
  			<Protection/>
  		</Style>
  		<Style ss:ID="standingCrop.prepareOrder.outCode">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0 && item != "checkbox">
									...
									<#if item == 'standingCrop.onhand' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'standingCrop.prepareOrder.outCode' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'standingCrop.batchText' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									...
									<#if item == 'standingCrop.availiQuantity' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'remark' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								...
								<#if item == 'standingCrop.prepareOrder.outCode' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertyshowName.randon1566961328560.flag')}</Data>
										</Cell>
								</#if>
								<#if item == 'standingCrop.batchText' || item == '*'>
										<Cell>
								...
								<#if item == 'batch' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertyshowName.randon1566961099280.flag')}</Data>
										</Cell>
								</#if>
					...
					<#if item?length gt 0>
								...
								<#if item == 'standingCrop.onhand' || item == '*'>
									<Cell>
										...
										<#if (data.standingCrop.onhand)?has_content><Data ss:Type="Number">#{(data.standingCrop.onhand)!; m6M6}</Data></#if>
								...
								<#if item == 'standingCrop.prepareOrder.outCode' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.standingCrop.prepareOrder.outCode)??>${(data.standingCrop.prepareOrder.outCode)!}</#if></Data>
								...
								<#if item == 'standingCrop.batchText' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.standingCrop.batchText)??>${(data.standingCrop.batchText)!}</#if></Data>
								...
								<#if item == 'standingCrop.availiQuantity' || item == '*'>
									<Cell>
										...
										<#if (data.standingCrop.availiQuantity)?has_content><Data ss:Type="Number">#{(data.standingCrop.availiQuantity)!; m6M6}</Data></#if>
