...
<GridData DefaultNodeExpanded="false"  MultiSelect="checkbox"  dgName="dg1541066103156" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<good.productCode
						style="font-color:0303B3"
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchCharge_dg1541066103156Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchCharge_dg1541066103156Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/product/product/customRef.action','dg1541066103156good.productCode','${getText("MESBasic.viewtitle.randon1506341311049")}',sPTGridID,nRow,sFieldName,BatchCharge_dg1541066103156Widget,null,false,false,'','MESBasic_1_product_customRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="BatchCharge_dg1541066103156Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<wareID.wareCode
						style="font-color:0303B3"
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchCharge_dg1541066103156Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchCharge_dg1541066103156Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/wareMan/ware/wareRef.action','dg1541066103156wareID.wareCode','${getText("MESBasic.viewtitle.randon1484031981880")}',sPTGridID,nRow,sFieldName,BatchCharge_dg1541066103156Widget,null,false,false,'','MESBasic_1_wareMan_wareRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="BatchCharge_dg1541066103156Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<placeSet.placeSetCode
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchCharge_dg1541066103156Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchCharge_dg1541066103156Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/storeSet/storeSet/pubStoreRef.action','dg1541066103156placeSet.placeSetCode','${getText("MESBasic.viewtitle.randon1514434358343")}',sPTGridID,nRow,sFieldName,BatchCharge_dg1541066103156Widget,null,false,false,'','MESBasic_1_storeSet_pubStoreRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="BatchCharge_dg1541066103156Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<putinDate
					...
					sort="false"  onPropertyChange="BatchCharge_dg1541066103156Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
									  ...
									  onBlur="document.body.click()" 
									   buttonImg="Calendar" onClick="initCalender(BatchCharge_dg1541066103156Widget,'BatchCharge_dg1541066103156Widget',nRow,sFieldName,'datetime')" 
									   onBtnClick="showCalender(BatchCharge_dg1541066103156Widget,'BatchCharge_dg1541066103156Widget',nRow,sFieldName,'datetime')" 
									  			 control="Text" 
	...
	<tbody>
		...
		<row  onClick="BatchCharge_dg1541066103156Widget._DT._autoAddNewRow(nRow)" >
					<c>${(row.id)!}</c>
					<c>${(row.version)!}</c>
					<c>${(row.good.id)!}</c>
					<c>${(row.wareID.id)!}</c>
