...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=WOM_7.5.0.0_procFeedback";
	openExportFrame(url);
}
...
<div id="WOM_procFeedback_procFeedbackHead_procFeedbackList_attachment">	
