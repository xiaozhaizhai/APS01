...
<#assign viewCode = 'WOM_7.5.0.0_procFeedback_CraftStandards' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'craftName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1541034087253')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'standardValue' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1541034112568')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'remark' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1541034061588')}</Data></Cell>
											</#if>
									...
									<#if item?length gt 0>
												<#if item == 'craftName' || item == '*'>
													<Cell>
														...
														<#if data.craftName??><Data ss:Type="String"><![CDATA[${(data.craftName)!}]]></Data></#if>
												...
												<#if item == 'standardValue' || item == '*'>
													<Cell>
														...
														<#if (data.standardValue)?has_content><Data ss:Type="Number">#{(data.standardValue)!; m6M6}</Data></#if>
