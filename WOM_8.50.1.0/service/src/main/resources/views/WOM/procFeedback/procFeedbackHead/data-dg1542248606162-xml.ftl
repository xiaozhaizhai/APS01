...
<GridData DefaultNodeExpanded="false"  MultiSelect="checkbox"  dgName="dg1542248606162" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<craftName
					sort="true"  onPropertyChange="CraftStandards_dg1542248606162Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
