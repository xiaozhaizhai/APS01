...
<script type="text/javascript">
	...
	function download(){
		//var url = "/WOM/procFeedback/procFeedbackHead/downLoad.action?viewCode=WOM_7.5.0.0_procFeedback_procFeedbackList&orgName=WOM_7.5.0.0_procFeedback_procFeedbackList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/WOM/procFeedback/procFeedbackHead/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
