...
<#assign showCusProps =  dgPage.showCusProps />
	...
	<Styles>
 		...
 		<Style ss:ID="s8">
  		...
  		<Style ss:ID="material.unitGroup.name">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0 && item != "checkbox">
									...
									<#if item == 'material.unitGroup.name' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								...
								<#if item == 'material.unitGroup.name' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertyshowName.randon1565178546014.flag')}</Data>
										</Cell>
								</#if>
								<#if item == 'needNumber' || item == '*'>
										<Cell>
								...
								<#if item == 'rsNUM' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563254148286')}</Data>
										</Cell>
								</#if>
								<#if item == 'rsPOS' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563254342780')}</Data>
										</Cell>
								</#if>
								<#if item == 'edition' || item == '*'>
										<Cell>
								...
								<#if item == 'coOperation' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563254818324')}</Data>
										</Cell>
								</#if>
					...
					<#if item?length gt 0>
								...
								<#if item == 'material.unitGroup.name' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.material.unitGroup.name)??>${(data.material.unitGroup.name)!}</#if></Data>
								...
								<#if item == 'needNumber' || item == '*'>
									<Cell>
										...
										<#if (data.needNumber)?has_content><Data ss:Type="Number">#{(data.needNumber)!; m2M2}</Data></#if>
								...
								<#if item == 'rsNUM' || item == '*'>
									<Cell>
										...
										<#if (data.rsNUM)?has_content><Data ss:Type="Number">#{(data.rsNUM)!; m2M2}</Data></#if>
								...
								<#if item == 'rsPOS' || item == '*'>
									<Cell>
										...
										<#if (data.rsPOS)?has_content><Data ss:Type="Number">#{(data.rsPOS)!; m2M2}</Data></#if>
