...
<#assign viewCode = 'WOM_7.5.0.0_manulOrder_ManulOrderMaterial' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		<Style ss:ID="manulOrderId.manulOrderNum">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		...
	  		<Style ss:ID="unit.unitGroup.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											<#if item == 'manulOrderId.manulOrderNum' || item == '*'>
											...
											<#if item == 'unit.unitGroup.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'materialBatchNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563254620511')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'material.productCode' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'needNumber' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563254572747')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'ware.wareCode' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'planStartTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563254655357')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'planEndTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563254700758')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'rsNUM' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563254148286')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'rsPOS' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563254342780')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												<#if item == 'manulOrderId.manulOrderNum' || item == '*'>
													<Cell>
														...
														<#if data.manulOrderId.manulOrderNum??><Data ss:Type="String"><![CDATA[${(data.manulOrderId.manulOrderNum)!}]]></Data></#if>
												...
												<#if item == 'materialBatchNum' || item == '*'>
													<Cell>
														...
														<#if data.materialBatchNum??><Data ss:Type="String"><![CDATA[${(data.materialBatchNum)!}]]></Data></#if>
												...
												<#if item == 'material.productCode' || item == '*'>
													<Cell>
														...
														<#if data.material.productCode??><Data ss:Type="String"><![CDATA[${(data.material.productCode)!}]]></Data></#if>
												...
												<#if item == 'unit.unitGroup.name' || item == '*'>
													<Cell>
														...
														<#if data.unit.unitGroup.name??><Data ss:Type="String"><![CDATA[${(data.unit.unitGroup.name)!}]]></Data></#if>
