...
<#assign showCusProps =  dgPage.showCusProps />
	...
	<Styles>
 		...
 		<Style ss:ID="s8">
  		...
  		<Style ss:ID="ware.wareState">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
			 						    	<#assign customPropList = showCusProps.get("batchingRejectParts")  />
											<#-- 排布自定义字段 -->
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0 && item != "checkbox">
									...
									<#if item == 'ware.wareState.value' || item == 'ware.wareState.id' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item?split('.')[0]}"/>
									</#if>
									<#if item == 'ware.id' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									...
									<#if item == 'tableInfoId' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#assign customGeneratedFlag=false />
										<#if item == 'tableInfoId' && !customGeneratedFlag >
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								...
								<#if item == 'ware.wareState.value' || item == 'ware.wareState.id' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1484031901523')}</Data>
										</Cell>
								</#if>
								<#if item == 'ware.id' || item == '*'>
										<Cell>
								...
								<#if item == 'rejectExeStaff.name' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.201811291126')}</Data>
										</Cell>
								</#if>
								<#if item == 'rejectTime' || item == '*'>
										<Cell>
								...
								<#if item == 'produceTaskId.tableNo' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.201811291128')}</Data>
										</Cell>
								</#if>
								<#if item == 'produceTaskId.factoryId.name' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.201811291129')}</Data>
										</Cell>
								</#if>
								<#if item == 'produceTaskId.productId.productName' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.201811291129002')}</Data>
										</Cell>
								</#if>
								<#if item == 'batchingId.id' || item == '*'>
										<Cell>
								...
								<#if item == 'receiveDate' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1543236378702')}</Data>
										</Cell>
								</#if>
								<#if item == 'tableInfoId' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('ec.common.TABLE_INFO_ID')}</Data>
										</Cell>
								</#if>
								<#assign customGeneratedFlag=false />
									<#if item == 'tableInfoId' && !customGeneratedFlag >
					...
					<#if item?length gt 0>
								...
								<#if item == 'ware.wareState.value' || item == 'ware.wareState.id' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String">${getText('${(data.ware.wareState.value)!}')}</Data>
								...
								<#if item == 'ware.id' || item == '*'>
									<Cell>
										...
										<Data ss:Type="Number"><#if (data.ware.id)??>${(data.ware.id)!}</#if></Data>
								...
								<#if item == 'store.id' || item == '*'>
									<Cell>
										...
										<Data ss:Type="Number"><#if (data.store.id)??>${(data.store.id)!}</#if></Data>
								...
								<#if item == 'batchingId.id' || item == '*'>
									<Cell>
										...
										<Data ss:Type="Number"><#if (data.batchingId.id)??>${(data.batchingId.id)!}</#if></Data>
								...
								<#if item == 'rejectReceiveStaff.name' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.rejectReceiveStaff.name)??>${(data.rejectReceiveStaff.name)!}</#if></Data>
								...
								<#if item == 'receiveDate' || item == '*'>
									<Cell ss:StyleID="s8">
										...
										<#if data.receiveDate??><Data ss:Type="Number"><@workerdate datetime='${(data.receiveDate)!?string("yyyy-MM-dd HH:mm:ss")}'></@workerdate></Data></#if>
								...
								<#if item == 'tableInfoId' || item == '*'>
									<Cell>
										...
										<Data ss:Type="Number"><#if (data.tableInfoId)??>${(data.tableInfoId)!}</#if></Data>
