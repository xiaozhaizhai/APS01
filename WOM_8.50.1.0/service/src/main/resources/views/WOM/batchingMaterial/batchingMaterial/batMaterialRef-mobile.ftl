...
<script type="text/javascript">
	CUI.ns("WOM.batchingMaterial.batchingMaterial","WOM.batchingMaterial.batchingMaterial.batMaterialRef");
</script>
<div class="container"  style="padding-top:10px;">
	...
	<div id="ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_queryForm_inputValue">
	...
	<form onsubmit="return false" id="ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_queryForm" exportUrl="/WOM/batchingMaterial/batchingMaterial/batMaterialRef-pending.action">
		...
		<input type="hidden" id="dataTableSortColOrder" name="dataTableSortColOrder" />
						<@quickquery unique="LAST_QUERY_ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_queryForm" formId="ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_queryForm" idprefix="ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef" expandType="all" expand=true fieldcodes="WOM_7_5_0_0_batchingMaterial_BatchingMaterial_tableNo_tableNo:ec.common.tableNo||WOM_7_5_0_0_produceTask_ProduceTask_tableNo_taskID_tableNo:WOM.propertydisplayName.randon1490613814833||MESBasic_1_product_Product_productCode_productId_productCode:WOM.propertydisplayName.radion141577264483344556||base_staff_name_orderStaff_name:WOM.staff.dimissionStaff_xls.staffName334||WOM_7_5_0_0_batchingMaterial_BatchingMaterial_arriveTime_arriveTime:WOM.propertydisplayName.randon1491789966310" >
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
											...
											<input type="hidden" id="taskID.id" name="taskID.id" value="" />
												<@mneclient mneenable=false isPrecise=true isCrossCompany=isCrossCompany reftitle="${getText('WOM.viewtitle.randon1489737198145')}"  conditionfunc="WOM.batchingMaterial.batchingMaterial.batMaterialRef._querycustomFunc('taskID_tableNo')" name="taskID.tableNo" id="ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_queryForm_taskID_tableNo" displayFieldName="tableNo" type="other" exp="like" classStyle="form-control" url="/WOM/produceTask/produceTask/taskRef.action" clicked=true multiple=false mnewidth=260 formId="ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_queryForm" searchClick="WOM.batchingMaterial.batchingMaterial.batMaterialRef.commonQuery('query')" />
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
											...
											<input type="hidden" id="productId.id" name="productId.id" value="" />
												<@mneclient mneenable=true isPrecise=true isCrossCompany=isCrossCompany reftitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  conditionfunc="WOM.batchingMaterial.batchingMaterial.batMaterialRef._querycustomFunc('productId_productCode')" name="productId.productCode" id="ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_queryForm_productId_productCode" displayFieldName="productCode" type="other" exp="like" classStyle="form-control" url="/MESBasic/product/product/productRefNew.action" clicked=true multiple=false mnewidth=260 formId="ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_queryForm" searchClick="WOM.batchingMaterial.batchingMaterial.batMaterialRef.commonQuery('query')" />
							...
							<div  field-unique-code="base_staff_name_orderStaff_name" class="mobi-dropdown col-xs-12 col-sm-6 col-md-4 col-lg-4 <#if (lastQuery.value)?? && lastQuery.value == "base_staff_name_orderStaff_name">mobi-dropdown-active</#if>"> 
								<div class="row">
									<div class="col-xs-12 col-sm-3 col-md-4  col-lg-4 mobi-dropdown-label"><label class="label-wd">
										${getText('WOM.staff.dimissionStaff_xls.staffName334')}
									</label></div>
									<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
									
											<input type="hidden" id="orderStaff.id" name="orderStaff.id" value="" />
												<#if (orderStaff_name_defaultValue)=='currentUser'>
													<@mneclient mneenable=true isPrecise=true isCrossCompany=isCrossCompany value="${Session.staff.name}" deValue="currentUser" reftitle="${getText('foundation.ec.entity.view.reference')}"  conditionfunc="WOM.batchingMaterial.batchingMaterial.batMaterialRef._querycustomFunc('orderStaff_name')" name="orderStaff.name" id="ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_queryForm_orderStaff_name" displayFieldName="name" type="Staff" exp="like" classStyle="form-control" url="/foundation/staff/common/staffListFrameset.action" clicked=true multiple=false mnewidth=260 formId="ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_queryForm" searchClick="WOM.batchingMaterial.batchingMaterial.batMaterialRef.commonQuery('query')" />
													<script type="text/javascript">
													(function($){
														$(function(){
												...
												<#else>
													<@mneclient mneenable=true isPrecise=true isCrossCompany=isCrossCompany reftitle="${getText('foundation.ec.entity.view.reference')}"  conditionfunc="WOM.batchingMaterial.batchingMaterial.batMaterialRef._querycustomFunc('orderStaff_name')" name="orderStaff.name" id="ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_queryForm_orderStaff_name" displayFieldName="name" type="Staff" exp="like" classStyle="form-control" url="/foundation/staff/common/staffListFrameset.action" clicked=true multiple=false mnewidth=260 formId="ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_queryForm" searchClick="WOM.batchingMaterial.batchingMaterial.batMaterialRef.commonQuery('query')" />
												</#if>
							...
							<div mobi-dropdown-group="arriveTime" field-unique-code="WOM_7_5_0_0_batchingMaterial_BatchingMaterial_arriveTime_arriveTime" class="mobi-dropdown col-xs-12 col-sm-6 col-md-4 col-lg-4 <#if (lastQuery.value)?? && lastQuery.value == "WOM_7_5_0_0_batchingMaterial_BatchingMaterial_arriveTime_arriveTime">mobi-dropdown-active</#if>"> 
								<div class="row">
									...
									<div class="input-group">
										...
										<@datepicker type="dateTime" cssClass="form-control right-border-radius" value="${arriveTime_defaultValue!}" deValue="${arriveTime_defaultValue!}"  name="arriveTime_start" id="arriveTime_start" exp="gequal"   formid="ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_queryForm" />
									</div>
								</div>			
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
									<div class="input-group">
										...
										<@datepicker type="dateTime" cssClass="form-control right-border-radius" value="${arriveTime_defaultValue!}" deValue="${arriveTime_defaultValue!}"  name="arriveTime_end" id="arriveTime_end" exp="lequal"   formid="ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_queryForm" />
									</div>
									</div>			
								</div>
							</div>
						<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 margin-bottom-5">						
				       	<@querybutton formId="ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_queryForm" type="search" onclick="WOM.batchingMaterial.batchingMaterial.batMaterialRef.commonQuery('query')" /> 
...
<script>
	$(function(){
		var buttons = $( 'button.btn-list', '#ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_queryForm' );
		if( buttons.length > 0 ){
			// 去掉按钮间的空格
...
ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_quickquery_info["productId.id"].columnName="ID";
...
<@datatable id="ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_query" renderOverEvent="ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_RenderOverEvent"  modelCode="WOM_7.5.0.0_batchingMaterial_BatchingMaterial" noPermissionKeys="tableNo,orderStaff.name,createTime,taskID.tableNo,productId.productCode,productId.productName,needPartId.offerSystem,needNum,doneNum,arriveTime,remark" hidekeyPrefix="ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_query" orderMode="backstage" queryFunc=datatable_queryFunc formId="ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_queryForm" firstLoad=datatable_firstLoad  exportExcel=true style="margin-left:13px;margin-right:4px;" editable=false dtPage="page" dataUrl=datatable_dataUrl transMethod="post" hidekey="['id','version','needPartId.offerSystem.id','orderStaff.id','taskID.id','productId.id','needPartId.id']" postData="&${(condition!'')}&permissionCode=${permissionCode!''}">
	<#if (Session['touchScreen']?? && Session['touchScreen']??)>
			...
			<@datacolumn   showFormat="TEXT" defaultDisplay="${taskID_tableNo_displayDefaultType!}"  key="taskID.tableNo"   label="${getText('WOM.propertydisplayName.randon1490605002360')}" textalign="center"  width=150   type="textfield"    click="function(cell){WOM.batchingMaterial.batchingMaterial.batMaterialRef.showLinkView('/WOM/produceTask/produceTask/makeTaskView.action?${getPowerCode('','WOM_7.5.0.0_produceTask_makeTaskView')}','taskID.id',cell)}" showFormatFunc=""/>
...
<script type="text/javascript">
	 ...
	 */
	WOM.batchingMaterial.batchingMaterial.batMaterialRef.query = function(type,pageNo){
		...
		if(!checkListValid("ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_queryForm")) {
				return false;
		}
		var dataPost = "";
		...
		url += "&crossCompanyFlag=${Parameters.crossCompanyFlag!}";
	 	datatable_ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_query.setRequestDataUrl(url,dataPost);
		return false;
	};
	...
	foundation.common.${requestUri!}__callbackFunction = function(){
		...
		var oRows = datatable_ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_query.getSelectedRow();
		if(oRows.length == 0){
		...
		try{
			if(CUI("#WOM_batchingMaterial_batchingMaterial_batMaterialRef_callBackFuncName").val() != ""){
				eval(CUI("#WOM_batchingMaterial_batchingMaterial_batMaterialRef_callBackFuncName").val() + "(arrObj)");
			}
		}catch(e){
		}
	};
...
WOM_batchingMaterial_batchingMaterial_batMaterialRef_refresh = function(node){
	//var url = "/WOM/batchingMaterial/batchingMaterial/batMaterialRef-query.action";
	//if(node.layRec){
	//	datatable_ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_query.setRequestDataUrl(url,'&'+node.modelName+'.layRec=' + node.layRec,false);
	//}else{
	//	datatable_ec_WOM_batchingMaterial_batchingMaterial_batMaterialRef_query.setRequestDataUrl(url,'',false);
	//}
...
WOM.batchingMaterial.batchingMaterial.batMaterialRef.showLinkView = function(url,propertyId,row,formId,title,width,height,dialogType){
	...
	if(formId) {
		WOM.batchingMaterial.batchingMaterial.batMaterialRef.showDialog(url,formId,title,width,height);
	}else {
		openFullScreen(url);
	}
};
...
function checkListValid(formId){if($('#' + formId + ' input[name^="arriveTime_start"]').val()!= null && $('#' + formId + ' input[name^="arriveTime_start"]').val()!= ''){if(!isDateTime($('#' + formId + ' input[name^="arriveTime_start"]').val()+"")){workbenchErrorBarWidget.showMessage("${getText('WOM.propertydisplayName.randon1491789966310')}${getText('ec.list.validate.datetime')}");return false;}}if($('#' + formId + ' input[name^="arriveTime_end"]').val()!= null && $('#' + formId + ' input[name^="arriveTime_end"]').val()!= ''){if(!isDateTime($('#' + formId + ' input[name^="arriveTime_end"]').val()+"")){workbenchErrorBarWidget.showMessage("${getText('WOM.propertydisplayName.randon1491789966310')}${getText('ec.list.validate.datetime')}");return false;}}if($('#' + formId + ' input[name="arriveTime_start"]').val()!='' && $('#' + formId + ' input[name="arriveTime_end"]').val()!=''){if($('#' + formId + ' input[name="arriveTime_start"]').val() > $('#' + formId + ' input[name="arriveTime_end"]').val()){workbenchErrorBarWidget.showMessage("${getText('WOM.propertydisplayName.randon1491789966310')}${getText('ec.list.validate.end')}${getText('ec.list.validate.compare')}${getText('WOM.propertydisplayName.randon1491789966310')}${getText('ec.list.validate.start')}");return false;}}return true;};
	...
	/* CUSTOM CODE START(view-REFERENCE-WOM_7.5.0.0_batchingMaterial_batMaterialRef,js,WOM_7.5.0.0_batchingMaterial_BatchingMaterial,WOM_7.5.0.0) */
// 自定义代码
/* CUSTOM CODE END */
	</script>
  </body>
