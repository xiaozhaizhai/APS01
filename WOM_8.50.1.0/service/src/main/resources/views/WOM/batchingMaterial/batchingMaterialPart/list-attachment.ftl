...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=WOM_7.5.0.0_batchingMaterial";
	openExportFrame(url);
}
...
<div id="WOM_batchingMaterial_batchingMaterialPart_batMaterialPartList_attachment">	
