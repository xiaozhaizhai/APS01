...
<#assign viewCode = 'WOM_7.5.0.0_batchingMaterial_BatchingRejectParts' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		<Style ss:ID="batchingId.tableNo">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		...
	  		<Style ss:ID="rejectReceiveStaff.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											<#if item == 'batchingId.tableNo' || item == '*'>
											...
											<#if item == 'ware.cargoStatue.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
											...
											<#if item == 'rejectReceiveStaff.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											...
											<#if item == 'batchingPartId.state.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
															<Column ss:Index="${count}" ss:StyleID="${item?substring(0,item?last_index_of('.'))}"  ss:Width="140"/>
														 <#else>
														    <Column ss:Index="${count}" ss:StyleID="${item}"  ss:Width="140" />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchingId.tableNo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.201811291406')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'produceTaskId.tableNo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.201811291328001')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1543236260606')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'produceTaskId.factoryId.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.201811291328')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'produceTaskId.productId.productName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.201811291330')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'rejectProduct.productCode' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productBatchNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1543236355408')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'rejectNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1543236406431')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'rejectReasonId.rejectReson' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1543218783588')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'ware.wareCode' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'store.placeSetCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1489731651449')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'store.placeSetName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1489731677162')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'rejectExeStaff.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.201811291408')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'rejectTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1543392762311')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isReceived' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1543236313796')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'rejectReceiveStaff.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.201811291408')}</Data></Cell>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'receiveDate' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1543236378702')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchingPartId.state.value' || item == '*'>
									...
									<#if item?length gt 0>
												<#if item == 'batchingId.tableNo' || item == '*'>
													<Cell>
														...
														<#if data.batchingId.tableNo??><Data ss:Type="String"><![CDATA[${(data.batchingId.tableNo)!}]]></Data></#if>
												...
												<#if item == 'produceTaskId.tableNo' || item == '*'>
													<Cell>
														...
														<#if data.produceTaskId.tableNo??><Data ss:Type="String"><![CDATA[${(data.produceTaskId.tableNo)!}]]></Data></#if>
												...
												<#if item == 'produceTaskId.factoryId.name' || item == '*'>
													<Cell>
														...
														<#if data.produceTaskId.factoryId.name??><Data ss:Type="String"><![CDATA[${(data.produceTaskId.factoryId.name)!}]]></Data></#if>
												...
												<#if item == 'produceTaskId.productId.productName' || item == '*'>
													<Cell>
														...
														<#if data.produceTaskId.productId.productName??><Data ss:Type="String"><![CDATA[${(data.produceTaskId.productId.productName)!}]]></Data></#if>
												...
												<#if item == 'rejectProduct.productCode' || item == '*'>
													<Cell>
														...
														<#if data.rejectProduct.productCode??><Data ss:Type="String"><![CDATA[${(data.rejectProduct.productCode)!}]]></Data></#if>
												...
												<#if item == 'rejectProduct.productName' || item == '*'>
													<Cell>
														...
														<#if data.rejectProduct.productName??><Data ss:Type="String"><![CDATA[${(data.rejectProduct.productName)!}]]></Data></#if>
												...
												<#if item == 'rejectReasonId.rejectReson' || item == '*'>
													<Cell>
														...
														<#if data.rejectReasonId.rejectReson??><Data ss:Type="String"><![CDATA[${(data.rejectReasonId.rejectReson)!}]]></Data></#if>
												...
												<#if item == 'ware.wareCode' || item == '*'>
													<Cell>
														...
														<#if data.ware.wareCode??><Data ss:Type="String"><![CDATA[${(data.ware.wareCode)!}]]></Data></#if>
												...
												<#if item == 'ware.wareName' || item == '*'>
													<Cell>
														...
														<#if data.ware.wareName??><Data ss:Type="String"><![CDATA[${(data.ware.wareName)!}]]></Data></#if>
												...
												<#if item == 'store.placeSetCode' || item == '*'>
													<Cell>
														...
														<#if data.store.placeSetCode??><Data ss:Type="String"><![CDATA[${(data.store.placeSetCode)!}]]></Data></#if>
												...
												<#if item == 'store.placeSetName' || item == '*'>
													<Cell>
														...
														<#if data.store.placeSetName??><Data ss:Type="String"><![CDATA[${(data.store.placeSetName)!}]]></Data></#if>
												...
												<#if item == 'rejectExeStaff.name' || item == '*'>
													<Cell>
														...
														<#if data.rejectExeStaff.name??><Data ss:Type="String"><![CDATA[${(data.rejectExeStaff.name)!}]]></Data></#if>
												...
												<#if item == 'rejectTime' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.rejectTime??><Data ss:Type="DateTime">${(data.rejectTime)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
												...
												<#if item == 'isReceived' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.isReceived?? && data.isReceived>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'rejectReceiveStaff.name' || item == '*'>
													<Cell>
														...
														<#if data.rejectReceiveStaff.name??><Data ss:Type="String"><![CDATA[${(data.rejectReceiveStaff.name)!}]]></Data></#if>
