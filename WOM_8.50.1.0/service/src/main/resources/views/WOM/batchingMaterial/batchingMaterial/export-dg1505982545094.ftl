 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0 && item != "checkbox">
									...
									<#if item == 'headId.id' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'factoryId.name' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'factoryId.area.value' || item == 'factoryId.area.id' || item == '*'>
									...
									<#if item == 'taskID.id' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'tableInfoId' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'offerSystem.value' || item == 'offerSystem.id' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item?split('.')[0]}"/>
									</#if>
									<#if item == 'needPartId.id' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
 						<#assign count = count + 1>
						</#if>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								...
								<#if item == 'factoryId.area.value' || item == 'factoryId.area.id' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1489991460442')}</Data>
										</Cell>
								</#if>
								<#if item == 'factoryId.id' || item == '*'>
										<Cell>
								...
								<#if item == 'offerSystem.value' || item == 'offerSystem.id' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1491978940082')}</Data>
										</Cell>
								</#if>
								<#if item == 'needPartId.id' || item == '*'>
										<Cell>
					...
					<#if item?length gt 0>
								...
								<#if item == 'headId.id' || item == '*'>
									<Cell>
										...
										<Data ss:Type="Number"><#if (data.headId.id)??>${(data.headId.id)!}</#if></Data>
								...
								<#if item == 'factoryId.area.value' || item == 'factoryId.area.id' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String">${getText('${(data.factoryId.area.value)!}')}</Data>
								...
								<#if item == 'taskID.id' || item == '*'>
									<Cell>
										...
										<Data ss:Type="Number"><#if (data.taskID.id)??>${(data.taskID.id)!}</#if></Data>
								...
								<#if item == 'needPartId.id' || item == '*'>
									<Cell>
										...
										<Data ss:Type="Number"><#if (data.needPartId.id)??>${(data.needPartId.id)!}</#if></Data>
