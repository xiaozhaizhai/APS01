<!-- WOM_7.5.0.0/produceTask/recycleTaskView -->
...
<#-- 命名空间 -->
<#assign editPageNs = "WOM.produceTask.produceTask.recycleTaskView">
<#-- 模型名称-->
<#assign modelName = "produceTask">
<#-- 视图编码-->
<#assign viewCode = "WOM_7.5.0.0_produceTask_recycleTaskView">
<#-- 实体编码-->
<#assign entity_code = "WOM_7.5.0.0_produceTask">
<#-- 视图名称-->
<#assign viewName = "recycleTaskView">
<#-- datagrid编码-->
<#assign datagridCode = "WOM_produceTask_produceTask_recycleTaskView_datagrids">
<#-- 首字母大写的模型名称-->
...
<#-- formid -->
<#assign editFormId = "WOM_produceTask_produceTask_recycleTaskView_form">
<#-- 待办状态 -->
...
<head>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <#assign configTitle = getText('WOM.viewtitle.randon1505456675560')>
		...
		#WOM_produceTask_produceTask_recycleTaskView_form{float:left;width:100%;}
		
		
		</style>
		<script type="text/javascript">
			CUI.ns('WOM.produceTask.produceTask.recycleTaskView');
			WOM.produceTask.produceTask.recycleTaskView.currentUser = ${userJson};
			WOM.produceTask.produceTask.recycleTaskView.currentStaff = ${staffJson};
			WOM.produceTask.produceTask.recycleTaskView.currentDepartment = ${deptJson};
			WOM.produceTask.produceTask.recycleTaskView.currentPosition = ${postJson};
			WOM.produceTask.produceTask.recycleTaskView.currentCompany = ${compJson};
		</script>
		<!-- CUSTOM CODE START(view-VIEW-WOM_7.5.0.0_produceTask_recycleTaskView,head,WOM_7.5.0.0_produceTask_ProduceTask,WOM_7.5.0.0) -->
<!-- 自定义代码 -->
...
<!-- CUSTOM CODE END -->
	...
	<body class="view-edit ">
		...
		<@s.form errorBarId="workbenchErrorBar" hiddenField="produceTask.factoryId.id,produceTask.formularId.id,produceTask.id,produceTask.productId.id,produceTask.planParId.id," onsubmitMethod="WOM.produceTask.produceTask.recycleTaskView.beforeSubmitMethod()" id="WOM_produceTask_produceTask_recycleTaskView_form" namespace="/WOM/produceTask/produceTask/recycleTaskView" action="submit?__pc__=${(Parameters.__pc__)!}&_bapFieldPermissonModelCode_=WOM_7.5.0.0_produceTask_ProduceTask&_bapFieldPermissonModelName_=ProduceTask&superEdit=${(superEdit!false)?string}" editPageNs="WOM.produceTask.produceTask.recycleTaskView" callback="WOM.produceTask.produceTask.recycleTaskView._callBackInfo" ecform="true">
			<input type="hidden" name="bap_validate_user_id" value="${(Session.user.id)!}" />
			<div style="float:none;width:auto;" class="edit-main grid-s5m0 col-main main-wrap" id="WOM_produceTask_produceTask_recycleTaskView_main_div">
			<div class="edit-head">
				<#include "../../../ec/tableInfo/operateheadbar_all.ftl" >
				<#include "../../../ec/tableInfo/creatorInfo.ftl" >
			</div>
    		<div class="edit-main" id="WOM_produceTask_produceTask_recycleTaskView">
...
<script type="text/javascript">
var attcountid = "WOM_produceTask_produceTask_recycleTaskView_form"+"_attcount";
	...
	<table class="edit-table" style="">
		...
		<tr >
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
									...
									<@mneclient iframe=mneIframe!false property_type="TEXT" mneenable=false reftitle="${getText('WOM.viewtitle.randon1489823707131')}" viewType="${viewType!}" deValue="${produceTask_planParId_dayPlanInfo_tableNo_defaultValue!}" conditionfunc="WOM.produceTask.produceTask.recycleTaskView._querycustomFunc('produceTask_planParId_dayPlanInfo_tableNo')" view=true  value="${(produceTask.planParId.dayPlanInfo.tableNo)!}" displayFieldName="tableNo" name="produceTask.planParId.dayPlanInfo.tableNo" id="produceTask_planParId_dayPlanInfo_tableNo" type="other" url="/WOM/producePlanRef/dayBatchPlanParts/planRef.action" clicked=true multiple=false mnewidth=260 formId="WOM_produceTask_produceTask_recycleTaskView_form" editCustomCallback="setOtherValue(obj);" refViewCode="WOM_7.5.0.0_producePlanRef_planRef"  onkeyupfuncname="setOtherValue(obj);_callback_produceTask_planParId_dayPlanInfo_tableNo(obj);" cssStyle="" isEdit=true   isCrossCompany=false  />
								...
								<#if !(produceTask.id)?? && (produceTask.planParId.dayPlanInfo.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('WOM_produceTask_produceTask_recycleTaskView_form',obj, 'produceTask.planParId.dayPlanInfo', '/WOM/producePlanRef/dayBatchPlanParts/planRef.action');
												CUI.commonFills('WOM_produceTask_produceTask_recycleTaskView_form', 'produceTask.planParId.dayPlanInfo',obj,true);
											}
										});
									})(jQuery);
								</#if>
								
									WOM.produceTask.produceTask.recycleTaskView.query_produceTask_planParId_dayPlanInfo_tableNo = function() {
								...
								<#if !(produceTask.id)?? && (produceTask.productId.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('WOM_produceTask_produceTask_recycleTaskView_form',obj, 'produceTask.productId', '/MESBasic/product/product/refProductLayout.action');
												CUI.commonFills('WOM_produceTask_produceTask_recycleTaskView_form', 'produceTask.productId',obj,true);
											}
										});
									})(jQuery);
								</#if>
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
						...
						<#assign produceTask_taskType_defaultValue  = 'womTaskType/type4'>
								...
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${produceTask_taskType_defaultValue!}" formId="WOM_produceTask_produceTask_recycleTaskView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.taskType.id" code="womTaskType" value="${(produceTask.taskType.id)!}"  />
									
								<#else>
									
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="WOM_produceTask_produceTask_recycleTaskView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.taskType.id" code="womTaskType" value="${(produceTask.taskType.id)!}"  />
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
									...
									<@mneclient iframe=mneIframe!false property_type="BAPCODE" reftitle="${getText('RM.viewtitle.randon1505377270901')}" viewType="${viewType!}" deValue="${produceTask_formularId_code_defaultValue!}" conditionfunc="WOM.produceTask.produceTask.recycleTaskView._querycustomFunc('produceTask_formularId_code')" view=true  value="${(produceTask.formularId.code)!}" displayFieldName="code" name="produceTask.formularId.code" id="produceTask_formularId_code" type="other" url="/RM/formula/formula/formulaResysleRef.action" clicked=true multiple=false mnewidth=260 formId="WOM_produceTask_produceTask_recycleTaskView_form" editCustomCallback="_callback_produceTask(obj);" refViewCode="RM_7.5.0.0_formula_formulaResysleRef" onkeyupfuncname="_callback_produceTask(obj);_callback_produceTask_formularId_code(obj);" cssStyle="" isEdit=true     isCrossCompany=false  />
								...
								<#if !(produceTask.id)?? && (produceTask.formularId.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('WOM_produceTask_produceTask_recycleTaskView_form',obj, 'produceTask.formularId', '/RM/formula/formula/formulaResysleRef.action');
												CUI.commonFills('WOM_produceTask_produceTask_recycleTaskView_form', 'produceTask.formularId',obj,true);
											}
										});
									})(jQuery);
								</#if>
								
									WOM.produceTask.produceTask.recycleTaskView.query_produceTask_formularId_code = function() {
								...
								<#if !(produceTask.id)?? && (produceTask.factoryId.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('WOM_produceTask_produceTask_recycleTaskView_form',obj, 'produceTask.factoryId', '/MESBasic/factoryModel/factoryModel/factoryProBatchRef.action');
												CUI.commonFills('WOM_produceTask_produceTask_recycleTaskView_form', 'produceTask.factoryId',obj,true);
											}
										});
									})(jQuery);
								</#if>
								
									WOM.produceTask.produceTask.recycleTaskView.query_produceTask_factoryId_name = function() {
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
							...
							<div class="fix-input-readonly">
								<input property_type="INTEGER" name="produceTask.recycleTime" id="produceTask_recycleTime"  style=";" originalvalue="<#if !newObj || (produceTask.recycleTime)?has_content>${(produceTask.recycleTime?html)!}<#else>${produceTask_recycleTime_defaultValue!}</#if>" value="<#if !newObj || (produceTask.recycleTime)?has_content>${(produceTask.recycleTime?html)!}<#else>${produceTask_recycleTime_defaultValue!}</#if>" type="text" class="cui-noborder-input numberField" readonly="readonly" />
							</div>
							<script type="text/javascript">
							</script>
		...
		<#assign cpvmInfo = ''>
			<#assign customPropList = getShowCustomProps("WOM_7.5.0.0_produceTask_ProduceTask", "WOM_7.5.0.0_produceTask_recycleTaskView", 'EDIT')>
				...
				<td nullable=<#if (c.nullable!false)>true<#else>false</#if> class="edit-table-content" <#if c.fieldType?? && c.fieldType == 'DATATIME'>celltype="DATATIME"</#if> <#if cspan gt 1>colspan="${colspanVal}"</#if> style="text-align:left;">
					...
					<#elseif fieldType == 'SELECTCOMP'>
						<#if columnType == 'SYSTEMCODE'>
							...
							<@systemcode property_type="${columnType}" iscustom=true showType="${fieldType}" viewType=viewType cssStyle="text-align:${c.align!}" formId="WOM_produceTask_produceTask_recycleTaskView_form" classStyle="cui-noborder-input" view=true cssStyle="" ecFlag=true multable=isMultable name="${elementName}" code="${(c.property.fillcontentMap.fillContent)!}" value="${produceTask[columnName]!}" seniorSystemCode=isS2 />
						<#else>
		...
		<tr >
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;display:none;" >
								...
								<#else>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="WOM_produceTask_produceTask_recycleTaskView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.formularId.setProcess.id" code="formulaProperty" value="${(produceTask.formularId.setProcess.id)!}"  />
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
								...
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${produceTask_workType_defaultValue!}" formId="WOM_produceTask_produceTask_recycleTaskView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.workType.id" code="produceType" value="${(produceTask.workType.id)!}"  />
									
								<#else>
									
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="WOM_produceTask_produceTask_recycleTaskView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.workType.id" code="produceType" value="${(produceTask.workType.id)!}"  />
...
<#assign colAdmFlag=checkUserPermisition('ec_ptManage_list_view')>
			...
			<#assign cpObjHideKey = '' >
			<#assign cpvmInfo = ''>
								<#assign customPropViewMappings = getShowCustomProps("WOM_7.5.0.0_produceTask_ProduceTaskActive", "WOM_7.5.0.0_produceTask_recycleTaskViewdg1505456701981", "DATAGRID", "produceTaskActive")>
								...
								<script type="text/javascript">
									function ProduceTaskActive_dg1505456701981_addNewRow(event)
																		{
	...
	ProduceTaskActive_dg1505285519610Widget._DT._initDomElements();
								...
								<script type="text/javascript">
									function ProduceTaskActive_dg1505456701981_copyNewRowDataFunc(event)
																		{
	//获得选中行
	...
	CUI.Dialog.confirm("${getText('WOM.confirmcontent.radion1504182834291')}",
		...
		workbenchErrorBarWidget.showMessage("${getText('WOM.showMessage00000013')}");
			...
			<#if  refId?? && (refId > 0)>
				<#assign dUrl="/WOM/produceTask/produceTask/data-dg1505456701981.action?produceTask.id=${refId!-1}&refId=${refId!-1}&datagridCode=WOM_7.5.0.0_produceTask_recycleTaskViewdg1505456701981">
			<#else>
				<#assign dUrl="/WOM/produceTask/produceTask/data-dg1505456701981.action?produceTask.id=${(produceTask.id)!-1}&datagridCode=WOM_7.5.0.0_produceTask_recycleTaskViewdg1505456701981">
			</#if>
			<#assign firstLoad = true>
				
			<#if viewType?? && viewType != "readonly" && newObj?? && !newObj && !(refId?? && (refId > 0))>
				<#assign buttons="[{text:\"${getText('ec.view.deleteline')}\",iconClass:\"cui-btn-del\",useInMore:\"false\",handler:function(event){DT_ProduceTaskActive_dg1505456701981_deldatagrid();}},{text:\"${getText('WOM.buttonPropertyshowName.radion1505441258642')}\",handler:function(event){ProduceTaskActive_dg1505456701981_addNewRow(event)},iconClass:\"cui-btn-add\",useInMore:\"false\"},{text:\"${getText('WOM.buttonPropertyshowName.radion1503995839036')}\",handler:function(event){ProduceTaskActive_dg1505456701981_copyNewRowDataFunc(event)},iconClass:\"cui-btn-add\",useInMore:\"false\"}]">
			...
			<#else>
				...
				<#if cpvmInfo?? && cpvmInfo?length gt 0>
					<#assign cpvmInfo = cpvmInfo?substring(1)>
					<input type="hidden" id="dg_cp_info_ProduceTaskActive_dg1505456701981" value="${cpvmInfo!}" />
				</#if>
			
			<input type="hidden" id="dg1505456701981_id" value="ProduceTaskActive_dg1505456701981" />
			
			<input type="hidden" id="dg1505456701981_url" value="${dUrl}" />
			
			<#assign assModelDisplayName = getText('WOM.modelname.randon1489671093316')!>
			<#assign assModelDisplayName = assModelDisplayName + getText('ec.common.validate.colon') >
			<@exportexcel action="/WOM/produceTask/produceTask/data-dg1505456701981.action?operateType=export&datagridCode=WOM_7.5.0.0_produceTask_recycleTaskViewdg1505456701981"  settingtext="" settingUrl="" prepareParams="" formId="" look="text" width=250 height=170 text="" exportPageChoose=0 dtPage="dgPage" prefix="ProduceTaskActive_dg1505456701981" />
			<@datagrid colAdminFlag=colAdmFlag withoutConfigTable=true id="ProduceTaskActive_dg1505456701981" viewType="${viewType}" renderOverEvent="dg1505456701981RenderOverEvent" route="${routeFlag}" formId="WOM_produceTask_produceTask_recycleTaskView_form" noPermissionKeys="productId.productCode,productId.id,productId.productName,activeType,property,standardNum,planNum,productId.productBaseUnit.name,isMixQuality,phase,sequence,needWeigh,batchNumObj.batchText,minQuality,maxQuality,lossRate,remark,batchNumObj.id,orderProcessId.id,activeId.id,formulaId.id,processId.id,putBatMateId.id" modelCode="WOM_7.5.0.0_produceTask_ProduceTaskActive" dataUrl="${dUrl}" postData="&dgPage.pageSize=65536" dataGridName="dg1505456701981" dtPage="dgPage"  hidekeyPrefix="dg1505456701981" hidekey="['id','version','productId.id','productId.productCode','productId.id','productId.id','productId.id','productId.productName','productId.id','productId.productBaseUnit.name','batchNumObj.id','batchNumObj.batchText','batchNumObj.id','batchNumObj.id','orderProcessId.id','orderProcessId.id','activeId.id','activeId.id','formulaId.id','formulaId.id','processId.id','processId.id','putBatMateId.id','putBatMateId.id'${cpObjHideKey!''}]" transMethod="post" paginator=false editable=false  buttons="${buttons}" noPadding=true isEdit=true tabViewIndex=0 pageInitMethod="dg1505456701981PageInitMethod"  defaultNodeExpanded=nodeExpanded  cannotAddNewRow=false cannotDeleteRow=true assModelDisplayName=assModelDisplayName dgTitle="${getText('WOM.dataGriddataGridName.radion1490443916302')}" activexButton="WOM.buttonPropertyshowName.radion1505441258642,addNewRow,add;WOM.buttonPropertyshowName.radion1503995839036,copyNewRowDataFunc,add" exportExcel=exportExcel addNewRow=true   canInsertRow=false  insertRowAble=true firstLoad=firstLoad  copyRow=false  copyColumn=false  ptRealTimeLoad=0 >		
							...
							<#elseif (productId_productCode_defaultValue!)?string=="currentComp">
								<#assign productId_productCode_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.productCode"        showFormat="SELECTCOMP" defaultValue="${(productId_productCode_defaultValue!)?string}" defaultDisplay="${(productId_productCode_displayDefaultType!)?string}" decimal="" editable=false type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.recycleTaskView"  textalign="left"  viewUrl="/MESBasic/product/product/refProductLayout.action" viewCode="MESBasic_1_product_refProductLayout" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1450085069587')}"  label="${getText('WOM.propertydisplayName.radion14157726448331')}" width=100 showFormatFunc=""  />
							...
							<#elseif (productId_id_defaultValue!)?string=="currentComp">
								<#assign productId_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.id"        showFormat="TEXT" defaultValue="${(productId_id_defaultValue!)?string}" defaultDisplay="${(productId_id_displayDefaultType!)?string}" decimal="" editable=false type="long" showType="long" notnull=false   selectCompName="WOM.produceTask.produceTask.recycleTaskView"  textalign="center" hiddenCol=true viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('MESBasic.propertydisplayName.randon1449796384550')}" width=100 showFormatFunc=""  />
							...
							<#elseif (productId_productName_defaultValue!)?string=="currentComp">
								<#assign productId_productName_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.productName"        showFormat="TEXT" defaultValue="${(productId_productName_defaultValue!)?string}" defaultDisplay="${(productId_productName_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="WOM.produceTask.produceTask.recycleTaskView"  textalign="left"  viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('WOM.propertydisplayName.radion1415772740737455')}" width=100 showFormatFunc=""  />
							...
							<#elseif (productId_productBaseUnit_name_defaultValue!)?string=="currentComp">
								<#assign productId_productBaseUnit_name_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.productBaseUnit.name"        showFormat="TEXT" defaultValue="${(productId_productBaseUnit_name_defaultValue!)?string}" defaultDisplay="${(productId_productBaseUnit_name_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="WOM.produceTask.produceTask.recycleTaskView"  textalign="left"  viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('WOM.propertydisplayName.radion1398235640483')}" width=60 showFormatFunc=""  />
							...
							<#elseif (batchNumObj_batchText_defaultValue!)?string=="currentComp">
								<#assign batchNumObj_batchText_defaultValue='${compJson!}'>
									...
									<@datacolumn key="batchNumObj.batchText"        showFormat="TEXT" defaultValue="${(batchNumObj_batchText_defaultValue!)?string}" defaultDisplay="${(batchNumObj_batchText_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="WOM.produceTask.produceTask.recycleTaskView"  textalign="left"  viewUrl="/WOM/standingcropRef/standingcropRef/batchNumOneMakeTask.action" viewCode="WOM_7.5.0.0_standingcropRef_batchNumOneMakeTask" mneenable=false crossCompany=false viewTitle="${getText('WOM.viewtitle.randon1503994294075')}"  label="${getText('WOM.propertydisplayName.randon1490064501469')}" width=100 showFormatFunc=""  />
								...
								<#else>
									...
									<#if cpvmColumnType == 'OBJECT'>
										<#if cpvm.refView??>
											...
											<#assign selectCompName = 'WOM.produceTask.produceTask.recycleTaskView'>
										</#if>
										<#assign pkName = ''>
										<#assign mainDisplayName = ''>
							...
							<#elseif (batchNumObj_id_defaultValue!)?string=="currentComp">
								<#assign batchNumObj_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="batchNumObj.id"        showFormat="TEXT" defaultValue="${(batchNumObj_id_defaultValue!)?string}" defaultDisplay="${(batchNumObj_id_displayDefaultType!)?string}" decimal="" editable=false type="long" showType="long" notnull=false   selectCompName="WOM.produceTask.produceTask.recycleTaskView"  textalign="center" hiddenCol=true viewUrl="/WOM/standingcropRef/standingcropRef/batchNumOneBatRef.action" viewCode="WOM_7.5.0.0_standingcropRef_batchNumOneBatRef" mneenable=false crossCompany=false viewTitle="${getText('WOM.viewtitle.randon1502607384728')}"  label="${getText('ec.common.ID')}" width=100 showFormatFunc=""  />
							...
							<#elseif (orderProcessId_id_defaultValue!)?string=="currentComp">
								<#assign orderProcessId_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="orderProcessId.id"        showFormat="TEXT" defaultValue="${(orderProcessId_id_defaultValue!)?string}" defaultDisplay="${(orderProcessId_id_displayDefaultType!)?string}" decimal="" editable=false type="long" showType="long" notnull=false   selectCompName="WOM.produceTask.produceTask.recycleTaskView"  textalign="center" hiddenCol=true viewUrl="/WOM/produceTask/produceTaskProcess/taskProcessRef.action" viewCode="WOM_7.5.0.0_produceTask_taskProcessRef" mneenable=false crossCompany=false viewTitle="${getText('WOM.viewtitle.randon1490685207348')}"  label="${getText('ec.common.ID')}" width=100 showFormatFunc=""  />
							...
							<#elseif (activeId_id_defaultValue!)?string=="currentComp">
								<#assign activeId_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="activeId.id"        showFormat="TEXT" defaultValue="${(activeId_id_defaultValue!)?string}" defaultDisplay="${(activeId_id_displayDefaultType!)?string}" decimal="" editable=false type="long" showType="long" notnull=false   selectCompName="WOM.produceTask.produceTask.recycleTaskView"  textalign="center" hiddenCol=true viewUrl="/RM/formula/formulaProcessActive/activeCheckRef.action" viewCode="RM_7.5.0.0_formula_activeCheckRef" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1497922173328')}"  label="${getText('ec.common.ID')}" width=100 showFormatFunc=""  />
							...
							<#elseif (formulaId_id_defaultValue!)?string=="currentComp">
								<#assign formulaId_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="formulaId.id"        showFormat="SELECTCOMP" defaultValue="${(formulaId_id_defaultValue!)?string}" defaultDisplay="${(formulaId_id_displayDefaultType!)?string}" decimal="" editable=false type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.recycleTaskView"  textalign="center" hiddenCol=true viewUrl="/RM/formula/formula/formulaTaskRef.action" viewCode="RM_7.5.0.0_formula_formulaTaskRef" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1498047455529')}"  label="${getText('ec.common.ID')}" width=100 showFormatFunc=""  />
							...
							<#elseif (processId_id_defaultValue!)?string=="currentComp">
								<#assign processId_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="processId.id"        showFormat="SELECTCOMP" defaultValue="${(processId_id_defaultValue!)?string}" defaultDisplay="${(processId_id_displayDefaultType!)?string}" decimal="" editable=false type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.recycleTaskView"  textalign="center" hiddenCol=true viewUrl="/RM/formula/formulaProcess/processReference.action" viewCode="RM_7.5.0.0_formula_processReference" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1488596828660')}"  label="${getText('ec.common.ID')}" width=100 showFormatFunc=""  />
							...
							<#elseif (putBatMateId_id_defaultValue!)?string=="currentComp">
								<#assign putBatMateId_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="putBatMateId.id"        showFormat="SELECTCOMP" defaultValue="${(putBatMateId_id_defaultValue!)?string}" defaultDisplay="${(putBatMateId_id_displayDefaultType!)?string}" decimal="" editable=false type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.recycleTaskView"  textalign="center" hiddenCol=true viewUrl="/RM/formula/formulaProcessActive/activeCheckRef.action" viewCode="RM_7.5.0.0_formula_activeCheckRef" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1497922173328')}"  label="${getText('ec.common.ID')}" width=100 showFormatFunc=""  />
			...
			<script type="text/javascript">
				function ProduceTaskActive_dg1505456701981_check_datagridvalid(){
					//
					var errorObj =ProduceTaskActive_dg1505456701981Widget._DT.testData();
					var errorContent='';
					if(errorObj!=null){
				...
				function savedg1505456701981DataGrid(){
					<#if  refId?? && (refId gt 0)>
					ProduceTaskActive_dg1505456701981Widget.setAllRowEdited();
					</#if>
					// 针对需要全部更新的PT，把pt Id存到body的CHANGED_PT中，保存时，会自动保存全部数据
					var changed_pt_name = $('body').data('CHANGED_PT');
					if(changed_pt_name && changed_pt_name.indexOf('ProduceTaskActive_dg1505456701981Widget') > -1) {
						ProduceTaskActive_dg1505456701981Widget.setAllRowEdited();
					}
					var json = ProduceTaskActive_dg1505456701981Widget.parseEditedData();
					$('input[name="dg1505456701981ListJson"]').remove();
					$('input[name="dgLists[\'dg1505456701981\']"]').remove();
					$('input[name="dg1505456701981ModelCode"]').remove();
					$('<input type="hidden" name="dgLists[\'dg1505456701981\']">').val(json).appendTo($('#WOM_produceTask_produceTask_recycleTaskView_form'));
					$('<input type="hidden" name="dg1505456701981ModelCode">').val('WOM_7.5.0.0_produceTask_ProduceTaskActive').appendTo($('#WOM_produceTask_produceTask_recycleTaskView_form'));
					//兼容旧版本提交函数
					$('<input type="hidden" name="dg1505456701981ListJson">').val(json).appendTo($('#WOM_produceTask_produceTask_recycleTaskView_form'));
				}
				function DT_ProduceTaskActive_dg1505456701981_deldatagrid(){
					var deleteRows = ProduceTaskActive_dg1505456701981Widget.deleteRows();
					...
					$.each(deleteRows, function(index, deleteRow){
						...
						if($("#dg1505456701981DeletedIds").length>0){
							$("#dg1505456701981DeletedIds")[0].value+=","+tepID;
						}else{
							CUI('<input type="hidden" id="dg1505456701981DeletedIds" name="dgDeletedIds[\'dg1505456701981\']" value="'+tepID+'">').appendTo(CUI('#WOM_produceTask_produceTask_recycleTaskView_form'));
						}
						//兼容旧版本提交函数
						CUI('<input type="hidden" name="dg1505456701981DeletedIds['+CUI('input[name^="dg1505456701981DeletedIds"]').length+']'+'" value="'+tepID+'">').appendTo(CUI('#WOM_produceTask_produceTask_recycleTaskView_form'));
					});
					return deleteRows;
				}
				function DT_ProduceTaskActive_dg1505456701981_delTreeNodes(){
					var deleteRows = ProduceTaskActive_dg1505456701981Widget._DT.removeTreeNode();
					if(!deleteRows || deleteRows.length == 0) {
						return false;
					}
					var delproperty = "'id','version','processId.id','activeId.id','headID.id','formulaId.id','productId.id'";
				...
				$(function($){
					var datagrids = $('body').data('WOM_produceTask_produceTask_recycleTaskView_datagrids');
					if(!datagrids) {
						datagrids = [];
					}
					for(var i=0;i<2;i++) {
					...
					if(datagrids[0].length>0) {
						for(var i=0;i<datagrids[0].length;i++) {
							if(datagrids[0][i] == 'ProduceTaskActive_dg1505456701981') {
								break;
							}
							if(i==datagrids[0].length-1) {
								datagrids[0][datagrids[0].length] = 'ProduceTaskActive_dg1505456701981';
							}
						}
					} else {
						datagrids[0][datagrids[0].length] = 'ProduceTaskActive_dg1505456701981';
					}
					$('body').data('WOM_produceTask_produceTask_recycleTaskView_datagrids', datagrids);
				});
				
				var ProduceTaskActive_dg1505456701981_importDialog = null;
				function ProduceTaskActive_dg1505456701981_showImportDialog(){
					try{
						if(ProduceTaskActive_dg1505456701981_importDialog!=null&&ProduceTaskActive_dg1505456701981_importDialog.isShow==1){
							return false;
						}
						var url = "/WOM/produceTask/produceTask/initImport.action?datagridCode=WOM_7.5.0.0_produceTask_recycleTaskViewdg1505456701981&tid=${id!}&datagridName=dg1505456701981";
							<#if canImportExcel>
								var buttonCode="WOM_7.5.0.0_produceTask_recycleTaskViewdg1505456701981_BUTTON_dgImport";
								url+="&buttonCode="+buttonCode;
							</#if>
						ProduceTaskActive_dg1505456701981_importDialog = new CUI.Dialog({
							...
							width: '420',
							dragable:true,
							buttons:[{id:"import",name:"${getHtmlText('common.button.import')}",handler:function(){var dg = eval("ProduceTaskActive_dg1505456701981"+"Widget");if(dg && dg.checkEdited && dg.checkEdited()){CUI.Dialog.alert("${getHtmlText('ec.view.unsavedgdata')}");}else{foundation.importExcel.submitImportForm();}}},{name:"${getHtmlText('common.button.cancel')}",id:"close",handler:function(){setTimeout(function(){$('#importResponse').remove();ProduceTaskActive_dg1505456701981_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.Confirm')}",id:"ok",display:'hidden',handler:function(){setTimeout(function(){$('#importResponse').remove();ProduceTaskActive_dg1505456701981_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.back')}",id:"tback",display:'hidden',handler:function(){tback();}}],
							beforeCloseEvent:function(){$('#importResponse').remove();}
						});
						ProduceTaskActive_dg1505456701981_importDialog.show();
					}catch(e){}
				}	
				
				function ProduceTaskActive_dg1505456701981_downLoadFile(){
					var url = "/WOM/produceTask/produceTask/downLoad.action?datagridCode=WOM_7.5.0.0_produceTask_recycleTaskViewdg1505456701981&templateRelatedModelCode=WOM_7.5.0.0_produceTask_recycleTaskViewdg1505456701981&downloadType=template&fileName=dg1505456701981";
					window.open(url,"","");
				}
				function dg1505456701981RenderOverEvent(){
					//启用物料批次
    if(isProBatch==true){
    	//将复制按钮显示
		...
		//隐藏物料批号列
		$( 'td[key="batchNumObj.batchText"]').hide();
		ProduceTaskActive_dg1505456701981Widget._DT._resizeHeight = true;
		ProduceTaskActive_dg1505456701981Widget._DT._initDomElements();
		ProduceTaskActive_dg1505456701981Widget._DT._resizeHeight = false;
    }
	...
	formulaChange1();
				...
				function dg1505456701981PageInitMethod(nTabIndex){
					WOM.produceTask.produceTask.recycleTaskView.initSize(nTabIndex);
...
<#assign colAdmFlag=checkUserPermisition('ec_ptManage_list_view')>
			...
			<#if  refId?? && (refId > 0)>
				<#assign dUrl="/WOM/produceTask/produceTask/data-dg1505456702135.action?produceTask.id=${refId!-1}&refId=${refId!-1}&datagridCode=WOM_7.5.0.0_produceTask_recycleTaskViewdg1505456702135">
			<#else>
				<#assign dUrl="/WOM/produceTask/produceTask/data-dg1505456702135.action?produceTask.id=${(produceTask.id)!-1}&datagridCode=WOM_7.5.0.0_produceTask_recycleTaskViewdg1505456702135">
			</#if>
			<#assign firstLoad = true>
				
			<#if viewType?? && viewType != "readonly" && newObj?? && !newObj && !(refId?? && (refId > 0))>
				<#assign buttons="[{text:\"${getText('ec.view.addline')}\",handler:function(event){this.addNewRow(event);},iconClass:\"cui-btn-add\",useInMore:\"false\"},{text:\"${getText('ec.view.deleteline')}\",iconClass:\"cui-btn-del\",useInMore:\"false\",handler:function(event){DT_ProduceMaterialSum_dg1505456702135_deldatagrid();}}]">
				<#assign canImportExcel=false>
			<#else>
				<#assign buttons="[{text:\"${getText('ec.view.addline')}\",handler:function(event){this.addNewRow(event);},iconClass:\"cui-btn-add\",useInMore:\"false\"},{text:\"${getText('ec.view.deleteline')}\",iconClass:\"cui-btn-del\",useInMore:\"false\",handler:function(event){DT_ProduceMaterialSum_dg1505456702135_deldatagrid();}}]">
				<#assign canImportExcel=false>
				...
				<#if cpvmInfo?? && cpvmInfo?length gt 0>
					<#assign cpvmInfo = cpvmInfo?substring(1)>
					<input type="hidden" id="dg_cp_info_ProduceMaterialSum_dg1505456702135" value="${cpvmInfo!}" />
				</#if>
			
			<input type="hidden" id="dg1505456702135_id" value="ProduceMaterialSum_dg1505456702135" />
			
			<input type="hidden" id="dg1505456702135_url" value="${dUrl}" />
			
			<#assign assModelDisplayName = getText('WOM.modelname.randon1489671141506')!>
			<#assign assModelDisplayName = assModelDisplayName + getText('ec.common.validate.colon') >
			<@exportexcel action="/WOM/produceTask/produceTask/data-dg1505456702135.action?operateType=export&datagridCode=WOM_7.5.0.0_produceTask_recycleTaskViewdg1505456702135"  settingtext="" settingUrl="" prepareParams="" formId="" look="text" width=250 height=170 text="" exportPageChoose=0 dtPage="dgPage" prefix="ProduceMaterialSum_dg1505456702135" />
			<@datagrid colAdminFlag=colAdmFlag withoutConfigTable=true id="ProduceMaterialSum_dg1505456702135" viewType="${viewType}" renderOverEvent="dg1505456702135RenderOverEvent" route="${routeFlag}" formId="WOM_produceTask_produceTask_recycleTaskView_form" noPermissionKeys="productId.productCode,productId.productName,property,planNum,productId.productBaseUnit.name,batchNum,headId.formularId.setProcess" modelCode="WOM_7.5.0.0_produceTask_ProduceMaterialSum" dataUrl="${dUrl}" postData="&dgPage.pageSize=65536" dataGridName="dg1505456702135" dtPage="dgPage"  hidekeyPrefix="dg1505456702135" hidekey="['id','version','productId.id','productId.productCode','productId.id','productId.productName','productId.id','productId.productBaseUnit.name','headId.id','headId.formularId.setProcess.id'${cpObjHideKey!''}]" transMethod="post" paginator=false editable=false  buttons="${buttons}" noPadding=true isEdit=true tabViewIndex=1 pageInitMethod="dg1505456702135PageInitMethod"  defaultNodeExpanded=nodeExpanded  cannotAddNewRow=false cannotDeleteRow=true assModelDisplayName=assModelDisplayName dgTitle="${getText('WOM.dataGriddataGridName.radion1490444001342')}" activexButton="" exportExcel=exportExcel addNewRow=true   canInsertRow=false  insertRowAble=true firstLoad=firstLoad  copyRow=false  copyColumn=false  ptRealTimeLoad=0 >		
							<#assign productId_productCode_displayDefaultType=''>
								<#assign productId_productCode_defaultValue=''>
										<#assign productId_productCode_defaultValue=''>
																	<#if (productId_productCode_defaultValue!)?string=="currentUser">
							...
							<#elseif (productId_productCode_defaultValue!)?string=="currentComp">
								<#assign productId_productCode_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.productCode"        showFormat="TEXT" defaultValue="${(productId_productCode_defaultValue!)?string}" defaultDisplay="${(productId_productCode_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="WOM.produceTask.produceTask.recycleTaskView"  textalign="left"  viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('WOM.propertydisplayName.radion14157726448331')}" width=120 showFormatFunc=""  />
							<#assign productId_productName_displayDefaultType=''>
								<#assign productId_productName_defaultValue=''>
										<#assign productId_productName_defaultValue=''>
																	<#if (productId_productName_defaultValue!)?string=="currentUser">
							...
							<#elseif (productId_productName_defaultValue!)?string=="currentComp">
								<#assign productId_productName_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.productName"        showFormat="SELECTCOMP" defaultValue="${(productId_productName_defaultValue!)?string}" defaultDisplay="${(productId_productName_displayDefaultType!)?string}" decimal="" editable=false type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.recycleTaskView"  textalign="left"  viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('WOM.propertydisplayName.radion1415772740737334')}" width=120 showFormatFunc=""  />
							<#assign property_displayDefaultType=''>
								<#assign property_defaultValue=''>
										<#assign property_defaultValue=''>
			...
			<script type="text/javascript">
				function ProduceMaterialSum_dg1505456702135_check_datagridvalid(){
					//
					var errorObj =ProduceMaterialSum_dg1505456702135Widget._DT.testData();
					var errorContent='';
					if(errorObj!=null){
					  for(var i=0;i<errorObj.length;i++){
						var obj1=errorObj[i];
				...
				function savedg1505456702135DataGrid(){
					<#if  refId?? && (refId gt 0)>
					ProduceMaterialSum_dg1505456702135Widget.setAllRowEdited();
					</#if>
					// 针对需要全部更新的PT，把pt Id存到body的CHANGED_PT中，保存时，会自动保存全部数据
					var changed_pt_name = $('body').data('CHANGED_PT');
					if(changed_pt_name && changed_pt_name.indexOf('ProduceMaterialSum_dg1505456702135Widget') > -1) {
						ProduceMaterialSum_dg1505456702135Widget.setAllRowEdited();
					}
					var json = ProduceMaterialSum_dg1505456702135Widget.parseEditedData();
					$('input[name="dg1505456702135ListJson"]').remove();
					$('input[name="dgLists[\'dg1505456702135\']"]').remove();
					$('input[name="dg1505456702135ModelCode"]').remove();
					$('<input type="hidden" name="dgLists[\'dg1505456702135\']">').val(json).appendTo($('#WOM_produceTask_produceTask_recycleTaskView_form'));
					$('<input type="hidden" name="dg1505456702135ModelCode">').val('WOM_7.5.0.0_produceTask_ProduceMaterialSum').appendTo($('#WOM_produceTask_produceTask_recycleTaskView_form'));
					//兼容旧版本提交函数
					$('<input type="hidden" name="dg1505456702135ListJson">').val(json).appendTo($('#WOM_produceTask_produceTask_recycleTaskView_form'));
				}
				function DT_ProduceMaterialSum_dg1505456702135_deldatagrid(){
					var deleteRows = ProduceMaterialSum_dg1505456702135Widget.deleteRows();
					if(!deleteRows || deleteRows.length == 0) {
						CUI.Dialog.alert("${getHtmlText('foundation.message.choicedel')}");
						return false;
					}
					...
					$.each(deleteRows, function(index, deleteRow){
						...
						if($("#dg1505456702135DeletedIds").length>0){
							$("#dg1505456702135DeletedIds")[0].value+=","+tepID;
						}else{
							CUI('<input type="hidden" id="dg1505456702135DeletedIds" name="dgDeletedIds[\'dg1505456702135\']" value="'+tepID+'">').appendTo(CUI('#WOM_produceTask_produceTask_recycleTaskView_form'));
						}
						//兼容旧版本提交函数
						CUI('<input type="hidden" name="dg1505456702135DeletedIds['+CUI('input[name^="dg1505456702135DeletedIds"]').length+']'+'" value="'+tepID+'">').appendTo(CUI('#WOM_produceTask_produceTask_recycleTaskView_form'));
					});
					return deleteRows;
				}
				function DT_ProduceMaterialSum_dg1505456702135_delTreeNodes(){
					var deleteRows = ProduceMaterialSum_dg1505456702135Widget._DT.removeTreeNode();
					if(!deleteRows || deleteRows.length == 0) {
						return false;
					}
					var delproperty = "'id','version','productId.id','headId.id'";
				...
				$(function($){
					...
					if(datagrids[1].length>0) {
						for(var i=0;i<datagrids[1].length;i++) {
							if(datagrids[1][i] == 'ProduceMaterialSum_dg1505456702135') {
								break;
							}
							if(i==datagrids[1].length-1) {
								datagrids[1][datagrids[1].length] = 'ProduceMaterialSum_dg1505456702135';
							}
						}
					} else {
						datagrids[1][datagrids[1].length] = 'ProduceMaterialSum_dg1505456702135';
				...
				var ProduceMaterialSum_dg1505456702135_importDialog = null;
				function ProduceMaterialSum_dg1505456702135_showImportDialog(){
					try{
						if(ProduceMaterialSum_dg1505456702135_importDialog!=null&&ProduceMaterialSum_dg1505456702135_importDialog.isShow==1){
							return false;
						}
						var url = "/WOM/produceTask/produceTask/initImport.action?datagridCode=WOM_7.5.0.0_produceTask_recycleTaskViewdg1505456702135&tid=${id!}&datagridName=dg1505456702135";
							<#if canImportExcel>
								var buttonCode="WOM_7.5.0.0_produceTask_recycleTaskViewdg1505456702135_BUTTON_dgImport";
								url+="&buttonCode="+buttonCode;
							</#if>
						ProduceMaterialSum_dg1505456702135_importDialog = new CUI.Dialog({
							title: "${getHtmlText('common.button.import')}",
							url:url,
							modal:true,
							description:'',
							...
							width: '420',
							dragable:true,
							buttons:[{id:"import",name:"${getHtmlText('common.button.import')}",handler:function(){var dg = eval("ProduceMaterialSum_dg1505456702135"+"Widget");if(dg && dg.checkEdited && dg.checkEdited()){CUI.Dialog.alert("${getHtmlText('ec.view.unsavedgdata')}");}else{foundation.importExcel.submitImportForm();}}},{name:"${getHtmlText('common.button.cancel')}",id:"close",handler:function(){setTimeout(function(){$('#importResponse').remove();ProduceMaterialSum_dg1505456702135_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.Confirm')}",id:"ok",display:'hidden',handler:function(){setTimeout(function(){$('#importResponse').remove();ProduceMaterialSum_dg1505456702135_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.back')}",id:"tback",display:'hidden',handler:function(){tback();}}],
							beforeCloseEvent:function(){$('#importResponse').remove();}
						});
						ProduceMaterialSum_dg1505456702135_importDialog.show();
					}catch(e){}
				}	
				
				function ProduceMaterialSum_dg1505456702135_downLoadFile(){
					var url = "/WOM/produceTask/produceTask/downLoad.action?datagridCode=WOM_7.5.0.0_produceTask_recycleTaskViewdg1505456702135&templateRelatedModelCode=WOM_7.5.0.0_produceTask_recycleTaskViewdg1505456702135&downloadType=template&fileName=dg1505456702135";
					window.open(url,"","");
				}
				function dg1505456702135RenderOverEvent(){
					//启用物料批次
    if(!isProBatch || ProduceMaterialSum_dg1505456702135Widget.getCellValue(0,"headId.formularId.setProcess.id")=="formulaProperty/formulaProperty1"){
		//隐藏物料批号列
		$( 'td[key="batchNum"]').hide();
		ProduceMaterialSum_dg1505456702135Widget._DT._resizeHeight = true;
		ProduceMaterialSum_dg1505456702135Widget._DT._initDomElements();
		ProduceMaterialSum_dg1505456702135Widget._DT._resizeHeight = false;
    }
				}
				function dg1505456702135PageInitMethod(nTabIndex){
					WOM.produceTask.produceTask.recycleTaskView.initSize(nTabIndex);
				}
			</script>
	...
	<#include "../../../ec/tableInfo/flowDealContainer_all.ftl">
		...
		<div id="WOM_produceTask_produceTask_recycleTaskView_dealInfo" style="display: none;margin-top:5px;">
			<ul class="edit-tabs">
				<#if ((produceTask.effectiveState)!0) == 0>
				<#if !(superEdit!false)>
				<li id="flowHead" onclick="WOM.produceTask.produceTask.recycleTaskView.showFlowInfo('flow')"><span class="icon_prograss"></span>${getText("ec.flow.flowImage")}</li>
				</#if>
				</#if>
				<li id="fileUploadHead" <#if !(superEdit!false)>class="bar"</#if> onclick="WOM.produceTask.produceTask.recycleTaskView.showFileUpload('fileUpload')"><span class="icon_file"></span>${getText("foundation.upload.attachment")}</li>
				<li id="dealInfoHead" class="bar" onclick="WOM.produceTask.produceTask.recycleTaskView.showDealInfo('dealInfo')"><span class="icon_handle"></span>${getText("ec.view.dealadvice")}</li>
			</ul>
		...
		<!-- CUSTOM CODE START(view-VIEW-WOM_7.5.0.0_produceTask_recycleTaskView,html,WOM_7.5.0.0_produceTask_ProduceTask,WOM_7.5.0.0) -->
<!-- 自定义代码 -->
...
<!-- CUSTOM CODE END -->
			...
			$(window).resize(function(){
				...
				if (width <= 800) {
					if($("#edit_sidebar").length==0 || $("#edit_sidebar").css("display")=="none"){
						$("#WOM_produceTask_produceTask_recycleTaskView_main_div").css("width",800);
						$(".edit-head").css("width",800);
						$(".edit-workflow").css("width",800);
						$("body").css({"overflow-x":"scroll","position":"relative","zIndex":"100"});
					}else{
						$("#WOM_produceTask_produceTask_recycleTaskView_main_div").css("width",650);
					...
					if (YAHOO.env.ua.ie == "6") {
						$("#WOM_produceTask_produceTask_recycleTaskView_main_div").css("width",w1);
						$(".edit-workflow").css("width",w1);
					}else{
						$("#WOM_produceTask_produceTask_recycleTaskView_main_div").css("width","auto");
		...
		<script type="text/javascript">
			WOM.produceTask.produceTask.recycleTaskView.initCount = 0;
			WOM.produceTask.produceTask.recycleTaskView.initSize = function(nTabIndex){
				var panesHeight;
				var thisHeight;
				var h = $(window).height();
			    var w = $(window).width();
				...
				var conHeight = h-$("#WOM_produceTask_produceTask_recycleTaskView_main_div .edit-head").height()-$("#WOM_produceTask_produceTask_recycleTaskView_main_div .edit-tabs").height()<#if pendingId?? || editNew>-$("#WOM_produceTask_produceTask_recycleTaskView_main_div .edit-workflow").height()</#if>;
				$("#WOM_produceTask_produceTask_recycleTaskView_main_div .edit-tabs").length == 0 ? conHeight = conHeight : conHeight = conHeight-28 //再减去28px，28px是由.edit-tabs的margin-top:14px+6px边框+8px的底部边距组成
				panesHeight = conHeight*0.4;  //当表单跟pt共存的时候采用4/6开
				var datagrids = $('body').data('WOM_produceTask_produceTask_recycleTaskView_datagrids');
				var padding_bottom=16;
				$("#WOM_produceTask_produceTask_recycleTaskView_main_div .pd_bottom,#WOM_produceTask_produceTask_recycleTaskView_main_div .edit-tabs").width(w-14*2-2-width_)  //把tab跟tab下面的内容宽度统一调整
				$("#WOM_produceTask_produceTask_recycleTaskView_main_div .edit-panes-s").each(function(index){
					//多页签切换时只计算本页签下的PT高度
					...
					if(datagrids && datagrids.length > 0) {
						if(datagrids[index].length > 0) {
							...
							for(var dg=0;dg<datagrids[index].length;dg++) {
								...
								if(dgwidget) {
									...
									if(WOM.produceTask.produceTask.recycleTaskView.initCount <= 2) {
										setTimeout(function(){WOM.produceTask.produceTask.recycleTaskView.initSize();}, 200);
										WOM.produceTask.produceTask.recycleTaskView.initCount++;
									}/* else {
										WOM.produceTask.produceTask.recycleTaskView.initCount = 0;
									}*/
								}
						...
						if(thisHeight < conHeight){ //当此页签下面的实际内容高度小于分配给它的高度
							...
							$(this).parent().height(conHeight);
							if(($("#WOM_produceTask_produceTask_recycleTaskView_main_div .edit-workflow").length > 0) && ($("#WOM_produceTask_produceTask_recycleTaskView_main_div .edit-tabs").length > 0)){		// 底下有处理结果，并且头部有页签切换，此时底部留白14像素
			...
			$(function(){
				$('#WOM_produceTask_produceTask_recycleTaskView_form').get(0).onkeydown=function(event){
				...
				WOM.produceTask.produceTask.recycleTaskView.buttonBar = new CUI.ButtonBar( { panel: '#top_buttonbar' }  );
				WOM.produceTask.produceTask.recycleTaskView.initSize();
				if(YAHOO.env.ua.ie == 6){
				...
				<#if businessCenterList??&&businessCenterList?size gt 0 >
					...
					$("#edit_side_btn").toggle(function(){
						if(parseInt($("#WOM_produceTask_produceTask_recycleTaskView_main_div").css("width"),10)==650){
							$("#WOM_produceTask_produceTask_recycleTaskView_main_div").css("width","800px");
						...
						//WOM.produceTask.produceTask.recycleTaskView.resizeLayout();
						//WOM.produceTask.produceTask.recycleTaskView.initSize();
						$('body').trigger('resize');
					},function(){
						if(parseInt($("#WOM_produceTask_produceTask_recycleTaskView_main_div").css("width"),10)==800){
							$("#WOM_produceTask_produceTask_recycleTaskView_main_div").css("width","650px");
				...
				$(window).resize(function(){WOM.produceTask.produceTask.recycleTaskView.initSize();});
				/*
				WOM.produceTask.produceTask.recycleTaskView.resizeLayout=function(){
		...
		$(function(){
			<#if editNew>
			WOM.produceTask.produceTask.recycleTaskView.setDepartment();
			<#else>
		...
		WOM.produceTask.produceTask.recycleTaskView.validate = function(){
		...
		WOM.produceTask.produceTask.recycleTaskView.beforeSaveProcess = function(){
			$('input[name="produceTask.extraCol"]').remove();
		}
		WOM.produceTask.produceTask.recycleTaskView.processDataGrid = function(){
										<#if false && isIE>
										$('#WOM_produceTask_produceTask_recycleTaskView_form').append(ProduceTaskActive_dg1505456701981Widget._DT.createInputs('dg1505456701981List'));
										</#if>
										<#if false && isIE>
										$('#WOM_produceTask_produceTask_recycleTaskView_form').append(ProduceMaterialSum_dg1505456702135Widget._DT.createInputs('dg1505456702135List'));
										</#if>
		};
		WOM.produceTask.produceTask.recycleTaskView.save = function(){
			<#if !(superEdit!false)>
			...
			if(!WOM.produceTask.produceTask.recycleTaskView.validate()){return;}
			//延迟到延迟提交中处理,解决onchange事件无法触发问题
			//WOM.produceTask.produceTask.recycleTaskView.beforeSaveProcess();

			//WOM.produceTask.produceTask.recycleTaskView.processDataGrid();
			$('#WOM_produceTask_produceTask_recycleTaskView_form').submit();
		}
		
		<#if viewType != "readonly">
		$(window).bind('beforeunload',function(){
		        if(isFormChanged('WOM_produceTask_produceTask_recycleTaskView_form','WOM_produceTask_produceTask_recycleTaskView_datagrids')) {      
		...
		//打印
		WOM.produceTask.produceTask.recycleTaskView.print = function(){
		...
		WOM.produceTask.produceTask.recycleTaskView.saveSetting = function(){
		...
		WOM.produceTask.produceTask.recycleTaskView.printSetting = function(){
			var viewCode = $('input[name="viewCode"]').val();
			var value = "";
			var printId = 0;
			var printVersion = 0;
			if(viewCode!=undefined && viewCode!=null && viewCode!=''){
				...
				WOM.produceTask.produceTask.recycleTaskView.settingDialog = new CUI.Dialog({
					...
					buttons:[
							{	name:"${getText("ec.flow.save")}",
								handler:function(){if(WOM.produceTask.produceTask.recycleTaskView.saveSetting()){this.close();}}
							},
							{	name:"${getText("ec.flow.cancal")}",
								handler:function(){this.close()}
							}]
					})
				WOM.produceTask.produceTask.recycleTaskView.settingDialog.show();
			}
		}
		
		
		
		WOM.produceTask.produceTask.recycleTaskView.reject = function(){
			...
			WOM.produceTask.produceTask.recycleTaskView.submit();
		}
		
		WOM.produceTask.produceTask.recycleTaskView.submit = function(uncheck){
			if(uncheck){
		...
		WOM.produceTask.produceTask.recycleTaskView.recall = function(){
		...
		WOM.produceTask.produceTask.recycleTaskView._callBackInfo = function(res){
		...
		<#if editNew>
		WOM.produceTask.produceTask.recycleTaskView.setDepartment = function(){
		...
		function dataGridBtnImgClick(sUrl,objNameCustomCondition,sTitle,sPTGridID,nRow,sFieldName,oGrid,customCallBack,crossCompany,isObjCustomProp,objCustomPropNames,viewCode){
			...
			if(customCallBack){
				WOM.produceTask.produceTask.recycleTaskView._customCallBack = customCallBack;
			}
			if (isObjCustomProp) {
				WOM.produceTask.produceTask.recycleTaskView._isObjCustomProp_IE = isObjCustomProp;
			} else {
				WOM.produceTask.produceTask.recycleTaskView._isObjCustomProp_IE = false;
			}
			if (objCustomPropNames) {
				WOM.produceTask.produceTask.recycleTaskView._objCustomPropNames_IE = objCustomPropNames;
			} else {
				WOM.produceTask.produceTask.recycleTaskView._objCustomPropNames_IE = '';
			}
			if (viewCode) {
				WOM.produceTask.produceTask.recycleTaskView._refViewCode_IE = viewCode;
			} else {
				WOM.produceTask.produceTask.recycleTaskView._refViewCode_IE = '';
			}
			WOM.produceTask.produceTask.recycleTaskView._selectEvent(objNameCustomCondition,null,sUrl,sTitle,null,null,null,crossCompany,obj);
		}
		
		WOM.produceTask.produceTask.recycleTaskView.initMnemonic_DG_IE = function(oConfig){
			// 助记码也需要区分是否为自定义字段
			WOM.produceTask.produceTask.recycleTaskView._isObjCustomProp_IE = oConfig._isObjCustomProp_IE;
			WOM.produceTask.produceTask.recycleTaskView._objCustomPropNames_IE = oConfig._objCustomPropNames_IE;
			
			var oGrid = oConfig.oGrid;
			// 获取控件PT  object
			var oPTGridEx = oGrid._DT || oGrid;
			// 存储当前操作相关信息
			WOM.produceTask.produceTask.recycleTaskView.gridEventObj = {
				"oGrid" : oGrid,
				"nRow" : oConfig.nRow - 1,
				"sKey":	oConfig.sFieldName
			}
			WOM.produceTask.produceTask.recycleTaskView._sUrl = oConfig.url;
			if(oConfig.customCallBack){
				WOM.produceTask.produceTask.recycleTaskView._customCallBack = oConfig.customCallBack;
			}
			// 自定义的表格对象
		...
		WOM.produceTask.produceTask.recycleTaskView._selectEvent = function(objName,_selectType,url,title,refparam,obj,customCallBack,crossCompanyFlag,gridEventObj,oGrid,isMultiselect,oColumn){

			var callbackName="";
			var condition='';
			var _prefix= '';
			var arr = objName.split('.');
			if(WOM.produceTask.produceTask.recycleTaskView._querycustomFunc(objName.replace(/\./g, '_')) !=null){
				condition=encodeURIComponent(WOM.produceTask.produceTask.recycleTaskView._querycustomFunc(objName.replace(/\./g, '_')));
			}
			if(gridEventObj) {
				WOM.produceTask.produceTask.recycleTaskView.gridEventObj = gridEventObj;
				callbackName = "WOM.produceTask.produceTask.recycleTaskView.getcallBackInfo_DG_IE";
			}else if(obj!=null && obj!=""){
				if(arr.length > 1){
					_prefix = '.'+ arr[0];
				}
				callbackName = isMultiselect ? "WOM.produceTask.produceTask.recycleTaskView.getMultiselectCallBackInfo_DG" : "WOM.produceTask.produceTask.recycleTaskView.getcallBackInfo_DG";
				WOM.produceTask.produceTask.recycleTaskView._currRow = $(obj).closest('tr')[0];
			}else{
				if(arr.length > 2){
					_prefix = '.'+ arr[0] + '.'+ arr[1];
				}
				callbackName ="WOM.produceTask.produceTask.recycleTaskView.getcallBackInfo";
			}

			if(_prefix!=''){
				WOM.produceTask.produceTask.recycleTaskView._prefix = _prefix.substring(1);
			}
			
			WOM.produceTask.produceTask.recycleTaskView._oGrid = oGrid;
			WOM.produceTask.produceTask.recycleTaskView._sUrl = url;
			if (oColumn) {
				if (oColumn.isObjCustomProp) {
					WOM.produceTask.produceTask.recycleTaskView._isObjCustomProp = oColumn.isObjCustomProp;
				} else {
					WOM.produceTask.produceTask.recycleTaskView._isObjCustomProp = false;
				} 
				if (oColumn.objCustomPropNames) {
					WOM.produceTask.produceTask.recycleTaskView._objCustomPropNames = oColumn.objCustomPropNames;
				} else {
					WOM.produceTask.produceTask.recycleTaskView._objCustomPropNames = '';
				}
				if (oColumn.viewCode) {
					WOM.produceTask.produceTask.recycleTaskView._refViewCode = oColumn.viewCode;
				} else {
					WOM.produceTask.produceTask.recycleTaskView._refViewCode = '';
				}
			} else {
				WOM.produceTask.produceTask.recycleTaskView._isObjCustomProp = false;
				WOM.produceTask.produceTask.recycleTaskView._objCustomPropNames = '';
			...
			if (WOM.produceTask.produceTask.recycleTaskView._isObjCustomProp == true && WOM.produceTask.produceTask.recycleTaskView._objCustomPropNames && objName && objName.substring(objName.length - 'MainDisplay'.length) == 'MainDisplay') {
				WOM.produceTask.produceTask.recycleTaskView._prefix = objName.substring(0, objName.length - 'MainDisplay'.length);
			}
			if(customCallBack){
				WOM.produceTask.produceTask.recycleTaskView._customCallBack = customCallBack;
			}
			if(WOM.produceTask.produceTask.recycleTaskView._querycustomFunc(objName.replace(/\./g, '_')) != null) {
				refparam = 'condition=' + encodeURIComponent(WOM.produceTask.produceTask.recycleTaskView._querycustomFunc(objName.replace(/\./g, '_')));
			}
			if(typeof WOM.produceTask.produceTask.recycleTaskView._querycustomFuncN == "function") {
				refparam += WOM.produceTask.produceTask.recycleTaskView._querycustomFuncN();
			}
			...
			WOM.produceTask.produceTask.recycleTaskView._dialog = foundation.common.select({
				pageType : 'other',
				closePage : true,
				condition : condition,
		...
		WOM.produceTask.produceTask.recycleTaskView._groupSelectEvent = function(objName,_selectType,url,title,refparam){
			if(WOM.produceTask.produceTask.recycleTaskView._querycustomFunc(objName.replace(/\./g, '_')) != null) {
				refparam = 'condition=' + encodeURIComponent(WOM.produceTask.produceTask.recycleTaskView._querycustomFunc(objName.replace(/\./g, '_')));
			}
			WOM.produceTask.produceTask.recycleTaskView._dialog = foundation.common.select({
				...
				closePage : true,
				callBackFuncName : 'WOM.produceTask.produceTask.recycleTaskView.getcallBackGroupInfo',
				url : url,
				title : title,
				params : refparam
			});
		}
		WOM.produceTask.produceTask.recycleTaskView._querycustomFunc = function(obj) {
			var str = eval("typeof(WOM.produceTask.produceTask.recycleTaskView.query_"+obj+")!='undefined'") ? eval('WOM.produceTask.produceTask.recycleTaskView.query_'+obj+'()') : null;
			return str;
		};
		WOM.produceTask.produceTask.recycleTaskView.getcallBackGroupInfo = function(obj){
			var ids = "";
			var names = "";
			...
			WOM.produceTask.produceTask.recycleTaskView._dialog.close();
		}
		WOM.produceTask.produceTask.recycleTaskView.getcallBackInfo = function(obj){
		
			obj[0] = foundation.common.getObject('WOM_produceTask_produceTask_recycleTaskView_form',obj[0], WOM.produceTask.produceTask.recycleTaskView._prefix, WOM.produceTask.produceTask.recycleTaskView._sUrl);
			CUI.commonFills('WOM_produceTask_produceTask_recycleTaskView_form',WOM.produceTask.produceTask.recycleTaskView._prefix,obj[0]);
			
			for(pro in obj[0]){
				try{
					var fname = "_callback_" + (WOM.produceTask.produceTask.recycleTaskView._prefix + "." + pro).replace(/\./g, '_')  + "_edit";
			...
			try{
				if(WOM.produceTask.produceTask.recycleTaskView._customCallBack) {
					eval(WOM.produceTask.produceTask.recycleTaskView._customCallBack);
					WOM.produceTask.produceTask.recycleTaskView._customCallBack = null;
				}
		...
		// 控件版PT回调
		WOM.produceTask.produceTask.recycleTaskView.getcallBackInfo_DG_IE = function(obj){
			if(WOM.produceTask.produceTask.recycleTaskView._customBeforeCallBack) {
				var flag = eval(WOM.produceTask.produceTask.recycleTaskView._customBeforeCallBack.split("(")[0] + "(obj)");
				if(flag === false){
					return false;
				}
			}
			var gridEventObj = WOM.produceTask.produceTask.recycleTaskView.gridEventObj;
			var rootKey = gridEventObj.sKey.split('.')[0];
			var jsonObj;
			if ( WOM.produceTask.produceTask.recycleTaskView._isObjCustomProp_IE == true && WOM.produceTask.produceTask.recycleTaskView._objCustomPropNames_IE ) {
				jsonObj = foundation.common.getObjectIE_CP_OBJ(gridEventObj,obj[0],rootKey,WOM.produceTask.produceTask.recycleTaskView._sUrl,WOM.produceTask.produceTask.recycleTaskView._objCustomPropNames_IE);
			} else {
				jsonObj = foundation.common.getObjectIE(gridEventObj,obj[0],rootKey,WOM.produceTask.produceTask.recycleTaskView._sUrl);
			}
			CUI.error_msg_DG_CP_map = {};
			var xmlHead = $(gridEventObj.oGrid._DT.opts.oXMLData).children( ':eq(0)' ).children( ':eq(0)' );
			if (WOM.produceTask.produceTask.recycleTaskView._isObjCustomProp_IE == true && WOM.produceTask.produceTask.recycleTaskView._objCustomPropNames_IE) { // 控件版PT显示自定义字段
				var showName = WOM.produceTask.produceTask.recycleTaskView._objCustomPropNames_IE.split(',')[0]; // 主显示字段名称
				var trueName = WOM.produceTask.produceTask.recycleTaskView._objCustomPropNames_IE.split(',')[1]; // 主键字段名称
			...
			if ( $('#dg_cp_info_' + gridEventObj.oGrid._DT.opts.id).length > 0 ) {
				...
				var id = jsonObj.id;
				var relationMap;
				if (dg_cp_info && id && WOM.produceTask.produceTask.recycleTaskView._refViewCode_IE) {
					$.ajax({
						async   : false,
						type    : 'POST',
						url     : '/foundation/customProp/related.action',
						data    : 'code=' + WOM.produceTask.produceTask.recycleTaskView._refViewCode_IE + '&id=' + id,
		...
		WOM.produceTask.produceTask.recycleTaskView.getcallBackInfo_DG = function(obj){
			if(WOM.produceTask.produceTask.recycleTaskView._customBeforeCallBack) {
				var flag = eval(WOM.produceTask.produceTask.recycleTaskView._customBeforeCallBack.split("(")[0] + "(obj)");
				if(flag === false){
					return false;
			...
			for(var i=0;i<obj.length;i++){
				if(i>0){
					if($(WOM.produceTask.produceTask.recycleTaskView._currRow).next().length==0){
						WOM.produceTask.produceTask.recycleTaskView._oGrid.addNewRow();
					}	
					WOM.produceTask.produceTask.recycleTaskView._currRow = $(WOM.produceTask.produceTask.recycleTaskView._currRow).next();
					$(WOM.produceTask.produceTask.recycleTaskView._currRow).attr('isEdited',true);
				}
				obj[i] = foundation.common.getObject(WOM.produceTask.produceTask.recycleTaskView._currRow,obj[i], WOM.produceTask.produceTask.recycleTaskView._prefix, WOM.produceTask.produceTask.recycleTaskView._sUrl);
				if (WOM.produceTask.produceTask.recycleTaskView._isObjCustomProp == true && WOM.produceTask.produceTask.recycleTaskView._objCustomPropNames) {
					eval("CUI.commonFills_DG_CP_OBJ(WOM.produceTask.produceTask.recycleTaskView._currRow,WOM.produceTask.produceTask.recycleTaskView._prefix,obj[i],WOM.produceTask.produceTask.recycleTaskView._oGrid,WOM.produceTask.produceTask.recycleTaskView._objCustomPropNames)");
				} else {
					eval("CUI.commonFills_DG(WOM.produceTask.produceTask.recycleTaskView._currRow,WOM.produceTask.produceTask.recycleTaskView._prefix,obj[i],WOM.produceTask.produceTask.recycleTaskView._oGrid)");
				}
				
				// 自定义字段参照回填
				if ( $('#dg_cp_info_' + WOM.produceTask.produceTask.recycleTaskView._oGrid.dataTableId).length > 0 ) {
					var dg_cp_info = $('#dg_cp_info_' + WOM.produceTask.produceTask.recycleTaskView._oGrid.dataTableId).val();
					var id = obj[i].id;
					var relationMap;
					if (dg_cp_info && id && WOM.produceTask.produceTask.recycleTaskView._refViewCode) {
						$.ajax({
							async   : false,
							type    : 'POST',
							url     : '/foundation/customProp/related.action',
							data    : 'code=' + WOM.produceTask.produceTask.recycleTaskView._refViewCode + '&id=' + id,
							success : function(res){
								if (res.dealSuccessFlag && res.relationMap) {
									relationMap = res.relationMap;
								}
						...
						if (relationMap) {
							...
							for (var n in infoArr) {
								...
								var val = relationMap[key];
								if (val) {
									name = WOM.produceTask.produceTask.recycleTaskView._oGrid.configs.hidekeyPrefix + name;
									objs[name] = val;
									if (propCode) {
										$.ajax({
											async   : false,
							...
							// console.log(objs);
							if (objs) {
								CUI.commonFills_DG_CP(WOM.produceTask.produceTask.recycleTaskView._currRow, objs, WOM.produceTask.produceTask.recycleTaskView._oGrid);
							}
						}
					}
				}
				...
				try{
					...
					for ( var item in  CUI.error_msg_DG_CP_map ){
						for ( var n in  CUI.error_msg_DG_CP_map[item] ){
							errorMsg += ( '<b>' + WOM.produceTask.produceTask.recycleTaskView._oGrid.getLabel(item) +  '</b>第<b>' + ( parseInt( n, 10 ) + 1)  + '</b>行回填失败！原因:系统编码值不匹配！<br/>' );
						}
					}
					if( errorMsg ){
						workbenchErrorBarWidget.showMessage( errorMsg );
		...
		WOM.produceTask.produceTask.recycleTaskView.getMultiselectCallBackInfo_DG = function(obj){
			for(var i=0;i<obj.length;i++){
				CUI.commonFillsMultiselect_DG(WOM.produceTask.produceTask.recycleTaskView._oGrid, WOM.produceTask.produceTask.recycleTaskView._currRow, WOM.produceTask.produceTask.recycleTaskView._key, WOM.produceTask.produceTask.recycleTaskView._displayFieldName, obj[i])
			}
			try{
				if(WOM.produceTask.produceTask.recycleTaskView._customCallBack) {
					eval(WOM.produceTask.produceTask.recycleTaskView._customCallBack);
		...
		WOM.produceTask.produceTask.recycleTaskView.generateInput = function(prefix, obj) {
			CUI.each(obj, function(key,value){
				if(value!=null && key!='rowHtmlObj' && key!='cellHtmlObj'){
					var name = prefix + '.' + key;
					if(typeof value == 'object') {
						WOM.produceTask.produceTask.recycleTaskView.generateInput(name, value);
					} else {
						if(value!=null&&value!='null'&&value!=undefined&&value!='') {
							CUI('input[name="' + name + '"]').remove();
							CUI('<input type="hidden" name="'+name+'" value="'+value+'">').appendTo(CUI('#WOM_produceTask_produceTask_recycleTaskView_form'));
						}
					}
				}
			});
		...
		$(function(){
			WOM.produceTask.produceTask.recycleTaskView.onloadForProduct();
	...
	if(batchProdTaskID != '' ){
		...
		WOM.produceTask.produceTask.recycleTaskView.beforeSubmitMethodSettingInPage = function(){
			WOM.produceTask.produceTask.recycleTaskView.onsaveForProduct();
		};
		WOM.produceTask.produceTask.recycleTaskView.beforeSubmitMethod = function(){
			...
			var customOnsaveResult =  WOM.produceTask.produceTask.recycleTaskView.beforeSubmitMethodSettingInPage();
		...
		<script type="text/javascript">
		WOM.produceTask.produceTask.recycleTaskView.showBusinessList = function(relatingModelCode,mainEntityId,businessCenterCode,url,showType){
			...
			if(CUI(id).html() == null || $.trim(CUI(id).html()) == ""){
				CUI(id).load(url);
				setTimeout(function(){
					CUI("#WOM_produceTask_produceTask_recycleTaskView_main_div").hide();
				},100);
			}else{
			    CUI(id).load(url);
				setTimeout(function(){
		...
		WOM.produceTask.produceTask.recycleTaskView.showThis = function(){
			if(!CUI("#WOM_produceTask_produceTask_recycleTaskView_main_div").is(':visible')) {
				CUI("#WOM_produceTask_produceTask_recycleTaskView_main_div").show();
		...
		WOM.produceTask.produceTask.recycleTaskView.showAudit=function(){
			<#if !id?? || editNew>
			CUI.Dialog.alert("${getText("foundation.base.audit.nolog")}")
			<#else>
			WOM.produceTask.produceTask.recycleTaskView.auditDialog = new CUI.Dialog({
				title : "${getText("foundation.base.audit")}",
				iframe : "WOM_produceTask_produceTask_recycleTaskView_auditInfo",
				modal:true,
			...
			WOM.produceTask.produceTask.recycleTaskView.auditDialog.show();
			</#if>
		}
		
		
		WOM.produceTask.produceTask.recycleTaskView.showInfoDialog=function(mode){
			
			WOM.produceTask.produceTask.recycleTaskView.infoDialog = new CUI.Dialog({
				title: "${getText("ec.view.info.view")}",
				elementId: "WOM_produceTask_produceTask_recycleTaskView_dealInfo",
				modal:true,
				height:500,
				width: 950,//适应国际化版
				buttons:[
			...
			WOM.produceTask.produceTask.recycleTaskView.infoDialog.show();
		...
		WOM.produceTask.produceTask.recycleTaskView.showFileUpload=function(){
		...
		WOM.produceTask.produceTask.recycleTaskView.showDealInfo=function(){
		...
		WOM.produceTask.produceTask.recycleTaskView.showFlowInfo=function(){
		...
		WOM.produceTask.produceTask.recycleTaskView.supervision=function(){
			WOM.produceTask.produceTask.recycleTaskView.modifyOwnerStaffDialog = new CUI.Dialog({
				...
				WOM.produceTask.produceTask.recycleTaskView.modifyOwnerStaffDialog.show();
		}
...
function setOtherValue(obj){
  ...
  formulaChange1();	
		...
		/* CUSTOM CODE START(view-VIEW-WOM_7.5.0.0_produceTask_recycleTaskView,js,WOM_7.5.0.0_produceTask_ProduceTask,WOM_7.5.0.0) */
// 自定义代码
...
/* CUSTOM CODE END */
		WOM.produceTask.produceTask.recycleTaskView.onloadForProduct = function(){
		/* CUSTOM CODE START(view-VIEW-WOM_7.5.0.0_produceTask_recycleTaskView,onloadForProduct,WOM_7.5.0.0_produceTask_ProduceTask,WOM_7.5.0.0) */
// 自定义代码

/* CUSTOM CODE END */
		}

		WOM.produceTask.produceTask.recycleTaskView.onsaveForProduct = function(){
		/* CUSTOM CODE START(view-VIEW-WOM_7.5.0.0_produceTask_recycleTaskView,onsaveForProduct,WOM_7.5.0.0_produceTask_ProduceTask,WOM_7.5.0.0) */
// 自定义代码
...
/* CUSTOM CODE END */		
		...
		<div class="col-sub">
			...
			<div class="edit-sidebar-inner" style='height:1000px;'>
				<div class="sidebar-top"><a href="#"  onclick="WOM.produceTask.produceTask.recycleTaskView.showThis()">${getText("ec.view.tableInfo")}</a></div>
					...
					<ul>
						<#list businessCenterList as l>
						 <li>
							...
							<#else>
								<a href="#"  onclick="WOM.produceTask.produceTask.recycleTaskView.showBusinessList('${l.relatingModel.code.replace('.','')}',${(produceTask.id)!},'${l.code}','${l.assview.url}?${getPowerCode(l.assview.code+'_self')}','${l.assview.showType}')" title="${getText(l.showName)}(${(l.count)!})">${getText(l.showName)}(${(l.count)!})</a>
							</#if>
						</li>
					    </#list>
					</ul>
