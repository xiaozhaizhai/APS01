			...
			<Row ss:AutoFitHeight="0">
				<#list exportFieldList as item>
					<#if item?length gt 0>
								...
								<#if item == 'headId.formularId.setProcess.value' || item == 'headId.formularId.setProcess.id' || item == '*'>
									<Cell>
									<#if checkFieldPermission('headId.formularId.setProcess','WOM_7.5.0.0_produceTask_ProduceMaterialSum','WOM_7.5.0.0_produceTask_ProduceMaterialSum_headId||WOM_7.5.0.0_produceTask_ProduceTask_formularId||RM_7.5.0.0_formula_Formula_setProcess') != 0>
