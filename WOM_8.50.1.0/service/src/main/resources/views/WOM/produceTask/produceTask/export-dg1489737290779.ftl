			...
			<Row ss:AutoFitHeight="0">
				<#list exportFieldList as item>
					<#if item?length gt 0>
								...
								<#if item == 'activeId.name' || item == '*'>
									<Cell>
									<#if checkFieldPermission('activeId.name','WOM_7.5.0.0_produceTask_ProduceTaskActive','WOM_7.5.0.0_produceTask_ProduceTaskActive_activeId||RM_7.5.0.0_formula_FormulaProcessActive_name') != 0>
