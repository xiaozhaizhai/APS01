...
<GridData DefaultNodeExpanded="false"   dgName="dg1540191119898" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<name
					sort="true"  onPropertyChange="ProduceTaskProcess_dg1540191119898Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<processType.name
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(ProduceTaskProcess_dg1540191119898Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(ProduceTaskProcess_dg1540191119898Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/RM/processType/processType/processTypeRef.action','dg1540191119898processType.name','${getText("RM.viewtitle.randon1487220867598")}',sPTGridID,nRow,sFieldName,ProduceTaskProcess_dg1540191119898Widget,null,false,false,'','RM_7.5.0.0_processType_processTypeRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="ProduceTaskProcess_dg1540191119898Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<#assign processState_defaultValue='processState/state01'>
						 						<#assign processState_defaultValue='processState/state01'>
				<#assign processState_defaultText=''>
				<processState.id
					sort="true"  onPropertyChange="ProduceTaskProcess_dg1540191119898Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
						...
						<#if (processState_defaultValue)?? &&(processState_defaultValue)?has_content>
							defaultValue='${(processState_defaultValue!)?string}'
						</#if>
						<#if (processState_defaultText)?? &&(processState_defaultText)?has_content>
							defaultText='${(processState_defaultText!)?string}'
						</#if>
						
					align="center" 
					showFormat="SELECTCOMP" 
						type="SELECTCOMP" 
					width="100">工序状态</processState.id>
				<#assign isRef = false >
					...
					sort="true"  onPropertyChange="ProduceTaskProcess_dg1540191119898Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
						...
						hideButtonsOnReadOnly="true"
									  onBlur="document.body.click()" 
									   buttonImg="Calendar" onClick="initCalender(ProduceTaskProcess_dg1540191119898Widget,'ProduceTaskProcess_dg1540191119898Widget',nRow,sFieldName,'datetime')" 
									   onBtnClick="showCalender(ProduceTaskProcess_dg1540191119898Widget,'ProduceTaskProcess_dg1540191119898Widget',nRow,sFieldName,'datetime')" 
				...
				<factoryId.name
						style="font-color:0303B3"
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(ProduceTaskProcess_dg1540191119898Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(ProduceTaskProcess_dg1540191119898Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/factoryModel/factoryModel/factroyRef1.action','dg1540191119898factoryId.name','${getText("MESBasic.viewtitle.radion1419491307826")}',sPTGridID,nRow,sFieldName,ProduceTaskProcess_dg1540191119898Widget,null,false,false,'','MESBasic_1_factoryModel_factroyRef1')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="ProduceTaskProcess_dg1540191119898Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<#list customPropViewMappings as cpvm>
					...
					<#if cpvm.property.type == 'OBJECT'>
						...
						<#if cpvm.refView??>
							...
							onFocus="CUI.toggleClearBtn_DG_IE(ProduceTaskProcess_dg1540191119898Widget,nRow,sFieldName)"
							onBtnClick="CUI.clearCellValue_DG_IE(ProduceTaskProcess_dg1540191119898Widget,nRow,sFieldName,true)"
							subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('${viewUrl!}','dg1540191119898${cpvm.propertyLayRec}','${getText("${viewTitle}")}',sPTGridID,nRow,'${cpvm.propertyLayRec}',ProduceTaskProcess_dg1540191119898Widget,null,false,true,'${mainDisplayName},${pkName}','${viewCode}')"
							hideEditOnReadOnly="true"
						</#if>
					</#if>
						sort="true"
						onPropertyChange="ProduceTaskProcess_dg1540191119898Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
					...
					<#elseif cpvm.property.type == 'DATETIME'>
						...
						onClick="initCalender(ProduceTaskProcess_dg1540191119898Widget,'ProduceTaskProcess_dg1540191119898Widget',nRow,sFieldName,<#if cpvm.format == 'YMD_H'>'dateTimeHour'<#elseif cpvm.format == 'YMD_HM'>'dateTimeMin'<#else>'datetime'</#if>)"
						onBtnClick="showCalender(ProduceTaskProcess_dg1540191119898Widget,'ProduceTaskProcess_dg1540191119898Widget',nRow,sFieldName,<#if cpvm.format == 'YMD_H'>'dateTimeHour'<#elseif cpvm.format == 'YMD_HM'>'dateTimeMin'<#else>'datetime'</#if>)"
						control="Text"
				...
				<formularProcess.id
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(ProduceTaskProcess_dg1540191119898Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(ProduceTaskProcess_dg1540191119898Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/RM/formula/formulaProcess/processReference.action','dg1540191119898formularProcess.id','${getText("RM.viewtitle.randon1488596828660")}',sPTGridID,nRow,sFieldName,ProduceTaskProcess_dg1540191119898Widget,null,false,false,'','RM_7.5.0.0_formula_processReference')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="ProduceTaskProcess_dg1540191119898Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
