...
<GridData DefaultNodeExpanded="false"   dgName="dg1496370446677" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<productId.productCode
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(ProduceMaterialSum_dg1496370446677Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(ProduceMaterialSum_dg1496370446677Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/product/product/productRefNew.action','dg1496370446677productId.productCode','${getText("MESBasic.viewtitle.randon1475137145215")}',sPTGridID,nRow,sFieldName,ProduceMaterialSum_dg1496370446677Widget,null,false,false,'','MESBasic_1_product_productRefNew')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="ProduceMaterialSum_dg1496370446677Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
					...
					showFormat="SELECTCOMP" 
						type="SELECTCOMP" 
					width="120">物品编码</productId.productCode>
				<#assign isRef = false >
				...
				<productId.productName
					...
					showFormat="TEXT" 
						type="TEXTFIELD" 
					width="120">物品名称</productId.productName>
				<#assign isRef = false >
			...
			<#if cpObjHideKey?? && cpObjHideKey?has_content>
				<#list cpObjHideKey?split(',') as key>
					...
					<#assign WOM_7_5_0_0_produceTask_ProduceMaterialSum_standardNum_permit = checkFieldPermission('standardNum','WOM_7.5.0.0_produceTask_ProduceMaterialSum','WOM_7.5.0.0_produceTask_ProduceMaterialSum_standardNum')>
						...
						<c><#if WOM_7_5_0_0_produceTask_ProduceMaterialSum_standardNum_permit != 0><#if (row.standardNum)?has_content>#{(row.standardNum)!; m2M2}</#if></#if></c>
					<#if !WOM_7_5_0_0_produceTask_ProduceMaterialSum_minQuality_permit??>
					<#assign WOM_7_5_0_0_produceTask_ProduceMaterialSum_minQuality_permit = checkFieldPermission('minQuality','WOM_7.5.0.0_produceTask_ProduceMaterialSum','WOM_7.5.0.0_produceTask_ProduceMaterialSum_minQuality')>
					</#if>
						<c><#if WOM_7_5_0_0_produceTask_ProduceMaterialSum_minQuality_permit != 0><#if (row.minQuality)?has_content>#{(row.minQuality)!; m2M2}</#if></#if></c>
					<#if !WOM_7_5_0_0_produceTask_ProduceMaterialSum_maxQuality_permit??>
					<#assign WOM_7_5_0_0_produceTask_ProduceMaterialSum_maxQuality_permit = checkFieldPermission('maxQuality','WOM_7.5.0.0_produceTask_ProduceMaterialSum','WOM_7.5.0.0_produceTask_ProduceMaterialSum_maxQuality')>
					</#if>
						<c><#if WOM_7_5_0_0_produceTask_ProduceMaterialSum_maxQuality_permit != 0><#if (row.maxQuality)?has_content>#{(row.maxQuality)!; m2M2}</#if></#if></c>
