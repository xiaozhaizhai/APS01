...
<GridData DefaultNodeExpanded="false"   dgName="dg1489737290779" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<processId.name
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(ProduceTaskActive_dg1489737290779Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(ProduceTaskActive_dg1489737290779Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/RM/formula/formulaProcess/processReference.action','dg1489737290779processId.name','${getText("RM.viewtitle.randon1488596828660")}',sPTGridID,nRow,sFieldName,ProduceTaskActive_dg1489737290779Widget,null,false,false,'','RM_7.5.0.0_formula_processReference')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="ProduceTaskActive_dg1489737290779Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<activeId.name
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(ProduceTaskActive_dg1489737290779Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(ProduceTaskActive_dg1489737290779Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/RM/formula/formulaProcessActive/activeRef.action','dg1489737290779activeId.name','${getText("RM.viewtitle.randon1489564694469")}',sPTGridID,nRow,sFieldName,ProduceTaskActive_dg1489737290779Widget,null,false,false,'','RM_7.5.0.0_formula_activeRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="ProduceTaskActive_dg1489737290779Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				    
				    
						hideButtonsOnReadOnly="true"
						<#assign WOM_7_5_0_0_produceTask_ProduceTaskActive_activeId_RM_7_5_0_0_formula_FormulaProcessActive_name_permit = checkFieldPermission('activeId.name','WOM_7.5.0.0_produceTask_ProduceTaskActive','RM_7.5.0.0_formula_FormulaProcessActive_name')>
						<#if WOM_7_5_0_0_produceTask_ProduceTaskActive_activeId_RM_7_5_0_0_formula_FormulaProcessActive_name_permit == 0>
						fieldPermit="0" title="${getText('ec.view.nopermittitle')}"
						</#if>
						<#if WOM_7_5_0_0_produceTask_ProduceTaskActive_activeId_RM_7_5_0_0_formula_FormulaProcessActive_name_permit == 1>
						fieldPermit="1" title="${getText('ec.view.readonlytitle')}"
						</#if>
				...
				<activeId.fromContainer.id
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(ProduceTaskActive_dg1489737290779Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(ProduceTaskActive_dg1489737290779Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/RM/formula/formulaProcessActive/activeRef.action','dg1489737290779activeId.fromContainer','${getText("RM.viewtitle.randon1489564694469")}',sPTGridID,nRow,sFieldName,ProduceTaskActive_dg1489737290779Widget,null,false,false,'','RM_7.5.0.0_formula_activeRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="ProduceTaskActive_dg1489737290779Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<activeId.occurTurn.id
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(ProduceTaskActive_dg1489737290779Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(ProduceTaskActive_dg1489737290779Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/RM/formula/formulaProcessActive/activeRef.action','dg1489737290779activeId.occurTurn','${getText("RM.viewtitle.randon1489564694469")}',sPTGridID,nRow,sFieldName,ProduceTaskActive_dg1489737290779Widget,null,false,false,'','RM_7.5.0.0_formula_activeRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="ProduceTaskActive_dg1489737290779Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<productId.productCode
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(ProduceTaskActive_dg1489737290779Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(ProduceTaskActive_dg1489737290779Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/product/product/productRefNew.action','dg1489737290779productId.productCode','${getText("MESBasic.viewtitle.randon1475137145215")}',sPTGridID,nRow,sFieldName,ProduceTaskActive_dg1489737290779Widget,null,false,false,'','MESBasic_1_product_productRefNew')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="ProduceTaskActive_dg1489737290779Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
		...
		<row  >
			...
			<#if cpObjHideKey?? && cpObjHideKey?has_content>
				<#list cpObjHideKey?split(',') as key>
					...
					<#if !WOM_7_5_0_0_produceTask_ProduceTaskActive_activeId_RM_7_5_0_0_formula_FormulaProcessActive_name_permit??>
					<#assign WOM_7_5_0_0_produceTask_ProduceTaskActive_activeId_RM_7_5_0_0_formula_FormulaProcessActive_name_permit = checkFieldPermission('activeId.name','WOM_7.5.0.0_produceTask_ProduceTaskActive','RM_7.5.0.0_formula_FormulaProcessActive_name')>
					</#if>
							<c><#if WOM_7_5_0_0_produceTask_ProduceTaskActive_activeId_RM_7_5_0_0_formula_FormulaProcessActive_name_permit != 0><#if (row.activeId.name)?has_content>${(row.activeId.name)!}</#if></#if></c>
					...
					<#assign WOM_7_5_0_0_produceTask_ProduceTaskActive_activeId_RM_7_5_0_0_formula_FormulaProcessActive_longTime_permit = checkFieldPermission('activeId.longTime','WOM_7.5.0.0_produceTask_ProduceTaskActive','RM_7.5.0.0_formula_FormulaProcessActive_longTime')>
						...
						<c><#if WOM_7_5_0_0_produceTask_ProduceTaskActive_activeId_RM_7_5_0_0_formula_FormulaProcessActive_longTime_permit != 0><#if (row.activeId.longTime)?has_content>#{(row.activeId.longTime)!; m6M6}</#if></#if></c>
