<!-- WOM_7.5.0.0/produceTask/makeTaskEdit -->
...
<#-- 命名空间 -->
<#assign editPageNs = "WOM.produceTask.produceTask.makeTaskEdit">
<#-- 模型名称-->
<#assign modelName = "produceTask">
<#-- 视图编码-->
<#assign viewCode = "WOM_7.5.0.0_produceTask_makeTaskEdit">
<#-- 实体编码-->
<#assign entity_code = "WOM_7.5.0.0_produceTask">
<#-- 视图名称-->
<#assign viewName = "makeTaskEdit">
<#-- datagrid编码-->
<#assign datagridCode = "WOM_produceTask_produceTask_makeTaskEdit_datagrids">
<#-- 首字母大写的模型名称-->
...
<#-- formid -->
<#assign editFormId = "WOM_produceTask_produceTask_makeTaskEdit_form">
<#-- 待办状态 -->
<#assign pendingstatus =( produceTask.pending.taskDescription)!>
<#-- 打印控件名称 -->
<#assign controlName = "WOM.viewcontrolName.randon1553584928204">
<#-- 批量？？ -->
...
<head>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <#assign configTitle = getText('WOM.viewtitle.randon1489669890981')>
		...
		#WOM_produceTask_produceTask_makeTaskEdit_form{float:left;width:100%;}
		
		
		</style>
		<script type="text/javascript">
			CUI.ns('WOM.produceTask.produceTask.makeTaskEdit');
			WOM.produceTask.produceTask.makeTaskEdit.currentUser = ${userJson};
			WOM.produceTask.produceTask.makeTaskEdit.currentStaff = ${staffJson};
			WOM.produceTask.produceTask.makeTaskEdit.currentDepartment = ${deptJson};
			WOM.produceTask.produceTask.makeTaskEdit.currentPosition = ${postJson};
			WOM.produceTask.produceTask.makeTaskEdit.currentCompany = ${compJson};
		</script>
		<!-- CUSTOM CODE START(view-EDIT-WOM_7.5.0.0_produceTask_makeTaskEdit,head,WOM_7.5.0.0_produceTask_ProduceTask,WOM_7.5.0.0) -->
<!-- 自定义代码 -->
...
<!-- CUSTOM CODE END -->
	...
	<body class="view-edit ">
		...
		<@s.form errorBarId="workbenchErrorBar" hiddenField="produceTask.factoryId.id,produceTask.manuOrderMain.id,produceTask.formularId.id,produceTask.id,produceTask.productId.id,produceTask.planParId.id," onsubmitMethod="WOM.produceTask.produceTask.makeTaskEdit.beforeSubmitMethod()" id="WOM_produceTask_produceTask_makeTaskEdit_form" namespace="/WOM/produceTask/produceTask/makeTaskEdit" action="submit?__pc__=${(Parameters.__pc__)!}&_bapFieldPermissonModelCode_=WOM_7.5.0.0_produceTask_ProduceTask&_bapFieldPermissonModelName_=ProduceTask&superEdit=${(superEdit!false)?string}" editPageNs="WOM.produceTask.produceTask.makeTaskEdit" callback="WOM.produceTask.produceTask.makeTaskEdit._callBackInfo" ecform="true">
			<input type="hidden" name="bap_validate_user_id" value="${(Session.user.id)!}" />
			<div style="float:none;width:auto;" class="edit-main grid-s5m0 col-main main-wrap" id="WOM_produceTask_produceTask_makeTaskEdit_main_div">
			<div class="edit-head">
				<#include "../../../ec/tableInfo/operateheadbar_all.ftl" >
				<#include "../../../ec/tableInfo/creatorInfo.ftl" >
			</div>
    		<div class="edit-main" id="WOM_produceTask_produceTask_makeTaskEdit">
...
<script type="text/javascript">
var attcountid = "WOM_produceTask_produceTask_makeTaskEdit_form"+"_attcount";
	...
	<table class="edit-table" style="">
		...
		<tr >
								...
								<#if !(produceTask.id)?? && (produceTask.productId.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('WOM_produceTask_produceTask_makeTaskEdit_form',obj, 'produceTask.productId', '/MESBasic/product/product/refProductLayout.action');
												CUI.commonFills('WOM_produceTask_produceTask_makeTaskEdit_form', 'produceTask.productId',obj,true);
											}
										});
									})(jQuery);
								</#if>
					...
					<td  nullable=false class="edit-table-content"   align="left" style="text-align: left;;" >
									...
									<@mneclient iframe=mneIframe!false property_type="BAPCODE" mneenable=false reftitle="${getText('RM.viewtitle.randon1488246963795')}" viewType="${viewType!}" deValue="${produceTask_formularId_code_defaultValue!}" conditionfunc="WOM.produceTask.produceTask.makeTaskEdit._querycustomFunc('produceTask_formularId_code')"  value="${(produceTask.formularId.code)!}" displayFieldName="code" name="produceTask.formularId.code" id="produceTask_formularId_code" type="other" url="/RM/formula/formula/formulaRef.action" clicked=true multiple=false mnewidth=260 formId="WOM_produceTask_produceTask_makeTaskEdit_form" editCustomCallback="_callback_produceTask(obj);" refViewCode="RM_7.5.0.0_formula_formulaRef"  onkeyupfuncname="_callback_produceTask(obj);_callback_produceTask_formularId_code(obj);" cssStyle="" isEdit=true   isCrossCompany=false  editLinkCallBack="_callback_produceTask_formularId_code_edit" delCustomCallback="_del_callback_produceTask_formularId_code()"/>
								...
								<#if !(produceTask.id)?? && (produceTask.formularId.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('WOM_produceTask_produceTask_makeTaskEdit_form',obj, 'produceTask.formularId', '/RM/formula/formula/formulaRef.action');
												CUI.commonFills('WOM_produceTask_produceTask_makeTaskEdit_form', 'produceTask.formularId',obj,true);
											}
										});
									})(jQuery);
								</#if>
								
									WOM.produceTask.produceTask.makeTaskEdit.query_produceTask_formularId_code = function() {
						...
						<#assign produceTask_taskType_defaultValue  = 'womTaskType/type1'>
								...
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${produceTask_taskType_defaultValue!}" formId="WOM_produceTask_produceTask_makeTaskEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.taskType.id" code="womTaskType" value="${(produceTask.taskType.id)!}"  />
									
								<#else>
									
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="WOM_produceTask_produceTask_makeTaskEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.taskType.id" code="womTaskType" value="${(produceTask.taskType.id)!}"  />
								...
								<#if !(produceTask.id)?? && (produceTask.factoryId.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('WOM_produceTask_produceTask_makeTaskEdit_form',obj, 'produceTask.factoryId', '/MESBasic/factoryModel/factoryModel/factoryProductRef.action');
												CUI.commonFills('WOM_produceTask_produceTask_makeTaskEdit_form', 'produceTask.factoryId',obj,true);
											}
										});
									})(jQuery);
								</#if>
								
									WOM.produceTask.produceTask.makeTaskEdit.query_produceTask_factoryId_name = function() {
					...
					<td  nullable=true class="edit-table-content" celltype="DATETIME"  align="left" style="text-align: left;;" >
						...
						<#assign produceTask_autoReportOnFinish_defaultValue  = ''>
								...
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${produceTask_autoReportOnFinish_defaultValue!}" formId="WOM_produceTask_produceTask_makeTaskEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false  name="produceTask.autoReportOnFinish.id" code="autoReportOnFinish" value="${(produceTask.autoReportOnFinish.id)!}"  />
									
								<#else>
									
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="WOM_produceTask_produceTask_makeTaskEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false  name="produceTask.autoReportOnFinish.id" code="autoReportOnFinish" value="${(produceTask.autoReportOnFinish.id)!}"  />
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
									...
									<@mneclient iframe=mneIframe!false property_type="TEXT" mneenable=false reftitle="${getText('WOM.viewtitle.randon1563350015905')}" viewType="${viewType!}" deValue="${produceTask_manuOrderMain_manulOrderNum_defaultValue!}" conditionfunc="WOM.produceTask.produceTask.makeTaskEdit._querycustomFunc('produceTask_manuOrderMain_manulOrderNum')"  value="${(produceTask.manuOrderMain.manulOrderNum)!}" displayFieldName="manulOrderNum" name="produceTask.manuOrderMain.manulOrderNum" id="produceTask_manuOrderMain_manulOrderNum" type="other" url="/WOM/manulOrder/manulOrderMain/manulOrdersRef.action" clicked=true multiple=false mnewidth=260 formId="WOM_produceTask_produceTask_makeTaskEdit_form" editCustomCallback="callbackPosition(obj);" refViewCode="WOM_7.5.0.0_manulOrder_manulOrdersRef"  onkeyupfuncname="callbackPosition(obj);_callback_produceTask_manuOrderMain_manulOrderNum(obj);" cssStyle="" isEdit=true   isCrossCompany=false  editLinkCallBack="_callback_produceTask_manuOrderMain_manulOrderNum_edit" delCustomCallback="_del_callback_produceTask_manuOrderMain_manulOrderNum()"/>
								...
								<#if !(produceTask.id)?? && (produceTask.manuOrderMain.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('WOM_produceTask_produceTask_makeTaskEdit_form',obj, 'produceTask.manuOrderMain', '/WOM/manulOrder/manulOrderMain/manulOrdersRef.action');
												CUI.commonFills('WOM_produceTask_produceTask_makeTaskEdit_form', 'produceTask.manuOrderMain',obj,true);
											}
										});
									})(jQuery);
								</#if>
								
									WOM.produceTask.produceTask.makeTaskEdit.query_produceTask_manuOrderMain_manulOrderNum = function() {
										return "factoryModelId="+$("[name='produceTask.factoryId.id']").val()+"&product="+$("[name='produceTask.productId.id']").val();
									}
								</script>
							...
							<label style="width:100%;;" value="${getText('WOM.propertydisplayName.randon1563257869976')}" >${getText('WOM.propertydisplayName.randon1563257869976')}</label>
				</td>
				
						<#assign produceTask_team_defaultValue  = ''>
							 							<#assign produceTask_team_defaultValue  = ''>
					<td  nullable=true class="edit-table-content"   style="text-align: left;;" >
								...
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${produceTask_team_defaultValue!}" formId="WOM_produceTask_produceTask_makeTaskEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false  name="produceTask.team.id" code="WOM_workTeam" value="${(produceTask.team.id)!}"  />
									
								<#else>
									
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="WOM_produceTask_produceTask_makeTaskEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false  name="produceTask.team.id" code="WOM_workTeam" value="${(produceTask.team.id)!}"  />
		...
		<#assign cpvmInfo = ''>
			<#assign customPropList = getShowCustomProps("WOM_7.5.0.0_produceTask_ProduceTask", "WOM_7.5.0.0_produceTask_makeTaskEdit", 'EDIT')>
				...
				<td nullable=<#if (c.nullable!false)>true<#else>false</#if> class="edit-table-content" <#if c.fieldType?? && c.fieldType == 'DATATIME'>celltype="DATATIME"</#if> <#if cspan gt 1>colspan="${colspanVal}"</#if> style="text-align:left;">
					...
					<#elseif fieldType == 'SELECTCOMP'>
						<#if columnType == 'SYSTEMCODE'>
							...
							<@systemcode property_type="${columnType}" iscustom=true showType="${fieldType}" viewType=viewType cssStyle="text-align:${c.align!}" formId="WOM_produceTask_produceTask_makeTaskEdit_form" classStyle="cui-noborder-input" view=(c.readonly!false) cssStyle="" ecFlag=true multable=isMultable name="${elementName}" code="${(c.property.fillcontentMap.fillContent)!}" value="${produceTask[columnName]!}" seniorSystemCode=isS2 />
						<#else>
		...
		<tr >
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;display:none;" >
								...
								<#else>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="WOM_produceTask_produceTask_makeTaskEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.formularId.setProcess.id" code="formulaProperty" value="${(produceTask.formularId.setProcess.id)!}"  />
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
								...
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${produceTask_workType_defaultValue!}" formId="WOM_produceTask_produceTask_makeTaskEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.workType.id" code="produceType" value="${(produceTask.workType.id)!}"  />
									
								<#else>
									
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="WOM_produceTask_produceTask_makeTaskEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.workType.id" code="produceType" value="${(produceTask.workType.id)!}"  />
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
									...
									<@mneclient iframe=mneIframe!false property_type="TEXT" mneenable=false reftitle="${getText('WOM.viewtitle.randon1489823707131')}" viewType="${viewType!}" deValue="${produceTask_planParId_dayPlanInfo_tableNo_defaultValue!}" conditionfunc="WOM.produceTask.produceTask.makeTaskEdit._querycustomFunc('produceTask_planParId_dayPlanInfo_tableNo')"  value="${(produceTask.planParId.dayPlanInfo.tableNo)!}" displayFieldName="tableNo" name="produceTask.planParId.dayPlanInfo.tableNo" id="produceTask_planParId_dayPlanInfo_tableNo" type="other" url="/WOM/producePlanRef/dayBatchPlanParts/planRef.action" clicked=true multiple=false mnewidth=260 formId="WOM_produceTask_produceTask_makeTaskEdit_form" editCustomCallback="setOtherValue(obj);" refViewCode="WOM_7.5.0.0_producePlanRef_planRef"  onkeyupfuncname="setOtherValue(obj);_callback_produceTask_planParId_dayPlanInfo_tableNo(obj);" cssStyle="" isEdit=true   isCrossCompany=false  />
								...
								<#if !(produceTask.id)?? && (produceTask.planParId.dayPlanInfo.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('WOM_produceTask_produceTask_makeTaskEdit_form',obj, 'produceTask.planParId.dayPlanInfo', '/WOM/producePlanRef/dayBatchPlanParts/planRef.action');
												CUI.commonFills('WOM_produceTask_produceTask_makeTaskEdit_form', 'produceTask.planParId.dayPlanInfo',obj,true);
											}
										});
									})(jQuery);
								</#if>
								
									WOM.produceTask.produceTask.makeTaskEdit.query_produceTask_planParId_dayPlanInfo_tableNo = function() {
...
<#assign colAdmFlag=checkUserPermisition('ec_ptManage_list_view')>
			...
			<#assign cpvmInfo = ''>
							...
							<script type="text/javascript">
								function ProduceTaskActive_dg1489730796226_copyNewRowDataFunc(event)
																{
	//获得选中行
	...
	CUI.Dialog.confirm("${getText('WOM.confirmcontent.radion1504182834291')}",
		...
		workbenchErrorBarWidget.showMessage("${getText('WOM.showMessage00000013')}");
			...
			<#if  refId?? && (refId > 0)>
				<#assign dUrl="/WOM/produceTask/produceTask/data-dg1489730796226.action?produceTask.id=${refId!-1}&refId=${refId!-1}&datagridCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489730796226">
			<#else>
				<#assign dUrl="/WOM/produceTask/produceTask/data-dg1489730796226.action?produceTask.id=${(produceTask.id)!-1}&datagridCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489730796226">
			</#if>
			<#assign firstLoad = true>
				
			<#if viewType?? && viewType != "readonly" && newObj?? && !newObj && !(refId?? && (refId > 0))>
				<#assign buttons="[{text:\"${getText('WOM.buttonPropertyshowName.radion1503995839036')}\",handler:function(event){ProduceTaskActive_dg1489730796226_copyNewRowDataFunc(event)},iconClass:\"cui-btn-add\",useInMore:\"false\"}]">
			...
			<#else>
				...
				<#if cpvmInfo?? && cpvmInfo?length gt 0>
					<#assign cpvmInfo = cpvmInfo?substring(1)>
					<input type="hidden" id="dg_cp_info_ProduceTaskActive_dg1489730796226" value="${cpvmInfo!}" />
				</#if>
			
			<input type="hidden" id="dg1489730796226_id" value="ProduceTaskActive_dg1489730796226" />
			
			<input type="hidden" id="dg1489730796226_url" value="${dUrl}" />
			
			<#assign assModelDisplayName = getText('WOM.modelname.randon1489671093316')!>
			<#assign assModelDisplayName = assModelDisplayName + getText('ec.common.validate.colon') >
			<@exportexcel action="/WOM/produceTask/produceTask/data-dg1489730796226.action?operateType=export&datagridCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489730796226"  settingtext="" settingUrl="" prepareParams="" formId="" look="text" width=250 height=170 text="" exportPageChoose=0 dtPage="dgPage" prefix="ProduceTaskActive_dg1489730796226" />
			<@datagrid colAdminFlag=colAdmFlag withoutConfigTable=true id="ProduceTaskActive_dg1489730796226" viewType="${viewType}" renderOverEvent="dg1489730796226RenderOverEvent" route="${routeFlag}" formId="WOM_produceTask_produceTask_makeTaskEdit_form" noPermissionKeys="productId.productCode,productId.id,productId.productName,orderProcessId.name,name,activeType,exeSystem,isReplace,property,standardNum,planNum,productId.productBaseUnit.name,isMixQuality,phase,sequence,needWeigh,batchNumObj.batchText,minQuality,maxQuality,lossRate,remark,batchNumObj.id,orderProcessId.id,activeId.id,formulaId.id,processId.id,putBatMateId.id,offerOrder,actOrder" modelCode="WOM_7.5.0.0_produceTask_ProduceTaskActive" dataUrl="${dUrl}" postData="&dgPage.pageSize=65536" dataGridName="dg1489730796226" dtPage="dgPage"  hidekeyPrefix="dg1489730796226" hidekey="['id','version','productId.id','productId.productCode','productId.id','productId.id','productId.id','productId.productName','orderProcessId.id','orderProcessId.name','productId.id','productId.productBaseUnit.name','batchNumObj.id','batchNumObj.batchText','batchNumObj.id','batchNumObj.id','orderProcessId.id','orderProcessId.id','activeId.id','activeId.id','formulaId.id','formulaId.id','processId.id','processId.id','putBatMateId.id','putBatMateId.id'${cpObjHideKey!''}]" transMethod="post" paginator=false editable=true buttons="${buttons}"  canImportExcel=canImportExcel noPadding=true isEdit=true tabViewIndex=0 pageInitMethod="dg1489730796226PageInitMethod"  defaultNodeExpanded=nodeExpanded  cannotAddNewRow=true cannotDeleteRow=false assModelDisplayName=assModelDisplayName dgTitle="${getText('WOM.dataGriddataGridName.radion1490443916302')}" activexButton="WOM.buttonPropertyshowName.radion1503995839036,copyNewRowDataFunc,add" exportExcel=exportExcel addNewRow=false   canInsertRow=false  insertRowAble=true firstLoad=firstLoad  copyRow=false  copyColumn=false  ptRealTimeLoad=0 >		
							...
							<#elseif (productId_productCode_defaultValue!)?string=="currentComp">
								<#assign productId_productCode_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.productCode"        showFormat="SELECTCOMP" defaultValue="${(productId_productCode_defaultValue!)?string}" defaultDisplay="${(productId_productCode_displayDefaultType!)?string}" decimal="" editable=false type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="left"  viewUrl="/MESBasic/product/product/refProductLayout.action" viewCode="MESBasic_1_product_refProductLayout" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1450085069587')}"  label="${getText('WOM.propertydisplayName.radion14157726448331')}" width=100 showFormatFunc=""  />
							...
							<#elseif (productId_id_defaultValue!)?string=="currentComp">
								<#assign productId_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.id"        showFormat="TEXT" defaultValue="${(productId_id_defaultValue!)?string}" defaultDisplay="${(productId_id_displayDefaultType!)?string}" decimal="" editable=false type="long" showType="long" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="center" hiddenCol=true viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('MESBasic.propertydisplayName.randon1449796384550')}" width=100 showFormatFunc=""  />
							...
							<#elseif (productId_productName_defaultValue!)?string=="currentComp">
								<#assign productId_productName_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.productName"        showFormat="TEXT" defaultValue="${(productId_productName_defaultValue!)?string}" defaultDisplay="${(productId_productName_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="left"  viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('WOM.propertydisplayName.radion1415772740737455')}" width=100 showFormatFunc=""  />
							...
							<#elseif (productId_productBaseUnit_name_defaultValue!)?string=="currentComp">
								<#assign productId_productBaseUnit_name_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.productBaseUnit.name"        showFormat="TEXT" defaultValue="${(productId_productBaseUnit_name_defaultValue!)?string}" defaultDisplay="${(productId_productBaseUnit_name_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="left"  viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('WOM.propertydisplayName.radion1398235640483')}" width=60 showFormatFunc=""  />
							...
							<#elseif (batchNumObj_batchText_defaultValue!)?string=="currentComp">
								<#assign batchNumObj_batchText_defaultValue='${compJson!}'>
									...
									<@datacolumn key="batchNumObj.batchText"        showFormat="SELECTCOMP" defaultValue="${(batchNumObj_batchText_defaultValue!)?string}" defaultDisplay="${(batchNumObj_batchText_displayDefaultType!)?string}" decimal="" editable=true type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="left"  viewUrl="/WOM/standingcropRef/standingcropRef/batchNumOneMakeTask.action" viewCode="WOM_7.5.0.0_standingcropRef_batchNumOneMakeTask" mneenable=false crossCompany=false viewTitle="${getText('WOM.viewtitle.randon1503994294075')}"  label="${getText('WOM.propertydisplayName.randon1490064501469')}" width=100 showFormatFunc=""  />
								...
								<#else>
									...
									<#if cpvmColumnType == 'OBJECT'>
										<#if cpvm.refView??>
											...
											<#assign selectCompName = 'WOM.produceTask.produceTask.makeTaskEdit'>
										</#if>
										<#assign pkName = ''>
										<#assign mainDisplayName = ''>
							...
							<#elseif (batchNumObj_id_defaultValue!)?string=="currentComp">
								<#assign batchNumObj_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="batchNumObj.id"        showFormat="TEXT" defaultValue="${(batchNumObj_id_defaultValue!)?string}" defaultDisplay="${(batchNumObj_id_displayDefaultType!)?string}" decimal="" editable=false type="long" showType="long" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="center" hiddenCol=true viewUrl="/WOM/standingcropRef/standingcropRef/batchNumOneBatRef.action" viewCode="WOM_7.5.0.0_standingcropRef_batchNumOneBatRef" mneenable=false crossCompany=false viewTitle="${getText('WOM.viewtitle.randon1502607384728')}"  label="${getText('ec.common.ID')}" width=100 showFormatFunc=""  />
							...
							<#elseif (orderProcessId_id_defaultValue!)?string=="currentComp">
								<#assign orderProcessId_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="orderProcessId.id"        showFormat="TEXT" defaultValue="${(orderProcessId_id_defaultValue!)?string}" defaultDisplay="${(orderProcessId_id_displayDefaultType!)?string}" decimal="" editable=false type="long" showType="long" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="center" hiddenCol=true viewUrl="/WOM/produceTask/produceTaskProcess/taskProcessRef.action" viewCode="WOM_7.5.0.0_produceTask_taskProcessRef" mneenable=false crossCompany=false viewTitle="${getText('WOM.viewtitle.randon1490685207348')}"  label="${getText('ec.common.ID')}" width=100 showFormatFunc=""  />
							...
							<#elseif (activeId_id_defaultValue!)?string=="currentComp">
								<#assign activeId_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="activeId.id"        showFormat="TEXT" defaultValue="${(activeId_id_defaultValue!)?string}" defaultDisplay="${(activeId_id_displayDefaultType!)?string}" decimal="" editable=false type="long" showType="long" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="center" hiddenCol=true viewUrl="/RM/formula/formulaProcessActive/activeCheckRef.action" viewCode="RM_7.5.0.0_formula_activeCheckRef" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1497922173328')}"  label="${getText('ec.common.ID')}" width=100 showFormatFunc=""  />
							...
							<#elseif (formulaId_id_defaultValue!)?string=="currentComp">
								<#assign formulaId_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="formulaId.id"        showFormat="SELECTCOMP" defaultValue="${(formulaId_id_defaultValue!)?string}" defaultDisplay="${(formulaId_id_displayDefaultType!)?string}" decimal="" editable=true type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="center" hiddenCol=true viewUrl="/RM/formula/formula/formulaTaskRef.action" viewCode="RM_7.5.0.0_formula_formulaTaskRef" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1498047455529')}"  label="${getText('ec.common.ID')}" width=100 showFormatFunc=""  />
							...
							<#elseif (processId_id_defaultValue!)?string=="currentComp">
								<#assign processId_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="processId.id"        showFormat="SELECTCOMP" defaultValue="${(processId_id_defaultValue!)?string}" defaultDisplay="${(processId_id_displayDefaultType!)?string}" decimal="" editable=true type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="center" hiddenCol=true viewUrl="/RM/formula/formulaProcess/processReference.action" viewCode="RM_7.5.0.0_formula_processReference" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1488596828660')}"  label="${getText('ec.common.ID')}" width=100 showFormatFunc=""  />
							...
							<#elseif (putBatMateId_id_defaultValue!)?string=="currentComp">
								<#assign putBatMateId_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="putBatMateId.id"        showFormat="SELECTCOMP" defaultValue="${(putBatMateId_id_defaultValue!)?string}" defaultDisplay="${(putBatMateId_id_displayDefaultType!)?string}" decimal="" editable=true type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="center" hiddenCol=true viewUrl="/RM/formula/formulaProcessActive/activeCheckRef.action" viewCode="RM_7.5.0.0_formula_activeCheckRef" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1497922173328')}"  label="${getText('ec.common.ID')}" width=100 showFormatFunc=""  />
			...
			<script type="text/javascript">
				function ProduceTaskActive_dg1489730796226_check_datagridvalid(){
					//
					var errorObj =ProduceTaskActive_dg1489730796226Widget._DT.testData();
					var errorContent='';
					if(errorObj!=null){
				...
				function savedg1489730796226DataGrid(){
					<#if  refId?? && (refId gt 0)>
					ProduceTaskActive_dg1489730796226Widget.setAllRowEdited();
					</#if>
					// 针对需要全部更新的PT，把pt Id存到body的CHANGED_PT中，保存时，会自动保存全部数据
					var changed_pt_name = $('body').data('CHANGED_PT');
					if(changed_pt_name && changed_pt_name.indexOf('ProduceTaskActive_dg1489730796226Widget') > -1) {
						ProduceTaskActive_dg1489730796226Widget.setAllRowEdited();
					}
					var json = ProduceTaskActive_dg1489730796226Widget.parseEditedData();
					$('input[name="dg1489730796226ListJson"]').remove();
					$('input[name="dgLists[\'dg1489730796226\']"]').remove();
					$('input[name="dg1489730796226ModelCode"]').remove();
					$('<input type="hidden" name="dgLists[\'dg1489730796226\']">').val(json).appendTo($('#WOM_produceTask_produceTask_makeTaskEdit_form'));
					$('<input type="hidden" name="dg1489730796226ModelCode">').val('WOM_7.5.0.0_produceTask_ProduceTaskActive').appendTo($('#WOM_produceTask_produceTask_makeTaskEdit_form'));
					//兼容旧版本提交函数
					$('<input type="hidden" name="dg1489730796226ListJson">').val(json).appendTo($('#WOM_produceTask_produceTask_makeTaskEdit_form'));
				}
				function DT_ProduceTaskActive_dg1489730796226_deldatagrid(){
					var deleteRows = ProduceTaskActive_dg1489730796226Widget.deleteRows();
					...
					$.each(deleteRows, function(index, deleteRow){
						...
						if($("#dg1489730796226DeletedIds").length>0){
							$("#dg1489730796226DeletedIds")[0].value+=","+tepID;
						}else{
							CUI('<input type="hidden" id="dg1489730796226DeletedIds" name="dgDeletedIds[\'dg1489730796226\']" value="'+tepID+'">').appendTo(CUI('#WOM_produceTask_produceTask_makeTaskEdit_form'));
						}
						//兼容旧版本提交函数
						CUI('<input type="hidden" name="dg1489730796226DeletedIds['+CUI('input[name^="dg1489730796226DeletedIds"]').length+']'+'" value="'+tepID+'">').appendTo(CUI('#WOM_produceTask_produceTask_makeTaskEdit_form'));
					});
					return deleteRows;
				}
				function DT_ProduceTaskActive_dg1489730796226_delTreeNodes(){
					var deleteRows = ProduceTaskActive_dg1489730796226Widget._DT.removeTreeNode();
					if(!deleteRows || deleteRows.length == 0) {
						return false;
					}
					var delproperty = "'id','version','processId.id','activeId.id','headID.id','formulaId.id','productId.id'";
				...
				$(function($){
					var datagrids = $('body').data('WOM_produceTask_produceTask_makeTaskEdit_datagrids');
					if(!datagrids) {
						datagrids = [];
					}
					for(var i=0;i<3;i++) {
					...
					if(datagrids[0].length>0) {
						for(var i=0;i<datagrids[0].length;i++) {
							if(datagrids[0][i] == 'ProduceTaskActive_dg1489730796226') {
								break;
							}
							if(i==datagrids[0].length-1) {
								datagrids[0][datagrids[0].length] = 'ProduceTaskActive_dg1489730796226';
							}
						}
					} else {
						datagrids[0][datagrids[0].length] = 'ProduceTaskActive_dg1489730796226';
					}
					$('body').data('WOM_produceTask_produceTask_makeTaskEdit_datagrids', datagrids);
				});
				
				var ProduceTaskActive_dg1489730796226_importDialog = null;
				function ProduceTaskActive_dg1489730796226_showImportDialog(){
					try{
						if(ProduceTaskActive_dg1489730796226_importDialog!=null&&ProduceTaskActive_dg1489730796226_importDialog.isShow==1){
							return false;
						}
						var url = "/WOM/produceTask/produceTask/initImport.action?datagridCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489730796226&tid=${id!}&datagridName=dg1489730796226";
							<#if canImportExcel>
								var buttonCode="WOM_7.5.0.0_produceTask_makeTaskEditdg1489730796226_BUTTON_dgImport";
								url+="&buttonCode="+buttonCode;
							</#if>
						ProduceTaskActive_dg1489730796226_importDialog = new CUI.Dialog({
							...
							width: '420',
							dragable:true,
							buttons:[{id:"import",name:"${getHtmlText('common.button.import')}",handler:function(){var dg = eval("ProduceTaskActive_dg1489730796226"+"Widget");if(dg && dg.checkEdited && dg.checkEdited()){CUI.Dialog.alert("${getHtmlText('ec.view.unsavedgdata')}");}else{foundation.importExcel.submitImportForm();}}},{name:"${getHtmlText('common.button.cancel')}",id:"close",handler:function(){setTimeout(function(){$('#importResponse').remove();ProduceTaskActive_dg1489730796226_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.Confirm')}",id:"ok",display:'hidden',handler:function(){setTimeout(function(){$('#importResponse').remove();ProduceTaskActive_dg1489730796226_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.back')}",id:"tback",display:'hidden',handler:function(){tback();}}],
							beforeCloseEvent:function(){$('#importResponse').remove();}
						});
						ProduceTaskActive_dg1489730796226_importDialog.show();
					}catch(e){}
				}	
				
				function ProduceTaskActive_dg1489730796226_downLoadFile(){
					var url = "/WOM/produceTask/produceTask/downLoad.action?datagridCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489730796226&templateRelatedModelCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489730796226&downloadType=template&fileName=dg1489730796226";
					window.open(url,"","");
				}
				function dg1489730796226RenderOverEvent(){
    ...
    */
	...
	//修改打开时
		...
		formulaChange1();
				...
				function dg1489730796226PageInitMethod(nTabIndex){
					WOM.produceTask.produceTask.makeTaskEdit.initSize(nTabIndex);
...
<#assign colAdmFlag=checkUserPermisition('ec_ptManage_list_view')>
			...
			<#if  refId?? && (refId > 0)>
				<#assign dUrl="/WOM/produceTask/produceTask/data-dg1489731937175.action?produceTask.id=${refId!-1}&refId=${refId!-1}&datagridCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489731937175">
			<#else>
				<#assign dUrl="/WOM/produceTask/produceTask/data-dg1489731937175.action?produceTask.id=${(produceTask.id)!-1}&datagridCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489731937175">
			</#if>
			<#assign firstLoad = true>
			...
			<#else>
				...
				<#if cpvmInfo?? && cpvmInfo?length gt 0>
					<#assign cpvmInfo = cpvmInfo?substring(1)>
					<input type="hidden" id="dg_cp_info_ProduceTaskProcess_dg1489731937175" value="${cpvmInfo!}" />
				</#if>
			
			<input type="hidden" id="dg1489731937175_id" value="ProduceTaskProcess_dg1489731937175" />
			
			<input type="hidden" id="dg1489731937175_url" value="${dUrl}" />
			
			<#assign assModelDisplayName = getText('WOM.modelname.randon1489671052624')!>
			<#assign assModelDisplayName = assModelDisplayName + getText('ec.common.validate.colon') >
			<@exportexcel action="/WOM/produceTask/produceTask/data-dg1489731937175.action?operateType=export&datagridCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489731937175"  settingtext="" settingUrl="" prepareParams="" formId="" look="text" width=250 height=170 text="" exportPageChoose=0 dtPage="dgPage" prefix="ProduceTaskProcess_dg1489731937175" />
			<@datagrid colAdminFlag=colAdmFlag withoutConfigTable=true id="ProduceTaskProcess_dg1489731937175" viewType="${viewType}" renderOverEvent="dg1489731937175RenderOverEvent" route="${routeFlag}" formId="WOM_produceTask_produceTask_makeTaskEdit_form" noPermissionKeys="name,processType.name,isFirstProcess,isLastProcess,longTime,factoryId.name,afterRatio,beforeRatio,exeOrder,remark,formularProcess.id" modelCode="WOM_7.5.0.0_produceTask_ProduceTaskProcess" dataUrl="${dUrl}" postData="&dgPage.pageSize=65536" dataGridName="dg1489731937175" dtPage="dgPage"  hidekeyPrefix="dg1489731937175" hidekey="['id','version','processType.id','processType.name','factoryId.id','factoryId.name','formularProcess.id','formularProcess.id'${cpObjHideKey!''}]" transMethod="post" paginator=false editable=true buttons="${buttons}"  canImportExcel=canImportExcel noPadding=true isEdit=true tabViewIndex=1 pageInitMethod="dg1489731937175PageInitMethod"  defaultNodeExpanded=nodeExpanded  cannotAddNewRow=true cannotDeleteRow=false assModelDisplayName=assModelDisplayName dgTitle="${getText('WOM.dataGriddataGridName.radion1490443951798')}" activexButton="" exportExcel=exportExcel addNewRow=false   canInsertRow=false  insertRowAble=true firstLoad=firstLoad  copyRow=false  copyColumn=false  ptRealTimeLoad=0 >		
							<#assign name_displayDefaultType=''>
								<#assign name_defaultValue=''>
										<#assign name_defaultValue=''>
							...
							<#elseif (processType_name_defaultValue!)?string=="currentComp">
								<#assign processType_name_defaultValue='${compJson!}'>
									...
									<@datacolumn key="processType.name"        showFormat="SELECTCOMP" defaultValue="${(processType_name_defaultValue!)?string}" defaultDisplay="${(processType_name_displayDefaultType!)?string}" decimal="" editable=false type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="left"  viewUrl="/RM/processType/processType/processTypeRef.action" viewCode="RM_7.5.0.0_processType_processTypeRef" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1487220867598')}"  label="${getText('WOM.propertydisplayName.randon14870743874974556')}" width=150 showFormatFunc=""  />
							...
							<#elseif (formularProcess_id_defaultValue!)?string=="currentComp">
								<#assign formularProcess_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="formularProcess.id"        showFormat="SELECTCOMP" defaultValue="${(formularProcess_id_defaultValue!)?string}" defaultDisplay="${(formularProcess_id_displayDefaultType!)?string}" decimal="" editable=true type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="center" hiddenCol=true viewUrl="/RM/formula/formulaProcess/processReference.action" viewCode="RM_7.5.0.0_formula_processReference" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1488596828660')}"  label="${getText('WOM.common.ID46676777')}" width=100 showFormatFunc=""  />
			...
			<script type="text/javascript">
				function ProduceTaskProcess_dg1489731937175_check_datagridvalid(){
					//
					var errorObj =ProduceTaskProcess_dg1489731937175Widget._DT.testData();
					var errorContent='';
					if(errorObj!=null){
					  for(var i=0;i<errorObj.length;i++){
						var obj1=errorObj[i];
				...
				function savedg1489731937175DataGrid(){
					<#if  refId?? && (refId gt 0)>
					ProduceTaskProcess_dg1489731937175Widget.setAllRowEdited();
					</#if>
					// 针对需要全部更新的PT，把pt Id存到body的CHANGED_PT中，保存时，会自动保存全部数据
					var changed_pt_name = $('body').data('CHANGED_PT');
					if(changed_pt_name && changed_pt_name.indexOf('ProduceTaskProcess_dg1489731937175Widget') > -1) {
						ProduceTaskProcess_dg1489731937175Widget.setAllRowEdited();
					}
					var json = ProduceTaskProcess_dg1489731937175Widget.parseEditedData();
					$('input[name="dg1489731937175ListJson"]').remove();
					$('input[name="dgLists[\'dg1489731937175\']"]').remove();
					$('input[name="dg1489731937175ModelCode"]').remove();
					$('<input type="hidden" name="dgLists[\'dg1489731937175\']">').val(json).appendTo($('#WOM_produceTask_produceTask_makeTaskEdit_form'));
					$('<input type="hidden" name="dg1489731937175ModelCode">').val('WOM_7.5.0.0_produceTask_ProduceTaskProcess').appendTo($('#WOM_produceTask_produceTask_makeTaskEdit_form'));
					//兼容旧版本提交函数
					$('<input type="hidden" name="dg1489731937175ListJson">').val(json).appendTo($('#WOM_produceTask_produceTask_makeTaskEdit_form'));
				}
				function DT_ProduceTaskProcess_dg1489731937175_deldatagrid(){
					var deleteRows = ProduceTaskProcess_dg1489731937175Widget.deleteRows();
					if(!deleteRows || deleteRows.length == 0) {
						CUI.Dialog.alert("${getHtmlText('foundation.message.choicedel')}");
						return false;
					}
					...
					$.each(deleteRows, function(index, deleteRow){
						...
						if($("#dg1489731937175DeletedIds").length>0){
							$("#dg1489731937175DeletedIds")[0].value+=","+tepID;
						}else{
							CUI('<input type="hidden" id="dg1489731937175DeletedIds" name="dgDeletedIds[\'dg1489731937175\']" value="'+tepID+'">').appendTo(CUI('#WOM_produceTask_produceTask_makeTaskEdit_form'));
						}
						//兼容旧版本提交函数
						CUI('<input type="hidden" name="dg1489731937175DeletedIds['+CUI('input[name^="dg1489731937175DeletedIds"]').length+']'+'" value="'+tepID+'">').appendTo(CUI('#WOM_produceTask_produceTask_makeTaskEdit_form'));
					});
					return deleteRows;
				}
				function DT_ProduceTaskProcess_dg1489731937175_delTreeNodes(){
					var deleteRows = ProduceTaskProcess_dg1489731937175Widget._DT.removeTreeNode();
					if(!deleteRows || deleteRows.length == 0) {
						return false;
					}
					var delproperty = "'id','version','processType.id','formulaId.id','factoryId.id','headId.id'";
				...
				$(function($){
					...
					if(datagrids[1].length>0) {
						for(var i=0;i<datagrids[1].length;i++) {
							if(datagrids[1][i] == 'ProduceTaskProcess_dg1489731937175') {
								break;
							}
							if(i==datagrids[1].length-1) {
								datagrids[1][datagrids[1].length] = 'ProduceTaskProcess_dg1489731937175';
							}
						}
					} else {
						datagrids[1][datagrids[1].length] = 'ProduceTaskProcess_dg1489731937175';
				...
				var ProduceTaskProcess_dg1489731937175_importDialog = null;
				function ProduceTaskProcess_dg1489731937175_showImportDialog(){
					try{
						if(ProduceTaskProcess_dg1489731937175_importDialog!=null&&ProduceTaskProcess_dg1489731937175_importDialog.isShow==1){
							return false;
						}
						var url = "/WOM/produceTask/produceTask/initImport.action?datagridCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489731937175&tid=${id!}&datagridName=dg1489731937175";
							<#if canImportExcel>
								var buttonCode="WOM_7.5.0.0_produceTask_makeTaskEditdg1489731937175_BUTTON_dgImport";
								url+="&buttonCode="+buttonCode;
							</#if>
						ProduceTaskProcess_dg1489731937175_importDialog = new CUI.Dialog({
							title: "${getHtmlText('common.button.import')}",
							url:url,
							modal:true,
							description:'',
							...
							width: '420',
							dragable:true,
							buttons:[{id:"import",name:"${getHtmlText('common.button.import')}",handler:function(){var dg = eval("ProduceTaskProcess_dg1489731937175"+"Widget");if(dg && dg.checkEdited && dg.checkEdited()){CUI.Dialog.alert("${getHtmlText('ec.view.unsavedgdata')}");}else{foundation.importExcel.submitImportForm();}}},{name:"${getHtmlText('common.button.cancel')}",id:"close",handler:function(){setTimeout(function(){$('#importResponse').remove();ProduceTaskProcess_dg1489731937175_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.Confirm')}",id:"ok",display:'hidden',handler:function(){setTimeout(function(){$('#importResponse').remove();ProduceTaskProcess_dg1489731937175_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.back')}",id:"tback",display:'hidden',handler:function(){tback();}}],
							beforeCloseEvent:function(){$('#importResponse').remove();}
						});
						ProduceTaskProcess_dg1489731937175_importDialog.show();
					}catch(e){}
				}	
				
				function ProduceTaskProcess_dg1489731937175_downLoadFile(){
					var url = "/WOM/produceTask/produceTask/downLoad.action?datagridCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489731937175&templateRelatedModelCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489731937175&downloadType=template&fileName=dg1489731937175";
					window.open(url,"","");
				}
				function dg1489731937175RenderOverEvent(){
	...
	for (var i = 0; i < tableObj.rows.length; i++) {    //遍历Table的所有Row 
		...
		tableObj.rows[i].ondblclick=function(){ 
		   ...
		   ProduceTaskActive_dg1489736028416Widget._DT.setRequestDataUrl("/WOM/produceTask/produceTask/data-dg1489736028416.action?produceTask.id="+produceTaskId+"&rt=json&oProcessID="+oProcessID);
				...
				function dg1489731937175PageInitMethod(nTabIndex){
					WOM.produceTask.produceTask.makeTaskEdit.initSize(nTabIndex);
				}
			</script>
...
<#assign colAdmFlag=checkUserPermisition('ec_ptManage_list_view')>
			...
			<#assign cpObjHideKey = '' >
			<#assign cpvmInfo = ''>
								<#assign customPropViewMappings = getShowCustomProps("WOM_7.5.0.0_produceTask_ProduceTaskActive", "WOM_7.5.0.0_produceTask_makeTaskEditdg1489736028416", "DATAGRID", "produceTaskActive")>
								<#list customPropViewMappings as cpvm>
									<#if cpvm.property.type == 'OBJECT' && cpObjHideKey?index_of(",'" +cpvm.propertyLayRec) lt 0>
										<#assign cpObjHideKey = cpObjHideKey + ",'" + cpvm.propertyLayRec + "'">
									</#if>
							...
							<script type="text/javascript">
								function ProduceTaskActive_dg1489736028416_addActive(event)
																{
	...
	if(selectRow!=undefined){
		...
		return false;
							...
							<script type="text/javascript">
								function ProduceTaskActive_dg1489736028416_editActive(event)
																{
		...
		if(selectRow!=undefined){
			...
			return false;
							...
							<script type="text/javascript">
								function ProduceTaskActive_dg1489736028416_delActive(event)
																{
		var selectRow=ProduceTaskActive_dg1489736028416Widget.getSelectedRow();
		if(selectRow!=undefined){
			var activeSourceId=ProduceTaskActive_dg1489736028416Widget.getCellValue(ProduceTaskActive_dg1489736028416Widget.getSelectedRow(),"activeSource.id");
			...
			<#if  refId?? && (refId > 0)>
				<#assign dUrl="/WOM/produceTask/produceTask/data-dg1489736028416.action?produceTask.id=${refId!-1}&refId=${refId!-1}&datagridCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489736028416">
			<#else>
				<#assign dUrl="/WOM/produceTask/produceTask/data-dg1489736028416.action?produceTask.id=${(produceTask.id)!-1}&datagridCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489736028416">
			</#if>
			<#assign firstLoad = true>
				
			<#if viewType?? && viewType != "readonly" && newObj?? && !newObj && !(refId?? && (refId > 0))>
				<#assign buttons="[{text:\"${getText('WOM.buttonPropertyshowName.radion1506665493884')}\",handler:function(event){ProduceTaskActive_dg1489736028416_addActive(event)},iconClass:\"cui-btn-add\",useInMore:\"false\"},{text:\"${getText('WOM.buttonPropertyshowName.radion1506665523875')}\",handler:function(event){ProduceTaskActive_dg1489736028416_editActive(event)},iconClass:\"cui-btn-edit\",useInMore:\"false\"},{text:\"${getText('WOM.buttonPropertyshowName.radion1506665569840')}\",handler:function(event){ProduceTaskActive_dg1489736028416_delActive(event)},iconClass:\"cui-btn-del\",useInMore:\"false\"}]">
				<#assign canImportExcel=false>
			<#else>
				<#assign buttons="[{text:\"${getText('WOM.buttonPropertyshowName.radion1506665493884')}\",handler:function(event){ProduceTaskActive_dg1489736028416_addActive(event)},iconClass:\"cui-btn-add\",useInMore:\"false\"},{text:\"${getText('WOM.buttonPropertyshowName.radion1506665523875')}\",handler:function(event){ProduceTaskActive_dg1489736028416_editActive(event)},iconClass:\"cui-btn-edit\",useInMore:\"false\"},{text:\"${getText('WOM.buttonPropertyshowName.radion1506665569840')}\",handler:function(event){ProduceTaskActive_dg1489736028416_delActive(event)},iconClass:\"cui-btn-del\",useInMore:\"false\"}]">
				<#assign canImportExcel=false>
				...
				<#if cpvmInfo?? && cpvmInfo?length gt 0>
					<#assign cpvmInfo = cpvmInfo?substring(1)>
					<input type="hidden" id="dg_cp_info_ProduceTaskActive_dg1489736028416" value="${cpvmInfo!}" />
				</#if>
			
			<input type="hidden" id="dg1489736028416_id" value="ProduceTaskActive_dg1489736028416" />
			
			<input type="hidden" id="dg1489736028416_url" value="${dUrl}" />
			
			<#assign assModelDisplayName = getText('WOM.modelname.randon1489671093316')!>
			<#assign assModelDisplayName = assModelDisplayName + getText('ec.common.validate.colon') >
			<@exportexcel action="/WOM/produceTask/produceTask/data-dg1489736028416.action?operateType=export&datagridCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489736028416"  settingtext="" settingUrl="" prepareParams="" formId="" look="text" width=250 height=170 text="" exportPageChoose=0 dtPage="dgPage" prefix="ProduceTaskActive_dg1489736028416" />
			<@datagrid colAdminFlag=colAdmFlag withoutConfigTable=true id="ProduceTaskActive_dg1489736028416" viewType="${viewType}" renderOverEvent="dg1489736028416RenderOverEvent" route="${routeFlag}" formId="WOM_produceTask_produceTask_makeTaskEdit_form" noPermissionKeys="oprate,orderProcessId.name,activeId.occurTurn,name,activeType,isBackMix,activeSource,activeId.fromContainer,activeId.container,productId.productCode,productId.productName,isReplace,isMixQuality,standardNum,minQuality,maxQuality,planNum,lossRate,activeId.longTime,activeId.auto,execSort,actOrder,offerOrder,activeId.batchSite,exeSystem,mobileTerminal,activeId.qualityStandard.name,activeId.testProduct.name,activeId.pickSite.name,activeId.finalInspection,activeId.isAnaly,remark,parentActive,parentActiveId" modelCode="WOM_7.5.0.0_produceTask_ProduceTaskActive" dataUrl="${dUrl}" postData="&dgPage.pageSize=65536" dataGridName="dg1489736028416" dtPage="dgPage"  hidekeyPrefix="dg1489736028416" hidekey="['id','version','orderProcessId.id','orderProcessId.name','activeId.id','activeId.occurTurn.id','activeId.id','activeId.fromContainer.id','activeId.id','activeId.container','productId.id','productId.productCode','productId.id','productId.productName','activeId.id','activeId.longTime','activeId.id','activeId.auto','activeId.id','activeId.batchSite.id','activeId.id','activeId.qualityStandard.name','activeId.id','activeId.testProduct.name','activeId.id','activeId.pickSite.name','activeId.id','activeId.finalInspection','activeId.id','activeId.isAnaly'${cpObjHideKey!''}]" transMethod="post" paginator=false editable=true buttons="${buttons}"  canImportExcel=canImportExcel noPadding=true isEdit=true tabViewIndex=1 pageInitMethod="dg1489736028416PageInitMethod"  defaultNodeExpanded=nodeExpanded  cannotAddNewRow=true cannotDeleteRow=false assModelDisplayName=assModelDisplayName dgTitle="${getText('WOM.dataGriddataGridName.radion1490443976015')}" activexButton="WOM.buttonPropertyshowName.radion1506665493884,addActive,add;WOM.buttonPropertyshowName.radion1506665523875,editActive,edit;WOM.buttonPropertyshowName.radion1506665569840,delActive,del" exportExcel=exportExcel addNewRow=false   canInsertRow=false  insertRowAble=true firstLoad=firstLoad  copyRow=false  copyColumn=false  ptRealTimeLoad=0 >		
							...
							<#elseif (activeId_container_defaultValue!)?string=="currentComp">
								<#assign activeId_container_defaultValue='${compJson!}'>
									...
									<@datacolumn key="activeId.container"        showFormat="TEXT" defaultValue="${(activeId_container_defaultValue!)?string}" defaultDisplay="${(activeId_container_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="left"  viewUrl="/RM/formula/formulaProcessActive/activeRef.action" viewCode="RM_7.5.0.0_formula_activeRef" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1489564694469')}"  label="${getText('RM.propertydisplayName.randon1488696547250')}" width=80 showFormatFunc=""  />
							<#assign productId_productCode_displayDefaultType=''>
								<#assign productId_productCode_defaultValue=''>
										<#assign productId_productCode_defaultValue=''>
																	<#if (productId_productCode_defaultValue!)?string=="currentUser">
							...
							<#elseif (productId_productCode_defaultValue!)?string=="currentComp">
								<#assign productId_productCode_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.productCode"        showFormat="SELECTCOMP" defaultValue="${(productId_productCode_defaultValue!)?string}" defaultDisplay="${(productId_productCode_displayDefaultType!)?string}" decimal="" editable=false type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="left"  viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('WOM.propertydisplayName.radion1415772644833222')}" width=80 showFormatFunc=""  />
							<#assign productId_productName_displayDefaultType=''>
								<#assign productId_productName_defaultValue=''>
										<#assign productId_productName_defaultValue=''>
																	<#if (productId_productName_defaultValue!)?string=="currentUser">
							...
							<#elseif (productId_productName_defaultValue!)?string=="currentComp">
								<#assign productId_productName_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.productName"        showFormat="TEXT" defaultValue="${(productId_productName_defaultValue!)?string}" defaultDisplay="${(productId_productName_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="left"  viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('WOM.propertydisplayName.radion1415772740737334')}" width=80 showFormatFunc=""  />
							<#assign isReplace_displayDefaultType=''>
								<#assign isReplace_defaultValue=''>
										<#assign isReplace_defaultValue=''>
							...
							<#elseif (activeId_longTime_defaultValue!)?string=="currentComp">
								<#assign activeId_longTime_defaultValue='${compJson!}'>
									...
									<@datacolumn key="activeId.longTime"        showFormat="TEXT" defaultValue="${(activeId_longTime_defaultValue!)?string}" defaultDisplay="${(activeId_longTime_displayDefaultType!)?string}" decimal="2" editable=false type="DECIMAL" showType="decimal" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="right"  viewUrl="/RM/formula/formulaProcessActive/activeRef.action" viewCode="RM_7.5.0.0_formula_activeRef" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1489564694469')}"  label="${getText('RM.propertydisplayName.randon1487330334270')}" width=80 showFormatFunc=""  />
							...
							<#elseif (activeId_auto_defaultValue!)?string=="currentComp">
								<#assign activeId_auto_defaultValue='${compJson!}'>
									...
									<@datacolumn key="activeId.auto"        showFormat="CHECKBOX" defaultValue="${(activeId_auto_defaultValue!)?string}" defaultDisplay="${(activeId_auto_displayDefaultType!)?string}" decimal="" editable=false type="boolean" showType="checkbox" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="center"  viewUrl="/RM/formula/formulaProcessActive/activeRef.action" viewCode="RM_7.5.0.0_formula_activeRef" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1489564694469')}"  label="${getText('WOM.propertydisplayName.randon1487331130107')}" width=80 showFormatFunc=""  />
							...
							<#elseif (activeId_qualityStandard_name_defaultValue!)?string=="currentComp">
								<#assign activeId_qualityStandard_name_defaultValue='${compJson!}'>
									...
									<@datacolumn key="activeId.qualityStandard.name"        showFormat="TEXT" defaultValue="${(activeId_qualityStandard_name_defaultValue!)?string}" defaultDisplay="${(activeId_qualityStandard_name_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="center"  viewUrl="/RM/formula/formulaProcessActive/activeRef.action" viewCode="RM_7.5.0.0_formula_activeRef" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1489564694469')}"  label="${getText('WOM.propertydisplayName.randon148759513963344')}" width=80 showFormatFunc=""  />
							...
							<#elseif (activeId_testProduct_name_defaultValue!)?string=="currentComp">
								<#assign activeId_testProduct_name_defaultValue='${compJson!}'>
									...
									<@datacolumn key="activeId.testProduct.name"        showFormat="TEXT" defaultValue="${(activeId_testProduct_name_defaultValue!)?string}" defaultDisplay="${(activeId_testProduct_name_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="left"  viewUrl="/RM/formula/formulaProcessActive/activeRef.action" viewCode="RM_7.5.0.0_formula_activeRef" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1489564694469')}"  label="${getText('WOM.propertydisplayName.randon1490317960117445456767')}" width=80 showFormatFunc=""  />
							...
							<#elseif (activeId_pickSite_name_defaultValue!)?string=="currentComp">
								<#assign activeId_pickSite_name_defaultValue='${compJson!}'>
									...
									<@datacolumn key="activeId.pickSite.name"        showFormat="TEXT" defaultValue="${(activeId_pickSite_name_defaultValue!)?string}" defaultDisplay="${(activeId_pickSite_name_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="left"  viewUrl="/RM/formula/formulaProcessActive/activeCheckRef.action" viewCode="RM_7.5.0.0_formula_activeCheckRef" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1497922173328')}"  label="${getText('WOM.propertydisplayName.randon150457889470250033')}" width=80 showFormatFunc=""  />
							...
							<#elseif (activeId_finalInspection_defaultValue!)?string=="currentComp">
								<#assign activeId_finalInspection_defaultValue='${compJson!}'>
									...
									<@datacolumn key="activeId.finalInspection"        showFormat="CHECKBOX" defaultValue="${(activeId_finalInspection_defaultValue!)?string}" defaultDisplay="${(activeId_finalInspection_displayDefaultType!)?string}" decimal="" editable=false type="boolean" showType="checkbox" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="center"  viewUrl="/RM/formula/formulaProcessActive/activeRef.action" viewCode="RM_7.5.0.0_formula_activeRef" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1489564694469')}"  label="${getText('RM.propertydisplayName.randon1497849337000')}" width=80 showFormatFunc=""  />
							...
							<#elseif (activeId_isAnaly_defaultValue!)?string=="currentComp">
								<#assign activeId_isAnaly_defaultValue='${compJson!}'>
									...
									<@datacolumn key="activeId.isAnaly"        showFormat="CHECKBOX" defaultValue="${(activeId_isAnaly_defaultValue!)?string}" defaultDisplay="${(activeId_isAnaly_displayDefaultType!)?string}" decimal="" editable=false type="boolean" showType="checkbox" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="center"  viewUrl="/RM/formula/formulaProcessActive/activeCheckRef.action" viewCode="RM_7.5.0.0_formula_activeCheckRef" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1497922173328')}"  label="${getText('RM.propertydisplayName.randon1543321671519')}" width=100 showFormatFunc=""  />
							<#assign customPropViewMappings = getShowCustomProps("WOM_7.5.0.0_produceTask_ProduceTaskActive", "WOM_7.5.0.0_produceTask_makeTaskEditdg1489736028416", "DATAGRID", "produceTaskActive")>
							<#-- 排布自定义字段 -->
							<#list customPropViewMappings as cpvm>
								<#assign cpvmColumnType = cpvm.property.type>
			...
			<script type="text/javascript">
				function ProduceTaskActive_dg1489736028416_check_datagridvalid(){
					//
					var errorObj =ProduceTaskActive_dg1489736028416Widget._DT.testData();
					var errorContent='';
					if(errorObj!=null){
					  for(var i=0;i<errorObj.length;i++){
						var obj1=errorObj[i];
				...
				function savedg1489736028416DataGrid(){
					<#if  refId?? && (refId gt 0)>
					ProduceTaskActive_dg1489736028416Widget.setAllRowEdited();
					</#if>
					// 针对需要全部更新的PT，把pt Id存到body的CHANGED_PT中，保存时，会自动保存全部数据
					var changed_pt_name = $('body').data('CHANGED_PT');
					if(changed_pt_name && changed_pt_name.indexOf('ProduceTaskActive_dg1489736028416Widget') > -1) {
						ProduceTaskActive_dg1489736028416Widget.setAllRowEdited();
					}
					var json = ProduceTaskActive_dg1489736028416Widget.parseEditedData();
					$('input[name="dg1489736028416ListJson"]').remove();
					$('input[name="dgLists[\'dg1489736028416\']"]').remove();
					$('input[name="dg1489736028416ModelCode"]').remove();
					$('<input type="hidden" name="dgLists[\'dg1489736028416\']">').val(json).appendTo($('#WOM_produceTask_produceTask_makeTaskEdit_form'));
					$('<input type="hidden" name="dg1489736028416ModelCode">').val('WOM_7.5.0.0_produceTask_ProduceTaskActive').appendTo($('#WOM_produceTask_produceTask_makeTaskEdit_form'));
					//兼容旧版本提交函数
					$('<input type="hidden" name="dg1489736028416ListJson">').val(json).appendTo($('#WOM_produceTask_produceTask_makeTaskEdit_form'));
				}
				function DT_ProduceTaskActive_dg1489736028416_deldatagrid(){
					var deleteRows = ProduceTaskActive_dg1489736028416Widget.deleteRows();
					if(!deleteRows || deleteRows.length == 0) {
						CUI.Dialog.alert("${getHtmlText('foundation.message.choicedel')}");
						return false;
					}
					...
					$.each(deleteRows, function(index, deleteRow){
						...
						if($("#dg1489736028416DeletedIds").length>0){
							$("#dg1489736028416DeletedIds")[0].value+=","+tepID;
						}else{
							CUI('<input type="hidden" id="dg1489736028416DeletedIds" name="dgDeletedIds[\'dg1489736028416\']" value="'+tepID+'">').appendTo(CUI('#WOM_produceTask_produceTask_makeTaskEdit_form'));
						}
						//兼容旧版本提交函数
						CUI('<input type="hidden" name="dg1489736028416DeletedIds['+CUI('input[name^="dg1489736028416DeletedIds"]').length+']'+'" value="'+tepID+'">').appendTo(CUI('#WOM_produceTask_produceTask_makeTaskEdit_form'));
					});
					return deleteRows;
				}
				function DT_ProduceTaskActive_dg1489736028416_delTreeNodes(){
					var deleteRows = ProduceTaskActive_dg1489736028416Widget._DT.removeTreeNode();
					if(!deleteRows || deleteRows.length == 0) {
						return false;
					}
					var delproperty = "'id','version','processId.id','activeId.id','headID.id','formulaId.id','productId.id'";
				...
				$(function($){
					...
					if(datagrids[1].length>0) {
						for(var i=0;i<datagrids[1].length;i++) {
							if(datagrids[1][i] == 'ProduceTaskActive_dg1489736028416') {
								break;
							}
							if(i==datagrids[1].length-1) {
								datagrids[1][datagrids[1].length] = 'ProduceTaskActive_dg1489736028416';
							}
						}
					} else {
						datagrids[1][datagrids[1].length] = 'ProduceTaskActive_dg1489736028416';
				...
				var ProduceTaskActive_dg1489736028416_importDialog = null;
				function ProduceTaskActive_dg1489736028416_showImportDialog(){
					try{
						if(ProduceTaskActive_dg1489736028416_importDialog!=null&&ProduceTaskActive_dg1489736028416_importDialog.isShow==1){
							return false;
						}
						var url = "/WOM/produceTask/produceTask/initImport.action?datagridCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489736028416&tid=${id!}&datagridName=dg1489736028416";
							<#if canImportExcel>
								var buttonCode="WOM_7.5.0.0_produceTask_makeTaskEditdg1489736028416_BUTTON_dgImport";
								url+="&buttonCode="+buttonCode;
							</#if>
						ProduceTaskActive_dg1489736028416_importDialog = new CUI.Dialog({
							title: "${getHtmlText('common.button.import')}",
							url:url,
							modal:true,
							description:'',
							...
							width: '420',
							dragable:true,
							buttons:[{id:"import",name:"${getHtmlText('common.button.import')}",handler:function(){var dg = eval("ProduceTaskActive_dg1489736028416"+"Widget");if(dg && dg.checkEdited && dg.checkEdited()){CUI.Dialog.alert("${getHtmlText('ec.view.unsavedgdata')}");}else{foundation.importExcel.submitImportForm();}}},{name:"${getHtmlText('common.button.cancel')}",id:"close",handler:function(){setTimeout(function(){$('#importResponse').remove();ProduceTaskActive_dg1489736028416_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.Confirm')}",id:"ok",display:'hidden',handler:function(){setTimeout(function(){$('#importResponse').remove();ProduceTaskActive_dg1489736028416_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.back')}",id:"tback",display:'hidden',handler:function(){tback();}}],
							beforeCloseEvent:function(){$('#importResponse').remove();}
						});
						ProduceTaskActive_dg1489736028416_importDialog.show();
					}catch(e){}
				}	
				
				function ProduceTaskActive_dg1489736028416_downLoadFile(){
					var url = "/WOM/produceTask/produceTask/downLoad.action?datagridCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489736028416&templateRelatedModelCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489736028416&downloadType=template&fileName=dg1489736028416";
					window.open(url,"","");
				}
				function dg1489736028416RenderOverEvent(){
					//颜色提示
    ...
    success : function(data){
        ...
        if(IsOpen == 'false'){
            ...
            ProduceTaskActive_dg1489736028416Widget._DT._resizeHeight = false; 
				...
				function dg1489736028416PageInitMethod(nTabIndex){
					WOM.produceTask.produceTask.makeTaskEdit.initSize(nTabIndex);
...
<#assign colAdmFlag=checkUserPermisition('ec_ptManage_list_view')>
			...
			<#assign cpObjHideKey = '' >
			<#assign cpvmInfo = ''>
								<#assign customPropViewMappings = getShowCustomProps("WOM_7.5.0.0_produceTask_ProduceMaterialSum", "WOM_7.5.0.0_produceTask_makeTaskEditdg1489732429091", "DATAGRID", "produceMaterialSum")>
								<#list customPropViewMappings as cpvm>
									<#if cpvm.property.type == 'OBJECT' && cpObjHideKey?index_of(",'" +cpvm.propertyLayRec) lt 0>
										<#assign cpObjHideKey = cpObjHideKey + ",'" + cpvm.propertyLayRec + "'">
									</#if>
			...
			<#if  refId?? && (refId > 0)>
				<#assign dUrl="/WOM/produceTask/produceTask/data-dg1489732429091.action?produceTask.id=${refId!-1}&refId=${refId!-1}&datagridCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489732429091">
			<#else>
				<#assign dUrl="/WOM/produceTask/produceTask/data-dg1489732429091.action?produceTask.id=${(produceTask.id)!-1}&datagridCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489732429091">
			</#if>
			<#assign firstLoad = true>
			...
			<#else>
				...
				<#if cpvmInfo?? && cpvmInfo?length gt 0>
					<#assign cpvmInfo = cpvmInfo?substring(1)>
					<input type="hidden" id="dg_cp_info_ProduceMaterialSum_dg1489732429091" value="${cpvmInfo!}" />
				</#if>
			
			<input type="hidden" id="dg1489732429091_id" value="ProduceMaterialSum_dg1489732429091" />
			
			<input type="hidden" id="dg1489732429091_url" value="${dUrl}" />
			
			<#assign assModelDisplayName = getText('WOM.modelname.randon1489671141506')!>
			<#assign assModelDisplayName = assModelDisplayName + getText('ec.common.validate.colon') >
			<@exportexcel action="/WOM/produceTask/produceTask/data-dg1489732429091.action?operateType=export&datagridCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489732429091"  settingtext="" settingUrl="" prepareParams="" formId="" look="text" width=250 height=170 text="" exportPageChoose=0 dtPage="dgPage" prefix="ProduceMaterialSum_dg1489732429091" />
			<@datagrid colAdminFlag=colAdmFlag withoutConfigTable=true id="ProduceMaterialSum_dg1489732429091" viewType="${viewType}" renderOverEvent="dg1489732429091RenderOverEvent" route="${routeFlag}" formId="WOM_produceTask_produceTask_makeTaskEdit_form" noPermissionKeys="productId.productCode,productId.productName,property,planNum,productId.productBaseUnit.name,batchNum,headId.formularId.setProcess" modelCode="WOM_7.5.0.0_produceTask_ProduceMaterialSum" dataUrl="${dUrl}" postData="&dgPage.pageSize=65536" dataGridName="dg1489732429091" dtPage="dgPage"  hidekeyPrefix="dg1489732429091" hidekey="['id','version','productId.id','productId.productCode','productId.id','productId.productName','productId.id','productId.productBaseUnit.name','headId.id','headId.formularId.setProcess.id'${cpObjHideKey!''}]" transMethod="post" paginator=false editable=false  buttons="${buttons}" noPadding=true isEdit=true tabViewIndex=2 pageInitMethod="dg1489732429091PageInitMethod"  defaultNodeExpanded=nodeExpanded  cannotAddNewRow=false cannotDeleteRow=true assModelDisplayName=assModelDisplayName dgTitle="${getText('WOM.dataGriddataGridName.radion1490444001342')}" activexButton="" exportExcel=exportExcel addNewRow=true   canInsertRow=false  insertRowAble=true firstLoad=firstLoad  copyRow=false  copyColumn=false  ptRealTimeLoad=0 >		
							<#assign productId_productCode_displayDefaultType=''>
								<#assign productId_productCode_defaultValue=''>
										<#assign productId_productCode_defaultValue=''>
																	<#if (productId_productCode_defaultValue!)?string=="currentUser">
							...
							<#elseif (productId_productCode_defaultValue!)?string=="currentComp">
								<#assign productId_productCode_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.productCode"        showFormat="SELECTCOMP" defaultValue="${(productId_productCode_defaultValue!)?string}" defaultDisplay="${(productId_productCode_displayDefaultType!)?string}" decimal="" editable=false type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="left"  viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('WOM.propertydisplayName.radion14157726448331')}" width=120 showFormatFunc=""  />
							<#assign productId_productName_displayDefaultType=''>
								<#assign productId_productName_defaultValue=''>
										<#assign productId_productName_defaultValue=''>
																	<#if (productId_productName_defaultValue!)?string=="currentUser">
							...
							<#elseif (productId_productName_defaultValue!)?string=="currentComp">
								<#assign productId_productName_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.productName"        showFormat="TEXT" defaultValue="${(productId_productName_defaultValue!)?string}" defaultDisplay="${(productId_productName_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="WOM.produceTask.produceTask.makeTaskEdit"  textalign="left"  viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('WOM.propertydisplayName.radion1415772740737334')}" width=120 showFormatFunc=""  />
							<#assign property_displayDefaultType=''>
								<#assign property_defaultValue=''>
										<#assign property_defaultValue=''>
			...
			<script type="text/javascript">
				function ProduceMaterialSum_dg1489732429091_check_datagridvalid(){
					//
					var errorObj =ProduceMaterialSum_dg1489732429091Widget._DT.testData();
					var errorContent='';
					if(errorObj!=null){
					  for(var i=0;i<errorObj.length;i++){
						var obj1=errorObj[i];
				...
				function savedg1489732429091DataGrid(){
					<#if  refId?? && (refId gt 0)>
					ProduceMaterialSum_dg1489732429091Widget.setAllRowEdited();
					</#if>
					// 针对需要全部更新的PT，把pt Id存到body的CHANGED_PT中，保存时，会自动保存全部数据
					var changed_pt_name = $('body').data('CHANGED_PT');
					if(changed_pt_name && changed_pt_name.indexOf('ProduceMaterialSum_dg1489732429091Widget') > -1) {
						ProduceMaterialSum_dg1489732429091Widget.setAllRowEdited();
					}
					var json = ProduceMaterialSum_dg1489732429091Widget.parseEditedData();
					$('input[name="dg1489732429091ListJson"]').remove();
					$('input[name="dgLists[\'dg1489732429091\']"]').remove();
					$('input[name="dg1489732429091ModelCode"]').remove();
					$('<input type="hidden" name="dgLists[\'dg1489732429091\']">').val(json).appendTo($('#WOM_produceTask_produceTask_makeTaskEdit_form'));
					$('<input type="hidden" name="dg1489732429091ModelCode">').val('WOM_7.5.0.0_produceTask_ProduceMaterialSum').appendTo($('#WOM_produceTask_produceTask_makeTaskEdit_form'));
					//兼容旧版本提交函数
					$('<input type="hidden" name="dg1489732429091ListJson">').val(json).appendTo($('#WOM_produceTask_produceTask_makeTaskEdit_form'));
				}
				function DT_ProduceMaterialSum_dg1489732429091_deldatagrid(){
					var deleteRows = ProduceMaterialSum_dg1489732429091Widget.deleteRows();
					if(!deleteRows || deleteRows.length == 0) {
						CUI.Dialog.alert("${getHtmlText('foundation.message.choicedel')}");
						return false;
					}
					...
					$.each(deleteRows, function(index, deleteRow){
						...
						if($("#dg1489732429091DeletedIds").length>0){
							$("#dg1489732429091DeletedIds")[0].value+=","+tepID;
						}else{
							CUI('<input type="hidden" id="dg1489732429091DeletedIds" name="dgDeletedIds[\'dg1489732429091\']" value="'+tepID+'">').appendTo(CUI('#WOM_produceTask_produceTask_makeTaskEdit_form'));
						}
						//兼容旧版本提交函数
						CUI('<input type="hidden" name="dg1489732429091DeletedIds['+CUI('input[name^="dg1489732429091DeletedIds"]').length+']'+'" value="'+tepID+'">').appendTo(CUI('#WOM_produceTask_produceTask_makeTaskEdit_form'));
					});
					return deleteRows;
				}
				function DT_ProduceMaterialSum_dg1489732429091_delTreeNodes(){
					var deleteRows = ProduceMaterialSum_dg1489732429091Widget._DT.removeTreeNode();
					if(!deleteRows || deleteRows.length == 0) {
						return false;
					}
					var delproperty = "'id','version','productId.id','headId.id'";
				...
				$(function($){
					...
					if(datagrids[2].length>0) {
						for(var i=0;i<datagrids[2].length;i++) {
							if(datagrids[2][i] == 'ProduceMaterialSum_dg1489732429091') {
								break;
							}
							if(i==datagrids[2].length-1) {
								datagrids[2][datagrids[2].length] = 'ProduceMaterialSum_dg1489732429091';
							}
						}
					} else {
						datagrids[2][datagrids[2].length] = 'ProduceMaterialSum_dg1489732429091';
				...
				var ProduceMaterialSum_dg1489732429091_importDialog = null;
				function ProduceMaterialSum_dg1489732429091_showImportDialog(){
					try{
						if(ProduceMaterialSum_dg1489732429091_importDialog!=null&&ProduceMaterialSum_dg1489732429091_importDialog.isShow==1){
							return false;
						}
						var url = "/WOM/produceTask/produceTask/initImport.action?datagridCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489732429091&tid=${id!}&datagridName=dg1489732429091";
							<#if canImportExcel>
								var buttonCode="WOM_7.5.0.0_produceTask_makeTaskEditdg1489732429091_BUTTON_dgImport";
								url+="&buttonCode="+buttonCode;
							</#if>
						ProduceMaterialSum_dg1489732429091_importDialog = new CUI.Dialog({
							title: "${getHtmlText('common.button.import')}",
							url:url,
							modal:true,
							description:'',
							...
							width: '420',
							dragable:true,
							buttons:[{id:"import",name:"${getHtmlText('common.button.import')}",handler:function(){var dg = eval("ProduceMaterialSum_dg1489732429091"+"Widget");if(dg && dg.checkEdited && dg.checkEdited()){CUI.Dialog.alert("${getHtmlText('ec.view.unsavedgdata')}");}else{foundation.importExcel.submitImportForm();}}},{name:"${getHtmlText('common.button.cancel')}",id:"close",handler:function(){setTimeout(function(){$('#importResponse').remove();ProduceMaterialSum_dg1489732429091_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.Confirm')}",id:"ok",display:'hidden',handler:function(){setTimeout(function(){$('#importResponse').remove();ProduceMaterialSum_dg1489732429091_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.back')}",id:"tback",display:'hidden',handler:function(){tback();}}],
							beforeCloseEvent:function(){$('#importResponse').remove();}
						});
						ProduceMaterialSum_dg1489732429091_importDialog.show();
					}catch(e){}
				}	
				
				function ProduceMaterialSum_dg1489732429091_downLoadFile(){
					var url = "/WOM/produceTask/produceTask/downLoad.action?datagridCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489732429091&templateRelatedModelCode=WOM_7.5.0.0_produceTask_makeTaskEditdg1489732429091&downloadType=template&fileName=dg1489732429091";
					window.open(url,"","");
				}
				function dg1489732429091RenderOverEvent(){
					//启用物料批次
    ...
    $('.paginatorbar-operatebar').hide();
				...
				function dg1489732429091PageInitMethod(nTabIndex){
					WOM.produceTask.produceTask.makeTaskEdit.initSize(nTabIndex);
				}
			</script>
	...
	<#include "../../../ec/tableInfo/flowDealContainer_all.ftl">
		...
		<div id="WOM_produceTask_produceTask_makeTaskEdit_dealInfo" style="display: none;margin-top:5px;">
			<ul class="edit-tabs">
				<#if !(superEdit!false)>
				<li id="flowHead" onclick="WOM.produceTask.produceTask.makeTaskEdit.showFlowInfo('flow')"><span class="icon_prograss"></span>${getText("ec.flow.flowImage")}</li>
				</#if>
				<li id="fileUploadHead" <#if !(superEdit!false)>class="bar"</#if> onclick="WOM.produceTask.produceTask.makeTaskEdit.showFileUpload('fileUpload')"><span class="icon_file"></span>${getText("foundation.upload.attachment")}</li>
				<li id="dealInfoHead" class="bar" onclick="WOM.produceTask.produceTask.makeTaskEdit.showDealInfo('dealInfo')"><span class="icon_handle"></span>${getText("ec.view.dealadvice")}</li>
			</ul>
		...
		<!-- CUSTOM CODE START(view-EDIT-WOM_7.5.0.0_produceTask_makeTaskEdit,html,WOM_7.5.0.0_produceTask_ProduceTask,WOM_7.5.0.0) -->
<!-- 自定义代码 -->
...
<!-- CUSTOM CODE END -->
			...
			$(window).resize(function(){
				...
				if (width <= 800) {
					if($("#edit_sidebar").length==0 || $("#edit_sidebar").css("display")=="none"){
						$("#WOM_produceTask_produceTask_makeTaskEdit_main_div").css("width",800);
						$(".edit-head").css("width",800);
						$(".edit-workflow").css("width",800);
						$("body").css({"overflow-x":"scroll","position":"relative","zIndex":"100"});
					}else{
						$("#WOM_produceTask_produceTask_makeTaskEdit_main_div").css("width",650);
					...
					if (YAHOO.env.ua.ie == "6") {
						$("#WOM_produceTask_produceTask_makeTaskEdit_main_div").css("width",w1);
						$(".edit-workflow").css("width",w1);
					}else{
						$("#WOM_produceTask_produceTask_makeTaskEdit_main_div").css("width","auto");
		...
		<script type="text/javascript">
			WOM.produceTask.produceTask.makeTaskEdit.initCount = 0;
			WOM.produceTask.produceTask.makeTaskEdit.initSize = function(nTabIndex){
				var panesHeight;
				var thisHeight;
				var h = $(window).height();
			    var w = $(window).width();
				...
				var conHeight = h-$("#WOM_produceTask_produceTask_makeTaskEdit_main_div .edit-head").height()-$("#WOM_produceTask_produceTask_makeTaskEdit_main_div .edit-tabs").height()<#if pendingId?? || editNew>-$("#WOM_produceTask_produceTask_makeTaskEdit_main_div .edit-workflow").height()</#if>;
				$("#WOM_produceTask_produceTask_makeTaskEdit_main_div .edit-tabs").length == 0 ? conHeight = conHeight : conHeight = conHeight-28 //再减去28px，28px是由.edit-tabs的margin-top:14px+6px边框+8px的底部边距组成
				panesHeight = conHeight*0.4;  //当表单跟pt共存的时候采用4/6开
				var datagrids = $('body').data('WOM_produceTask_produceTask_makeTaskEdit_datagrids');
				var padding_bottom=16;
				$("#WOM_produceTask_produceTask_makeTaskEdit_main_div .pd_bottom,#WOM_produceTask_produceTask_makeTaskEdit_main_div .edit-tabs").width(w-14*2-2-width_)  //把tab跟tab下面的内容宽度统一调整
				$("#WOM_produceTask_produceTask_makeTaskEdit_main_div .edit-panes-s").each(function(index){
					//多页签切换时只计算本页签下的PT高度
					...
					if(datagrids && datagrids.length > 0) {
						if(datagrids[index].length > 0) {
							...
							for(var dg=0;dg<datagrids[index].length;dg++) {
								...
								if(dgwidget) {
									...
									if(WOM.produceTask.produceTask.makeTaskEdit.initCount <= 2) {
										setTimeout(function(){WOM.produceTask.produceTask.makeTaskEdit.initSize();}, 200);
										WOM.produceTask.produceTask.makeTaskEdit.initCount++;
									}/* else {
										WOM.produceTask.produceTask.makeTaskEdit.initCount = 0;
									}*/
								}
						...
						if(thisHeight < conHeight){ //当此页签下面的实际内容高度小于分配给它的高度
							...
							$(this).parent().height(conHeight);
							if(($("#WOM_produceTask_produceTask_makeTaskEdit_main_div .edit-workflow").length > 0) && ($("#WOM_produceTask_produceTask_makeTaskEdit_main_div .edit-tabs").length > 0)){		// 底下有处理结果，并且头部有页签切换，此时底部留白14像素
			...
			$(function(){
				$('#WOM_produceTask_produceTask_makeTaskEdit_form').get(0).onkeydown=function(event){
				...
				WOM.produceTask.produceTask.makeTaskEdit.buttonBar = new CUI.ButtonBar( { panel: '#top_buttonbar' }  );
				WOM.produceTask.produceTask.makeTaskEdit.initSize();
				if(YAHOO.env.ua.ie == 6){
				...
				<#if businessCenterList??&&businessCenterList?size gt 0 >
					...
					$("#edit_side_btn").toggle(function(){
						if(parseInt($("#WOM_produceTask_produceTask_makeTaskEdit_main_div").css("width"),10)==650){
							$("#WOM_produceTask_produceTask_makeTaskEdit_main_div").css("width","800px");
						...
						//WOM.produceTask.produceTask.makeTaskEdit.resizeLayout();
						//WOM.produceTask.produceTask.makeTaskEdit.initSize();
						$('body').trigger('resize');
					},function(){
						if(parseInt($("#WOM_produceTask_produceTask_makeTaskEdit_main_div").css("width"),10)==800){
							$("#WOM_produceTask_produceTask_makeTaskEdit_main_div").css("width","650px");
				...
				$(window).resize(function(){WOM.produceTask.produceTask.makeTaskEdit.initSize();});
				/*
				WOM.produceTask.produceTask.makeTaskEdit.resizeLayout=function(){
		...
		$(function(){
			<#if editNew>
			WOM.produceTask.produceTask.makeTaskEdit.setDepartment();
			<#else>
		...
		WOM.produceTask.produceTask.makeTaskEdit.validate = function(){
		...
		WOM.produceTask.produceTask.makeTaskEdit.beforeSaveProcess = function(){
			try{eval("savedg1489736028416DataGrid()");}catch(e){}
			try{eval("savedg1489730796226DataGrid()");}catch(e){}
			try{eval("savedg1489731937175DataGrid()");}catch(e){}
			try{eval("savedg1489732429091DataGrid()");}catch(e){}

			var extraCol = '<extra-data>';
			$('#WOM_produceTask_produceTask_makeTaskEdit_form').trigger('beforeSubmit');
		...
		WOM.produceTask.produceTask.makeTaskEdit.processDataGrid = function(){
										<#if false && isIE>
										$('#WOM_produceTask_produceTask_makeTaskEdit_form').append(ProduceTaskActive_dg1489730796226Widget._DT.createInputs('dg1489730796226List'));
										</#if>
										<#if false && isIE>
										$('#WOM_produceTask_produceTask_makeTaskEdit_form').append(ProduceTaskProcess_dg1489731937175Widget._DT.createInputs('dg1489731937175List'));
										</#if>
										<#if false && isIE>
										$('#WOM_produceTask_produceTask_makeTaskEdit_form').append(ProduceTaskActive_dg1489736028416Widget._DT.createInputs('dg1489736028416List'));
										</#if>
										<#if false && isIE>
										$('#WOM_produceTask_produceTask_makeTaskEdit_form').append(ProduceMaterialSum_dg1489732429091Widget._DT.createInputs('dg1489732429091List'));
										</#if>
		};
		WOM.produceTask.produceTask.makeTaskEdit.save = function(){
			<#if !(superEdit!false)>
			...
			if(!WOM.produceTask.produceTask.makeTaskEdit.validate()){return;}
			//延迟到延迟提交中处理,解决onchange事件无法触发问题
			//WOM.produceTask.produceTask.makeTaskEdit.beforeSaveProcess();

			//WOM.produceTask.produceTask.makeTaskEdit.processDataGrid();
			$('#WOM_produceTask_produceTask_makeTaskEdit_form').submit();
		}
		
		<#if viewType != "readonly">
		$(window).bind('beforeunload',function(){
		        if(isFormChanged('WOM_produceTask_produceTask_makeTaskEdit_form','WOM_produceTask_produceTask_makeTaskEdit_datagrids')) {      
		...
		//打印
		WOM.produceTask.produceTask.makeTaskEdit.print = function(){
		...
		WOM.produceTask.produceTask.makeTaskEdit.saveSetting = function(){
		...
		WOM.produceTask.produceTask.makeTaskEdit.printSetting = function(){
			var viewCode = $('input[name="viewCode"]').val();
			var value = "";
			var printId = 0;
			var printVersion = 0;
			if(viewCode!=undefined && viewCode!=null && viewCode!=''){
				...
				WOM.produceTask.produceTask.makeTaskEdit.settingDialog = new CUI.Dialog({
					...
					buttons:[
							{	name:"${getText("ec.flow.save")}",
								handler:function(){if(WOM.produceTask.produceTask.makeTaskEdit.saveSetting()){this.close();}}
							},
							{	name:"${getText("ec.flow.cancal")}",
								handler:function(){this.close()}
							}]
					})
				WOM.produceTask.produceTask.makeTaskEdit.settingDialog.show();
			}
		}
		
		
		
		WOM.produceTask.produceTask.makeTaskEdit.reject = function(){
			...
			WOM.produceTask.produceTask.makeTaskEdit.submit();
		}
		
		WOM.produceTask.produceTask.makeTaskEdit.submit = function(uncheck){
			if(uncheck){
		...
		WOM.produceTask.produceTask.makeTaskEdit.recall = function(){
		...
		WOM.produceTask.produceTask.makeTaskEdit._callBackInfo = function(res){
		...
		<#if editNew>
		WOM.produceTask.produceTask.makeTaskEdit.setDepartment = function(){
		...
		function dataGridBtnImgClick(sUrl,objNameCustomCondition,sTitle,sPTGridID,nRow,sFieldName,oGrid,customCallBack,crossCompany,isObjCustomProp,objCustomPropNames,viewCode){
			...
			if(customCallBack){
				WOM.produceTask.produceTask.makeTaskEdit._customCallBack = customCallBack;
			}
			if (isObjCustomProp) {
				WOM.produceTask.produceTask.makeTaskEdit._isObjCustomProp_IE = isObjCustomProp;
			} else {
				WOM.produceTask.produceTask.makeTaskEdit._isObjCustomProp_IE = false;
			}
			if (objCustomPropNames) {
				WOM.produceTask.produceTask.makeTaskEdit._objCustomPropNames_IE = objCustomPropNames;
			} else {
				WOM.produceTask.produceTask.makeTaskEdit._objCustomPropNames_IE = '';
			}
			if (viewCode) {
				WOM.produceTask.produceTask.makeTaskEdit._refViewCode_IE = viewCode;
			} else {
				WOM.produceTask.produceTask.makeTaskEdit._refViewCode_IE = '';
			}
			WOM.produceTask.produceTask.makeTaskEdit._selectEvent(objNameCustomCondition,null,sUrl,sTitle,null,null,null,crossCompany,obj);
		}
		
		WOM.produceTask.produceTask.makeTaskEdit.initMnemonic_DG_IE = function(oConfig){
			// 助记码也需要区分是否为自定义字段
			WOM.produceTask.produceTask.makeTaskEdit._isObjCustomProp_IE = oConfig._isObjCustomProp_IE;
			WOM.produceTask.produceTask.makeTaskEdit._objCustomPropNames_IE = oConfig._objCustomPropNames_IE;
			
			var oGrid = oConfig.oGrid;
			// 获取控件PT  object
			var oPTGridEx = oGrid._DT || oGrid;
			// 存储当前操作相关信息
			WOM.produceTask.produceTask.makeTaskEdit.gridEventObj = {
				"oGrid" : oGrid,
				"nRow" : oConfig.nRow - 1,
				"sKey":	oConfig.sFieldName
			}
			WOM.produceTask.produceTask.makeTaskEdit._sUrl = oConfig.url;
			if(oConfig.customCallBack){
				WOM.produceTask.produceTask.makeTaskEdit._customCallBack = oConfig.customCallBack;
			}
			// 自定义的表格对象
		...
		WOM.produceTask.produceTask.makeTaskEdit._selectEvent = function(objName,_selectType,url,title,refparam,obj,customCallBack,crossCompanyFlag,gridEventObj,oGrid,isMultiselect,oColumn){

			var callbackName="";
			var condition='';
			var _prefix= '';
			var arr = objName.split('.');
			if(WOM.produceTask.produceTask.makeTaskEdit._querycustomFunc(objName.replace(/\./g, '_')) !=null){
				condition=encodeURIComponent(WOM.produceTask.produceTask.makeTaskEdit._querycustomFunc(objName.replace(/\./g, '_')));
			}
			if(gridEventObj) {
				WOM.produceTask.produceTask.makeTaskEdit.gridEventObj = gridEventObj;
				callbackName = "WOM.produceTask.produceTask.makeTaskEdit.getcallBackInfo_DG_IE";
			}else if(obj!=null && obj!=""){
				if(arr.length > 1){
					_prefix = '.'+ arr[0];
				}
				callbackName = isMultiselect ? "WOM.produceTask.produceTask.makeTaskEdit.getMultiselectCallBackInfo_DG" : "WOM.produceTask.produceTask.makeTaskEdit.getcallBackInfo_DG";
				WOM.produceTask.produceTask.makeTaskEdit._currRow = $(obj).closest('tr')[0];
			}else{
				if(arr.length > 2){
					_prefix = '.'+ arr[0] + '.'+ arr[1];
				}
				callbackName ="WOM.produceTask.produceTask.makeTaskEdit.getcallBackInfo";
			}

			if(_prefix!=''){
				WOM.produceTask.produceTask.makeTaskEdit._prefix = _prefix.substring(1);
			}
			
			WOM.produceTask.produceTask.makeTaskEdit._oGrid = oGrid;
			WOM.produceTask.produceTask.makeTaskEdit._sUrl = url;
			if (oColumn) {
				if (oColumn.isObjCustomProp) {
					WOM.produceTask.produceTask.makeTaskEdit._isObjCustomProp = oColumn.isObjCustomProp;
				} else {
					WOM.produceTask.produceTask.makeTaskEdit._isObjCustomProp = false;
				} 
				if (oColumn.objCustomPropNames) {
					WOM.produceTask.produceTask.makeTaskEdit._objCustomPropNames = oColumn.objCustomPropNames;
				} else {
					WOM.produceTask.produceTask.makeTaskEdit._objCustomPropNames = '';
				}
				if (oColumn.viewCode) {
					WOM.produceTask.produceTask.makeTaskEdit._refViewCode = oColumn.viewCode;
				} else {
					WOM.produceTask.produceTask.makeTaskEdit._refViewCode = '';
				}
			} else {
				WOM.produceTask.produceTask.makeTaskEdit._isObjCustomProp = false;
				WOM.produceTask.produceTask.makeTaskEdit._objCustomPropNames = '';
			...
			if (WOM.produceTask.produceTask.makeTaskEdit._isObjCustomProp == true && WOM.produceTask.produceTask.makeTaskEdit._objCustomPropNames && objName && objName.substring(objName.length - 'MainDisplay'.length) == 'MainDisplay') {
				WOM.produceTask.produceTask.makeTaskEdit._prefix = objName.substring(0, objName.length - 'MainDisplay'.length);
			}
			if(customCallBack){
				WOM.produceTask.produceTask.makeTaskEdit._customCallBack = customCallBack;
			}
			if(WOM.produceTask.produceTask.makeTaskEdit._querycustomFunc(objName.replace(/\./g, '_')) != null) {
				refparam = 'condition=' + encodeURIComponent(WOM.produceTask.produceTask.makeTaskEdit._querycustomFunc(objName.replace(/\./g, '_')));
			}
			if(typeof WOM.produceTask.produceTask.makeTaskEdit._querycustomFuncN == "function") {
				refparam += WOM.produceTask.produceTask.makeTaskEdit._querycustomFuncN();
			}
			...
			WOM.produceTask.produceTask.makeTaskEdit._dialog = foundation.common.select({
				pageType : 'other',
				closePage : true,
				condition : condition,
		...
		WOM.produceTask.produceTask.makeTaskEdit._groupSelectEvent = function(objName,_selectType,url,title,refparam){
			if(WOM.produceTask.produceTask.makeTaskEdit._querycustomFunc(objName.replace(/\./g, '_')) != null) {
				refparam = 'condition=' + encodeURIComponent(WOM.produceTask.produceTask.makeTaskEdit._querycustomFunc(objName.replace(/\./g, '_')));
			}
			WOM.produceTask.produceTask.makeTaskEdit._dialog = foundation.common.select({
				...
				closePage : true,
				callBackFuncName : 'WOM.produceTask.produceTask.makeTaskEdit.getcallBackGroupInfo',
				url : url,
				title : title,
				params : refparam
			});
		}
		WOM.produceTask.produceTask.makeTaskEdit._querycustomFunc = function(obj) {
			var str = eval("typeof(WOM.produceTask.produceTask.makeTaskEdit.query_"+obj+")!='undefined'") ? eval('WOM.produceTask.produceTask.makeTaskEdit.query_'+obj+'()') : null;
			return str;
		};
		WOM.produceTask.produceTask.makeTaskEdit.getcallBackGroupInfo = function(obj){
			var ids = "";
			var names = "";
			...
			WOM.produceTask.produceTask.makeTaskEdit._dialog.close();
		}
		WOM.produceTask.produceTask.makeTaskEdit.getcallBackInfo = function(obj){
		
			obj[0] = foundation.common.getObject('WOM_produceTask_produceTask_makeTaskEdit_form',obj[0], WOM.produceTask.produceTask.makeTaskEdit._prefix, WOM.produceTask.produceTask.makeTaskEdit._sUrl);
			CUI.commonFills('WOM_produceTask_produceTask_makeTaskEdit_form',WOM.produceTask.produceTask.makeTaskEdit._prefix,obj[0]);
			
			for(pro in obj[0]){
				try{
					var fname = "_callback_" + (WOM.produceTask.produceTask.makeTaskEdit._prefix + "." + pro).replace(/\./g, '_')  + "_edit";
			...
			try{
				if(WOM.produceTask.produceTask.makeTaskEdit._customCallBack) {
					eval(WOM.produceTask.produceTask.makeTaskEdit._customCallBack);
					WOM.produceTask.produceTask.makeTaskEdit._customCallBack = null;
				}
		...
		// 控件版PT回调
		WOM.produceTask.produceTask.makeTaskEdit.getcallBackInfo_DG_IE = function(obj){
			if(WOM.produceTask.produceTask.makeTaskEdit._customBeforeCallBack) {
				var flag = eval(WOM.produceTask.produceTask.makeTaskEdit._customBeforeCallBack.split("(")[0] + "(obj)");
				if(flag === false){
					return false;
				}
			}
			var gridEventObj = WOM.produceTask.produceTask.makeTaskEdit.gridEventObj;
			var rootKey = gridEventObj.sKey.split('.')[0];
			var jsonObj;
			if ( WOM.produceTask.produceTask.makeTaskEdit._isObjCustomProp_IE == true && WOM.produceTask.produceTask.makeTaskEdit._objCustomPropNames_IE ) {
				jsonObj = foundation.common.getObjectIE_CP_OBJ(gridEventObj,obj[0],rootKey,WOM.produceTask.produceTask.makeTaskEdit._sUrl,WOM.produceTask.produceTask.makeTaskEdit._objCustomPropNames_IE);
			} else {
				jsonObj = foundation.common.getObjectIE(gridEventObj,obj[0],rootKey,WOM.produceTask.produceTask.makeTaskEdit._sUrl);
			}
			CUI.error_msg_DG_CP_map = {};
			var xmlHead = $(gridEventObj.oGrid._DT.opts.oXMLData).children( ':eq(0)' ).children( ':eq(0)' );
			if (WOM.produceTask.produceTask.makeTaskEdit._isObjCustomProp_IE == true && WOM.produceTask.produceTask.makeTaskEdit._objCustomPropNames_IE) { // 控件版PT显示自定义字段
				var showName = WOM.produceTask.produceTask.makeTaskEdit._objCustomPropNames_IE.split(',')[0]; // 主显示字段名称
				var trueName = WOM.produceTask.produceTask.makeTaskEdit._objCustomPropNames_IE.split(',')[1]; // 主键字段名称
			...
			if ( $('#dg_cp_info_' + gridEventObj.oGrid._DT.opts.id).length > 0 ) {
				...
				var id = jsonObj.id;
				var relationMap;
				if (dg_cp_info && id && WOM.produceTask.produceTask.makeTaskEdit._refViewCode_IE) {
					$.ajax({
						async   : false,
						type    : 'POST',
						url     : '/foundation/customProp/related.action',
						data    : 'code=' + WOM.produceTask.produceTask.makeTaskEdit._refViewCode_IE + '&id=' + id,
		...
		WOM.produceTask.produceTask.makeTaskEdit.getcallBackInfo_DG = function(obj){
			if(WOM.produceTask.produceTask.makeTaskEdit._customBeforeCallBack) {
				var flag = eval(WOM.produceTask.produceTask.makeTaskEdit._customBeforeCallBack.split("(")[0] + "(obj)");
				if(flag === false){
					return false;
			...
			for(var i=0;i<obj.length;i++){
				if(i>0){
					if($(WOM.produceTask.produceTask.makeTaskEdit._currRow).next().length==0){
						WOM.produceTask.produceTask.makeTaskEdit._oGrid.addNewRow();
					}	
					WOM.produceTask.produceTask.makeTaskEdit._currRow = $(WOM.produceTask.produceTask.makeTaskEdit._currRow).next();
					$(WOM.produceTask.produceTask.makeTaskEdit._currRow).attr('isEdited',true);
				}
				obj[i] = foundation.common.getObject(WOM.produceTask.produceTask.makeTaskEdit._currRow,obj[i], WOM.produceTask.produceTask.makeTaskEdit._prefix, WOM.produceTask.produceTask.makeTaskEdit._sUrl);
				if (WOM.produceTask.produceTask.makeTaskEdit._isObjCustomProp == true && WOM.produceTask.produceTask.makeTaskEdit._objCustomPropNames) {
					eval("CUI.commonFills_DG_CP_OBJ(WOM.produceTask.produceTask.makeTaskEdit._currRow,WOM.produceTask.produceTask.makeTaskEdit._prefix,obj[i],WOM.produceTask.produceTask.makeTaskEdit._oGrid,WOM.produceTask.produceTask.makeTaskEdit._objCustomPropNames)");
				} else {
					eval("CUI.commonFills_DG(WOM.produceTask.produceTask.makeTaskEdit._currRow,WOM.produceTask.produceTask.makeTaskEdit._prefix,obj[i],WOM.produceTask.produceTask.makeTaskEdit._oGrid)");
				}
				
				// 自定义字段参照回填
				if ( $('#dg_cp_info_' + WOM.produceTask.produceTask.makeTaskEdit._oGrid.dataTableId).length > 0 ) {
					var dg_cp_info = $('#dg_cp_info_' + WOM.produceTask.produceTask.makeTaskEdit._oGrid.dataTableId).val();
					var id = obj[i].id;
					var relationMap;
					if (dg_cp_info && id && WOM.produceTask.produceTask.makeTaskEdit._refViewCode) {
						$.ajax({
							async   : false,
							type    : 'POST',
							url     : '/foundation/customProp/related.action',
							data    : 'code=' + WOM.produceTask.produceTask.makeTaskEdit._refViewCode + '&id=' + id,
							success : function(res){
								if (res.dealSuccessFlag && res.relationMap) {
									relationMap = res.relationMap;
								}
						...
						if (relationMap) {
							...
							for (var n in infoArr) {
								...
								var val = relationMap[key];
								if (val) {
									name = WOM.produceTask.produceTask.makeTaskEdit._oGrid.configs.hidekeyPrefix + name;
									objs[name] = val;
									if (propCode) {
										$.ajax({
											async   : false,
							...
							// console.log(objs);
							if (objs) {
								CUI.commonFills_DG_CP(WOM.produceTask.produceTask.makeTaskEdit._currRow, objs, WOM.produceTask.produceTask.makeTaskEdit._oGrid);
							}
						}
					}
				}
				...
				try{
					...
					for ( var item in  CUI.error_msg_DG_CP_map ){
						for ( var n in  CUI.error_msg_DG_CP_map[item] ){
							errorMsg += ( '<b>' + WOM.produceTask.produceTask.makeTaskEdit._oGrid.getLabel(item) +  '</b>第<b>' + ( parseInt( n, 10 ) + 1)  + '</b>行回填失败！原因:系统编码值不匹配！<br/>' );
						}
					}
					if( errorMsg ){
						workbenchErrorBarWidget.showMessage( errorMsg );
		...
		WOM.produceTask.produceTask.makeTaskEdit.getMultiselectCallBackInfo_DG = function(obj){
			for(var i=0;i<obj.length;i++){
				CUI.commonFillsMultiselect_DG(WOM.produceTask.produceTask.makeTaskEdit._oGrid, WOM.produceTask.produceTask.makeTaskEdit._currRow, WOM.produceTask.produceTask.makeTaskEdit._key, WOM.produceTask.produceTask.makeTaskEdit._displayFieldName, obj[i])
			}
			try{
				if(WOM.produceTask.produceTask.makeTaskEdit._customCallBack) {
					eval(WOM.produceTask.produceTask.makeTaskEdit._customCallBack);
		...
		WOM.produceTask.produceTask.makeTaskEdit.generateInput = function(prefix, obj) {
			CUI.each(obj, function(key,value){
				if(value!=null && key!='rowHtmlObj' && key!='cellHtmlObj'){
					var name = prefix + '.' + key;
					if(typeof value == 'object') {
						WOM.produceTask.produceTask.makeTaskEdit.generateInput(name, value);
					} else {
						if(value!=null&&value!='null'&&value!=undefined&&value!='') {
							CUI('input[name="' + name + '"]').remove();
							CUI('<input type="hidden" name="'+name+'" value="'+value+'">').appendTo(CUI('#WOM_produceTask_produceTask_makeTaskEdit_form'));
						}
					}
				}
			});
		...
		$(function(){
			WOM.produceTask.produceTask.makeTaskEdit.onloadForProduct();
...
beforeChangeNum = $('#produceTask_productNum').val();
		...
		WOM.produceTask.produceTask.makeTaskEdit.beforeSubmitMethodSettingInPage = function(){
			WOM.produceTask.produceTask.makeTaskEdit.onsaveForProduct();
...
if(isNeedConfirm=="88"){
   ...
   if(batchContral=='true'){
      ...
      CUI.Dialog.alert("${getText('WOM.confirmcontent.radion1504182834291pl11')}");
		...
		WOM.produceTask.produceTask.makeTaskEdit.beforeSubmitMethod = function(){
			...
			var customOnsaveResult =  WOM.produceTask.produceTask.makeTaskEdit.beforeSubmitMethodSettingInPage();
		...
		<script type="text/javascript">
		WOM.produceTask.produceTask.makeTaskEdit.showBusinessList = function(relatingModelCode,mainEntityId,businessCenterCode,url,showType){
			...
			if(CUI(id).html() == null || $.trim(CUI(id).html()) == ""){
				CUI(id).load(url);
				setTimeout(function(){
					CUI("#WOM_produceTask_produceTask_makeTaskEdit_main_div").hide();
				},100);
			}else{
			    CUI(id).load(url);
				setTimeout(function(){
		...
		WOM.produceTask.produceTask.makeTaskEdit.showThis = function(){
			if(!CUI("#WOM_produceTask_produceTask_makeTaskEdit_main_div").is(':visible')) {
				CUI("#WOM_produceTask_produceTask_makeTaskEdit_main_div").show();
		...
		WOM.produceTask.produceTask.makeTaskEdit.showAudit=function(){
			<#if !id?? || editNew>
			CUI.Dialog.alert("${getText("foundation.base.audit.nolog")}")
			<#else>
			WOM.produceTask.produceTask.makeTaskEdit.auditDialog = new CUI.Dialog({
				title : "${getText("foundation.base.audit")}",
				iframe : "WOM_produceTask_produceTask_makeTaskEdit_auditInfo",
				modal:true,
			...
			WOM.produceTask.produceTask.makeTaskEdit.auditDialog.show();
			</#if>
		}
		
		
		WOM.produceTask.produceTask.makeTaskEdit.showInfoDialog=function(mode){
			
			WOM.produceTask.produceTask.makeTaskEdit.infoDialog = new CUI.Dialog({
				title: "${getText("ec.view.info.view")}",
				elementId: "WOM_produceTask_produceTask_makeTaskEdit_dealInfo",
				modal:true,
				height:500,
				width: 950,//适应国际化版
				buttons:[
			...
			WOM.produceTask.produceTask.makeTaskEdit.infoDialog.show();
		...
		WOM.produceTask.produceTask.makeTaskEdit.showFileUpload=function(){
		...
		WOM.produceTask.produceTask.makeTaskEdit.showDealInfo=function(){
		...
		WOM.produceTask.produceTask.makeTaskEdit.showFlowInfo=function(){
		...
		WOM.produceTask.produceTask.makeTaskEdit.supervision=function(){
			WOM.produceTask.produceTask.makeTaskEdit.modifyOwnerStaffDialog = new CUI.Dialog({
				...
				WOM.produceTask.produceTask.makeTaskEdit.modifyOwnerStaffDialog.show();
		}
...
function callbackPosition(obj) {
				...
				$('#produceTask_formularId_editions').val(obj[0].edition);
				$('#produceTask_formularId_name').val(obj[0].product.productCode);
				$('#produceTask_productId_productName').val(obj[0].product.productName);
				$('#produceTask_productId_productSpecif').val(obj[0].product.productSpecif);
				$('#produceTask_productId_productModel').val(obj[0].product.productModel);
				$('#produceTask_productId_productBaseUnit_name').val(obj[0].product.unitGroup.name);
				$('#produceTask_productNum').val(obj[0].orderNumber);
				$('input[name="produceTask.planStartTime"]').val(obj[0].planStartTime);
				$('input[name="produceTask.planEndTime"]').val(obj[0].planEndTime);
				var formulaCode =obj[0].manulOrderNum
				//var formulaCode = obj[0].product.productCode +'_'+ obj[0].edition;
				console.log(formulaCode);
				$.ajax({
					url: "/public/WOM/produceTask/produceTask/getFormulaId.action",
					type: 'post',
					traditional: true,
					async: false,
					data: {
					...
					success: function(res) {
						if (res.hasFormula == 1) {
							$('input[name="produceTask.formularId.code"]').val(formulaCode);
							$('input[name="produceTask.formularId.id"]').val(res.formulaId);
						}else{
							workbenchErrorBarWidget.showMessage("配方不存在或未启用,请检查配方编码!");
						}
					}
				});			
...
function checkRatioChange(){
   ...
   for(var i=0;i<len;i++){
	   ...
	   if(before!=after){
		...
		/* CUSTOM CODE START(view-EDIT-WOM_7.5.0.0_produceTask_makeTaskEdit,js,WOM_7.5.0.0_produceTask_ProduceTask,WOM_7.5.0.0) */
// 自定义代码
 
    WOM.produceTask.produceTaskActive =WOM.produceTask.produceTask.makeTaskEdit;
      WOM.produceTask.produceTaskActive.callBackInfo=function(){ 
		setTimeout(function(){
			CUI.Dialog.toggleAllButton();
			activeDialog.close();        
			ProduceTaskActive_dg1489736028416Widget._DT.setRequestDataUrl(ProduceTaskActive_dg1489736028416Widget._DT.requestUrl);
         },600);
        
        }
      
      
        var activeDialog=new CUI.Dialog({//新增活动
			title:"活动",
			formId:"WOM_produceTask_produceTaskActive_avtiveEdit_form",
			type:5,
			modal:true,
	...
	function produceTask_formularId_code_delete(){
      	 produceTask_factoryId_name_delete();
      	setValue('produceTaskautoReportOnFinishid','');
		...
		$('#produceTask_productId_productCode_mneTipLabel').show();
		formulaChange1();
        ...
        //重写 by  pl 
		//为了批量指令单中能够不经过待办，组织url参数打开链接，直接可以打开单据
        WOM.produceTask.produceTask.makeTaskEdit._callBackInfo = function(res){
          console.log(res);
			if(res.dealSuccessFlag){
					var showMsg ;
	...
	//制造指令单产品过滤物料批号
	WOM.produceTask.produceTask.makeTaskEdit.query_dg1489730796226batchNumObj_batchText= function(){
		var product=ProduceTaskActive_dg1489730796226Widget.getCellValue(ProduceTaskActive_dg1489730796226Widget.getSelectedRow(),"productId.id");
...
/* CUSTOM CODE END */
		WOM.produceTask.produceTask.makeTaskEdit.onloadForProduct = function(){
		/* CUSTOM CODE START(view-EDIT-WOM_7.5.0.0_produceTask_makeTaskEdit,onloadForProduct,WOM_7.5.0.0_produceTask_ProduceTask,WOM_7.5.0.0) */
// 自定义代码

/* CUSTOM CODE END */
		}

		WOM.produceTask.produceTask.makeTaskEdit.onsaveForProduct = function(){
		/* CUSTOM CODE START(view-EDIT-WOM_7.5.0.0_produceTask_makeTaskEdit,onsaveForProduct,WOM_7.5.0.0_produceTask_ProduceTask,WOM_7.5.0.0) */
// 自定义代码
...
/* CUSTOM CODE END */		
		...
		<div class="col-sub">
			...
			<div class="edit-sidebar-inner" style='height:1000px;'>
				<div class="sidebar-top"><a href="#"  onclick="WOM.produceTask.produceTask.makeTaskEdit.showThis()">${getText("ec.view.tableInfo")}</a></div>
					...
					<ul>
						<#list businessCenterList as l>
						 <li>
							...
							<#else>
								<a href="#"  onclick="WOM.produceTask.produceTask.makeTaskEdit.showBusinessList('${l.relatingModel.code.replace('.','')}',${(produceTask.id)!},'${l.code}','${l.assview.url}?${getPowerCode(l.assview.code+'_self')}','${l.assview.showType}')" title="${getText(l.showName)}(${(l.count)!})">${getText(l.showName)}(${(l.count)!})</a>
							</#if>
						</li>
					    </#list>
					</ul>
