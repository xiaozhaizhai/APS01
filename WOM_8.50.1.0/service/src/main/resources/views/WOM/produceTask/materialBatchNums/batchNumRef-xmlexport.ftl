...
<#assign viewCode = 'WOM_7.5.0.0_produceTask_MaterialBatchNums' />
<#assign propertyCode = '' />
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'proNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490617192684')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchNum.batchText' || item == '*'>
							...
							<Row ss:AutoFitHeight="0">
								<#list exportFieldList as item>
									<#if item?length gt 0>
												<#if item == 'productId.productCode' || item == '*'>
													<Cell>
													<#if checkFieldPermission('productId.productCode','WOM_7.5.0.0_produceTask_MaterialBatchNums','WOM_7.5.0.0_produceTask_MaterialBatchNums_productId||MESBasic_1_product_Product_productCode') != 0>
												...
												<#if item == 'productId.productName' || item == '*'>
													<Cell>
													<#if checkFieldPermission('productId.productName','WOM_7.5.0.0_produceTask_MaterialBatchNums','WOM_7.5.0.0_produceTask_MaterialBatchNums_productId||MESBasic_1_product_Product_productName') != 0>
												...
												<#if item == 'proNum' || item == '*'>
													<Cell>
													<#if checkFieldPermission('proNum','WOM_7.5.0.0_produceTask_MaterialBatchNums','WOM_7.5.0.0_produceTask_MaterialBatchNums_proNum') != 0>
														<#if data.proNum??><Data ss:Type="String"><![CDATA[${(data.proNum)!}]]></Data></#if>
													</#if>
													</Cell>
												</#if>
												<#if item == 'batchNum.batchText' || item == '*'>
													...
													<#if checkFieldPermission('batchNum.batchText','WOM_7.5.0.0_produceTask_MaterialBatchNums','WOM_7.5.0.0_produceTask_MaterialBatchNums_batchNum||WOM_7.5.0.0_standingcropRef_StandingcropRef_batchText') != 0>
														<#if data.batchNum.batchText??><Data ss:Type="String"><![CDATA[${(data.batchNum.batchText)!}]]></Data></#if>
													</#if>
													</Cell>
												</#if>
								...
								<#if item??>
									<#if item.name?index_of(".")!=-1>
											...
											<Cell  ss:StyleID="${item.styleid}" >
												<#if checkFieldPermission('${(item.name)!}','WOM_7.5.0.0_produceTask_MaterialBatchNums','${(item.propertyCode)!}') != 0>
