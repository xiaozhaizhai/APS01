...
<#assign viewCode = 'WOM_7.5.0.0_produceTask_AdjustOrTempRecords' />
<#assign propertyCode = '' />
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'activeRecordState.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
															<Column ss:Index="${count}" ss:StyleID="${item?substring(0,item?last_index_of('.'))}"  ss:Width="140"/>
														 <#else>
														    <Column ss:Index="${count}" ss:StyleID="${item}"  ss:Width="140" />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'processName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1542192019742')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'acticeName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1542181804390')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'activeType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1542182374652')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'activeRecordState.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1542181818133')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'actualUse' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1542179773992')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'startTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1542098129762')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'endTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1542098149042')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'remark' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1542098160250')}</Data></Cell>
											</#if>
									...
									<#if item?length gt 0>
												<#if item == 'processName' || item == '*'>
													<Cell>
														...
														<#if data.processName??><Data ss:Type="String"><![CDATA[${(data.processName)!}]]></Data></#if>
												...
												<#if item == 'acticeName' || item == '*'>
													<Cell>
														...
														<#if data.acticeName??><Data ss:Type="String"><![CDATA[${(data.acticeName)!}]]></Data></#if>
