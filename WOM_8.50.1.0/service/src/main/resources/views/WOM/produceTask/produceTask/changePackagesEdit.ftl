...
<head>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <#assign configTitle = getText('WOM.viewtitle.randon1506058887536')>
		...
		#WOM_produceTask_produceTask_changePackagesEdit_form{float:left;width:100%;}
		.pd-top{padding-top:0px}    /*紧贴头部，取消10px的空隙*/
		</style>
		<script type="text/javascript">
			CUI.ns('WOM.produceTask.produceTask.changePackagesEdit');
			WOM.produceTask.produceTask.changePackagesEdit.currentUser = ${userJson};
			WOM.produceTask.produceTask.changePackagesEdit.currentStaff = ${staffJson};
			WOM.produceTask.produceTask.changePackagesEdit.currentDepartment = ${deptJson};
			WOM.produceTask.produceTask.changePackagesEdit.currentPosition = ${postJson};
			WOM.produceTask.produceTask.changePackagesEdit.currentCompany = ${compJson};
		</script>
    </head>
	<body>
		<@loadpanel/>
		...
		<@s.form errorBarId="workbenchErrorBar" hiddenField="produceTask.bulkProduct.id,produceTask.factoryId.id,produceTask.formularId.id,produceTask.id,produceTask.productId.id,produceTask.bulkBatchNum.id,produceTask.planParId.id," onsubmitMethod="WOM.produceTask.produceTask.changePackagesEdit.beforeSubmitMethod()" id="WOM_produceTask_produceTask_changePackagesEdit_form" namespace="/WOM/produceTask/produceTask/changePackagesEdit" action="submit?__pc__=${(Parameters.__pc__)!}&_bapFieldPermissonModelCode_=WOM_7.5.0.0_produceTask_ProduceTask&_bapFieldPermissonModelName_=ProduceTask&superEdit=${(superEdit!false)?string}" callback="WOM.produceTask.produceTask.changePackagesEdit._callBackInfo" ecform="true">
		<input type="hidden" name="bap_validate_user_id" value="${(Session.user.id)!}" />
		<div style="float:none;width:auto;" class="edit-main grid-s5m0 col-main main-wrap" id="WOM_produceTask_produceTask_changePackagesEdit_main_div">
    					<div class="edit-head">
    						...
    						<div class="edit-menubar">
								<div class="fl" id="top_buttonbar">
									...
									<a class='cui-btn-new' id="edit-save-btn" onclick="WOM.produceTask.produceTask.changePackagesEdit.save()"><span class="save"></span>${getHtmlText("ec.flow.save")}</a>
									...
									<script type="text/javascript">
										$(function(){
											$('#edit-${t.name}-btn').click(function(){
												...
												WOM.produceTask.produceTask.changePackagesEdit.submit(true);
											});
										});
									</script>
											</#if>
									...
									<#if !(superEdit!false)>
									<a class='cui-btn-new' id="edit-submit-btn" onclick="WOM.produceTask.produceTask.changePackagesEdit.submit()"><span class="submit"></span>${getHtmlText("ec.flow.submit")}</a>
									...
									<a class='cui-btn-new'  id="edit-recall-btn" onclick="WOM.produceTask.produceTask.changePackagesEdit.recall()"><span class="edit-cancel"></span>${getHtmlText("ec.flow.recall")}</a>
								
									</#if>
									<#if hasSupervision>
									<a class='cui-btn-new' id="edit-supervision-btn" onclick="WOM.produceTask.produceTask.changePackagesEdit.supervision()"><span class="edit-person"></span>${getHtmlText("ec.flow.supervision.modifyPending")}</a>
								...
								<div class="fr">
									<ul>
										<#if !(superEdit!false)>
										<li id="fr_flow"><a title='${getText("ec.flow.flowImage")}' onclick="WOM.produceTask.produceTask.changePackagesEdit.showInfoDialog('flow')"><span class='icon_prograss' ></span></a></li>
										</#if>
										<#if auditCheck('WOM_7.5.0.0_produceTask_changePackagesEdit') == '1'>
										<li id="fr_audit" ><a title='${getText("foundation.base.audit")}' onclick="WOM.produceTask.produceTask.changePackagesEdit.showAudit()">
										<span class='icon_audit' ></span>
										</a></li>
										</#if>
										<li id="fr_fileUpload" onMouseOver="this.style.color='#ffc001'" onMouseOut="this.style.color='#FFFFFF'"><a title='${getText("foundation.upload.attachment")}' onclick="WOM.produceTask.produceTask.changePackagesEdit.showInfoDialog('fileUpload')">
										
										<span class='icon_file' ><i class='total'><em id="WOM_produceTask_produceTask_changePackagesEdit_form_attcount"></em></i></span>
										</a></li>
										<li id="fr_dealInfo"><a title='${getText("ec.view.dealadvice")}'  onclick="WOM.produceTask.produceTask.changePackagesEdit.showInfoDialog('dealInfo')"><span class='icon_handle'></span></a></li>
									</ul>
								</div>
							</div>
							</#if>
								...
								<span class="position">
									<input id="positionLayRec" type="hidden" name="produceTask.positionLayRec" value="<#if editNew>${(creatorInfo.positions[0].layRec)!}<#else>${(produceTask.positionLayRec)!}</#if>" />
										<#if editNew>
											...
											<select id="creatorPosition" name="produceTask.createPositionId" onchange="WOM.produceTask.produceTask.changePackagesEdit.setDepartment()">
												<#list creatorInfo.positions as p>
													<#if !(p.isVirtual?? && p.isVirtual)>
    					...
    					<div class="edit-main" id="WOM_produceTask_produceTask_changePackagesEdit">
    						<div class="edit-content">
								<input type="hidden" id="dealInfoGroup" name="dealInfoGroup" value="">
								<input type="hidden" name="viewselect" value="changePackagesEdit">
								<input type="hidden" name="datagridKey" value="WOM_produceTask_produceTask_changePackagesEdit_datagrids">
								<input type="hidden" name="viewCode" value="WOM_7.5.0.0_produceTask_changePackagesEdit">
...
<script type="text/javascript">
var attcountid = "WOM_produceTask_produceTask_changePackagesEdit_form"+"_attcount";
...
<div class="edit-panes-s" style="width:98%;margin-left:10px;">
	<table class="edit-table" style="">
		...
		<tr >
												...
												<#if !WOM_7_5_0_0_produceTask_ProduceTask_planParId_WOM_7_5_0_0_producePlanRef_DayBatchPlanParts_dayPlanInfo_WOM_7_5_0_0_producePlanRef_DayBatchPlanInfo_tableNo_permit??>
					<#assign WOM_7_5_0_0_produceTask_ProduceTask_planParId_WOM_7_5_0_0_producePlanRef_DayBatchPlanParts_dayPlanInfo_WOM_7_5_0_0_producePlanRef_DayBatchPlanInfo_tableNo_permit = checkFieldPermission('produceTask.planParId.dayPlanInfo.tableNo','WOM_7.5.0.0_produceTask_ProduceTask','WOM_7.5.0.0_producePlanRef_DayBatchPlanInfo_tableNo')>
					</#if>
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_planParId_WOM_7_5_0_0_producePlanRef_DayBatchPlanParts_dayPlanInfo_WOM_7_5_0_0_producePlanRef_DayBatchPlanInfo_tableNo_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-symbol"   align="right" style="text-align: right;;" >
							<label style="<#if WOM_7_5_0_0_produceTask_ProduceTask_planParId_WOM_7_5_0_0_producePlanRef_DayBatchPlanParts_dayPlanInfo_WOM_7_5_0_0_producePlanRef_DayBatchPlanInfo_tableNo_permit != 3>color:#B1B1B1;</#if>width:100%;;" value="${getText('WOM.propertydisplayName.randon1505994371242')}" >${getText('WOM.propertydisplayName.randon1505994371242')}</label>
				</td>
					...
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_planParId_WOM_7_5_0_0_producePlanRef_DayBatchPlanParts_dayPlanInfo_WOM_7_5_0_0_producePlanRef_DayBatchPlanInfo_tableNo_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
							<#if WOM_7_5_0_0_produceTask_ProduceTask_planParId_WOM_7_5_0_0_producePlanRef_DayBatchPlanParts_dayPlanInfo_WOM_7_5_0_0_producePlanRef_DayBatchPlanInfo_tableNo_permit == 0>
							...
							<#else>
								...
								<#if WOM_7_5_0_0_produceTask_ProduceTask_planParId_WOM_7_5_0_0_producePlanRef_DayBatchPlanParts_dayPlanInfo_WOM_7_5_0_0_producePlanRef_DayBatchPlanInfo_tableNo_permit == 1>
									<@mneclient iframe=mneIframe!false property_type="TEXT" mneenable=false reftitle="${getText('WOM.viewtitle.randon1489823707131')}" conditionfunc="WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc('produceTask_planParId_dayPlanInfo_tableNo')" view=true value="${(produceTask.planParId.dayPlanInfo.tableNo)!}" displayFieldName="tableNo" name="produceTask.planParId.dayPlanInfo.tableNo" id="produceTask_planParId_dayPlanInfo_tableNo" type="other" url="/WOM/producePlanRef/dayBatchPlanParts/planRef.action" clicked=true multiple=false mnewidth=260 formId="WOM_produceTask_produceTask_changePackagesEdit_form" editCustomCallback="setOtherValue(obj);" onkeyupfuncname="setOtherValue(obj);_callback_produceTask_planParId_dayPlanInfo_tableNo(obj);" cssStyle="" isEdit=true  refViewCode="WOM_7.5.0.0_producePlanRef_planRef"   isCrossCompany=false  />
								<#else>
									<@mneclient iframe=mneIframe!false property_type="TEXT" mneenable=false reftitle="${getText('WOM.viewtitle.randon1489823707131')}" viewType="${viewType!}" deValue="${produceTask_planParId_dayPlanInfo_tableNo_defaultValue!}" conditionfunc="WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc('produceTask_planParId_dayPlanInfo_tableNo')"  value="${(produceTask.planParId.dayPlanInfo.tableNo)!}" displayFieldName="tableNo" name="produceTask.planParId.dayPlanInfo.tableNo" id="produceTask_planParId_dayPlanInfo_tableNo" type="other" url="/WOM/producePlanRef/dayBatchPlanParts/planRef.action" clicked=true multiple=false mnewidth=260 formId="WOM_produceTask_produceTask_changePackagesEdit_form" editCustomCallback="setOtherValue(obj);" refViewCode="WOM_7.5.0.0_producePlanRef_planRef"  onkeyupfuncname="setOtherValue(obj);_callback_produceTask_planParId_dayPlanInfo_tableNo(obj);" cssStyle="" isEdit=true   isCrossCompany=false  />
								</#if>
								...
								<#if !(produceTask.id)?? && (produceTask.planParId.dayPlanInfo.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('WOM_produceTask_produceTask_changePackagesEdit_form',obj, 'produceTask.planParId.dayPlanInfo', '/WOM/producePlanRef/dayBatchPlanParts/planRef.action');
												CUI.commonFills('WOM_produceTask_produceTask_changePackagesEdit_form', 'produceTask.planParId.dayPlanInfo',obj,true);
											}
										});
									})(jQuery);
								</#if>
								
									WOM.produceTask.produceTask.changePackagesEdit.query_produceTask_planParId_dayPlanInfo_tableNo = function() {
					...
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_productId_MESBasic_1_product_Product_productCode_permit != 3>nofieldPermission="true"</#if> nullable=false class="edit-table-content"   align="left" style="text-align: left;;" >
							...
							<#else>
								...
								<#if WOM_7_5_0_0_produceTask_ProduceTask_productId_MESBasic_1_product_Product_productCode_permit == 1>
									<@mneclient iframe=mneIframe!false property_type="TEXT" reftitle="${getText('MESBasic.viewtitle.randon1450085069587')}" conditionfunc="WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc('produceTask_productId_productCode')" view=true value="${(produceTask.productId.productCode)!}" displayFieldName="productCode" name="produceTask.productId.productCode" id="produceTask_productId_productCode" type="other" url="/MESBasic/product/product/refProductLayout.action" clicked=true multiple=false mnewidth=260 formId="WOM_produceTask_produceTask_changePackagesEdit_form" editCustomCallback="getDefaultFormular(obj);" onkeyupfuncname="getDefaultFormular(obj);_callback_produceTask_productId_productCode(obj);" cssStyle="" isEdit=true beforecallback='clearFormular(obj)'  refViewCode="MESBasic_1_product_refProductLayout"  isCrossCompany=false editLinkCallBack="_callback_produceTask_productId_productCode_edit"/>
								<#else>
									<@mneclient iframe=mneIframe!false property_type="TEXT" reftitle="${getText('MESBasic.viewtitle.randon1450085069587')}" viewType="${viewType!}" deValue="${produceTask_productId_productCode_defaultValue!}" conditionfunc="WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc('produceTask_productId_productCode')"  value="${(produceTask.productId.productCode)!}" displayFieldName="productCode" name="produceTask.productId.productCode" id="produceTask_productId_productCode" type="other" url="/MESBasic/product/product/refProductLayout.action" clicked=true multiple=false mnewidth=260 formId="WOM_produceTask_produceTask_changePackagesEdit_form" editCustomCallback="getDefaultFormular(obj);" refViewCode="MESBasic_1_product_refProductLayout" onkeyupfuncname="getDefaultFormular(obj);_callback_produceTask_productId_productCode(obj);" cssStyle="" isEdit=true beforecallback='clearFormular(obj)'    isCrossCompany=false  editLinkCallBack="_callback_produceTask_productId_productCode_edit" delCustomCallback="_del_callback_produceTask_productId_productCode()"/>
								</#if>
								...
								<#if !(produceTask.id)?? && (produceTask.productId.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('WOM_produceTask_produceTask_changePackagesEdit_form',obj, 'produceTask.productId', '/MESBasic/product/product/refProductLayout.action');
												CUI.commonFills('WOM_produceTask_produceTask_changePackagesEdit_form', 'produceTask.productId',obj,true);
											}
										});
									})(jQuery);
								</#if>
					...
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_productId_MESBasic_1_product_Product_productSpecif_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
					...
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_formularId_RM_7_5_0_0_formula_Formula_code_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-symbol"   align="right" style="text-align: right;;" >
							<label style="<#if WOM_7_5_0_0_produceTask_ProduceTask_formularId_RM_7_5_0_0_formula_Formula_code_permit != 3>color:#B1B1B1;</#if>width:100%;;" value="${getText('WOM.propertydisplayName.randonpl3')}" >${getText('WOM.propertydisplayName.randonpl3')}</label>
				</td>
					...
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_formularId_RM_7_5_0_0_formula_Formula_code_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
							...
							<#else>
								...
								<#if WOM_7_5_0_0_produceTask_ProduceTask_formularId_RM_7_5_0_0_formula_Formula_code_permit == 1>
									<@mneclient iframe=mneIframe!false property_type="BAPCODE" reftitle="${getText('RM.viewtitle.randon1505377270901')}" conditionfunc="WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc('produceTask_formularId_code')" view=true value="${(produceTask.formularId.code)!}" displayFieldName="code" name="produceTask.formularId.code" id="produceTask_formularId_code" type="other" url="/RM/formula/formula/formulaResysleRef.action" clicked=true multiple=false mnewidth=260 formId="WOM_produceTask_produceTask_changePackagesEdit_form" editCustomCallback="_callback_produceTask(obj);" onkeyupfuncname="_callback_produceTask(obj);_callback_produceTask_formularId_code(obj);" cssStyle="" isEdit=true   refViewCode="RM_7.5.0.0_formula_formulaResysleRef"  isCrossCompany=false />
								<#else>
									<@mneclient iframe=mneIframe!false property_type="BAPCODE" reftitle="${getText('RM.viewtitle.randon1505377270901')}" viewType="${viewType!}" deValue="${produceTask_formularId_code_defaultValue!}" conditionfunc="WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc('produceTask_formularId_code')"  value="${(produceTask.formularId.code)!}" displayFieldName="code" name="produceTask.formularId.code" id="produceTask_formularId_code" type="other" url="/RM/formula/formula/formulaResysleRef.action" clicked=true multiple=false mnewidth=260 formId="WOM_produceTask_produceTask_changePackagesEdit_form" editCustomCallback="_callback_produceTask(obj);" refViewCode="RM_7.5.0.0_formula_formulaResysleRef" onkeyupfuncname="_callback_produceTask(obj);_callback_produceTask_formularId_code(obj);" cssStyle="" isEdit=true     isCrossCompany=false  />
								</#if>
								...
								<#if !(produceTask.id)?? && (produceTask.formularId.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('WOM_produceTask_produceTask_changePackagesEdit_form',obj, 'produceTask.formularId', '/RM/formula/formula/formulaResysleRef.action');
												CUI.commonFills('WOM_produceTask_produceTask_changePackagesEdit_form', 'produceTask.formularId',obj,true);
											}
										});
									})(jQuery);
								</#if>
								
									WOM.produceTask.produceTask.changePackagesEdit.query_produceTask_formularId_code = function() {
					...
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_formularId_RM_7_5_0_0_formula_Formula_name_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-symbol"   align="right" style="text-align: right;;" >
							<label style="<#if WOM_7_5_0_0_produceTask_ProduceTask_formularId_RM_7_5_0_0_formula_Formula_name_permit != 3>color:#B1B1B1;</#if>width:100%;;" value="${getText('WOM.propertydisplayName.randonpl4')}" >${getText('WOM.propertydisplayName.randonpl4')}</label>
				</td>
					...
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_formularId_RM_7_5_0_0_formula_Formula_name_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-content"   style="text-align: left;;" >
					...
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_taskType_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
							...
							<#else>
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange="" viewType="${viewType!}" deValue="${produceTask_taskType_defaultValue!}" formId="WOM_produceTask_produceTask_changePackagesEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.taskType.id" code="womTaskType" value="${(produceTask.taskType.id)!}"  />
									<#else>
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${produceTask_taskType_defaultValue!}" formId="WOM_produceTask_produceTask_changePackagesEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.taskType.id" code="womTaskType" value="${(produceTask.taskType.id)!}"  />
									</#if>
								<#else>
									<#if WOM_7_5_0_0_produceTask_ProduceTask_taskType_permit == 1>
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="WOM_produceTask_produceTask_changePackagesEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.taskType.id" code="womTaskType" value="${(produceTask.taskType.id)!}"  />
									<#else>
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="WOM_produceTask_produceTask_changePackagesEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.taskType.id" code="womTaskType" value="${(produceTask.taskType.id)!}"  />
									</#if>
								</#if>
					...
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_factoryId_MESBasic_1_factoryModel_FactoryModel_name_permit != 3>nofieldPermission="true"</#if> nullable=false class="edit-table-content"   align="left" style="text-align: left;;" >
							...
							<#else>
								...
								<#if WOM_7_5_0_0_produceTask_ProduceTask_factoryId_MESBasic_1_factoryModel_FactoryModel_name_permit == 1>
									<@mneclient iframe=mneIframe!false property_type="TEXT" reftitle="${getText('MESBasic.viewtitle.randon1498043312692')}" conditionfunc="WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc('produceTask_factoryId_name')" view=true value="${(produceTask.factoryId.name)!}" displayFieldName="name" name="produceTask.factoryId.name" id="produceTask_factoryId_name" type="other" url="/MESBasic/factoryModel/factoryModel/factoryProBatchRef.action" clicked=true multiple=false mnewidth=260 formId="WOM_produceTask_produceTask_changePackagesEdit_form" editCustomCallback=";" onkeyupfuncname=";_callback_produceTask_factoryId_name(obj);" cssStyle="" isEdit=true   refViewCode="MESBasic_1_factoryModel_factoryProBatchRef"  isCrossCompany=false />
								<#else>
									<@mneclient iframe=mneIframe!false property_type="TEXT" reftitle="${getText('MESBasic.viewtitle.randon1498043312692')}" viewType="${viewType!}" deValue="${produceTask_factoryId_name_defaultValue!}" conditionfunc="WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc('produceTask_factoryId_name')"  value="${(produceTask.factoryId.name)!}" displayFieldName="name" name="produceTask.factoryId.name" id="produceTask_factoryId_name" type="other" url="/MESBasic/factoryModel/factoryModel/factoryProBatchRef.action" clicked=true multiple=false mnewidth=260 formId="WOM_produceTask_produceTask_changePackagesEdit_form" editCustomCallback=";" refViewCode="MESBasic_1_factoryModel_factoryProBatchRef" onkeyupfuncname=";_callback_produceTask_factoryId_name(obj);" cssStyle="" isEdit=true     isCrossCompany=false  />
								</#if>
								...
								<#if !(produceTask.id)?? && (produceTask.factoryId.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('WOM_produceTask_produceTask_changePackagesEdit_form',obj, 'produceTask.factoryId', '/MESBasic/factoryModel/factoryModel/factoryProBatchRef.action');
												CUI.commonFills('WOM_produceTask_produceTask_changePackagesEdit_form', 'produceTask.factoryId',obj,true);
											}
										});
									})(jQuery);
								</#if>
								
									WOM.produceTask.produceTask.changePackagesEdit.query_produceTask_factoryId_name = function() {
					...
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_bulkProduct_MESBasic_1_product_Product_productCode_permit != 3>nofieldPermission="true"</#if> nullable=false class="edit-table-content"   align="left" style="text-align: left;;" >
							...
							<#else>
								...
								<#if WOM_7_5_0_0_produceTask_ProduceTask_bulkProduct_MESBasic_1_product_Product_productCode_permit == 1>
									<@mneclient iframe=mneIframe!false property_type="TEXT" reftitle="${getText('MESBasic.viewtitle.randon1475137145215')}" conditionfunc="WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc('produceTask_bulkProduct_productCode')" view=true value="${(produceTask.bulkProduct.productCode)!}" displayFieldName="productCode" name="produceTask.bulkProduct.productCode" id="produceTask_bulkProduct_productCode" type="other" url="/MESBasic/product/product/productRefNew.action" clicked=true multiple=false mnewidth=260 formId="WOM_produceTask_produceTask_changePackagesEdit_form" editCustomCallback=";" onkeyupfuncname=";_callback_produceTask_bulkProduct_productCode(obj);" cssStyle="" isEdit=true   refViewCode="MESBasic_1_product_productRefNew"  isCrossCompany=false />
								<#else>
									<@mneclient iframe=mneIframe!false property_type="TEXT" reftitle="${getText('MESBasic.viewtitle.randon1475137145215')}" viewType="${viewType!}" deValue="${produceTask_bulkProduct_productCode_defaultValue!}" conditionfunc="WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc('produceTask_bulkProduct_productCode')"  value="${(produceTask.bulkProduct.productCode)!}" displayFieldName="productCode" name="produceTask.bulkProduct.productCode" id="produceTask_bulkProduct_productCode" type="other" url="/MESBasic/product/product/productRefNew.action" clicked=true multiple=false mnewidth=260 formId="WOM_produceTask_produceTask_changePackagesEdit_form" editCustomCallback=";" refViewCode="MESBasic_1_product_productRefNew" onkeyupfuncname=";_callback_produceTask_bulkProduct_productCode(obj);" cssStyle="" isEdit=true     isCrossCompany=false  />
								</#if>
								...
								<#if !(produceTask.id)?? && (produceTask.bulkProduct.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('WOM_produceTask_produceTask_changePackagesEdit_form',obj, 'produceTask.bulkProduct', '/MESBasic/product/product/productRefNew.action');
												CUI.commonFills('WOM_produceTask_produceTask_changePackagesEdit_form', 'produceTask.bulkProduct',obj,true);
											}
										});
									})(jQuery);
								</#if>
					...
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_bulkBatchNum_WOM_7_5_0_0_standingcropRef_StandingcropRef_batchText_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-symbol"   align="right" style="text-align: right;;" >
					...
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_bulkBatchNum_WOM_7_5_0_0_standingcropRef_StandingcropRef_batchText_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-content"   style="text-align: left;;" >
							...
							<#else>
								...
								<#if WOM_7_5_0_0_produceTask_ProduceTask_bulkBatchNum_WOM_7_5_0_0_standingcropRef_StandingcropRef_batchText_permit == 1>
									<@mneclient iframe=mneIframe!false property_type="TEXT" reftitle="${getText('WOM.viewtitle.randon1503994294075')}" conditionfunc="WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc('produceTask_bulkBatchNum_batchText')" view=true value="${(produceTask.bulkBatchNum.batchText)!}" displayFieldName="batchText" name="produceTask.bulkBatchNum.batchText" id="produceTask_bulkBatchNum_batchText" type="other" url="/WOM/standingcropRef/standingcropRef/batchNumOneMakeTask.action" clicked=true multiple=false mnewidth=260 formId="WOM_produceTask_produceTask_changePackagesEdit_form" editCustomCallback=";" onkeyupfuncname=";_callback_produceTask_bulkBatchNum_batchText(obj);" cssStyle="" isEdit=true   refViewCode="WOM_7.5.0.0_standingcropRef_batchNumOneMakeTask"  isCrossCompany=false />
								<#else>
									<@mneclient iframe=mneIframe!false property_type="TEXT" reftitle="${getText('WOM.viewtitle.randon1503994294075')}" viewType="${viewType!}" deValue="${produceTask_bulkBatchNum_batchText_defaultValue!}" conditionfunc="WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc('produceTask_bulkBatchNum_batchText')"  value="${(produceTask.bulkBatchNum.batchText)!}" displayFieldName="batchText" name="produceTask.bulkBatchNum.batchText" id="produceTask_bulkBatchNum_batchText" type="other" url="/WOM/standingcropRef/standingcropRef/batchNumOneMakeTask.action" clicked=true multiple=false mnewidth=260 formId="WOM_produceTask_produceTask_changePackagesEdit_form" editCustomCallback=";" refViewCode="WOM_7.5.0.0_standingcropRef_batchNumOneMakeTask" onkeyupfuncname=";_callback_produceTask_bulkBatchNum_batchText(obj);" cssStyle="" isEdit=true     isCrossCompany=false  />
								</#if>
								...
								<#if !(produceTask.id)?? && (produceTask.bulkBatchNum.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('WOM_produceTask_produceTask_changePackagesEdit_form',obj, 'produceTask.bulkBatchNum', '/WOM/standingcropRef/standingcropRef/batchNumOneMakeTask.action');
												CUI.commonFills('WOM_produceTask_produceTask_changePackagesEdit_form', 'produceTask.bulkBatchNum',obj,true);
											}
										});
									})(jQuery);
								</#if>
					...
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_bulkNum_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-symbol"   align="right" style="text-align: right;;" >
							<label style="<#if WOM_7_5_0_0_produceTask_ProduceTask_bulkNum_permit != 3>color:#B1B1B1;</#if>width:100%;;" value="${getText('WOM.propertydisplayName.randon1495854016913')}" >${getText('WOM.propertydisplayName.randon1495854016913')}</label>
				</td>
					...
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_bulkNum_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-content"   style="text-align: left;;" >
							...
							<div class="fix-input<#if WOM_7_5_0_0_produceTask_ProduceTask_bulkNum_permit == 1>-readonly</#if>">
									<input name="produceTask.bulkNum" id="produceTask_bulkNum"  style=";" originalvalue="<#if newObj&& !(produceTask.bulkNum)?has_content>${produceTask_bulkNum_defaultValue!}<#elseif (produceTask.bulkNum)?has_content>#{(produceTask.bulkNum)!; m6M6}</#if>" value="<#if newObj&& !(produceTask.bulkNum)?has_content>${produceTask_bulkNum_defaultValue!}<#elseif (produceTask.bulkNum)?has_content>#{(produceTask.bulkNum)!; m6M6}</#if>" type="text" class="cui-noborder-input numberField"<#if WOM_7_5_0_0_produceTask_ProduceTask_bulkNum_permit == 1> readonly=readonly</#if> />
							</div>
							<script type="text/javascript">
								$(function(){
					...
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_planEndTime_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-content" celltype="DATETIME"  align="left" style="text-align: left;;" >
		...
		<#assign cpvmInfo = ''>
			<#assign customPropList = getShowCustomProps("WOM_7.5.0.0_produceTask_ProduceTask", "WOM_7.5.0.0_produceTask_changePackagesEdit", 'EDIT')>
				...
				<td nullable=<#if (c.nullable!false)>true<#else>false</#if> class="edit-table-content" <#if c.fieldType?? && c.fieldType == 'DATATIME'>celltype="DATATIME"</#if> <#if cspan gt 1>colspan="${colspanVal}"</#if> style="text-align:left;">
					...
					<#elseif fieldType == 'SELECTCOMP'>
						<#if columnType == 'SYSTEMCODE'>
							...
							<@systemcode property_type="${columnType}" iscustom=true showType="${fieldType}" viewType=viewType formId="WOM_produceTask_produceTask_changePackagesEdit_form" classStyle="cui-noborder-input"  cssStyle="" ecFlag=true multable=isMultable name="${elementName}" code="${(c.property.fillcontentMap.fillContent)!}" value="${produceTask[columnName]!}" seniorSystemCode=isS2 />
						<#else>
	...
	<table class="edit-table" style="display:none;">
		...
		<tr >
												...
												<#if !WOM_7_5_0_0_produceTask_ProduceTask_formularId_RM_7_5_0_0_formula_Formula_setProcess_permit??>
					<#assign WOM_7_5_0_0_produceTask_ProduceTask_formularId_RM_7_5_0_0_formula_Formula_setProcess_permit = checkFieldPermission('produceTask.formularId.setProcess','WOM_7.5.0.0_produceTask_ProduceTask','RM_7.5.0.0_formula_Formula_setProcess')>
					</#if>
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_formularId_RM_7_5_0_0_formula_Formula_setProcess_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-symbol"   align="right" style="text-align: right;display:none;" >
							<label style="<#if WOM_7_5_0_0_produceTask_ProduceTask_formularId_RM_7_5_0_0_formula_Formula_setProcess_permit != 3>color:#B1B1B1;</#if>width:100%;;" value="${getText('RM.propertydisplayName.randon1490578864812')}" >${getText('RM.propertydisplayName.randon1490578864812')}</label>
				</td>
					...
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_formularId_RM_7_5_0_0_formula_Formula_setProcess_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-content"   align="left" style="text-align: left;display:none;" >
							<#if WOM_7_5_0_0_produceTask_ProduceTask_formularId_RM_7_5_0_0_formula_Formula_setProcess_permit == 0>
							<div class="fix-input-readonly"><input type="text" class="cui-noborder-input nopermit" readonly="readonly" value="${getText('ec.view.nofieldpermission')}"/></div>
							<#else>
								<#if newObj>
									<#if WOM_7_5_0_0_produceTask_ProduceTask_formularId_RM_7_5_0_0_formula_Formula_setProcess_permit == 1>
								...
								<#else>
									<#if WOM_7_5_0_0_produceTask_ProduceTask_formularId_RM_7_5_0_0_formula_Formula_setProcess_permit == 1>
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="WOM_produceTask_produceTask_changePackagesEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.formularId.setProcess.id" code="formulaProperty" value="${(produceTask.formularId.setProcess.id)!}"  />
									<#else>
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="WOM_produceTask_produceTask_changePackagesEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.formularId.setProcess.id" code="formulaProperty" value="${(produceTask.formularId.setProcess.id)!}"  />
									</#if>
								</#if>
							 					...
							 					<#if !WOM_7_5_0_0_produceTask_ProduceTask_tasksID_permit??>
					<#assign WOM_7_5_0_0_produceTask_ProduceTask_tasksID_permit = checkFieldPermission('produceTask.tasksID','WOM_7.5.0.0_produceTask_ProduceTask','WOM_7.5.0.0_produceTask_ProduceTask_tasksID')>
					</#if>
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_tasksID_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-symbol"   align="right" style="text-align: right;;" >
							<label style="<#if WOM_7_5_0_0_produceTask_ProduceTask_tasksID_permit != 3>color:#B1B1B1;</#if>width:100%;;" value="${getText('WOM.propertydisplayName.randon1496283447542')}" >${getText('WOM.propertydisplayName.randon1496283447542')}</label>
				</td>
					...
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_tasksID_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
							<#if WOM_7_5_0_0_produceTask_ProduceTask_tasksID_permit == 0>
							<div class="fix-input-readonly"><input type="text" class="cui-noborder-input nopermit" readonly="readonly" value="${getText('ec.view.nofieldpermission')}"/></div>
							<#else>
							<div class="fix-input<#if WOM_7_5_0_0_produceTask_ProduceTask_tasksID_permit == 1>-readonly</#if>">
								<input property_type="LONG" name="produceTask.tasksID" id="produceTask_tasksID"  style=";" originalvalue="<#if !newObj || (produceTask.tasksID)?has_content>${(produceTask.tasksID?html)!}<#else>${produceTask_tasksID_defaultValue!}</#if>" value="<#if !newObj || (produceTask.tasksID)?has_content>${(produceTask.tasksID?html)!}<#else>${produceTask_tasksID_defaultValue!}</#if>" type="text" class="cui-noborder-input numberField"<#if WOM_7_5_0_0_produceTask_ProduceTask_tasksID_permit == 1> readonly=readonly</#if> />
							</div>
							<script type="text/javascript">
							</script>
							</#if>
							 					...
							 					<#if !WOM_7_5_0_0_produceTask_ProduceTask_workType_permit??>
					<#assign WOM_7_5_0_0_produceTask_ProduceTask_workType_permit = checkFieldPermission('produceTask.workType','WOM_7.5.0.0_produceTask_ProduceTask','WOM_7.5.0.0_produceTask_ProduceTask_workType')>
					</#if>
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_workType_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-symbol"   align="right" style="text-align: right;;" >
							<label style="<#if WOM_7_5_0_0_produceTask_ProduceTask_workType_permit != 3>color:#B1B1B1;</#if>width:100%;;" value="${getText('WOM.propertydisplayName.randon1495090060829')}" >${getText('WOM.propertydisplayName.randon1495090060829')}</label>
				</td>
					...
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_workType_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
							<#if WOM_7_5_0_0_produceTask_ProduceTask_workType_permit == 0>
							<div class="fix-input-readonly"><input type="text" class="cui-noborder-input nopermit" readonly="readonly" value="${getText('ec.view.nofieldpermission')}"/></div>
							<#else>
								<#if newObj>
									<#if WOM_7_5_0_0_produceTask_ProduceTask_workType_permit == 1>
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange="" viewType="${viewType!}" deValue="${produceTask_workType_defaultValue!}" formId="WOM_produceTask_produceTask_changePackagesEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.workType.id" code="produceType" value="${(produceTask.workType.id)!}"  />
									<#else>
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${produceTask_workType_defaultValue!}" formId="WOM_produceTask_produceTask_changePackagesEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.workType.id" code="produceType" value="${(produceTask.workType.id)!}"  />
									</#if>
								<#else>
									<#if WOM_7_5_0_0_produceTask_ProduceTask_workType_permit == 1>
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="WOM_produceTask_produceTask_changePackagesEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.workType.id" code="produceType" value="${(produceTask.workType.id)!}"  />
									<#else>
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="WOM_produceTask_produceTask_changePackagesEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.workType.id" code="produceType" value="${(produceTask.workType.id)!}"  />
									</#if>
								</#if>
										...
										try{
											...
											checkbox_view.bind('click', function(){
												...
												CUI('input[name="produceTask.supportEbr_check"]').each(function(){
							 					...
							 					<#if !WOM_7_5_0_0_produceTask_ProduceTask_batchProdTaskID_permit??>
					<#assign WOM_7_5_0_0_produceTask_ProduceTask_batchProdTaskID_permit = checkFieldPermission('produceTask.batchProdTaskID','WOM_7.5.0.0_produceTask_ProduceTask','WOM_7.5.0.0_produceTask_ProduceTask_batchProdTaskID')>
					</#if>
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_batchProdTaskID_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-symbol"   align="right" style="text-align: right;display:none;" >
							<label style="<#if WOM_7_5_0_0_produceTask_ProduceTask_batchProdTaskID_permit != 3>color:#B1B1B1;</#if>width:100%;;" value="${getText('WOM.propertydisplayName.randon1495867997233')}" >${getText('WOM.propertydisplayName.randon1495867997233')}</label>
				</td>
					...
					<td <#if WOM_7_5_0_0_produceTask_ProduceTask_batchProdTaskID_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-content"   align="left" style="text-align: left;display:none;" >
							<#if WOM_7_5_0_0_produceTask_ProduceTask_batchProdTaskID_permit == 0>
							<div class="fix-input-readonly"><input type="text" class="cui-noborder-input nopermit" readonly="readonly" value="${getText('ec.view.nofieldpermission')}"/></div>
							<#else>
							<div class="fix-input<#if WOM_7_5_0_0_produceTask_ProduceTask_batchProdTaskID_permit == 1>-readonly</#if>">
								<input property_type="TEXT" name="produceTask.batchProdTaskID" id="produceTask_batchProdTaskID"  style=";" originalvalue="<#if !newObj || (produceTask.batchProdTaskID)?has_content>${(produceTask.batchProdTaskID?html)!}<#else>${produceTask_batchProdTaskID_defaultValue!}</#if>" value="<#if !newObj || (produceTask.batchProdTaskID)?has_content>${(produceTask.batchProdTaskID?html)!}<#else>${produceTask_batchProdTaskID_defaultValue!}</#if>" type="text" class="cui-noborder-input "<#if WOM_7_5_0_0_produceTask_ProduceTask_batchProdTaskID_permit == 1> readonly=readonly</#if> />
							</div>
							<script type="text/javascript">
							</script>
							</#if>
			...
			<#assign cpvmInfo = ''>
							...
							<script type="text/javascript">
								function ProduceTaskActive_dg1506058953802_addNewRow(event)
																{
	ProduceTaskActive_dg1505285519610Widget.addRow();
	...
	//表体滚动条bug修改
	ProduceTaskActive_dg1505285519610Widget._DT._resizeHeight = true;
	ProduceTaskActive_dg1505285519610Widget._DT._initDomElements();
}
							</script>
							<script type="text/javascript">
								function ProduceTaskActive_dg1506058953802_copyNewRowDataFunc(event)
																{
	//获得选中行
	var selectRow = ProduceTaskActive_dg1505285519610Widget.getSelectedRow();
	...
	CUI.Dialog.confirm("${getText('WOM.confirmcontent.radion1504182834291')}",
		function(){
			...
			if(isProBatch==true){
				...
				ProduceTaskActive_dg1505285519610Widget._DT._resizeHeight = true;
				ProduceTaskActive_dg1505285519610Widget._DT._initDomElements();
				ProduceTaskActive_dg1505285519610Widget._DT._resizeHeight = false;
			}
			//获取未删前的html
			...
			if($("#id").val()==""){
				...
				var newRow = ProduceTaskActive_dg1505285519610Widget.getRowLength()-1;//新行号
				//赋值
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"productId.productCode",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"productId.productCode"));//物品编码
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"productId.id",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"productId.id"));//物品id
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"productId.productName",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"productId.productName"));//物品名称
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"orderProcessId.id",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"orderProcessId.id"));//工序名称id
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"orderProcessId.name",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"orderProcessId.name"));//工序名称
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"name",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"name"));//活动名称
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"activeType.id",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"activeType.id"));//活动类型
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"exeSystem.id",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"exeSystem.id"));//执行系统
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"isReplace",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"isReplace"));//替代料
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"property.id",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"property.id"));//性质
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"standardNum",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"standardNum"));//理论用量			 
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"planNum",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"planNum"));//计划用量	  
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"productId.productBaseUnit.name",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"productId.productBaseUnit.name"));	//单位 
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"isMixQuality",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"isMixQuality"));//固定数量
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"phase",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"phase"));//阶段
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"sequence",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"sequence"));//次序号
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"needWeigh",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"needWeigh"));//是否需要称重
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"batchNumObj.id",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"batchNumObj.id"));//物料批号id	
				//ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"batchNumObj.batchText",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"batchNumObj.batchText"));//物料批号
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"minQuality",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"minQuality"));//理论下限
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"maxQuality",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"maxQuality"));//理论上限
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"lossRate",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"lossRate"));//损耗率  
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"remark",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"remark"));//备注
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"activeId.id",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"activeId.id"));//活动id	
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"formulaId.id",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"formulaId.id"));//配方id  
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"processId.id",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"processId.id"));//工序id		
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"putBatMateId.id",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"putBatMateId.id"));//投配料活动id	
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"offerOrder",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"offerOrder"));//配料顺序
				ProduceTaskActive_dg1505285519610Widget.setCellValue(newRow,"actOrder",ProduceTaskActive_dg1505285519610Widget.getCellValue(selectRow,"actOrder"));//投料顺序	
		}
	);
	}else{
		workbenchErrorBarWidget.showMessage("${getText('WOM.showMessage00000013')}");
			...
			<#if  refId?? && (refId > 0)>
				<#assign dUrl="/WOM/produceTask/produceTask/data-dg1506058953802.action?produceTask.id=${refId!-1}&refId=${refId!-1}&datagridCode=WOM_7.5.0.0_produceTask_changePackagesEditdg1506058953802">
			<#else>
				<#assign dUrl="/WOM/produceTask/produceTask/data-dg1506058953802.action?produceTask.id=${(produceTask.id)!-1}&datagridCode=WOM_7.5.0.0_produceTask_changePackagesEditdg1506058953802">
			</#if>
			<#assign firstLoad = true>
				
			<#if newObj?? && !newObj && !(refId?? && (refId > 0))>
				<#assign buttons="[{text:\"${getText('ec.view.deleteline')}\",iconClass:\"cui-btn-del\",useInMore:\"false\",handler:function(event){DT_ProduceTaskActive_dg1506058953802_deldatagrid();}},{text:\"${getText('WOM.buttonPropertyshowName.radion1505441258642')}\",handler:function(event){ProduceTaskActive_dg1506058953802_addNewRow(event)},iconClass:\"cui-btn-add\",useInMore:\"false\"},{text:\"${getText('WOM.buttonPropertyshowName.radion1503995839036')}\",handler:function(event){ProduceTaskActive_dg1506058953802_copyNewRowDataFunc(event)},iconClass:\"cui-btn-add\",useInMore:\"false\"}]">
			...
			<#else>
				...
				<#if cpvmInfo?? && cpvmInfo?length gt 0>
					<#assign cpvmInfo = cpvmInfo?substring(1)>
					<input type="hidden" id="dg_cp_info_ProduceTaskActive_dg1506058953802" value="${cpvmInfo!}" />
				</#if>
			
			<input type="hidden" id="dg1506058953802_id" value="ProduceTaskActive_dg1506058953802" />
			
			<input type="hidden" id="dg1506058953802_url" value="${dUrl}" />
			
			<#assign assModelDisplayName = getText('WOM.modelname.randon1489671093316')!>
			<#assign assModelDisplayName = assModelDisplayName + getText('ec.common.validate.colon') >
			<@exportexcel action="/WOM/produceTask/produceTask/data-dg1506058953802.action?operateType=export&datagridCode=WOM_7.5.0.0_produceTask_changePackagesEditdg1506058953802"  settingtext="" settingUrl="" prepareParams="" formId="" look="text" width=250 height=170 text="" exportPageChoose=0 dtPage="dgPage" prefix="ProduceTaskActive_dg1506058953802" />
			<@datagrid withoutConfigTable=true id="ProduceTaskActive_dg1506058953802" viewType="${viewType}" renderOverEvent="dg1506058953802RenderOverEvent" route="${routeFlag}" formId="WOM_produceTask_produceTask_changePackagesEdit_form" noPermissionKeys="productId.productCode,productId.id,productId.productName,property,productId.productBaseUnit.name,isMixQuality,phase,sequence,needWeigh,batchNumObj.batchText,lossRate,remark,batchNumObj.id,orderProcessId.id,activeId.id,formulaId.id,processId.id,putBatMateId.id,planNum" modelCode="WOM_7.5.0.0_produceTask_ProduceTaskActive" dataUrl="${dUrl}" postData="&dgPage.pageSize=65536" dataGridName="dg1506058953802" dtPage="dgPage"  hidekeyPrefix="dg1506058953802" hidekey="['id','version','productId.id','productId.productCode','productId.id','productId.id','productId.id','productId.productName','productId.id','productId.productBaseUnit.name','batchNumObj.id','batchNumObj.batchText','batchNumObj.id','batchNumObj.id','orderProcessId.id','orderProcessId.id','activeId.id','activeId.id','formulaId.id','formulaId.id','processId.id','processId.id','putBatMateId.id','putBatMateId.id'${cpObjHideKey!''}]" transMethod="post" paginator=false editable=true buttons="${buttons}"  canImportExcel=canImportExcel noPadding=true isEdit=true tabViewIndex=0 pageInitMethod="dg1506058953802PageInitMethod"  defaultNodeExpanded=nodeExpanded  cannotAddNewRow=true cannotDeleteRow=false assModelDisplayName=assModelDisplayName dgTitle="${getText('WOM.dataGriddataGridName.radion1490443916302')}" activexButton="WOM.buttonPropertyshowName.radion1505441258642,addNewRow;WOM.buttonPropertyshowName.radion1503995839036,copyNewRowDataFunc" exportExcel=exportExcel addNewRow=false   canInsertRow=false  insertRowAble=false firstLoad=firstLoad >		
							...
							<#elseif (productId_productCode_defaultValue!)?string=="currentComp">
								<#assign productId_productCode_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.productCode"        showFormat="SELECTCOMP" defaultValue="${(productId_productCode_defaultValue!)?string}" defaultDisplay="${(productId_productCode_displayDefaultType!)?string}" decimal="" editable=true type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.changePackagesEdit"  textalign="left"  viewUrl="/MESBasic/product/product/refProductLayout.action" viewCode="MESBasic_1_product_refProductLayout" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1450085069587')}"  label="${getText('WOM.propertydisplayName.radion14157726448331')}" width=100 showFormatFunc=""/>
							...
							<#elseif (productId_id_defaultValue!)?string=="currentComp">
								<#assign productId_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.id"        showFormat="TEXT" defaultValue="${(productId_id_defaultValue!)?string}" defaultDisplay="${(productId_id_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="WOM.produceTask.produceTask.changePackagesEdit"  textalign="center" hiddenCol=true viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('MESBasic.propertydisplayName.randon1449796384550')}" width=100 showFormatFunc=""/>
							...
							<#elseif (productId_productName_defaultValue!)?string=="currentComp">
								<#assign productId_productName_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.productName"        showFormat="TEXT" defaultValue="${(productId_productName_defaultValue!)?string}" defaultDisplay="${(productId_productName_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="WOM.produceTask.produceTask.changePackagesEdit"  textalign="left"  viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('WOM.propertydisplayName.radion1415772740737455')}" width=100 showFormatFunc=""/>
							<#assign property_displayDefaultType=''>
								<#assign property_defaultValue=''>
										<#assign property_defaultValue=''>
										 									<@systemCodeColumn code="RMproperty" textalign="left" defaultValue="${(property_defaultValue!)?string}" key="property.id" editable=true type="selectcomp" notnull=false     label="${getText('WOM.propertydisplayName.randon1503996516434')}" width=80  />
							...
							<#elseif (productId_productBaseUnit_name_defaultValue!)?string=="currentComp">
								<#assign productId_productBaseUnit_name_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.productBaseUnit.name"        showFormat="TEXT" defaultValue="${(productId_productBaseUnit_name_defaultValue!)?string}" defaultDisplay="${(productId_productBaseUnit_name_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="WOM.produceTask.produceTask.changePackagesEdit"  textalign="left"  viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('WOM.propertydisplayName.radion1398235640483')}" width=60 showFormatFunc=""/>
							<#assign isMixQuality_displayDefaultType=''>
								<#assign isMixQuality_defaultValue=''>
										<#assign isMixQuality_defaultValue=''>
										  
									<@datacolumn key="isMixQuality"        showFormat="CHECKBOX" defaultValue="${(isMixQuality_defaultValue!)?string}" defaultDisplay="${(isMixQuality_displayDefaultType!)?string}" decimal="" editable=true type="checkbox" showType="checkbox" notnull=false     textalign="center"  viewUrl="" viewCode="" mneenable=false crossCompany=false viewTitle="${getText('')}"  label="${getText('WOM.propertydisplayName.randon1489729935738')}" width=80 showFormatFunc=""/>
							...
							<#assign needWeigh_displayDefaultType=''>
								<#assign needWeigh_defaultValue=''>
									...
									<@datacolumn key="needWeigh"        showFormat="CHECKBOX" defaultValue="${(needWeigh_defaultValue!)?string}" defaultDisplay="${(needWeigh_displayDefaultType!)?string}" decimal="" editable=true type="checkbox" showType="checkbox" notnull=false     textalign="center"  viewUrl="" viewCode="" mneenable=false crossCompany=false viewTitle="${getText('')}"  label="${getText('WOM.propertydisplayName.randon1503995551484')}" width=100 showFormatFunc=""/>
							...
							<#elseif (batchNumObj_batchText_defaultValue!)?string=="currentComp">
								<#assign batchNumObj_batchText_defaultValue='${compJson!}'>
									...
									<@datacolumn key="batchNumObj.batchText"        showFormat="SELECTCOMP" defaultValue="${(batchNumObj_batchText_defaultValue!)?string}" defaultDisplay="${(batchNumObj_batchText_displayDefaultType!)?string}" decimal="" editable=true type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.changePackagesEdit"  textalign="center"  viewUrl="/WOM/standingcropRef/standingcropRef/batchNumOneMakeTask.action" viewCode="WOM_7.5.0.0_standingcropRef_batchNumOneMakeTask" mneenable=false crossCompany=false viewTitle="${getText('WOM.viewtitle.randon1503994294075')}"  label="${getText('WOM.propertydisplayName.randon1490064501469')}" width=100 showFormatFunc=""/>
							...
							<#elseif (batchNumObj_id_defaultValue!)?string=="currentComp">
								<#assign batchNumObj_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="batchNumObj.id"        showFormat="TEXT" defaultValue="${(batchNumObj_id_defaultValue!)?string}" defaultDisplay="${(batchNumObj_id_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="WOM.produceTask.produceTask.changePackagesEdit"  textalign="center" hiddenCol=true viewUrl="/WOM/standingcropRef/standingcropRef/batchNumOneMakeTask.action" viewCode="WOM_7.5.0.0_standingcropRef_batchNumOneMakeTask" mneenable=false crossCompany=false viewTitle="${getText('WOM.viewtitle.randon1503994294075')}"  label="${getText('ec.common.ID')}" width=100 showFormatFunc=""/>
							...
							<#elseif (orderProcessId_id_defaultValue!)?string=="currentComp">
								<#assign orderProcessId_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="orderProcessId.id"        showFormat="TEXT" defaultValue="${(orderProcessId_id_defaultValue!)?string}" defaultDisplay="${(orderProcessId_id_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="WOM.produceTask.produceTask.changePackagesEdit"  textalign="center" hiddenCol=true viewUrl="" viewCode="WOM_7.5.0.0_produceTask_taskProcessRef" mneenable=false crossCompany=false viewTitle="${getText('')}"  label="${getText('ec.common.ID')}" width=100 showFormatFunc=""/>
							...
							<#elseif (activeId_id_defaultValue!)?string=="currentComp">
								<#assign activeId_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="activeId.id"        showFormat="TEXT" defaultValue="${(activeId_id_defaultValue!)?string}" defaultDisplay="${(activeId_id_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="WOM.produceTask.produceTask.changePackagesEdit"  textalign="center" hiddenCol=true viewUrl="/RM/formula/formulaProcessActive/activeCheckRef.action" viewCode="RM_7.5.0.0_formula_activeCheckRef" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1497922173328')}"  label="${getText('ec.common.ID')}" width=100 showFormatFunc=""/>
							...
							<#elseif (formulaId_id_defaultValue!)?string=="currentComp">
								<#assign formulaId_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="formulaId.id"        showFormat="SELECTCOMP" defaultValue="${(formulaId_id_defaultValue!)?string}" defaultDisplay="${(formulaId_id_displayDefaultType!)?string}" decimal="" editable=true type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.changePackagesEdit"  textalign="center" hiddenCol=true viewUrl="/RM/formula/formula/formulaTaskRef.action" viewCode="RM_7.5.0.0_formula_formulaTaskRef" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1498047455529')}"  label="${getText('ec.common.ID')}" width=100 showFormatFunc=""/>
							...
							<#elseif (processId_id_defaultValue!)?string=="currentComp">
								<#assign processId_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="processId.id"        showFormat="SELECTCOMP" defaultValue="${(processId_id_defaultValue!)?string}" defaultDisplay="${(processId_id_displayDefaultType!)?string}" decimal="" editable=true type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.changePackagesEdit"  textalign="center" hiddenCol=true viewUrl="/RM/formula/formulaProcess/processReference.action" viewCode="RM_7.5.0.0_formula_processReference" mneenable=false crossCompany=false viewTitle="${getText('RM.viewtitle.randon1488596828660')}"  label="${getText('ec.common.ID')}" width=100 showFormatFunc=""/>
			...
			<script type="text/javascript">
				function ProduceTaskActive_dg1506058953802_check_datagridvalid(){
					//
					var errorObj =ProduceTaskActive_dg1506058953802Widget._DT.testData();
					var errorContent='';
					if(errorObj!=null){
				...
				function savedg1506058953802DataGrid(){
					<#if  refId?? && (refId gt 0)>
					ProduceTaskActive_dg1506058953802Widget.setAllRowEdited();
					</#if>
					// 针对需要全部更新的PT，把pt Id存到body的CHANGED_PT中，保存时，会自动保存全部数据
					var changed_pt_name = $('body').data('CHANGED_PT');
					if(changed_pt_name && changed_pt_name.indexOf('ProduceTaskActive_dg1506058953802Widget') > -1) {
						ProduceTaskActive_dg1506058953802Widget.setAllRowEdited();
					}
					var json = ProduceTaskActive_dg1506058953802Widget.parseEditedData();
					$('input[name="dg1506058953802ListJson"]').remove();
					$('input[name="dgLists[\'dg1506058953802\']"]').remove();
					$('input[name="dg1506058953802ModelCode"]').remove();
					$('<input type="hidden" name="dgLists[\'dg1506058953802\']">').val(json).appendTo($('#WOM_produceTask_produceTask_changePackagesEdit_form'));
					$('<input type="hidden" name="dg1506058953802ModelCode">').val('WOM_7.5.0.0_produceTask_ProduceTaskActive').appendTo($('#WOM_produceTask_produceTask_changePackagesEdit_form'));
					//兼容旧版本提交函数
					$('<input type="hidden" name="dg1506058953802ListJson">').val(json).appendTo($('#WOM_produceTask_produceTask_changePackagesEdit_form'));
				}
				function DT_ProduceTaskActive_dg1506058953802_deldatagrid(){
					var deleteRows = ProduceTaskActive_dg1506058953802Widget.deleteRows();
					...
					$.each(deleteRows, function(index, deleteRow){
						...
						if($("#dg1506058953802DeletedIds").length>0){
							$("#dg1506058953802DeletedIds")[0].value+=","+tepID;
						}else{
							CUI('<input type="hidden" id="dg1506058953802DeletedIds" name="dgDeletedIds[\'dg1506058953802\']" value="'+tepID+'">').appendTo(CUI('#WOM_produceTask_produceTask_changePackagesEdit_form'));
						}
						//兼容旧版本提交函数
						CUI('<input type="hidden" name="dg1506058953802DeletedIds['+CUI('input[name^="dg1506058953802DeletedIds"]').length+']'+'" value="'+tepID+'">').appendTo(CUI('#WOM_produceTask_produceTask_changePackagesEdit_form'));
					});
				}
				function DT_ProduceTaskActive_dg1506058953802_delTreeNodes(){
					var deleteRows = ProduceTaskActive_dg1506058953802Widget._DT.removeTreeNode();
					if(!deleteRows || deleteRows.length == 0) {
						return false;
					}
					var delproperty = "'id','version','processId.id','activeId.id','headID.id','formulaId.id','productId.id'";
				...
				$(function($){
					var datagrids = $('body').data('WOM_produceTask_produceTask_changePackagesEdit_datagrids');
					if(!datagrids) {
						datagrids = [];
					}
					for(var i=0;i<2;i++) {
					...
					if(datagrids[0].length>0) {
						for(var i=0;i<datagrids[0].length;i++) {
							if(datagrids[0][i] == 'ProduceTaskActive_dg1506058953802') {
								break;
							}
							if(i==datagrids[0].length-1) {
								datagrids[0][datagrids[0].length] = 'ProduceTaskActive_dg1506058953802';
							}
						}
					} else {
						datagrids[0][datagrids[0].length] = 'ProduceTaskActive_dg1506058953802';
					}
					$('body').data('WOM_produceTask_produceTask_changePackagesEdit_datagrids', datagrids);
				});
				
				var ProduceTaskActive_dg1506058953802_importDialog = null;
				function ProduceTaskActive_dg1506058953802_showImportDialog(){
					try{
						if(ProduceTaskActive_dg1506058953802_importDialog!=null&&ProduceTaskActive_dg1506058953802_importDialog.isShow==1){
							return false;
						}
						var url = "/WOM/produceTask/produceTask/initImport.action?datagridCode=WOM_7.5.0.0_produceTask_changePackagesEditdg1506058953802&tid=${id!}&datagridName=dg1506058953802";
						ProduceTaskActive_dg1506058953802_importDialog = new CUI.Dialog({
							...
							width: '420',
							dragable:true,
							buttons:[{id:"import",name:"${getHtmlText('common.button.import')}",handler:function(){var dg = eval("ProduceTaskActive_dg1506058953802"+"Widget");if(dg && dg.checkEdited && dg.checkEdited()){CUI.Dialog.alert("${getHtmlText('ec.view.unsavedgdata')}");}else{foundation.importExcel.submitImportForm();}}},{name:"${getHtmlText('common.button.cancel')}",id:"close",handler:function(){setTimeout(function(){$('#importResponse').remove();ProduceTaskActive_dg1506058953802_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.Confirm')}",id:"ok",display:'hidden',handler:function(){setTimeout(function(){$('#importResponse').remove();ProduceTaskActive_dg1506058953802_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.back')}",id:"tback",display:'hidden',handler:function(){tback();}}],
							beforeCloseEvent:function(){$('#importResponse').remove();}
						});
						ProduceTaskActive_dg1506058953802_importDialog.show();
					}catch(e){}
				}	
				
				function ProduceTaskActive_dg1506058953802_downLoadFile(){
					var url = "/WOM/produceTask/produceTask/downLoad.action?datagridCode=WOM_7.5.0.0_produceTask_changePackagesEditdg1506058953802&templateRelatedModelCode=WOM_7.5.0.0_produceTask_changePackagesEditdg1506058953802&downloadType=template&fileName=dg1506058953802";
					window.open(url,"","");
				}
				function dg1506058953802RenderOverEvent(){
					//启用物料批次
    if(isProBatch==true){
    	//将复制按钮显示
    ...
    if(ProduceTaskActive_dg1505285519610Widget.getRowLength()>0){
    	//禁用生产数量
	...
	//}
				...
				function dg1506058953802PageInitMethod(nTabIndex){
					WOM.produceTask.produceTask.changePackagesEdit.initSize(nTabIndex);
...
<div class="edit-panes-s" >
			...
			<#if  refId?? && (refId > 0)>
				<#assign dUrl="/WOM/produceTask/produceTask/data-dg1506058953963.action?produceTask.id=${refId!-1}&refId=${refId!-1}&datagridCode=WOM_7.5.0.0_produceTask_changePackagesEditdg1506058953963">
			<#else>
				<#assign dUrl="/WOM/produceTask/produceTask/data-dg1506058953963.action?produceTask.id=${(produceTask.id)!-1}&datagridCode=WOM_7.5.0.0_produceTask_changePackagesEditdg1506058953963">
			</#if>
			<#assign firstLoad = true>
				
			<#if newObj?? && !newObj && !(refId?? && (refId > 0))>
				<#assign buttons="[{text:\"${getText('ec.view.addline')}\",handler:function(event){this.addNewRow(event);},iconClass:\"cui-btn-add\",useInMore:\"false\"},{text:\"${getText('ec.view.deleteline')}\",iconClass:\"cui-btn-del\",useInMore:\"false\",handler:function(event){DT_ProduceMaterialSum_dg1506058953963_deldatagrid();}}]">
				<#assign canImportExcel=false>
			<#else>
				<#assign buttons="[{text:\"${getText('ec.view.addline')}\",handler:function(event){this.addNewRow(event);},iconClass:\"cui-btn-add\",useInMore:\"false\"},{text:\"${getText('ec.view.deleteline')}\",iconClass:\"cui-btn-del\",useInMore:\"false\",handler:function(event){DT_ProduceMaterialSum_dg1506058953963_deldatagrid();}}]">
				<#assign canImportExcel=false>
				...
				<#if cpvmInfo?? && cpvmInfo?length gt 0>
					<#assign cpvmInfo = cpvmInfo?substring(1)>
					<input type="hidden" id="dg_cp_info_ProduceMaterialSum_dg1506058953963" value="${cpvmInfo!}" />
				</#if>
			
			<input type="hidden" id="dg1506058953963_id" value="ProduceMaterialSum_dg1506058953963" />
			
			<input type="hidden" id="dg1506058953963_url" value="${dUrl}" />
			
			<#assign assModelDisplayName = getText('WOM.modelname.randon1489671141506')!>
			<#assign assModelDisplayName = assModelDisplayName + getText('ec.common.validate.colon') >
			<@exportexcel action="/WOM/produceTask/produceTask/data-dg1506058953963.action?operateType=export&datagridCode=WOM_7.5.0.0_produceTask_changePackagesEditdg1506058953963"  settingtext="" settingUrl="" prepareParams="" formId="" look="text" width=250 height=170 text="" exportPageChoose=0 dtPage="dgPage" prefix="ProduceMaterialSum_dg1506058953963" />
			<@datagrid withoutConfigTable=true id="ProduceMaterialSum_dg1506058953963" viewType="${viewType}" renderOverEvent="dg1506058953963RenderOverEvent" route="${routeFlag}" formId="WOM_produceTask_produceTask_changePackagesEdit_form" noPermissionKeys="productId.productCode,productId.productName,property,planNum,productId.productBaseUnit.name,batchNum,headId.formularId.setProcess" modelCode="WOM_7.5.0.0_produceTask_ProduceMaterialSum" dataUrl="${dUrl}" postData="&dgPage.pageSize=65536" dataGridName="dg1506058953963" dtPage="dgPage"  hidekeyPrefix="dg1506058953963" hidekey="['id','version','productId.id','productId.productCode','productId.id','productId.productName','productId.id','productId.productBaseUnit.name','headId.id','headId.formularId.setProcess.id'${cpObjHideKey!''}]" transMethod="post" paginator=false editable=false  noPadding=true isEdit=true tabViewIndex=1 pageInitMethod="dg1506058953963PageInitMethod"  defaultNodeExpanded=nodeExpanded  cannotAddNewRow=false cannotDeleteRow=true assModelDisplayName=assModelDisplayName dgTitle="${getText('WOM.dataGriddataGridName.radion1490444001342')}" activexButton="" exportExcel=exportExcel addNewRow=true   canInsertRow=false  insertRowAble=false firstLoad=firstLoad >		
							<#assign productId_productCode_displayDefaultType=''>
								<#assign productId_productCode_defaultValue=''>
										<#assign productId_productCode_defaultValue=''>
																	<#if (productId_productCode_defaultValue!)?string=="currentUser">
							...
							<#elseif (productId_productCode_defaultValue!)?string=="currentComp">
								<#assign productId_productCode_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.productCode"        showFormat="TEXT" defaultValue="${(productId_productCode_defaultValue!)?string}" defaultDisplay="${(productId_productCode_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="WOM.produceTask.produceTask.changePackagesEdit"  textalign="left"  viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('WOM.propertydisplayName.radion14157726448331')}" width=120 showFormatFunc=""/>
							<#assign productId_productName_displayDefaultType=''>
								<#assign productId_productName_defaultValue=''>
										<#assign productId_productName_defaultValue=''>
																	<#if (productId_productName_defaultValue!)?string=="currentUser">
							...
							<#elseif (productId_productName_defaultValue!)?string=="currentComp">
								<#assign productId_productName_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.productName"        showFormat="SELECTCOMP" defaultValue="${(productId_productName_defaultValue!)?string}" defaultDisplay="${(productId_productName_displayDefaultType!)?string}" decimal="" editable=false type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.changePackagesEdit"  textalign="left"  viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('WOM.propertydisplayName.radion1415772740737334')}" width=120 showFormatFunc=""/>
							<#assign property_displayDefaultType=''>
								<#assign property_defaultValue=''>
										<#assign property_defaultValue=''>
			...
			<script type="text/javascript">
				function ProduceMaterialSum_dg1506058953963_check_datagridvalid(){
					//
					var errorObj =ProduceMaterialSum_dg1506058953963Widget._DT.testData();
					var errorContent='';
					if(errorObj!=null){
					  for(var i=0;i<errorObj.length;i++){
						var obj1=errorObj[i];
				...
				function savedg1506058953963DataGrid(){
					<#if  refId?? && (refId gt 0)>
					ProduceMaterialSum_dg1506058953963Widget.setAllRowEdited();
					</#if>
					// 针对需要全部更新的PT，把pt Id存到body的CHANGED_PT中，保存时，会自动保存全部数据
					var changed_pt_name = $('body').data('CHANGED_PT');
					if(changed_pt_name && changed_pt_name.indexOf('ProduceMaterialSum_dg1506058953963Widget') > -1) {
						ProduceMaterialSum_dg1506058953963Widget.setAllRowEdited();
					}
					var json = ProduceMaterialSum_dg1506058953963Widget.parseEditedData();
					$('input[name="dg1506058953963ListJson"]').remove();
					$('input[name="dgLists[\'dg1506058953963\']"]').remove();
					$('input[name="dg1506058953963ModelCode"]').remove();
					$('<input type="hidden" name="dgLists[\'dg1506058953963\']">').val(json).appendTo($('#WOM_produceTask_produceTask_changePackagesEdit_form'));
					$('<input type="hidden" name="dg1506058953963ModelCode">').val('WOM_7.5.0.0_produceTask_ProduceMaterialSum').appendTo($('#WOM_produceTask_produceTask_changePackagesEdit_form'));
					//兼容旧版本提交函数
					$('<input type="hidden" name="dg1506058953963ListJson">').val(json).appendTo($('#WOM_produceTask_produceTask_changePackagesEdit_form'));
				}
				function DT_ProduceMaterialSum_dg1506058953963_deldatagrid(){
					var deleteRows = ProduceMaterialSum_dg1506058953963Widget.deleteRows();
					if(!deleteRows || deleteRows.length == 0) {
						CUI.Dialog.alert("${getHtmlText('foundation.message.choicedel')}");
						return false;
					}
					...
					$.each(deleteRows, function(index, deleteRow){
						...
						if($("#dg1506058953963DeletedIds").length>0){
							$("#dg1506058953963DeletedIds")[0].value+=","+tepID;
						}else{
							CUI('<input type="hidden" id="dg1506058953963DeletedIds" name="dgDeletedIds[\'dg1506058953963\']" value="'+tepID+'">').appendTo(CUI('#WOM_produceTask_produceTask_changePackagesEdit_form'));
						}
						//兼容旧版本提交函数
						CUI('<input type="hidden" name="dg1506058953963DeletedIds['+CUI('input[name^="dg1506058953963DeletedIds"]').length+']'+'" value="'+tepID+'">').appendTo(CUI('#WOM_produceTask_produceTask_changePackagesEdit_form'));
					});
				}
				function DT_ProduceMaterialSum_dg1506058953963_delTreeNodes(){
					var deleteRows = ProduceMaterialSum_dg1506058953963Widget._DT.removeTreeNode();
					if(!deleteRows || deleteRows.length == 0) {
						return false;
					}
					var delproperty = "'id','version','productId.id','headId.id'";
				...
				$(function($){
					...
					if(datagrids[1].length>0) {
						for(var i=0;i<datagrids[1].length;i++) {
							if(datagrids[1][i] == 'ProduceMaterialSum_dg1506058953963') {
								break;
							}
							if(i==datagrids[1].length-1) {
								datagrids[1][datagrids[1].length] = 'ProduceMaterialSum_dg1506058953963';
							}
						}
					} else {
						datagrids[1][datagrids[1].length] = 'ProduceMaterialSum_dg1506058953963';
				...
				var ProduceMaterialSum_dg1506058953963_importDialog = null;
				function ProduceMaterialSum_dg1506058953963_showImportDialog(){
					try{
						if(ProduceMaterialSum_dg1506058953963_importDialog!=null&&ProduceMaterialSum_dg1506058953963_importDialog.isShow==1){
							return false;
						}
						var url = "/WOM/produceTask/produceTask/initImport.action?datagridCode=WOM_7.5.0.0_produceTask_changePackagesEditdg1506058953963&tid=${id!}&datagridName=dg1506058953963";
						ProduceMaterialSum_dg1506058953963_importDialog = new CUI.Dialog({
							title: "${getHtmlText('common.button.import')}",
							url:url,
							modal:true,
							description:'',
							...
							width: '420',
							dragable:true,
							buttons:[{id:"import",name:"${getHtmlText('common.button.import')}",handler:function(){var dg = eval("ProduceMaterialSum_dg1506058953963"+"Widget");if(dg && dg.checkEdited && dg.checkEdited()){CUI.Dialog.alert("${getHtmlText('ec.view.unsavedgdata')}");}else{foundation.importExcel.submitImportForm();}}},{name:"${getHtmlText('common.button.cancel')}",id:"close",handler:function(){setTimeout(function(){$('#importResponse').remove();ProduceMaterialSum_dg1506058953963_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.Confirm')}",id:"ok",display:'hidden',handler:function(){setTimeout(function(){$('#importResponse').remove();ProduceMaterialSum_dg1506058953963_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.back')}",id:"tback",display:'hidden',handler:function(){tback();}}],
							beforeCloseEvent:function(){$('#importResponse').remove();}
						});
						ProduceMaterialSum_dg1506058953963_importDialog.show();
					}catch(e){}
				}	
				
				function ProduceMaterialSum_dg1506058953963_downLoadFile(){
					var url = "/WOM/produceTask/produceTask/downLoad.action?datagridCode=WOM_7.5.0.0_produceTask_changePackagesEditdg1506058953963&templateRelatedModelCode=WOM_7.5.0.0_produceTask_changePackagesEditdg1506058953963&downloadType=template&fileName=dg1506058953963";
					window.open(url,"","");
				}
				function dg1506058953963RenderOverEvent(){
					//启用物料批次
    if(!isProBatch || ProduceMaterialSum_dg1505285519431Widget.getCellValue(0,"headId.formularId.setProcess.id")=="formulaProperty/formulaProperty1"){
		//隐藏物料批号列
		$( 'td[key="batchNum"]').hide();
		ProduceMaterialSum_dg1505285519431Widget._DT._resizeHeight = true;
		ProduceMaterialSum_dg1505285519431Widget._DT._initDomElements();
		ProduceMaterialSum_dg1505285519431Widget._DT._resizeHeight = false;
    }
				}
				function dg1506058953963PageInitMethod(nTabIndex){
					WOM.produceTask.produceTask.changePackagesEdit.initSize(nTabIndex);
				}
			</script>
				...
				<table width="100%">
					<tr>
						...
						<td id="workflow_outcomes">
							...
							<#list transitions as t>
								...
								<#if t.selectPeople??&&t.selectPeople gt 0>
										...
										<#elseif t.selectPeople==3>
											<@mneclient reftitle="${getText('ec.edit.refStaff')}" mneTip="${getText('ec.edit.assignStaff')}" isWrap=true multiDivStyle="height:25px;overflow:hidden;" conditionfunc="WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc('assignStaffSelect_${t.name}')"  name="assignStaffSelect_${t.name}" id="assignStaffSelect_${t.name}" type="userRange" url="/foundation/user/common/userListGroupFrameset.action" displayFieldName="staffname"  ids=defaultSelectIds names=defaultSelectNames  onkeyupfuncname="getassignStaffSelect_${t.name}MultiInfo()" funcparam="unassignUserSupport=true&multiSelect=true&sourceStaff=${(pending.sourceStaff)!''}" sourceStaff="${(pending.sourceStaff)!''}" clicked=true multiple=true mnewidth=260 isEdit=true deploymentId="${deploymentId!''}" selectPeople="${t.selectPeople}" outcome="${t.name}"/>
										<#elseif t.selectPeople==4>
											<@mneclient reftitle="${getText('ec.edit.refStaff')}" mneTip="${getText('ec.edit.assignStaff')}" isWrap=true multiDivStyle="height:25px;overflow:hidden;" conditionfunc="WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc('assignStaffSelect_${t.name}')"  name="assignStaffSelect_${t.name}" id="assignStaffSelect_${t.name}" type="userRange" url="/foundation/user/common/userListGroupFrameset.action" displayFieldName="staffname"  ids=defaultSelectIds names=defaultSelectNames  onkeyupfuncname="getassignStaffSelect_${t.name}MultiInfo()" funcparam="unassignUserSupport=true&multiSelect=true&sourceStaff=${(pending.sourceStaff)!''}" sourceStaff="${(pending.sourceStaff)!''}" clicked=true multiple=true mnewidth=260 isEdit=true selectPeople="${t.selectPeople}" outcome="${t.name}"/>
										<#elseif t.selectPeople==5>
											<@mneclient reftitle="${getText('ec.edit.refStaff')}" mneTip="${getText('ec.edit.assignStaff')}" isWrap=true multiDivStyle="height:25px;overflow:hidden;" conditionfunc="WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc('assignStaffSelect_${t.name}')"  name="assignStaffSelect_${t.name}" id="assignStaffSelect_${t.name}" type="userRange" url="/foundation/user/common/groupUserList.action" displayFieldName="staffname"  ids=defaultSelectIds names=defaultSelectNames  onkeyupfuncname="getassignStaffSelect_${t.name}MultiInfo()" funcparam="unassignUserSupport=true&multiSelect=true" clicked=true multiple=true mnewidth=260 isEdit=true deploymentId="${deploymentId!''}" selectPeople="${t.selectPeople}" outcome="${t.name}"/>
										</#if>
										...
										<@mneclient reftitle="${getText('ec.edit.refStaff')}" mneTip="${getText('ec.edit.assignStaff')}" isWrap=true multiDivStyle="height:25px;overflow:hidden;" conditionfunc="WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc('assignStaffSelect_${t.name}')"  name="assignStaffSelect_${t.name}" id="assignStaffSelect_${t.name}" type="userRange" url="/foundation/user/common/userListFramesetRange.action" displayFieldName="staffname"  ids="" names=""  onkeyupfuncname="getassignStaffSelect_${t.name}MultiInfo()" funcparam="unassignUserSupport=true&multiSelect=true" clicked=true multiple=true mnewidth=260 isEdit=true deploymentId="${deploymentId!''}"/>
										<#else>
							...
							<#if pending?? && pending.loop??&& pending.loop gt 0>
								...
								<div style="float:left;width:27%;padding-right:5px;display:none;" id="countersign_assignStaff" >
									...
									<#elseif pending.loop==3>
										<@mneclient reftitle="${getText('ec.edit.refStaff')}" mneTip="${getText('ec.edit.countersign')}" isWrap=true multiDivStyle="height:25px;overflow:hidden;" conditionfunc="WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc('countersignUsers')"  name="countersignUsers" id="countersignUsers" type="userRange" url="/foundation/user/common/userListGroupFrameset.action" displayFieldName="staffname"  ids="" names=""  onkeyupfuncname="getcountersignUsersMultiInfo()" funcparam="unassignUserSupport=true&multiSelect=true" clicked=true multiple=true mnewidth=260 isEdit=true selectPeople="${pending.loop}"/>
									<#elseif pending.loop==4>
										<@mneclient reftitle="${getText('ec.edit.refStaff')}" mneTip="${getText('ec.edit.countersign')}" isWrap=true multiDivStyle="height:25px;overflow:hidden;" conditionfunc="WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc('countersignUsers')"  name="countersignUsers" id="countersignUsers" type="userRange" url="/foundation/user/common/userListGroupFrameset.action" displayFieldName="staffname"  ids="" names=""  onkeyupfuncname="getcountersignUsersMultiInfo()" funcparam="unassignUserSupport=true&multiSelect=true" clicked=true multiple=true mnewidth=260 isEdit=true selectPeople="${pending.loop}"/>
									<#elseif pending.loop==5>
										<@mneclient reftitle="${getText('ec.edit.refStaff')}" mneTip="${getText('ec.edit.countersign')}" isWrap=true multiDivStyle="height:25px;overflow:hidden;" conditionfunc="WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc('countersignUsers')"  name="countersignUsers" id="countersignUsers" type="userRange" url="/foundation/user/common/groupUserList.action" displayFieldName="staffname"  ids="" names=""  onkeyupfuncname="getcountersignUsersMultiInfo()" funcparam="unassignUserSupport=true&multiSelect=true" clicked=true multiple=true mnewidth=260 isEdit=true deploymentId="${deploymentId!''}" outcome="${pending.activityName}" selectPeople="${pending.loop}"/>
									</#if>
								</div>
							...
							<a class="cui-btn-blue" onclick="WOM.produceTask.produceTask.changePackagesEdit.save()"><span class='btn_r'>${getText('ec.flow.save')}</span></a>
							<a class="cui-btn-green" onclick="WOM.produceTask.produceTask.changePackagesEdit.submit()"><span class='btn_r'>${getText('ec.flow.submit')}</span></a>
	...
	<script type="text/javascript">	
		...
		<div id="WOM_produceTask_produceTask_changePackagesEdit_dealInfo" style="display: none;margin-top:5px;">
			<ul class="edit-tabs">
				<#if !(superEdit!false)>
				<li id="flowHead" onclick="WOM.produceTask.produceTask.changePackagesEdit.showFlowInfo('flow')"><span class="icon_prograss"></span>${getText("ec.flow.flowImage")}</li>
				</#if>
				<li id="fileUploadHead" <#if !(superEdit!false)>class="bar"</#if> onclick="WOM.produceTask.produceTask.changePackagesEdit.showFileUpload('fileUpload')"><span class="icon_file"></span>${getText("foundation.upload.attachment")}</li>
				<li id="dealInfoHead" class="bar" onclick="WOM.produceTask.produceTask.changePackagesEdit.showDealInfo('dealInfo')"><span class="icon_handle"></span>${getText("ec.view.dealadvice")}</li>
			</ul>
		...
		<!-- CUSTOM CODE START(view-EDIT-WOM_7.5.0.0_produceTask_changePackagesEdit,html,WOM_7.5.0.0_produceTask_ProduceTask,WOM_7.5.0.0) -->
<!-- 自定义代码 -->
...
<!-- CUSTOM CODE END -->
			...
			$(window).resize(function(){
				...
				if (width <= 800) {
					if($("#edit_sidebar").length==0 || $("#edit_sidebar").css("display")=="none"){
						$("#WOM_produceTask_produceTask_changePackagesEdit_main_div").css("width",800);
						$(".edit-head").css("width",800);
						$(".edit-workflow").css("width",800);
						$("body").css({"overflow-x":"scroll","position":"relative","zIndex":"100"});
					}else{
						$("#WOM_produceTask_produceTask_changePackagesEdit_main_div").css("width",650);
					...
					if (YAHOO.env.ua.ie == "6") {
						$("#WOM_produceTask_produceTask_changePackagesEdit_main_div").css("width",w1);
						$(".edit-workflow").css("width",w1);
					}else{
						$("#WOM_produceTask_produceTask_changePackagesEdit_main_div").css("width","auto");
		...
		<script type="text/javascript">
			WOM.produceTask.produceTask.changePackagesEdit.initCount = 0;
			WOM.produceTask.produceTask.changePackagesEdit.initSize = function(nTabIndex){
				var panesHeight;
				var thisHeight;
				var h = $(window).height();
			    var w = $(window).width();
				...
				var conHeight = h-$("#WOM_produceTask_produceTask_changePackagesEdit_main_div .edit-head").height()-$("#WOM_produceTask_produceTask_changePackagesEdit_main_div .edit-tabs").height()<#if pendingId?? || editNew>-$("#WOM_produceTask_produceTask_changePackagesEdit_main_div .edit-workflow").height()</#if>;
				$("#WOM_produceTask_produceTask_changePackagesEdit_main_div .edit-tabs").length == 0 ? conHeight = conHeight : conHeight = conHeight-28 //再减去28px，28px是由.edit-tabs的margin-top:14px+6px边框+8px的底部边距组成
				panesHeight = conHeight*0.4;  //当表单跟pt共存的时候采用4/6开
				var datagrids = $('body').data('WOM_produceTask_produceTask_changePackagesEdit_datagrids');
				var padding_bottom=16;
				$("#WOM_produceTask_produceTask_changePackagesEdit_main_div .pd_bottom,#WOM_produceTask_produceTask_changePackagesEdit_main_div .edit-tabs").width(w-14*2-2-width_)  //把tab跟tab下面的内容宽度统一调整
				$("#WOM_produceTask_produceTask_changePackagesEdit_main_div .edit-panes-s").each(function(index){
					//多页签切换时只计算本页签下的PT高度
					...
					if(datagrids && datagrids.length > 0) {
						if(datagrids[index].length > 0) {
							...
							for(var dg=0;dg<datagrids[index].length;dg++) {
								...
								if(dgwidget) {
									...
									if(WOM.produceTask.produceTask.changePackagesEdit.initCount <= 2) {
										setTimeout(function(){WOM.produceTask.produceTask.changePackagesEdit.initSize();}, 200);
										WOM.produceTask.produceTask.changePackagesEdit.initCount++;
									}/* else {
										WOM.produceTask.produceTask.changePackagesEdit.initCount = 0;
									}*/
								}
						...
						if(thisHeight < conHeight){ //当此页签下面的实际内容高度小于分配给它的高度
							...
							$(this).parent().height(conHeight);
							if(($("#WOM_produceTask_produceTask_changePackagesEdit_main_div .edit-workflow").length > 0) && ($("#WOM_produceTask_produceTask_changePackagesEdit_main_div .edit-tabs").length > 0)){		// 底下有处理结果，并且头部有页签切换，此时底部留白14像素
			...
			$(function(){
				WOM.produceTask.produceTask.changePackagesEdit.buttonBar = new CUI.ButtonBar( { panel: '#top_buttonbar' }  );
				WOM.produceTask.produceTask.changePackagesEdit.initSize();
				if(YAHOO.env.ua.ie == 6){
				...
				<#if businessCenterList??&&businessCenterList?size gt 0 >
					...
					$("#edit_side_btn").toggle(function(){
						if(parseInt($("#WOM_produceTask_produceTask_changePackagesEdit_main_div").css("width"),10)==650){
							$("#WOM_produceTask_produceTask_changePackagesEdit_main_div").css("width","800px");
						...
						//WOM.produceTask.produceTask.changePackagesEdit.resizeLayout();
						//WOM.produceTask.produceTask.changePackagesEdit.initSize();
						$('body').trigger('resize');
					},function(){
						if(parseInt($("#WOM_produceTask_produceTask_changePackagesEdit_main_div").css("width"),10)==800){
							$("#WOM_produceTask_produceTask_changePackagesEdit_main_div").css("width","650px");
				...
				$(window).resize(function(){WOM.produceTask.produceTask.changePackagesEdit.initSize();});
				/*
				WOM.produceTask.produceTask.changePackagesEdit.resizeLayout=function(){
		...
		$(function(){
			<#if editNew>
			WOM.produceTask.produceTask.changePackagesEdit.setDepartment();
			<#else>
		...
		WOM.produceTask.produceTask.changePackagesEdit.validate = function(){
		...
		WOM.produceTask.produceTask.changePackagesEdit.beforeSaveProcess = function(){
			try{eval("savedg1506058953963DataGrid()");}catch(e){}
			try{eval("savedg1506058953802DataGrid()");}catch(e){}

			var extraCol = '<extra-data>';
			$('#WOM_produceTask_produceTask_changePackagesEdit_form').trigger('beforeSubmit');
		...
		WOM.produceTask.produceTask.changePackagesEdit.processDataGrid = function(){
										<#if false && isIE>
										$('#WOM_produceTask_produceTask_changePackagesEdit_form').append(ProduceTaskActive_dg1506058953802Widget._DT.createInputs('dg1506058953802List'));
										</#if>
										<#if false && isIE>
										$('#WOM_produceTask_produceTask_changePackagesEdit_form').append(ProduceMaterialSum_dg1506058953963Widget._DT.createInputs('dg1506058953963List'));
										</#if>
		};
		WOM.produceTask.produceTask.changePackagesEdit.save = function(){
			<#if !(superEdit!false)>
			...
			if(!WOM.produceTask.produceTask.changePackagesEdit.validate()){return;}
			WOM.produceTask.produceTask.changePackagesEdit.beforeSaveProcess();

			//WOM.produceTask.produceTask.changePackagesEdit.processDataGrid();
			$('#WOM_produceTask_produceTask_changePackagesEdit_form').submit();
		}
		
		<#if viewType != "readonly">
		$(window).bind('beforeunload',function(){
		        if(isFormChanged('WOM_produceTask_produceTask_changePackagesEdit_form','WOM_produceTask_produceTask_changePackagesEdit_datagrids')) {      
		...
		//打印
		WOM.produceTask.produceTask.changePackagesEdit.print = function(){
		...
		WOM.produceTask.produceTask.changePackagesEdit.saveSetting = function(){
		...
		WOM.produceTask.produceTask.changePackagesEdit.printSetting = function(){
			var viewCode = $('input[name="viewCode"]').val();
			var value = "";
			var printId = 0;
			var printVersion = 0;
			if(viewCode!=undefined && viewCode!=null && viewCode!=''){
				...
				WOM.produceTask.produceTask.changePackagesEdit.settingDialog = new CUI.Dialog({
					...
					buttons:[
							{	name:"${getText("ec.flow.save")}",
								handler:function(){if(WOM.produceTask.produceTask.changePackagesEdit.saveSetting()){this.close();}}
							},
							{	name:"${getText("ec.flow.cancal")}",
								handler:function(){this.close()}
							}]
					})
				WOM.produceTask.produceTask.changePackagesEdit.settingDialog.show();
			}
		}
		
		
		WOM.produceTask.produceTask.changePackagesEdit.submit = function(uncheck){
			$('#operateType').val("submit");
			if(uncheck){}
			else
		...
		WOM.produceTask.produceTask.changePackagesEdit.recall = function(){
		...
		WOM.produceTask.produceTask.changePackagesEdit._callBackInfo = function(res){
		...
		<#if editNew>
		WOM.produceTask.produceTask.changePackagesEdit.setDepartment = function(){
		...
		function dataGridBtnImgClick(sUrl,objNameCustomCondition,sTitle,sPTGridID,nRow,sFieldName,oGrid,customCallBack,crossCompany,isObjCustomProp,objCustomPropNames,viewCode){
			...
			if(customCallBack){
				WOM.produceTask.produceTask.changePackagesEdit._customCallBack = customCallBack;
			}
			if (isObjCustomProp) {
				WOM.produceTask.produceTask.changePackagesEdit._isObjCustomProp_IE = isObjCustomProp;
			} else {
				WOM.produceTask.produceTask.changePackagesEdit._isObjCustomProp_IE = false;
			}
			if (objCustomPropNames) {
				WOM.produceTask.produceTask.changePackagesEdit._objCustomPropNames_IE = objCustomPropNames;
			} else {
				WOM.produceTask.produceTask.changePackagesEdit._objCustomPropNames_IE = '';
			}
			if (viewCode) {
				WOM.produceTask.produceTask.changePackagesEdit._refViewCode_IE = viewCode;
			} else {
				WOM.produceTask.produceTask.changePackagesEdit._refViewCode_IE = '';
			}
			WOM.produceTask.produceTask.changePackagesEdit._selectEvent(objNameCustomCondition,null,sUrl,sTitle,null,null,null,crossCompany,obj);
		}
		
		WOM.produceTask.produceTask.changePackagesEdit.initMnemonic_DG_IE = function(oConfig){
			// 助记码也需要区分是否为自定义字段
			WOM.produceTask.produceTask.changePackagesEdit._isObjCustomProp_IE = oConfig._isObjCustomProp_IE;
			WOM.produceTask.produceTask.changePackagesEdit._objCustomPropNames_IE = oConfig._objCustomPropNames_IE;
			
			var oGrid = oConfig.oGrid;
			// 获取控件PT  object
			var oPTGridEx = oGrid._DT || oGrid;
			// 存储当前操作相关信息
			WOM.produceTask.produceTask.changePackagesEdit.gridEventObj = {
				"oGrid" : oGrid,
				"nRow" : oConfig.nRow - 1,
				"sKey":	oConfig.sFieldName
			}
			WOM.produceTask.produceTask.changePackagesEdit._sUrl = oConfig.url;
			if(oConfig.customCallBack){
				WOM.produceTask.produceTask.changePackagesEdit._customCallBack = oConfig.customCallBack;
			}
			// 自定义的表格对象
		...
		WOM.produceTask.produceTask.changePackagesEdit._selectEvent = function(objName,_selectType,url,title,refparam,obj,customCallBack,crossCompanyFlag,gridEventObj,oGrid,isMultiselect,oColumn){

			var callbackName="";
			var _prefix= '';
			var arr = objName.split('.');
			if(gridEventObj) {
				WOM.produceTask.produceTask.changePackagesEdit.gridEventObj = gridEventObj;
				callbackName = "WOM.produceTask.produceTask.changePackagesEdit.getcallBackInfo_DG_IE";
			}else if(obj!=null && obj!=""){
				if(arr.length > 1){
					_prefix = '.'+ arr[0];
				}
				callbackName = isMultiselect ? "WOM.produceTask.produceTask.changePackagesEdit.getMultiselectCallBackInfo_DG" : "WOM.produceTask.produceTask.changePackagesEdit.getcallBackInfo_DG";
				WOM.produceTask.produceTask.changePackagesEdit._currRow = obj.parentNode.parentNode.parentNode;
			}else{
				if(arr.length > 2){
					_prefix = '.'+ arr[0] + '.'+ arr[1];
				}
				callbackName ="WOM.produceTask.produceTask.changePackagesEdit.getcallBackInfo";
			}

			if(_prefix!=''){
				WOM.produceTask.produceTask.changePackagesEdit._prefix = _prefix.substring(1);
			}
			
			WOM.produceTask.produceTask.changePackagesEdit._oGrid = oGrid;
			WOM.produceTask.produceTask.changePackagesEdit._sUrl = url;
			if (oColumn) {
				if (oColumn.isObjCustomProp) {
					WOM.produceTask.produceTask.changePackagesEdit._isObjCustomProp = oColumn.isObjCustomProp;
				} else {
					WOM.produceTask.produceTask.changePackagesEdit._isObjCustomProp = false;
				} 
				if (oColumn.objCustomPropNames) {
					WOM.produceTask.produceTask.changePackagesEdit._objCustomPropNames = oColumn.objCustomPropNames;
				} else {
					WOM.produceTask.produceTask.changePackagesEdit._objCustomPropNames = '';
				}
				if (oColumn.viewCode) {
					WOM.produceTask.produceTask.changePackagesEdit._refViewCode = oColumn.viewCode;
				} else {
					WOM.produceTask.produceTask.changePackagesEdit._refViewCode = '';
				}
			} else {
				WOM.produceTask.produceTask.changePackagesEdit._isObjCustomProp = false;
				WOM.produceTask.produceTask.changePackagesEdit._objCustomPropNames = '';
			...
			if (WOM.produceTask.produceTask.changePackagesEdit._isObjCustomProp == true && WOM.produceTask.produceTask.changePackagesEdit._objCustomPropNames && objName && objName.substring(objName.length - 'MainDisplay'.length) == 'MainDisplay') {
				WOM.produceTask.produceTask.changePackagesEdit._prefix = objName.substring(0, objName.length - 'MainDisplay'.length);
			}
			if(customCallBack){
				WOM.produceTask.produceTask.changePackagesEdit._customCallBack = customCallBack;
			}
			if(WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc(objName.replace(/\./g, '_')) != null) {
				refparam = 'condition=' + encodeURIComponent(WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc(objName.replace(/\./g, '_')));
			}
			if(typeof WOM.produceTask.produceTask.changePackagesEdit._querycustomFuncN == "function") {
				refparam += WOM.produceTask.produceTask.changePackagesEdit._querycustomFuncN();
			}
			...
			WOM.produceTask.produceTask.changePackagesEdit._dialog = foundation.common.select({
				pageType : 'other',
				closePage : true,
		...
		WOM.produceTask.produceTask.changePackagesEdit._groupSelectEvent = function(objName,_selectType,url,title,refparam){
			if(WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc(objName.replace(/\./g, '_')) != null) {
				refparam = 'condition=' + encodeURIComponent(WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc(objName.replace(/\./g, '_')));
			}
			WOM.produceTask.produceTask.changePackagesEdit._dialog = foundation.common.select({
				...
				closePage : true,
				callBackFuncName : 'WOM.produceTask.produceTask.changePackagesEdit.getcallBackGroupInfo',
				url : url,
				title : title,
				params : refparam
			});
		}
		WOM.produceTask.produceTask.changePackagesEdit._querycustomFunc = function(obj) {
			var str = eval("typeof(WOM.produceTask.produceTask.changePackagesEdit.query_"+obj+")!='undefined'") ? eval('WOM.produceTask.produceTask.changePackagesEdit.query_'+obj+'()') : null;
			return str;
		};
		WOM.produceTask.produceTask.changePackagesEdit.getcallBackGroupInfo = function(obj){
			var ids = "";
			var names = "";
			...
			WOM.produceTask.produceTask.changePackagesEdit._dialog.close();
		}
		WOM.produceTask.produceTask.changePackagesEdit.getcallBackInfo = function(obj){
		
			obj[0] = foundation.common.getObject('WOM_produceTask_produceTask_changePackagesEdit_form',obj[0], WOM.produceTask.produceTask.changePackagesEdit._prefix, WOM.produceTask.produceTask.changePackagesEdit._sUrl);
			CUI.commonFills('WOM_produceTask_produceTask_changePackagesEdit_form',WOM.produceTask.produceTask.changePackagesEdit._prefix,obj[0]);
			
			for(pro in obj[0]){
				try{
					var fname = "_callback_" + (WOM.produceTask.produceTask.changePackagesEdit._prefix + "." + pro).replace(/\./g, '_')  + "_edit";
			...
			try{
				if(WOM.produceTask.produceTask.changePackagesEdit._customCallBack) {
					eval(WOM.produceTask.produceTask.changePackagesEdit._customCallBack);
					WOM.produceTask.produceTask.changePackagesEdit._customCallBack = null;
				}
		...
		// 控件版PT回调
		WOM.produceTask.produceTask.changePackagesEdit.getcallBackInfo_DG_IE = function(obj){
			if(WOM.produceTask.produceTask.changePackagesEdit._customBeforeCallBack) {
				var flag = eval(WOM.produceTask.produceTask.changePackagesEdit._customBeforeCallBack.split("(")[0] + "(obj)");
				if(flag === false){
					return false;
				}
			}
			var gridEventObj = WOM.produceTask.produceTask.changePackagesEdit.gridEventObj;
			var rootKey = gridEventObj.sKey.split('.')[0];
			var jsonObj;
			if ( WOM.produceTask.produceTask.changePackagesEdit._isObjCustomProp_IE == true && WOM.produceTask.produceTask.changePackagesEdit._objCustomPropNames_IE ) {
				jsonObj = foundation.common.getObjectIE_CP_OBJ(gridEventObj,obj[0],rootKey,WOM.produceTask.produceTask.changePackagesEdit._sUrl,WOM.produceTask.produceTask.changePackagesEdit._objCustomPropNames_IE);
			} else {
				jsonObj = foundation.common.getObjectIE(gridEventObj,obj[0],rootKey,WOM.produceTask.produceTask.changePackagesEdit._sUrl);
			}
			CUI.error_msg_DG_CP_map = {};
			var xmlHead = $(gridEventObj.oGrid._DT.opts.oXMLData).children( ':eq(0)' ).children( ':eq(0)' );
			if (WOM.produceTask.produceTask.changePackagesEdit._isObjCustomProp_IE == true && WOM.produceTask.produceTask.changePackagesEdit._objCustomPropNames_IE) { // 控件版PT显示自定义字段
				var showName = WOM.produceTask.produceTask.changePackagesEdit._objCustomPropNames_IE.split(',')[0]; // 主显示字段名称
				var trueName = WOM.produceTask.produceTask.changePackagesEdit._objCustomPropNames_IE.split(',')[1]; // 主键字段名称
			...
			if ( $('#dg_cp_info_' + gridEventObj.oGrid._DT.opts.id).length > 0 ) {
				...
				var id = jsonObj.id;
				var relationMap;
				if (dg_cp_info && id && WOM.produceTask.produceTask.changePackagesEdit._refViewCode_IE) {
					$.ajax({
						async   : false,
						type    : 'POST',
						url     : '/foundation/customProp/related.action',
						data    : 'code=' + WOM.produceTask.produceTask.changePackagesEdit._refViewCode_IE + '&id=' + id,
		...
		WOM.produceTask.produceTask.changePackagesEdit.getcallBackInfo_DG = function(obj){
			if(WOM.produceTask.produceTask.changePackagesEdit._customBeforeCallBack) {
				var flag = eval(WOM.produceTask.produceTask.changePackagesEdit._customBeforeCallBack.split("(")[0] + "(obj)");
				if(flag === false){
					return false;
			...
			for(var i=0;i<obj.length;i++){
				if(i>0){
					if($(WOM.produceTask.produceTask.changePackagesEdit._currRow).next().length==0){
						WOM.produceTask.produceTask.changePackagesEdit._oGrid.addNewRow();
					}	
					WOM.produceTask.produceTask.changePackagesEdit._currRow = $(WOM.produceTask.produceTask.changePackagesEdit._currRow).next();
					$(WOM.produceTask.produceTask.changePackagesEdit._currRow).attr('isEdited',true);
				}
				obj[i] = foundation.common.getObject(WOM.produceTask.produceTask.changePackagesEdit._currRow,obj[i], WOM.produceTask.produceTask.changePackagesEdit._prefix, WOM.produceTask.produceTask.changePackagesEdit._sUrl);
				if (WOM.produceTask.produceTask.changePackagesEdit._isObjCustomProp == true && WOM.produceTask.produceTask.changePackagesEdit._objCustomPropNames) {
					eval("CUI.commonFills_DG_CP_OBJ(WOM.produceTask.produceTask.changePackagesEdit._currRow,WOM.produceTask.produceTask.changePackagesEdit._prefix,obj[i],WOM.produceTask.produceTask.changePackagesEdit._oGrid,WOM.produceTask.produceTask.changePackagesEdit._objCustomPropNames)");
				} else {
					eval("CUI.commonFills_DG(WOM.produceTask.produceTask.changePackagesEdit._currRow,WOM.produceTask.produceTask.changePackagesEdit._prefix,obj[i],WOM.produceTask.produceTask.changePackagesEdit._oGrid)");
				}
				
				// 自定义字段参照回填
				if ( $('#dg_cp_info_' + WOM.produceTask.produceTask.changePackagesEdit._oGrid.dataTableId).length > 0 ) {
					var dg_cp_info = $('#dg_cp_info_' + WOM.produceTask.produceTask.changePackagesEdit._oGrid.dataTableId).val();
					var id = obj[i].id;
					var relationMap;
					if (dg_cp_info && id && WOM.produceTask.produceTask.changePackagesEdit._refViewCode) {
						$.ajax({
							async   : false,
							type    : 'POST',
							url     : '/foundation/customProp/related.action',
							data    : 'code=' + WOM.produceTask.produceTask.changePackagesEdit._refViewCode + '&id=' + id,
							success : function(res){
								if (res.dealSuccessFlag && res.relationMap) {
									relationMap = res.relationMap;
								}
						...
						if (relationMap) {
							...
							for (var n in infoArr) {
								...
								var val = relationMap[key];
								if (val) {
									name = WOM.produceTask.produceTask.changePackagesEdit._oGrid.configs.hidekeyPrefix + name;
									objs[name] = val;
									if (propCode) {
										$.ajax({
											async   : false,
							...
							// console.log(objs);
							if (objs) {
								CUI.commonFills_DG_CP(WOM.produceTask.produceTask.changePackagesEdit._currRow, objs, WOM.produceTask.produceTask.changePackagesEdit._oGrid);
							}
						}
					}
				}
				...
				try{
					...
					for ( var item in  CUI.error_msg_DG_CP_map ){
						for ( var n in  CUI.error_msg_DG_CP_map[item] ){
							errorMsg += ( '<b>' + WOM.produceTask.produceTask.changePackagesEdit._oGrid.getLabel(item) +  '</b>第<b>' + ( parseInt( n, 10 ) + 1)  + '</b>行回填失败！原因:系统编码值不匹配！<br/>' );
						}
					}
					if( errorMsg ){
						workbenchErrorBarWidget.showMessage( errorMsg );
		...
		WOM.produceTask.produceTask.changePackagesEdit.getMultiselectCallBackInfo_DG = function(obj){
			for(var i=0;i<obj.length;i++){
				CUI.commonFillsMultiselect_DG(WOM.produceTask.produceTask.changePackagesEdit._oGrid, WOM.produceTask.produceTask.changePackagesEdit._currRow, WOM.produceTask.produceTask.changePackagesEdit._key, WOM.produceTask.produceTask.changePackagesEdit._displayFieldName, obj[i])
			}
			try{
				if(WOM.produceTask.produceTask.changePackagesEdit._customCallBack) {
					eval(WOM.produceTask.produceTask.changePackagesEdit._customCallBack);
		...
		WOM.produceTask.produceTask.changePackagesEdit.generateInput = function(prefix, obj) {
			CUI.each(obj, function(key,value){
				if(value!=null && key!='rowHtmlObj' && key!='cellHtmlObj'){
					var name = prefix + '.' + key;
					if(typeof value == 'object') {
						WOM.produceTask.produceTask.changePackagesEdit.generateInput(name, value);
					} else {
						if(value!=null&&value!='null'&&value!=undefined&&value!='') {
							CUI('input[name="' + name + '"]').remove();
							CUI('<input type="hidden" name="'+name+'" value="'+value+'">').appendTo(CUI('#WOM_produceTask_produceTask_changePackagesEdit_form'));
						}
					}
				}
			});
		...
		$(function(){
			WOM.produceTask.produceTask.changePackagesEdit.onloadForProduct();
	...
	if(tasksID!=''){
		var url=$('#WOM_produceTask_produceTask_recycleTaskEdit_form').attr('action');
		url=url.replace('submit.action','batchTaskSubmit.action')
		$("#WOM_produceTask_produceTask_recycleTaskEdit_form").attr("action", url);
	...
	if(batchProdTaskID != '' ){
		...
		WOM.produceTask.produceTask.changePackagesEdit.beforeSubmitMethodSettingInPage = function(){
			WOM.produceTask.produceTask.changePackagesEdit.onsaveForProduct();
		};
		WOM.produceTask.produceTask.changePackagesEdit.beforeSubmitMethod = function(){
			<#if pending?? && pending.loop?? && pending.loop gt 0>
			...
			var customOnsaveResult =  WOM.produceTask.produceTask.changePackagesEdit.beforeSubmitMethodSettingInPage();
		...
		<script type="text/javascript">
		WOM.produceTask.produceTask.changePackagesEdit.showBusinessList = function(relatingModelCode,mainEntityId,businessCenterCode,url,showType){
			...
			if(CUI(id).html() == null || $.trim(CUI(id).html()) == ""){
				CUI(id).load(url);
				setTimeout(function(){
					CUI("#WOM_produceTask_produceTask_changePackagesEdit_main_div").hide();
				},100);
			}else{
			    CUI(id).load(url);
				setTimeout(function(){
		...
		WOM.produceTask.produceTask.changePackagesEdit.showThis = function(){
			if(!CUI("#WOM_produceTask_produceTask_changePackagesEdit_main_div").is(':visible')) {
				CUI("#WOM_produceTask_produceTask_changePackagesEdit_main_div").show();
		...
		WOM.produceTask.produceTask.changePackagesEdit.showAudit=function(){
			<#if !id?? || editNew>
			CUI.Dialog.alert("${getText("foundation.base.audit.nolog")}")
			<#else>
			WOM.produceTask.produceTask.changePackagesEdit.auditDialog = new CUI.Dialog({
				title : "${getText("foundation.base.audit")}",
				iframe : "WOM_produceTask_produceTask_changePackagesEdit_auditInfo",
				modal:true,
			...
			WOM.produceTask.produceTask.changePackagesEdit.auditDialog.show();
			</#if>
		}
		
		
		WOM.produceTask.produceTask.changePackagesEdit.showInfoDialog=function(mode){
			
			WOM.produceTask.produceTask.changePackagesEdit.infoDialog = new CUI.Dialog({
				title: "${getText("ec.view.info.view")}",
				elementId: "WOM_produceTask_produceTask_changePackagesEdit_dealInfo",
				modal:true,
				height:500,
				width: 850,
				buttons:[
			...
			WOM.produceTask.produceTask.changePackagesEdit.infoDialog.show();
		...
		WOM.produceTask.produceTask.changePackagesEdit.showFileUpload=function(){
		...
		WOM.produceTask.produceTask.changePackagesEdit.showDealInfo=function(){
		...
		WOM.produceTask.produceTask.changePackagesEdit.showFlowInfo=function(){
		...
		WOM.produceTask.produceTask.changePackagesEdit.supervision=function(){
			WOM.produceTask.produceTask.changePackagesEdit.modifyOwnerStaffDialog = new CUI.Dialog({
				...
				WOM.produceTask.produceTask.changePackagesEdit.modifyOwnerStaffDialog.show();
		}
...
function _callback_produceTask(obj){
		...
		$(".paginatorbar-operatebar :eq(0)").hide();
		$(".paginatorbar-operatebar :eq(2)").hide();
		var length=ProduceTaskActive_dg1505285519610Widget.getRowLength();//pt长度
		if(length>0){
			//清空pt数据
			ProduceTaskActive_dg1505285519610Widget._DT.delAllRows();
		}
		formulaChange1();
...
function getDefaultFormular(obj){
	...
	$.ajax({
		...
		traditional: true,
		async : false,
		data:{"productID":productID,"taskType":"recycleTask"},
		success : function(res) {
...
function setOtherValue(obj){
  ...
  formulaChange1();	
		...
		/* CUSTOM CODE START(view-EDIT-WOM_7.5.0.0_produceTask_changePackagesEdit,js,WOM_7.5.0.0_produceTask_ProduceTask,WOM_7.5.0.0) */
// 自定义代码

/* CUSTOM CODE END */

		WOM.produceTask.produceTask.changePackagesEdit.onloadForProduct = function(){
		/* CUSTOM CODE START(view-EDIT-WOM_7.5.0.0_produceTask_changePackagesEdit,onloadForProduct,WOM_7.5.0.0_produceTask_ProduceTask,WOM_7.5.0.0) */
// 自定义代码

/* CUSTOM CODE END */
		}

		WOM.produceTask.produceTask.changePackagesEdit.onsaveForProduct = function(){
		/* CUSTOM CODE START(view-EDIT-WOM_7.5.0.0_produceTask_changePackagesEdit,onsaveForProduct,WOM_7.5.0.0_produceTask_ProduceTask,WOM_7.5.0.0) */
// 自定义代码
...
/* CUSTOM CODE END */
		...
		<div class="col-sub">
			...
			<div class="edit-sidebar-inner" style='height:1000px;'>
				<div class="sidebar-top"><a href="#"  onclick="WOM.produceTask.produceTask.changePackagesEdit.showThis()">${getText("ec.view.tableInfo")}</a></div>
					...
					<ul>
						<#list businessCenterList as l>
						 <li>
							...
							<#else>
								<a href="#"  onclick="WOM.produceTask.produceTask.changePackagesEdit.showBusinessList('${l.relatingModel.code.replace('.','')}',${(produceTask.id)!},'${l.code}','${l.assview.url}?${getPowerCode(l.assview.code+'_self')}','${l.assview.showType}')" title="${getText(l.showName)}(${(l.count)!})">${getText(l.showName)}(${(l.count)!})</a>
							</#if>
						</li>
					    </#list>
					</ul>
