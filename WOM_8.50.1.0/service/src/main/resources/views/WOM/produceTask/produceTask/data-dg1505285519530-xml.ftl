<#assign cpObjHideKey = '' >
		<#assign customPropViewMappings = getShowCustomProps("WOM_7.5.0.0_produceTask_ProduceTaskProcess", "WOM_7.5.0.0_produceTask_recycleTaskEditdg1505285519530", "DATAGRID", "produceTaskProcess")>
...
<GridData DefaultNodeExpanded="false"   dgName="dg1505285519530" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<name
					sort="false"  onPropertyChange="ProduceTaskProcess_dg1505285519530Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<processType.name
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(ProduceTaskProcess_dg1505285519530Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(ProduceTaskProcess_dg1505285519530Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/RM/processType/processType/processTypeRef.action','dg1505285519530processType.name','${getText("RM.viewtitle.randon1487220867598")}',sPTGridID,nRow,sFieldName,ProduceTaskProcess_dg1505285519530Widget,null,false,false,'','RM_7.5.0.0_processType_processTypeRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="ProduceTaskProcess_dg1505285519530Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<isLastProcess
					sort="false"  onPropertyChange="ProduceTaskProcess_dg1505285519530Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
						...
						readOnly="true" hideEditOnReadOnly="true" 
						hideButtonsOnReadOnly="true"
						<#assign WOM_7_5_0_0_produceTask_ProduceTaskProcess_isLastProcess_permit = checkFieldPermission('isLastProcess','WOM_7.5.0.0_produceTask_ProduceTaskProcess','WOM_7.5.0.0_produceTask_ProduceTaskProcess_isLastProcess')>
						<#if WOM_7_5_0_0_produceTask_ProduceTaskProcess_isLastProcess_permit == 0>
						fieldPermit="0" title="${getText('ec.view.nopermittitle')}"
						</#if>
						<#if WOM_7_5_0_0_produceTask_ProduceTaskProcess_isLastProcess_permit == 1>
						fieldPermit="1" title="${getText('ec.view.readonlytitle')}"
						</#if>
				...
				<factoryId.name
						style="font-color:0303B3"
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(ProduceTaskProcess_dg1505285519530Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(ProduceTaskProcess_dg1505285519530Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/factoryModel/factoryModel/factoryChoiceRef.action','dg1505285519530factoryId.name','${getText("MESBasic.viewtitle.randon1490322790398")}',sPTGridID,nRow,sFieldName,ProduceTaskProcess_dg1505285519530Widget,null,false,false,'','MESBasic_1_factoryModel_factoryChoiceRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="ProduceTaskProcess_dg1505285519530Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<#list customPropViewMappings as cpvm>
					...
					<#if cpvm.property.type == 'OBJECT'>
						...
						<#if cpvm.refView??>
							...
							onFocus="CUI.toggleClearBtn_DG_IE(ProduceTaskProcess_dg1505285519530Widget,nRow,sFieldName)"
							onBtnClick="CUI.clearCellValue_DG_IE(ProduceTaskProcess_dg1505285519530Widget,nRow,sFieldName,true)"
							subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('${viewUrl!}','dg1505285519530${cpvm.propertyLayRec}','${getText("${viewTitle}")}',sPTGridID,nRow,'${cpvm.propertyLayRec}',ProduceTaskProcess_dg1505285519530Widget,null,false,true,'${mainDisplayName},${pkName}','${viewCode}')"
							hideEditOnReadOnly="true"
						</#if>
					</#if>
						sort="false"
						onPropertyChange="ProduceTaskProcess_dg1505285519530Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
					...
					<#elseif cpvm.property.type == 'DATETIME'>
						...
						onClick="initCalender(ProduceTaskProcess_dg1505285519530Widget,'ProduceTaskProcess_dg1505285519530Widget',nRow,sFieldName,<#if cpvm.format == 'YMD_H'>'dateTimeHour'<#elseif cpvm.format == 'YMD_HM'>'dateTimeMin'<#else>'datetime'</#if>)"
						onBtnClick="showCalender(ProduceTaskProcess_dg1505285519530Widget,'ProduceTaskProcess_dg1505285519530Widget',nRow,sFieldName,<#if cpvm.format == 'YMD_H'>'dateTimeHour'<#elseif cpvm.format == 'YMD_HM'>'dateTimeMin'<#else>'datetime'</#if>)"
						control="Text"
				...
				<formularProcess.id
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(ProduceTaskProcess_dg1505285519530Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(ProduceTaskProcess_dg1505285519530Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/RM/formula/formulaProcess/processReference.action','dg1505285519530formularProcess.id','${getText("RM.viewtitle.randon1488596828660")}',sPTGridID,nRow,sFieldName,ProduceTaskProcess_dg1505285519530Widget,null,false,false,'','RM_7.5.0.0_formula_processReference')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="ProduceTaskProcess_dg1505285519530Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
	...
	<tbody>
		...
		<row  onClick="ProduceTaskProcess_dg1505285519530Widget._DT._autoAddNewRow(nRow)" >
					<c>${(row.id)!}</c>
					<c>${(row.version)!}</c>
			...
			<#if cpObjHideKey?? && cpObjHideKey?has_content>
				<#list cpObjHideKey?split(',') as key>
					...
					<#if !WOM_7_5_0_0_produceTask_ProduceTaskProcess_isLastProcess_permit??>
					<#assign WOM_7_5_0_0_produceTask_ProduceTaskProcess_isLastProcess_permit = checkFieldPermission('isLastProcess','WOM_7.5.0.0_produceTask_ProduceTaskProcess','WOM_7.5.0.0_produceTask_ProduceTaskProcess_isLastProcess')>
					</#if>
							<c><#if WOM_7_5_0_0_produceTask_ProduceTaskProcess_isLastProcess_permit != 0><#if (row.isLastProcess)?has_content>${(row.isLastProcess?string)!}<#else>false</#if></#if></c>
