...
<#assign viewCode = 'WOM_7.5.0.0_produceTask_ProduceTask' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		<Style ss:ID="actEndTime">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="actStartTime">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="batchContral">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="batchTaskState">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		...
	  		<Style ss:ID="formularId.edition">
	  			<NumberFormat ss:Format="0.00"/>
	  			<Protection/>
	  		</Style>
	  		...
	  		<Style ss:ID="manuOrderMain.manulOrderNum">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="manuOrderMain.orderNumber">
	  			<NumberFormat ss:Format="0.00"/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'manuOrderMain.manulOrderNum' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											...
											<#if item == 'manuOrderMain.orderNumber' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											...
											<#if item == 'formularId.edition' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											...
											<#if item == 'finishNum' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'batchContral' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'batchTaskState.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
											...
											<#if item == 'actStartTime' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'actEndTime' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'staticFlag' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
			 						        <#assign customGeneratedFlag=false />
												<#if item == 'staticFlag' && !customGeneratedFlag >
												</#if>
											<#if item == 'remark' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'tableNo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('ec.common.tableNo')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'manuOrderMain.manulOrderNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563193157341')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productId.productCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.radion1415772644833dd')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productId.productName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.radion14157727407377788')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'manuOrderMain.orderNumber' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1563254234602')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productBatchNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489668325364')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formularId.code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1488246312092')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formularId.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1487075823790')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formularId.edition' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1487139592239')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'factoryId.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.radion141923239378233')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489658031489')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'finishNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489669609086')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchContral' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1491449305032')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchTaskState.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertyshowName.randon1564033654921.flag')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskState.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490865032818')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'planStartTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489669409811')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'planEndTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489669527423')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'actStartTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489669554931')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'actEndTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489669589966')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'staticFlag' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1543321923004')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
												<#if item == 'staticFlag' && !customGeneratedFlag >
												</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'remark' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489669389730')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												<#if item == 'tableNo' || item == '*'>
													<Cell>
														...
														<#if data.tableNo??><Data ss:Type="String"><![CDATA[${(data.tableNo)!}]]></Data></#if>
												...
												<#if item == 'manuOrderMain.manulOrderNum' || item == '*'>
													<Cell>
														...
														<#if data.manuOrderMain.manulOrderNum??><Data ss:Type="String"><![CDATA[${(data.manuOrderMain.manulOrderNum)!}]]></Data></#if>
												...
												<#if item == 'productId.productCode' || item == '*'>
													<Cell>
														...
														<#if data.productId.productCode??><Data ss:Type="String"><![CDATA[${(data.productId.productCode)!}]]></Data></#if>
												...
												<#if item == 'productId.productName' || item == '*'>
													<Cell>
														...
														<#if data.productId.productName??><Data ss:Type="String"><![CDATA[${(data.productId.productName)!}]]></Data></#if>
												...
												<#if item == 'manuOrderMain.orderNumber' || item == '*'>
													<Cell>
														...
														<#if (data.manuOrderMain.orderNumber)?has_content><Data ss:Type="Number">#{(data.manuOrderMain.orderNumber)!; m2M2}</Data></#if>
												...
												<#if item == 'productBatchNum' || item == '*'>
													<Cell>
														...
														<#if data.productBatchNum??><Data ss:Type="String"><![CDATA[${(data.productBatchNum)!}]]></Data></#if>
												...
												<#if item == 'formularId.code' || item == '*'>
													<Cell>
														...
														<#if data.formularId.code??><Data ss:Type="String"><![CDATA[${(data.formularId.code)!}]]></Data></#if>
												...
												<#if item == 'formularId.name' || item == '*'>
													<Cell>
														...
														<#if data.formularId.name??><Data ss:Type="String"><![CDATA[${(data.formularId.name)!}]]></Data></#if>
												...
												<#if item == 'formularId.edition' || item == '*'>
													<Cell>
														...
														<#if (data.formularId.edition)?has_content><Data ss:Type="Number">#{(data.formularId.edition)!; m6M6}</Data></#if>
												...
												<#if item == 'finishNum' || item == '*'>
													<Cell>
														...
														<#if (data.finishNum)?has_content><Data ss:Type="Number">#{(data.finishNum)!; m6M6}</Data></#if>
												...
												<#if item == 'batchContral' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.batchContral?? && data.batchContral>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'batchTaskState.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.batchTaskState.value)!}')}</Data>
												...
												<#if item == 'taskState.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.taskState.value)!}')}</Data>
												...
												<#if item == 'planStartTime' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.planStartTime??><Data ss:Type="DateTime">${(data.planStartTime)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
												...
												<#if item == 'planEndTime' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.planEndTime??><Data ss:Type="DateTime">${(data.planEndTime)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
												...
												<#if item == 'actStartTime' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.actStartTime??><Data ss:Type="DateTime">${(data.actStartTime)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
												...
												<#if item == 'actEndTime' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.actEndTime??><Data ss:Type="DateTime">${(data.actEndTime)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
												...
												<#if item == 'staticFlag' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.staticFlag?? && data.staticFlag>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'remark' || item == '*'>
													<Cell>
														...
														<#if data.remark??><Data ss:Type="String"><![CDATA[${(data.remark)!}]]></Data></#if>
