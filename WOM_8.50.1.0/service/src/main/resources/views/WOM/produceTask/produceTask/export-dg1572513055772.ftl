 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								...
								<#if item == 'processType.name' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon14870743874974556')}</Data>
										</Cell>
								</#if>
								<#if item == 'isFirstProcess' || item == '*'>
										<Cell>
								...
								<#if item == 'beforeRatio' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('WOM.propertydisplayName.randon1506304489838')}</Data>
										</Cell>
								</#if>
								<#if item == 'exeOrder' || item == '*'>
										<Cell>
					...
					<#if item?length gt 0>
								...
								<#if item == 'beforeRatio' || item == '*'>
									<Cell>
										...
										<#if (data.beforeRatio)?has_content><Data ss:Type="Number">#{(data.beforeRatio)!; m6M6}</Data></#if>
