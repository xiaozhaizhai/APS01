<!-- WOM_7.5.0.0/produceTask/chPackageEdit -->
...
<#-- 命名空间 -->
<#assign editPageNs = "WOM.produceTask.produceTask.chPackageEdit">
<#-- 模型名称-->
<#assign modelName = "produceTask">
<#-- 视图编码-->
<#assign viewCode = "WOM_7.5.0.0_produceTask_chPackageEdit">
<#-- 实体编码-->
<#assign entity_code = "WOM_7.5.0.0_produceTask">
<#-- 视图名称-->
<#assign viewName = "chPackageEdit">
<#-- datagrid编码-->
<#assign datagridCode = "WOM_produceTask_produceTask_chPackageEdit_datagrids">
<#-- 首字母大写的模型名称-->
...
<#-- formid -->
<#assign editFormId = "WOM_produceTask_produceTask_chPackageEdit_form">
<#-- 待办状态 -->
...
<head>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <#assign configTitle = getText('WOM.viewtitle.randon1506059969392')>
		...
		#WOM_produceTask_produceTask_chPackageEdit_form{float:left;width:100%;}
		
		
		</style>
		<script type="text/javascript">
			CUI.ns('WOM.produceTask.produceTask.chPackageEdit');
			WOM.produceTask.produceTask.chPackageEdit.currentUser = ${userJson};
			WOM.produceTask.produceTask.chPackageEdit.currentStaff = ${staffJson};
			WOM.produceTask.produceTask.chPackageEdit.currentDepartment = ${deptJson};
			WOM.produceTask.produceTask.chPackageEdit.currentPosition = ${postJson};
			WOM.produceTask.produceTask.chPackageEdit.currentCompany = ${compJson};
		</script>
		<!-- CUSTOM CODE START(view-EDIT-WOM_7.5.0.0_produceTask_chPackageEdit,head,WOM_7.5.0.0_produceTask_ProduceTask,WOM_7.5.0.0) -->
<!-- 自定义代码 -->
...
<!-- CUSTOM CODE END -->
	...
	<body class="view-edit ">
		...
		<@s.form errorBarId="workbenchErrorBar" hiddenField="produceTask.bulkProduct.id,produceTask.factoryId.id,produceTask.formularId.id,produceTask.id,produceTask.productId.id,produceTask.bulkBatchNum.id," onsubmitMethod="WOM.produceTask.produceTask.chPackageEdit.beforeSubmitMethod()" id="WOM_produceTask_produceTask_chPackageEdit_form" namespace="/WOM/produceTask/produceTask/chPackageEdit" action="submit?__pc__=${(Parameters.__pc__)!}&_bapFieldPermissonModelCode_=WOM_7.5.0.0_produceTask_ProduceTask&_bapFieldPermissonModelName_=ProduceTask&superEdit=${(superEdit!false)?string}" editPageNs="WOM.produceTask.produceTask.chPackageEdit" callback="WOM.produceTask.produceTask.chPackageEdit._callBackInfo" ecform="true">
			<input type="hidden" name="bap_validate_user_id" value="${(Session.user.id)!}" />
			<div style="float:none;width:auto;" class="edit-main grid-s5m0 col-main main-wrap" id="WOM_produceTask_produceTask_chPackageEdit_main_div">
			<div class="edit-head">
				<#include "../../../ec/tableInfo/operateheadbar_all.ftl" >
				<#include "../../../ec/tableInfo/creatorInfo.ftl" >
			</div>
    		<div class="edit-main" id="WOM_produceTask_produceTask_chPackageEdit">
...
<script type="text/javascript">
var attcountid = "WOM_produceTask_produceTask_chPackageEdit_form"+"_attcount";
	...
	<table class="edit-table" style="">
		...
		<tr >
								...
								<#if !(produceTask.id)?? && (produceTask.productId.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('WOM_produceTask_produceTask_chPackageEdit_form',obj, 'produceTask.productId', '/MESBasic/product/product/refProductLayout.action');
												CUI.commonFills('WOM_produceTask_produceTask_chPackageEdit_form', 'produceTask.productId',obj,true);
											}
										});
									})(jQuery);
								</#if>
								...
								<#if !(produceTask.id)?? && (produceTask.factoryId.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('WOM_produceTask_produceTask_chPackageEdit_form',obj, 'produceTask.factoryId', '/MESBasic/factoryModel/factoryModel/factoryProBatchRef.action');
												CUI.commonFills('WOM_produceTask_produceTask_chPackageEdit_form', 'produceTask.factoryId',obj,true);
											}
										});
									})(jQuery);
								</#if>
								
									WOM.produceTask.produceTask.chPackageEdit.query_produceTask_factoryId_name = function() {
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
									...
									<@mneclient iframe=mneIframe!false property_type="BAPCODE" reftitle="${getText('RM.viewtitle.randon1508312483176')}" viewType="${viewType!}" deValue="${produceTask_formularId_code_defaultValue!}" conditionfunc="WOM.produceTask.produceTask.chPackageEdit._querycustomFunc('produceTask_formularId_code')"  value="${(produceTask.formularId.code)!}" displayFieldName="code" name="produceTask.formularId.code" id="produceTask_formularId_code" type="other" url="/RM/formula/formula/formulachPackRef.action" clicked=true multiple=false mnewidth=260 formId="WOM_produceTask_produceTask_chPackageEdit_form" editCustomCallback="_callback_produceTask(obj);" refViewCode="RM_7.5.0.0_formula_formulachPackRef" onkeyupfuncname="_callback_produceTask(obj);_callback_produceTask_formularId_code(obj);" cssStyle="" isEdit=true     isCrossCompany=false  />
								...
								<#if !(produceTask.id)?? && (produceTask.formularId.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('WOM_produceTask_produceTask_chPackageEdit_form',obj, 'produceTask.formularId', '/RM/formula/formula/formulachPackRef.action');
												CUI.commonFills('WOM_produceTask_produceTask_chPackageEdit_form', 'produceTask.formularId',obj,true);
											}
										});
									})(jQuery);
								</#if>
								
									WOM.produceTask.produceTask.chPackageEdit.query_produceTask_formularId_code = function() {
					...
					<td  nullable=true class="edit-table-content"   style="text-align: left;;" >
						...
						<#assign produceTask_taskType_defaultValue  = 'womTaskType/type7'>
								...
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${produceTask_taskType_defaultValue!}" formId="WOM_produceTask_produceTask_chPackageEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.taskType.id" code="womTaskType" value="${(produceTask.taskType.id)!}"  />
									
								<#else>
									
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="WOM_produceTask_produceTask_chPackageEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.taskType.id" code="womTaskType" value="${(produceTask.taskType.id)!}"  />
					...
					<td  nullable=false class="edit-table-content"   align="left" style="text-align: left;;" >
									...
									<@mneclient iframe=mneIframe!false property_type="TEXT" reftitle="${getText('MESBasic.viewtitle.randon1475137145215')}" viewType="${viewType!}" deValue="${produceTask_bulkProduct_productCode_defaultValue!}" conditionfunc="WOM.produceTask.produceTask.chPackageEdit._querycustomFunc('produceTask_bulkProduct_productCode')"  value="${(produceTask.bulkProduct.productCode)!}" displayFieldName="productCode" name="produceTask.bulkProduct.productCode" id="produceTask_bulkProduct_productCode" type="other" url="/MESBasic/product/product/productRefNew.action" clicked=true multiple=false mnewidth=260 formId="WOM_produceTask_produceTask_chPackageEdit_form" editCustomCallback=";" refViewCode="MESBasic_1_product_productRefNew" onkeyupfuncname=";_callback_produceTask_bulkProduct_productCode(obj);" cssStyle="" isEdit=true beforecallback='clearBatchText(obj)'    isCrossCompany=false  />
								...
								<#if !(produceTask.id)?? && (produceTask.bulkProduct.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('WOM_produceTask_produceTask_chPackageEdit_form',obj, 'produceTask.bulkProduct', '/MESBasic/product/product/productRefNew.action');
												CUI.commonFills('WOM_produceTask_produceTask_chPackageEdit_form', 'produceTask.bulkProduct',obj,true);
											}
										});
									})(jQuery);
								</#if>
					...
					<td  nullable=false class="edit-table-content"   align="left" style="text-align: left;;" >
									...
									<@mneclient iframe=mneIframe!false property_type="TEXT" reftitle="${getText('WOM.viewtitle.randon1495109507430')}" viewType="${viewType!}" deValue="${produceTask_bulkBatchNum_batchText_defaultValue!}" conditionfunc="WOM.produceTask.produceTask.chPackageEdit._querycustomFunc('produceTask_bulkBatchNum_batchText')"  value="${(produceTask.bulkBatchNum.batchText)!}" displayFieldName="batchText" name="produceTask.bulkBatchNum.batchText" id="produceTask_bulkBatchNum_batchText" type="other" url="/WOM/standingcropRef/standingcropRef/batchNumOneRef.action" clicked=true multiple=false mnewidth=260 formId="WOM_produceTask_produceTask_chPackageEdit_form" editCustomCallback=";" refViewCode="WOM_7.5.0.0_standingcropRef_batchNumOneRef" onkeyupfuncname=";_callback_produceTask_bulkBatchNum_batchText(obj);" cssStyle="" isEdit=true     isCrossCompany=false  />
								...
								<#if !(produceTask.id)?? && (produceTask.bulkBatchNum.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('WOM_produceTask_produceTask_chPackageEdit_form',obj, 'produceTask.bulkBatchNum', '/WOM/standingcropRef/standingcropRef/batchNumOneRef.action');
												CUI.commonFills('WOM_produceTask_produceTask_chPackageEdit_form', 'produceTask.bulkBatchNum',obj,true);
											}
										});
									})(jQuery);
								</#if>
								
									WOM.produceTask.produceTask.chPackageEdit.query_produceTask_bulkBatchNum_batchText = function() {
							...
							<label style="width:100%;;" value="${getText('WOM.propertydisplayName.randon14958540888816913')}" >${getText('WOM.propertydisplayName.randon14958540888816913')}</label>
				</td>
		...
		<#assign cpvmInfo = ''>
			<#assign customPropList = getShowCustomProps("WOM_7.5.0.0_produceTask_ProduceTask", "WOM_7.5.0.0_produceTask_chPackageEdit", 'EDIT')>
				...
				<td nullable=<#if (c.nullable!false)>true<#else>false</#if> class="edit-table-content" <#if c.fieldType?? && c.fieldType == 'DATATIME'>celltype="DATATIME"</#if> <#if cspan gt 1>colspan="${colspanVal}"</#if> style="text-align:left;">
					...
					<#elseif fieldType == 'SELECTCOMP'>
						<#if columnType == 'SYSTEMCODE'>
							...
							<@systemcode property_type="${columnType}" iscustom=true showType="${fieldType}" viewType=viewType cssStyle="text-align:${c.align!}" formId="WOM_produceTask_produceTask_chPackageEdit_form" classStyle="cui-noborder-input" view=(c.readonly!false) cssStyle="" ecFlag=true multable=isMultable name="${elementName}" code="${(c.property.fillcontentMap.fillContent)!}" value="${produceTask[columnName]!}" seniorSystemCode=isS2 />
						<#else>
		...
		<tr >
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;display:none;" >
								...
								<#else>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="WOM_produceTask_produceTask_chPackageEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.formularId.setProcess.id" code="formulaProperty" value="${(produceTask.formularId.setProcess.id)!}"  />
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
								...
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${produceTask_workType_defaultValue!}" formId="WOM_produceTask_produceTask_chPackageEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.workType.id" code="produceType" value="${(produceTask.workType.id)!}"  />
									
								<#else>
									
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="WOM_produceTask_produceTask_chPackageEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="produceTask.workType.id" code="produceType" value="${(produceTask.workType.id)!}"  />
...
<#assign colAdmFlag=checkUserPermisition('ec_ptManage_list_view')>
			...
			<#assign cpvmInfo = ''>
							...
							<script type="text/javascript">
								function ProduceTaskActive_dg1506060049547_addNewRow(event)
																{
	ProduceTaskActive_dg1506060049547Widget.addRow();
	...
	//表体滚动条bug修改
	ProduceTaskActive_dg1506060049547Widget._DT._resizeHeight = true;
	ProduceTaskActive_dg1506060049547Widget._DT._initDomElements();
	ProduceTaskActive_dg1506060049547Widget.setCellValue(ProduceTaskActive_dg1506060049547Widget.getRowLength()-1,'property.id',"RMproperty/property1");
}
							</script>
							<script type="text/javascript">
								function ProduceTaskActive_dg1506060049547_copyNewRowDataFunc(event)
																{
	//获得选中行
	var selectRow = ProduceTaskActive_dg1506060049547Widget.getSelectedRow();
	...
	CUI.Dialog.confirm("${getText('WOM.confirmcontent.radion1504182834291')}",
		function(){
			...
			if(isProBatch==true){
				...
				ProduceTaskActive_dg1506060049547Widget._DT._resizeHeight = true;
				ProduceTaskActive_dg1506060049547Widget._DT._initDomElements();
				ProduceTaskActive_dg1506060049547Widget._DT._resizeHeight = false;
			}
			//获取未删前的html
			...
			if($("#id").val()=="" || $("[name='produceTask.formularId.id']").val()==""){
				...
				var newRow = ProduceTaskActive_dg1506060049547Widget.getRowLength()-1;//新行号
				//赋值
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"productId.productCode",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"productId.productCode"));//物品编码
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"productId.id",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"productId.id"));//物品id
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"productId.productName",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"productId.productName"));//物品名称
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"orderProcessId.id",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"orderProcessId.id"));//工序名称id
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"orderProcessId.name",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"orderProcessId.name"));//工序名称
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"name",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"name"));//活动名称
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"activeType.id",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"activeType.id"));//活动类型
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"exeSystem.id",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"exeSystem.id"));//执行系统
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"isReplace",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"isReplace"));//替代料
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"property.id",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"property.id"));//性质
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"standardNum",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"standardNum"));//理论用量			 
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"planNum",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"planNum"));//计划用量	  
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"productId.productBaseUnit.name",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"productId.productBaseUnit.name"));	//单位 
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"isMixQuality",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"isMixQuality"));//固定数量
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"phase",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"phase"));//阶段
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"sequence",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"sequence"));//次序号
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"needWeigh",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"needWeigh"));//是否需要称重
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"batchNumObj.id",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"batchNumObj.id"));//物料批号id	
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"batchNumObj.batchText",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"batchNumObj.batchText"));//物料批号
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"minQuality",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"minQuality"));//理论下限
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"maxQuality",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"maxQuality"));//理论上限
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"lossRate",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"lossRate"));//损耗率  
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"activeId.id",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"activeId.id"));//活动id	
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"formulaId.id",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"formulaId.id"));//配方id  
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"processId.id",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"processId.id"));//工序id		
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"putBatMateId.id",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"putBatMateId.id"));//投配料活动id	
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"offerOrder",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"offerOrder"));//配料顺序
				ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"actOrder",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"actOrder"));//投料顺序		
				if(ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"remark")==undefined){
					ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"remark","");//备注
				}else{
					ProduceTaskActive_dg1506060049547Widget.setCellValue(newRow,"remark",ProduceTaskActive_dg1506060049547Widget.getCellValue(selectRow,"remark"));//备注
				}	
		}
	);
	}else{
		workbenchErrorBarWidget.showMessage("${getText('WOM.showMessage00000013')}");
			...
			<#if  refId?? && (refId > 0)>
				<#assign dUrl="/WOM/produceTask/produceTask/data-dg1506060049547.action?produceTask.id=${refId!-1}&refId=${refId!-1}&datagridCode=WOM_7.5.0.0_produceTask_chPackageEditdg1506060049547">
			<#else>
				<#assign dUrl="/WOM/produceTask/produceTask/data-dg1506060049547.action?produceTask.id=${(produceTask.id)!-1}&datagridCode=WOM_7.5.0.0_produceTask_chPackageEditdg1506060049547">
			</#if>
			<#assign firstLoad = true>
				
			<#if viewType?? && viewType != "readonly" && newObj?? && !newObj && !(refId?? && (refId > 0))>
				<#assign buttons="[{text:\"${getText('ec.view.deleteline')}\",iconClass:\"cui-btn-del\",useInMore:\"false\",handler:function(event){DT_ProduceTaskActive_dg1506060049547_deldatagrid();}},{text:\"${getText('WOM.buttonPropertyshowName.radion1505441258642')}\",handler:function(event){ProduceTaskActive_dg1506060049547_addNewRow(event)},iconClass:\"cui-btn-add\",useInMore:\"false\"},{text:\"${getText('WOM.buttonPropertyshowName.radion1503995839036')}\",handler:function(event){ProduceTaskActive_dg1506060049547_copyNewRowDataFunc(event)},iconClass:\"cui-btn-add\",useInMore:\"false\"}]">
			...
			<#else>
				...
				<#if cpvmInfo?? && cpvmInfo?length gt 0>
					<#assign cpvmInfo = cpvmInfo?substring(1)>
					<input type="hidden" id="dg_cp_info_ProduceTaskActive_dg1506060049547" value="${cpvmInfo!}" />
				</#if>
			
			<input type="hidden" id="dg1506060049547_id" value="ProduceTaskActive_dg1506060049547" />
			
			<input type="hidden" id="dg1506060049547_url" value="${dUrl}" />
			
			<#assign assModelDisplayName = getText('WOM.modelname.randon1489671093316')!>
			<#assign assModelDisplayName = assModelDisplayName + getText('ec.common.validate.colon') >
			<@exportexcel action="/WOM/produceTask/produceTask/data-dg1506060049547.action?operateType=export&datagridCode=WOM_7.5.0.0_produceTask_chPackageEditdg1506060049547"  settingtext="" settingUrl="" prepareParams="" formId="" look="text" width=250 height=170 text="" exportPageChoose=0 dtPage="dgPage" prefix="ProduceTaskActive_dg1506060049547" />
			<@datagrid colAdminFlag=colAdmFlag withoutConfigTable=true id="ProduceTaskActive_dg1506060049547" viewType="${viewType}" renderOverEvent="dg1506060049547RenderOverEvent" route="${routeFlag}" formId="WOM_produceTask_produceTask_chPackageEdit_form" noPermissionKeys="productId.productCode,productId.id,productId.productName,activeType,property,standardNum,planNum,productId.productBaseUnit.name,isMixQuality,phase,sequence,needWeigh,batchNumObj.batchText,minQuality,maxQuality,lossRate,remark,batchNumObj.id,orderProcessId.id,activeId.id,formulaId.id,processId.id,putBatMateId.id" modelCode="WOM_7.5.0.0_produceTask_ProduceTaskActive" dataUrl="${dUrl}" postData="&dgPage.pageSize=65536" dataGridName="dg1506060049547" dtPage="dgPage"  hidekeyPrefix="dg1506060049547" hidekey="['id','version','productId.id','productId.productCode','productId.id','productId.id','productId.id','productId.productName','productId.id','productId.productBaseUnit.name','batchNumObj.id','batchNumObj.batchText','batchNumObj.id','batchNumObj.id','orderProcessId.id','orderProcessId.id','activeId.id','activeId.id','formulaId.id','formulaId.id','processId.id','processId.id','putBatMateId.id','putBatMateId.id'${cpObjHideKey!''}]" transMethod="post" paginator=false editable=true buttons="${buttons}"  canImportExcel=canImportExcel noPadding=true isEdit=true tabViewIndex=0 pageInitMethod="dg1506060049547PageInitMethod"  defaultNodeExpanded=nodeExpanded  cannotAddNewRow=true cannotDeleteRow=false assModelDisplayName=assModelDisplayName dgTitle="${getText('WOM.dataGriddataGridName.radion1490443916302')}" activexButton="WOM.buttonPropertyshowName.radion1505441258642,addNewRow,add;WOM.buttonPropertyshowName.radion1503995839036,copyNewRowDataFunc,add" exportExcel=exportExcel addNewRow=false   canInsertRow=false  insertRowAble=true firstLoad=firstLoad  copyRow=false  copyColumn=false  ptRealTimeLoad=0 >		
							...
							<#elseif (batchNumObj_batchText_defaultValue!)?string=="currentComp">
								<#assign batchNumObj_batchText_defaultValue='${compJson!}'>
									...
									<@datacolumn key="batchNumObj.batchText"        showFormat="SELECTCOMP" defaultValue="${(batchNumObj_batchText_defaultValue!)?string}" defaultDisplay="${(batchNumObj_batchText_displayDefaultType!)?string}" decimal="" editable=true type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.chPackageEdit"  textalign="left"  viewUrl="/WOM/standingcropRef/standingcropRef/batchNumOneMakeTask.action" viewCode="WOM_7.5.0.0_standingcropRef_batchNumOneMakeTask" mneenable=false crossCompany=false viewTitle="${getText('WOM.viewtitle.randon1503994294075')}"  label="${getText('WOM.propertydisplayName.randon1490064501469')}" width=100 showFormatFunc=""  />
							...
							<#elseif (orderProcessId_id_defaultValue!)?string=="currentComp">
								<#assign orderProcessId_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="orderProcessId.id"        showFormat="TEXT" defaultValue="${(orderProcessId_id_defaultValue!)?string}" defaultDisplay="${(orderProcessId_id_displayDefaultType!)?string}" decimal="" editable=false type="long" showType="long" notnull=false   selectCompName="WOM.produceTask.produceTask.chPackageEdit"  textalign="center" hiddenCol=true viewUrl="/WOM/produceTask/produceTaskProcess/taskProcessRef.action" viewCode="WOM_7.5.0.0_produceTask_taskProcessRef" mneenable=false crossCompany=false viewTitle="${getText('WOM.viewtitle.randon1490685207348')}"  label="${getText('ec.common.ID')}" width=100 showFormatFunc=""  />
			...
			<script type="text/javascript">
				function ProduceTaskActive_dg1506060049547_check_datagridvalid(){
					//
					var errorObj =ProduceTaskActive_dg1506060049547Widget._DT.testData();
					var errorContent='';
					if(errorObj!=null){
				...
				function savedg1506060049547DataGrid(){
					<#if  refId?? && (refId gt 0)>
					ProduceTaskActive_dg1506060049547Widget.setAllRowEdited();
					</#if>
					// 针对需要全部更新的PT，把pt Id存到body的CHANGED_PT中，保存时，会自动保存全部数据
					var changed_pt_name = $('body').data('CHANGED_PT');
					if(changed_pt_name && changed_pt_name.indexOf('ProduceTaskActive_dg1506060049547Widget') > -1) {
						ProduceTaskActive_dg1506060049547Widget.setAllRowEdited();
					}
					var json = ProduceTaskActive_dg1506060049547Widget.parseEditedData();
					$('input[name="dg1506060049547ListJson"]').remove();
					$('input[name="dgLists[\'dg1506060049547\']"]').remove();
					$('input[name="dg1506060049547ModelCode"]').remove();
					$('<input type="hidden" name="dgLists[\'dg1506060049547\']">').val(json).appendTo($('#WOM_produceTask_produceTask_chPackageEdit_form'));
					$('<input type="hidden" name="dg1506060049547ModelCode">').val('WOM_7.5.0.0_produceTask_ProduceTaskActive').appendTo($('#WOM_produceTask_produceTask_chPackageEdit_form'));
					//兼容旧版本提交函数
					$('<input type="hidden" name="dg1506060049547ListJson">').val(json).appendTo($('#WOM_produceTask_produceTask_chPackageEdit_form'));
				}
				function DT_ProduceTaskActive_dg1506060049547_deldatagrid(){
					var deleteRows = ProduceTaskActive_dg1506060049547Widget.deleteRows();
					...
					$.each(deleteRows, function(index, deleteRow){
						...
						if($("#dg1506060049547DeletedIds").length>0){
							$("#dg1506060049547DeletedIds")[0].value+=","+tepID;
						}else{
							CUI('<input type="hidden" id="dg1506060049547DeletedIds" name="dgDeletedIds[\'dg1506060049547\']" value="'+tepID+'">').appendTo(CUI('#WOM_produceTask_produceTask_chPackageEdit_form'));
						}
						//兼容旧版本提交函数
						CUI('<input type="hidden" name="dg1506060049547DeletedIds['+CUI('input[name^="dg1506060049547DeletedIds"]').length+']'+'" value="'+tepID+'">').appendTo(CUI('#WOM_produceTask_produceTask_chPackageEdit_form'));
					});
					return deleteRows;
				}
				function DT_ProduceTaskActive_dg1506060049547_delTreeNodes(){
					var deleteRows = ProduceTaskActive_dg1506060049547Widget._DT.removeTreeNode();
					if(!deleteRows || deleteRows.length == 0) {
						return false;
					}
					var delproperty = "'id','version','processId.id','activeId.id','headID.id','formulaId.id','productId.id'";
				...
				$(function($){
					var datagrids = $('body').data('WOM_produceTask_produceTask_chPackageEdit_datagrids');
					if(!datagrids) {
						datagrids = [];
					}
					for(var i=0;i<2;i++) {
					...
					if(datagrids[0].length>0) {
						for(var i=0;i<datagrids[0].length;i++) {
							if(datagrids[0][i] == 'ProduceTaskActive_dg1506060049547') {
								break;
							}
							if(i==datagrids[0].length-1) {
								datagrids[0][datagrids[0].length] = 'ProduceTaskActive_dg1506060049547';
							}
						}
					} else {
						datagrids[0][datagrids[0].length] = 'ProduceTaskActive_dg1506060049547';
					}
					$('body').data('WOM_produceTask_produceTask_chPackageEdit_datagrids', datagrids);
				});
				
				var ProduceTaskActive_dg1506060049547_importDialog = null;
				function ProduceTaskActive_dg1506060049547_showImportDialog(){
					try{
						if(ProduceTaskActive_dg1506060049547_importDialog!=null&&ProduceTaskActive_dg1506060049547_importDialog.isShow==1){
							return false;
						}
						var url = "/WOM/produceTask/produceTask/initImport.action?datagridCode=WOM_7.5.0.0_produceTask_chPackageEditdg1506060049547&tid=${id!}&datagridName=dg1506060049547";
							<#if canImportExcel>
								var buttonCode="WOM_7.5.0.0_produceTask_chPackageEditdg1506060049547_BUTTON_dgImport";
								url+="&buttonCode="+buttonCode;
							</#if>
						ProduceTaskActive_dg1506060049547_importDialog = new CUI.Dialog({
							...
							width: '420',
							dragable:true,
							buttons:[{id:"import",name:"${getHtmlText('common.button.import')}",handler:function(){var dg = eval("ProduceTaskActive_dg1506060049547"+"Widget");if(dg && dg.checkEdited && dg.checkEdited()){CUI.Dialog.alert("${getHtmlText('ec.view.unsavedgdata')}");}else{foundation.importExcel.submitImportForm();}}},{name:"${getHtmlText('common.button.cancel')}",id:"close",handler:function(){setTimeout(function(){$('#importResponse').remove();ProduceTaskActive_dg1506060049547_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.Confirm')}",id:"ok",display:'hidden',handler:function(){setTimeout(function(){$('#importResponse').remove();ProduceTaskActive_dg1506060049547_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.back')}",id:"tback",display:'hidden',handler:function(){tback();}}],
							beforeCloseEvent:function(){$('#importResponse').remove();}
						});
						ProduceTaskActive_dg1506060049547_importDialog.show();
					}catch(e){}
				}	
				
				function ProduceTaskActive_dg1506060049547_downLoadFile(){
					var url = "/WOM/produceTask/produceTask/downLoad.action?datagridCode=WOM_7.5.0.0_produceTask_chPackageEditdg1506060049547&templateRelatedModelCode=WOM_7.5.0.0_produceTask_chPackageEditdg1506060049547&downloadType=template&fileName=dg1506060049547";
					window.open(url,"","");
				}
				function dg1506060049547RenderOverEvent(){
					//启用物料批次
    if(isProBatch==true){
    	//将复制按钮显示
	...
	if($("[name='produceTask.formularId.code']").val()!=""){
		if(ProduceTaskActive_dg1506060049547Widget.getRowLength()>0){
			//禁用生产数量
	...
	//}
				...
				function dg1506060049547PageInitMethod(nTabIndex){
					WOM.produceTask.produceTask.chPackageEdit.initSize(nTabIndex);
...
$("#ProduceTaskActive_dg1506060049547 .paginatorbar-operatebar span:eq(2)").attr('class','buttonbar-button cui-btn-copy');
				}
			</script>
...
<#assign colAdmFlag=checkUserPermisition('ec_ptManage_list_view')>
			...
			<#if  refId?? && (refId > 0)>
				<#assign dUrl="/WOM/produceTask/produceTask/data-dg1506060049644.action?produceTask.id=${refId!-1}&refId=${refId!-1}&datagridCode=WOM_7.5.0.0_produceTask_chPackageEditdg1506060049644">
			<#else>
				<#assign dUrl="/WOM/produceTask/produceTask/data-dg1506060049644.action?produceTask.id=${(produceTask.id)!-1}&datagridCode=WOM_7.5.0.0_produceTask_chPackageEditdg1506060049644">
			</#if>
			<#assign firstLoad = true>
				
			<#if viewType?? && viewType != "readonly" && newObj?? && !newObj && !(refId?? && (refId > 0))>
				<#assign buttons="[{text:\"${getText('ec.view.addline')}\",handler:function(event){this.addNewRow(event);},iconClass:\"cui-btn-add\",useInMore:\"false\"},{text:\"${getText('ec.view.deleteline')}\",iconClass:\"cui-btn-del\",useInMore:\"false\",handler:function(event){DT_ProduceMaterialSum_dg1506060049644_deldatagrid();}}]">
				<#assign canImportExcel=false>
			<#else>
				<#assign buttons="[{text:\"${getText('ec.view.addline')}\",handler:function(event){this.addNewRow(event);},iconClass:\"cui-btn-add\",useInMore:\"false\"},{text:\"${getText('ec.view.deleteline')}\",iconClass:\"cui-btn-del\",useInMore:\"false\",handler:function(event){DT_ProduceMaterialSum_dg1506060049644_deldatagrid();}}]">
				<#assign canImportExcel=false>
				...
				<#if cpvmInfo?? && cpvmInfo?length gt 0>
					<#assign cpvmInfo = cpvmInfo?substring(1)>
					<input type="hidden" id="dg_cp_info_ProduceMaterialSum_dg1506060049644" value="${cpvmInfo!}" />
				</#if>
			
			<input type="hidden" id="dg1506060049644_id" value="ProduceMaterialSum_dg1506060049644" />
			
			<input type="hidden" id="dg1506060049644_url" value="${dUrl}" />
			
			<#assign assModelDisplayName = getText('WOM.modelname.randon1489671141506')!>
			<#assign assModelDisplayName = assModelDisplayName + getText('ec.common.validate.colon') >
			<@exportexcel action="/WOM/produceTask/produceTask/data-dg1506060049644.action?operateType=export&datagridCode=WOM_7.5.0.0_produceTask_chPackageEditdg1506060049644"  settingtext="" settingUrl="" prepareParams="" formId="" look="text" width=250 height=170 text="" exportPageChoose=0 dtPage="dgPage" prefix="ProduceMaterialSum_dg1506060049644" />
			<@datagrid colAdminFlag=colAdmFlag withoutConfigTable=true id="ProduceMaterialSum_dg1506060049644" viewType="${viewType}" renderOverEvent="dg1506060049644RenderOverEvent" route="${routeFlag}" formId="WOM_produceTask_produceTask_chPackageEdit_form" noPermissionKeys="productId.productCode,productId.productName,property,planNum,productId.productBaseUnit.name,batchNum,headId.formularId.setProcess" modelCode="WOM_7.5.0.0_produceTask_ProduceMaterialSum" dataUrl="${dUrl}" postData="&dgPage.pageSize=65536" dataGridName="dg1506060049644" dtPage="dgPage"  hidekeyPrefix="dg1506060049644" hidekey="['id','version','productId.id','productId.productCode','productId.id','productId.productName','productId.id','productId.productBaseUnit.name','headId.id','headId.formularId.setProcess.id'${cpObjHideKey!''}]" transMethod="post" paginator=false editable=false  buttons="${buttons}" noPadding=true isEdit=true tabViewIndex=1 pageInitMethod="dg1506060049644PageInitMethod"  defaultNodeExpanded=nodeExpanded  cannotAddNewRow=false cannotDeleteRow=true assModelDisplayName=assModelDisplayName dgTitle="${getText('WOM.dataGriddataGridName.radion1490444001342')}" activexButton="" exportExcel=exportExcel addNewRow=true   canInsertRow=false  insertRowAble=true firstLoad=firstLoad  copyRow=false  copyColumn=false  ptRealTimeLoad=0 >		
							<#assign productId_productCode_displayDefaultType=''>
								<#assign productId_productCode_defaultValue=''>
										<#assign productId_productCode_defaultValue=''>
																	<#if (productId_productCode_defaultValue!)?string=="currentUser">
							...
							<#elseif (productId_productName_defaultValue!)?string=="currentComp">
								<#assign productId_productName_defaultValue='${compJson!}'>
									...
									<@datacolumn key="productId.productName"        showFormat="SELECTCOMP" defaultValue="${(productId_productName_defaultValue!)?string}" defaultDisplay="${(productId_productName_displayDefaultType!)?string}" decimal="" editable=false type="selectcomp" showType="selectcomp" notnull=false   selectCompName="WOM.produceTask.produceTask.chPackageEdit"  textalign="left"  viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('WOM.propertydisplayName.radion1415772740737334')}" width=120 showFormatFunc=""  />
							<#assign property_displayDefaultType=''>
								<#assign property_defaultValue=''>
										<#assign property_defaultValue=''>
			...
			<script type="text/javascript">
				function ProduceMaterialSum_dg1506060049644_check_datagridvalid(){
					//
					var errorObj =ProduceMaterialSum_dg1506060049644Widget._DT.testData();
					var errorContent='';
					if(errorObj!=null){
					  for(var i=0;i<errorObj.length;i++){
						var obj1=errorObj[i];
				...
				function savedg1506060049644DataGrid(){
					<#if  refId?? && (refId gt 0)>
					ProduceMaterialSum_dg1506060049644Widget.setAllRowEdited();
					</#if>
					// 针对需要全部更新的PT，把pt Id存到body的CHANGED_PT中，保存时，会自动保存全部数据
					var changed_pt_name = $('body').data('CHANGED_PT');
					if(changed_pt_name && changed_pt_name.indexOf('ProduceMaterialSum_dg1506060049644Widget') > -1) {
						ProduceMaterialSum_dg1506060049644Widget.setAllRowEdited();
					}
					var json = ProduceMaterialSum_dg1506060049644Widget.parseEditedData();
					$('input[name="dg1506060049644ListJson"]').remove();
					$('input[name="dgLists[\'dg1506060049644\']"]').remove();
					$('input[name="dg1506060049644ModelCode"]').remove();
					$('<input type="hidden" name="dgLists[\'dg1506060049644\']">').val(json).appendTo($('#WOM_produceTask_produceTask_chPackageEdit_form'));
					$('<input type="hidden" name="dg1506060049644ModelCode">').val('WOM_7.5.0.0_produceTask_ProduceMaterialSum').appendTo($('#WOM_produceTask_produceTask_chPackageEdit_form'));
					//兼容旧版本提交函数
					$('<input type="hidden" name="dg1506060049644ListJson">').val(json).appendTo($('#WOM_produceTask_produceTask_chPackageEdit_form'));
				}
				function DT_ProduceMaterialSum_dg1506060049644_deldatagrid(){
					var deleteRows = ProduceMaterialSum_dg1506060049644Widget.deleteRows();
					if(!deleteRows || deleteRows.length == 0) {
						CUI.Dialog.alert("${getHtmlText('foundation.message.choicedel')}");
						return false;
					}
					...
					$.each(deleteRows, function(index, deleteRow){
						...
						if($("#dg1506060049644DeletedIds").length>0){
							$("#dg1506060049644DeletedIds")[0].value+=","+tepID;
						}else{
							CUI('<input type="hidden" id="dg1506060049644DeletedIds" name="dgDeletedIds[\'dg1506060049644\']" value="'+tepID+'">').appendTo(CUI('#WOM_produceTask_produceTask_chPackageEdit_form'));
						}
						//兼容旧版本提交函数
						CUI('<input type="hidden" name="dg1506060049644DeletedIds['+CUI('input[name^="dg1506060049644DeletedIds"]').length+']'+'" value="'+tepID+'">').appendTo(CUI('#WOM_produceTask_produceTask_chPackageEdit_form'));
					});
					return deleteRows;
				}
				function DT_ProduceMaterialSum_dg1506060049644_delTreeNodes(){
					var deleteRows = ProduceMaterialSum_dg1506060049644Widget._DT.removeTreeNode();
					if(!deleteRows || deleteRows.length == 0) {
						return false;
					}
					var delproperty = "'id','version','productId.id','headId.id'";
				...
				$(function($){
					...
					if(datagrids[1].length>0) {
						for(var i=0;i<datagrids[1].length;i++) {
							if(datagrids[1][i] == 'ProduceMaterialSum_dg1506060049644') {
								break;
							}
							if(i==datagrids[1].length-1) {
								datagrids[1][datagrids[1].length] = 'ProduceMaterialSum_dg1506060049644';
							}
						}
					} else {
						datagrids[1][datagrids[1].length] = 'ProduceMaterialSum_dg1506060049644';
				...
				var ProduceMaterialSum_dg1506060049644_importDialog = null;
				function ProduceMaterialSum_dg1506060049644_showImportDialog(){
					try{
						if(ProduceMaterialSum_dg1506060049644_importDialog!=null&&ProduceMaterialSum_dg1506060049644_importDialog.isShow==1){
							return false;
						}
						var url = "/WOM/produceTask/produceTask/initImport.action?datagridCode=WOM_7.5.0.0_produceTask_chPackageEditdg1506060049644&tid=${id!}&datagridName=dg1506060049644";
							<#if canImportExcel>
								var buttonCode="WOM_7.5.0.0_produceTask_chPackageEditdg1506060049644_BUTTON_dgImport";
								url+="&buttonCode="+buttonCode;
							</#if>
						ProduceMaterialSum_dg1506060049644_importDialog = new CUI.Dialog({
							title: "${getHtmlText('common.button.import')}",
							url:url,
							modal:true,
							description:'',
							...
							width: '420',
							dragable:true,
							buttons:[{id:"import",name:"${getHtmlText('common.button.import')}",handler:function(){var dg = eval("ProduceMaterialSum_dg1506060049644"+"Widget");if(dg && dg.checkEdited && dg.checkEdited()){CUI.Dialog.alert("${getHtmlText('ec.view.unsavedgdata')}");}else{foundation.importExcel.submitImportForm();}}},{name:"${getHtmlText('common.button.cancel')}",id:"close",handler:function(){setTimeout(function(){$('#importResponse').remove();ProduceMaterialSum_dg1506060049644_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.Confirm')}",id:"ok",display:'hidden',handler:function(){setTimeout(function(){$('#importResponse').remove();ProduceMaterialSum_dg1506060049644_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.back')}",id:"tback",display:'hidden',handler:function(){tback();}}],
							beforeCloseEvent:function(){$('#importResponse').remove();}
						});
						ProduceMaterialSum_dg1506060049644_importDialog.show();
					}catch(e){}
				}	
				
				function ProduceMaterialSum_dg1506060049644_downLoadFile(){
					var url = "/WOM/produceTask/produceTask/downLoad.action?datagridCode=WOM_7.5.0.0_produceTask_chPackageEditdg1506060049644&templateRelatedModelCode=WOM_7.5.0.0_produceTask_chPackageEditdg1506060049644&downloadType=template&fileName=dg1506060049644";
					window.open(url,"","");
				}
				function dg1506060049644RenderOverEvent(){
					//启用物料批次
    if(!isProBatch || ProduceMaterialSum_dg1506060049644Widget.getCellValue(0,"headId.formularId.setProcess.id")=="formulaProperty/formulaProperty1"){
		//隐藏物料批号列
		$( 'td[key="batchNum"]').hide();
		ProduceMaterialSum_dg1506060049644Widget._DT._resizeHeight = true;
		ProduceMaterialSum_dg1506060049644Widget._DT._initDomElements();
		ProduceMaterialSum_dg1506060049644Widget._DT._resizeHeight = false;
    }
				}
				function dg1506060049644PageInitMethod(nTabIndex){
					WOM.produceTask.produceTask.chPackageEdit.initSize(nTabIndex);
				}
			</script>
	...
	<#include "../../../ec/tableInfo/flowDealContainer_all.ftl">
		...
		<div id="WOM_produceTask_produceTask_chPackageEdit_dealInfo" style="display: none;margin-top:5px;">
			<ul class="edit-tabs">
				<#if !(superEdit!false)>
				<li id="flowHead" onclick="WOM.produceTask.produceTask.chPackageEdit.showFlowInfo('flow')"><span class="icon_prograss"></span>${getText("ec.flow.flowImage")}</li>
				</#if>
				<li id="fileUploadHead" <#if !(superEdit!false)>class="bar"</#if> onclick="WOM.produceTask.produceTask.chPackageEdit.showFileUpload('fileUpload')"><span class="icon_file"></span>${getText("foundation.upload.attachment")}</li>
				<li id="dealInfoHead" class="bar" onclick="WOM.produceTask.produceTask.chPackageEdit.showDealInfo('dealInfo')"><span class="icon_handle"></span>${getText("ec.view.dealadvice")}</li>
			</ul>
		...
		<!-- CUSTOM CODE START(view-EDIT-WOM_7.5.0.0_produceTask_chPackageEdit,html,WOM_7.5.0.0_produceTask_ProduceTask,WOM_7.5.0.0) -->
<!-- 自定义代码 -->
<style type="text/css">
	.cui-btn-putin {
...
<!-- CUSTOM CODE END -->
			...
			$(window).resize(function(){
				...
				if (width <= 800) {
					if($("#edit_sidebar").length==0 || $("#edit_sidebar").css("display")=="none"){
						$("#WOM_produceTask_produceTask_chPackageEdit_main_div").css("width",800);
						$(".edit-head").css("width",800);
						$(".edit-workflow").css("width",800);
						$("body").css({"overflow-x":"scroll","position":"relative","zIndex":"100"});
					}else{
						$("#WOM_produceTask_produceTask_chPackageEdit_main_div").css("width",650);
					...
					if (YAHOO.env.ua.ie == "6") {
						$("#WOM_produceTask_produceTask_chPackageEdit_main_div").css("width",w1);
						$(".edit-workflow").css("width",w1);
					}else{
						$("#WOM_produceTask_produceTask_chPackageEdit_main_div").css("width","auto");
		...
		<script type="text/javascript">
			WOM.produceTask.produceTask.chPackageEdit.initCount = 0;
			WOM.produceTask.produceTask.chPackageEdit.initSize = function(nTabIndex){
				var panesHeight;
				var thisHeight;
				var h = $(window).height();
			    var w = $(window).width();
				...
				var conHeight = h-$("#WOM_produceTask_produceTask_chPackageEdit_main_div .edit-head").height()-$("#WOM_produceTask_produceTask_chPackageEdit_main_div .edit-tabs").height()<#if pendingId?? || editNew>-$("#WOM_produceTask_produceTask_chPackageEdit_main_div .edit-workflow").height()</#if>;
				$("#WOM_produceTask_produceTask_chPackageEdit_main_div .edit-tabs").length == 0 ? conHeight = conHeight : conHeight = conHeight-28 //再减去28px，28px是由.edit-tabs的margin-top:14px+6px边框+8px的底部边距组成
				panesHeight = conHeight*0.4;  //当表单跟pt共存的时候采用4/6开
				var datagrids = $('body').data('WOM_produceTask_produceTask_chPackageEdit_datagrids');
				var padding_bottom=16;
				$("#WOM_produceTask_produceTask_chPackageEdit_main_div .pd_bottom,#WOM_produceTask_produceTask_chPackageEdit_main_div .edit-tabs").width(w-14*2-2-width_)  //把tab跟tab下面的内容宽度统一调整
				$("#WOM_produceTask_produceTask_chPackageEdit_main_div .edit-panes-s").each(function(index){
					//多页签切换时只计算本页签下的PT高度
					...
					if(datagrids && datagrids.length > 0) {
						if(datagrids[index].length > 0) {
							...
							for(var dg=0;dg<datagrids[index].length;dg++) {
								...
								if(dgwidget) {
									...
									if(WOM.produceTask.produceTask.chPackageEdit.initCount <= 2) {
										setTimeout(function(){WOM.produceTask.produceTask.chPackageEdit.initSize();}, 200);
										WOM.produceTask.produceTask.chPackageEdit.initCount++;
									}/* else {
										WOM.produceTask.produceTask.chPackageEdit.initCount = 0;
									}*/
								}
						...
						if(thisHeight < conHeight){ //当此页签下面的实际内容高度小于分配给它的高度
							...
							$(this).parent().height(conHeight);
							if(($("#WOM_produceTask_produceTask_chPackageEdit_main_div .edit-workflow").length > 0) && ($("#WOM_produceTask_produceTask_chPackageEdit_main_div .edit-tabs").length > 0)){		// 底下有处理结果，并且头部有页签切换，此时底部留白14像素
			...
			$(function(){
				$('#WOM_produceTask_produceTask_chPackageEdit_form').get(0).onkeydown=function(event){
				...
				WOM.produceTask.produceTask.chPackageEdit.buttonBar = new CUI.ButtonBar( { panel: '#top_buttonbar' }  );
				WOM.produceTask.produceTask.chPackageEdit.initSize();
				if(YAHOO.env.ua.ie == 6){
				...
				<#if businessCenterList??&&businessCenterList?size gt 0 >
					...
					$("#edit_side_btn").toggle(function(){
						if(parseInt($("#WOM_produceTask_produceTask_chPackageEdit_main_div").css("width"),10)==650){
							$("#WOM_produceTask_produceTask_chPackageEdit_main_div").css("width","800px");
						...
						//WOM.produceTask.produceTask.chPackageEdit.resizeLayout();
						//WOM.produceTask.produceTask.chPackageEdit.initSize();
						$('body').trigger('resize');
					},function(){
						if(parseInt($("#WOM_produceTask_produceTask_chPackageEdit_main_div").css("width"),10)==800){
							$("#WOM_produceTask_produceTask_chPackageEdit_main_div").css("width","650px");
				...
				$(window).resize(function(){WOM.produceTask.produceTask.chPackageEdit.initSize();});
				/*
				WOM.produceTask.produceTask.chPackageEdit.resizeLayout=function(){
		...
		$(function(){
			<#if editNew>
			WOM.produceTask.produceTask.chPackageEdit.setDepartment();
			<#else>
		...
		WOM.produceTask.produceTask.chPackageEdit.validate = function(){
		...
		WOM.produceTask.produceTask.chPackageEdit.beforeSaveProcess = function(){
			try{eval("savedg1506060049644DataGrid()");}catch(e){}
			try{eval("savedg1506060049547DataGrid()");}catch(e){}

			var extraCol = '<extra-data>';
			$('#WOM_produceTask_produceTask_chPackageEdit_form').trigger('beforeSubmit');
		...
		WOM.produceTask.produceTask.chPackageEdit.processDataGrid = function(){
										<#if false && isIE>
										$('#WOM_produceTask_produceTask_chPackageEdit_form').append(ProduceTaskActive_dg1506060049547Widget._DT.createInputs('dg1506060049547List'));
										</#if>
										<#if false && isIE>
										$('#WOM_produceTask_produceTask_chPackageEdit_form').append(ProduceMaterialSum_dg1506060049644Widget._DT.createInputs('dg1506060049644List'));
										</#if>
		};
		WOM.produceTask.produceTask.chPackageEdit.save = function(){
			<#if !(superEdit!false)>
			...
			if(!WOM.produceTask.produceTask.chPackageEdit.validate()){return;}
			//延迟到延迟提交中处理,解决onchange事件无法触发问题
			//WOM.produceTask.produceTask.chPackageEdit.beforeSaveProcess();

			//WOM.produceTask.produceTask.chPackageEdit.processDataGrid();
			$('#WOM_produceTask_produceTask_chPackageEdit_form').submit();
		}
		
		<#if viewType != "readonly">
		$(window).bind('beforeunload',function(){
		        if(isFormChanged('WOM_produceTask_produceTask_chPackageEdit_form','WOM_produceTask_produceTask_chPackageEdit_datagrids')) {      
		...
		//打印
		WOM.produceTask.produceTask.chPackageEdit.print = function(){
		...
		WOM.produceTask.produceTask.chPackageEdit.saveSetting = function(){
		...
		WOM.produceTask.produceTask.chPackageEdit.printSetting = function(){
			var viewCode = $('input[name="viewCode"]').val();
			var value = "";
			var printId = 0;
			var printVersion = 0;
			if(viewCode!=undefined && viewCode!=null && viewCode!=''){
				...
				WOM.produceTask.produceTask.chPackageEdit.settingDialog = new CUI.Dialog({
					...
					buttons:[
							{	name:"${getText("ec.flow.save")}",
								handler:function(){if(WOM.produceTask.produceTask.chPackageEdit.saveSetting()){this.close();}}
							},
							{	name:"${getText("ec.flow.cancal")}",
								handler:function(){this.close()}
							}]
					})
				WOM.produceTask.produceTask.chPackageEdit.settingDialog.show();
			}
		}
		
		
		
		WOM.produceTask.produceTask.chPackageEdit.reject = function(){
			...
			WOM.produceTask.produceTask.chPackageEdit.submit();
		}
		
		WOM.produceTask.produceTask.chPackageEdit.submit = function(uncheck){
			if(uncheck){
		...
		WOM.produceTask.produceTask.chPackageEdit.recall = function(){
		...
		WOM.produceTask.produceTask.chPackageEdit._callBackInfo = function(res){
		...
		<#if editNew>
		WOM.produceTask.produceTask.chPackageEdit.setDepartment = function(){
		...
		function dataGridBtnImgClick(sUrl,objNameCustomCondition,sTitle,sPTGridID,nRow,sFieldName,oGrid,customCallBack,crossCompany,isObjCustomProp,objCustomPropNames,viewCode){
			...
			if(customCallBack){
				WOM.produceTask.produceTask.chPackageEdit._customCallBack = customCallBack;
			}
			if (isObjCustomProp) {
				WOM.produceTask.produceTask.chPackageEdit._isObjCustomProp_IE = isObjCustomProp;
			} else {
				WOM.produceTask.produceTask.chPackageEdit._isObjCustomProp_IE = false;
			}
			if (objCustomPropNames) {
				WOM.produceTask.produceTask.chPackageEdit._objCustomPropNames_IE = objCustomPropNames;
			} else {
				WOM.produceTask.produceTask.chPackageEdit._objCustomPropNames_IE = '';
			}
			if (viewCode) {
				WOM.produceTask.produceTask.chPackageEdit._refViewCode_IE = viewCode;
			} else {
				WOM.produceTask.produceTask.chPackageEdit._refViewCode_IE = '';
			}
			WOM.produceTask.produceTask.chPackageEdit._selectEvent(objNameCustomCondition,null,sUrl,sTitle,null,null,null,crossCompany,obj);
		}
		
		WOM.produceTask.produceTask.chPackageEdit.initMnemonic_DG_IE = function(oConfig){
			// 助记码也需要区分是否为自定义字段
			WOM.produceTask.produceTask.chPackageEdit._isObjCustomProp_IE = oConfig._isObjCustomProp_IE;
			WOM.produceTask.produceTask.chPackageEdit._objCustomPropNames_IE = oConfig._objCustomPropNames_IE;
			
			var oGrid = oConfig.oGrid;
			// 获取控件PT  object
			var oPTGridEx = oGrid._DT || oGrid;
			// 存储当前操作相关信息
			WOM.produceTask.produceTask.chPackageEdit.gridEventObj = {
				"oGrid" : oGrid,
				"nRow" : oConfig.nRow - 1,
				"sKey":	oConfig.sFieldName
			}
			WOM.produceTask.produceTask.chPackageEdit._sUrl = oConfig.url;
			if(oConfig.customCallBack){
				WOM.produceTask.produceTask.chPackageEdit._customCallBack = oConfig.customCallBack;
			}
			// 自定义的表格对象
		...
		WOM.produceTask.produceTask.chPackageEdit._selectEvent = function(objName,_selectType,url,title,refparam,obj,customCallBack,crossCompanyFlag,gridEventObj,oGrid,isMultiselect,oColumn){

			var callbackName="";
			var condition='';
			var _prefix= '';
			var arr = objName.split('.');
			if(WOM.produceTask.produceTask.chPackageEdit._querycustomFunc(objName.replace(/\./g, '_')) !=null){
				condition=encodeURIComponent(WOM.produceTask.produceTask.chPackageEdit._querycustomFunc(objName.replace(/\./g, '_')));
			}
			if(gridEventObj) {
				WOM.produceTask.produceTask.chPackageEdit.gridEventObj = gridEventObj;
				callbackName = "WOM.produceTask.produceTask.chPackageEdit.getcallBackInfo_DG_IE";
			}else if(obj!=null && obj!=""){
				if(arr.length > 1){
					_prefix = '.'+ arr[0];
				}
				callbackName = isMultiselect ? "WOM.produceTask.produceTask.chPackageEdit.getMultiselectCallBackInfo_DG" : "WOM.produceTask.produceTask.chPackageEdit.getcallBackInfo_DG";
				WOM.produceTask.produceTask.chPackageEdit._currRow = $(obj).closest('tr')[0];
			}else{
				if(arr.length > 2){
					_prefix = '.'+ arr[0] + '.'+ arr[1];
				}
				callbackName ="WOM.produceTask.produceTask.chPackageEdit.getcallBackInfo";
			}

			if(_prefix!=''){
				WOM.produceTask.produceTask.chPackageEdit._prefix = _prefix.substring(1);
			}
			
			WOM.produceTask.produceTask.chPackageEdit._oGrid = oGrid;
			WOM.produceTask.produceTask.chPackageEdit._sUrl = url;
			if (oColumn) {
				if (oColumn.isObjCustomProp) {
					WOM.produceTask.produceTask.chPackageEdit._isObjCustomProp = oColumn.isObjCustomProp;
				} else {
					WOM.produceTask.produceTask.chPackageEdit._isObjCustomProp = false;
				} 
				if (oColumn.objCustomPropNames) {
					WOM.produceTask.produceTask.chPackageEdit._objCustomPropNames = oColumn.objCustomPropNames;
				} else {
					WOM.produceTask.produceTask.chPackageEdit._objCustomPropNames = '';
				}
				if (oColumn.viewCode) {
					WOM.produceTask.produceTask.chPackageEdit._refViewCode = oColumn.viewCode;
				} else {
					WOM.produceTask.produceTask.chPackageEdit._refViewCode = '';
				}
			} else {
				WOM.produceTask.produceTask.chPackageEdit._isObjCustomProp = false;
				WOM.produceTask.produceTask.chPackageEdit._objCustomPropNames = '';
			...
			if (WOM.produceTask.produceTask.chPackageEdit._isObjCustomProp == true && WOM.produceTask.produceTask.chPackageEdit._objCustomPropNames && objName && objName.substring(objName.length - 'MainDisplay'.length) == 'MainDisplay') {
				WOM.produceTask.produceTask.chPackageEdit._prefix = objName.substring(0, objName.length - 'MainDisplay'.length);
			}
			if(customCallBack){
				WOM.produceTask.produceTask.chPackageEdit._customCallBack = customCallBack;
			}
			if(WOM.produceTask.produceTask.chPackageEdit._querycustomFunc(objName.replace(/\./g, '_')) != null) {
				refparam = 'condition=' + encodeURIComponent(WOM.produceTask.produceTask.chPackageEdit._querycustomFunc(objName.replace(/\./g, '_')));
			}
			if(typeof WOM.produceTask.produceTask.chPackageEdit._querycustomFuncN == "function") {
				refparam += WOM.produceTask.produceTask.chPackageEdit._querycustomFuncN();
			}
			...
			WOM.produceTask.produceTask.chPackageEdit._dialog = foundation.common.select({
				pageType : 'other',
				closePage : true,
				condition : condition,
		...
		WOM.produceTask.produceTask.chPackageEdit._groupSelectEvent = function(objName,_selectType,url,title,refparam){
			if(WOM.produceTask.produceTask.chPackageEdit._querycustomFunc(objName.replace(/\./g, '_')) != null) {
				refparam = 'condition=' + encodeURIComponent(WOM.produceTask.produceTask.chPackageEdit._querycustomFunc(objName.replace(/\./g, '_')));
			}
			WOM.produceTask.produceTask.chPackageEdit._dialog = foundation.common.select({
				...
				closePage : true,
				callBackFuncName : 'WOM.produceTask.produceTask.chPackageEdit.getcallBackGroupInfo',
				url : url,
				title : title,
				params : refparam
			});
		}
		WOM.produceTask.produceTask.chPackageEdit._querycustomFunc = function(obj) {
			var str = eval("typeof(WOM.produceTask.produceTask.chPackageEdit.query_"+obj+")!='undefined'") ? eval('WOM.produceTask.produceTask.chPackageEdit.query_'+obj+'()') : null;
			return str;
		};
		WOM.produceTask.produceTask.chPackageEdit.getcallBackGroupInfo = function(obj){
			var ids = "";
			var names = "";
			...
			WOM.produceTask.produceTask.chPackageEdit._dialog.close();
		}
		WOM.produceTask.produceTask.chPackageEdit.getcallBackInfo = function(obj){
		
			obj[0] = foundation.common.getObject('WOM_produceTask_produceTask_chPackageEdit_form',obj[0], WOM.produceTask.produceTask.chPackageEdit._prefix, WOM.produceTask.produceTask.chPackageEdit._sUrl);
			CUI.commonFills('WOM_produceTask_produceTask_chPackageEdit_form',WOM.produceTask.produceTask.chPackageEdit._prefix,obj[0]);
			
			for(pro in obj[0]){
				try{
					var fname = "_callback_" + (WOM.produceTask.produceTask.chPackageEdit._prefix + "." + pro).replace(/\./g, '_')  + "_edit";
			...
			try{
				if(WOM.produceTask.produceTask.chPackageEdit._customCallBack) {
					eval(WOM.produceTask.produceTask.chPackageEdit._customCallBack);
					WOM.produceTask.produceTask.chPackageEdit._customCallBack = null;
				}
		...
		// 控件版PT回调
		WOM.produceTask.produceTask.chPackageEdit.getcallBackInfo_DG_IE = function(obj){
			if(WOM.produceTask.produceTask.chPackageEdit._customBeforeCallBack) {
				var flag = eval(WOM.produceTask.produceTask.chPackageEdit._customBeforeCallBack.split("(")[0] + "(obj)");
				if(flag === false){
					return false;
				}
			}
			var gridEventObj = WOM.produceTask.produceTask.chPackageEdit.gridEventObj;
			var rootKey = gridEventObj.sKey.split('.')[0];
			var jsonObj;
			if ( WOM.produceTask.produceTask.chPackageEdit._isObjCustomProp_IE == true && WOM.produceTask.produceTask.chPackageEdit._objCustomPropNames_IE ) {
				jsonObj = foundation.common.getObjectIE_CP_OBJ(gridEventObj,obj[0],rootKey,WOM.produceTask.produceTask.chPackageEdit._sUrl,WOM.produceTask.produceTask.chPackageEdit._objCustomPropNames_IE);
			} else {
				jsonObj = foundation.common.getObjectIE(gridEventObj,obj[0],rootKey,WOM.produceTask.produceTask.chPackageEdit._sUrl);
			}
			CUI.error_msg_DG_CP_map = {};
			var xmlHead = $(gridEventObj.oGrid._DT.opts.oXMLData).children( ':eq(0)' ).children( ':eq(0)' );
			if (WOM.produceTask.produceTask.chPackageEdit._isObjCustomProp_IE == true && WOM.produceTask.produceTask.chPackageEdit._objCustomPropNames_IE) { // 控件版PT显示自定义字段
				var showName = WOM.produceTask.produceTask.chPackageEdit._objCustomPropNames_IE.split(',')[0]; // 主显示字段名称
				var trueName = WOM.produceTask.produceTask.chPackageEdit._objCustomPropNames_IE.split(',')[1]; // 主键字段名称
			...
			if ( $('#dg_cp_info_' + gridEventObj.oGrid._DT.opts.id).length > 0 ) {
				...
				var id = jsonObj.id;
				var relationMap;
				if (dg_cp_info && id && WOM.produceTask.produceTask.chPackageEdit._refViewCode_IE) {
					$.ajax({
						async   : false,
						type    : 'POST',
						url     : '/foundation/customProp/related.action',
						data    : 'code=' + WOM.produceTask.produceTask.chPackageEdit._refViewCode_IE + '&id=' + id,
		...
		WOM.produceTask.produceTask.chPackageEdit.getcallBackInfo_DG = function(obj){
			if(WOM.produceTask.produceTask.chPackageEdit._customBeforeCallBack) {
				var flag = eval(WOM.produceTask.produceTask.chPackageEdit._customBeforeCallBack.split("(")[0] + "(obj)");
				if(flag === false){
					return false;
			...
			for(var i=0;i<obj.length;i++){
				if(i>0){
					if($(WOM.produceTask.produceTask.chPackageEdit._currRow).next().length==0){
						WOM.produceTask.produceTask.chPackageEdit._oGrid.addNewRow();
					}	
					WOM.produceTask.produceTask.chPackageEdit._currRow = $(WOM.produceTask.produceTask.chPackageEdit._currRow).next();
					$(WOM.produceTask.produceTask.chPackageEdit._currRow).attr('isEdited',true);
				}
				obj[i] = foundation.common.getObject(WOM.produceTask.produceTask.chPackageEdit._currRow,obj[i], WOM.produceTask.produceTask.chPackageEdit._prefix, WOM.produceTask.produceTask.chPackageEdit._sUrl);
				if (WOM.produceTask.produceTask.chPackageEdit._isObjCustomProp == true && WOM.produceTask.produceTask.chPackageEdit._objCustomPropNames) {
					eval("CUI.commonFills_DG_CP_OBJ(WOM.produceTask.produceTask.chPackageEdit._currRow,WOM.produceTask.produceTask.chPackageEdit._prefix,obj[i],WOM.produceTask.produceTask.chPackageEdit._oGrid,WOM.produceTask.produceTask.chPackageEdit._objCustomPropNames)");
				} else {
					eval("CUI.commonFills_DG(WOM.produceTask.produceTask.chPackageEdit._currRow,WOM.produceTask.produceTask.chPackageEdit._prefix,obj[i],WOM.produceTask.produceTask.chPackageEdit._oGrid)");
				}
				
				// 自定义字段参照回填
				if ( $('#dg_cp_info_' + WOM.produceTask.produceTask.chPackageEdit._oGrid.dataTableId).length > 0 ) {
					var dg_cp_info = $('#dg_cp_info_' + WOM.produceTask.produceTask.chPackageEdit._oGrid.dataTableId).val();
					var id = obj[i].id;
					var relationMap;
					if (dg_cp_info && id && WOM.produceTask.produceTask.chPackageEdit._refViewCode) {
						$.ajax({
							async   : false,
							type    : 'POST',
							url     : '/foundation/customProp/related.action',
							data    : 'code=' + WOM.produceTask.produceTask.chPackageEdit._refViewCode + '&id=' + id,
							success : function(res){
								if (res.dealSuccessFlag && res.relationMap) {
									relationMap = res.relationMap;
								}
						...
						if (relationMap) {
							...
							for (var n in infoArr) {
								...
								var val = relationMap[key];
								if (val) {
									name = WOM.produceTask.produceTask.chPackageEdit._oGrid.configs.hidekeyPrefix + name;
									objs[name] = val;
									if (propCode) {
										$.ajax({
											async   : false,
							...
							// console.log(objs);
							if (objs) {
								CUI.commonFills_DG_CP(WOM.produceTask.produceTask.chPackageEdit._currRow, objs, WOM.produceTask.produceTask.chPackageEdit._oGrid);
							}
						}
					}
				}
				...
				try{
					...
					for ( var item in  CUI.error_msg_DG_CP_map ){
						for ( var n in  CUI.error_msg_DG_CP_map[item] ){
							errorMsg += ( '<b>' + WOM.produceTask.produceTask.chPackageEdit._oGrid.getLabel(item) +  '</b>第<b>' + ( parseInt( n, 10 ) + 1)  + '</b>行回填失败！原因:系统编码值不匹配！<br/>' );
						}
					}
					if( errorMsg ){
						workbenchErrorBarWidget.showMessage( errorMsg );
		...
		WOM.produceTask.produceTask.chPackageEdit.getMultiselectCallBackInfo_DG = function(obj){
			for(var i=0;i<obj.length;i++){
				CUI.commonFillsMultiselect_DG(WOM.produceTask.produceTask.chPackageEdit._oGrid, WOM.produceTask.produceTask.chPackageEdit._currRow, WOM.produceTask.produceTask.chPackageEdit._key, WOM.produceTask.produceTask.chPackageEdit._displayFieldName, obj[i])
			}
			try{
				if(WOM.produceTask.produceTask.chPackageEdit._customCallBack) {
					eval(WOM.produceTask.produceTask.chPackageEdit._customCallBack);
		...
		WOM.produceTask.produceTask.chPackageEdit.generateInput = function(prefix, obj) {
			CUI.each(obj, function(key,value){
				if(value!=null && key!='rowHtmlObj' && key!='cellHtmlObj'){
					var name = prefix + '.' + key;
					if(typeof value == 'object') {
						WOM.produceTask.produceTask.chPackageEdit.generateInput(name, value);
					} else {
						if(value!=null&&value!='null'&&value!=undefined&&value!='') {
							CUI('input[name="' + name + '"]').remove();
							CUI('<input type="hidden" name="'+name+'" value="'+value+'">').appendTo(CUI('#WOM_produceTask_produceTask_chPackageEdit_form'));
						}
					}
				}
			});
		...
		$(function(){
			WOM.produceTask.produceTask.chPackageEdit.onloadForProduct();
	...
	if(batchProdTaskID != '' ){
		...
		WOM.produceTask.produceTask.chPackageEdit.beforeSubmitMethodSettingInPage = function(){
			WOM.produceTask.produceTask.chPackageEdit.onsaveForProduct();
			//新包装编码
var newproId=$("[name='produceTask.productId.id']").val();
//原包装编码
var oldproId=$("[name='produceTask.bulkProduct.id']").val();
if(newproId!="" && oldproId!="" && newproId==oldproId){
	//新包装编码和原包装编码不能相同，请重新选择！
	workbenchErrorBarWidget.showMessage("${getText('WOM.chPackageEdit.newolderrorrandon123456')}","f");
	return false;
}
		};
		WOM.produceTask.produceTask.chPackageEdit.beforeSubmitMethod = function(){
			...
			var customOnsaveResult =  WOM.produceTask.produceTask.chPackageEdit.beforeSubmitMethodSettingInPage();
		...
		<script type="text/javascript">
		WOM.produceTask.produceTask.chPackageEdit.showBusinessList = function(relatingModelCode,mainEntityId,businessCenterCode,url,showType){
			...
			if(CUI(id).html() == null || $.trim(CUI(id).html()) == ""){
				CUI(id).load(url);
				setTimeout(function(){
					CUI("#WOM_produceTask_produceTask_chPackageEdit_main_div").hide();
				},100);
			}else{
			    CUI(id).load(url);
				setTimeout(function(){
		...
		WOM.produceTask.produceTask.chPackageEdit.showThis = function(){
			if(!CUI("#WOM_produceTask_produceTask_chPackageEdit_main_div").is(':visible')) {
				CUI("#WOM_produceTask_produceTask_chPackageEdit_main_div").show();
		...
		WOM.produceTask.produceTask.chPackageEdit.showAudit=function(){
			<#if !id?? || editNew>
			CUI.Dialog.alert("${getText("foundation.base.audit.nolog")}")
			<#else>
			WOM.produceTask.produceTask.chPackageEdit.auditDialog = new CUI.Dialog({
				title : "${getText("foundation.base.audit")}",
				iframe : "WOM_produceTask_produceTask_chPackageEdit_auditInfo",
				modal:true,
			...
			WOM.produceTask.produceTask.chPackageEdit.auditDialog.show();
			</#if>
		}
		
		
		WOM.produceTask.produceTask.chPackageEdit.showInfoDialog=function(mode){
			
			WOM.produceTask.produceTask.chPackageEdit.infoDialog = new CUI.Dialog({
				title: "${getText("ec.view.info.view")}",
				elementId: "WOM_produceTask_produceTask_chPackageEdit_dealInfo",
				modal:true,
				height:500,
				width: 950,//适应国际化版
				buttons:[
			...
			WOM.produceTask.produceTask.chPackageEdit.infoDialog.show();
		...
		WOM.produceTask.produceTask.chPackageEdit.showFileUpload=function(){
		...
		WOM.produceTask.produceTask.chPackageEdit.showDealInfo=function(){
		...
		WOM.produceTask.produceTask.chPackageEdit.showFlowInfo=function(){
		...
		WOM.produceTask.produceTask.chPackageEdit.supervision=function(){
			WOM.produceTask.produceTask.chPackageEdit.modifyOwnerStaffDialog = new CUI.Dialog({
				...
				WOM.produceTask.produceTask.chPackageEdit.modifyOwnerStaffDialog.show();
		}
...
function _callback_produceTask(obj){
		...
		var dlength=$("#ProduceMaterialSum_dg1506060049644_tbody").length;
		if(dlength==0){
			//清空用料汇总表体记录
			var headId=$("#id").val(); 
			if(headId!=""){
			...
			ProduceMaterialSum_dg1506060049644Widget._DT.delAllRows();
		}
		formulaChange1();
		...
		$.ajax({
			...
			success : function(res) {
				if(res.dealSuccessFlag==true){
				  ...
				  $("[name='produceTask.formularId.edition']").val(res.edition);//配方版本							  
				}
			}
		});
...
function clearBatchNum(){
		var nRow=ProduceTaskActive_dg1506060049547Widget.getSelectedRow();
			//批号清空
		ProduceTaskActive_dg1506060049547Widget.setCellValue(nRow,"batchNumObj.id","");
		ProduceTaskActive_dg1506060049547Widget.setCellValue(nRow,"batchNumObj.batchText","");
	}



		/* CUSTOM CODE START(view-EDIT-WOM_7.5.0.0_produceTask_chPackageEdit,js,WOM_7.5.0.0_produceTask_ProduceTask,WOM_7.5.0.0) */
// 自定义代码
 var isProBatch="";
	...
	function produceTask_formularId_code_delete(){
        ...
        ProduceTaskActive_dg1506060049547Widget._DT._resizeHeight = true;
        ProduceTaskActive_dg1506060049547Widget._DT._initDomElements();
      		ProduceTaskActive_dg1506060049547Widget._DT.configs.checkEditCondition = function( key, nRow){
			if(key=="planNum"){//计划用量
	...
	function produceTask_productId_productCode_delete(){
	   ...
	   CUI.restoreMneTips($("#WOM_produceTask_produceTask_chPackageEdit_form #produceTask_productId_productCode"),'produceTask_productId_productCode_mneTipLabel','WOM_produceTask_produceTask_makeTaskEdit_form');
	...
	//制造指令单产品过滤物料批号
	WOM.produceTask.produceTask.chPackageEdit.query_dg1506060049547batchNumObj_batchText= function(){
		var product=ProduceTaskActive_dg1506060049547Widget.getCellValue(ProduceTaskActive_dg1506060049547Widget.getSelectedRow(),"productId.id");
		return "goodID="+product;
	}
    
    
    //原包装编码 清除重写
    function produceTask_bulkProduct_productCode_delete(){
	   produceTask_bulkProduct_productCode_prefix = '',
	   //$("#WOM_produceTask_produceTask_chPackageEdit_form #produceTask_bulkProduct_productCode").val('');
	   //var arr="produceTask.bulkProduct.productCode".split('.');
	   //for(var i=0;i<arr.length-1;i++) {
	   //	if(i!=0) {
	   //		produceTask_bulkProduct_productCode_prefix += '.';
	   //	}
	   //	produceTask_bulkProduct_productCode_prefix += arr[i];
	   //}
	   //CUI('#WOM_produceTask_produceTask_chPackageEdit_form input[name="'+produceTask_bulkProduct_productCode_prefix + '.id"]').val('');
	   CUI.clearInput("produceTask.bulkProduct.productCode");
	   CUI("#WOM_produceTask_produceTask_chPackageEdit_form #produceTask_bulkProduct_productCode").attr('valuebak','');
	   CUI('#WOM_produceTask_produceTask_chPackageEdit_form input[name="'+produceTask_bulkProduct_productCode_prefix + '.id"]').attr('valuebak','');
	   CUI.restoreMneTips($("#WOM_produceTask_produceTask_chPackageEdit_form #produceTask_bulkProduct_productCode"),'produceTask_bulkProduct_productCode_mneTipLabel','WOM_produceTask_produceTask_chPackageEdit_form');
...
//配方放大镜重写
	function _callback_produceTask_formularId_code(obj) {
		...
		CUI.clearMneTips('produceTask_formularId_code_mneTipLabel','WOM_produceTask_produceTask_chPackageEdit_form');
		if(ProduceTaskActive_dg1506060049547Widget.getRowLength()!=0 &&  $("[name='produceTask.formularId.id']").val()!=obj[0].id){
			CUI.Dialog.confirm(  '更改配方将清空表体数据，是否继续？',  // 提示消息
				function(){
					var arr = 'produceTask.formularId.code'.split('.');
					obj[0] = foundation.common.getObject('WOM_produceTask_produceTask_chPackageEdit_form',obj[0], arr[0]+'.'+arr[1], '/RM/formula/formula/formulachPackRef.action');
					if(null != obj[0].id && obj[0].id != ""){
						CUI.commonFills('WOM_produceTask_produceTask_chPackageEdit_form',(arr.length == 2) ? arr[0] : arr[0]+'.'+arr[1],obj[0]);
						//自定义字段回填
						CUI.commonFills_CP(obj[0].id,'/RM/formula/formula/formulachPackRef.action');
					} else {
						CUI.clearInput('produceTask.formularId.code');
					}
		...
		}else if(ProduceTaskActive_dg1506060049547Widget.getRowLength()==0 &&  $("[name='produceTask.formularId.id']").val()!=obj[0].id){
			var arr = 'produceTask.formularId.code'.split('.');
		obj[0] = foundation.common.getObject('WOM_produceTask_produceTask_chPackageEdit_form',obj[0], arr[0]+'.'+arr[1], '/RM/formula/formula/formulachPackRef.action');
		if(null != obj[0].id && obj[0].id != ""){
			CUI.commonFills('WOM_produceTask_produceTask_chPackageEdit_form',(arr.length == 2) ? arr[0] : arr[0]+'.'+arr[1],obj[0]);
...
/* CUSTOM CODE END */
		WOM.produceTask.produceTask.chPackageEdit.onloadForProduct = function(){
		/* CUSTOM CODE START(view-EDIT-WOM_7.5.0.0_produceTask_chPackageEdit,onloadForProduct,WOM_7.5.0.0_produceTask_ProduceTask,WOM_7.5.0.0) */
// 自定义代码

/* CUSTOM CODE END */
		}

		WOM.produceTask.produceTask.chPackageEdit.onsaveForProduct = function(){
		/* CUSTOM CODE START(view-EDIT-WOM_7.5.0.0_produceTask_chPackageEdit,onsaveForProduct,WOM_7.5.0.0_produceTask_ProduceTask,WOM_7.5.0.0) */
// 自定义代码
...
/* CUSTOM CODE END */		
		...
		<div class="col-sub">
			...
			<div class="edit-sidebar-inner" style='height:1000px;'>
				<div class="sidebar-top"><a href="#"  onclick="WOM.produceTask.produceTask.chPackageEdit.showThis()">${getText("ec.view.tableInfo")}</a></div>
					...
					<ul>
						<#list businessCenterList as l>
						 <li>
							...
							<#else>
								<a href="#"  onclick="WOM.produceTask.produceTask.chPackageEdit.showBusinessList('${l.relatingModel.code.replace('.','')}',${(produceTask.id)!},'${l.code}','${l.assview.url}?${getPowerCode(l.assview.code+'_self')}','${l.assview.showType}')" title="${getText(l.showName)}(${(l.count)!})">${getText(l.showName)}(${(l.count)!})</a>
							</#if>
						</li>
					    </#list>
					</ul>
