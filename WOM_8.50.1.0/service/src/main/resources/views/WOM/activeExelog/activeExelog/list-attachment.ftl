...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=WOM_7.5.0.0_activeExelog";
	openExportFrame(url);
}
...
<div id="WOM_activeExelog_activeExelog_activeExelogList_attachment">	
