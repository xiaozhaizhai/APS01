...
<script type="text/javascript">
	...
	function download(){
		//var url = "/WOM/materialReject/rejectReason/downLoad.action?viewCode=WOM_7.5.0.0_materialReject_rejectReasonList&orgName=WOM_7.5.0.0_materialReject_rejectReasonList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/WOM/materialReject/rejectReason/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
