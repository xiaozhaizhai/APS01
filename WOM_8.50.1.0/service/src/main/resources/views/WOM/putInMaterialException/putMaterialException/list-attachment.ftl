...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=WOM_7.5.0.0_putInMaterialException";
	openExportFrame(url);
}
...
<div id="WOM_putInMaterialException_putMaterialException_putinExceptionList_attachment">	
