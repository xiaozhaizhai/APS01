...
<script type="text/javascript">
	...
	function download(){
		//var url = "/WOM/putInMaterialException/putMaterialException/downLoad.action?viewCode=WOM_7.5.0.0_putInMaterialException_putinExceptionList&orgName=WOM_7.5.0.0_putInMaterialException_putinExceptionList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/WOM/putInMaterialException/putMaterialException/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
