...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
	...
	<Style ss:ID="WOM_7.5.0.0_inventoryRecords_InventoryRecord_inventoryDate">
  			<NumberFormat ss:Format="yyyy-mm-dd"/>
  			<Protection/>
	</Style>
	<Style ss:ID="WOM_7.5.0.0_inventoryRecords_InventoryRecord_inFlag">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="WOM_7.5.0.0_inventoryRecords_InventoryRecord_outFlag">
  			<NumberFormat/>
  			<Protection/>
	</Style>
...
<Worksheet ss:Name="sheet1">
	<Table ss:ExpandedColumnCount="256" ss:ExpandedRowCount="3" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="16.5">
			<Column ss:Index="1" ss:Width="100"  ss:StyleID="WOM_7.5.0.0_inventoryRecords_InventoryRecord_inventoryDate"/>
			<Column ss:Index="2" ss:Width="100"  ss:StyleID="WOM_7.5.0.0_inventoryRecords_InventoryRecord_inFlag"/>
			<Column ss:Index="3" ss:Width="100"  ss:StyleID="WOM_7.5.0.0_inventoryRecords_InventoryRecord_outFlag"/>
	<#assign secondCount=4/>
	<#if customStyleCodes??>
		...
		<Row ss:AutoFitHeight="0">
						<Cell >
							<Data ss:Type="String">盘库日期</Data>
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										WOM_7.5.0.0_inventoryRecords_InventoryRecord_inventoryDate
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							<Data ss:Type="String">入库是否成功</Data>
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										WOM_7.5.0.0_inventoryRecords_InventoryRecord_inFlag
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							<Data ss:Type="String">出库是否成功</Data>
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										WOM_7.5.0.0_inventoryRecords_InventoryRecord_outFlag
									 </ss:Data>
							</Comment>
						</Cell>
