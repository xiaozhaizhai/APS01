...
<script type="text/javascript">
	...
	function download(){
		//var url = "/WOM/inventoryRecords/inventoryRecord/downLoad.action?viewCode=WOM_7.5.0.0_inventoryRecords_inventoryList&orgName=WOM_7.5.0.0_inventoryRecords_inventoryList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/WOM/inventoryRecords/inventoryRecord/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
