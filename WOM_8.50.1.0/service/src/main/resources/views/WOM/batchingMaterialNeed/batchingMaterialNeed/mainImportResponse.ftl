...
<script type="text/javascript">
	...
	function download(){
		//var url = "/WOM/batchingMaterialNeed/batchingMaterialNeed/downLoad.action?viewCode=WOM_7.5.0.0_batchingMaterialNeed_batchNeedList&orgName=WOM_7.5.0.0_batchingMaterialNeed_batchNeedList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/WOM/batchingMaterialNeed/batchingMaterialNeed/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
