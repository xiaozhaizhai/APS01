...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=WOM_7.5.0.0_batchingMaterialNeed";
	openExportFrame(url);
}
...
<div id="WOM_batchingMaterialNeed_batchingMaterialNeed_batchNeedList_attachment">	
