...
<script type="text/javascript">
	...
	function download(){
		//var url = "/WOM/batchTimeLiner/batchTrace/downLoad.action?viewCode=WOM_7.5.0.0_batchTimeLiner_batchTraceList&orgName=WOM_7.5.0.0_batchTimeLiner_batchTraceList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/WOM/batchTimeLiner/batchTrace/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
