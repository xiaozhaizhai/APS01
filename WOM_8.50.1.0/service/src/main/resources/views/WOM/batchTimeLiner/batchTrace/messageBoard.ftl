<!-- WOM_7.5.0.0/batchTimeLiner/messageBoard -->
...
<#-- 命名空间 -->
<#assign editPageNs = "WOM.batchTimeLiner.batchTrace.messageBoard">
<#-- 模型名称-->
<#assign modelName = "batchTrace">
<#-- 视图编码-->
<#assign viewCode = "WOM_7.5.0.0_batchTimeLiner_messageBoard">
<#-- 实体编码-->
<#assign entity_code = "WOM_7.5.0.0_batchTimeLiner">
<#-- 视图名称-->
<#assign viewName = "messageBoard">
<#-- datagrid编码-->
<#assign datagridCode = "WOM_batchTimeLiner_batchTrace_messageBoard_datagrids">
<#-- 首字母大写的模型名称-->
...
<#-- formid -->
<#assign editFormId = "WOM_batchTimeLiner_batchTrace_messageBoard_form">
<#-- 待办状态 -->
