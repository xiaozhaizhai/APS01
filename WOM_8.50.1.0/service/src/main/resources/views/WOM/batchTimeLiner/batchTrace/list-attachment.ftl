...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=WOM_7.5.0.0_batchTimeLiner";
	openExportFrame(url);
}
...
<div id="WOM_batchTimeLiner_batchTrace_batchTraceList_attachment">	
