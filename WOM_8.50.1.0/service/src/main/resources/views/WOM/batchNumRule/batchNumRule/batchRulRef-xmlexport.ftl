...
<#assign viewCode = 'WOM_7.5.0.0_batchNumRule_BatchNumRule' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490409027018')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490409049075')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'ruleType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1509601492783')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isAccountPeriod' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1508132389761')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'menu' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490409085465')}</Data></Cell>
											</#if>
									...
									<#if item?length gt 0>
												...
												<#if item == 'ruleType.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.ruleType.value)!}')}</Data>
												...
												<#if item == 'isAccountPeriod' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.isAccountPeriod?? && data.isAccountPeriod>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'menu' || item == '*'>
													<Cell>
														...
														<#if data.menu??><Data ss:Type="String"><![CDATA[${(data.menu)!}]]></Data></#if>
