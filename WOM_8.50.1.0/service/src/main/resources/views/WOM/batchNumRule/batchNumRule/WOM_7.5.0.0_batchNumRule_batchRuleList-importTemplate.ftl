...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
	...
	<Style ss:ID="WOM_7.5.0.0_batchNumRule_BatchNumRule_code">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="WOM_7.5.0.0_batchNumRule_BatchNumRule_name">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="WOM_7.5.0.0_batchNumRule_BatchNumRule_ruleType">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="WOM_7.5.0.0_batchNumRule_BatchNumRule_isAccountPeriod">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="WOM_7.5.0.0_batchNumRule_BatchNumRule_menu">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="WOM_7.5.0.0_batchNumRule_BatchNumRule_ruleDetail">
  			<NumberFormat/>
  			<Protection/>
	</Style>
...
<Worksheet ss:Name="sheet1">
	<Table ss:ExpandedColumnCount="256" ss:ExpandedRowCount="3" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="16.5">
			<Column ss:Index="1" ss:Width="100"  ss:StyleID="WOM_7.5.0.0_batchNumRule_BatchNumRule_code"/>
			<Column ss:Index="2" ss:Width="100"  ss:StyleID="WOM_7.5.0.0_batchNumRule_BatchNumRule_name"/>
			<Column ss:Index="3" ss:Width="100"  ss:StyleID="WOM_7.5.0.0_batchNumRule_BatchNumRule_ruleType"/>
			<Column ss:Index="4" ss:Width="100"  ss:StyleID="WOM_7.5.0.0_batchNumRule_BatchNumRule_isAccountPeriod"/>
			<Column ss:Index="5" ss:Width="100"  ss:StyleID="WOM_7.5.0.0_batchNumRule_BatchNumRule_menu"/>
			<Column ss:Index="6" ss:Width="100"  ss:StyleID="WOM_7.5.0.0_batchNumRule_BatchNumRule_ruleDetail"/>
						...
						<Cell >
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										WOM_7.5.0.0_batchNumRule_BatchNumRule_code
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										WOM_7.5.0.0_batchNumRule_BatchNumRule_name
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							<Data ss:Type="String">规则类型</Data>
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										WOM_7.5.0.0_batchNumRule_BatchNumRule_ruleType
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							<Data ss:Type="String">会计期</Data>
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										WOM_7.5.0.0_batchNumRule_BatchNumRule_isAccountPeriod
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										WOM_7.5.0.0_batchNumRule_BatchNumRule_menu
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							<Data ss:Type="String">规则</Data>
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										WOM_7.5.0.0_batchNumRule_BatchNumRule_ruleDetail
									 </ss:Data>
							</Comment>
						</Cell>
