...
<#assign viewCode = 'WOM_7.5.0.0_batchProduceTask_BatchProduceTask' />
<#assign propertyCode = '' />
								...
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'taskType.value' || item == '*'>
			 						        ...
			 						        <#assign customGeneratedFlag=false />
												<#if item == 'taskType.value' && !customGeneratedFlag >
												</#if>
											<#if item == 'remark' || item == '*'>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'staffID.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1495090009466')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'makeTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1495090040714')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1503904068848')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
												<#if item == 'taskType.value' && !customGeneratedFlag >
												</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'remark' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1495090125387')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												...
												<#if item == 'makeTime' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.makeTime??><Data ss:Type="DateTime">${(data.makeTime)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
