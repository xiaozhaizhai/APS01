...
<GridData DefaultNodeExpanded="false"   dgName="dg1496366180645" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<productId.productCode
						style="font-color:0303B3"
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchProdTaskPart_dg1496366180645Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchProdTaskPart_dg1496366180645Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/product/product/refProductLayout.action','dg1496366180645productId.productCode','${getText("MESBasic.viewtitle.randon1450085069587")}',sPTGridID,nRow,sFieldName,BatchProdTaskPart_dg1496366180645Widget,null,false,false,'','MESBasic_1_product_refProductLayout')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="BatchProdTaskPart_dg1496366180645Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<factoryId.name
						style="font-color:0303B3"
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchProdTaskPart_dg1496366180645Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchProdTaskPart_dg1496366180645Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/factoryModel/factoryModel/factroyRef1.action','dg1496366180645factoryId.name','${getText("MESBasic.viewtitle.radion1419491307826")}',sPTGridID,nRow,sFieldName,BatchProdTaskPart_dg1496366180645Widget,null,false,false,'','MESBasic_1_factoryModel_factroyRef1')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="BatchProdTaskPart_dg1496366180645Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<formularId.code
						style="font-color:0303B3"
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchProdTaskPart_dg1496366180645Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchProdTaskPart_dg1496366180645Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/RM/formula/formula/formulaRef.action','dg1496366180645formularId.code','${getText("RM.viewtitle.randon1488246963795")}',sPTGridID,nRow,sFieldName,BatchProdTaskPart_dg1496366180645Widget,null,false,false,'','RM_7.5.0.0_formula_formulaRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="BatchProdTaskPart_dg1496366180645Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<bulkProduct.productCode
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchProdTaskPart_dg1496366180645Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchProdTaskPart_dg1496366180645Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/product/product/refProductLayout.action','dg1496366180645bulkProduct.productCode','${getText("MESBasic.viewtitle.randon1450085069587")}',sPTGridID,nRow,sFieldName,BatchProdTaskPart_dg1496366180645Widget,null,false,false,'','MESBasic_1_product_refProductLayout')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="BatchProdTaskPart_dg1496366180645Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<bulkBatchNum.batchText
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(BatchProdTaskPart_dg1496366180645Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(BatchProdTaskPart_dg1496366180645Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/WOM/standingcropRef/standingcropRef/batchNumOneRef.action','dg1496366180645bulkBatchNum.batchText','${getText("WOM.viewtitle.randon1495109507430")}',sPTGridID,nRow,sFieldName,BatchProdTaskPart_dg1496366180645Widget,null,false,false,'','WOM_7.5.0.0_standingcropRef_batchNumOneRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="BatchProdTaskPart_dg1496366180645Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
					...
					sort="true"  onPropertyChange="BatchProdTaskPart_dg1496366180645Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
						...
						hideButtonsOnReadOnly="true"
									  onBlur="document.body.click()" 
									   buttonImg="Calendar" onClick="initCalender(BatchProdTaskPart_dg1496366180645Widget,'BatchProdTaskPart_dg1496366180645Widget',nRow,sFieldName,'datetime')" 
									   onBtnClick="showCalender(BatchProdTaskPart_dg1496366180645Widget,'BatchProdTaskPart_dg1496366180645Widget',nRow,sFieldName,'datetime')" 
				...
				<#list customPropViewMappings as cpvm>
					...
					<#if cpvm.property.type == 'OBJECT'>
						...
						<#if cpvm.refView??>
							...
							onFocus="CUI.toggleClearBtn_DG_IE(BatchProdTaskPart_dg1496366180645Widget,nRow,sFieldName)"
							onBtnClick="CUI.clearCellValue_DG_IE(BatchProdTaskPart_dg1496366180645Widget,nRow,sFieldName,true)"
							subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('${viewUrl!}','dg1496366180645${cpvm.propertyLayRec}','${getText("${viewTitle}")}',sPTGridID,nRow,'${cpvm.propertyLayRec}',BatchProdTaskPart_dg1496366180645Widget,null,false,true,'${mainDisplayName},${pkName}','${viewCode}')"
							hideEditOnReadOnly="true"
						</#if>
					</#if>
						sort="true"
						onPropertyChange="BatchProdTaskPart_dg1496366180645Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
					...
					<#elseif cpvm.property.type == 'DATETIME'>
						...
						onClick="initCalender(BatchProdTaskPart_dg1496366180645Widget,'BatchProdTaskPart_dg1496366180645Widget',nRow,sFieldName,<#if cpvm.format == 'YMD_H'>'dateTimeHour'<#elseif cpvm.format == 'YMD_HM'>'dateTimeMin'<#else>'datetime'</#if>)"
						onBtnClick="showCalender(BatchProdTaskPart_dg1496366180645Widget,'BatchProdTaskPart_dg1496366180645Widget',nRow,sFieldName,<#if cpvm.format == 'YMD_H'>'dateTimeHour'<#elseif cpvm.format == 'YMD_HM'>'dateTimeMin'<#else>'datetime'</#if>)"
						control="Text"
