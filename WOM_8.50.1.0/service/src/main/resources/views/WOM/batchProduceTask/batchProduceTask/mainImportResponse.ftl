...
<script type="text/javascript">
	...
	function download(){
		//var url = "/WOM/batchProduceTask/batchProduceTask/downLoad.action?viewCode=WOM_7.5.0.0_batchProduceTask_batchTaskList&orgName=WOM_7.5.0.0_batchProduceTask_batchTaskList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/WOM/batchProduceTask/batchProduceTask/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
