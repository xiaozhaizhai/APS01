...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=WOM_7.5.0.0_batchProduceTask";
	openExportFrame(url);
}
...
<div id="WOM_batchProduceTask_batchProduceTask_batchTaskList_attachment">	
