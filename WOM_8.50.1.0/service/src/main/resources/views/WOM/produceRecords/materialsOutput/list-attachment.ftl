...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=WOM_7.5.0.0_produceRecords";
	openExportFrame(url);
}
...
<div id="WOM_produceRecords_materialsOutput_outputList_attachment">	
