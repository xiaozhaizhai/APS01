...
<script type="text/javascript">
	...
	function download(){
		//var url = "/WOM/produceRecords/materialsOutput/downLoad.action?viewCode=WOM_7.5.0.0_produceRecords_outputList&orgName=WOM_7.5.0.0_produceRecords_outputList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/WOM/produceRecords/materialsOutput/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
