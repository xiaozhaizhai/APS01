...
<#assign viewCode = 'WOM_7.5.0.0_standingcropRef_StandingcropRef' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		<Style ss:ID="availiQuantity">
	  			<NumberFormat ss:Format="0.00"/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="batchText">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="frozenQuantity">
	  			<NumberFormat ss:Format="0.00"/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'frozenQuantity' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'availiQuantity' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchText' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490064501469')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'good.productCode' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'onhand' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490064713692')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'frozenQuantity' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490064544582')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'availiQuantity' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490064478475')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
							...
							<Row ss:AutoFitHeight="0">
								<#list exportFieldList as item>
									<#if item?length gt 0>
												<#if item == 'batchText' || item == '*'>
													<Cell>
													<#if checkFieldPermission('batchText','WOM_7.5.0.0_standingcropRef_StandingcropRef','WOM_7.5.0.0_standingcropRef_StandingcropRef_batchText') != 0>
														<#if data.batchText??><Data ss:Type="String"><![CDATA[${(data.batchText)!}]]></Data></#if>
													</#if>
													</Cell>
												</#if>
												<#if item == 'good.productCode' || item == '*'>
													<Cell>
													<#if checkFieldPermission('good.productCode','WOM_7.5.0.0_standingcropRef_StandingcropRef','WOM_7.5.0.0_standingcropRef_StandingcropRef_good||MESBasic_1_product_Product_productCode') != 0>
														<#if data.good.productCode??><Data ss:Type="String"><![CDATA[${(data.good.productCode)!}]]></Data></#if>
													</#if>
													</Cell>
												</#if>
												<#if item == 'good.productName' || item == '*'>
													<Cell>
													<#if checkFieldPermission('good.productName','WOM_7.5.0.0_standingcropRef_StandingcropRef','WOM_7.5.0.0_standingcropRef_StandingcropRef_good||MESBasic_1_product_Product_productName') != 0>
														<#if data.good.productName??><Data ss:Type="String"><![CDATA[${(data.good.productName)!}]]></Data></#if>
													</#if>
													</Cell>
												</#if>
												<#if item == 'wareID.wareCode' || item == '*'>
													<Cell>
													<#if checkFieldPermission('wareID.wareCode','WOM_7.5.0.0_standingcropRef_StandingcropRef','WOM_7.5.0.0_standingcropRef_StandingcropRef_wareID||MESBasic_1_wareMan_Ware_wareCode') != 0>
												...
												<#if item == 'wareID.wareName' || item == '*'>
													<Cell>
													<#if checkFieldPermission('wareID.wareName','WOM_7.5.0.0_standingcropRef_StandingcropRef','WOM_7.5.0.0_standingcropRef_StandingcropRef_wareID||MESBasic_1_wareMan_Ware_wareName') != 0>
												...
												<#if item == 'placeSet.placeSetCode' || item == '*'>
													<Cell>
													<#if checkFieldPermission('placeSet.placeSetCode','WOM_7.5.0.0_standingcropRef_StandingcropRef','WOM_7.5.0.0_standingcropRef_StandingcropRef_placeSet||MESBasic_1_storeSet_StoreSet_placeSetCode') != 0>
														<#if data.placeSet.placeSetCode??><Data ss:Type="String"><![CDATA[${(data.placeSet.placeSetCode)!}]]></Data></#if>
													</#if>
													</Cell>
												</#if>
												<#if item == 'placeSet.placeSetName' || item == '*'>
													<Cell>
													<#if checkFieldPermission('placeSet.placeSetName','WOM_7.5.0.0_standingcropRef_StandingcropRef','WOM_7.5.0.0_standingcropRef_StandingcropRef_placeSet||MESBasic_1_storeSet_StoreSet_placeSetName') != 0>
														<#if data.placeSet.placeSetName??><Data ss:Type="String"><![CDATA[${(data.placeSet.placeSetName)!}]]></Data></#if>
													</#if>
													</Cell>
												</#if>
												<#if item == 'onhand' || item == '*'>
													<Cell>
													<#if checkFieldPermission('onhand','WOM_7.5.0.0_standingcropRef_StandingcropRef','WOM_7.5.0.0_standingcropRef_StandingcropRef_onhand') != 0>
														<#if (data.onhand)?has_content><Data ss:Type="Number">#{(data.onhand)!; m6M6}</Data></#if>
													</#if>
													</Cell>
												</#if>
												<#if item == 'frozenQuantity' || item == '*'>
													<Cell>
													<#if checkFieldPermission('frozenQuantity','WOM_7.5.0.0_standingcropRef_StandingcropRef','WOM_7.5.0.0_standingcropRef_StandingcropRef_frozenQuantity') != 0>
														<#if (data.frozenQuantity)?has_content><Data ss:Type="Number">#{(data.frozenQuantity)!; m6M6}</Data></#if>
													</#if>
													</Cell>
												</#if>
												<#if item == 'availiQuantity' || item == '*'>
													<Cell>
													<#if checkFieldPermission('availiQuantity','WOM_7.5.0.0_standingcropRef_StandingcropRef','WOM_7.5.0.0_standingcropRef_StandingcropRef_availiQuantity') != 0>
														<#if (data.availiQuantity)?has_content><Data ss:Type="Number">#{(data.availiQuantity)!; m6M6}</Data></#if>
													</#if>
													</Cell>
												</#if>
								...
								<#if item??>
									<#if item.name?index_of(".")!=-1>
											...
											<Cell  ss:StyleID="${item.styleid}" >
												<#if checkFieldPermission('${(item.name)!}','WOM_7.5.0.0_standingcropRef_StandingcropRef','${(item.propertyCode)!}') != 0>
