...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=WOM_7.5.0.0_qualityRecords";
	openExportFrame(url);
}
...
<div id="WOM_qualityRecords_qualityInspect_qualityInspectList_attachment">	
