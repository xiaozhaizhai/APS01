	...
	<form <#if useInBusiness?? && useInBusiness == 'yes'>style="position:relative;*z-index:1;zoom:1;"</#if> onsubmit="return false" id="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm" exportUrl="/WOM/taskReporting/taskReporting/taskReportingRef-query.action">
		...
		<div id="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm_btn_toggle" class="quick-query-btn-toggle quick-query-btn-expand" style="display:none;" title="${getText('ec.view.expandTip')}" onclick="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm_expandAllCondition()" ></div>
		<#assign advFlag = getAdvClassific('WOM_7.5.0.0_taskReporting_taskReportingRef')>
		<#if advFlag?? && advFlag>
		<@dataclassific id="dataClassific" viewCode="WOM_7.5.0.0_taskReporting_taskReportingRef" formId="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm" dataTableId="ec_WOM_taskReporting_taskReporting_taskReportingRef_query"   />
		</#if>
					<@quickquery unique="LAST_QUERY_ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm" isExpandAll=true formId="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm" idprefix="ec_WOM_taskReporting_taskReporting_taskReportingRef" expandType="all"  fieldcodes="WOM_7.5.0.0_taskReporting_TaskReporting_tableNo_tableNo:ec.common.tableNo||WOM_7.5.0.0_produceTask_ProduceTask_tableNo_taskID_tableNo:WOM.common.tableNo1111||MESBasic_1_product_Product_productName_productID_productName:WOM.propertydisplayName.radion1415772740737333344||WOM_7.5.0.0_taskReporting_TaskReporting_batchNum_batchNum:WOM.propertydisplayName.randon1490772885990||WOM_7.5.0.0_taskReporting_TaskReporting_reportType_reportType:WOM.propertydisplayName.randon1490773072845||base_staff_name_reportStaff_name:WOM.propertydisplayName.randon1490772995868||WOM_7.5.0.0_taskReporting_TaskReporting_reportDate_reportDate:WOM.propertydisplayName.randon1490787728846" > 
							<#assign tableNo_defaultValue  = ''>
									<#assign tableNo_defaultValue  = ''>
							<@queryfield formId="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm" code="WOM_7.5.0.0_taskReporting_TaskReporting_tableNo" showFormat="TEXT" defaultValue=tableNo_defaultValue  divCode="WOM_7.5.0.0_taskReporting_TaskReporting_tableNo_tableNo" isCustomize=true style="" > 
											<div class="fix-input">
							...
							<#assign taskID_tableNo_defaultValue  = ''>
									<#assign taskID_tableNo_defaultValue  = ''>
							<@queryfield formId="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm" code="WOM_7.5.0.0_produceTask_ProduceTask_tableNo" showFormat="SELECTCOMP" defaultValue=taskID_tableNo_defaultValue  divCode="WOM_7.5.0.0_produceTask_ProduceTask_tableNo_taskID_tableNo" isCustomize=true style="" > 
										<input type="hidden" id="taskID.id" name="taskID.id" value="" />
												<@mneclient iframe=true mneenable=false isCrossCompany=isCrossCompany isPrecise=true deValue="${taskID_tableNo_defaultValue!}" reftitle="${getText('WOM.viewtitle.randon1489737198145')}"  conditionfunc="WOM.taskReporting.taskReporting.taskReportingRef._querycustomFunc('taskID_tableNo')" name="taskID.tableNo" id="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm_taskID_tableNo" displayFieldName="tableNo" type="other" exp="like" classStyle="cui-noborder-input" url="/WOM/produceTask/produceTask/taskRef.action"   refViewCode="WOM_7.5.0.0_produceTask_taskRef"  clicked=true multiple=false mnewidth=260 formId="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm" searchClick="WOM.taskReporting.taskReporting.taskReportingRef.commonQuery('query')"   />
							</@queryfield>
							<#assign productID_productName_defaultValue  = ''>
									<#assign productID_productName_defaultValue  = ''>
							<@queryfield formId="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm" code="MESBasic_1_product_Product_productName" showFormat="SELECTCOMP" defaultValue=productID_productName_defaultValue  divCode="MESBasic_1_product_Product_productName_productID_productName" isCustomize=true style="" > 
										<input type="hidden" id="productID.id" name="productID.id" value="" />
												<@mneclient iframe=true mneenable=true isCrossCompany=isCrossCompany isPrecise=true deValue="${productID_productName_defaultValue!}" reftitle="${getText('MESBasic.viewtitle.randon1450085069587')}"  conditionfunc="WOM.taskReporting.taskReporting.taskReportingRef._querycustomFunc('productID_productName')" name="productID.productName" id="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm_productID_productName" displayFieldName="productName" type="other" exp="like" classStyle="cui-noborder-input" url="/MESBasic/product/product/refProductLayout.action"   refViewCode="MESBasic_1_product_refProductLayout"  clicked=true multiple=false mnewidth=260 formId="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm" searchClick="WOM.taskReporting.taskReporting.taskReportingRef.commonQuery('query')"   />
							</@queryfield>
							<#assign batchNum_defaultValue  = ''>
									<#assign batchNum_defaultValue  = ''>
							<@queryfield formId="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm" code="WOM_7.5.0.0_taskReporting_TaskReporting_batchNum" showFormat="TEXT" defaultValue=batchNum_defaultValue  divCode="WOM_7.5.0.0_taskReporting_TaskReporting_batchNum_batchNum" isCustomize=true style="" > 
											<div class="fix-input">
							...
							<#assign reportType_defaultValue  = ''>
									<#assign reportType_defaultValue  = ''>
							<@queryfield formId="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm" code="WOM_7.5.0.0_taskReporting_TaskReporting_reportType" showFormat="SELECTCOMP" defaultValue=reportType_defaultValue  divCode="WOM_7.5.0.0_taskReporting_TaskReporting_reportType_reportType" isCustomize=true style="" > 
							...
							<#assign reportStaff_name_defaultValue  = ''>
									<#assign reportStaff_name_defaultValue  = ''>
							<@queryfield formId="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm" code="base_staff_name" showFormat="SELECTCOMP" defaultValue=reportStaff_name_defaultValue  divCode="base_staff_name_reportStaff_name" isCustomize=true style="" > 
										<input type="hidden" id="reportStaff.id" name="reportStaff.id" value="" />
												<@mneclient iframe=true mneenable=true isCrossCompany=isCrossCompany isPrecise=true deValue="${reportStaff_name_defaultValue!}" reftitle="${getText('foundation.ec.entity.view.reference')}"  conditionfunc="WOM.taskReporting.taskReporting.taskReportingRef._querycustomFunc('reportStaff_name')" name="reportStaff.name" id="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm_reportStaff_name" displayFieldName="name" type="Staff" exp="like" classStyle="cui-noborder-input" url="/foundation/staff/common/staffListFrameset.action"   refViewCode="sysbase_1.0_staff_ref"  clicked=true multiple=false mnewidth=260 formId="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm" searchClick="WOM.taskReporting.taskReporting.taskReportingRef.commonQuery('query')"   />
							</@queryfield>
							...
							<@queryfield formId="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm" code="WOM_7.5.0.0_taskReporting_TaskReporting_reportDate" showFormat="YMD_HMS" defaultValue=reportDate_defaultValue  divCode="WOM_7.5.0.0_taskReporting_TaskReporting_reportDate_reportDate" isCustomize=true style="" > 
								<div>
							  	 	<div style="float:left;width:45%">
									<@datepicker type="dateTime" cssClass="cui-noborder-input" name="reportDate_start" id="reportDate_start" exp="gequal"   formid="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm" />
									</div>
									...
									<@datepicker type="dateTime" cssClass="cui-noborder-input" name="reportDate_end" id="reportDate_end" exp="lequal"   formid="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm" />
							  		</div>
						  		</div>
							</@queryfield>
							<div class="quick-query-buttonbar" style="margin-bottom:6px;margin-right:12px;">
						       	<@querybutton formId="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm" type="adv" onclick="WOM.taskReporting.taskReporting.taskReportingRef.commonQuery('query')" onadvancedclick="advQuery('WOM.taskReporting.taskReporting.taskReportingRef.advquery')" /> 
...
ec_WOM_taskReporting_taskReporting_taskReportingRef_quickquery_info["MainTableName"]="WOM_TASK_REPORTINGS";
...
ec_WOM_taskReporting_taskReporting_taskReportingRef_quickquery_info["productID.id"].columnName="PRODUCT_ID";
...
<script>
 $(function(){
 	var advRemainDialog = $('[id="WOM.taskReporting.taskReporting.taskReportingRef.advquery"]');
...
<div style="position:relative;z-index:10;display:none;" id="WOM.taskReporting.taskReporting.taskReportingRef.advquery">
    <@errorbar id="adv_query_edit_bar"></@errorbar>
    <div class="advConContent">
    <form <#if useInBusiness?? && useInBusiness == 'yes'>style="position:relative;*z-index:1;zoom:1;"</#if> onsubmit="return false" id="ec_WOM_taskReporting_taskReporting_taskReportingRef_adv_queryForm" exportUrl="/WOM/taskReporting/taskReporting/taskReportingRef-query.action">
							<#assign tableNo_defaultValue  = ''>
									<#assign tableNo_defaultValue  = ''>
								<@advsqueryfield formId="ec_WOM_taskReporting_taskReporting_taskReportingRef_adv_queryForm" code="WOM_7.5.0.0_taskReporting_TaskReporting_tableNo" showFormat="TEXT" defaultValue=tableNo_defaultValue  divCode="WOM_7.5.0.0_taskReporting_TaskReporting_tableNo_tableNo" isCustomize=true > 
							...
							<#assign taskID_tableNo_defaultValue  = ''>
									<#assign taskID_tableNo_defaultValue  = ''>
								<@advsqueryfield formId="ec_WOM_taskReporting_taskReporting_taskReportingRef_adv_queryForm" code="WOM_7.5.0.0_produceTask_ProduceTask_tableNo" showFormat="SELECTCOMP" defaultValue=taskID_tableNo_defaultValue  divCode="WOM_7.5.0.0_produceTask_ProduceTask_tableNo_taskID_tableNo" isCustomize=true > 
							...
							<div class="quick_query_content advQuery_content">
								...
								<input type="hidden" id="modelCode" modelcode="WOM_7.5.0.0_produceTask_ProduceTask" />
										<input type="hidden" id="adv_taskID.id" name="taskID.id" value="" />
												<@mneclient iframe=true mneenable=false advresume="adv_taskID.id" isCrossCompany=isCrossCompany isPrecise=true deValue="${taskID_tableNo_defaultValue!}" reftitle="${getText('WOM.viewtitle.randon1489737198145')}"  conditionfunc="WOM.taskReporting.taskReporting.taskReportingRef._querycustomFunc('taskID_tableNo')" name="taskID.tableNo" id="adv_ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm_taskID_tableNo" displayFieldName="tableNo" type="other" exp="like"  classStyle="cui-noborder-input" url="/WOM/produceTask/produceTask/taskRef.action"   refViewCode="WOM_7.5.0.0_produceTask_taskRef"  clicked=true multiple=false mnewidth=260 formId="ec_WOM_taskReporting_taskReporting_taskReportingRef_adv_queryForm"   />
							...
							<#assign productID_productName_defaultValue  = ''>
									<#assign productID_productName_defaultValue  = ''>
								<@advsqueryfield formId="ec_WOM_taskReporting_taskReporting_taskReportingRef_adv_queryForm" code="MESBasic_1_product_Product_productName" showFormat="SELECTCOMP" defaultValue=productID_productName_defaultValue  divCode="MESBasic_1_product_Product_productName_productID_productName" isCustomize=true > 
							...
							<div class="quick_query_content advQuery_content">
								...
								<input type="hidden" id="modelCode" modelcode="MESBasic_1_product_Product" />
										<input type="hidden" id="adv_productID.id" name="productID.id" value="" />
												<@mneclient iframe=true mneenable=true advresume="adv_productID.id" isCrossCompany=isCrossCompany isPrecise=true deValue="${productID_productName_defaultValue!}" reftitle="${getText('MESBasic.viewtitle.randon1450085069587')}"  conditionfunc="WOM.taskReporting.taskReporting.taskReportingRef._querycustomFunc('productID_productName')" name="productID.productName" id="adv_ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm_productID_productName" displayFieldName="productName" type="other" exp="like"  classStyle="cui-noborder-input" url="/MESBasic/product/product/refProductLayout.action"   refViewCode="MESBasic_1_product_refProductLayout"  clicked=true multiple=false mnewidth=260 formId="ec_WOM_taskReporting_taskReporting_taskReportingRef_adv_queryForm"   />
							...
							<#assign batchNum_defaultValue  = ''>
									<#assign batchNum_defaultValue  = ''>
								<@advsqueryfield formId="ec_WOM_taskReporting_taskReporting_taskReportingRef_adv_queryForm" code="WOM_7.5.0.0_taskReporting_TaskReporting_batchNum" showFormat="TEXT" defaultValue=batchNum_defaultValue  divCode="WOM_7.5.0.0_taskReporting_TaskReporting_batchNum_batchNum" isCustomize=true > 
...
ec.view.newAdvQuery._initNewAdvQuery=function(values){
		ec.advQuery.query = new CUI.NewAdvQuery({
			...
			env: 'runtime',
			viewCode: 'WOM_7.5.0.0_taskReporting_taskReportingRef',
			modelCode: 'WOM_7.5.0.0_taskReporting_TaskReporting',
			modelName: 'TaskReporting',
			formId: 'ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm',
			olddiv: 'WOM.taskReporting.taskReporting.taskReportingRef.advquery',
			values: values,
...
ec.view.newAdvQuery._customQuery= function(){
	$("[id='WOM.taskReporting.taskReporting.taskReportingRef.advquery'] #advQueryLoading").show();
	var url="/ec/advQuery/advconfig.action?view.code="+'WOM_7.5.0.0_taskReporting_taskReportingRef'+"&entity.code="+'WOM_7.5.0.0_taskReporting';
		 $.ajax({
		 url: url, 
		 cache: false,
		 async: false,
		 success:function(html){ 
		 	$("[id='WOM.taskReporting.taskReporting.taskReportingRef.advquery'] #customquContent").html(html);
		 	$("[id='WOM.taskReporting.taskReporting.taskReportingRef.advquery'] #advQueryLoading").hide();
		 }
	});
	onceOpen = true;
...
function changeCustomQuery(){
	if(showType == "up"){
		$('[id="WOM.taskReporting.taskReporting.taskReportingRef.advquery"] div.customqu-content').css('display','none');
		$('[id="WOM.taskReporting.taskReporting.taskReportingRef.advquery"] div.move-grade').css('display','none');
		// $('[id="WOM.taskReporting.taskReporting.taskReportingRef.advquery"] span.customQuery').css('background','url("/bap/struts/css/icon_adv.png") 0 -61px no-repeat');
		$('[id="WOM.taskReporting.taskReporting.taskReportingRef.advquery"] span.customQuery').removeClass("customQuery_down").addClass("customQuery_up");											
		$('[id="WOM.taskReporting.taskReporting.taskReportingRef.advquery"] div.advConContent').css('height','400px');		
		showType = "down";
	}else{
		$('[id="WOM.taskReporting.taskReporting.taskReportingRef.advquery"] div.customqu-content').css('display','block');
		$('[id="WOM.taskReporting.taskReporting.taskReportingRef.advquery"] div.move-grade').css('display','block');
		// $('[id="WOM.taskReporting.taskReporting.taskReportingRef.advquery"] span.customQuery').css('background','url("/bap/struts/css/icon_adv.png") 0 -144px no-repeat');
		$('[id="WOM.taskReporting.taskReporting.taskReportingRef.advquery"] span.customQuery').removeClass("customQuery_up").addClass("customQuery_down");						
		$('[id="WOM.taskReporting.taskReporting.taskReportingRef.advquery"] div.advConContent').css('height','130px');
		if(!onceOpen){
			customQuery();
			onceOpen = true;
		}
...
<@datatable  colAdminFlag=colAdmFlag  superChecked=superChecked superCheckedName=superCheckedName superCheckedId=superCheckedId checkedRowsMap=checkedRowsMap id="ec_WOM_taskReporting_taskReporting_taskReportingRef_query" renderOverEvent="ec_WOM_taskReporting_taskReporting_taskReportingRef_RenderOverEvent" pageInitMethod="ec_WOM_taskReporting_taskReporting_taskReportingRef_PageInitMethod" modelCode="WOM_7.5.0.0_taskReporting_TaskReporting" noPermissionKeys="tableNo,taskID.tableNo,productID.productCode,productID.productName,batchNum,reportStaff.name,reportDate,reportType,remark" hidekeyPrefix="ec_WOM_taskReporting_taskReporting_taskReportingRef_query" orderMode="backstage" queryFunc=datatable_queryFunc formId="ec_WOM_taskReporting_taskReporting_taskReportingRef_queryForm" firstLoad=datatable_firstLoad  lockColumnCount="" dblclick="WOM.taskReporting.taskReporting.taskReportingRef.sendBacktaskReportingRef" style="margin-left:13px;margin-right:4px;" editable=false dtPage="page" dataUrl=datatable_dataUrl transMethod="post" hidekey="['id','version','layRec','valid','cid','reportType.id','taskID.id','productID.id','reportStaff.id','tableNo','tableNo','id']" postData="&${(condition!'')}&permissionCode=${permissionCode!''}" throwError="WOM.taskReporting.taskReporting.taskReportingRef.showErrorMsg"   >
			...
			<@datacolumn columnName="TABLE_NO"    showFormat="TEXT" defaultDisplay="${taskID_tableNo_displayDefaultType!}"  key="taskID.tableNo"   label="${getText('WOM.common.tableNo1111')}" textalign="left"  width=190   type="textfield"    click="function(cell){WOM.taskReporting.taskReporting.taskReportingRef.showLinkView('/WOM/produceTask/produceTask/makeTaskView.action?${getPowerCode('','WOM_7.5.0.0_produceTask_makeTaskView')}','taskID.id',cell)}" showFormatFunc="" cssstyle="" />
			...
			<@datacolumn columnName="BATCH_NUM"    showFormat="TEXT" defaultDisplay="${batchNum_displayDefaultType!}"  key="batchNum"   label="${getText('WOM.propertydisplayName.randon1490772885990')}" textalign="left"  width=100   type="textfield"    showFormatFunc="" cssstyle="" />
			...
			<@datacolumn columnName="REPORT_TYPE"    showFormat="SELECTCOMP" defaultDisplay="${reportType_displayDefaultType!}"  key="reportType.value"   label="${getText('WOM.propertydisplayName.randon1490773072845')}" textalign="center"  width=100   type="systemcode"    showFormatFunc="" cssstyle="" />
				<#assign customPropList = getShowCustomProps("WOM_7.5.0.0_taskReporting_TaskReporting", "WOM_7.5.0.0_taskReporting_taskReportingRef", "LIST", "taskReporting")>
				<#-- 排布自定义字段 -->
...
function ec_WOM_taskReporting_taskReporting_taskReportingRef_PageInitMethod(){
}
