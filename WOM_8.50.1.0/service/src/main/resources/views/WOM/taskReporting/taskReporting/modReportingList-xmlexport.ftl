			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'reportStaff.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.staff.dimissionStaff_xls.staffName0000')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'reportDate' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490787728846')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'reportType.value' || item == '*'>
