...
<#assign viewCode = 'WOM_7.5.0.0_taskReporting_TaskReporting' />
<#assign propertyCode = '' />
								...
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'reportType.value' || item == '*'>
			 						        ...
			 						        <#assign customGeneratedFlag=false />
												<#if item == 'reportType.value' && !customGeneratedFlag >
												</#if>
			 						        <#assign customGeneratedFlag=false />
												<#if item == 'reportType.value' && !customGeneratedFlag >
												</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskID.tableNo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.common.tableNo1111')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productID.productCode' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490772885990')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'reportStaff.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertyshowName.randon1568768467863.flag')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'reportDate' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertyshowName.randon1568768474887.flag')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'reportType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490773072845')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
												<#if item == 'reportType.value' && !customGeneratedFlag >
												</#if>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'remark' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490773089261')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
