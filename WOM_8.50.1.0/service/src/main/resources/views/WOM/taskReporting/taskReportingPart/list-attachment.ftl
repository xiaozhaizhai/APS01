...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=WOM_7.5.0.0_taskReporting";
	openExportFrame(url);
}
...
<div id="WOM_taskReporting_taskReportingPart_reportDetaliList_attachment">	
