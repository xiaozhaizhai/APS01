	...
	<form <#if useInBusiness?? && useInBusiness == 'yes'>style="position:relative;*z-index:1;zoom:1;"</#if> onsubmit="return false" id="ec_WOM_putInMaterial_putInMaterial_putinRefList_queryForm" exportUrl="/WOM/putInMaterial/putInMaterial/putinRefList-query.action">
		...
		<div id="ec_WOM_putInMaterial_putInMaterial_putinRefList_queryForm_btn_toggle" class="quick-query-btn-toggle quick-query-btn-expand" style="display:none;" title="${getText('ec.view.expandTip')}" onclick="ec_WOM_putInMaterial_putInMaterial_putinRefList_queryForm_expandAllCondition()" ></div>
		<#assign advFlag = getAdvClassific('WOM_7.5.0.0_putInMaterial_putinRefList')>
		<#if advFlag?? && advFlag>
		<@dataclassific id="dataClassific" viewCode="WOM_7.5.0.0_putInMaterial_putinRefList" formId="ec_WOM_putInMaterial_putInMaterial_putinRefList_queryForm" dataTableId="ec_WOM_putInMaterial_putInMaterial_putinRefList_query"   />
		</#if>
					<@quickquery unique="LAST_QUERY_ec_WOM_putInMaterial_putInMaterial_putinRefList_queryForm" isExpandAll=true formId="ec_WOM_putInMaterial_putInMaterial_putinRefList_queryForm" idprefix="ec_WOM_putInMaterial_putInMaterial_putinRefList" expandType="all"  fieldcodes="WOM_7.5.0.0_putInMaterial_PutInMaterial_tableNo_tableNo:ec.common.tableNo||WOM_7.5.0.0_produceTask_ProduceTask_tableNo_taskID_tableNo:WOM.modelname.randon1489657901718||base_staff_name_putinStaff_name:WOM.staff.dimissionStaff_xls.staffName43566" > 
							<#assign tableNo_defaultValue  = ''>
									<#assign tableNo_defaultValue  = ''>
							<@queryfield formId="ec_WOM_putInMaterial_putInMaterial_putinRefList_queryForm" code="WOM_7.5.0.0_putInMaterial_PutInMaterial_tableNo" showFormat="TEXT" defaultValue=tableNo_defaultValue  divCode="WOM_7.5.0.0_putInMaterial_PutInMaterial_tableNo_tableNo" isCustomize=true style="" > 
											<div class="fix-input">
							...
							<#assign taskID_tableNo_defaultValue  = ''>
									<#assign taskID_tableNo_defaultValue  = ''>
							<@queryfield formId="ec_WOM_putInMaterial_putInMaterial_putinRefList_queryForm" code="WOM_7.5.0.0_produceTask_ProduceTask_tableNo" showFormat="SELECTCOMP" defaultValue=taskID_tableNo_defaultValue  divCode="WOM_7.5.0.0_produceTask_ProduceTask_tableNo_taskID_tableNo" isCustomize=true style="" > 
										<input type="hidden" id="taskID.id" name="taskID.id" value="" />
												<@mneclient iframe=true mneenable=false isCrossCompany=isCrossCompany isPrecise=true deValue="${taskID_tableNo_defaultValue!}" reftitle="${getText('WOM.viewtitle.randon1489737198145')}"  conditionfunc="WOM.putInMaterial.putInMaterial.putinRefList._querycustomFunc('taskID_tableNo')" name="taskID.tableNo" id="ec_WOM_putInMaterial_putInMaterial_putinRefList_queryForm_taskID_tableNo" displayFieldName="tableNo" type="other" exp="like" classStyle="cui-noborder-input" url="/WOM/produceTask/produceTask/taskRef.action"   refViewCode="WOM_7.5.0.0_produceTask_taskRef"  clicked=true multiple=false mnewidth=260 formId="ec_WOM_putInMaterial_putInMaterial_putinRefList_queryForm" searchClick="WOM.putInMaterial.putInMaterial.putinRefList.commonQuery('query')"   />
							</@queryfield>
							<#assign putinStaff_name_defaultValue  = ''>
									<#assign putinStaff_name_defaultValue  = ''>
							<@queryfield formId="ec_WOM_putInMaterial_putInMaterial_putinRefList_queryForm" code="base_staff_name" showFormat="SELECTCOMP" defaultValue=putinStaff_name_defaultValue  divCode="base_staff_name_putinStaff_name" isCustomize=true style="" > 
										<input type="hidden" id="putinStaff.id" name="putinStaff.id" value="" />
												<@mneclient iframe=true mneenable=true isCrossCompany=isCrossCompany isPrecise=true deValue="${putinStaff_name_defaultValue!}" reftitle="${getText('foundation.ec.entity.view.reference')}"  conditionfunc="WOM.putInMaterial.putInMaterial.putinRefList._querycustomFunc('putinStaff_name')" name="putinStaff.name" id="ec_WOM_putInMaterial_putInMaterial_putinRefList_queryForm_putinStaff_name" displayFieldName="name" type="Staff" exp="like" classStyle="cui-noborder-input" url="/foundation/staff/common/staffListFrameset.action"   refViewCode="sysbase_1.0_staff_ref"  clicked=true multiple=false mnewidth=260 formId="ec_WOM_putInMaterial_putInMaterial_putinRefList_queryForm" searchClick="WOM.putInMaterial.putInMaterial.putinRefList.commonQuery('query')"   />
							</@queryfield>
							<div class="quick-query-buttonbar" style="margin-bottom:6px;margin-right:12px;">
						       	<@querybutton formId="ec_WOM_putInMaterial_putInMaterial_putinRefList_queryForm" type="adv" onclick="WOM.putInMaterial.putInMaterial.putinRefList.commonQuery('query')" onadvancedclick="advQuery('WOM.putInMaterial.putInMaterial.putinRefList.advquery')" /> 
...
ec_WOM_putInMaterial_putInMaterial_putinRefList_quickquery_info["MainTableName"]="WOM_PUT_IN_MATERIALS";
...
<script>
 $(function(){
 	var advRemainDialog = $('[id="WOM.putInMaterial.putInMaterial.putinRefList.advquery"]');
...
<div style="position:relative;z-index:10;display:none;" id="WOM.putInMaterial.putInMaterial.putinRefList.advquery">
    <@errorbar id="adv_query_edit_bar"></@errorbar>
    <div class="advConContent">
    <form <#if useInBusiness?? && useInBusiness == 'yes'>style="position:relative;*z-index:1;zoom:1;"</#if> onsubmit="return false" id="ec_WOM_putInMaterial_putInMaterial_putinRefList_adv_queryForm" exportUrl="/WOM/putInMaterial/putInMaterial/putinRefList-query.action">
							<#assign tableNo_defaultValue  = ''>
									<#assign tableNo_defaultValue  = ''>
								<@advsqueryfield formId="ec_WOM_putInMaterial_putInMaterial_putinRefList_adv_queryForm" code="WOM_7.5.0.0_putInMaterial_PutInMaterial_tableNo" showFormat="TEXT" defaultValue=tableNo_defaultValue  divCode="WOM_7.5.0.0_putInMaterial_PutInMaterial_tableNo_tableNo" isCustomize=true > 
							...
							<#assign taskID_tableNo_defaultValue  = ''>
									<#assign taskID_tableNo_defaultValue  = ''>
								<@advsqueryfield formId="ec_WOM_putInMaterial_putInMaterial_putinRefList_adv_queryForm" code="WOM_7.5.0.0_produceTask_ProduceTask_tableNo" showFormat="SELECTCOMP" defaultValue=taskID_tableNo_defaultValue  divCode="WOM_7.5.0.0_produceTask_ProduceTask_tableNo_taskID_tableNo" isCustomize=true > 
							...
							<div class="quick_query_content advQuery_content">
								...
								<input type="hidden" id="modelCode" modelcode="WOM_7.5.0.0_produceTask_ProduceTask" />
										<input type="hidden" id="adv_taskID.id" name="taskID.id" value="" />
												<@mneclient iframe=true mneenable=false advresume="adv_taskID.id" isCrossCompany=isCrossCompany isPrecise=true deValue="${taskID_tableNo_defaultValue!}" reftitle="${getText('WOM.viewtitle.randon1489737198145')}"  conditionfunc="WOM.putInMaterial.putInMaterial.putinRefList._querycustomFunc('taskID_tableNo')" name="taskID.tableNo" id="adv_ec_WOM_putInMaterial_putInMaterial_putinRefList_queryForm_taskID_tableNo" displayFieldName="tableNo" type="other" exp="like"  classStyle="cui-noborder-input" url="/WOM/produceTask/produceTask/taskRef.action"   refViewCode="WOM_7.5.0.0_produceTask_taskRef"  clicked=true multiple=false mnewidth=260 formId="ec_WOM_putInMaterial_putInMaterial_putinRefList_adv_queryForm"   />
...
ec.view.newAdvQuery._initNewAdvQuery=function(values){
		ec.advQuery.query = new CUI.NewAdvQuery({
			...
			env: 'runtime',
			viewCode: 'WOM_7.5.0.0_putInMaterial_putinRefList',
			modelCode: 'WOM_7.5.0.0_putInMaterial_PutInMaterial',
			modelName: 'PutInMaterial',
			formId: 'ec_WOM_putInMaterial_putInMaterial_putinRefList_queryForm',
			olddiv: 'WOM.putInMaterial.putInMaterial.putinRefList.advquery',
			values: values,
...
ec.view.newAdvQuery._customQuery= function(){
	$("[id='WOM.putInMaterial.putInMaterial.putinRefList.advquery'] #advQueryLoading").show();
	var url="/ec/advQuery/advconfig.action?view.code="+'WOM_7.5.0.0_putInMaterial_putinRefList'+"&entity.code="+'WOM_7.5.0.0_putInMaterial';
		 $.ajax({
		 url: url, 
		 cache: false,
		 async: false,
		 success:function(html){ 
		 	$("[id='WOM.putInMaterial.putInMaterial.putinRefList.advquery'] #customquContent").html(html);
		 	$("[id='WOM.putInMaterial.putInMaterial.putinRefList.advquery'] #advQueryLoading").hide();
		 }
	});
	onceOpen = true;
...
function changeCustomQuery(){
	if(showType == "up"){
		$('[id="WOM.putInMaterial.putInMaterial.putinRefList.advquery"] div.customqu-content').css('display','none');
		$('[id="WOM.putInMaterial.putInMaterial.putinRefList.advquery"] div.move-grade').css('display','none');
		// $('[id="WOM.putInMaterial.putInMaterial.putinRefList.advquery"] span.customQuery').css('background','url("/bap/struts/css/icon_adv.png") 0 -61px no-repeat');
		$('[id="WOM.putInMaterial.putInMaterial.putinRefList.advquery"] span.customQuery').removeClass("customQuery_down").addClass("customQuery_up");											
		$('[id="WOM.putInMaterial.putInMaterial.putinRefList.advquery"] div.advConContent').css('height','400px');		
		showType = "down";
	}else{
		$('[id="WOM.putInMaterial.putInMaterial.putinRefList.advquery"] div.customqu-content').css('display','block');
		$('[id="WOM.putInMaterial.putInMaterial.putinRefList.advquery"] div.move-grade').css('display','block');
		// $('[id="WOM.putInMaterial.putInMaterial.putinRefList.advquery"] span.customQuery').css('background','url("/bap/struts/css/icon_adv.png") 0 -144px no-repeat');
		$('[id="WOM.putInMaterial.putInMaterial.putinRefList.advquery"] span.customQuery').removeClass("customQuery_up").addClass("customQuery_down");						
		$('[id="WOM.putInMaterial.putInMaterial.putinRefList.advquery"] div.advConContent').css('height','130px');
		if(!onceOpen){
			customQuery();
			onceOpen = true;
		}
...
<@datatable  colAdminFlag=colAdmFlag  superChecked=superChecked superCheckedName=superCheckedName superCheckedId=superCheckedId checkedRowsMap=checkedRowsMap id="ec_WOM_putInMaterial_putInMaterial_putinRefList_query" renderOverEvent="ec_WOM_putInMaterial_putInMaterial_putinRefList_RenderOverEvent" pageInitMethod="ec_WOM_putInMaterial_putInMaterial_putinRefList_PageInitMethod" modelCode="WOM_7.5.0.0_putInMaterial_PutInMaterial" noPermissionKeys="tableNo,taskID.tableNo,taskID.productId.productCode,taskID.productId.productName,taskID.productBatchNum,putinStaff.name,remark" hidekeyPrefix="ec_WOM_putInMaterial_putInMaterial_putinRefList_query" orderMode="backstage" queryFunc=datatable_queryFunc formId="ec_WOM_putInMaterial_putInMaterial_putinRefList_queryForm" firstLoad=datatable_firstLoad  lockColumnCount="" dblclick="WOM.putInMaterial.putInMaterial.putinRefList.sendBackputinRefList" style="margin-left:13px;margin-right:4px;" editable=false dtPage="page" dataUrl=datatable_dataUrl transMethod="post" hidekey="['id','version','layRec','valid','cid','taskID.id','taskID.productId.id','putinStaff.id','tableNo','tableNo','id']" postData="&${(condition!'')}&permissionCode=${permissionCode!''}" throwError="WOM.putInMaterial.putInMaterial.putinRefList.showErrorMsg"   >
			...
			<@datacolumn columnName="NAME"    showFormat="TEXT" defaultDisplay="${putinStaff_name_displayDefaultType!}"  key="putinStaff.name"   label="${getText('WOM.staff.dimissionStaff_xls.staffName43566')}" textalign="left"  width=80   type="textfield"    showFormatFunc="" cssstyle="" />
				<#assign customPropList = getShowCustomProps("WOM_7.5.0.0_putInMaterial_PutInMaterial", "WOM_7.5.0.0_putInMaterial_putinRefList", "LIST", "putInMaterial")>
				<#-- 排布自定义字段 -->
...
function ec_WOM_putInMaterial_putInMaterial_putinRefList_PageInitMethod(){
}
