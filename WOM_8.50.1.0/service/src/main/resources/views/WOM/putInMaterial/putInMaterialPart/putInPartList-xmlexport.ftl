...
<#assign viewCode = 'WOM_7.5.0.0_putInMaterial_PutInMaterialPart' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="headId.taskID.productBatchNum">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="headId.taskID.productId.productCode">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="headId.taskID.productId.productName">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="headId.taskID.tableNo">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="lossNum">
	  		...
	  		<Style ss:ID="putinStaff.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="putinType">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="remark">
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											<#if item == 'headId.taskID.tableNo' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'headId.taskID.productId.productCode' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'headId.taskID.productId.productName' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'headId.taskID.productBatchNum' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											...
											<#if item == 'taskActiveId.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'useNum' || item == '*'>
											...
											<#if item == 'lossNum' || item == '*'>
			 						        ...
			 						        <#assign customGeneratedFlag=false />
												<#if item == 'lossNum' && !customGeneratedFlag >
												</#if>
			 						        <#assign customGeneratedFlag=false />
												<#if item == 'lossNum' && !customGeneratedFlag >
												</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'headId.taskID.tableNo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.common.tableNo1112')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'headId.taskID.productId.productCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.radion14157726448334334')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'headId.taskID.productId.productName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.radion14157727407373333445')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'headId.taskID.productBatchNum' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productId.productCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.radion14157726448331')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productId.productName' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490605271044')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'putinStaff.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1492078276959')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'putinDate' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1492078322275')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'putinEndDate' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1492674267022')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'putinType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1491633306278')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskProcessId.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489720649125')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'factoryId.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489720709421')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'taskActiveId.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490066495700')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'useNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490605292518')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'lossNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490605314992')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
												<#if item == 'lossNum' && !customGeneratedFlag >
												</#if>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'remark' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1490605337153')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												<#if item == 'headId.taskID.tableNo' || item == '*'>
													<Cell>
														...
														<#if data.headId.taskID.tableNo??><Data ss:Type="String"><![CDATA[${(data.headId.taskID.tableNo)!}]]></Data></#if>
												...
												<#if item == 'headId.taskID.productId.productCode' || item == '*'>
													<Cell>
														...
														<#if data.headId.taskID.productId.productCode??><Data ss:Type="String"><![CDATA[${(data.headId.taskID.productId.productCode)!}]]></Data></#if>
												...
												<#if item == 'headId.taskID.productId.productName' || item == '*'>
													<Cell>
														...
														<#if data.headId.taskID.productId.productName??><Data ss:Type="String"><![CDATA[${(data.headId.taskID.productId.productName)!}]]></Data></#if>
												...
												<#if item == 'headId.taskID.productBatchNum' || item == '*'>
													<Cell>
														...
														<#if data.headId.taskID.productBatchNum??><Data ss:Type="String"><![CDATA[${(data.headId.taskID.productBatchNum)!}]]></Data></#if>
												...
												<#if item == 'putinStaff.name' || item == '*'>
													<Cell>
														...
														<#if data.putinStaff.name??><Data ss:Type="String"><![CDATA[${(data.putinStaff.name)!}]]></Data></#if>
												...
												<#if item == 'putinDate' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.putinDate??><Data ss:Type="DateTime">${(data.putinDate)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
												...
												<#if item == 'putinEndDate' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.putinEndDate??><Data ss:Type="DateTime">${(data.putinEndDate)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
												...
												<#if item == 'putinType.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.putinType.value)!}')}</Data>
												...
												<#if item == 'taskProcessId.name' || item == '*'>
													<Cell>
														...
														<#if data.taskProcessId.name??><Data ss:Type="String"><![CDATA[${(data.taskProcessId.name)!}]]></Data></#if>
												...
												<#if item == 'taskActiveId.name' || item == '*'>
													<Cell>
														...
														<#if data.taskActiveId.name??><Data ss:Type="String"><![CDATA[${(data.taskActiveId.name)!}]]></Data></#if>
