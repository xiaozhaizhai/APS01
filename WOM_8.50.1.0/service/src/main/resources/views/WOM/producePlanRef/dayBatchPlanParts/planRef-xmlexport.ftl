...
<#assign viewCode = 'WOM_7.5.0.0_producePlanRef_DayBatchPlanParts' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="dayPlanInfo.tableNo">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="endTime">
	  		...
	  		<Style ss:ID="formularID.produceType">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		...
	  		<Style ss:ID="formularID.supportEbr">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		...
	  		<Style ss:ID="productId.productModel">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		...
	  		<Style ss:ID="productId.productSpecif">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											<#if item == 'dayPlanInfo.tableNo' || item == '*'>
											...
											<#if item == 'productId.productModel' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'productId.productSpecif' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											...
											<#if item == 'formularID.produceType.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
															<Column ss:Index="${count}" ss:StyleID="${item?substring(0,item?last_index_of('.'))}"  ss:Width="140"/>
														 <#else>
														    <Column ss:Index="${count}" ss:StyleID="${item}"  ss:Width="140" />
											...
											<#if item == 'factoryCode.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'formularID.supportEbr' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489823243312')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'quantity' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489823617233')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formularID.code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon148824631209sss2')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formularID.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon14870758237ee90')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formularID.setProcess.value' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formularID.produceType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487076555894')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'factoryCode.name' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'startTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489823646428')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'endTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1489823379542')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												<#if item == 'dayPlanInfo.tableNo' || item == '*'>
													<Cell>
														...
														<#if data.dayPlanInfo.tableNo??><Data ss:Type="String"><![CDATA[${(data.dayPlanInfo.tableNo)!}]]></Data></#if>
												...
												<#if item == 'productId.productModel' || item == '*'>
													<Cell>
														...
														<#if data.productId.productModel??><Data ss:Type="String"><![CDATA[${(data.productId.productModel)!}]]></Data></#if>
												...
												<#if item == 'productId.productSpecif' || item == '*'>
													<Cell>
														...
														<#if data.productId.productSpecif??><Data ss:Type="String"><![CDATA[${(data.productId.productSpecif)!}]]></Data></#if>
												...
												<#if item == 'quantity' || item == '*'>
													<Cell>
														...
														<#if (data.quantity)?has_content><Data ss:Type="Number">#{(data.quantity)!; m6M6}</Data></#if>
												...
												<#if item == 'formularID.produceType.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.formularID.produceType.value)!}')}</Data>
												...
												<#if item == 'factoryCode.name' || item == '*'>
													<Cell>
														...
														<#if data.factoryCode.name??><Data ss:Type="String"><![CDATA[${(data.factoryCode.name)!}]]></Data></#if>
												...
												<#if item == 'formularID.supportEbr' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.formularID.supportEbr?? && data.formularID.supportEbr>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
