...
<script type="text/javascript">
	CUI.ns("WOM.producePlanRef.dayBatchPlanParts","WOM.producePlanRef.dayBatchPlanParts.batchPlanRef");
</script>
<div class="container"  style="padding-top:10px;">
	...
	<div id="ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_queryForm_inputValue">
	...
	<form onsubmit="return false" id="ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_queryForm" exportUrl="/WOM/producePlanRef/dayBatchPlanParts/batchPlanRef-query.action">
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
											...
											<input type="hidden" id="dayPlanInfo.id" name="dayPlanInfo.id" value="" />
												<@mneclient mneenable=false isPrecise=true isCrossCompany=isCrossCompany reftitle="${getText('')}"  conditionfunc="WOM.producePlanRef.dayBatchPlanParts.batchPlanRef._querycustomFunc('dayPlanInfo_tableNo')" name="dayPlanInfo.tableNo" id="ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_queryForm_dayPlanInfo_tableNo" displayFieldName="tableNo" type="other" exp="like" classStyle="form-control" url="" clicked=true multiple=false mnewidth=260 formId="ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_queryForm" searchClick="WOM.producePlanRef.dayBatchPlanParts.batchPlanRef.commonQuery('query')" />
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
											...
											<input type="hidden" id="productId.id" name="productId.id" value="" />
												<@mneclient mneenable=true isPrecise=true isCrossCompany=isCrossCompany reftitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  conditionfunc="WOM.producePlanRef.dayBatchPlanParts.batchPlanRef._querycustomFunc('productId_productCode')" name="productId.productCode" id="ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_queryForm_productId_productCode" displayFieldName="productCode" type="other" exp="like" classStyle="form-control" url="/MESBasic/product/product/productRefNew.action" clicked=true multiple=false mnewidth=260 formId="ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_queryForm" searchClick="WOM.producePlanRef.dayBatchPlanParts.batchPlanRef.commonQuery('query')" />
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
											...
											<input type="hidden" id="formularID.id" name="formularID.id" value="" />
												<@mneclient mneenable=true isPrecise=true isCrossCompany=isCrossCompany reftitle="${getText('RM.viewtitle.randon1488246963795')}"  conditionfunc="WOM.producePlanRef.dayBatchPlanParts.batchPlanRef._querycustomFunc('formularID_code')" name="formularID.code" id="ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_queryForm_formularID_code" displayFieldName="code" type="other" exp="equal" classStyle="form-control" url="/RM/formula/formula/formulaRef.action" clicked=true multiple=false mnewidth=260 formId="ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_queryForm" searchClick="WOM.producePlanRef.dayBatchPlanParts.batchPlanRef.commonQuery('query')" />
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
											...
											<input type="hidden" id="factoryCode.id" name="factoryCode.id" value="" />
												<@mneclient mneenable=true isPrecise=true isCrossCompany=isCrossCompany reftitle="${getText('MESBasic.viewtitle.radion1419491307826')}"  conditionfunc="WOM.producePlanRef.dayBatchPlanParts.batchPlanRef._querycustomFunc('factoryCode_name')" name="factoryCode.name" id="ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_queryForm_factoryCode_name" displayFieldName="name" type="other" exp="like" classStyle="form-control" url="/MESBasic/factoryModel/factoryModel/factroyRef1.action" clicked=true multiple=false mnewidth=260 formId="ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_queryForm" searchClick="WOM.producePlanRef.dayBatchPlanParts.batchPlanRef.commonQuery('query')" />
							...
							<div mobi-dropdown-group="startTime" field-unique-code="WOM_7_5_0_0_producePlanRef_DayBatchPlanParts_startTime_startTime" class="mobi-dropdown col-xs-12 col-sm-6 col-md-4 col-lg-4 <#if (lastQuery.value)?? && lastQuery.value == "WOM_7_5_0_0_producePlanRef_DayBatchPlanParts_startTime_startTime">mobi-dropdown-active</#if>"> 
								<div class="row">
									...
									<div class="input-group">
										...
										<@datepicker type="dateTimeMin" cssClass="form-control right-border-radius" value="${startTime_defaultValue!}" deValue="${startTime_defaultValue!}"  name="startTime_start" id="startTime_start" exp="gequal"   formid="ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_queryForm" />
									</div>
								</div>			
							</div>
						</div>
						<div mobi-dropdown-group="startTime" field-unique-code="WOM_7_5_0_0_producePlanRef_DayBatchPlanParts_startTime_startTime" class="mobi-dropdown col-xs-12 col-sm-6 col-md-4 col-lg-4 <#if (lastQuery.value)?? && lastQuery.value == "WOM_7_5_0_0_producePlanRef_DayBatchPlanParts_startTime_startTime">mobi-dropdown-active</#if>"> 
							<div class="row">
								...
								<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
									<div class="input-group">
										...
										<@datepicker type="dateTimeMin" cssClass="form-control right-border-radius" value="${startTime_defaultValue!}" deValue="${startTime_defaultValue!}"  name="startTime_end" id="startTime_end" exp="lequal"   formid="ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_queryForm" />
									</div>
									</div>			
								</div>
							</div>
							...
							<div mobi-dropdown-group="endTime" field-unique-code="WOM_7_5_0_0_producePlanRef_DayBatchPlanParts_endTime_endTime" class="mobi-dropdown col-xs-12 col-sm-6 col-md-4 col-lg-4 <#if (lastQuery.value)?? && lastQuery.value == "WOM_7_5_0_0_producePlanRef_DayBatchPlanParts_endTime_endTime">mobi-dropdown-active</#if>"> 
								<div class="row">
									...
									<div class="input-group">
										<span class="input-group-addon">${getText('ec.list.validate.start')}</span>
										<@datepicker type="dateTimeMin" cssClass="form-control right-border-radius" value="${endTime_defaultValue!}" deValue="${endTime_defaultValue!}"  name="endTime_start" id="endTime_start" exp="gequal"   formid="ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_queryForm" />
									</div>
								</div>			
							</div>
						</div>
						<div mobi-dropdown-group="endTime" field-unique-code="WOM_7_5_0_0_producePlanRef_DayBatchPlanParts_endTime_endTime" class="mobi-dropdown col-xs-12 col-sm-6 col-md-4 col-lg-4 <#if (lastQuery.value)?? && lastQuery.value == "WOM_7_5_0_0_producePlanRef_DayBatchPlanParts_endTime_endTime">mobi-dropdown-active</#if>"> 
							<div class="row">
								...
								<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
									<div class="input-group">
										<span class="input-group-addon">${getText('ec.list.validate.end')}</span>	
										<@datepicker type="dateTimeMin" cssClass="form-control right-border-radius" value="${endTime_defaultValue!}" deValue="${endTime_defaultValue!}"  name="endTime_end" id="endTime_end" exp="lequal"   formid="ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_queryForm" />
									</div>
									</div>			
								</div>
							</div>
						<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 margin-bottom-5">						
				       	<@querybutton formId="ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_queryForm" type="search" onclick="WOM.producePlanRef.dayBatchPlanParts.batchPlanRef.commonQuery('query')" /> 
...
<script>
	$(function(){
		var buttons = $( 'button.btn-list', '#ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_queryForm' );
		if( buttons.length > 0 ){
			// 去掉按钮间的空格
...
ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_quickquery_info["productId.id"].columnName="ID";
...
<script type="text/javascript">
	 ...
	 */
	WOM.producePlanRef.dayBatchPlanParts.batchPlanRef.query = function(type,pageNo){
		...
		if(!checkListValid("ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_queryForm")) {
				return false;
		}
		var dataPost = "";
		...
		url += "&crossCompanyFlag=${Parameters.crossCompanyFlag!}";
	 	datatable_ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_query.setRequestDataUrl(url,dataPost);
		return false;
	};
	...
	foundation.common.${requestUri!}__callbackFunction = function(){
		...
		var oRows = datatable_ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_query.getSelectedRow();
		if(oRows.length == 0){
		...
		try{
			if(CUI("#WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_callBackFuncName").val() != ""){
				eval(CUI("#WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_callBackFuncName").val() + "(arrObj)");
			}
		}catch(e){
		}
	};
...
WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_refresh = function(node){
	//var url = "/WOM/producePlanRef/dayBatchPlanParts/batchPlanRef-query.action";
	//if(node.layRec){
	//	datatable_ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_query.setRequestDataUrl(url,'&'+node.modelName+'.layRec=' + node.layRec,false);
	//}else{
	//	datatable_ec_WOM_producePlanRef_dayBatchPlanParts_batchPlanRef_query.setRequestDataUrl(url,'',false);
	//}
...
WOM.producePlanRef.dayBatchPlanParts.batchPlanRef.showLinkView = function(url,propertyId,row,formId,title,width,height,dialogType){
	...
	if(formId) {
		WOM.producePlanRef.dayBatchPlanParts.batchPlanRef.showDialog(url,formId,title,width,height);
	}else {
		openFullScreen(url);
	}
};
...
function checkListValid(formId){if($('#' + formId + ' input[name^="startTime_start"]').val()!= null && $('#' + formId + ' input[name^="startTime_start"]').val()!= ''){if(!isDateTime($('#' + formId + ' input[name^="startTime_start"]').val()+"")){workbenchErrorBarWidget.showMessage("${getText('WOM.propertydisplayName.randon1489823646428')}${getText('ec.list.validate.datetime')}");return false;}}if($('#' + formId + ' input[name^="startTime_end"]').val()!= null && $('#' + formId + ' input[name^="startTime_end"]').val()!= ''){if(!isDateTime($('#' + formId + ' input[name^="startTime_end"]').val()+"")){workbenchErrorBarWidget.showMessage("${getText('WOM.propertydisplayName.randon1489823646428')}${getText('ec.list.validate.datetime')}");return false;}}if($('#' + formId + ' input[name^="endTime_start"]').val()!= null && $('#' + formId + ' input[name^="endTime_start"]').val()!= ''){if(!isDateTime($('#' + formId + ' input[name^="endTime_start"]').val()+"")){workbenchErrorBarWidget.showMessage("${getText('WOM.propertydisplayName.randon1489823379542')}${getText('ec.list.validate.datetime')}");return false;}}if($('#' + formId + ' input[name^="endTime_end"]').val()!= null && $('#' + formId + ' input[name^="endTime_end"]').val()!= ''){if(!isDateTime($('#' + formId + ' input[name^="endTime_end"]').val()+"")){workbenchErrorBarWidget.showMessage("${getText('WOM.propertydisplayName.randon1489823379542')}${getText('ec.list.validate.datetime')}");return false;}}if($('#' + formId + ' input[name="startTime_start"]').val()!='' && $('#' + formId + ' input[name="startTime_end"]').val()!=''){if($('#' + formId + ' input[name="startTime_start"]').val() > $('#' + formId + ' input[name="startTime_end"]').val()){workbenchErrorBarWidget.showMessage("${getText('WOM.propertydisplayName.randon1489823646428')}${getText('ec.list.validate.end')}${getText('ec.list.validate.compare')}${getText('WOM.propertydisplayName.randon1489823646428')}${getText('ec.list.validate.start')}");return false;}}if($('#' + formId + ' input[name="endTime_start"]').val()!='' && $('#' + formId + ' input[name="endTime_end"]').val()!=''){if($('#' + formId + ' input[name="endTime_start"]').val() > $('#' + formId + ' input[name="endTime_end"]').val()){workbenchErrorBarWidget.showMessage("${getText('WOM.propertydisplayName.randon1489823379542')}${getText('ec.list.validate.end')}${getText('ec.list.validate.compare')}${getText('WOM.propertydisplayName.randon1489823379542')}${getText('ec.list.validate.start')}");return false;}}return true;};
	...
	/* CUSTOM CODE START(view-REFERENCE-WOM_7.5.0.0_producePlanRef_batchPlanRef,js,WOM_7.5.0.0_producePlanRef_DayBatchPlanParts,WOM_7.5.0.0) */
// 自定义代码
/* CUSTOM CODE END */
	</script>
  </body>
