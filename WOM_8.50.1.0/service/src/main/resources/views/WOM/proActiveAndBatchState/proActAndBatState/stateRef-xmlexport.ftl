...
<#assign viewCode = 'WOM_7.5.0.0_proActiveAndBatchState_ProActAndBatState' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		<Style ss:ID="activeBatchStateID.batchUse">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="activeBatchStateID.isConclusion">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="activeBatchStateID.isInitial">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		...
	  		<Style ss:ID="activeEnd">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="qualifiedPass">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="quaWithoutPass">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="regectsDeal">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="remark">
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'activeBatchStateID.isInitial' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'activeBatchStateID.isConclusion' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'quaWithoutPass' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'regectsDeal' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'qualifiedPass' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'activeEnd.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
											...
											<#if item == 'activeBatchStateID.batchUseForDisplay' || item == '*'>
														 <#if item?index_of('.')!=-1>  
															<Column ss:Index="${count}" ss:StyleID="${item?substring(0,item?last_index_of('.'))}"  ss:Width="140"/>
														 <#else>
														    <Column ss:Index="${count}" ss:StyleID="${item}"  ss:Width="140" />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'activeBatchStateID.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('publicSet.propertydisplayName.randon1509427955424')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'activeBatchStateID.isInitial' || item == '*'>
													<Cell><Data ss:Type="String">${getText('publicSet.propertydisplayName.randon1509427974756')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'activeBatchStateID.isConclusion' || item == '*'>
													<Cell><Data ss:Type="String">${getText('publicSet.propertydisplayName.randon1509427994356')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'quaWithoutPass' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1509445588580')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'regectsDeal' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1509445608978')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'qualifiedPass' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1509445631497')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'activeEnd.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1509445866110')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'activeBatchStateID.batchUseForDisplay' || item == '*'>
													<Cell><Data ss:Type="String">${getText('publicSet.propertydisplayName.randon1509428719202')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'remark' || item == '*'>
													<Cell><Data ss:Type="String">${getText('WOM.propertydisplayName.randon1509445670888')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												<#if item == 'activeBatchStateID.name' || item == '*'>
													<Cell>
														...
														<#if data.activeBatchStateID.name??><Data ss:Type="String"><![CDATA[${(data.activeBatchStateID.name)!}]]></Data></#if>
												...
												<#if item == 'activeBatchStateID.isInitial' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.activeBatchStateID.isInitial?? && data.activeBatchStateID.isInitial>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'activeBatchStateID.isConclusion' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.activeBatchStateID.isConclusion?? && data.activeBatchStateID.isConclusion>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'quaWithoutPass' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.quaWithoutPass?? && data.quaWithoutPass>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'regectsDeal' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.regectsDeal?? && data.regectsDeal>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'qualifiedPass' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.qualifiedPass?? && data.qualifiedPass>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'activeEnd.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.activeEnd.value)!}')}</Data>
												...
												<#if item == 'activeBatchStateID.batchUseForDisplay' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.activeBatchStateID.batchUse)!}')}</Data>
