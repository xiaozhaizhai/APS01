...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=WOM_7.5.0.0_prepareMaterial";
	openExportFrame(url);
}
...
<div id="WOM_prepareMaterial_prepareMaterialPart_prepareDetailsList_attachment">	
