...
@Service("wOMCraftStandardsImportService")
public class WOMCraftStandardsImportServiceImpl implements WOMCraftStandardsImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_procFeedback",model="WOM_7.5.0.0_procFeedback_CraftStandards",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMCraftStandards bizObj, WOMCraftStandards oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMCraftStandards bizObj, String bussinesskeyFieldName,
