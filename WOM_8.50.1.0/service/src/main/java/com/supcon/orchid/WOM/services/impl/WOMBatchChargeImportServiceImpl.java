...
@Service("wOMBatchChargeImportService")
public class WOMBatchChargeImportServiceImpl implements WOMBatchChargeImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_procFeedback",model="WOM_7.5.0.0_procFeedback_BatchCharge",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMBatchCharge bizObj, WOMBatchCharge oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMBatchCharge bizObj, String bussinesskeyFieldName,
