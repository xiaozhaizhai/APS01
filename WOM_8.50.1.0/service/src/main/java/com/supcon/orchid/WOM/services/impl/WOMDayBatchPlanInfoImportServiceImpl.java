...
@Service("wOMDayBatchPlanInfoImportService")
public class WOMDayBatchPlanInfoImportServiceImpl implements WOMDayBatchPlanInfoImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_producePlanRef",model="WOM_7.5.0.0_producePlanRef_DayBatchPlanInfo",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMDayBatchPlanInfo bizObj, WOMDayBatchPlanInfo oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("WOM.entityname.randon1489822754667") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("WOM.entityname.randon1489822754667") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(WOMDayBatchPlanInfo bizObj, String bussinesskeyFieldName,
