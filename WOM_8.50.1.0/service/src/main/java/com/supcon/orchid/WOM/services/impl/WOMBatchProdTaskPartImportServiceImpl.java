...
@Service("wOMBatchProdTaskPartImportService")
public class WOMBatchProdTaskPartImportServiceImpl implements WOMBatchProdTaskPartImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_batchProduceTask",model="WOM_7.5.0.0_batchProduceTask_BatchProdTaskPart",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMBatchProdTaskPart bizObj, WOMBatchProdTaskPart oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMBatchProdTaskPart bizObj, String bussinesskeyFieldName,
