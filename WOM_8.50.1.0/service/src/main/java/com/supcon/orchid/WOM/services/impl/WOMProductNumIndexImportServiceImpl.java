...
@Service("wOMProductNumIndexImportService")
public class WOMProductNumIndexImportServiceImpl implements WOMProductNumIndexImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_produceTask",model="WOM_7.5.0.0_produceTask_ProductNumIndex",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMProductNumIndex bizObj, WOMProductNumIndex oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMProductNumIndex bizObj, String bussinesskeyFieldName,
