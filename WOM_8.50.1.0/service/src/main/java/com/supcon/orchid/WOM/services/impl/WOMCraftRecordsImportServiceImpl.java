...
@Service("wOMCraftRecordsImportService")
public class WOMCraftRecordsImportServiceImpl implements WOMCraftRecordsImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_procFeedback",model="WOM_7.5.0.0_procFeedback_CraftRecords",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMCraftRecords bizObj, WOMCraftRecords oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMCraftRecords bizObj, String bussinesskeyFieldName,
