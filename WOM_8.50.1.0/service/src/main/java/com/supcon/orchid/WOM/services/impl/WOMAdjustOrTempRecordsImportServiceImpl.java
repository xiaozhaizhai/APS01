...
@Service("wOMAdjustOrTempRecordsImportService")
public class WOMAdjustOrTempRecordsImportServiceImpl implements WOMAdjustOrTempRecordsImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_produceTask",model="WOM_7.5.0.0_produceTask_AdjustOrTempRecords",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMAdjustOrTempRecords bizObj, WOMAdjustOrTempRecords oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMAdjustOrTempRecords bizObj, String bussinesskeyFieldName,
