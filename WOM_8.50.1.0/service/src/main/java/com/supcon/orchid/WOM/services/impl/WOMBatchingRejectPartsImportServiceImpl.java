...
@Service("wOMBatchingRejectPartsImportService")
public class WOMBatchingRejectPartsImportServiceImpl implements WOMBatchingRejectPartsImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_batchingMaterial",model="WOM_7.5.0.0_batchingMaterial_BatchingRejectParts",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMBatchingRejectParts bizObj, WOMBatchingRejectParts oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMBatchingRejectParts bizObj, String bussinesskeyFieldName,
