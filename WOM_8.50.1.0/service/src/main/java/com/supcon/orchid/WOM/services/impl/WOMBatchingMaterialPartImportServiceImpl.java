...
@Service("wOMBatchingMaterialPartImportService")
public class WOMBatchingMaterialPartImportServiceImpl implements WOMBatchingMaterialPartImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_batchingMaterial",model="WOM_7.5.0.0_batchingMaterial_BatchingMaterialPart",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMBatchingMaterialPart bizObj, WOMBatchingMaterialPart oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMBatchingMaterialPart bizObj, String bussinesskeyFieldName,
