...
@Service("wOMTaskReportingPartImportService")
public class WOMTaskReportingPartImportServiceImpl implements WOMTaskReportingPartImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_taskReporting",model="WOM_7.5.0.0_taskReporting_TaskReportingPart",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMTaskReportingPart bizObj, WOMTaskReportingPart oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMTaskReportingPart bizObj, String bussinesskeyFieldName,
