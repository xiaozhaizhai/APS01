...
@Service("wOMTaskReportManageImportService")
public class WOMTaskReportManageImportServiceImpl implements WOMTaskReportManageImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_generalManage",model="WOM_7.5.0.0_generalManage_TaskReportManage",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMTaskReportManage bizObj, WOMTaskReportManage oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMTaskReportManage bizObj, String bussinesskeyFieldName,
