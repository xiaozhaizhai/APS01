...
@Service("wOMAdjustOrTempHeadImportService")
public class WOMAdjustOrTempHeadImportServiceImpl implements WOMAdjustOrTempHeadImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_produceTask",model="WOM_7.5.0.0_produceTask_AdjustOrTempHead",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMAdjustOrTempHead bizObj, WOMAdjustOrTempHead oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMAdjustOrTempHead bizObj, String bussinesskeyFieldName,
