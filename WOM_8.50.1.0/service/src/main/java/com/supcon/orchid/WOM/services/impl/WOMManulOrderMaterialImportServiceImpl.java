...
@Service("wOMManulOrderMaterialImportService")
public class WOMManulOrderMaterialImportServiceImpl implements WOMManulOrderMaterialImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_manulOrder",model="WOM_7.5.0.0_manulOrder_ManulOrderMaterial",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMManulOrderMaterial bizObj, WOMManulOrderMaterial oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("WOM.entityname.randon1563192160390") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("WOM.entityname.randon1563192160390") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(WOMManulOrderMaterial bizObj, String bussinesskeyFieldName,
