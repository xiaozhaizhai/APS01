...
@Service("wOMInspectImportService")
public class WOMInspectImportServiceImpl implements WOMInspectImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_generalManage",model="WOM_7.5.0.0_generalManage_Inspect",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMInspect bizObj, WOMInspect oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMInspect bizObj, String bussinesskeyFieldName,
