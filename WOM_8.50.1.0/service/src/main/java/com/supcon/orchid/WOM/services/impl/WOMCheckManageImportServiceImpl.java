...
@Service("wOMCheckManageImportService")
public class WOMCheckManageImportServiceImpl implements WOMCheckManageImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_generalManage",model="WOM_7.5.0.0_generalManage_CheckManage",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMCheckManage bizObj, WOMCheckManage oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMCheckManage bizObj, String bussinesskeyFieldName,
