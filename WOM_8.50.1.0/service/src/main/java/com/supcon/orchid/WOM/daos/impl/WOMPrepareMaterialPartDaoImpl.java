...
@Repository
public class WOMPrepareMaterialPartDaoImpl extends ExtendedGenericDaoImpl<WOMPrepareMaterialPart, Long> implements WOMPrepareMaterialPartDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_prepareMaterial_PrepareMaterialPart,WOM_7.5.0.0) */
// 自定义代码
