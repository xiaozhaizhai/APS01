...
@Service("wOMProdTaskActiExelogImportService")
public class WOMProdTaskActiExelogImportServiceImpl implements WOMProdTaskActiExelogImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_produceTask",model="WOM_7.5.0.0_produceTask_ProdTaskActiExelog",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMProdTaskActiExelog bizObj, WOMProdTaskActiExelog oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMProdTaskActiExelog bizObj, String bussinesskeyFieldName,
