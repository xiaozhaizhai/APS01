...
@Service("wOMProduceMaterialSumImportService")
public class WOMProduceMaterialSumImportServiceImpl implements WOMProduceMaterialSumImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_produceTask",model="WOM_7.5.0.0_produceTask_ProduceMaterialSum",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMProduceMaterialSum bizObj, WOMProduceMaterialSum oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMProduceMaterialSum bizObj, String bussinesskeyFieldName,
