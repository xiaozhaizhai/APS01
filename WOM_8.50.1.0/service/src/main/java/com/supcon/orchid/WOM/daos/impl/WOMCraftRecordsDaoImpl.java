...
@Repository
public class WOMCraftRecordsDaoImpl extends ExtendedGenericDaoImpl<WOMCraftRecords, Long> implements WOMCraftRecordsDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_procFeedback_CraftRecords,WOM_7.5.0.0) */
// 自定义代码
