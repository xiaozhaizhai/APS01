...
@Repository
public class WOMBatchingRejectPartsDaoImpl extends ExtendedGenericDaoImpl<WOMBatchingRejectParts, Long> implements WOMBatchingRejectPartsDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_batchingMaterial_BatchingRejectParts,WOM_7.5.0.0) */
// 自定义代码
