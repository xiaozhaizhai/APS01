...
@Service("wOMPrepareMaterialPartImportService")
public class WOMPrepareMaterialPartImportServiceImpl implements WOMPrepareMaterialPartImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_prepareMaterial",model="WOM_7.5.0.0_prepareMaterial_PrepareMaterialPart",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMPrepareMaterialPart bizObj, WOMPrepareMaterialPart oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMPrepareMaterialPart bizObj, String bussinesskeyFieldName,
