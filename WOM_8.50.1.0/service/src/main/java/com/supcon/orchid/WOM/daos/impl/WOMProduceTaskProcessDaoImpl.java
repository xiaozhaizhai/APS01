...
@Repository
public class WOMProduceTaskProcessDaoImpl extends ExtendedGenericDaoImpl<WOMProduceTaskProcess, Long> implements WOMProduceTaskProcessDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_produceTask_ProduceTaskProcess,WOM_7.5.0.0) */
// 自定义代码
