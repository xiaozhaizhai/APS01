...
@Repository
public class WOMTaskBeforeProcessDaoImpl extends ExtendedGenericDaoImpl<WOMTaskBeforeProcess, Long> implements WOMTaskBeforeProcessDao {
	...
	public DataClassific getDataClassific(String code) {
	 ...
	 /* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_produceTask_TaskBeforeProcess,WOM_7.5.0.0) */
// 自定义代码
/* CUSTOM CODE END */
}