...
@Service("wOMMaterialsOutputImportService")
public class WOMMaterialsOutputImportServiceImpl implements WOMMaterialsOutputImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_produceRecords",model="WOM_7.5.0.0_produceRecords_MaterialsOutput",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMMaterialsOutput bizObj, WOMMaterialsOutput oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("WOM.entityname.randon1541146558377") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("WOM.entityname.randon1541146558377") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(WOMMaterialsOutput bizObj, String bussinesskeyFieldName,
