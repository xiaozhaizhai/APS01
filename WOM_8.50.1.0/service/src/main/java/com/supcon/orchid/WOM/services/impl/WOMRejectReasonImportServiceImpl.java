...
@Service("wOMRejectReasonImportService")
public class WOMRejectReasonImportServiceImpl implements WOMRejectReasonImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_materialReject",model="WOM_7.5.0.0_materialReject_RejectReason",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMRejectReason bizObj, WOMRejectReason oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("WOM.entityname.randon1543218605993") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("WOM.entityname.randon1543218605993") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(WOMRejectReason bizObj, String bussinesskeyFieldName,
