...
@Service("wOMInventoryRecordImportService")
public class WOMInventoryRecordImportServiceImpl implements WOMInventoryRecordImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_inventoryRecords",model="WOM_7.5.0.0_inventoryRecords_InventoryRecord",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMInventoryRecord bizObj, WOMInventoryRecord oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("WOM.entityname.randon1566887979029") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("WOM.entityname.randon1566887979029") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(WOMInventoryRecord bizObj, String bussinesskeyFieldName,
