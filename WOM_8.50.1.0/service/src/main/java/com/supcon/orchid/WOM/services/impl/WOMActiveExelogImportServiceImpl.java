...
@Service("wOMActiveExelogImportService")
public class WOMActiveExelogImportServiceImpl implements WOMActiveExelogImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_activeExelog",model="WOM_7.5.0.0_activeExelog_ActiveExelog",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMActiveExelog bizObj, WOMActiveExelog oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("WOM.entityname.randon1495533983333") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("WOM.entityname.randon1495533983333") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(WOMActiveExelog bizObj, String bussinesskeyFieldName,
