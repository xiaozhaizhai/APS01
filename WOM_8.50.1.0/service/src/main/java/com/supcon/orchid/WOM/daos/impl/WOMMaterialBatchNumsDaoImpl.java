...
@Repository
public class WOMMaterialBatchNumsDaoImpl extends ExtendedGenericDaoImpl<WOMMaterialBatchNums, Long> implements WOMMaterialBatchNumsDao {
	...
	public DataClassific getDataClassific(String code) {
	 ...
	 /* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_produceTask_MaterialBatchNums,WOM_7.5.0.0) */
// 自定义代码
/* CUSTOM CODE END */
}