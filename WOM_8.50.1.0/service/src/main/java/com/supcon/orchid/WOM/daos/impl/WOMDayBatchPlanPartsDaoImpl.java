...
@Repository
public class WOMDayBatchPlanPartsDaoImpl extends ExtendedGenericDaoImpl<WOMDayBatchPlanParts, Long> implements WOMDayBatchPlanPartsDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_producePlanRef_DayBatchPlanParts,WOM_7.5.0.0) */
// 自定义代码
