...
@Repository
public class WOMManulOrderMaterialDaoImpl extends ExtendedGenericDaoImpl<WOMManulOrderMaterial, Long> implements WOMManulOrderMaterialDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_manulOrder_ManulOrderMaterial,WOM_7.5.0.0) */
// 自定义代码
