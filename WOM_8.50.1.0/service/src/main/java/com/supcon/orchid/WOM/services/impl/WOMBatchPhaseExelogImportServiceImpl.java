...
@Service("wOMBatchPhaseExelogImportService")
public class WOMBatchPhaseExelogImportServiceImpl implements WOMBatchPhaseExelogImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_produceTask",model="WOM_7.5.0.0_produceTask_BatchPhaseExelog",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMBatchPhaseExelog bizObj, WOMBatchPhaseExelog oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMBatchPhaseExelog bizObj, String bussinesskeyFieldName,
