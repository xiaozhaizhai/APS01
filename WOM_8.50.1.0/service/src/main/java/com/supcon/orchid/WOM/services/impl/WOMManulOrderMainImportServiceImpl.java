...
@Service("wOMManulOrderMainImportService")
public class WOMManulOrderMainImportServiceImpl implements WOMManulOrderMainImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_manulOrder",model="WOM_7.5.0.0_manulOrder_ManulOrderMain",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMManulOrderMain bizObj, WOMManulOrderMain oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMManulOrderMain bizObj, String bussinesskeyFieldName,
