...
@Repository
public class WOMProductNumIndexDaoImpl extends ExtendedGenericDaoImpl<WOMProductNumIndex, Long> implements WOMProductNumIndexDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_produceTask_ProductNumIndex,WOM_7.5.0.0) */
// 自定义代码
