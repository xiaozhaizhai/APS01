...
@Service("wOMProduceTaskManageImportService")
public class WOMProduceTaskManageImportServiceImpl implements WOMProduceTaskManageImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_generalManage",model="WOM_7.5.0.0_generalManage_ProduceTaskManage",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMProduceTaskManage bizObj, WOMProduceTaskManage oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("WOM.entityname.randon1502695503593") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("WOM.entityname.randon1502695503593") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(WOMProduceTaskManage bizObj, String bussinesskeyFieldName,
