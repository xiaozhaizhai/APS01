...
@Repository
public class WOMTaskReportManageDaoImpl extends ExtendedGenericDaoImpl<WOMTaskReportManage, Long> implements WOMTaskReportManageDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_generalManage_TaskReportManage,WOM_7.5.0.0) */
// 自定义代码
