...
@Service("wOMPrepareMaterialImportService")
public class WOMPrepareMaterialImportServiceImpl implements WOMPrepareMaterialImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_prepareMaterial",model="WOM_7.5.0.0_prepareMaterial_PrepareMaterial",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMPrepareMaterial bizObj, WOMPrepareMaterial oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("WOM.entityname.randon1489976457717") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("WOM.entityname.randon1489976457717") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(WOMPrepareMaterial bizObj, String bussinesskeyFieldName,
