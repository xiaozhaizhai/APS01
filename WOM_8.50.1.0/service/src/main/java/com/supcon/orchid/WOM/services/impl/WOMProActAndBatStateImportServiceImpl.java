...
@Service("wOMProActAndBatStateImportService")
public class WOMProActAndBatStateImportServiceImpl implements WOMProActAndBatStateImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_proActiveAndBatchState",model="WOM_7.5.0.0_proActiveAndBatchState_ProActAndBatState",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMProActAndBatState bizObj, WOMProActAndBatState oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("WOM.entityname.randon1509445475842") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("WOM.entityname.randon1509445475842") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(WOMProActAndBatState bizObj, String bussinesskeyFieldName,
