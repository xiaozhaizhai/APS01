...
@Service("wOMProduceTaskProcessImportService")
public class WOMProduceTaskProcessImportServiceImpl implements WOMProduceTaskProcessImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_produceTask",model="WOM_7.5.0.0_produceTask_ProduceTaskProcess",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMProduceTaskProcess bizObj, WOMProduceTaskProcess oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMProduceTaskProcess bizObj, String bussinesskeyFieldName,
