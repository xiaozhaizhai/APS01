...
@Repository
public class WOMProduceTaskActiveDaoImpl extends ExtendedGenericDaoImpl<WOMProduceTaskActive, Long> implements WOMProduceTaskActiveDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_produceTask_ProduceTaskActive,WOM_7.5.0.0) */
// 自定义代码
