...
@Service("wOMDayBatchPlanPartsImportService")
public class WOMDayBatchPlanPartsImportServiceImpl implements WOMDayBatchPlanPartsImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_producePlanRef",model="WOM_7.5.0.0_producePlanRef_DayBatchPlanParts",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMDayBatchPlanParts bizObj, WOMDayBatchPlanParts oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMDayBatchPlanParts bizObj, String bussinesskeyFieldName,
