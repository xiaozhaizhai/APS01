...
@Repository
public class WOMProActAndBatStateDaoImpl extends ExtendedGenericDaoImpl<WOMProActAndBatState, Long> implements WOMProActAndBatStateDao {
	@Override
	...
	@Override
	public WOMProActAndBatStateDealInfo copyAndSaveDealInfo(DealInfo di) {
		WOMProActAndBatStateDealInfo dealInfo = new WOMProActAndBatStateDealInfo();
	...
	@Override
	public WOMProActAndBatStateDealInfo copyAndSaveDealInfo(DealInfo di, WOMProActAndBatState mainObj, Staff dealStaff) {
		WOMProActAndBatStateDealInfo dealInfo = copyAndSaveDealInfo(di);
	...
	public Date findLastDealInfo(Long tableInfoId, String activityName) {
		Criteria criteria = getSession().createCriteria(WOMProActAndBatStateDealInfo.class);
		...
		List<WOMProActAndBatStateDealInfo> dealinfo = criteria.list();
		return (dealinfo!=null&&!dealinfo.isEmpty()) ? dealinfo.get(0).getCreateTime() : null;
	}

	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_proActiveAndBatchState_ProActAndBatState,WOM_7.5.0.0) */
// 自定义代码
