...
@Service("wOMPutMaterialExceptionImportService")
public class WOMPutMaterialExceptionImportServiceImpl implements WOMPutMaterialExceptionImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_putInMaterialException",model="WOM_7.5.0.0_putInMaterialException_PutMaterialException",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMPutMaterialException bizObj, WOMPutMaterialException oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("WOM.entityname.randon1494811888680") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("WOM.entityname.randon1494811888680") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(WOMPutMaterialException bizObj, String bussinesskeyFieldName,
