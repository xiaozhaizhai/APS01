...
@Service("wOMBatchNumRuleImportService")
public class WOMBatchNumRuleImportServiceImpl implements WOMBatchNumRuleImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_batchNumRule",model="WOM_7.5.0.0_batchNumRule_BatchNumRule",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMBatchNumRule bizObj, WOMBatchNumRule oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("WOM.entityname.randon1490408941607") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("WOM.entityname.randon1490408941607") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(WOMBatchNumRule bizObj, String bussinesskeyFieldName,
