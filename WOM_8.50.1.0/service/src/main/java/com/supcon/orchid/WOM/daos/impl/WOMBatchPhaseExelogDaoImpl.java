...
@Repository
public class WOMBatchPhaseExelogDaoImpl extends ExtendedGenericDaoImpl<WOMBatchPhaseExelog, Long> implements WOMBatchPhaseExelogDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_produceTask_BatchPhaseExelog,WOM_7.5.0.0) */
// 自定义代码
