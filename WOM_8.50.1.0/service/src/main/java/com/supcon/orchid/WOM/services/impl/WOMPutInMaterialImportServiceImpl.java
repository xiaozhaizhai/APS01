...
@Service("wOMPutInMaterialImportService")
public class WOMPutInMaterialImportServiceImpl implements WOMPutInMaterialImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_putInMaterial",model="WOM_7.5.0.0_putInMaterial_PutInMaterial",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMPutInMaterial bizObj, WOMPutInMaterial oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("WOM.entityname.randon1490604762072") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("WOM.entityname.randon1490604762072") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(WOMPutInMaterial bizObj, String bussinesskeyFieldName,
