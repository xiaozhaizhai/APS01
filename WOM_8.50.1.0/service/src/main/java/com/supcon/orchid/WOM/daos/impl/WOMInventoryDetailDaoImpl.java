...
@Repository
public class WOMInventoryDetailDaoImpl extends ExtendedGenericDaoImpl<WOMInventoryDetail, Long> implements WOMInventoryDetailDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_inventoryRecords_InventoryDetail,WOM_7.5.0.0) */
// 自定义代码
