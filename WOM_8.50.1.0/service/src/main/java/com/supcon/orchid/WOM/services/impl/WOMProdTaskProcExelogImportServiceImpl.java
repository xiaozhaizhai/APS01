...
@Service("wOMProdTaskProcExelogImportService")
public class WOMProdTaskProcExelogImportServiceImpl implements WOMProdTaskProcExelogImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_produceTask",model="WOM_7.5.0.0_produceTask_ProdTaskProcExelog",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMProdTaskProcExelog bizObj, WOMProdTaskProcExelog oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMProdTaskProcExelog bizObj, String bussinesskeyFieldName,
