...
@Repository
public class WOMWaitPutinRecordsDaoImpl extends ExtendedGenericDaoImpl<WOMWaitPutinRecords, Long> implements WOMWaitPutinRecordsDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_produceTask_WaitPutinRecords,WOM_7.5.0.0) */
// 自定义代码
