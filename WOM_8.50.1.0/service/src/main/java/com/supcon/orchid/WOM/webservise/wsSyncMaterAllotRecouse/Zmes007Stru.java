...
/**
 * <p>Zmes007Stru complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="Zmes007Stru"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Lgort2" type="{urn:sap-com:document:sap:rfc:functions}char4"/&gt;
 *         &lt;element name="Steps" type="{urn:sap-com:document:sap:rfc:functions}char1"/&gt;
...
@XmlType(name = "Zmes007Stru", propOrder = {
    "datum",
    "uzeit",
    "numb",
    "uname",
...
public class Zmes007Stru {
    ...
    @XmlElement(name = "Lgort2", required = true)
    protected String lgort2;
     ...
     *     
     */
    public void setLgort2(String value) {
        this.lgort2 = value;
    }
