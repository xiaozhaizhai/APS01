...
@Service("wOMProcFeedbackHeadImportService")
public class WOMProcFeedbackHeadImportServiceImpl implements WOMProcFeedbackHeadImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_procFeedback",model="WOM_7.5.0.0_procFeedback_ProcFeedbackHead",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMProcFeedbackHead bizObj, WOMProcFeedbackHead oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("WOM.entityname.randon1540952358311") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("WOM.entityname.randon1540952358311") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(WOMProcFeedbackHead bizObj, String bussinesskeyFieldName,
