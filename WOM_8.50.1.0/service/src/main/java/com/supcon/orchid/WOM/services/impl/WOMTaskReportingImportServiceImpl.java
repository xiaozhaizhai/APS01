...
@Service("wOMTaskReportingImportService")
public class WOMTaskReportingImportServiceImpl implements WOMTaskReportingImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_taskReporting",model="WOM_7.5.0.0_taskReporting_TaskReporting",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMTaskReporting bizObj, WOMTaskReporting oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("WOM.entityname.randon1490772713348") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("WOM.entityname.randon1490772713348") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(WOMTaskReporting bizObj, String bussinesskeyFieldName,
