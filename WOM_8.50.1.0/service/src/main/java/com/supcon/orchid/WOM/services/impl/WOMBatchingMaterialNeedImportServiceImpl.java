...
@Service("wOMBatchingMaterialNeedImportService")
public class WOMBatchingMaterialNeedImportServiceImpl implements WOMBatchingMaterialNeedImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_batchingMaterialNeed",model="WOM_7.5.0.0_batchingMaterialNeed_BatchingMaterialNeed",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMBatchingMaterialNeed bizObj, WOMBatchingMaterialNeed oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("WOM.entityname.randon1490613727875") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("WOM.entityname.randon1490613727875") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(WOMBatchingMaterialNeed bizObj, String bussinesskeyFieldName,
