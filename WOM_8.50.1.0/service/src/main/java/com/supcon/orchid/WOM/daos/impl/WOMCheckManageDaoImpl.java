...
@Repository
public class WOMCheckManageDaoImpl extends ExtendedGenericDaoImpl<WOMCheckManage, Long> implements WOMCheckManageDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_generalManage_CheckManage,WOM_7.5.0.0) */
// 自定义代码
