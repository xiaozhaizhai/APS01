...
@Service("wOMProduceTaskImportService")
public class WOMProduceTaskImportServiceImpl implements WOMProduceTaskImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_produceTask",model="WOM_7.5.0.0_produceTask_ProduceTask",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMProduceTask bizObj, WOMProduceTask oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("WOM.entityname.randon1489657790851") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("WOM.entityname.randon1489657790851") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(WOMProduceTask bizObj, String bussinesskeyFieldName,
