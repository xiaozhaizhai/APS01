...
@Service("wOMInventoryDetailImportService")
public class WOMInventoryDetailImportServiceImpl implements WOMInventoryDetailImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_inventoryRecords",model="WOM_7.5.0.0_inventoryRecords_InventoryDetail",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMInventoryDetail bizObj, WOMInventoryDetail oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMInventoryDetail bizObj, String bussinesskeyFieldName,
