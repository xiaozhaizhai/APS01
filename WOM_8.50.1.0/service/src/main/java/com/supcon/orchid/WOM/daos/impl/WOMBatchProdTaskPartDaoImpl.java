...
@Repository
public class WOMBatchProdTaskPartDaoImpl extends ExtendedGenericDaoImpl<WOMBatchProdTaskPart, Long> implements WOMBatchProdTaskPartDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_batchProduceTask_BatchProdTaskPart,WOM_7.5.0.0) */
// 自定义代码
