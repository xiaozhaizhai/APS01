...
@Service("wOMPutInMaterialPartImportService")
public class WOMPutInMaterialPartImportServiceImpl implements WOMPutInMaterialPartImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_putInMaterial",model="WOM_7.5.0.0_putInMaterial_PutInMaterialPart",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMPutInMaterialPart bizObj, WOMPutInMaterialPart oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMPutInMaterialPart bizObj, String bussinesskeyFieldName,
