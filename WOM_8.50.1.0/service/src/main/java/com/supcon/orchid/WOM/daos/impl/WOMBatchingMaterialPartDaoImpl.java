...
@Repository
public class WOMBatchingMaterialPartDaoImpl extends ExtendedGenericDaoImpl<WOMBatchingMaterialPart, Long> implements WOMBatchingMaterialPartDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_batchingMaterial_BatchingMaterialPart,WOM_7.5.0.0) */
// 自定义代码
