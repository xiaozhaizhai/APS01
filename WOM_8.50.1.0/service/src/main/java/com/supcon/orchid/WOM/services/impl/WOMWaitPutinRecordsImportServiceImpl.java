...
@Service("wOMWaitPutinRecordsImportService")
public class WOMWaitPutinRecordsImportServiceImpl implements WOMWaitPutinRecordsImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_produceTask",model="WOM_7.5.0.0_produceTask_WaitPutinRecords",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMWaitPutinRecords bizObj, WOMWaitPutinRecords oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMWaitPutinRecords bizObj, String bussinesskeyFieldName,
