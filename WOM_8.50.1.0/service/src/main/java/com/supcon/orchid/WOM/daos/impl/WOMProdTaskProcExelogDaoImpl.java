...
@Repository
public class WOMProdTaskProcExelogDaoImpl extends ExtendedGenericDaoImpl<WOMProdTaskProcExelog, Long> implements WOMProdTaskProcExelogDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_produceTask_ProdTaskProcExelog,WOM_7.5.0.0) */
// 自定义代码
