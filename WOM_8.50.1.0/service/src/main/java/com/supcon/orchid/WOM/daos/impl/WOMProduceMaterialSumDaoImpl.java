...
@Repository
public class WOMProduceMaterialSumDaoImpl extends ExtendedGenericDaoImpl<WOMProduceMaterialSum, Long> implements WOMProduceMaterialSumDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_produceTask_ProduceMaterialSum,WOM_7.5.0.0) */
// 自定义代码
