...
@Repository
public class WOMBatchChargeDetailsDaoImpl extends ExtendedGenericDaoImpl<WOMBatchChargeDetails, Long> implements WOMBatchChargeDetailsDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_produceTask_BatchChargeDetails,WOM_7.5.0.0) */
// 自定义代码
