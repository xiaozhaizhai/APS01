...
@Repository
public class WOMMakeBatOrderHeadDaoImpl extends ExtendedGenericDaoImpl<WOMMakeBatOrderHead, Long> implements WOMMakeBatOrderHeadDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_batchingMaterialNeed_MakeBatOrderHead,WOM_7.5.0.0) */
// 自定义代码
