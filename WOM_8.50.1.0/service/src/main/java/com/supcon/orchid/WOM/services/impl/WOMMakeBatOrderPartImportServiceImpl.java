...
@Service("wOMMakeBatOrderPartImportService")
public class WOMMakeBatOrderPartImportServiceImpl implements WOMMakeBatOrderPartImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_batchingMaterialNeed",model="WOM_7.5.0.0_batchingMaterialNeed_MakeBatOrderPart",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMMakeBatOrderPart bizObj, WOMMakeBatOrderPart oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMMakeBatOrderPart bizObj, String bussinesskeyFieldName,
