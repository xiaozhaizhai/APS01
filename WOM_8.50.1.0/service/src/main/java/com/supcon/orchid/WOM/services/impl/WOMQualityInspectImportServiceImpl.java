...
@Service("wOMQualityInspectImportService")
public class WOMQualityInspectImportServiceImpl implements WOMQualityInspectImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_qualityRecords",model="WOM_7.5.0.0_qualityRecords_QualityInspect",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMQualityInspect bizObj, WOMQualityInspect oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("WOM.entityname.randon1541146480273") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("WOM.entityname.randon1541146480273") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(WOMQualityInspect bizObj, String bussinesskeyFieldName,
