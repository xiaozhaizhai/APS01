...
import com.supcon.orchid.WOM.daos.WOMCheckReportDao;
...
@Repository
public class WOMCheckReportDaoImpl extends ExtendedGenericDaoImpl<WOMCheckReport, Long> implements WOMCheckReportDao {
	...
	public DataClassific getDataClassific(String code) {
	 ...
	 /* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_generalManage_CheckReport,WOM_7.5.0.0) */
// 自定义代码
