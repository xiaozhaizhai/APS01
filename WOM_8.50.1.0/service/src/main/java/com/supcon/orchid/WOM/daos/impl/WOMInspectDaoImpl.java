...
@Repository
public class WOMInspectDaoImpl extends ExtendedGenericDaoImpl<WOMInspect, Long> implements WOMInspectDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_generalManage_Inspect,WOM_7.5.0.0) */
// 自定义代码
