...
@Service("wOMBatchTraceImportService")
public class WOMBatchTraceImportServiceImpl implements WOMBatchTraceImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_batchTimeLiner",model="WOM_7.5.0.0_batchTimeLiner_BatchTrace",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMBatchTrace bizObj, WOMBatchTrace oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("WOM.entityname.randon1544495048732") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("WOM.entityname.randon1544495048732") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(WOMBatchTrace bizObj, String bussinesskeyFieldName,
