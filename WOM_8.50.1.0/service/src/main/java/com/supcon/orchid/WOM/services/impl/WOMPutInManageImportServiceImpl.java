...
@Service("wOMPutInManageImportService")
public class WOMPutInManageImportServiceImpl implements WOMPutInManageImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_generalManage",model="WOM_7.5.0.0_generalManage_PutInManage",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMPutInManage bizObj, WOMPutInManage oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMPutInManage bizObj, String bussinesskeyFieldName,
