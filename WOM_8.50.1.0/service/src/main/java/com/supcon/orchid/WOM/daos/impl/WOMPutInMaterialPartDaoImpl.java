...
@Repository
public class WOMPutInMaterialPartDaoImpl extends ExtendedGenericDaoImpl<WOMPutInMaterialPart, Long> implements WOMPutInMaterialPartDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_putInMaterial_PutInMaterialPart,WOM_7.5.0.0) */
// 自定义代码
