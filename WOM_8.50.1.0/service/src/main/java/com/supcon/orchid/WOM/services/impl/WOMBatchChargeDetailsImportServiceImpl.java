...
@Service("wOMBatchChargeDetailsImportService")
public class WOMBatchChargeDetailsImportServiceImpl implements WOMBatchChargeDetailsImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_produceTask",model="WOM_7.5.0.0_produceTask_BatchChargeDetails",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMBatchChargeDetails bizObj, WOMBatchChargeDetails oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMBatchChargeDetails bizObj, String bussinesskeyFieldName,
