...
@Service("wOMMakeBatOrderHeadImportService")
public class WOMMakeBatOrderHeadImportServiceImpl implements WOMMakeBatOrderHeadImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_batchingMaterialNeed",model="WOM_7.5.0.0_batchingMaterialNeed_MakeBatOrderHead",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMMakeBatOrderHead bizObj, WOMMakeBatOrderHead oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMMakeBatOrderHead bizObj, String bussinesskeyFieldName,
