...
@Service("wOMProduceTaskActiveImportService")
public class WOMProduceTaskActiveImportServiceImpl implements WOMProduceTaskActiveImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_produceTask",model="WOM_7.5.0.0_produceTask_ProduceTaskActive",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMProduceTaskActive bizObj, WOMProduceTaskActive oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(WOMProduceTaskActive bizObj, String bussinesskeyFieldName,
