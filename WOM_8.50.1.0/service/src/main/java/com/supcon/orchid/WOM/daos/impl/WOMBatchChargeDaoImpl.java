...
@Repository
public class WOMBatchChargeDaoImpl extends ExtendedGenericDaoImpl<WOMBatchCharge, Long> implements WOMBatchChargeDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,WOM_7.5.0.0_procFeedback_BatchCharge,WOM_7.5.0.0) */
// 自定义代码
