...
@Service("wOMBatchingMaterialImportService")
public class WOMBatchingMaterialImportServiceImpl implements WOMBatchingMaterialImportService {
	...
	@Override
	@AuditLog(entity="WOM_7.5.0.0_batchingMaterial",model="WOM_7.5.0.0_batchingMaterial_BatchingMaterial",desc="保存业务信息",operType="1")
	public void saveImportDataLog(WOMBatchingMaterial bizObj, WOMBatchingMaterial oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("WOM.entityname.randon1491789700218") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("WOM.entityname.randon1491789700218") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(WOMBatchingMaterial bizObj, String bussinesskeyFieldName,
