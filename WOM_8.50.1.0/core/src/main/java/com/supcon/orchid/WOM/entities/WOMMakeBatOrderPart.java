 ...
 * 创建配料指令表体.
 */
@javax.persistence.Entity(name=WOMMakeBatOrderPart.JPA_NAME)
@Table(name = WOMMakeBatOrderPart.TABLE_NAME)
@BAPEntity(entityCode="WOM_7.5.0.0_batchingMaterialNeed")
@XmlRootElement
@BAPModelCode(code="WOM_7.5.0.0_batchingMaterialNeed_MakeBatOrderPart")
@AttributeOverrides({
		@AttributeOverride(name="id", column=@Column(name = "ID")),
		@AttributeOverride(name="version", column=@Column(name = "VERSION")),
		@AttributeOverride(name="cid", column=@Column(name = "CID")),
		@AttributeOverride(name="valid", column=@Column(name = "VALID"))
		/* CUSTOM CODE START(entity,attribute_overrides,WOM_7.5.0.0_batchingMaterialNeed_MakeBatOrderPart,WOM_7.5.0.0) */
// 自定义代码
...
@BAPCustomComponent
@DataAudit
@XmlSeeAlso({WOMMakeBatOrderPartConvertor.class})
public class WOMMakeBatOrderPart extends com.supcon.orchid.orm.entities.AbstractEcPartEntity {
	...
	public static final String MODEL_CODE = "WOM_7.5.0.0_batchingMaterialNeed_MakeBatOrderPart";
	public static final String DOC_TYPE = "WOM_batchingMaterialNeed_makeBatOrderPart";
	public static final String TABLE_NAME = "wom_make_bat_order_parts";
	public static final String JPA_NAME = "WOMMakeBatOrderPart";
	private WOMMakeBatOrderHead headID;
	private WOMBatchingMaterialNeed needID;


		private java.math.BigDecimal num ; // 配料数量


		private String remark ; // 备注
	
	private List<WOMMakeBatOrderHead> makeBatOrderHeadList;
	
	public void setMakeBatOrderHeadList(List<WOMMakeBatOrderHead> makeBatOrderHeadList){
		this.makeBatOrderHeadList = makeBatOrderHeadList;
	}
	@Transient
	public List<WOMMakeBatOrderHead> getMakeBatOrderHeadList(){
    ...
    public WOMMakeBatOrderHead getHeadID() {
        return headID;
    }
    public void setHeadID(WOMMakeBatOrderHead headID) {
        this.headID = headID;
    }
	@OneToOne
	@JoinColumn(name = "NEEDID", referencedColumnName="ID")
	@XmlJavaTypeAdapter(BAPAdapter.class)
	@Fetch(FetchMode.SELECT)
						
    public WOMBatchingMaterialNeed getNeedID() {
        return needID;
    }
    public void setNeedID(WOMBatchingMaterialNeed needID) {
        this.needID = needID;
    }
	/**
	 * 获取配料数量.
	...
	protected String _getEntityName() {
		return WOMMakeBatOrderPart.class.getName();
	}
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_batchingMaterialNeed_MakeBatOrderPart_bigintparama")
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_batchingMaterialNeed_MakeBatOrderPart_bigintparamb")
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_batchingMaterialNeed_MakeBatOrderPart_charparama")
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_batchingMaterialNeed_MakeBatOrderPart_charparamb")
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_batchingMaterialNeed_MakeBatOrderPart_dateparama")
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_batchingMaterialNeed_MakeBatOrderPart_dateparamb")
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_batchingMaterialNeed_MakeBatOrderPart_numberparama")
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_batchingMaterialNeed_MakeBatOrderPart_numberparamb")
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_batchingMaterialNeed_MakeBatOrderPart_objparama", complex = true)
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_batchingMaterialNeed_MakeBatOrderPart_objparamb", complex = true)
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_batchingMaterialNeed_MakeBatOrderPart_scparama", complex = true)
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_batchingMaterialNeed_MakeBatOrderPart_scparamb", complex = true)
	...
	/* CUSTOM CODE START(entity,functions,WOM_7.5.0.0_batchingMaterialNeed_MakeBatOrderPart,WOM_7.5.0.0) */
// 自定义代码
