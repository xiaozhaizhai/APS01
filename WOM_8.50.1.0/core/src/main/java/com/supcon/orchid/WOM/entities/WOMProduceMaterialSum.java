 ...
 * 用料汇总.
 */
@javax.persistence.Entity(name=WOMProduceMaterialSum.JPA_NAME)
@Table(name = WOMProduceMaterialSum.TABLE_NAME)
@BAPEntity(entityCode="WOM_7.5.0.0_produceTask")
@XmlRootElement
@BAPModelCode(code="WOM_7.5.0.0_produceTask_ProduceMaterialSum")
@AttributeOverrides({
		...
		/* CUSTOM CODE START(entity,attribute_overrides,WOM_7.5.0.0_produceTask_ProduceMaterialSum,WOM_7.5.0.0) */
// 自定义代码
...
@BAPCustomComponent
@DataAudit
@XmlSeeAlso({WOMProduceMaterialSumConvertor.class})
public class WOMProduceMaterialSum extends com.supcon.orchid.orm.entities.AbstractEcPartEntity {
	...
	public static final String MODEL_CODE = "WOM_7.5.0.0_produceTask_ProduceMaterialSum";
	public static final String DOC_TYPE = "WOM_produceTask_produceMaterialSum";
	public static final String TABLE_NAME = "wom_produce_material_sums";
	public static final String JPA_NAME = "WOMProduceMaterialSum";


		private String batchNum ; // 批号
	private WOMProduceTask headId;

		private Boolean isMixQuality = 
...
; // 性质
	...
	@Index(name="IDX_PRODUCEMATERIAL_TABLE_ID")
	@Column
	...
	protected String _getEntityName() {
		return WOMProduceMaterialSum.class.getName();
	}
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_produceTask_ProduceMaterialSum_bigintparama")
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_produceTask_ProduceMaterialSum_bigintparamb")
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_produceTask_ProduceMaterialSum_charparama")
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_produceTask_ProduceMaterialSum_charparamb")
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_produceTask_ProduceMaterialSum_dateparama")
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_produceTask_ProduceMaterialSum_dateparamb")
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_produceTask_ProduceMaterialSum_numberparama")
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_produceTask_ProduceMaterialSum_numberparamb")
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_produceTask_ProduceMaterialSum_objparama", complex = true)
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_produceTask_ProduceMaterialSum_objparamb", complex = true)
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_produceTask_ProduceMaterialSum_scparama", complex = true)
	...
	@BAPCustomComponent(code = "WOM_7.5.0.0_produceTask_ProduceMaterialSum_scparamb", complex = true)
	...
	/* CUSTOM CODE START(entity,functions,WOM_7.5.0.0_produceTask_ProduceMaterialSum,WOM_7.5.0.0) */
// 自定义代码
