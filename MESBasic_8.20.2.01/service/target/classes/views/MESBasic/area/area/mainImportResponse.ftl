...
<script type="text/javascript">
	...
	function download(){
		//var url = "/MESBasic/area/area/downLoad.action?viewCode=MESBasic_1_area_areaList&orgName=MESBasic_1_area_areaList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/MESBasic/area/area/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
