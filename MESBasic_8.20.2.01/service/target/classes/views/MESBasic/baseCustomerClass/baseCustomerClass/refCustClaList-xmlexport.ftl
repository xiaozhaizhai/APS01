...
<#assign viewCode = 'MESBasic_1_baseCustomerClass_BaseCustomerClass' />
<#assign propertyCode = '' />
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'ccName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1449628587988')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'ccMemo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1449628553060')}</Data></Cell>
											</#if>
									...
									<#if item?length gt 0>
												<#if item == 'ccCode' || item == '*'>
													<Cell>
														...
														<#if data.ccCode??><Data ss:Type="String"><![CDATA[${(data.ccCode)!}]]></Data></#if>
												...
												<#if item == 'ccName' || item == '*'>
													<Cell>
														...
														<#if data.ccName??><Data ss:Type="String"><![CDATA[${(data.ccName)!}]]></Data></#if>
												...
												<#if item == 'ccMemo' || item == '*'>
													<Cell>
														...
														<#if data.ccMemo??><Data ss:Type="String"><![CDATA[${(data.ccMemo)!}]]></Data></#if>
