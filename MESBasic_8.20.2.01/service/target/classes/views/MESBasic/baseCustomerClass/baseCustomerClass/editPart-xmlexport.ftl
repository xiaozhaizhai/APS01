 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								...
								<#if item == 'ccCode' || item == '*'>
										<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1436773901012')}</Data></Cell>
								</#if>
								<#if item == 'ccNAME' || item == '*'>
										<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1436773836491')}</Data></Cell>
								</#if>
								<#if item == 'ccMemo' || item == '*'>
										<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1436773942009')}</Data></Cell>
								</#if>
			...
			<Row ss:AutoFitHeight="0">
				<#list exportFieldList as item>
					<#if item?length gt 0>
								...
								<#if item == 'ccCode' || item == '*'>
									<Cell>
									<#if checkFieldPermission('ccCode','MESBasic_1_baseCustomerClass_BaseCustomerClass','MESBasic_1_baseCustomerClass_BaseCustomerClass_ccCode') != 0>
										<#if data.ccCode??><Data ss:Type="String">${(data.ccCode)!}</Data></#if>
									</#if>
									</Cell>
								</#if>
								<#if item == 'ccNAME' || item == '*'>
									<Cell>
									<#if checkFieldPermission('ccNAME','MESBasic_1_baseCustomerClass_BaseCustomerClass','MESBasic_1_baseCustomerClass_BaseCustomerClass_ccNAME') != 0>
										<#if data.ccNAME??><Data ss:Type="String">${(data.ccNAME)!}</Data></#if>
									</#if>
									</Cell>
								</#if>
								<#if item == 'ccMemo' || item == '*'>
									<Cell>
									<#if checkFieldPermission('ccMemo','MESBasic_1_baseCustomerClass_BaseCustomerClass','MESBasic_1_baseCustomerClass_BaseCustomerClass_ccMemo') != 0>
										<#if data.ccMemo??><Data ss:Type="String">${(data.ccMemo)!}</Data></#if>
									</#if>
									</Cell>
								</#if>
