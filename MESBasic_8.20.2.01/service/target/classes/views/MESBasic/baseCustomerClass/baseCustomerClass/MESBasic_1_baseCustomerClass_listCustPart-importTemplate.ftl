...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
	...
	<Style ss:ID="MESBasic_1_baseCustomerClass_BaseCustomerClass_ccCode">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="MESBasic_1_baseCustomerClass_BaseCustomerClass_ccName">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="MESBasic_1_baseCustomerClass_BaseCustomerClass_ccMemo">
  			<NumberFormat/>
  			<Protection/>
	</Style>
...
<Worksheet ss:Name="sheet1">
	<Table ss:ExpandedColumnCount="256" ss:ExpandedRowCount="3" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="16.5">
			<Column ss:Index="1" ss:Width="100"  ss:StyleID="MESBasic_1_baseCustomerClass_BaseCustomerClass_ccCode"/>
			<Column ss:Index="2" ss:Width="100"  ss:StyleID="MESBasic_1_baseCustomerClass_BaseCustomerClass_ccName"/>
			<Column ss:Index="3" ss:Width="100"  ss:StyleID="MESBasic_1_baseCustomerClass_BaseCustomerClass_ccMemo"/>
	...
	<#if customStyleCodes??>
		...
		<Row ss:AutoFitHeight="0">
						<Cell ss:StyleID="unNullable">
							<Data ss:Type="String">分类编码</Data>
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										MESBasic_1_baseCustomerClass_BaseCustomerClass_ccCode
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell ss:StyleID="unNullable">
							<Data ss:Type="String">分类名称</Data>
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										MESBasic_1_baseCustomerClass_BaseCustomerClass_ccName
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										MESBasic_1_baseCustomerClass_BaseCustomerClass_ccMemo
									 </ss:Data>
							</Comment>
						</Cell>
