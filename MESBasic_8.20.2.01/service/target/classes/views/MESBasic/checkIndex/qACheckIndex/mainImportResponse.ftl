...
<script type="text/javascript">
	...
	function download(){
		//var url = "/MESBasic/checkIndex/qACheckIndex/downLoad.action?viewCode=MESBasic_1_checkIndex_checkIndexEdit&orgName=MESBasic_1_checkIndex_checkIndexEdit-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/MESBasic/checkIndex/qACheckIndex/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
