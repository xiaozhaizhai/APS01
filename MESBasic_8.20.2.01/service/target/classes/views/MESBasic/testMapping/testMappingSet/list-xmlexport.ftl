...
<#if xmlState=='START'>
	...
	<Styles>
 		...
 		<Style ss:ID="s8">
  		...
  		<Style ss:ID="testName">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
  		<Style ss:ID="testShortName">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
 	</Styles>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0 && item != "checkbox">
									<#if item == 'testName' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'testShortName' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								...
								<#if item == 'testName' || item == '*'>
										<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1430808486471')}</Data></Cell>
								</#if>
								<#if item == 'testShortName' || item == '*'>
										<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1430808617634')}</Data></Cell>
								</#if>
								<#if item == 'product.productName' || item == '*'>
			...
			<Row ss:AutoFitHeight="0">
				<#list exportFieldList as item>
					<#if item?length gt 0>
								...
								<#if item == 'testName' || item == '*'>
									<Cell>
									<#if checkFieldPermission('testName','MESBasic_1_testMapping_TestMappingSet','MESBasic_1_testMapping_TestMappingSet_testName') != 0>
										<#if data.testName??><Data ss:Type="String">${(data.testName)!}</Data></#if>
									</#if>
									</Cell>
								</#if>
								<#if item == 'testShortName' || item == '*'>
									<Cell>
									<#if checkFieldPermission('testShortName','MESBasic_1_testMapping_TestMappingSet','MESBasic_1_testMapping_TestMappingSet_testShortName') != 0>
										<#if data.testShortName??><Data ss:Type="String">${(data.testShortName)!}</Data></#if>
									</#if>
									</Cell>
								</#if>
								<#if item == 'product.productName' || item == '*'>
									<Cell>
									<#if checkFieldPermission('product.productName','MESBasic_1_testMapping_TestMappingSet','MESBasic_1_testMapping_TestMappingSet_product||MESBasic_1_product_Product_productName') != 0>
										<#if data.product.productName??><Data ss:Type="String">${(data.product.productName)!}</Data></#if>
									</#if>
									</Cell>
								</#if>
								<#if item == 'product.productCode' || item == '*'>
									<Cell>
									<#if checkFieldPermission('product.productCode','MESBasic_1_testMapping_TestMappingSet','MESBasic_1_testMapping_TestMappingSet_product||MESBasic_1_product_Product_productCode') != 0>
										<#if data.product.productCode??><Data ss:Type="String">${(data.product.productCode)!}</Data></#if>
									</#if>
									</Cell>
								</#if>
