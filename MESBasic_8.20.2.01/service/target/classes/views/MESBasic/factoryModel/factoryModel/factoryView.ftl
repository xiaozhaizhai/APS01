<!-- MESBasic_1/factoryModel/factoryView -->
...
<#-- 命名空间 -->
<#assign editPageNs = "MESBasic.factoryModel.factoryModel.factoryView">
<#-- 模型名称-->
<#assign modelName = "factoryModel">
<#-- 视图编码-->
<#assign viewCode = "MESBasic_1_factoryModel_factoryView">
<#-- 实体编码-->
<#assign entity_code = "MESBasic_1_factoryModel">
<#-- 视图名称-->
<#assign viewName = "factoryView">
<#-- datagrid编码-->
<#assign datagridCode = "MESBasic_factoryModel_factoryModel_factoryView_datagrids">
<#-- 首字母大写的模型名称-->
...
<#-- formid -->
<#assign editFormId = "MESBasic_factoryModel_factoryModel_factoryView_form">
<#-- 待办状态 -->
...
<head>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <#assign configTitle = getText('MESBasic.viewtitle.radion1419232837411')>
		...
		#MESBasic_factoryModel_factoryModel_factoryView_form{float:left;width:100%;}
		
		
		</style>
		<script type="text/javascript">
			CUI.ns('MESBasic.factoryModel.factoryModel.factoryView');
			MESBasic.factoryModel.factoryModel.factoryView.currentUser = ${userJson};
			MESBasic.factoryModel.factoryModel.factoryView.currentStaff = ${staffJson};
			MESBasic.factoryModel.factoryModel.factoryView.currentDepartment = ${deptJson};
			MESBasic.factoryModel.factoryModel.factoryView.currentPosition = ${postJson};
			MESBasic.factoryModel.factoryModel.factoryView.currentCompany = ${compJson};
		</script>
		<!-- CUSTOM CODE START(view-VIEW-MESBasic_1_factoryModel_factoryView,head,MESBasic_1_factoryModel_FactoryModel,MESBasic_1) -->
<!-- 自定义代码 -->
...
<!-- CUSTOM CODE END -->
	...
	<body class="view-edit ">
		...
		<@s.form errorBarId="workbenchErrorBar" hiddenField="factoryModel.endItem.id,factoryModel.nodeType.id,factoryModel.assignBatchNo.id,factoryModel.department.id," onsubmitMethod="MESBasic.factoryModel.factoryModel.factoryView.beforeSubmitMethod()" id="MESBasic_factoryModel_factoryModel_factoryView_form" namespace="/MESBasic/factoryModel/factoryModel/factoryView" action="submit?__pc__=${(Parameters.__pc__)!}&_bapFieldPermissonModelCode_=MESBasic_1_factoryModel_FactoryModel&_bapFieldPermissonModelName_=FactoryModel" editPageNs="MESBasic.factoryModel.factoryModel.factoryView" callback="MESBasic.factoryModel.factoryModel.factoryView._callBackInfo" ecform="true">
			<input type="hidden" name="bap_validate_user_id" value="${(Session.user.id)!}" />
			<div style="float:none;width:auto;" class="edit-main grid-s5m0 col-main main-wrap" id="MESBasic_factoryModel_factoryModel_factoryView_main_div">
			<div class="edit-head">
				<#include "../../../ec/tableInfo/operateheadbar_all.ftl" >
				<#include "../../../ec/tableInfo/creatorInfo.ftl" >
			</div>
    		<div class="edit-main" id="MESBasic_factoryModel_factoryModel_factoryView">
...
<script type="text/javascript">
var attcountid = "MESBasic_factoryModel_factoryModel_factoryView_form"+"_attcount";
		...
		<tr >
								...
								<#if !(factoryModel.id)?? && (factoryModel.nodeType.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('MESBasic_factoryModel_factoryModel_factoryView_form',obj, 'factoryModel.nodeType', '/MESBasic/nodeType/nodeType/noderef.action');
												CUI.commonFills('MESBasic_factoryModel_factoryModel_factoryView_form', 'factoryModel.nodeType',obj,true);
											}
										});
									})(jQuery);
								</#if>
					...
					<td  nullable=true class="edit-table-content"   style="text-align: left;;" >
								...
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${factoryModel_area_defaultValue!}" formId="MESBasic_factoryModel_factoryModel_factoryView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="factoryModel.area.id" code="MesArea" value="${(factoryModel.area.id)!}"  />
									
								<#else>
									
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="MESBasic_factoryModel_factoryModel_factoryView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="factoryModel.area.id" code="MesArea" value="${(factoryModel.area.id)!}"  />
					...
					<td  nullable=true class="edit-table-content"   style="text-align: left;;" >
								...
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${factoryModel_interfaceUrl_defaultValue!}" formId="MESBasic_factoryModel_factoryModel_factoryView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="factoryModel.interfaceUrl.id" code="serviceUrl" value="${(factoryModel.interfaceUrl.id)!}"  />
									
								<#else>
									
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="MESBasic_factoryModel_factoryModel_factoryView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="factoryModel.interfaceUrl.id" code="serviceUrl" value="${(factoryModel.interfaceUrl.id)!}"  />
								...
								<#if newObj && (factoryModel_department_name_defaultValue)=='currentDepart'>
									(function($){
										$(function(){
											...
											obj = foundation.common.getObject('MESBasic_factoryModel_factoryModel_factoryView_form',obj, 'factoryModel.department', '/foundation/department/common/departmentListFrameCustom.action?operateCode=attendence_1.0_gatherDeal_list_self');
											CUI.commonFills('MESBasic_factoryModel_factoryModel_factoryView_form', 'factoryModel.department',obj,true);
				...
				<td class="edit-table-symbol">&nbsp;</td>
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
									...
									<@mneclient iframe=mneIframe!false property_type="TEXT" reftitle="${getText('MESBasic.viewtitle.radion1417920493220')}" viewType="${viewType!}" deValue="${factoryModel_endItem_itemName_defaultValue!}" conditionfunc="MESBasic.factoryModel.factoryModel.factoryView._querycustomFunc('factoryModel_endItem_itemName')" view=true  value="${(factoryModel.endItem.itemName)!}" displayFieldName="itemName" name="factoryModel.endItem.itemName" id="factoryModel_endItem_itemName" type="other" url="/MESBasic/itemManage/itemSetup/switcherOnlyRef.action" clicked=true multiple=false mnewidth=260 formId="MESBasic_factoryModel_factoryModel_factoryView_form" editCustomCallback=";" refViewCode="MESBasic_1_itemManage_switcherOnlyRef" onkeyupfuncname=";_callback_factoryModel_endItem_itemName(obj);" cssStyle="" isEdit=true     isCrossCompany=false  />
								...
								<#if !(factoryModel.id)?? && (factoryModel.endItem.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('MESBasic_factoryModel_factoryModel_factoryView_form',obj, 'factoryModel.endItem', '/MESBasic/itemManage/itemSetup/switcherOnlyRef.action');
												CUI.commonFills('MESBasic_factoryModel_factoryModel_factoryView_form', 'factoryModel.endItem',obj,true);
											}
										});
									})(jQuery);
								</#if>
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
									...
									<@mneclient iframe=mneIframe!false property_type="TEXT" reftitle="${getText('MESBasic.viewtitle.radion1417920493220')}" viewType="${viewType!}" deValue="${factoryModel_assignBatchNo_itemName_defaultValue!}" conditionfunc="MESBasic.factoryModel.factoryModel.factoryView._querycustomFunc('factoryModel_assignBatchNo_itemName')" view=true  value="${(factoryModel.assignBatchNo.itemName)!}" displayFieldName="itemName" name="factoryModel.assignBatchNo.itemName" id="factoryModel_assignBatchNo_itemName" type="other" url="/MESBasic/itemManage/itemSetup/switcherOnlyRef.action" clicked=true multiple=false mnewidth=260 formId="MESBasic_factoryModel_factoryModel_factoryView_form" editCustomCallback=";" refViewCode="MESBasic_1_itemManage_switcherOnlyRef" onkeyupfuncname=";_callback_factoryModel_assignBatchNo_itemName(obj);" cssStyle="" isEdit=true     isCrossCompany=false  />
								...
								<#if !(factoryModel.id)?? && (factoryModel.assignBatchNo.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('MESBasic_factoryModel_factoryModel_factoryView_form',obj, 'factoryModel.assignBatchNo', '/MESBasic/itemManage/itemSetup/switcherOnlyRef.action');
												CUI.commonFills('MESBasic_factoryModel_factoryModel_factoryView_form', 'factoryModel.assignBatchNo',obj,true);
											}
										});
									})(jQuery);
								</#if>
				...
				<td class="edit-table-symbol">&nbsp;</td>
					...
					<td  nullable=true class="edit-table-content"   colspan="5" align="left" style="text-align: left;;" >
							...
							<div class="fix-input-readonly fix-ie7-textarea"><textarea property_type="TEXT" id="factoryModel_description" originalvalue="<#if !newObj || (factoryModel.description)?has_content>${(factoryModel.description?html)!}<#else>${factoryModel_description_defaultValue?html}</#if>"  name="factoryModel.description" class="cui-noborder-textarea cui-textarea-auto" readonly="readonly" style="height:60px;;" ><#if !newObj || (factoryModel.description)?has_content>${(factoryModel.description)!}<#else>${factoryModel_description_defaultValue}</#if></textarea></div>
	...
	<table class="edit-table" style="display:none;">
		...
		<tr >
					...
					<td  nullable=true class="edit-table-content"   style="text-align: left;;" >
							...
							<div class="fix-input-readonly">
								<input property_type="LONG" name="factoryModel.belongLine" id="factoryModel_belongLine"  style=";" originalvalue="<#if !newObj || (factoryModel.belongLine)?has_content>${(factoryModel.belongLine?html)!}<#else>${factoryModel_belongLine_defaultValue!}</#if>" value="<#if !newObj || (factoryModel.belongLine)?has_content>${(factoryModel.belongLine?html)!}<#else>${factoryModel_belongLine_defaultValue!}</#if>" type="text" class="cui-noborder-input numberField" readonly="readonly" />
							</div>
							<script type="text/javascript">
							</script>
...
<#assign colAdmFlag=checkUserPermisition('ec_ptManage_list_view')>
			...
			<@datagrid colAdminFlag=colAdmFlag withoutConfigTable=true id="ObjPostion_dg1460955592809" viewType="${viewType}" renderOverEvent="dg1460955592809RenderOverEvent" route="${routeFlag}" formId="MESBasic_factoryModel_factoryModel_factoryView_form" noPermissionKeys="objPos.name,objPos.code,objPos.department.name,objPos.department.fullPathName" modelCode="MESBasic_1_factoryModel_ObjPostion" dataUrl="${dUrl}" postData="&dgPage.pageSize=65536" dataGridName="dg1460955592809" dtPage="dgPage"  hidekeyPrefix="dg1460955592809" hidekey="['id','version','objPos.id','objPos.name','objPos.id','objPos.code','objPos.id','objPos.department.name','objPos.id','objPos.department.fullPathName'${cpObjHideKey!''}]" transMethod="post" paginator=false editable=false  buttons="${buttons}" noPadding=true isEdit=true tabViewIndex=0 pageInitMethod="dg1460955592809PageInitMethod"  defaultNodeExpanded=nodeExpanded  cannotAddNewRow=false cannotDeleteRow=true assModelDisplayName=assModelDisplayName  activexButton="" exportExcel=exportExcel addNewRow=true   canInsertRow=false  insertRowAble=true firstLoad=firstLoad  copyRow=false  copyColumn=false  ptRealTimeLoad=0 >		
							...
							<#elseif (objPos_name_defaultValue!)?string=="currentComp">
								<#assign objPos_name_defaultValue='${compJson!}'>
									...
									<@datacolumn key="objPos.name"        showFormat="SELECTCOMP" defaultValue="${(objPos_name_defaultValue!)?string}" defaultDisplay="${(objPos_name_displayDefaultType!)?string}" decimal="" editable=false type="selectcomp" showType="selectcomp" notnull=false   selectCompName="MESBasic.factoryModel.factoryModel.factoryView"  textalign="left"  viewUrl="/foundation/position/common/positionListFrame.action" viewCode="sysbase_1.0_position_position" mneenable=true crossCompany=false viewTitle="${getText('ec.edit.refPos')}"  label="${getText('foundation.position.name')}" width=120 showFormatFunc="" beforecallback="checkUnique(obj)"  />
							...
							<#elseif (objPos_code_defaultValue!)?string=="currentComp">
								<#assign objPos_code_defaultValue='${compJson!}'>
									...
									<@datacolumn key="objPos.code"        showFormat="TEXT" defaultValue="${(objPos_code_defaultValue!)?string}" defaultDisplay="${(objPos_code_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="MESBasic.factoryModel.factoryModel.factoryView"  textalign="left"  viewUrl="/foundation/position/common/positionListFrame.action" viewCode="sysbase_1.0_position_position" mneenable=false crossCompany=false viewTitle="${getText('ec.edit.refPos')}"  label="${getText('foundation.position.code')}" width=120 showFormatFunc=""  />
							...
							<#elseif (objPos_department_fullPathName_defaultValue!)?string=="currentComp">
								<#assign objPos_department_fullPathName_defaultValue='${compJson!}'>
									...
									<@datacolumn key="objPos.department.fullPathName"        showFormat="TEXT" defaultValue="${(objPos_department_fullPathName_defaultValue!)?string}" defaultDisplay="${(objPos_department_fullPathName_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="MESBasic.factoryModel.factoryModel.factoryView"  textalign="left"  viewUrl="/foundation/position/common/positionListFrame.action" viewCode="sysbase_1.0_position_position" mneenable=false crossCompany=false viewTitle="${getText('ec.edit.refPos')}"  label="${getText('foundation.ec.common.fullPathName')}" width=140 showFormatFunc=""  />
			...
			<script type="text/javascript">
				...
				function savedg1460955592809DataGrid(){
					...
					$('<input type="hidden" name="dgLists[\'dg1460955592809\']">').val(json).appendTo($('#MESBasic_factoryModel_factoryModel_factoryView_form'));
					$('<input type="hidden" name="dg1460955592809ModelCode">').val('MESBasic_1_factoryModel_ObjPostion').appendTo($('#MESBasic_factoryModel_factoryModel_factoryView_form'));
					//兼容旧版本提交函数
					$('<input type="hidden" name="dg1460955592809ListJson">').val(json).appendTo($('#MESBasic_factoryModel_factoryModel_factoryView_form'));
				}
				function DT_ObjPostion_dg1460955592809_deldatagrid(){
					...
					$.each(deleteRows, function(index, deleteRow){
						...
						if($("#dg1460955592809DeletedIds").length>0){
							...
							CUI('<input type="hidden" id="dg1460955592809DeletedIds" name="dgDeletedIds[\'dg1460955592809\']" value="'+tepID+'">').appendTo(CUI('#MESBasic_factoryModel_factoryModel_factoryView_form'));
						}
						//兼容旧版本提交函数
						CUI('<input type="hidden" name="dg1460955592809DeletedIds['+CUI('input[name^="dg1460955592809DeletedIds"]').length+']'+'" value="'+tepID+'">').appendTo(CUI('#MESBasic_factoryModel_factoryModel_factoryView_form'));
					});
					return deleteRows;
				}
				...
				$(function($){
					var datagrids = $('body').data('MESBasic_factoryModel_factoryModel_factoryView_datagrids');
					if(!datagrids) {
						datagrids = [];
					}
					for(var i=0;i<4;i++) {
					...
					$('body').data('MESBasic_factoryModel_factoryModel_factoryView_datagrids', datagrids);
				});
				...
				function ObjPostion_dg1460955592809_showImportDialog(){
					try{
						...
						var url = "/MESBasic/factoryModel/factoryModel/initImport.action?datagridCode=MESBasic_1_factoryModel_factoryEditdg1460955592809&tid=${id!}&datagridName=dg1460955592809";
							<#if canImportExcel>
								var buttonCode="MESBasic_1_factoryModel_factoryViewdg1460955592809_BUTTON_dgImport";
				...
				function dg1460955592809PageInitMethod(nTabIndex){
					MESBasic.factoryModel.factoryModel.factoryView.initSize(nTabIndex);
				}
			</script>
...
<#assign colAdmFlag=checkUserPermisition('ec_ptManage_list_view')>
			...
			<@datagrid colAdminFlag=colAdmFlag withoutConfigTable=true id="ObjTeam_dg1490261761014" viewType="${viewType}" renderOverEvent="dg1490261761014RenderOverEvent" route="${routeFlag}" formId="MESBasic_factoryModel_factoryModel_factoryView_form" noPermissionKeys="objTeam.name,objTeam.code,objTeam.dept.name,objTeam.principal.name" modelCode="MESBasic_1_factoryModel_ObjTeam" dataUrl="${dUrl}" postData="&dgPage.pageSize=65536" dataGridName="dg1490261761014" dtPage="dgPage"  hidekeyPrefix="dg1490261761014" hidekey="['id','version','objTeam.id','objTeam.name','objTeam.id','objTeam.code','objTeam.id','objTeam.dept.name','objTeam.id','objTeam.principal.name'${cpObjHideKey!''}]" transMethod="post" paginator=false editable=false  buttons="${buttons}" noPadding=true isEdit=true tabViewIndex=1 pageInitMethod="dg1490261761014PageInitMethod"  defaultNodeExpanded=nodeExpanded  cannotAddNewRow=false cannotDeleteRow=true assModelDisplayName=assModelDisplayName  activexButton="" exportExcel=exportExcel addNewRow=true   canInsertRow=false  insertRowAble=true firstLoad=firstLoad  copyRow=false  copyColumn=false  ptRealTimeLoad=0 >		
							...
							<#elseif (objTeam_name_defaultValue!)?string=="currentComp">
								<#assign objTeam_name_defaultValue='${compJson!}'>
									...
									<@datacolumn key="objTeam.name"        showFormat="SELECTCOMP" defaultValue="${(objTeam_name_defaultValue!)?string}" defaultDisplay="${(objTeam_name_displayDefaultType!)?string}" decimal="" editable=false type="selectcomp" showType="selectcomp" notnull=false   selectCompName="MESBasic.factoryModel.factoryModel.factoryView"  textalign="left"  viewUrl="/X6Basic/teamManage/teamInfo/ref.action" viewCode="X6Basic_1.0_teamManage_ref" mneenable=false crossCompany=false viewTitle="${getText('X6Basic.viewtitle.radion1398316764087')}"  label="${getText('X6Basic.propertydisplayName.radion1398303611599')}" width=100 showFormatFunc=""  />
							...
							<#elseif (objTeam_dept_name_defaultValue!)?string=="currentComp">
								<#assign objTeam_dept_name_defaultValue='${compJson!}'>
									...
									<@datacolumn key="objTeam.dept.name"        showFormat="TEXT" defaultValue="${(objTeam_dept_name_defaultValue!)?string}" defaultDisplay="${(objTeam_dept_name_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="MESBasic.factoryModel.factoryModel.factoryView"  textalign="left"  viewUrl="/X6Basic/teamManage/teamInfo/ref.action" viewCode="X6Basic_1.0_teamManage_ref" mneenable=false crossCompany=false viewTitle="${getText('X6Basic.viewtitle.radion1398316764087')}"  label="${getText('part.fzwdy.xm.mainPositionId.department.name')}" width=100 showFormatFunc=""  />
							...
							<#elseif (objTeam_principal_name_defaultValue!)?string=="currentComp">
								<#assign objTeam_principal_name_defaultValue='${compJson!}'>
									...
									<@datacolumn key="objTeam.principal.name"        showFormat="TEXT" defaultValue="${(objTeam_principal_name_defaultValue!)?string}" defaultDisplay="${(objTeam_principal_name_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="MESBasic.factoryModel.factoryModel.factoryView"  textalign="left"  viewUrl="/X6Basic/teamManage/teamInfo/ref.action" viewCode="X6Basic_1.0_teamManage_ref" mneenable=false crossCompany=false viewTitle="${getText('X6Basic.viewtitle.radion1398316764087')}"  label="${getText('foundation.staff.dimissionStaff_xls.staffName')}" width=100 showFormatFunc=""  />
			...
			<script type="text/javascript">
				...
				function savedg1490261761014DataGrid(){
					...
					$('<input type="hidden" name="dgLists[\'dg1490261761014\']">').val(json).appendTo($('#MESBasic_factoryModel_factoryModel_factoryView_form'));
					$('<input type="hidden" name="dg1490261761014ModelCode">').val('MESBasic_1_factoryModel_ObjTeam').appendTo($('#MESBasic_factoryModel_factoryModel_factoryView_form'));
					//兼容旧版本提交函数
					$('<input type="hidden" name="dg1490261761014ListJson">').val(json).appendTo($('#MESBasic_factoryModel_factoryModel_factoryView_form'));
				}
				function DT_ObjTeam_dg1490261761014_deldatagrid(){
					...
					$.each(deleteRows, function(index, deleteRow){
						...
						if($("#dg1490261761014DeletedIds").length>0){
							...
							CUI('<input type="hidden" id="dg1490261761014DeletedIds" name="dgDeletedIds[\'dg1490261761014\']" value="'+tepID+'">').appendTo(CUI('#MESBasic_factoryModel_factoryModel_factoryView_form'));
						}
						//兼容旧版本提交函数
						CUI('<input type="hidden" name="dg1490261761014DeletedIds['+CUI('input[name^="dg1490261761014DeletedIds"]').length+']'+'" value="'+tepID+'">').appendTo(CUI('#MESBasic_factoryModel_factoryModel_factoryView_form'));
					});
					return deleteRows;
				}
				...
				function ObjTeam_dg1490261761014_showImportDialog(){
					try{
						...
						var url = "/MESBasic/factoryModel/factoryModel/initImport.action?datagridCode=MESBasic_1_factoryModel_factoryEditdg1490261761014&tid=${id!}&datagridName=dg1490261761014";
							<#if canImportExcel>
								var buttonCode="MESBasic_1_factoryModel_factoryViewdg1490261761014_BUTTON_dgImport";
								url+="&buttonCode="+buttonCode;
							</#if>
...
<#assign colAdmFlag=checkUserPermisition('ec_ptManage_list_view')>
	...
	if(!BatchModeState){
		...
		$("td[key='clearItem.itemName']").hide();
			...
			<#if viewType?? && viewType != "readonly" && newObj?? && !newObj && !(refId?? && (refId > 0))>
				<#assign buttons="[{text:\"${getText('MESBasic.buttonPropertyshowName.radion1552006043276')}\",handler:function(event){ObjEquipment_dg1460958585675_EquipAddRow(event)},iconClass:\"cui-btn-add\",useInMore:\"false\"}]">
				<#assign canImportExcel=false>
			<#else>
				<#assign buttons="[{text:\"${getText('MESBasic.buttonPropertyshowName.radion1552006043276')}\",handler:function(event){ObjEquipment_dg1460958585675_EquipAddRow(event)},iconClass:\"cui-btn-add\",useInMore:\"false\"}]">
				<#assign canImportExcel=false>
			...
			<@datagrid colAdminFlag=colAdmFlag withoutConfigTable=true id="ObjEquipment_dg1460958585675" viewType="${viewType}" renderOverEvent="dg1460958585675RenderOverEvent" route="${routeFlag}" formId="MESBasic_factoryModel_factoryModel_factoryView_form" noPermissionKeys="objDepartment.name,isFixed,equipmentNum,objEqu.name,equipmentType,isContainer,clearType,clearItem.itemName" modelCode="MESBasic_1_factoryModel_ObjEquipment" dataUrl="${dUrl}" postData="&dgPage.pageSize=65536" dataGridName="dg1460958585675" dtPage="dgPage"  hidekeyPrefix="dg1460958585675" hidekey="['id','version','objDepartment.id','objDepartment.name','objEqu.id','objEqu.name','clearItem.id','clearItem.itemName'${cpObjHideKey!''}]" transMethod="post" paginator=false editable=false  buttons="${buttons}" noPadding=true isEdit=true tabViewIndex=2 pageInitMethod="dg1460958585675PageInitMethod"  defaultNodeExpanded=nodeExpanded  cannotAddNewRow=false cannotDeleteRow=true assModelDisplayName=assModelDisplayName  activexButton="MESBasic.buttonPropertyshowName.radion1552006043276,EquipAddRow,add" exportExcel=exportExcel addNewRow=true   canInsertRow=false  insertRowAble=true firstLoad=firstLoad  copyRow=false  copyColumn=false  ptRealTimeLoad=0 >		
							...
							<#assign isFixed_displayDefaultType=''>
								<#assign isFixed_defaultValue=''>
									...
									<@datacolumn key="isFixed"        showFormat="CHECKBOX" defaultValue="${(isFixed_defaultValue!)?string}" defaultDisplay="${(isFixed_displayDefaultType!)?string}" onchange="ObjEquipment_dg1460958585675Widget.evalCustomFunction(nRow,sFieldName,'ChangeisFixed()')" decimal="" editable=false type="boolean" showType="checkbox" notnull=false     textalign="center"  viewUrl="" viewCode="" mneenable=false crossCompany=false viewTitle="${getText('')}"  label="${getText('MESBasic.propertydisplayName.randon1551872577107')}" width=100 showFormatFunc=""  />
							<#assign equipmentNum_displayDefaultType=''>
								<#assign equipmentNum_defaultValue=''>
										<#assign equipmentNum_defaultValue=''>
										 
									<@datacolumn key="equipmentNum"        showFormat="TEXT" defaultValue="${(equipmentNum_defaultValue!)?string}" defaultDisplay="${(equipmentNum_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false     textalign="left"  viewUrl="" viewCode="" mneenable=false crossCompany=false viewTitle="${getText('')}"  label="${getText('MESBasic.propertydisplayName.randon1551872782825')}" width=100 showFormatFunc=""  />
							...
							<#elseif (objEqu_name_defaultValue!)?string=="currentComp">
								<#assign objEqu_name_defaultValue='${compJson!}'>
									...
									<@datacolumn key="objEqu.name"        showFormat="SELECTCOMP" defaultValue="${(objEqu_name_defaultValue!)?string}" defaultDisplay="${(objEqu_name_displayDefaultType!)?string}" decimal="" editable=false type="selectcomp" showType="selectcomp" notnull=false   selectCompName="MESBasic.factoryModel.factoryModel.factoryView"  textalign="left"  viewUrl="/MESBasic/equipManage/equipment/ref.action" viewCode="MESBasic_1_equipManage_ref" mneenable=true crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1423967959681')}"  label="${getText('MESBasic.propertydisplayName.randon1423967231438')}" width=120 showFormatFunc=""  />
							<#assign equipmentType_displayDefaultType=''>
								<#assign equipmentType_defaultValue=''>
										<#assign equipmentType_defaultValue=''>
										 
									<@systemCodeColumn code="MESEquipmentType" textalign="center" defaultValue="${(equipmentType_defaultValue!)?string}" key="equipmentType.id" editable=false type="selectcomp" notnull=false    onchange="ObjEquipment_dg1460958585675Widget.evalCustomFunction(nRow,sFieldName,'ChooseSysCode(nRow)')"  label="${getText('MESBasic.propertydisplayName.randon1556022564127')}" width=100   />
							...
							<#assign clearType_displayDefaultType=''>
								<#assign clearType_defaultValue=''>
									...
									<@systemCodeColumn code="MESClearSignat" textalign="center" defaultValue="${(clearType_defaultValue!)?string}" key="clearType.id" editable=false type="selectcomp" notnull=false    onchange="ObjEquipment_dg1460958585675Widget.evalCustomFunction(nRow,sFieldName,'ClearTypeChange(nRow)')"  label="${getText('MESBasic.propertydisplayName.randon1551874573019')}" width=100   />
							...
							<#elseif (clearItem_itemName_defaultValue!)?string=="currentComp">
								<#assign clearItem_itemName_defaultValue='${compJson!}'>
									...
									<@datacolumn key="clearItem.itemName"        showFormat="SELECTCOMP" defaultValue="${(clearItem_itemName_defaultValue!)?string}" defaultDisplay="${(clearItem_itemName_displayDefaultType!)?string}" decimal="" editable=false type="selectcomp" showType="selectcomp" notnull=false   selectCompName="MESBasic.factoryModel.factoryModel.factoryView"  textalign="left"  viewUrl="/MESBasic/itemManage/itemSetup/itemSelfList.action" viewCode="MESBasic_1_itemManage_itemSelfList" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.radion1421223012419')}"  label="${getText('MESBasic.201903131941001')}" width=100 showFormatFunc=""  />
			...
			<script type="text/javascript">
				...
				function savedg1460958585675DataGrid(){
					...
					$('<input type="hidden" name="dgLists[\'dg1460958585675\']">').val(json).appendTo($('#MESBasic_factoryModel_factoryModel_factoryView_form'));
					$('<input type="hidden" name="dg1460958585675ModelCode">').val('MESBasic_1_factoryModel_ObjEquipment').appendTo($('#MESBasic_factoryModel_factoryModel_factoryView_form'));
					//兼容旧版本提交函数
					$('<input type="hidden" name="dg1460958585675ListJson">').val(json).appendTo($('#MESBasic_factoryModel_factoryModel_factoryView_form'));
				}
				function DT_ObjEquipment_dg1460958585675_deldatagrid(){
					...
					$.each(deleteRows, function(index, deleteRow){
						...
						if($("#dg1460958585675DeletedIds").length>0){
							...
							CUI('<input type="hidden" id="dg1460958585675DeletedIds" name="dgDeletedIds[\'dg1460958585675\']" value="'+tepID+'">').appendTo(CUI('#MESBasic_factoryModel_factoryModel_factoryView_form'));
						}
						//兼容旧版本提交函数
						CUI('<input type="hidden" name="dg1460958585675DeletedIds['+CUI('input[name^="dg1460958585675DeletedIds"]').length+']'+'" value="'+tepID+'">').appendTo(CUI('#MESBasic_factoryModel_factoryModel_factoryView_form'));
					});
					return deleteRows;
				}
				...
				function ObjEquipment_dg1460958585675_showImportDialog(){
					try{
						...
						var url = "/MESBasic/factoryModel/factoryModel/initImport.action?datagridCode=MESBasic_1_factoryModel_factoryEditdg1460958585675&tid=${id!}&datagridName=dg1460958585675";
							<#if canImportExcel>
								var buttonCode="MESBasic_1_factoryModel_factoryViewdg1460958585675_BUTTON_dgImport";
								url+="&buttonCode="+buttonCode;
							</#if>
...
<#assign colAdmFlag=checkUserPermisition('ec_ptManage_list_view')>
			...
			<@datagrid colAdminFlag=colAdmFlag withoutConfigTable=true id="ObjProduct_dg1460958766002" viewType="${viewType}" renderOverEvent="dg1460958766002RenderOverEvent" route="${routeFlag}" formId="MESBasic_factoryModel_factoryModel_factoryView_form" noPermissionKeys="objProduct.productName,objProduct.productCode,objProduct.productSpecif,emsFlag" modelCode="MESBasic_1_factoryModel_ObjProduct" dataUrl="${dUrl}" postData="&dgPage.pageSize=65536" dataGridName="dg1460958766002" dtPage="dgPage"  hidekeyPrefix="dg1460958766002" hidekey="['id','version','objProduct.id','objProduct.productName','objProduct.id','objProduct.productCode','objProduct.id','objProduct.productSpecif'${cpObjHideKey!''}]" transMethod="post" paginator=false editable=false  buttons="${buttons}" noPadding=true isEdit=true tabViewIndex=3 pageInitMethod="dg1460958766002PageInitMethod"  defaultNodeExpanded=nodeExpanded  cannotAddNewRow=false cannotDeleteRow=true assModelDisplayName=assModelDisplayName  activexButton="" exportExcel=exportExcel addNewRow=true   canInsertRow=false  insertRowAble=true firstLoad=firstLoad  copyRow=false  copyColumn=false  ptRealTimeLoad=0 >		
							...
							<#elseif (objProduct_productName_defaultValue!)?string=="currentComp">
								<#assign objProduct_productName_defaultValue='${compJson!}'>
									...
									<@datacolumn key="objProduct.productName"        showFormat="SELECTCOMP" defaultValue="${(objProduct_productName_defaultValue!)?string}" defaultDisplay="${(objProduct_productName_displayDefaultType!)?string}" decimal="" editable=false type="selectcomp" showType="selectcomp" notnull=false   selectCompName="MESBasic.factoryModel.factoryModel.factoryView"  textalign="left"  viewUrl="/MESBasic/product/product/productRef.action" viewCode="MESBasic_1_product_productRef" mneenable=true crossCompany=false viewTitle="${getText('MESBasic.viewtitle.radion1415773613713')}"  label="${getText('MESBasic.propertydisplayName.radion1415772740737')}" width=140 showFormatFunc=""  />
							...
							<#elseif (objProduct_productCode_defaultValue!)?string=="currentComp">
								<#assign objProduct_productCode_defaultValue='${compJson!}'>
									...
									<@datacolumn key="objProduct.productCode"        showFormat="TEXT" defaultValue="${(objProduct_productCode_defaultValue!)?string}" defaultDisplay="${(objProduct_productCode_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="MESBasic.factoryModel.factoryModel.factoryView"  textalign="left"  viewUrl="/MESBasic/product/product/ref.action" viewCode="MESBasic_1_product_ref" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1428027703233')}"  label="${getText('MESBasic.propertydisplayName.radion1415772644833')}" width=140 showFormatFunc=""  />
							...
							<#assign emsFlag_displayDefaultType=''>
								<#assign emsFlag_defaultValue=''>
									...
									<@datacolumn key="emsFlag"        showFormat="CHECKBOX" defaultValue="${(emsFlag_defaultValue!)?string}" defaultDisplay="${(emsFlag_displayDefaultType!)?string}" decimal="" editable=false type="boolean" showType="checkbox" notnull=false     textalign="center"  viewUrl="" viewCode="" mneenable=false crossCompany=false viewTitle="${getText('')}"  label="${getText('MESBasic.propertydisplayName.randon1490343661648')}" width=100 showFormatFunc=""  />
			...
			<script type="text/javascript">
				...
				function savedg1460958766002DataGrid(){
					...
					$('<input type="hidden" name="dgLists[\'dg1460958766002\']">').val(json).appendTo($('#MESBasic_factoryModel_factoryModel_factoryView_form'));
					$('<input type="hidden" name="dg1460958766002ModelCode">').val('MESBasic_1_factoryModel_ObjProduct').appendTo($('#MESBasic_factoryModel_factoryModel_factoryView_form'));
					//兼容旧版本提交函数
					$('<input type="hidden" name="dg1460958766002ListJson">').val(json).appendTo($('#MESBasic_factoryModel_factoryModel_factoryView_form'));
				}
				function DT_ObjProduct_dg1460958766002_deldatagrid(){
					...
					$.each(deleteRows, function(index, deleteRow){
						...
						if($("#dg1460958766002DeletedIds").length>0){
							...
							CUI('<input type="hidden" id="dg1460958766002DeletedIds" name="dgDeletedIds[\'dg1460958766002\']" value="'+tepID+'">').appendTo(CUI('#MESBasic_factoryModel_factoryModel_factoryView_form'));
						}
						//兼容旧版本提交函数
						CUI('<input type="hidden" name="dg1460958766002DeletedIds['+CUI('input[name^="dg1460958766002DeletedIds"]').length+']'+'" value="'+tepID+'">').appendTo(CUI('#MESBasic_factoryModel_factoryModel_factoryView_form'));
					});
					return deleteRows;
				}
				...
				function ObjProduct_dg1460958766002_showImportDialog(){
					try{
						...
						var url = "/MESBasic/factoryModel/factoryModel/initImport.action?datagridCode=MESBasic_1_factoryModel_factoryEditdg1460958766002&tid=${id!}&datagridName=dg1460958766002";
							<#if canImportExcel>
								var buttonCode="MESBasic_1_factoryModel_factoryViewdg1460958766002_BUTTON_dgImport";
								url+="&buttonCode="+buttonCode;
							</#if>
	...
	if(key=="emsFlag"){
		...
		<div id="MESBasic_factoryModel_factoryModel_factoryView_dealInfo" style="display: none;margin-top:5px;">
			<ul class="edit-tabs">
				<li id="fileUploadHead" <#if !(superEdit!false)>class="bar"</#if> onclick="MESBasic.factoryModel.factoryModel.factoryView.showFileUpload('fileUpload')"><span class="icon_file"></span>${getText("foundation.upload.attachment")}</li>
			</ul>
			<div class="edit-panes wid-hei"  style="padding:0px;">
				<div id="fileUploadDiv" class="wid-hei"></div>
			</div>
		</div>
		<!-- CUSTOM CODE START(view-VIEW-MESBasic_1_factoryModel_factoryView,html,MESBasic_1_factoryModel_FactoryModel,MESBasic_1) -->
<!-- 自定义代码 -->
...
<!-- CUSTOM CODE END -->
			...
			$(window).resize(function(){
				...
				if (width <= 800) {
					if($("#edit_sidebar").length==0 || $("#edit_sidebar").css("display")=="none"){
						$("#MESBasic_factoryModel_factoryModel_factoryView_main_div").css("width",800);
						$(".edit-head").css("width",800);
						$(".edit-workflow").css("width",800);
						$("body").css({"overflow-x":"scroll","position":"relative","zIndex":"100"});
					}else{
						$("#MESBasic_factoryModel_factoryModel_factoryView_main_div").css("width",650);
					...
					if (YAHOO.env.ua.ie == "6") {
						$("#MESBasic_factoryModel_factoryModel_factoryView_main_div").css("width",w1);
						$(".edit-workflow").css("width",w1);
					}else{
						$("#MESBasic_factoryModel_factoryModel_factoryView_main_div").css("width","auto");
		...
		<script type="text/javascript">
			MESBasic.factoryModel.factoryModel.factoryView.initCount = 0;
			MESBasic.factoryModel.factoryModel.factoryView.initSize = function(nTabIndex){
				var panesHeight;
				var thisHeight;
				var h = $(window).height();
			    var w = $(window).width();
				...
				var conHeight = h-$("#MESBasic_factoryModel_factoryModel_factoryView_main_div .edit-head").height()-$("#MESBasic_factoryModel_factoryModel_factoryView_main_div .edit-tabs").height()<#if pendingId?? || editNew>-$("#MESBasic_factoryModel_factoryModel_factoryView_main_div .edit-workflow").height()</#if>;
				$("#MESBasic_factoryModel_factoryModel_factoryView_main_div .edit-tabs").length == 0 ? conHeight = conHeight : conHeight = conHeight-28 //再减去28px，28px是由.edit-tabs的margin-top:14px+6px边框+8px的底部边距组成
				panesHeight = conHeight*0.4;  //当表单跟pt共存的时候采用4/6开
				var datagrids = $('body').data('MESBasic_factoryModel_factoryModel_factoryView_datagrids');
				var padding_bottom=16;
				$("#MESBasic_factoryModel_factoryModel_factoryView_main_div .pd_bottom,#MESBasic_factoryModel_factoryModel_factoryView_main_div .edit-tabs").width(w-14*2-2-width_)  //把tab跟tab下面的内容宽度统一调整
				$("#MESBasic_factoryModel_factoryModel_factoryView_main_div .edit-panes-s").each(function(index){
					//多页签切换时只计算本页签下的PT高度
					...
					if(datagrids && datagrids.length > 0) {
						if(datagrids[index].length > 0) {
							...
							for(var dg=0;dg<datagrids[index].length;dg++) {
								...
								if(dgwidget) {
									...
									if(MESBasic.factoryModel.factoryModel.factoryView.initCount <= 2) {
										setTimeout(function(){MESBasic.factoryModel.factoryModel.factoryView.initSize();}, 200);
										MESBasic.factoryModel.factoryModel.factoryView.initCount++;
									}/* else {
										MESBasic.factoryModel.factoryModel.factoryView.initCount = 0;
									}*/
								}
						...
						if(thisHeight < conHeight){ //当此页签下面的实际内容高度小于分配给它的高度
							...
							$(this).parent().height(conHeight);
							if(($("#MESBasic_factoryModel_factoryModel_factoryView_main_div .edit-workflow").length > 0) && ($("#MESBasic_factoryModel_factoryModel_factoryView_main_div .edit-tabs").length > 0)){		// 底下有处理结果，并且头部有页签切换，此时底部留白14像素
			...
			$(function(){
				$('#MESBasic_factoryModel_factoryModel_factoryView_form').get(0).onkeydown=function(event){
				...
				MESBasic.factoryModel.factoryModel.factoryView.buttonBar = new CUI.ButtonBar( { panel: '#top_buttonbar' }  );
				MESBasic.factoryModel.factoryModel.factoryView.initSize();
				if(YAHOO.env.ua.ie == 6){
				...
				<#if businessCenterList??&&businessCenterList?size gt 0 >
					...
					$("#edit_side_btn").toggle(function(){
						if(parseInt($("#MESBasic_factoryModel_factoryModel_factoryView_main_div").css("width"),10)==650){
							$("#MESBasic_factoryModel_factoryModel_factoryView_main_div").css("width","800px");
						...
						//MESBasic.factoryModel.factoryModel.factoryView.resizeLayout();
						//MESBasic.factoryModel.factoryModel.factoryView.initSize();
						$('body').trigger('resize');
					},function(){
						if(parseInt($("#MESBasic_factoryModel_factoryModel_factoryView_main_div").css("width"),10)==800){
							$("#MESBasic_factoryModel_factoryModel_factoryView_main_div").css("width","650px");
				...
				$(window).resize(function(){MESBasic.factoryModel.factoryModel.factoryView.initSize();});
				/*
				MESBasic.factoryModel.factoryModel.factoryView.resizeLayout=function(){
		...
		MESBasic.factoryModel.factoryModel.factoryView.validate = function(){
		...
		MESBasic.factoryModel.factoryModel.factoryView.beforeSaveProcess = function(){
			$('input[name="factoryModel.extraCol"]').remove();
		}
		MESBasic.factoryModel.factoryModel.factoryView.processDataGrid = function(){
										<#if false && isIE>
										$('#MESBasic_factoryModel_factoryModel_factoryView_form').append(ObjPostion_dg1460955592809Widget._DT.createInputs('dg1460955592809List'));
										</#if>
										<#if false && isIE>
										$('#MESBasic_factoryModel_factoryModel_factoryView_form').append(ObjTeam_dg1490261761014Widget._DT.createInputs('dg1490261761014List'));
										</#if>
										<#if false && isIE>
										$('#MESBasic_factoryModel_factoryModel_factoryView_form').append(ObjEquipment_dg1460958585675Widget._DT.createInputs('dg1460958585675List'));
										</#if>
										<#if false && isIE>
										$('#MESBasic_factoryModel_factoryModel_factoryView_form').append(ObjProduct_dg1460958766002Widget._DT.createInputs('dg1460958766002List'));
										</#if>
		};
		MESBasic.factoryModel.factoryModel.factoryView.save = function(){
			$('#operateType').val("submit");
			try{eval('beforeSubmitUploadForm()');}catch(e){}
			if(!MESBasic.factoryModel.factoryModel.factoryView.validate()){return;}
			//延迟到延迟提交中处理,解决onchange事件无法触发问题
			//MESBasic.factoryModel.factoryModel.factoryView.beforeSaveProcess();

			//MESBasic.factoryModel.factoryModel.factoryView.processDataGrid();
			$('#MESBasic_factoryModel_factoryModel_factoryView_form').submit();
		}
		
		<#if viewType != "readonly">
		$(window).bind('beforeunload',function(){
		        if(isFormChanged('MESBasic_factoryModel_factoryModel_factoryView_form','MESBasic_factoryModel_factoryModel_factoryView_datagrids')) {      
		...
		//打印
		MESBasic.factoryModel.factoryModel.factoryView.print = function(){
		...
		MESBasic.factoryModel.factoryModel.factoryView.saveSetting = function(){
		...
		MESBasic.factoryModel.factoryModel.factoryView.printSetting = function(){
			var viewCode = $('input[name="viewCode"]').val();
			var value = "";
			var printId = 0;
			var printVersion = 0;
			if(viewCode!=undefined && viewCode!=null && viewCode!=''){
				...
				MESBasic.factoryModel.factoryModel.factoryView.settingDialog = new CUI.Dialog({
					...
					buttons:[
							{	name:"${getText("ec.flow.save")}",
								handler:function(){if(MESBasic.factoryModel.factoryModel.factoryView.saveSetting()){this.close();}}
							},
							{	name:"${getText("ec.flow.cancal")}",
								handler:function(){this.close()}
							}]
					})
				MESBasic.factoryModel.factoryModel.factoryView.settingDialog.show();
			}
		}
		
		
		MESBasic.factoryModel.factoryModel.factoryView._callBackInfo = function(res){
		...
		function dataGridBtnImgClick(sUrl,objNameCustomCondition,sTitle,sPTGridID,nRow,sFieldName,oGrid,customCallBack,crossCompany,isObjCustomProp,objCustomPropNames,viewCode){
			...
			if(customCallBack){
				MESBasic.factoryModel.factoryModel.factoryView._customCallBack = customCallBack;
			}
			if (isObjCustomProp) {
				MESBasic.factoryModel.factoryModel.factoryView._isObjCustomProp_IE = isObjCustomProp;
			} else {
				MESBasic.factoryModel.factoryModel.factoryView._isObjCustomProp_IE = false;
			}
			if (objCustomPropNames) {
				MESBasic.factoryModel.factoryModel.factoryView._objCustomPropNames_IE = objCustomPropNames;
			} else {
				MESBasic.factoryModel.factoryModel.factoryView._objCustomPropNames_IE = '';
			}
			if (viewCode) {
				MESBasic.factoryModel.factoryModel.factoryView._refViewCode_IE = viewCode;
			} else {
				MESBasic.factoryModel.factoryModel.factoryView._refViewCode_IE = '';
			}
			MESBasic.factoryModel.factoryModel.factoryView._selectEvent(objNameCustomCondition,null,sUrl,sTitle,null,null,null,crossCompany,obj);
		}
		
		MESBasic.factoryModel.factoryModel.factoryView.initMnemonic_DG_IE = function(oConfig){
			// 助记码也需要区分是否为自定义字段
			MESBasic.factoryModel.factoryModel.factoryView._isObjCustomProp_IE = oConfig._isObjCustomProp_IE;
			MESBasic.factoryModel.factoryModel.factoryView._objCustomPropNames_IE = oConfig._objCustomPropNames_IE;
			
			var oGrid = oConfig.oGrid;
			// 获取控件PT  object
			var oPTGridEx = oGrid._DT || oGrid;
			// 存储当前操作相关信息
			MESBasic.factoryModel.factoryModel.factoryView.gridEventObj = {
				"oGrid" : oGrid,
				"nRow" : oConfig.nRow - 1,
				"sKey":	oConfig.sFieldName
			}
			MESBasic.factoryModel.factoryModel.factoryView._sUrl = oConfig.url;
			if(oConfig.customCallBack){
				MESBasic.factoryModel.factoryModel.factoryView._customCallBack = oConfig.customCallBack;
			}
			// 自定义的表格对象
		...
		MESBasic.factoryModel.factoryModel.factoryView._selectEvent = function(objName,_selectType,url,title,refparam,obj,customCallBack,crossCompanyFlag,gridEventObj,oGrid,isMultiselect,oColumn){

			var callbackName="";
			var condition='';
			var _prefix= '';
			var arr = objName.split('.');
			if(MESBasic.factoryModel.factoryModel.factoryView._querycustomFunc(objName.replace(/\./g, '_')) !=null){
				condition=encodeURIComponent(MESBasic.factoryModel.factoryModel.factoryView._querycustomFunc(objName.replace(/\./g, '_')));
			}
			if(gridEventObj) {
				MESBasic.factoryModel.factoryModel.factoryView.gridEventObj = gridEventObj;
				callbackName = "MESBasic.factoryModel.factoryModel.factoryView.getcallBackInfo_DG_IE";
			}else if(obj!=null && obj!=""){
				if(arr.length > 1){
					_prefix = '.'+ arr[0];
				}
				callbackName = isMultiselect ? "MESBasic.factoryModel.factoryModel.factoryView.getMultiselectCallBackInfo_DG" : "MESBasic.factoryModel.factoryModel.factoryView.getcallBackInfo_DG";
				MESBasic.factoryModel.factoryModel.factoryView._currRow = $(obj).closest('tr')[0];
			}else{
				if(arr.length > 2){
					_prefix = '.'+ arr[0] + '.'+ arr[1];
				}
				callbackName ="MESBasic.factoryModel.factoryModel.factoryView.getcallBackInfo";
			}

			if(_prefix!=''){
				MESBasic.factoryModel.factoryModel.factoryView._prefix = _prefix.substring(1);
			}
			
			MESBasic.factoryModel.factoryModel.factoryView._oGrid = oGrid;
			MESBasic.factoryModel.factoryModel.factoryView._sUrl = url;
			if (oColumn) {
				if (oColumn.isObjCustomProp) {
					MESBasic.factoryModel.factoryModel.factoryView._isObjCustomProp = oColumn.isObjCustomProp;
				} else {
					MESBasic.factoryModel.factoryModel.factoryView._isObjCustomProp = false;
				} 
				if (oColumn.objCustomPropNames) {
					MESBasic.factoryModel.factoryModel.factoryView._objCustomPropNames = oColumn.objCustomPropNames;
				} else {
					MESBasic.factoryModel.factoryModel.factoryView._objCustomPropNames = '';
				}
				if (oColumn.viewCode) {
					MESBasic.factoryModel.factoryModel.factoryView._refViewCode = oColumn.viewCode;
				} else {
					MESBasic.factoryModel.factoryModel.factoryView._refViewCode = '';
				}
			} else {
				MESBasic.factoryModel.factoryModel.factoryView._isObjCustomProp = false;
				MESBasic.factoryModel.factoryModel.factoryView._objCustomPropNames = '';
			...
			if (MESBasic.factoryModel.factoryModel.factoryView._isObjCustomProp == true && MESBasic.factoryModel.factoryModel.factoryView._objCustomPropNames && objName && objName.substring(objName.length - 'MainDisplay'.length) == 'MainDisplay') {
				MESBasic.factoryModel.factoryModel.factoryView._prefix = objName.substring(0, objName.length - 'MainDisplay'.length);
			}
			if(customCallBack){
				MESBasic.factoryModel.factoryModel.factoryView._customCallBack = customCallBack;
			}
			if(MESBasic.factoryModel.factoryModel.factoryView._querycustomFunc(objName.replace(/\./g, '_')) != null) {
				refparam = 'condition=' + encodeURIComponent(MESBasic.factoryModel.factoryModel.factoryView._querycustomFunc(objName.replace(/\./g, '_')));
			}
			if(typeof MESBasic.factoryModel.factoryModel.factoryView._querycustomFuncN == "function") {
				refparam += MESBasic.factoryModel.factoryModel.factoryView._querycustomFuncN();
			}
			...
			MESBasic.factoryModel.factoryModel.factoryView._dialog = foundation.common.select({
				pageType : 'other',
				closePage : true,
				condition : condition,
		...
		MESBasic.factoryModel.factoryModel.factoryView._groupSelectEvent = function(objName,_selectType,url,title,refparam){
			if(MESBasic.factoryModel.factoryModel.factoryView._querycustomFunc(objName.replace(/\./g, '_')) != null) {
				refparam = 'condition=' + encodeURIComponent(MESBasic.factoryModel.factoryModel.factoryView._querycustomFunc(objName.replace(/\./g, '_')));
			}
			MESBasic.factoryModel.factoryModel.factoryView._dialog = foundation.common.select({
				...
				closePage : true,
				callBackFuncName : 'MESBasic.factoryModel.factoryModel.factoryView.getcallBackGroupInfo',
				url : url,
				title : title,
				params : refparam
			});
		}
		MESBasic.factoryModel.factoryModel.factoryView._querycustomFunc = function(obj) {
			var str = eval("typeof(MESBasic.factoryModel.factoryModel.factoryView.query_"+obj+")!='undefined'") ? eval('MESBasic.factoryModel.factoryModel.factoryView.query_'+obj+'()') : null;
			return str;
		};
		MESBasic.factoryModel.factoryModel.factoryView.getcallBackGroupInfo = function(obj){
			var ids = "";
			var names = "";
			...
			MESBasic.factoryModel.factoryModel.factoryView._dialog.close();
		}
		MESBasic.factoryModel.factoryModel.factoryView.getcallBackInfo = function(obj){
		
			obj[0] = foundation.common.getObject('MESBasic_factoryModel_factoryModel_factoryView_form',obj[0], MESBasic.factoryModel.factoryModel.factoryView._prefix, MESBasic.factoryModel.factoryModel.factoryView._sUrl);
			CUI.commonFills('MESBasic_factoryModel_factoryModel_factoryView_form',MESBasic.factoryModel.factoryModel.factoryView._prefix,obj[0]);
			
			for(pro in obj[0]){
				try{
					var fname = "_callback_" + (MESBasic.factoryModel.factoryModel.factoryView._prefix + "." + pro).replace(/\./g, '_')  + "_edit";
			...
			try{
				if(MESBasic.factoryModel.factoryModel.factoryView._customCallBack) {
					eval(MESBasic.factoryModel.factoryModel.factoryView._customCallBack);
					MESBasic.factoryModel.factoryModel.factoryView._customCallBack = null;
				}
		...
		// 控件版PT回调
		MESBasic.factoryModel.factoryModel.factoryView.getcallBackInfo_DG_IE = function(obj){
			if(MESBasic.factoryModel.factoryModel.factoryView._customBeforeCallBack) {
				var flag = eval(MESBasic.factoryModel.factoryModel.factoryView._customBeforeCallBack.split("(")[0] + "(obj)");
				if(flag === false){
					return false;
				}
			}
			var gridEventObj = MESBasic.factoryModel.factoryModel.factoryView.gridEventObj;
			var rootKey = gridEventObj.sKey.split('.')[0];
			var jsonObj;
			if ( MESBasic.factoryModel.factoryModel.factoryView._isObjCustomProp_IE == true && MESBasic.factoryModel.factoryModel.factoryView._objCustomPropNames_IE ) {
				jsonObj = foundation.common.getObjectIE_CP_OBJ(gridEventObj,obj[0],rootKey,MESBasic.factoryModel.factoryModel.factoryView._sUrl,MESBasic.factoryModel.factoryModel.factoryView._objCustomPropNames_IE);
			} else {
				jsonObj = foundation.common.getObjectIE(gridEventObj,obj[0],rootKey,MESBasic.factoryModel.factoryModel.factoryView._sUrl);
			}
			CUI.error_msg_DG_CP_map = {};
			var xmlHead = $(gridEventObj.oGrid._DT.opts.oXMLData).children( ':eq(0)' ).children( ':eq(0)' );
			if (MESBasic.factoryModel.factoryModel.factoryView._isObjCustomProp_IE == true && MESBasic.factoryModel.factoryModel.factoryView._objCustomPropNames_IE) { // 控件版PT显示自定义字段
				var showName = MESBasic.factoryModel.factoryModel.factoryView._objCustomPropNames_IE.split(',')[0]; // 主显示字段名称
				var trueName = MESBasic.factoryModel.factoryModel.factoryView._objCustomPropNames_IE.split(',')[1]; // 主键字段名称
			...
			if ( $('#dg_cp_info_' + gridEventObj.oGrid._DT.opts.id).length > 0 ) {
				...
				var id = jsonObj.id;
				var relationMap;
				if (dg_cp_info && id && MESBasic.factoryModel.factoryModel.factoryView._refViewCode_IE) {
					$.ajax({
						async   : false,
						type    : 'POST',
						url     : '/foundation/customProp/related.action',
						data    : 'code=' + MESBasic.factoryModel.factoryModel.factoryView._refViewCode_IE + '&id=' + id,
		...
		MESBasic.factoryModel.factoryModel.factoryView.getcallBackInfo_DG = function(obj){
			if(MESBasic.factoryModel.factoryModel.factoryView._customBeforeCallBack) {
				var flag = eval(MESBasic.factoryModel.factoryModel.factoryView._customBeforeCallBack.split("(")[0] + "(obj)");
				if(flag === false){
					return false;
			...
			for(var i=0;i<obj.length;i++){
				if(i>0){
					if($(MESBasic.factoryModel.factoryModel.factoryView._currRow).next().length==0){
						MESBasic.factoryModel.factoryModel.factoryView._oGrid.addNewRow();
					}	
					MESBasic.factoryModel.factoryModel.factoryView._currRow = $(MESBasic.factoryModel.factoryModel.factoryView._currRow).next();
					$(MESBasic.factoryModel.factoryModel.factoryView._currRow).attr('isEdited',true);
				}
				obj[i] = foundation.common.getObject(MESBasic.factoryModel.factoryModel.factoryView._currRow,obj[i], MESBasic.factoryModel.factoryModel.factoryView._prefix, MESBasic.factoryModel.factoryModel.factoryView._sUrl);
				if (MESBasic.factoryModel.factoryModel.factoryView._isObjCustomProp == true && MESBasic.factoryModel.factoryModel.factoryView._objCustomPropNames) {
					eval("CUI.commonFills_DG_CP_OBJ(MESBasic.factoryModel.factoryModel.factoryView._currRow,MESBasic.factoryModel.factoryModel.factoryView._prefix,obj[i],MESBasic.factoryModel.factoryModel.factoryView._oGrid,MESBasic.factoryModel.factoryModel.factoryView._objCustomPropNames)");
				} else {
					eval("CUI.commonFills_DG(MESBasic.factoryModel.factoryModel.factoryView._currRow,MESBasic.factoryModel.factoryModel.factoryView._prefix,obj[i],MESBasic.factoryModel.factoryModel.factoryView._oGrid)");
				}
				
				// 自定义字段参照回填
				if ( $('#dg_cp_info_' + MESBasic.factoryModel.factoryModel.factoryView._oGrid.dataTableId).length > 0 ) {
					var dg_cp_info = $('#dg_cp_info_' + MESBasic.factoryModel.factoryModel.factoryView._oGrid.dataTableId).val();
					var id = obj[i].id;
					var relationMap;
					if (dg_cp_info && id && MESBasic.factoryModel.factoryModel.factoryView._refViewCode) {
						$.ajax({
							async   : false,
							type    : 'POST',
							url     : '/foundation/customProp/related.action',
							data    : 'code=' + MESBasic.factoryModel.factoryModel.factoryView._refViewCode + '&id=' + id,
							success : function(res){
								if (res.dealSuccessFlag && res.relationMap) {
									relationMap = res.relationMap;
								}
						...
						if (relationMap) {
							...
							for (var n in infoArr) {
								...
								var val = relationMap[key];
								if (val) {
									name = MESBasic.factoryModel.factoryModel.factoryView._oGrid.configs.hidekeyPrefix + name;
									objs[name] = val;
									if (propCode) {
										$.ajax({
											async   : false,
							...
							// console.log(objs);
							if (objs) {
								CUI.commonFills_DG_CP(MESBasic.factoryModel.factoryModel.factoryView._currRow, objs, MESBasic.factoryModel.factoryModel.factoryView._oGrid);
							}
						}
					}
				}
				...
				try{
					...
					for ( var item in  CUI.error_msg_DG_CP_map ){
						for ( var n in  CUI.error_msg_DG_CP_map[item] ){
							errorMsg += ( '<b>' + MESBasic.factoryModel.factoryModel.factoryView._oGrid.getLabel(item) +  '</b>第<b>' + ( parseInt( n, 10 ) + 1)  + '</b>行回填失败！原因:系统编码值不匹配！<br/>' );
						}
					}
					if( errorMsg ){
						workbenchErrorBarWidget.showMessage( errorMsg );
		...
		MESBasic.factoryModel.factoryModel.factoryView.getMultiselectCallBackInfo_DG = function(obj){
			for(var i=0;i<obj.length;i++){
				CUI.commonFillsMultiselect_DG(MESBasic.factoryModel.factoryModel.factoryView._oGrid, MESBasic.factoryModel.factoryModel.factoryView._currRow, MESBasic.factoryModel.factoryModel.factoryView._key, MESBasic.factoryModel.factoryModel.factoryView._displayFieldName, obj[i])
			}
			try{
				if(MESBasic.factoryModel.factoryModel.factoryView._customCallBack) {
					eval(MESBasic.factoryModel.factoryModel.factoryView._customCallBack);
		...
		MESBasic.factoryModel.factoryModel.factoryView.generateInput = function(prefix, obj) {
			CUI.each(obj, function(key,value){
				if(value!=null && key!='rowHtmlObj' && key!='cellHtmlObj'){
					var name = prefix + '.' + key;
					if(typeof value == 'object') {
						MESBasic.factoryModel.factoryModel.factoryView.generateInput(name, value);
					} else {
						if(value!=null&&value!='null'&&value!=undefined&&value!='') {
							CUI('input[name="' + name + '"]').remove();
							CUI('<input type="hidden" name="'+name+'" value="'+value+'">').appendTo(CUI('#MESBasic_factoryModel_factoryModel_factoryView_form'));
						}
					}
				}
			});
		...
		$(function(){
			MESBasic.factoryModel.factoryModel.factoryView.onloadForProduct();
...
$.ajax(
{
	...
	success: function (result) {
		...
		MESBasic.factoryModel.factoryModel.factoryView.beforeSubmitMethodSettingInPage = function(){
			MESBasic.factoryModel.factoryModel.factoryView.onsaveForProduct();
	...
	for(var i = 0;i < ObjEquipment_dg1460958585675Widget.getRowLength();i++){
		...
		MESBasic.factoryModel.factoryModel.factoryView.beforeSubmitMethod = function(){
			...
			var customOnsaveResult =  MESBasic.factoryModel.factoryModel.factoryView.beforeSubmitMethodSettingInPage();
		...
		<script type="text/javascript">
		MESBasic.factoryModel.factoryModel.factoryView.showBusinessList = function(relatingModelCode,mainEntityId,businessCenterCode,url,showType){
			...
			if(CUI(id).html() == null || $.trim(CUI(id).html()) == ""){
				CUI(id).load(url);
				setTimeout(function(){
					CUI("#MESBasic_factoryModel_factoryModel_factoryView_main_div").hide();
				},100);
			}else{
			    CUI(id).load(url);
				setTimeout(function(){
		...
		MESBasic.factoryModel.factoryModel.factoryView.showThis = function(){
			if(!CUI("#MESBasic_factoryModel_factoryModel_factoryView_main_div").is(':visible')) {
				CUI("#MESBasic_factoryModel_factoryModel_factoryView_main_div").show();
		...
		MESBasic.factoryModel.factoryModel.factoryView.showAudit=function(){
			<#if !id?? || editNew>
			CUI.Dialog.alert("${getText("foundation.base.audit.nolog")}")
			<#else>
			MESBasic.factoryModel.factoryModel.factoryView.auditDialog = new CUI.Dialog({
				title : "${getText("foundation.base.audit")}",
				iframe : "MESBasic_factoryModel_factoryModel_factoryView_auditInfo",
				modal:true,
			...
			MESBasic.factoryModel.factoryModel.factoryView.auditDialog.show();
			</#if>
		}
		
		
		MESBasic.factoryModel.factoryModel.factoryView.showInfoDialog=function(mode){
			
			MESBasic.factoryModel.factoryModel.factoryView.infoDialog = new CUI.Dialog({
				title: "${getText("ec.view.info.view")}",
				elementId: "MESBasic_factoryModel_factoryModel_factoryView_dealInfo",
				modal:true,
				height:500,
				width: 950,//适应国际化版
				buttons:[
			...
			MESBasic.factoryModel.factoryModel.factoryView.infoDialog.show();
		...
		MESBasic.factoryModel.factoryModel.factoryView.showFileUpload=function(){
			...
			<#else>
			CUI("#fileUploadDiv").load("/foundation/workbench/fileupload-new-init.action?readOnlyFlag=true&linkId=${fileuploadLinkId!-1}&type=${fileuploadType!'Table'}&entityCode=MESBasic_1_factoryModel");
			</#if>
			}
		}
		
		MESBasic.factoryModel.factoryModel.factoryView.showDealInfo=function(){
		...
		MESBasic.factoryModel.factoryModel.factoryView.showFlowInfo=function(){
		...
		MESBasic.factoryModel.factoryModel.factoryView.supervision=function(){
			MESBasic.factoryModel.factoryModel.factoryView.modifyOwnerStaffDialog = new CUI.Dialog({
				...
				MESBasic.factoryModel.factoryModel.factoryView.modifyOwnerStaffDialog.show();
		}
...
function ClearTypeChange(nRow){
	...
	if(ClearType == ''){
		...
		/* CUSTOM CODE START(view-VIEW-MESBasic_1_factoryModel_factoryView,js,MESBasic_1_factoryModel_FactoryModel,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
		MESBasic.factoryModel.factoryModel.factoryView.onloadForProduct = function(){
		/* CUSTOM CODE START(view-VIEW-MESBasic_1_factoryModel_factoryView,onloadForProduct,MESBasic_1_factoryModel_FactoryModel,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
		}

		MESBasic.factoryModel.factoryModel.factoryView.onsaveForProduct = function(){
		/* CUSTOM CODE START(view-VIEW-MESBasic_1_factoryModel_factoryView,onsaveForProduct,MESBasic_1_factoryModel_FactoryModel,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */		
		...
		<div class="col-sub">
			...
			<div class="edit-sidebar-inner" style='height:1000px;'>
				<div class="sidebar-top"><a href="#"  onclick="MESBasic.factoryModel.factoryModel.factoryView.showThis()">${getText("ec.view.tableInfo")}</a></div>
					...
					<ul>
						<#list businessCenterList as l>
						 <li>
							...
							<#else>
								<a href="#"  onclick="MESBasic.factoryModel.factoryModel.factoryView.showBusinessList('${l.relatingModel.code.replace('.','')}',${(factoryModel.id)!},'${l.code}','${l.assview.url}?${getPowerCode(l.assview.code+'_self')}','${l.assview.showType}')" title="${getText(l.showName)}(${(l.count)!})">${getText(l.showName)}(${(l.count)!})</a>
							</#if>
						</li>
					    </#list>
					</ul>
