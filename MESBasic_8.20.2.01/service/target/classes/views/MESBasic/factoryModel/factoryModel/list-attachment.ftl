...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=MESBasic_1_factoryModel";
	openExportFrame(url);
}
...
<div id="MESBasic_factoryModel_factoryModel_factoryListPart_attachment">	
