...
<Worksheet ss:Name="sheet1">
	<Table ss:ExpandedColumnCount="256" ss:ExpandedRowCount="3" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="16.5">
			...
			<Column ss:Index="4" ss:Width="100"  ss:StyleID="MESBasic_1_factoryModel_FactoryModel_area"/>
			<Column ss:Index="5" ss:Width="100"  ss:StyleID="MESBasic_1_factoryModel_FactoryModel_nodeDesc"/>
			<Column ss:Index="6" ss:Width="100"  ss:StyleID="MESBasic_1_factoryModel_FactoryModel_isEbr"/>
			<Column ss:Index="7" ss:Width="100"  ss:StyleID="MESBasic_1_factoryModel_FactoryModel_department"/>
			<Column ss:Index="8" ss:Width="100"  ss:StyleID="MESBasic_1_factoryModel_FactoryModel_assignBatchNo"/>
			<Column ss:Index="9" ss:Width="100"  ss:StyleID="MESBasic_1_factoryModel_FactoryModel_endItem"/>
			<Column ss:Index="10" ss:Width="100"  ss:StyleID="MESBasic_1_factoryModel_FactoryModel_workArea"/>
			<Column ss:Index="11" ss:Width="100"  ss:StyleID="MESBasic_1_factoryModel_FactoryModel_isOnlyStore"/>
			<Column ss:Index="12" ss:Width="100"  ss:StyleID="MESBasic_1_factoryModel_FactoryModel_runState"/>
			<Column ss:Index="13" ss:Width="100"  ss:StyleID="MESBasic_1_factoryModel_FactoryModel_emsFlag"/>
			<Column ss:Index="14" ss:Width="100"  ss:StyleID="MESBasic_1_factoryModel_FactoryModel_interfaceUrl"/>
	...
	<#if customStyleCodes??>
		...
		<Row ss:AutoFitHeight="0">
						...
						<Cell >
							<Data ss:Type="String">指定批号位号</Data>
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
						...
						<Cell >
							<Data ss:Type="String">结束工序位号</Data>
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
