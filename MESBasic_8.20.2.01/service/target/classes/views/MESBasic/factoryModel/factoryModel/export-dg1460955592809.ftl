...
<#assign showCusProps =  dgPage.showCusProps />
	...
	<Styles>
 		...
 		<Style ss:ID="s8">
  		...
  		<Style ss:ID="objPos.code">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
  		<Style ss:ID="objPos.department.fullPathName">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
  		<Style ss:ID="objPos.department.name">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
  		<Style ss:ID="objPos.name">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
 	</Styles>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0 && item != "checkbox">
									<#if item == 'objPos.name' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'objPos.code' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'objPos.department.name' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'objPos.department.fullPathName' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								<#if item == 'objPos.name' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('foundation.position.name')}</Data>
										</Cell>
								</#if>
								<#if item == 'objPos.code' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('foundation.position.code')}</Data>
										</Cell>
								</#if>
								<#if item == 'objPos.department.name' || item == '*'>
										<Cell>
								...
								<#if item == 'objPos.department.fullPathName' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('foundation.ec.common.fullPathName')}</Data>
										</Cell>
								</#if>
					...
					<#if item?length gt 0>
								<#if item == 'objPos.name' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.objPos.name)??>${(data.objPos.name)!}</#if></Data>
								...
								<#if item == 'objPos.code' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.objPos.code)??>${(data.objPos.code)!}</#if></Data>
								...
								<#if item == 'objPos.department.name' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.objPos.department.name)??>${(data.objPos.department.name)!}</#if></Data>
								...
								<#if item == 'objPos.department.fullPathName' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.objPos.department.fullPathName)??>${(data.objPos.department.fullPathName)!}</#if></Data>
