			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'nodeType.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1460947375824')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'area.value' || item == '*'>
							...
							<Row ss:AutoFitHeight="0">
								<#list exportFieldList as item>
									<#if item?length gt 0>
												<#if item == 'name' || item == '*'>
													<Cell>
													<#if checkFieldPermission('name','MESBasic_1_factoryModel_FactoryModel','MESBasic_1_factoryModel_FactoryModel_name') != 0>
												...
												<#if item == 'code' || item == '*'>
													<Cell>
													<#if checkFieldPermission('code','MESBasic_1_factoryModel_FactoryModel','MESBasic_1_factoryModel_FactoryModel_code') != 0>
												...
												<#if item == 'nodeType.name' || item == '*'>
													<Cell>
													<#if checkFieldPermission('nodeType.name','MESBasic_1_factoryModel_FactoryModel','MESBasic_1_factoryModel_FactoryModel_nodeType||MESBasic_1_nodeType_NodeType_name') != 0>
												...
												<#if item == 'area.value' || item == '*'>
													<Cell>
													<#if checkFieldPermission('area','MESBasic_1_factoryModel_FactoryModel','MESBasic_1_factoryModel_FactoryModel_area') != 0>
												...
												<#if item == 'description' || item == '*'>
													<Cell>
													<#if checkFieldPermission('description','MESBasic_1_factoryModel_FactoryModel','MESBasic_1_factoryModel_FactoryModel_nodeDesc') != 0>
								...
								<#if item??>
									<#if item.name?index_of(".")!=-1>
											...
											<Cell  ss:StyleID="${item.styleid}" >
												<#if checkFieldPermission('${(item.name)!}','MESBasic_1_factoryModel_FactoryModel','${(item.propertyCode)!}') != 0>
