...
<#assign viewCode = 'MESBasic_1_factoryModel_ObjProduct' />
<#assign propertyCode = '' />
									...
									<#if item?length gt 0>
												...
												<#if item == 'objProduct.productName' || item == '*'>
													<Cell>
														...
														<#if data.objProduct.productName??><Data ss:Type="String"><![CDATA[${(data.objProduct.productName)!}]]></Data></#if>
												...
												<#if item == 'objProduct.productCode' || item == '*'>
													<Cell>
														...
														<#if data.objProduct.productCode??><Data ss:Type="String"><![CDATA[${(data.objProduct.productCode)!}]]></Data></#if>
