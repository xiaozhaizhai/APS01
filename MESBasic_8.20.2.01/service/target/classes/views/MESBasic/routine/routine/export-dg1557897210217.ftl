 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								<#if item == 'STATUS' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('STATUS')}</Data>
										</Cell>
								</#if>
								<#if item == 'version' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('version')}</Data>
										</Cell>
								</#if>
					...
					<#if item?length gt 0>
								<#if item == 'STATUS' || item == '*'>
									<Cell>
										...
										<Data ss:Type="Number"><#if (data.STATUS)??>${(data.STATUS)!}</#if></Data>
								...
								<#if item == 'version' || item == '*'>
									<Cell>
										...
										<Data ss:Type="Number"><#if (data.version)??>${(data.version)!}</#if></Data>
