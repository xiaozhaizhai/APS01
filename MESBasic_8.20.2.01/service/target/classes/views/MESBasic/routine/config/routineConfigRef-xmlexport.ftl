...
<#assign viewCode = 'MESBasic_1_routine_Config' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="routine.code">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="routine.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'forSource' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1416558162801')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'forDestination' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1416558185409')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												<#if item == 'routine.code' || item == '*'>
													<Cell>
														...
														<#if data.routine.code??><Data ss:Type="String"><![CDATA[${(data.routine.code)!}]]></Data></#if>
												...
												<#if item == 'routine.name' || item == '*'>
													<Cell>
														...
														<#if data.routine.name??><Data ss:Type="String"><![CDATA[${(data.routine.name)!}]]></Data></#if>
												...
												<#if item == 'formula' || item == '*'>
													<Cell>
														...
														<#if data.formula??><Data ss:Type="String"><![CDATA[${(data.formula)!}]]></Data></#if>
