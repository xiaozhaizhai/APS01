...
<script type="text/javascript">
	...
	function download(){
		var url = "/MESBasic/resetDaily/resetDaily/downLoad.action?viewCode=MESBasic_1_resetDaily_resetDailyList&orgName=MESBasic_1_resetDaily_resetDailyList-import-error.xls&downloadType=mainError&time=${time}";
		window.open(url,"","");
	}
