...
<#assign viewCode = 'MESBasic_1_product_ProdSecUnit' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		<Style ss:ID="baseUnit.code">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="baseUnit.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="changeRate">
	  		...
	  		<Style ss:ID="secUnit.code">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="secUnit.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'baseUnit.code' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'baseUnit.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'changeRate' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'secUnit.code' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'secUnit.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'baseUnit.code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randoncode1437382413209')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'baseUnit.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion139823564048301')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'changeRate' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1530515455954')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'secUnit.code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randoncode1530515393619')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'secUnit.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1530515393619')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												...
												<#if item == 'baseUnit.code' || item == '*'>
													<Cell>
														...
														<#if data.baseUnit.code??><Data ss:Type="String"><![CDATA[${(data.baseUnit.code)!}]]></Data></#if>
												...
												<#if item == 'baseUnit.name' || item == '*'>
													<Cell>
														...
														<#if data.baseUnit.name??><Data ss:Type="String"><![CDATA[${(data.baseUnit.name)!}]]></Data></#if>
												...
												<#if item == 'changeRate' || item == '*'>
													<Cell>
														...
														<#if (data.changeRate)?has_content><Data ss:Type="Number">#{(data.changeRate)!; m6M6}</Data></#if>
												...
												<#if item == 'secUnit.code' || item == '*'>
													<Cell>
														...
														<#if data.secUnit.code??><Data ss:Type="String"><![CDATA[${(data.secUnit.code)!}]]></Data></#if>
												...
												<#if item == 'secUnit.name' || item == '*'>
													<Cell>
														...
														<#if data.secUnit.name??><Data ss:Type="String"><![CDATA[${(data.secUnit.name)!}]]></Data></#if>
