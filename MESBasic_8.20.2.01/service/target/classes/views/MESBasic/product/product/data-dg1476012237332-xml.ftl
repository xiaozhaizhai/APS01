...
<GridData DefaultNodeExpanded="false"   dgName="dg1476012237332" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<clevel
					...
					sort="true"  onPropertyChange="ProdLevel_dg1476012237332Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<compareID.productCode
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(ProdLevel_dg1476012237332Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(ProdLevel_dg1476012237332Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/product/product/ref.action','dg1476012237332compareID.productCode','${getText("MESBasic.viewtitle.randon1428027703233")}',sPTGridID,nRow,sFieldName,ProdLevel_dg1476012237332Widget,null,false,false,'','MESBasic_1_product_ref')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="ProdLevel_dg1476012237332Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
