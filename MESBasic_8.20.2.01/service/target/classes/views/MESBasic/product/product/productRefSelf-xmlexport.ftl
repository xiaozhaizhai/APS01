...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="attachExplain">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="correcteam">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="goodState">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		...
	  		<Style ss:ID="prostatus">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="provalue">
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'assetno' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'attachExplain' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											...
											<#if item == 'provalue' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'correcteam' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'storageplace' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'prostatus.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
											...
											<#if item == 'assetno' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1426063348625')}</Data></Cell>
											</#if>
											<#if item == 'attachExplain' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1416221150939')}</Data></Cell>
											</#if>
											<#if item == 'productSpecif' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415772620384')}</Data></Cell>
											</#if>
											<#if item == 'seqno' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1426062856782')}</Data></Cell>
											</#if>
											<#if item == 'unit' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1416221204854')}</Data></Cell>
											</#if>
											<#if item == 'provalue' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1426062803208')}</Data></Cell>
											</#if>
											<#if item == 'correcteam' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1426062928664')}</Data></Cell>
											</#if>
											<#if item == 'storageplace' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1426062975311')}</Data></Cell>
											</#if>
											<#if item == 'prostatus.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1426063248991')}</Data></Cell>
											</#if>
											<#if item == 'goodState.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1416221691507')}</Data></Cell>
											</#if>
							...
							<Row ss:AutoFitHeight="0">
								<#list exportFieldList as item>
									<#if item?length gt 0>
												...
												<#if item == 'assetno' || item == '*'>
													<Cell>
													<#if checkFieldPermission('assetno','MESBasic_1_product_Product','MESBasic_1_product_Product_assetno') != 0>
														<#if data.assetno??><Data ss:Type="String"><![CDATA[${(data.assetno)!}]]></Data></#if>
													</#if>
													</Cell>
												</#if>
												<#if item == 'attachExplain' || item == '*'>
													<Cell>
													<#if checkFieldPermission('attachExplain','MESBasic_1_product_Product','MESBasic_1_product_Product_attachExplain') != 0>
														<#if data.attachExplain??><Data ss:Type="String"><![CDATA[${(data.attachExplain)!}]]></Data></#if>
													</#if>
													</Cell>
												</#if>
												<#if item == 'productSpecif' || item == '*'>
												...
												<#if item == 'seqno' || item == '*'>
													<Cell>
													<#if checkFieldPermission('seqno','MESBasic_1_product_Product','MESBasic_1_product_Product_seqno') != 0>
														<#if data.seqno??><Data ss:Type="String"><![CDATA[${(data.seqno)!}]]></Data></#if>
													</#if>
													</Cell>
												</#if>
												<#if item == 'unit' || item == '*'>
													<Cell>
													<#if checkFieldPermission('unit','MESBasic_1_product_Product','MESBasic_1_product_Product_unit') != 0>
														<#if data.unit??><Data ss:Type="String"><![CDATA[${(data.unit)!}]]></Data></#if>
													</#if>
													</Cell>
												</#if>
												<#if item == 'provalue' || item == '*'>
													<Cell>
													<#if checkFieldPermission('provalue','MESBasic_1_product_Product','MESBasic_1_product_Product_provalue') != 0>
														<#if (data.provalue)?has_content><Data ss:Type="Number">#{(data.provalue)!; m2M2}</Data></#if>
													</#if>
													</Cell>
												</#if>
												<#if item == 'correcteam' || item == '*'>
													<Cell>
													<#if checkFieldPermission('correcteam','MESBasic_1_product_Product','MESBasic_1_product_Product_correcteam') != 0>
														<#if data.correcteam??><Data ss:Type="String"><![CDATA[${(data.correcteam)!}]]></Data></#if>
													</#if>
													</Cell>
												</#if>
												<#if item == 'storageplace' || item == '*'>
													<Cell>
													<#if checkFieldPermission('storageplace','MESBasic_1_product_Product','MESBasic_1_product_Product_storageplace') != 0>
														<#if data.storageplace??><Data ss:Type="String"><![CDATA[${(data.storageplace)!}]]></Data></#if>
													</#if>
													</Cell>
												</#if>
												<#if item == 'prostatus.value' || item == '*'>
													<Cell>
													<#if checkFieldPermission('prostatus','MESBasic_1_product_Product','MESBasic_1_product_Product_prostatus') != 0>
														<Data ss:Type="String">${getText('${(data.prostatus.value)!}')}</Data>
													</#if>
													</Cell>
												</#if>
												<#if item == 'goodState.value' || item == '*'>
													<Cell>
													<#if checkFieldPermission('goodState','MESBasic_1_product_Product','MESBasic_1_product_Product_goodState') != 0>
														<Data ss:Type="String">${getText('${(data.goodState.value)!}')}</Data>
													</#if>
													</Cell>
												</#if>
