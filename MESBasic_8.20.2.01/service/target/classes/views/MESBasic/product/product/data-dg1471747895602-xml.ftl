...
<GridData DefaultNodeExpanded="false"   dgName="dg1471747895602" pageSize="${dg1471747895602Page.pageSize}" totalCount="${dg1471747895602Page.totalCount}" totalPages="${dg1471747895602Page.totalPages}" pageNo="${dg1471747895602Page.pageNo}" hasPre="${dg1471747895602Page.hasPre?string}" hasNext="${dg1471747895602Page.hasNext?string}" prePage="${dg1471747895602Page.prePage}" nextPage="${dg1471747895602Page.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<resetCyc
					sort="false"  onPropertyChange="ProdResetDaily_dg1471747895602Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
	...
	<tbody>
		<#list dg1471747895602Page.result as row>
		<row  onClick="ProdResetDaily_dg1471747895602Widget._DT._autoAddNewRow(nRow)" >
					<c>${(row.id)!}</c>
					<c>${(row.version)!}</c>
			<#if cpObjHideKey?? && cpObjHideKey?has_content>
