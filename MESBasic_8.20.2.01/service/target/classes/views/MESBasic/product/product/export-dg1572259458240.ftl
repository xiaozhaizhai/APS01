 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								<#if item == 'baseUnit.name' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1530515344717')}</Data>
										</Cell>
								</#if>
								<#if item == 'secUnit.name' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1530515393619')}</Data>
										</Cell>
								</#if>
								<#if item == 'changeRate' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1530515455954')}</Data>
										</Cell>
								</#if>
								<#if item == 'demo' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1530515498015')}</Data>
										</Cell>
								</#if>
					...
					<#if item?length gt 0>
								<#if item == 'baseUnit.name' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.baseUnit.name)??>${(data.baseUnit.name)!}</#if></Data>
								...
								<#if item == 'secUnit.name' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.secUnit.name)??>${(data.secUnit.name)!}</#if></Data>
