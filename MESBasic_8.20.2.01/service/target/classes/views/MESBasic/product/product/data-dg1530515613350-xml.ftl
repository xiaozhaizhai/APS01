...
<GridData DefaultNodeExpanded="false"   dgName="dg1530515613350" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<baseUnit.name
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(ProdSecUnit_dg1530515613350Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(ProdSecUnit_dg1530515613350Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/X6Basic/unitGroup/baseUnit/unitRef.action','dg1530515613350baseUnit.name','${getText("X6Basic.viewtitle.radion1398240433147")}',sPTGridID,nRow,sFieldName,ProdSecUnit_dg1530515613350Widget,null,false,false,'','X6Basic_1.0_unitGroup_unitRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="ProdSecUnit_dg1530515613350Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<secUnit.name
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(ProdSecUnit_dg1530515613350Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(ProdSecUnit_dg1530515613350Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/X6Basic/unitGroup/baseUnit/unitRef.action','dg1530515613350secUnit.name','${getText("X6Basic.viewtitle.radion1398240433147")}',sPTGridID,nRow,sFieldName,ProdSecUnit_dg1530515613350Widget,null,false,false,'','X6Basic_1.0_unitGroup_unitRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="ProdSecUnit_dg1530515613350Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
	...
	<tbody>
		...
		<row  onClick="ProdSecUnit_dg1530515613350Widget._DT._autoAddNewRow(nRow)" >
					<c>${(row.id)!}</c>
					<c>${(row.version)!}</c>
					<c>${(row.baseUnit.id)!}</c>
					<c>${(row.secUnit.id)!}</c>
