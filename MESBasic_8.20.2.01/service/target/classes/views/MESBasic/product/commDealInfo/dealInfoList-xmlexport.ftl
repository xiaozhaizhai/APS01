...
<#assign viewCode = 'MESBasic_1_product_CommDealInfo' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'dealerID.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.staff.dimissionStaff_xls.staffName08')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'dealTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon147152482282503')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'dealContent' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon147152485003803')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												<#if item == 'dealerID.name' || item == '*'>
													<Cell>
														...
														<#if data.dealerID.name??><Data ss:Type="String"><![CDATA[${(data.dealerID.name)!}]]></Data></#if>
												...
												<#if item == 'dealTime' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.dealTime??><Data ss:Type="DateTime">${(data.dealTime)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
												...
												<#if item == 'dealContent' || item == '*'>
													<Cell>
														...
														<#if data.dealContent??><Data ss:Type="String"><![CDATA[${(data.dealContent)!}]]></Data></#if>
