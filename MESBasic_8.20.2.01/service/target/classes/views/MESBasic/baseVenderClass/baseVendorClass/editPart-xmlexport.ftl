...
<#assign viewCode = 'MESBasic_1_baseVenderClass_BaseVendorClass' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1449472741485')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1449472903805')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'vcMemo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1449472974516')}</Data></Cell>
											</#if>
									...
									<#if item?length gt 0>
												...
												<#if item == 'vcMemo' || item == '*'>
													<Cell>
														...
														<#if data.vcMemo??><Data ss:Type="String"><![CDATA[${(data.vcMemo)!}]]></Data></#if>
