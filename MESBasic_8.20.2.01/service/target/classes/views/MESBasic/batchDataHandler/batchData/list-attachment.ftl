...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=MESBasic_1_batchDataHandler";
	openExportFrame(url);
}
...
<div id="MESBasic_batchDataHandler_batchData_dataList_attachment">	
