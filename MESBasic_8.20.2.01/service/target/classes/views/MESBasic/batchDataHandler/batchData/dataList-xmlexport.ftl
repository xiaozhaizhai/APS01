...
<#assign viewCode = 'MESBasic_1_batchDataHandler_BatchData' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="dataTime">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="processed">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="purchaseCode">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="tag">
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'businessType.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'processed' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1446448712064')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'tag' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1446448741483')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'tvalue' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1555573666952')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'purchaseCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1555665070092')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'content' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1446448676587')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'businessType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1446448645696')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'dataTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1446448690014')}</Data></Cell>
											</#if>
									...
									<#if item?length gt 0>
												<#if item == 'processed' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.processed?? && data.processed>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'tag' || item == '*'>
													<Cell>
														...
														<#if data.tag??><Data ss:Type="String"><![CDATA[${(data.tag)!}]]></Data></#if>
												...
												<#if item == 'tvalue' || item == '*'>
													<Cell>
														...
														<#if data.tvalue??><Data ss:Type="String"><![CDATA[${(data.tvalue)!}]]></Data></#if>
												...
												<#if item == 'purchaseCode' || item == '*'>
													<Cell>
														...
														<#if data.purchaseCode??><Data ss:Type="String"><![CDATA[${(data.purchaseCode)!}]]></Data></#if>
												...
												<#if item == 'content' || item == '*'>
													<Cell>
														...
														<#if data.content??><Data ss:Type="String"><![CDATA[${(data.content)!}]]></Data></#if>
												...
												<#if item == 'businessType.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.businessType.value)!}')}</Data>
												...
												<#if item == 'dataTime' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.dataTime??><Data ss:Type="DateTime">${(data.dataTime)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
