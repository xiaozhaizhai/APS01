...
<#assign viewCode = 'MESBasic_1_storeSet_StoreSet' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		<Style ss:ID="inPriority">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="outPriority">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="owner.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="placeSetCode">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="placeSetName">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'placeSetCode' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'placeSetName' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'owner.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'inPriority' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'outPriority' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'inPriority' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1486607396188')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'outPriority' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1486616796931')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
							...
							<Row ss:AutoFitHeight="0">
								<#list exportFieldList as item>
									<#if item?length gt 0>
												<#if item == 'wareId.wareCode' || item == '*'>
													<Cell>
													<#if checkFieldPermission('wareId.wareCode','MESBasic_1_storeSet_StoreSet','MESBasic_1_storeSet_StoreSet_wareId||MESBasic_1_wareMan_Ware_wareCode') != 0>
												...
												<#if item == 'wareId.wareName' || item == '*'>
													<Cell>
													<#if checkFieldPermission('wareId.wareName','MESBasic_1_storeSet_StoreSet','MESBasic_1_storeSet_StoreSet_wareId||MESBasic_1_wareMan_Ware_wareName') != 0>
												...
												<#if item == 'placeSetCode' || item == '*'>
													<Cell>
													<#if checkFieldPermission('placeSetCode','MESBasic_1_storeSet_StoreSet','MESBasic_1_storeSet_StoreSet_placeSetCode') != 0>
														<#if data.placeSetCode??><Data ss:Type="String"><![CDATA[${(data.placeSetCode)!}]]></Data></#if>
													</#if>
													</Cell>
												</#if>
												<#if item == 'placeSetName' || item == '*'>
													<Cell>
													<#if checkFieldPermission('placeSetName','MESBasic_1_storeSet_StoreSet','MESBasic_1_storeSet_StoreSet_placeSetName') != 0>
														<#if data.placeSetName??><Data ss:Type="String"><![CDATA[${(data.placeSetName)!}]]></Data></#if>
													</#if>
													</Cell>
												</#if>
												<#if item == 'owner.name' || item == '*'>
													<Cell>
													<#if checkFieldPermission('owner.name','MESBasic_1_storeSet_StoreSet','MESBasic_1_storeSet_StoreSet_owner||base_staff_name') != 0>
														<#if data.owner.name??><Data ss:Type="String"><![CDATA[${(data.owner.name)!}]]></Data></#if>
													</#if>
													</Cell>
												</#if>
												<#if item == 'inPriority' || item == '*'>
													<Cell>
													<#if checkFieldPermission('inPriority','MESBasic_1_storeSet_StoreSet','MESBasic_1_storeSet_StoreSet_inPriority') != 0>
														<#if data.inPriority??><Data ss:Type="Number"><![CDATA[${(data.inPriority)!}]]></Data></#if>
													</#if>
													</Cell>
												</#if>
												<#if item == 'outPriority' || item == '*'>
													<Cell>
													<#if checkFieldPermission('outPriority','MESBasic_1_storeSet_StoreSet','MESBasic_1_storeSet_StoreSet_outPriority') != 0>
														<#if data.outPriority??><Data ss:Type="Number"><![CDATA[${(data.outPriority)!}]]></Data></#if>
													</#if>
													</Cell>
												</#if>
								...
								<#if item??>
									<#if item.name?index_of(".")!=-1>
											...
											<Cell  ss:StyleID="${item.styleid}" >
												<#if checkFieldPermission('${(item.name)!}','MESBasic_1_storeSet_StoreSet','${(item.propertyCode)!}') != 0>
