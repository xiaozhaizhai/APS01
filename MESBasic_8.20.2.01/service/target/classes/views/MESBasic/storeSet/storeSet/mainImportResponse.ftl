...
<script type="text/javascript">
	...
	function download(){
		var url = "/MESBasic/storeSet/storeSet/downLoad.action?viewCode=MESBasic_1_storeSet_storeBoxRef&orgName=MESBasic_1_storeSet_storeBoxRef-import-error.xls&downloadType=mainError&time=${time}";
		window.open(url,"","");
	}
