...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=MESBasic_1_thirdDataHandler";
	openExportFrame(url);
}
...
<div id="MESBasic_thirdDataHandler_dataTrans_dataList_attachment">	
