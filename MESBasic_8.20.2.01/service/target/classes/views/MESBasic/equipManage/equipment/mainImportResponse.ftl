...
<script type="text/javascript">
	...
	function download(){
		//var url = "/MESBasic/equipManage/equipment/downLoad.action?viewCode=MESBasic_1_equipManage_list&orgName=MESBasic_1_equipManage_list-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/MESBasic/equipManage/equipment/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
