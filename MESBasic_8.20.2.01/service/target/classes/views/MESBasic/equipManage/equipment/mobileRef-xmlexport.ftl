		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'eamType.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'installPlace.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'eamType.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1516068643374')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'installPlace.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1524636521326')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'eamBuyTime' || item == '*'>
									...
									<#if item?length gt 0>
												...
												<#if item == 'eamType.name' || item == '*'>
													<Cell>
														...
														<#if data.eamType.name??><Data ss:Type="String"><![CDATA[${(data.eamType.name)!}]]></Data></#if>
												...
												<#if item == 'installPlace.name' || item == '*'>
													<Cell>
														...
														<#if data.installPlace.name??><Data ss:Type="String"><![CDATA[${(data.installPlace.name)!}]]></Data></#if>
