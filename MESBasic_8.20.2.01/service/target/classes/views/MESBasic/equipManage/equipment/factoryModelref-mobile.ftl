...
<script type="text/javascript">
	CUI.ns("MESBasic.equipManage.equipment","MESBasic.equipManage.equipment.factoryModelref");
</script>
<div class="container"  style="padding-top:10px;">
	...
	<div id="ec_MESBasic_equipManage_equipment_factoryModelref_queryForm_inputValue">
	...
	<form onsubmit="return false" id="ec_MESBasic_equipManage_equipment_factoryModelref_queryForm" exportUrl="/MESBasic/equipManage/equipment/factoryModelref-query.action">
							...
							<div mobi-dropdown-group="eamBuyTime" field-unique-code="MESBasic_1_equipManage_Equipment_eamBuyTime_eamBuyTime" class="mobi-dropdown col-xs-12 col-sm-6 col-md-4 col-lg-4 <#if (lastQuery.value)?? && lastQuery.value == "MESBasic_1_equipManage_Equipment_eamBuyTime_eamBuyTime">mobi-dropdown-active</#if>"> 
								<div class="row">
									...
									<div class="input-group">
										...
										<@datepicker cssClass="form-control right-border-radius" type="date" value="${eamBuyTime_defaultValue!}" deValue="${eamBuyTime_defaultValue!}"  name="eamBuyTime_start" id="eamBuyTime_start" exp="gequal"   formid="ec_MESBasic_equipManage_equipment_factoryModelref_queryForm" />
									</div>
								</div>			
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
									<div class="input-group">
										...
										<@datepicker cssClass="form-control right-border-radius" type="date" value="${eamBuyTime_defaultValue!}" deValue="${eamBuyTime_defaultValue!}"  name="eamBuyTime_end" id="eamBuyTime_end" exp="lequal"   formid="ec_MESBasic_equipManage_equipment_factoryModelref_queryForm" />
									</div>
									</div>			
								</div>
							</div>
...
<script>
	$(function(){
		var buttons = $( 'button.btn-list', '#ec_MESBasic_equipManage_equipment_factoryModelref_queryForm' );
		if( buttons.length > 0 ){
			// 去掉按钮间的空格
...
<script type="text/javascript">
	...
	foundation.common.${requestUri!}__callbackFunction = function(){
		...
		var oRows = datatable_ec_MESBasic_equipManage_equipment_factoryModelref_query.getSelectedRow();
		if(oRows.length == 0){
		...
		try{
			if(CUI("#MESBasic_equipManage_equipment_factoryModelref_callBackFuncName").val() != ""){
				eval(CUI("#MESBasic_equipManage_equipment_factoryModelref_callBackFuncName").val() + "(arrObj)");
			}
		}catch(e){
		}
	};
...
MESBasic.equipManage.equipment.factoryModelref.showLinkView = function(url,propertyId,row,formId,title,width,height,dialogType){
	...
	if(formId) {
		MESBasic.equipManage.equipment.factoryModelref.showDialog(url,formId,title,width,height);
	}else {
		openFullScreen(url);
	}
};
