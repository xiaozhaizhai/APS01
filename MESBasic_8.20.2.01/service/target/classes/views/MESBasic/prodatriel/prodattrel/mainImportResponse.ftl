...
<script type="text/javascript">
	...
	function download(){
		var url = "/MESBasic/prodatriel/prodattrel/downLoad.action?viewCode=MESBasic_1_prodatriel_prodAttrList&orgName=MESBasic_1_prodatriel_prodAttrList-import-error.xls&downloadType=mainError&time=${time}";
		window.open(url,"","");
	}
