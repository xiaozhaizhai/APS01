...
<#assign viewCode = 'MESBasic_1_backgroundServiceMonitor_MESServices' />
<#assign propertyCode = '' />
									...
									<#if item?length gt 0>
												<#if item == 'serviceCode' || item == '*'>
													<Cell>
														...
														<#if data.serviceCode??><Data ss:Type="String"><![CDATA[${(data.serviceCode)!}]]></Data></#if>
												...
												<#if item == 'serviceName' || item == '*'>
													<Cell>
														...
														<#if data.serviceName??><Data ss:Type="String"><![CDATA[${(data.serviceName)!}]]></Data></#if>
