...
<script type="text/javascript">
	...
	function download(){
		//var url = "/MESBasic/backgroundServiceMonitor/mESServices/downLoad.action?viewCode=MESBasic_1_backgroundServiceMonitor_logList&orgName=MESBasic_1_backgroundServiceMonitor_logList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/MESBasic/backgroundServiceMonitor/mESServices/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
