...
<#assign viewCode = 'MESBasic_1_backgroundServiceMonitor_ServiceLogger' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'logTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1429057503018')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'logContent' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1429057525068')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												<#if item == 'logTime' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.logTime??><Data ss:Type="DateTime">${(data.logTime)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
												...
												<#if item == 'logContent' || item == '*'>
													<Cell>
														...
														<#if data.logContent??><Data ss:Type="String"><![CDATA[${(data.logContent)!}]]></Data></#if>
