...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
	...
	<Style ss:ID="MESBasic_1_factoryWare_FactoryWare_code">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="MESBasic_1_factoryWare_FactoryWare_name">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="MESBasic_1_factoryWare_FactoryWare_wareId">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="MESBasic_1_factoryWare_FactoryWare_storeId">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="MESBasic_1_factoryWare_FactoryWare_meno">
  			<NumberFormat/>
  			<Protection/>
	</Style>
...
<Worksheet ss:Name="sheet1">
	<Table ss:ExpandedColumnCount="256" ss:ExpandedRowCount="3" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="16.5">
			<Column ss:Index="1" ss:Width="100"  ss:StyleID="MESBasic_1_factoryWare_FactoryWare_code"/>
			<Column ss:Index="2" ss:Width="100"  ss:StyleID="MESBasic_1_factoryWare_FactoryWare_name"/>
			<Column ss:Index="3" ss:Width="100"  ss:StyleID="MESBasic_1_factoryWare_FactoryWare_wareId"/>
			<Column ss:Index="4" ss:Width="100"  ss:StyleID="MESBasic_1_factoryWare_FactoryWare_storeId"/>
			<Column ss:Index="5" ss:Width="100"  ss:StyleID="MESBasic_1_factoryWare_FactoryWare_meno"/>
	...
	<#if customStyleCodes??>
		...
		<Row ss:AutoFitHeight="0">
						<Cell >
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										MESBasic_1_factoryWare_FactoryWare_code
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										MESBasic_1_factoryWare_FactoryWare_name
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										MESBasic_1_factoryWare_FactoryWare_wareId||MESBasic_1_wareMan_Ware_wareCode
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
						...
						<Cell >
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										MESBasic_1_factoryWare_FactoryWare_storeId||MESBasic_1_storeSet_StoreSet_id
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
						...
						<Cell >
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										MESBasic_1_factoryWare_FactoryWare_meno
									 </ss:Data>
							</Comment>
						</Cell>
