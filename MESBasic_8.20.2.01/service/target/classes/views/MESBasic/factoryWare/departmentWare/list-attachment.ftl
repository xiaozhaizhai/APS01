...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=MESBasic_1_factoryWare";
	openExportFrame(url);
}
...
<div id="MESBasic_factoryWare_departmentWare_departWarePart_attachment">	
