 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								...
								<#if item == 'productId.productModel' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415772568665')}</Data>
										</Cell>
								</#if>
								<#if item == 'productId.productSpecif' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415772620384')}</Data>
										</Cell>
								</#if>
								<#if item == 'meno' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1487051366444')}</Data>
										</Cell>
								</#if>
			...
			<Row ss:AutoFitHeight="0">
				<#list exportFieldList as item>
					<#if item?length gt 0>
								<#if item == 'productId.productCode' || item == '*'>
									<Cell>
									<#if checkFieldPermission('productId.productCode','MESBasic_1_factoryWare_FacWareMaterial','MESBasic_1_factoryWare_FacWareMaterial_productId||MESBasic_1_product_Product_productCode') != 0>
								...
								<#if item == 'productId.productName' || item == '*'>
									<Cell>
									<#if checkFieldPermission('productId.productName','MESBasic_1_factoryWare_FacWareMaterial','MESBasic_1_factoryWare_FacWareMaterial_productId||MESBasic_1_product_Product_productName') != 0>
								...
								<#if item == 'productId.productModel' || item == '*'>
									<Cell>
									<#if checkFieldPermission('productId.productModel','MESBasic_1_factoryWare_FacWareMaterial','MESBasic_1_factoryWare_FacWareMaterial_productId||MESBasic_1_product_Product_productModel') != 0>
										<Data ss:Type="String"><#if (data.productId.productModel)??>${(data.productId.productModel)!}</#if></Data>
									</#if>
									</Cell>
								</#if>
								<#if item == 'productId.productSpecif' || item == '*'>
									<Cell>
									<#if checkFieldPermission('productId.productSpecif','MESBasic_1_factoryWare_FacWareMaterial','MESBasic_1_factoryWare_FacWareMaterial_productId||MESBasic_1_product_Product_productSpecif') != 0>
										<Data ss:Type="String"><#if (data.productId.productSpecif)??>${(data.productId.productSpecif)!}</#if></Data>
									</#if>
									</Cell>
								</#if>
								<#if item == 'meno' || item == '*'>
									<Cell>
									<#if checkFieldPermission('meno','MESBasic_1_factoryWare_FacWareMaterial','MESBasic_1_factoryWare_FacWareMaterial_meno') != 0>
