			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'customerCCCode.ccName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1449628587988.Cust1')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'customerVocationForDisplay' || item == '*'>
									...
									<#if item?length gt 0>
												...
												<#if item == 'customerCCCode.ccName' || item == '*'>
													<Cell>
														...
														<#if data.customerCCCode.ccName??><Data ss:Type="String"><![CDATA[${(data.customerCCCode.ccName)!}]]></Data></#if>
