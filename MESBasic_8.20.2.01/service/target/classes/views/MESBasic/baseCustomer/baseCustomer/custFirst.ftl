...
<title>${getText('MESBasic.viewtitle.randon1449742311346')}</title>
<@maincss/>
<@mainjs/>
<!-- CUSTOM CODE START(view-REFERENCE-MESBasic_1_baseCustomer_custFirst,head,MESBasic_1_baseCustomer_BaseCustomer,MESBasic_1) -->
<!-- 自定义代码 -->
...
<script type="text/javascript">
	 var MESBasic_baseCustomer_baseCustomer_custFirst_layout = {};
	 
	 MESBasic_baseCustomer_baseCustomer_custFirst_layout.refresh = function(node){
	 	MESBasic_baseCustomer_baseCustomer_custFirst_layout.node = node;
	 	node.modelName = "baseCustomerClass";
	 	MESBasic_baseCustomer_baseCustomer_refCustListPart_refresh(node);
	 }
	 
	 MESBasic_baseCustomer_baseCustomer_custFirst_layout.getNode = function(){
	 ...
	 MESBasic_baseCustomer_baseCustomer_custFirst_layout.refreshTree = function(nodeId){
	 	MESBasic_baseCustomerClass_baseCustomerClass_refCustClaTree_refresh(nodeId);
	 }
	 
	  MESBasic_baseCustomer_baseCustomer_custFirst_layout.refreshNodeId = function(node, operate){
	 	return MESBasic_baseCustomerClass_baseCustomerClass_refCustClaTree_refreshNodeId(node, operate);
	 }
	 
	 MESBasic_baseCustomer_baseCustomer_custFirst_layout.getList = function(){
	 ...
	 new CUI.Layout("layout1_ref", {});
			...
			setTimeout(function(){
				$("#center1_ref").load("/MESBasic/baseCustomer/baseCustomer/refCustListPart.action?${getPowerCode('MESBasic_1_baseCustomer_refCustListPart_self')}&openType=${Parameters.openType!}&crossCompanyFlag=${Parameters.crossCompanyFlag!}&refUrl=${requestUri!}&callBackFuncName=${callBackFuncName!}&permissionCode=MESBasic_1_baseCustomer_custFirst"+layoutParams,null,null,false,'centerFrame');
			},200);
		
	MESBasic_baseCustomerClass_baseCustomerClass_refCustClaTree_getLayout = function(){
		return MESBasic_baseCustomer_baseCustomer_custFirst_layout;
	}
