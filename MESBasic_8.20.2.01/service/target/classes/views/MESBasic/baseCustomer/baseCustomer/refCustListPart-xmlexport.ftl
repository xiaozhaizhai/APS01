...
<#assign viewCode = 'MESBasic_1_baseCustomer_BaseCustomer' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		<Style ss:ID="customerCCCode.ccCode">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		...
	  		<Style ss:ID="customerDCCode">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="customerDegreeCode">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		...
	  		<Style ss:ID="customerVocation">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="ownerStaff.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'customerVocationForDisplay' || item == '*'>
														 <#if item?index_of('.')!=-1>  
											...
											<#if item == 'customerDCCodeForDisplay' || item == '*'>
														 <#if item?index_of('.')!=-1>  
															<Column ss:Index="${count}" ss:StyleID="${item?substring(0,item?last_index_of('.'))}"  ss:Width="140"/>
														 <#else>
														    <Column ss:Index="${count}" ss:StyleID="${item}"  ss:Width="140" />
											...
											<#if item == 'customerDegreeCodeForDisplay' || item == '*'>
														 <#if item?index_of('.')!=-1>  
															<Column ss:Index="${count}" ss:StyleID="${item?substring(0,item?last_index_of('.'))}"  ss:Width="140"/>
														 <#else>
														    <Column ss:Index="${count}" ss:StyleID="${item}"  ss:Width="140" />
											...
											<#if item == 'customerPropertyForDisplay' || item == '*'>
														 <#if item?index_of('.')!=-1>  
															<Column ss:Index="${count}" ss:StyleID="${item?substring(0,item?last_index_of('.'))}"  ss:Width="140"/>
														 <#else>
														    <Column ss:Index="${count}" ss:StyleID="${item}"  ss:Width="140" />
											...
											<#if item == 'ownerStaff.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'customerCCCode.ccCode' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'customerCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1449640688865')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'customerShortName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1449647160005')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'customerName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1449646749348')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'customerVocationForDisplay' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1449648077021')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'customerDCCodeForDisplay' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1449640880459')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'customerDegreeCodeForDisplay' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1449641128193')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'customerPropertyForDisplay' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1449647028584')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'ownerStaff.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.foundation.staff.dimissionStaff_xls.staffName.Cust1')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'customerCCCode.ccCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1449628448449')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												<#if item == 'customerCode' || item == '*'>
													<Cell>
														...
														<#if data.customerCode??><Data ss:Type="String"><![CDATA[${(data.customerCode)!}]]></Data></#if>
												...
												<#if item == 'customerShortName' || item == '*'>
													<Cell>
														...
														<#if data.customerShortName??><Data ss:Type="String"><![CDATA[${(data.customerShortName)!}]]></Data></#if>
												...
												<#if item == 'customerName' || item == '*'>
													<Cell>
														...
														<#if data.customerName??><Data ss:Type="String"><![CDATA[${(data.customerName)!}]]></Data></#if>
												...
												<#if item == 'customerVocationForDisplay' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.customerVocationForDisplay)!}')}</Data>
												...
												<#if item == 'customerDCCodeForDisplay' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.customerDCCodeForDisplay)!}')}</Data>
												...
												<#if item == 'customerDegreeCodeForDisplay' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.customerDegreeCodeForDisplay)!}')}</Data>
												...
												<#if item == 'customerPropertyForDisplay' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.customerPropertyForDisplay)!}')}</Data>
												...
												<#if item == 'ownerStaff.name' || item == '*'>
													<Cell>
														...
														<#if data.ownerStaff.name??><Data ss:Type="String"><![CDATA[${(data.ownerStaff.name)!}]]></Data></#if>
												...
												<#if item == 'customerCCCode.ccCode' || item == '*'>
													<Cell>
														...
														<#if data.customerCCCode.ccCode??><Data ss:Type="String"><![CDATA[${(data.customerCCCode.ccCode)!}]]></Data></#if>
