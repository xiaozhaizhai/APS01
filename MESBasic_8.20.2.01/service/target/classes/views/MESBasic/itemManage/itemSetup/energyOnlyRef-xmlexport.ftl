			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'energyType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1417588204115')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'virtualTag' || item == '*'>
									...
									<#if item?length gt 0>
												...
												<#if item == 'energyType.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.energyType.value)!}')}</Data>
