...
<#assign viewCode = 'MESBasic_1_baseVendor_BaseVendor' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		<Style ss:ID="vendorCode">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="vendorDegreeCode">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="vendorName">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="vendorShortName">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="vendorState">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="vendorVCCode.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											<#if item == 'vendorCode' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'vendorShortName' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'vendorName' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'vendorDegreeCodeForDisplay' || item == '*'>
														 <#if item?index_of('.')!=-1>  
											...
											<#if item == 'vendorVCCode.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'vendorStateForDisplay' || item == '*'>
														 <#if item?index_of('.')!=-1>  
															<Column ss:Index="${count}" ss:StyleID="${item?substring(0,item?last_index_of('.'))}"  ss:Width="140"/>
														 <#else>
														    <Column ss:Index="${count}" ss:StyleID="${item}"  ss:Width="140" />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'vendorCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1449537304035')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'vendorShortName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1449540785278')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'vendorName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1449540299342')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'vendorDegreeCodeForDisplay' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1449538619738')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'vendorVCCode.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1449472903805.vendor1')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'vendorStateForDisplay' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1450243165523')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												<#if item == 'vendorCode' || item == '*'>
													<Cell>
														...
														<#if data.vendorCode??><Data ss:Type="String"><![CDATA[${(data.vendorCode)!}]]></Data></#if>
												...
												<#if item == 'vendorShortName' || item == '*'>
													<Cell>
														...
														<#if data.vendorShortName??><Data ss:Type="String"><![CDATA[${(data.vendorShortName)!}]]></Data></#if>
												...
												<#if item == 'vendorName' || item == '*'>
													<Cell>
														...
														<#if data.vendorName??><Data ss:Type="String"><![CDATA[${(data.vendorName)!}]]></Data></#if>
												...
												<#if item == 'vendorDegreeCodeForDisplay' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.vendorDegreeCodeForDisplay)!}')}</Data>
												...
												<#if item == 'vendorVCCode.name' || item == '*'>
													<Cell>
														...
														<#if data.vendorVCCode.name??><Data ss:Type="String"><![CDATA[${(data.vendorVCCode.name)!}]]></Data></#if>
												...
												<#if item == 'vendorStateForDisplay' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.vendorStateForDisplay)!}')}</Data>
