...
<GridData DefaultNodeExpanded="false"  MultiSelect="checkbox"  dgName="dg1551703065405" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<property.itemNumber
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(PropertyTags_dg1551703065405Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(PropertyTags_dg1551703065405Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/itemManage/itemSetup/itemSelfList.action','dg1551703065405property.itemNumber','${getText("MESBasic.viewtitle.radion1421223012419")}',sPTGridID,nRow,sFieldName,PropertyTags_dg1551703065405Widget,null,false,false,'','MESBasic_1_itemManage_itemSelfList')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="PropertyTags_dg1551703065405Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<property.itemClass.id
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(PropertyTags_dg1551703065405Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(PropertyTags_dg1551703065405Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/itemManage/itemSetup/itemRefForContainer.action','dg1551703065405property.itemClass','${getText("MESBasic.viewtitle.randon1422422463756")}',sPTGridID,nRow,sFieldName,PropertyTags_dg1551703065405Widget,null,false,false,'','MESBasic_1_itemManage_itemRefForContainer')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="PropertyTags_dg1551703065405Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<property.tagType.id
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(PropertyTags_dg1551703065405Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(PropertyTags_dg1551703065405Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/itemManage/itemSetup/itemRefForContainer.action','dg1551703065405property.tagType','${getText("MESBasic.viewtitle.randon1422422463756")}',sPTGridID,nRow,sFieldName,PropertyTags_dg1551703065405Widget,null,false,false,'','MESBasic_1_itemManage_itemRefForContainer')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="PropertyTags_dg1551703065405Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<#list customPropViewMappings as cpvm>
					...
					<#if cpvm.property.type == 'OBJECT'>
						...
						<#if cpvm.refView??>
							...
							onFocus="CUI.toggleClearBtn_DG_IE(PropertyTags_dg1551703065405Widget,nRow,sFieldName)"
							onBtnClick="CUI.clearCellValue_DG_IE(PropertyTags_dg1551703065405Widget,nRow,sFieldName,true)"
							subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('${viewUrl!}','dg1551703065405${cpvm.propertyLayRec}','${getText("${viewTitle}")}',sPTGridID,nRow,'${cpvm.propertyLayRec}',PropertyTags_dg1551703065405Widget,null,false,true,'${mainDisplayName},${pkName}','${viewCode}')"
							hideEditOnReadOnly="true"
						</#if>
					</#if>
						sort="true"
						onPropertyChange="PropertyTags_dg1551703065405Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
					...
					<#elseif cpvm.property.type == 'DATETIME'>
						...
						onClick="initCalender(PropertyTags_dg1551703065405Widget,'PropertyTags_dg1551703065405Widget',nRow,sFieldName,<#if cpvm.format == 'YMD_H'>'dateTimeHour'<#elseif cpvm.format == 'YMD_HM'>'dateTimeMin'<#else>'datetime'</#if>)"
						onBtnClick="showCalender(PropertyTags_dg1551703065405Widget,'PropertyTags_dg1551703065405Widget',nRow,sFieldName,<#if cpvm.format == 'YMD_H'>'dateTimeHour'<#elseif cpvm.format == 'YMD_HM'>'dateTimeMin'<#else>'datetime'</#if>)"
						control="Text"
