...
<script type="text/javascript">
	...
	function download(){
		var url = "/MESBasic/tagProperty/tagProperty/downLoad.action?viewCode=MESBasic_1_tagProperty_tagList&orgName=MESBasic_1_tagProperty_tagList-import-error.xls&downloadType=mainError&time=${time}";
		window.open(url,"","");
	}
