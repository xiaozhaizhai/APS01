...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
	...
	<Style ss:ID="MESBasic_1_eamType_EamType_code">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="MESBasic_1_eamType_EamType_name">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="MESBasic_1_eamType_EamType_typeMemo">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="MESBasic_1_eamType_EamType_eamtypeAttribute">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="MESBasic_1_eamType_EamType_otherspecial">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="MESBasic_1_eamType_EamType_isspecial">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="MESBasic_1_eamType_EamType_isMea">
  			<NumberFormat/>
  			<Protection/>
	</Style>
...
<Worksheet ss:Name="sheet1">
	<Table ss:ExpandedColumnCount="256" ss:ExpandedRowCount="3" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="16.5">
			<Column ss:Index="1" ss:Width="100"  ss:StyleID="MESBasic_1_eamType_EamType_code"/>
			<Column ss:Index="2" ss:Width="100"  ss:StyleID="MESBasic_1_eamType_EamType_name"/>
			<Column ss:Index="3" ss:Width="100"  ss:StyleID="MESBasic_1_eamType_EamType_typeMemo"/>
			<Column ss:Index="4" ss:Width="100"  ss:StyleID="MESBasic_1_eamType_EamType_eamtypeAttribute"/>
			<Column ss:Index="5" ss:Width="100"  ss:StyleID="MESBasic_1_eamType_EamType_otherspecial"/>
			<Column ss:Index="6" ss:Width="100"  ss:StyleID="MESBasic_1_eamType_EamType_isspecial"/>
			<Column ss:Index="7" ss:Width="100"  ss:StyleID="MESBasic_1_eamType_EamType_isMea"/>
						...
						<Cell ss:StyleID="unNullable">
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										MESBasic_1_eamType_EamType_code
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell ss:StyleID="unNullable">
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										MESBasic_1_eamType_EamType_name
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										MESBasic_1_eamType_EamType_typeMemo
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							<Data ss:Type="String">末级</Data>
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										MESBasic_1_eamType_EamType_eamtypeAttribute
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										MESBasic_1_eamType_EamType_otherspecial
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										MESBasic_1_eamType_EamType_isspecial
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							<Data ss:Type="String">测量设备</Data>
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										MESBasic_1_eamType_EamType_isMea
									 </ss:Data>
							</Comment>
						</Cell>
