...
<script type="text/javascript">
	...
	function download(){
		var url = "/MESBasic/product_type/producttype/downLoad.action?viewCode=MESBasic_1_product_type_list&orgName=MESBasic_1_product_type_list-import-error.xls&downloadType=mainError&time=${time}";
		window.open(url,"","");
	}
