 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								...
								<#if item == 'code' || item == '*'>
										<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415321030666')}</Data></Cell>
								</#if>
								<#if item == 'name' || item == '*'>
										<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415321054576')}</Data></Cell>
								</#if>
								<#if item == 'remark' || item == '*'>
										<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415607380055')}</Data></Cell>
								</#if>
			...
			<Row ss:AutoFitHeight="0">
				<#list exportFieldList as item>
					<#if item?length gt 0>
								...
								<#if item == 'code' || item == '*'>
									<Cell>
									<#if checkFieldPermission('code','MESBasic_1_material_Material','MESBasic_1_material_Material_code') != 0>
								...
								<#if item == 'name' || item == '*'>
									<Cell>
									<#if checkFieldPermission('name','MESBasic_1_material_Material','MESBasic_1_material_Material_name') != 0>
								...
								<#if item == 'remark' || item == '*'>
									<Cell>
									<#if checkFieldPermission('remark','MESBasic_1_material_Material','MESBasic_1_material_Material_remark') != 0>
										<#if data.remark??><Data ss:Type="String">${(data.remark)!}</Data></#if>
									</#if>
									</Cell>
								</#if>
