...
<script type="text/javascript">
	...
	function download(){
		var url = "/MESBasic/material/material/downLoad.action?viewCode=MESBasic_1_material_materialList&orgName=MESBasic_1_material_materialList-import-error.xls&downloadType=mainError&time=${time}";
		window.open(url,"","");
	}
