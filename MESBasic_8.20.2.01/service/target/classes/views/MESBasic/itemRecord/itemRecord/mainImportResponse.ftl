...
<script type="text/javascript">
	...
	function download(){
		//var url = "/MESBasic/itemRecord/itemRecord/downLoad.action?viewCode=MESBasic_1_itemRecord_itemRecordList&orgName=MESBasic_1_itemRecord_itemRecordList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/MESBasic/itemRecord/itemRecord/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
