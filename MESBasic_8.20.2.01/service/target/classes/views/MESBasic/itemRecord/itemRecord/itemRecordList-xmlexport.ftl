...
<#assign viewCode = 'MESBasic_1_itemRecord_ItemRecord' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		<Style ss:ID="averageValue">
	  			<NumberFormat ss:Format="0.000000"/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="balanceValue">
	  		...
	  		<Style ss:ID="itemNumber.code">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="maxValue">
	  			<NumberFormat ss:Format="0.000000"/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="minValue">
	  			<NumberFormat ss:Format="0.000000"/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="planNo">
	  		...
	  		<Style ss:ID="realValue">
	  			<NumberFormat ss:Format="0.000000"/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="reaultValue">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="recordTime">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'totalValue' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'realValue' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'planNo' || item == '*'>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'recordTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415340663783')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'averageValue' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415340352536')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'maxValue' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415340515757')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'minValue' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415340539418')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'balanceValue' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415340378186')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'count' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415340400455')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'totalValue' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415340718971')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'realValue' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415340583078')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'planNo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415340562803')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'reaultValue' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415340607673')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												<#if item == 'itemNumber.code' || item == '*'>
													<Cell>
														...
														<#if data.itemNumber.code??><Data ss:Type="String"><![CDATA[${(data.itemNumber.code)!}]]></Data></#if>
												...
												<#if item == 'recordTime' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.recordTime??><Data ss:Type="DateTime">${(data.recordTime)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
												...
												<#if item == 'averageValue' || item == '*'>
													<Cell>
														...
														<#if (data.averageValue)?has_content><Data ss:Type="Number">#{(data.averageValue)!; m6M6}</Data></#if>
												...
												<#if item == 'maxValue' || item == '*'>
													<Cell>
														...
														<#if (data.maxValue)?has_content><Data ss:Type="Number">#{(data.maxValue)!; m6M6}</Data></#if>
												...
												<#if item == 'minValue' || item == '*'>
													<Cell>
														...
														<#if (data.minValue)?has_content><Data ss:Type="Number">#{(data.minValue)!; m6M6}</Data></#if>
												...
												<#if item == 'balanceValue' || item == '*'>
													<Cell>
														...
														<#if (data.balanceValue)?has_content><Data ss:Type="Number">#{(data.balanceValue)!; m2M2}</Data></#if>
												...
												<#if item == 'count' || item == '*'>
													<Cell>
														...
														<#if data.count??><Data ss:Type="Number"><![CDATA[${(data.count)!}]]></Data></#if>
												...
												<#if item == 'totalValue' || item == '*'>
													<Cell>
														...
														<#if (data.totalValue)?has_content><Data ss:Type="Number">#{(data.totalValue)!; m6M6}</Data></#if>
												...
												<#if item == 'realValue' || item == '*'>
													<Cell>
														...
														<#if (data.realValue)?has_content><Data ss:Type="Number">#{(data.realValue)!; m6M6}</Data></#if>
												...
												<#if item == 'planNo' || item == '*'>
													<Cell>
														...
														<#if data.planNo??><Data ss:Type="String"><![CDATA[${(data.planNo)!}]]></Data></#if>
												...
												<#if item == 'reaultValue' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.reaultValue?? && data.reaultValue>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
