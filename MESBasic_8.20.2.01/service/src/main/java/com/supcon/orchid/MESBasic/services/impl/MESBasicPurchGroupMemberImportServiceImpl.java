...
@Service("mESBasicPurchGroupMemberImportService")
public class MESBasicPurchGroupMemberImportServiceImpl implements MESBasicPurchGroupMemberImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_purch_Group",model="MESBasic_1_purch_Group_PurchGroupMember",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicPurchGroupMember bizObj, MESBasicPurchGroupMember oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicPurchGroupMember bizObj, String bussinesskeyFieldName,
