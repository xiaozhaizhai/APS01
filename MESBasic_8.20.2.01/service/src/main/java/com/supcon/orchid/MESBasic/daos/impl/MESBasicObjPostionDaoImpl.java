...
@Repository
public class MESBasicObjPostionDaoImpl extends ExtendedGenericDaoImpl<MESBasicObjPostion, Long> implements MESBasicObjPostionDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_factoryModel_ObjPostion,MESBasic_1) */
// 自定义代码
