...
@Repository
public class MESBasicPositionDealDaoImpl extends ExtendedGenericDaoImpl<MESBasicPositionDeal, Long> implements MESBasicPositionDealDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_factoryModel_PositionDeal,MESBasic_1) */
// 自定义代码
