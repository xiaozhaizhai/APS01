...
@Repository
public class MESBasicTestMappingSetDaoImpl extends ExtendedGenericDaoImpl<MESBasicTestMappingSet, Long> implements MESBasicTestMappingSetDao {
	@Override
	public void saveDealInfo(MESBasicTestMappingSetDealInfo dealInfo){
	...
	@Override
	public MESBasicTestMappingSetDealInfo copyAndSaveDealInfo(DealInfo di) {
		MESBasicTestMappingSetDealInfo dealInfo = new MESBasicTestMappingSetDealInfo();
	...
	@Override
	public MESBasicTestMappingSetDealInfo copyAndSaveDealInfo(DealInfo di, MESBasicTestMappingSet mainObj, Staff dealStaff) {
		MESBasicTestMappingSetDealInfo dealInfo = copyAndSaveDealInfo(di);
	...
	public Date findLastDealInfo(Long tableInfoId, String activityName) {
		Criteria criteria = getSession().createCriteria(MESBasicTestMappingSetDealInfo.class);
		...
		List<MESBasicTestMappingSetDealInfo> dealinfo = criteria.list();
		return (dealinfo!=null&&!dealinfo.isEmpty()) ? dealinfo.get(0).getCreateTime() : null;
	}

	 /* CUSTOM CODE START(daoimpl,functions,MESBasic_1_testMapping_TestMappingSet,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
}