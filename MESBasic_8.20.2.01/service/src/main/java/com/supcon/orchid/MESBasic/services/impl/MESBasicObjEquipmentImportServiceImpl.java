...
@Service("mESBasicObjEquipmentImportService")
public class MESBasicObjEquipmentImportServiceImpl implements MESBasicObjEquipmentImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicObjEquipment bizObj, MESBasicObjEquipment oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicObjEquipment bizObj, String bussinesskeyFieldName,
