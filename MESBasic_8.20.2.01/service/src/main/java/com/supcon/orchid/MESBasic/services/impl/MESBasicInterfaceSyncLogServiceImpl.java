...
import com.supcon.orchid.MESBasic.services.MESBasicInterfaceSyncLogImportService;
...
import com.supcon.orchid.workflow.engine.transformers.PendingResultTransformer;
import com.supcon.orchid.MESBasic.daos.impl.MESBasicInterfaceSyncLogDaoImpl;
import java.lang.reflect.Method;
...
/* CUSTOM CODE START(serviceimpl,import,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */

@Service("mESBasic_interfaceSyncLogService")
@Transactional
public class MESBasicInterfaceSyncLogServiceImpl  extends BaseServiceImpl<MESBasicInterfaceSyncLog> implements MESBasicInterfaceSyncLogService, InitializingBean, DisposableBean {
	...
	@Resource
	private IBAPBaseService<MESBasicInterfaceSyncLog> bapBaseService;
	...
	@Autowired
	private MESBasicInterfaceSyncLogImportService interfaceSyncLogImportService;
	/**
	 * 根据主显示字段列表获取Map
	...
	public Map<String, Object> getMainDisplayMap(Serializable mainDisplayName, Serializable businessKeyName,List<Serializable> mainDisplayKeys) {
		String hql = "select " + mainDisplayName + ",id,"+ businessKeyName + " from " + MESBasicInterfaceSyncLog.JPA_NAME + " where " + mainDisplayName + " in (:mainDisplayKeys)"  + "and VALID = 1";
	...
	public Map<Serializable,Serializable> getBusinessKeyMap(Serializable businessKeyName,List<Serializable> businessKeys){
		if(businessKeyName!=null && String.valueOf(businessKeyName).length() > 0){
			String hql = "select " + businessKeyName + ",id from " + MESBasicInterfaceSyncLog.JPA_NAME + " where " + businessKeyName + " in (:businessKeys)";
			Query query = interfaceSyncLogDao.createQuery(hql);
	...
	*/
	...
	public Map<String, Object> getParentNodeMap(Serializable mainDisplayName, Serializable businessKeyName, List<Serializable> serial, String queryParam) {
		...
		if(queryParam!=null && queryParam.equals("md")){
			hql = "select " + mainDisplayName + ",id,"+ businessKeyName + ",fullPathName,layNo,layRec,parentId,leaf from " + MESBasicInterfaceSyncLog.JPA_NAME + " where " + mainDisplayName + " in (:serial)";
		}else if(queryParam!=null && queryParam.equals("bk")){
			hql = "select " + mainDisplayName + ",id,"+ businessKeyName + ",fullPathName,layNo,layRec,parentId,leaf from " + MESBasicInterfaceSyncLog.JPA_NAME + " where " + businessKeyName + " in (:serial)";
		}
		Query query =  interfaceSyncLogDao.createQuery(hql);
		...
		/*String sql = null;
		if(queryParam!=null && queryParam.equals("md")){
			sql = "select * from " + MESBasicInterfaceSyncLog.TABLE_NAME + " where " + mainDisplayName + " = ?";
		}else if(queryParam!=null && queryParam.equals("bk")){
			sql = "select * from " + MESBasicInterfaceSyncLog.TABLE_NAME + " where " + businessKeyName + " = ?";
		}
		List<MESBasicInterfaceSyncLog> list = (List<MESBasicInterfaceSyncLog>) interfaceSyncLogDao.createNativeQuery(sql,serial.get(0)).list();
		*/
		Map<String, Object> m = new HashMap<String, Object>();
		if(queryParam!=null && queryParam.equals("md")){
			m.put("count", list.size());
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public MESBasicInterfaceSyncLog getInterfaceSyncLog(long id){
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public MESBasicInterfaceSyncLog getInterfaceSyncLog(long id, String viewCode){
		MESBasicInterfaceSyncLog interfaceSyncLog = interfaceSyncLogDao.load(id);
	...
	@Override
	@AuditLog(entity="MESBasic_1_interfaceSyncLog",model="MESBasic_1_interfaceSyncLog_InterfaceSyncLog",desc="foundation.common.delete",operType="3")
	public void deleteInterfaceSyncLog(MESBasicInterfaceSyncLog interfaceSyncLog){
		if(null != interfaceSyncLog && (StringUtils.isEmpty(AuditUtil.getColumnStringD()) || MESBasicInterfaceSyncLog.MODEL_CODE.equals(AuditUtil.getColumnStringD()))){
		...
		List<MESBasicInterfaceSyncLog> params = new ArrayList<MESBasicInterfaceSyncLog>();
		params.add(interfaceSyncLog);
		Map<String, Object> props = new HashMap<String, Object>();
		props.put("callType", "service");
		props.put("entityCode", "MESBasic_1_interfaceSyncLog");
	...
	public void deleteInterfaceSyncLog(List<Long> interfaceSyncLogIds, String eventTopic) {
		List<MESBasicInterfaceSyncLog> interfaceSyncLogs = new ArrayList<MESBasicInterfaceSyncLog>();
		for(Long interfaceSyncLogId : interfaceSyncLogIds){
			MESBasicInterfaceSyncLog interfaceSyncLog = getInterfaceSyncLog(interfaceSyncLogId);
		...
		for(MESBasicInterfaceSyncLog interfaceSyncLog : interfaceSyncLogs){
			beforeDeleteInterfaceSyncLog(interfaceSyncLog);
		}
		...
		if(interfaceSyncLogIds != null && interfaceSyncLogIds.size() > 0) {
			String hql = "update " + MESBasicInterfaceSyncLog.JPA_NAME + " set valid = false where id in(:ids)";
			Query query = interfaceSyncLogDao.createQuery(hql);
		...
		if(eventTopic==null){
			for(MESBasicInterfaceSyncLog interfaceSyncLogz : interfaceSyncLogs){
	...
	private void deleteCollection(String ids,SignatureLog signatureLog) {
		...
		if(null != signatureLog){
			...
			String msgId="moduleCode:MESBasic_1#entityCode:MESBasic_1_interfaceSyncLog#modelCode:MESBasic_1_interfaceSyncLog_InterfaceSyncLog#timeStamp:"+String.valueOf(new Date().getTime());
			reliableMessageSenderService.sendQueue(msgId,signatureLog);
		}
	}
	
	@Override
	@AuditLog(entity="MESBasic_1_interfaceSyncLog",model="MESBasic_1_interfaceSyncLog_InterfaceSyncLog",desc="ec.engine.restore",operType="10")
	...
	public void findBusinessKeyUsed(long interfaceSyncLogId){
		Property property = modelServiceFoundation.getBussinessProperty("MESBasic_1_interfaceSyncLog_InterfaceSyncLog");
		if(property != null){
			String propertyName = property.getColumnName();
			String sql  = "select * from " + MESBasicInterfaceSyncLog.TABLE_NAME + " where valid = 1 and " + 
					propertyName + " =  (select "+ propertyName +" from "+ MESBasicInterfaceSyncLog.TABLE_NAME +" where id = ? )";
	...
	@Override
	@AuditLog(entity="MESBasic_1_interfaceSyncLog",model="MESBasic_1_interfaceSyncLog_InterfaceSyncLog",desc="foundation.batch.import",operType="4")
	public  void batchImportBaseInterfaceSyncLog(List<MESBasicInterfaceSyncLog>  interfaceSyncLogs){
		for(MESBasicInterfaceSyncLog interfaceSyncLog:interfaceSyncLogs)  {
	...
	@Override
	public  void excelBatchImportBaseInterfaceSyncLog(List<MESBasicInterfaceSyncLog>  interfaceSyncLogs){
		for(MESBasicInterfaceSyncLog interfaceSyncLog:interfaceSyncLogs)  {
	...
	@Override
	@AuditLog(entity="MESBasic_1_interfaceSyncLog",model="MESBasic_1_interfaceSyncLog_InterfaceSyncLog",desc="ec.flow.save")
	public void saveInterfaceSyncLog(MESBasicInterfaceSyncLog interfaceSyncLog, Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads){
		saveInterfaceSyncLog(interfaceSyncLog, dgLists,dgDeleteIDs,assFileUploads, null);
	}
	
	@Override
	@AuditLog(entity="MESBasic_1_interfaceSyncLog",model="MESBasic_1_interfaceSyncLog_InterfaceSyncLog",desc="ec.flow.save")
	public void saveInterfaceSyncLog(MESBasicInterfaceSyncLog interfaceSyncLog, Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads, String viewCode){
		saveInterfaceSyncLog(interfaceSyncLog, dgLists,dgDeleteIDs,assFileUploads, viewCode, null,null);
	}


	public void generateInterfaceSyncLogCodes(MESBasicInterfaceSyncLog interfaceSyncLog) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		generateInterfaceSyncLogCodes(interfaceSyncLog, false);
	}
	
	public void generateInterfaceSyncLogCodes(MESBasicInterfaceSyncLog interfaceSyncLog, Boolean viewIsView) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
	}
	
	public void generateInterfaceSyncLogSummarys(MESBasicInterfaceSyncLog interfaceSyncLog) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		generateInterfaceSyncLogSummarys(interfaceSyncLog, false);
	}

	public void generateInterfaceSyncLogSummarys(MESBasicInterfaceSyncLog interfaceSyncLog, Boolean viewIsView) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
	}
	
	@Override
	@AuditLog(entity="MESBasic_1_interfaceSyncLog",model="MESBasic_1_interfaceSyncLog_InterfaceSyncLog")
	public void saveInterfaceSyncLog(MESBasicInterfaceSyncLog interfaceSyncLog,Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads,String viewCode, String eventTopic,boolean... isImport){
		this.saveInterfaceSyncLog(interfaceSyncLog, dgLists,dgDeleteIDs,assFileUploads, viewCode, eventTopic,null,isImport);
	}

	@Override
	@AuditLog(entity="MESBasic_1_interfaceSyncLog",model="MESBasic_1_interfaceSyncLog_InterfaceSyncLog")
	public void saveInterfaceSyncLog(MESBasicInterfaceSyncLog interfaceSyncLog,Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads,String viewCode, String eventTopic, SignatureLog signatureLog,boolean... isImport){
		boolean isNew = false;
		String entityCode = "MESBasic_1_interfaceSyncLog";
		Map<String, Object> props = new HashMap<String, Object>();
		props.put("callType", "service");
		props.put("entityCode", "MESBasic_1_interfaceSyncLog");
		String url = null;
		if(interfaceSyncLog.getId() != null && interfaceSyncLog.getId() > 0){
			if(StringUtils.isEmpty(AuditUtil.getColumnStringD()) || MESBasicInterfaceSyncLog.MODEL_CODE.equals(AuditUtil.getColumnStringD())){
				AuditUtil.setAuditDes("ec.pending.edit");
				AuditUtil.setAuditOperationType("2");
			}
			props.put("eventType", "modify");
			url = "com/supcon/orchid/entities/sync/mESBasic_1_interfaceSyncLog/modify";
		}else{
			isNew = true;
			if(StringUtils.isEmpty(AuditUtil.getColumnStringD()) || MESBasicInterfaceSyncLog.MODEL_CODE.equals(AuditUtil.getColumnStringD())){
			...
			url = "com/supcon/orchid/entities/sync/mESBasic_1_interfaceSyncLog/add";
		}
	...
	private void executeGScript(String entityCode, String scriptType, List<Event> events, MESBasicInterfaceSyncLog interfaceSyncLog){
		for(Event e : events){
	...
	@Override
	@AuditLog(entity="MESBasic_1_interfaceSyncLog",model="MESBasic_1_interfaceSyncLog_InterfaceSyncLog")
	public void mergeInterfaceSyncLog(MESBasicInterfaceSyncLog interfaceSyncLog, Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads){
		ReflectUtils.filterObjectIdIsNVL(interfaceSyncLog);
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public Page<MESBasicInterfaceSyncLog> findInterfaceSyncLogs(Page<MESBasicInterfaceSyncLog> page, Criterion... criterions) {
	...
	@SuppressWarnings("unchecked")
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	private MESBasicInterfaceSyncLogDealInfo getDealInfoEntity(Long tableInfoId) {
		
		List<MESBasicInterfaceSyncLogDealInfo> list=interfaceSyncLogDao.createQuery("from " + MESBasicInterfaceSyncLogDealInfo.JPA_NAME + " where tableInfoId=?", tableInfoId).setMaxResults(1).list();
		if(list.size()>0){
			return list.get(0);
		}
		return null;
	...
	@Override
	public void saveDealInfo(MESBasicInterfaceSyncLogDealInfo dealInfo) {
		interfaceSyncLogDao.saveDealInfo(dealInfo);
	}
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public int getDealInfoCount(Long tableInfoId) {
		String sql = "SELECT count(1) totalCount " + "FROM "+MESBasicInterfaceSyncLogDealInfo.TABLE_NAME+" DI " + "LEFT JOIN " + User.TABLE_NAME + " U ON DI.USER_ID=U.ID " + "LEFT JOIN " + Staff.TABLE_NAME
	...
	public List<Object[]> findDealInfos(Long tableInfoId, boolean expandFlag) {
		String sql = "SELECT DI.TASK_DESCRIPTION ACTIVITYNAME,DI.CREATE_TIME CREATETIME ,DI.COMMENTS COMMENTS,DI.OUTCOME OUTCOME,S.NAME STAFFNAME,DI.OUTCOME_DES OUTCOME_DES,DI.ASSIGN_STAFF ASSIGNSTAFF ,DEALINFO_TYPE DEALINFOTYPE, DI.PROXY_STAFF PROXYSTAFF, DI.PENDING_CREATE_TIME PCREATETIME,  DI.SIGNATURE SIGNATURE, WT.TYPE,WTR.TYPE TRANSITIONTYPE "
				+ " FROM "+MESBasicInterfaceSyncLogDealInfo.TABLE_NAME + " DI " 
	...
	public Map<String, List<Object[]>> findDealInfosGroup(Long tableInfoId, boolean expandFlag) {
		...
		groupSql.append(" FROM "
				+ MESBasicInterfaceSyncLogDealInfo.TABLE_NAME
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public void findInterfaceSyncLogs(Page<MESBasicInterfaceSyncLog> page,  String viewCode, int type, String processKey,Boolean flowBulkFlag, Boolean hasAttachment,Boolean noQueryFlag,String exportSql, Map exportMap, List<Param> params) {
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public void findInterfaceSyncLogs(Page<MESBasicInterfaceSyncLog> page,  String viewCode, int type, String processKey,Boolean flowBulkFlag, Boolean hasAttachment, List<Param> params, String permissionCode,Boolean noQueryFlag,String exportSql, Map exportMap) {
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public void findInterfaceSyncLogs(Page<MESBasicInterfaceSyncLog> page,  String viewCode, int type, String processKey,Boolean flowBulkFlag, Boolean hasAttachment, List<Param> params, String permissionCode, Boolean noQueryFlag,String exportSql, Map exportMap, Object... objects) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void commonQuery(Page<MESBasicInterfaceSyncLog> page, String viewCode, int type, String processKey, Boolean flowBulkFlag,
	...
	//				}
			...
			if(needPermission){
				...
				if(view.getType() == ViewType.REFERENCE || view.getType() == ViewType.REFTREE){
					if(view.getShowType().equals(ShowType.PART)){
						...
						if(null == layoutView  || !(layoutView.getIsPermission() && layoutView.getPermissionCode().trim().length() > 0)){
							...
							powerCode = "MESBasic_1_interfaceSyncLog_InterfaceSyncLog" + "_" + layoutView.getPermissionCode();
						}
						if(null == layoutView)  {
							layoutView = getLayoutView(permissionCode);
							if(null == layoutView  || !(layoutView.getIsPermission() && layoutView.getPermissionCode().trim().length() > 0)){
						...
						if(view.getIsPermission() && view.getPermissionCode().trim().length() > 0){
							powerCode = "MESBasic_1_interfaceSyncLog_InterfaceSyncLog" + "_" + view.getPermissionCode();
						}
					}
				...
				if(powerCodeList.size() > 0) {
					...
					List<Object> checkList =  interfaceSyncLogDao.createNativeQuery(powerOperateSql, "MESBasic_1_interfaceSyncLog").list();
					if(checkList.size()>0){
						powerCode = checkList.get(0).toString();
					}
				}	
					String	pc = dataPermissionService.getBaseModelPowerCondition(this.creatorService.getStaffFromSession().getUser(), powerCode, "\"interfaceSyncLog\"","MESBasic_1_interfaceSyncLog",customCondition,"INTERFACE_SYNC_LOG",false);
				if (pc.trim().length() > 0) {
					if (hasWhere){
						s.append(" AND ");
					}else{
				...
				if(type == Sql.TYPE_LIST_QUERY){
					...
					if(!"".equals(pendingSql)){
						s.append(" \"interfaceSyncLog\".TABLE_INFO_ID IN (  SELECT   D.TABLE_INFO_ID "+
	                      "   FROM   "+MESBasicInterfaceSyncLogDealInfo.TABLE_NAME+" d "+
	                      "  WHERE   ("+pendingSql+") "+
			...
			if(!noQueryFlag)  {
				...
				List<MESBasicInterfaceSyncLog> result = new ArrayList<MESBasicInterfaceSyncLog>();
				if(page.isExportFlag()) {  
					result = getResult(page, query, new PendingResultTransformer(MESBasicInterfaceSyncLog.class,interfaceSyncLogDao,maps,true));
				}else {
					result = getResult(page, query, new PendingResultTransformer(MESBasicInterfaceSyncLog.class,interfaceSyncLogDao,maps));
				}
				modelServiceFoundation.initCacheData();
				page.setResult(result);
				if(null != hasAttachment && hasAttachment) {
					for (MESBasicInterfaceSyncLog interfaceSyncLog : result) {
						long count = 0l;
						count = documentService.getCountByLinkIdAndType(interfaceSyncLog.getId(), "MESBasic_interfaceSyncLog_interfaceSyncLog");
						if(count > 0) {
							List<Document> documents = documentService.getByLinkIdAndType(interfaceSyncLog.getId(), "MESBasic_interfaceSyncLog_interfaceSyncLog");
	...
	private View getLayoutView(String permissionCode) {
		if(null!=permissionCode&&permissionCode.indexOf("MESBasic_1_interfaceSyncLog")!=-1) {
				String personalCode=permissionCode.substring(permissionCode.indexOf("MESBasic_1_interfaceSyncLog")+"MESBasic_1_interfaceSyncLog".length()+1);
				if(null!=personalCode&&personalCode.trim().length()>0)  {
						return viewServiceFoundation.getViewWithPermissionCode("MESBasic_1_interfaceSyncLog",personalCode);
				}
		}
		return null;
	}
	
	private void getConfigAssoPropsResult(String viewCode, List<MESBasicInterfaceSyncLog> result) {
		getConfigAssoPropsResult(viewCode, null, result);
	}
	
	private void getConfigAssoPropsResult(String viewCode,String dataGridCode, List<MESBasicInterfaceSyncLog> result) {
		View view = null;
		...
		Map<Long, MESBasicInterfaceSyncLog> rsMap = new HashMap<Long, MESBasicInterfaceSyncLog>();
		for (MESBasicInterfaceSyncLog interfaceSyncLog : result) {
	...
	protected EntityTableInfo getTableInfo(MESBasicInterfaceSyncLog interfaceSyncLog,boolean... isImport) {
		...
		ti.setValid(true);
		ti.setTargetEntityCode("MESBasic_1_interfaceSyncLog");
			...
			if(refViewCode!=null&&!refViewCode.equals(""))  {
				...
				if(needPermission)  {
					if(null == refView ){
						...
						powerCode ="MESBasic_1_interfaceSyncLog_InterfaceSyncLog" + "_" + refView.getPermissionCode();
						searchRefView=true;
					}
					String powerCodeSql = "select m.code as code from base_MenuOperate m where m.code = ? and m.valid = 1";
					List<Object> powerCodeList =  interfaceSyncLogDao.createNativeQuery(powerCodeSql, powerCode).list();
					if(powerCodeList.size() > 0) {
						...
						powerSql  = dataPermissionService.getBaseModelPowerCondition(this.creatorService.getStaffFromSession().getUser(), powerCode, "\"interfaceSyncLog\"","MESBasic_1_interfaceSyncLog","","INTERFACE_SYNC_LOG",false);
	...
	public void afterPropertiesSet() throws Exception {
		this.beforeInitBean();
		this.counter = this.counterManager.addCounter("interfaceSyncLog", "MESBasic_1_interfaceSyncLog", "interfaceSyncLog_{1,date,yyyyMMdd}_{0,number,000}", CounterType.Daily);
		String formatStr = "";
		this.afterInitBean();
	}
	@Override
	...
	protected String getEntityCode(){return MESBasicInterfaceSyncLog.ENTITY_CODE;}
	protected String getModuleCode(){return MESBasicInterfaceSyncLog.MODULE_CODE;}
	protected String getModelCode(){return MESBasicInterfaceSyncLog.MODEL_CODE;}
	 ...
	 */
	public void checkUniqueConstraint(MESBasicInterfaceSyncLog interfaceSyncLog){
	}
	
	
	@Override
	public List<MESBasicInterfaceSyncLog> getInterfaceSyncLogs(String sql, List<Object> params) {
		DetachedCriteria detachedCriteria = DetachedCriteria.forClass(MESBasicInterfaceSyncLog.class);
		if(params!=null){
			...
			return interfaceSyncLogDao.findByHql("from " + MESBasicInterfaceSyncLog.JPA_NAME + " " + ((sql==null || sql.isEmpty()) ? "" : "where " + sql)) ;
		}
	...
	@Override
	public List<MESBasicInterfaceSyncLog> findInterfaceSyncLogsBySql(String sql, List<Object> params){
		DetachedCriteria detachedCriteria = DetachedCriteria.forClass(MESBasicInterfaceSyncLog.class);
	...
	@Override
	public List<MESBasicInterfaceSyncLog> findInterfaceSyncLogsByHql(String hql, Object... objects){
		
		return   interfaceSyncLogDao.findByHql(hql, objects);
	}
	
	@Override
	public MESBasicInterfaceSyncLog loadInterfaceSyncLogByBussinessKey(MESBasicInterfaceSyncLog interfaceSyncLog){
		return loadInterfaceSyncLogByBussinessKey(interfaceSyncLog.getId());
	}
	
	@Override
	public Page<MESBasicInterfaceSyncLog> getInterfaceSyncLogs(Page<MESBasicInterfaceSyncLog> page, String sql, List<Object> params, String sort) {
		DetachedCriteria detachedCriteria = DetachedCriteria.forClass(MESBasicInterfaceSyncLog.class);
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public MESBasicInterfaceSyncLog loadInterfaceSyncLogByBussinessKey(Serializable bussinessKey){
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public List<MESBasicInterfaceSyncLog> findByProperty(String propertyName, Object object){
		return interfaceSyncLogDao.findByProperty(propertyName, object);
	}
	
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public MESBasicInterfaceSyncLog findEntityByProperty(String propertyName, Object object){
	...
	public void deleteByBussinessKeys(String bussinessKeys){
		if(null != bussinessKeys && bussinessKeys.trim().length() > 0){
			...
			String sql = "update " + MESBasicInterfaceSyncLog.JPA_NAME + " set valid=0 where id in (:businessKeys)";
	...
	public String findValidateDatagrids(Map<String,Class> dgClassMap){
		...
		List<View> dgviews = viewServiceFoundation.findViewsByAssModelCode("MESBasic_1_interfaceSyncLog_InterfaceSyncLog","runtime");
		try {
	...
	public String findMainViewPath(){
		String mainViewPath="";
		List<View> views = viewServiceFoundation.findViewsByEntityCode("MESBasic_1_interfaceSyncLog", ViewType.VIEW);
		for(View v:views){
			if(v.getMainView()){
	...
	public void dealDatagridsSave(MESBasicInterfaceSyncLog interfaceSyncLog,String viewCode,Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads){
			...
			try {
				for(DataGrid dg:dgs){
					...
					if(dgLists!=null&&dgLists.get(dg.getName())!=null){
						...
						java.lang.reflect.Method _reflect_setMethod=_reflect_dgclass.getMethod("set"+fLTU(dg.getOrgProperty().getName()), MESBasicInterfaceSyncLog.class);
	...
	public List<Object> getBusinessKeyData(String businessKeyName){
		...
		if(null != businessKeyName){
			String sql = "select " + businessKeyName +" from "+ MESBasicInterfaceSyncLog.TABLE_NAME +" where valid = 1";
	...
	public List<Object> getBusinessKeyDataByBusinessKeyName(String businessKeyName){
		List<Object> list = new ArrayList<Object>();
		if(null != businessKeyName){
			String sql = "select " + businessKeyName +" from "+ MESBasicInterfaceSyncLog.TABLE_NAME;
			list = interfaceSyncLogDao.createNativeQuery(sql).list();
		}
		return list;
	}
	...
	public Map<Object, Object> getReplaceProperty(String propertyName,String businessKey){
		...
		if(null != propertyName && null != businessKey){
			String sql = "select " + businessKey + "," + propertyName +" from "+ MESBasicInterfaceSyncLog.TABLE_NAME +" group by " + propertyName + "," + businessKey;
			list = interfaceSyncLogDao.createNativeQuery(sql).list();
		}
		if (list != null && !list.isEmpty()) {
			for (Object[] obj : list) {
	...
	@Autowired
	private MESBasicInterfaceSyncLogDaoImpl interfaceSyncLogDaoImpl;
	
	
	@Override
	@Transactional(propagation = Propagation.SUPPORTS)
	@AuditLog(entity="MESBasic_1_interfaceSyncLog",model="MESBasic_1_interfaceSyncLog_InterfaceSyncLog",desc="foundation.import.bussiness.info",operType="5")
	public Map<Object, Long> importBatchInterfaceSyncLog(final List<MESBasicInterfaceSyncLog> insertObjs, final List<MESBasicInterfaceSyncLog> updateObjs, 
	...
	public Map<Object, Long> importBatchInterfaceSyncLog(final List<MESBasicInterfaceSyncLog> insertObjs, final List<MESBasicInterfaceSyncLog> updateObjs, 
		...
		AuditUtil.setAuditDes(InternationalResource.get("foundation.import.bussiness.info.args",null,InternationalResource.get("MESBasic.modelname.randon1493192130394"),importCount));
		...
		Map<Long, MESBasicInterfaceSyncLog> oldUpdateObjsMap = new HashMap<Long, MESBasicInterfaceSyncLog>(); 
		List<Long> updateObjIdsList = new ArrayList<Long>();
		for(int updateIndex = 0; updateIndex < updateObjs.size(); updateIndex++)  {
			MESBasicInterfaceSyncLog bizObj = updateObjs.get(updateIndex);
		...
		if (updateObjIdsList.size() > 0) {
			...
			List<MESBasicInterfaceSyncLog> bizObjList = interfaceSyncLogDao.findByCriteria(detachedCriteria);
			if (null != bizObjList) {
				for (int mIndex = 0; mIndex < bizObjList.size(); mIndex++) {
					MESBasicInterfaceSyncLog bizObj = bizObjList.get(mIndex);
		...
		final List<MESBasicInterfaceSyncLog> nmeObjs = new ArrayList<MESBasicInterfaceSyncLog>();
		...
		long id=autoGeneratorID.getNextId(MESBasicInterfaceSyncLog.TABLE_NAME,expLength,dbId);//id表只操作一次，实际id通过++来增长
		for(MESBasicInterfaceSyncLog interfaceSyncLog:insertObjs)  {
			//id = autoGeneratorID.getNextId(MESBasicInterfaceSyncLog.TABLE_NAME,1,dbId);
		...
		for(Map<String,String> map : columnMaps){
			if(map.get("type").equals("SYSTEMCODE")){
				...
				Object[] result = (Object[]) interfaceSyncLogDao.createNativeQuery(sql, "MESBasic_1_interfaceSyncLog_InterfaceSyncLog"+"_"+map.get("name")).uniqueResult();
		...
		interfaceSyncLogDaoImpl.getSession().doWork(new Work() {
			...
			public void execute(Connection conn) throws SQLException {
				...
				if(updateObjs != null && updateObjs.size()>0){
					...
					String updateSql = "UPDATE " + MESBasicInterfaceSyncLog.TABLE_NAME + " SET ";
					...
					for(int updateIndex =0;updateIndex<updateObjs.size();updateIndex++){
						MESBasicInterfaceSyncLog interfaceSyncLog = updateObjs.get(updateIndex);
				...
				if(insertObjs != null && insertObjs.size()>0){//新增
					...
					String insertSql = "INSERT INTO " + MESBasicInterfaceSyncLog.TABLE_NAME + " (";
					for(int i = 0;i<columnMaps.size();i++){
						String mName = columnMaps.get(i).get("name");
						String methodName = "get"+ mName.replaceFirst(mName.substring(0, 1), mName.substring(0, 1).toUpperCase());
...
//					String idSql = "select id from " + MESBasicInterfaceSyncLog.TABLE_NAME + " order by id desc";
...
//					}
					...
					for(int insertIndex = 0; insertIndex<insertObjs.size(); insertIndex++)  {
						MESBasicInterfaceSyncLog interfaceSyncLog = insertObjs.get(insertIndex);
		...
		for(int insertIndex = 0; insertIndex < insertObjs.size(); insertIndex++)  {//新增
			MESBasicInterfaceSyncLog bizObj = insertObjs.get(insertIndex);
		...
		for(int updateIndex = 0; updateIndex < updateObjs.size(); updateIndex++)  {//修改
			MESBasicInterfaceSyncLog bizObj = updateObjs.get(updateIndex);
			MESBasicInterfaceSyncLog oldBizObj = oldUpdateObjsMap.get(bizObj.getId());
	...
	private String getDbIdName(){
		...
		String dbIDName = interfaceSyncLogDao.createNativeQuery(sql, "MESBasic_1_interfaceSyncLog_InterfaceSyncLog").uniqueResult().toString();
		return dbIDName;
	}
	...
	@Override
	@AuditLog(entity="MESBasic_1_interfaceSyncLog",model="MESBasic_1_interfaceSyncLog_InterfaceSyncLog",desc="ec.flow.save")
	public void saveInterfaceSyncLog(MESBasicInterfaceSyncLog interfaceSyncLog, DataGridService dataGridService){
		saveInterfaceSyncLog(interfaceSyncLog, dataGridService, null);
	}
	
	@Override
	@AuditLog(entity="MESBasic_1_interfaceSyncLog",model="MESBasic_1_interfaceSyncLog_InterfaceSyncLog",desc="ec.flow.save")
	public void saveInterfaceSyncLog(MESBasicInterfaceSyncLog interfaceSyncLog, DataGridService dataGridService, String viewCode){
		saveInterfaceSyncLog(interfaceSyncLog, dataGridService, viewCode, null);
	}
	
	@Override
	@AuditLog(entity="MESBasic_1_interfaceSyncLog",model="MESBasic_1_interfaceSyncLog_InterfaceSyncLog")
	public void saveInterfaceSyncLog(MESBasicInterfaceSyncLog interfaceSyncLog, DataGridService dataGridService, String viewCode, String eventTopic, boolean... isImport){
		this.saveInterfaceSyncLog(interfaceSyncLog, dataGridService, viewCode, eventTopic,null,isImport);
	}
	
	@Override
	@AuditLog(entity="MESBasic_1_interfaceSyncLog",model="MESBasic_1_interfaceSyncLog_InterfaceSyncLog")
	public void saveInterfaceSyncLog(MESBasicInterfaceSyncLog interfaceSyncLog, DataGridService dataGridService, String viewCode, String eventTopic,SignatureLog signatureLog, boolean... isImport){
		boolean isNew = false;
		String entityCode = "MESBasic_1_interfaceSyncLog";
		Map<String, Object> props = new HashMap<String, Object>();
		props.put("callType", "service");
	...
	@Override
	@AuditLog(entity="MESBasic_1_interfaceSyncLog",model="MESBasic_1_interfaceSyncLog_InterfaceSyncLog")
	public Map<Object, Object> interfaceSyncLogDataGridImport(MESBasicInterfaceSyncLog interfaceSyncLog, DataGridService dataGridService, String viewCode, String eventTopic,Property businessKey, boolean isImport){
	...
	@Override
	@AuditLog(entity="MESBasic_1_interfaceSyncLog",model="MESBasic_1_interfaceSyncLog_InterfaceSyncLog")
	public void mergeInterfaceSyncLog(MESBasicInterfaceSyncLog interfaceSyncLog, DataGridService dataGridService){
		ReflectUtils.filterObjectIdIsNVL(interfaceSyncLog);
		beforeSaveInterfaceSyncLog(interfaceSyncLog);
		interfaceSyncLogDao.merge(interfaceSyncLog);
	 ...
	 */
	@Override
	@AuditLog(entity="MESBasic_1_interfaceSyncLog",model="MESBasic_1_interfaceSyncLog_InterfaceSyncLog",desc="foundation.common.exportExcel",operType="11")
	 ...
	 */
	@Override
	@AuditLog(entity="MESBasic_1_interfaceSyncLog",model="MESBasic_1_interfaceSyncLog_InterfaceSyncLog",desc="ec.print.page.print",operType="4")
	...
	@Override
	@AuditLog(entity="MESBasic_1_interfaceSyncLog",model="MESBasic_1_interfaceSyncLog_InterfaceSyncLog",desc="foundation.batch.save",operType="4")
	public void batchSaveInterfaceSyncLog(MESBasicInterfaceSyncLog interfaceSyncLog, DataGridService dataGridService,View view,List<Event>  events, String eventTopic, boolean... isImport){
		String entityCode = "MESBasic_1_interfaceSyncLog";
		Map<String, Object> props = new HashMap<String, Object>();
		props.put("callType", "service");
		props.put("entityCode", "MESBasic_1_interfaceSyncLog");
	...
	@Override
	public Page<MESBasicInterfaceSyncLog> getByPage(Page<MESBasicInterfaceSyncLog> page,DetachedCriteria detachedCriteria){
	...
	public String generateTableNo(){
		this.counter.setPattern(modelServiceFoundation.getEntity("MESBasic_1_interfaceSyncLog").getPrefix()+"_{1,date,yyyyMMdd}_{0,number,000}");
		return this.counter.incrementAndGetString(new Date(),new Date());
	}
	private void beforeSaveInterfaceSyncLog(MESBasicInterfaceSyncLog interfaceSyncLog, Object... objects){
		checkUniqueConstraint(interfaceSyncLog);
	/* CUSTOM CODE START(serviceimpl,beforeSave,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	
	private void afterSaveInterfaceSyncLog(MESBasicInterfaceSyncLog interfaceSyncLog, Object... objects){
	/* CUSTOM CODE START(serviceimpl,afterSave,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	@Override
	public void beforeExcelImportInterfaceSyncLog(List<MESBasicInterfaceSyncLog> interfaceSyncLogs, Map<String, Map<Integer, Map<Integer, String>>> errors){
	/* CUSTOM CODE START(serviceimpl,beforeExcelImport,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	@Override
	public void afterExcelImportInterfaceSyncLog(List<MESBasicInterfaceSyncLog> interfaceSyncLogs){
	/* CUSTOM CODE START(serviceimpl,afterExcelImport,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	@Override
	public void beforeExcelBatchImportInterfaceSyncLog(List<MESBasicInterfaceSyncLog> interfaceSyncLogs, Map<Integer, Map<Integer, String>> errors){
	/* CUSTOM CODE START(serviceimpl,beforeExcelBatchImport,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */	
	...
	@Override
	public void afterExcelBatchImportInterfaceSyncLog(List<MESBasicInterfaceSyncLog> interfaceSyncLogs){
	/* CUSTOM CODE START(serviceimpl,afterExcelBatchImport,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */	
	}
	
	private void beforeDeleteInterfaceSyncLog(MESBasicInterfaceSyncLog interfaceSyncLog){
	/* CUSTOM CODE START(serviceimpl,beforeDelete,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	
	private void afterDeleteInterfaceSyncLog(MESBasicInterfaceSyncLog interfaceSyncLog){
	/* CUSTOM CODE START(serviceimpl,afterDelete,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	
	private void beforeRestoreInterfaceSyncLog(MESBasicInterfaceSyncLog interfaceSyncLog){
	/* CUSTOM CODE START(serviceimpl,beforeRestore,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	
	private void afterRestoreInterfaceSyncLog(MESBasicInterfaceSyncLog interfaceSyncLog){
	/* CUSTOM CODE START(serviceimpl,afterRestore,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	
	private void customGenerateCodes(MESBasicInterfaceSyncLog interfaceSyncLog, Object... objects) {
		/* CUSTOM CODE START(serviceimpl,customGenerateCodes,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	private void customGenerateSummarys(MESBasicInterfaceSyncLog interfaceSyncLog, Object... objects) {
		/* CUSTOM CODE START(serviceimpl,customGenerateCodes,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	/* CUSTOM CODE START(serviceimpl,beforeServiceDestroy,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	private void beforeInitBean(){
		/* CUSTOM CODE START(serviceimpl,beforeInitBean,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	private void afterInitBean(){
		/* CUSTOM CODE START(serviceimpl,afterInitBean,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	@Override
	public void beforeImportInterfaceSyncLog(List<MESBasicInterfaceSyncLog> insertObjs, List<MESBasicInterfaceSyncLog> updateObjs, 
		...
		/* CUSTOM CODE START(serviceimpl,beforeImportInterfaceSyncLog,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	@Override
	public void afterImportInterfaceSyncLog(List<MESBasicInterfaceSyncLog> insertObjs, List<MESBasicInterfaceSyncLog> updateObjs, 
		...
		/* CUSTOM CODE START(serviceimpl,afterImportInterfaceSyncLog,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	/* CUSTOM CODE START(serviceimpl,functions,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码
