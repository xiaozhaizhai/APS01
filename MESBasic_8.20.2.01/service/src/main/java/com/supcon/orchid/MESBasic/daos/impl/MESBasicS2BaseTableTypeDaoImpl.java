...
@Repository
public class MESBasicS2BaseTableTypeDaoImpl extends TreeDaoImpl<MESBasicS2BaseTableType, Long> implements MESBasicS2BaseTableTypeDao {
	@Override
	...
	@Override
	public MESBasicS2BaseTableTypeDealInfo copyAndSaveDealInfo(DealInfo di) {
		MESBasicS2BaseTableTypeDealInfo dealInfo = new MESBasicS2BaseTableTypeDealInfo();
	...
	@Override
	public MESBasicS2BaseTableTypeDealInfo copyAndSaveDealInfo(DealInfo di, MESBasicS2BaseTableType mainObj, Staff dealStaff) {
		MESBasicS2BaseTableTypeDealInfo dealInfo = copyAndSaveDealInfo(di);
	...
	public Date findLastDealInfo(Long tableInfoId, String activityName) {
		Criteria criteria = getSession().createCriteria(MESBasicS2BaseTableTypeDealInfo.class);
		...
		List<MESBasicS2BaseTableTypeDealInfo> dealinfo = criteria.list();
		return (dealinfo!=null&&!dealinfo.isEmpty()) ? dealinfo.get(0).getCreateTime() : null;
	}

	 /* CUSTOM CODE START(daoimpl,functions,MESBasic_1_tableType_S2BaseTableType,MESBasic_1) */
// 自定义代码
