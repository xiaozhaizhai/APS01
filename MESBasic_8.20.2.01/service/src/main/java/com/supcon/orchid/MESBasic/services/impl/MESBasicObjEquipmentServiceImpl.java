...
import com.supcon.orchid.MESBasic.services.MESBasicObjEquipmentImportService;
import com.supcon.orchid.utils.DateUtils;
...
import com.supcon.orchid.workflow.engine.transformers.PendingResultTransformer;
import com.supcon.orchid.MESBasic.daos.impl.MESBasicObjEquipmentDaoImpl;
import java.lang.reflect.Method;
...
/* CUSTOM CODE START(serviceimpl,import,MESBasic_1_factoryModel_ObjEquipment,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */

@Service("mESBasic_objEquipmentService")
@Transactional
public class MESBasicObjEquipmentServiceImpl  extends BaseServiceImpl<MESBasicObjEquipment> implements MESBasicObjEquipmentService, InitializingBean, DisposableBean {
	...
	@Resource
	private IBAPBaseService<MESBasicObjEquipment> bapBaseService;
	...
	@Autowired
	private MESBasicObjEquipmentImportService objEquipmentImportService;
	/**
	 * 根据主显示字段列表获取Map
	...
	public Map<String, Object> getMainDisplayMap(Serializable mainDisplayName, Serializable businessKeyName,List<Serializable> mainDisplayKeys) {
		String hql = "select " + mainDisplayName + ",id,"+ businessKeyName + " from " + MESBasicObjEquipment.JPA_NAME + " where " + mainDisplayName + " in (:mainDisplayKeys)"  + "and VALID = 1";
		Query query =  objEquipmentDao.createQuery(hql);
	...
	public Map<Serializable,Serializable> getBusinessKeyMap(Serializable businessKeyName,List<Serializable> businessKeys){
		if(businessKeyName!=null && String.valueOf(businessKeyName).length() > 0){
			String hql = "select " + businessKeyName + ",id from " + MESBasicObjEquipment.JPA_NAME + " where " + businessKeyName + " in (:businessKeys)";
			Query query = objEquipmentDao.createQuery(hql);
	...
	*/
	...
	public Map<String, Object> getParentNodeMap(Serializable mainDisplayName, Serializable businessKeyName, List<Serializable> serial, String queryParam) {
		...
		if(queryParam!=null && queryParam.equals("md")){
			hql = "select " + mainDisplayName + ",id,"+ businessKeyName + ",fullPathName,layNo,layRec,parentId,leaf from " + MESBasicObjEquipment.JPA_NAME + " where " + mainDisplayName + " in (:serial)";
		}else if(queryParam!=null && queryParam.equals("bk")){
			hql = "select " + mainDisplayName + ",id,"+ businessKeyName + ",fullPathName,layNo,layRec,parentId,leaf from " + MESBasicObjEquipment.JPA_NAME + " where " + businessKeyName + " in (:serial)";
		}
		Query query =  objEquipmentDao.createQuery(hql);
		...
		/*String sql = null;
		if(queryParam!=null && queryParam.equals("md")){
			sql = "select * from " + MESBasicObjEquipment.TABLE_NAME + " where " + mainDisplayName + " = ?";
		}else if(queryParam!=null && queryParam.equals("bk")){
			sql = "select * from " + MESBasicObjEquipment.TABLE_NAME + " where " + businessKeyName + " = ?";
		}
		List<MESBasicObjEquipment> list = (List<MESBasicObjEquipment>) objEquipmentDao.createNativeQuery(sql,serial.get(0)).list();
		*/
		Map<String, Object> m = new HashMap<String, Object>();
		if(queryParam!=null && queryParam.equals("md")){
			m.put("count", list.size());
	...
	public MESBasicObjEquipment getObjEquipment(long id){
		return getObjEquipment(id, null);
	}

	
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public MESBasicObjEquipment getObjEquipment(long id, String viewCode){
		MESBasicObjEquipment objEquipment = objEquipmentDao.load(id);
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public String getObjEquipmentAsJSON(long id, String include){
		MESBasicObjEquipment objEquipment = objEquipmentDao.load(id);
		// 一对多情况处理
		...
		return JSONPlainSerializer.serializeAsJSON(objEquipment, include, new BAPEntityTransformer());
	}
	

	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment",desc="foundation.common.delete",operType="3")
	public void deleteObjEquipment(MESBasicObjEquipment objEquipment){
		if(null != objEquipment && (StringUtils.isEmpty(AuditUtil.getColumnStringD()) || MESBasicObjEquipment.MODEL_CODE.equals(AuditUtil.getColumnStringD()))){
			AuditUtil.setColumnStringB(null == objEquipment.getId() ? "" : objEquipment.getId().toString());
			AuditUtil.setColumnStringA(null == objEquipment.getId() ? "" : objEquipment.getId().toString());
			AuditUtil.setColumnStringC(objEquipment.getId().toString());
		}
		beforeDeleteObjEquipment(objEquipment);
		objEquipmentDao.deletePhysical(objEquipment);
		afterDeleteObjEquipment(objEquipment);
		objEquipmentDao.flush();
		List<MESBasicObjEquipment> params = new ArrayList<MESBasicObjEquipment>();
		params.add(objEquipment);
	...
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment",desc="foundation.common.delete",operType="3")
	public void deleteObjEquipment(List<Long> objEquipmentIds){
		deleteObjEquipment(objEquipmentIds, null);
	}

	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment",desc="foundation.common.delete",operType="3")
	public void deleteObjEquipment(List<Long> objEquipmentIds, String eventTopic) {
		List<MESBasicObjEquipment> objEquipments = new ArrayList<MESBasicObjEquipment>();
		for(Long objEquipmentId : objEquipmentIds){
			MESBasicObjEquipment objEquipment = getObjEquipment(objEquipmentId);
			objEquipments.add(objEquipment);
			if(null != objEquipment && (StringUtils.isEmpty(AuditUtil.getColumnStringD()) || MESBasicObjEquipment.MODEL_CODE.equals(AuditUtil.getColumnStringD()))){
				if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
					AuditUtil.setColumnStringA(AuditUtil.getColumnStringA() + (null == objEquipment.getId() ? "" : "," + objEquipment.getId().toString()));
				} else {
					AuditUtil.setColumnStringA(null == objEquipment.getId() ? "" : objEquipment.getId().toString());
				}
				if(!StringUtils.isEmpty(AuditUtil.getColumnStringB())){
					AuditUtil.setColumnStringB(AuditUtil.getColumnStringB() + (null == objEquipment.getId() ? "" : "," + objEquipment.getId().toString()));
				} else {
					AuditUtil.setColumnStringB(null == objEquipment.getId() ? "" : objEquipment.getId().toString());
				}
				if(!StringUtils.isEmpty(AuditUtil.getColumnStringC())){
					AuditUtil.setColumnStringC(AuditUtil.getColumnStringC() + (null == objEquipment.getId() ? "" : "," + objEquipment.getId().toString()));
				} else {
					AuditUtil.setColumnStringC(null == objEquipment.getId() ? "" : objEquipment.getId().toString());
				}
			}
		}
		 ...
		 * 增加SQL/HQL执行的数据日志记录
		 */
		if(objEquipments != null && objEquipments.size() > 0 ){
			for(MESBasicObjEquipment objEquipment : objEquipments){
				List<String> propertyNames = new ArrayList<String>();
				List<Object> previousState = new ArrayList<Object>();
				java.lang.reflect.Field[] fields = MESBasicObjEquipment.class.getDeclaredFields();
				try {
					for(java.lang.reflect.Field field : fields){
						...
						try{
							...
							previousState.add(field.get(objEquipment));
						}
					}
					dataAuditLogService.saveCustomerAudit(InternationalResource.get("foundation.common.delete"),objEquipment, objEquipment.getId(), null, previousState.toArray(), propertyNames.toArray(new String[propertyNames.size()]));
				} catch (IllegalArgumentException | IllegalAccessException e) {
				}
			}
		}
		if(objEquipmentIds != null && objEquipmentIds.size() > 0) {
			String hql = "delete " + MESBasicObjEquipment.JPA_NAME + " where id in(:ids)";
			Query query = objEquipmentDao.createQuery(hql);
			query.setParameterList("ids", objEquipmentIds);
			query.executeUpdate();
		}
		...
		if(eventTopic==null){
			for(MESBasicObjEquipment objEquipmentz : objEquipments){
				objEquipmentz.setValid(false);
				List<MESBasicObjEquipment> params = new ArrayList<MESBasicObjEquipment>();
				params.add(objEquipmentz);
				Map<String, Object> props = new HashMap<String, Object>();
				props.put("callType", "service");
				props.put("entityCode", "MESBasic_1_factoryModel");
				props.put("eventType", "delete");
	...
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment",desc="foundation.common.delete",operType="3")
	public void deleteObjEquipment(long objEquipmentId, int objEquipmentVersion){
		this.deleteObjEquipment(objEquipmentId, objEquipmentVersion,null);
	}
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment",desc="foundation.common.delete",operType="3")
	public void deleteObjEquipment(long objEquipmentId, int objEquipmentVersion,SignatureLog signatureLog){
		MESBasicObjEquipment objEquipment = getObjEquipment(objEquipmentId);
		...
		beforeDeleteObjEquipment(objEquipment);
		objEquipmentDao.delete(objEquipmentId, objEquipmentVersion);
		afterDeleteObjEquipment(objEquipment);
		objEquipmentDao.flush();
		List<MESBasicObjEquipment> params = new ArrayList<MESBasicObjEquipment>();
		params.add(objEquipment);
		...
		if(signatureLog != null ) {
			...
			businessKey=objEquipment.getId();
			signatureLog.setTableId(objEquipment.getId());
			if(businessKey != null) {
	...
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment",desc="foundation.common.delete",operType="3")
	public void deleteObjEquipment(String objEquipmentIds){
		this.deleteObjEquipment(objEquipmentIds,null);
	}
	
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment",desc="foundation.common.delete",operType="3")
	public void deleteObjEquipment(String objEquipmentIds,SignatureLog signatureLog){
		deleteCollection(objEquipmentIds,signatureLog);
	}
	...
	private void deleteCollection(String ids,SignatureLog signatureLog) {
		...
		for(String idVersion : idst) {
			...
			if (id != null && id.trim().length() > 0 && version != null && version.trim().length() > 0) {
				deleteObjEquipment(Long.valueOf(id), Integer.valueOf(version),signatureLog);
			}
		}
		if(null != signatureLog){
			...
			String msgId="moduleCode:MESBasic_1#entityCode:MESBasic_1_factoryModel#modelCode:MESBasic_1_factoryModel_ObjEquipment#timeStamp:"+String.valueOf(new Date().getTime());
			reliableMessageSenderService.sendQueue(msgId,signatureLog);
		}
	}
	
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment",desc="ec.engine.restore",operType="10")
	public void restoreObjEquipment(String objEquipmentIds){
		restoreCollection(objEquipmentIds);
	}
	...
	public void restoreCollection(String ids) {
		...
		for(String idVersion : idst) {
			...
			if (id != null && id.trim().length() > 0) {
				restoreObjEquipment(Long.valueOf(id));
			}
		}
	}
	...
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment",desc="ec.engine.restore",operType="10")
	public void restoreObjEquipment(long objEquipmentId){
		
		findBusinessKeyUsed(objEquipmentId);	//判断业务主键是否重复
		...
		beforeRestoreObjEquipment(objEquipment);
		objEquipment.setValid(true);
		objEquipmentDao.update(objEquipment);
		afterRestoreObjEquipment(objEquipment);
		List<MESBasicObjEquipment> params = new ArrayList<MESBasicObjEquipment>();
		params.add(objEquipment);
		Map<String, Object> props = new HashMap<String, Object>();
		props.put("callType", "service");
	...
	public void findBusinessKeyUsed(long objEquipmentId){
		Property property = modelServiceFoundation.getBussinessProperty("MESBasic_1_factoryModel_ObjEquipment");
		if(property != null){
			String propertyName = property.getColumnName();
			String sql  = "select * from " + MESBasicObjEquipment.TABLE_NAME + " where valid = 1 and " + 
					propertyName + " =  (select "+ propertyName +" from "+ MESBasicObjEquipment.TABLE_NAME +" where id = ? )";
			List<Object> list =  objEquipmentDao.createNativeQuery(sql,objEquipmentId).list();
			if(list.size() > 0){
	...
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment",desc="foundation.batch.import",operType="4")
	public  void batchImportBaseObjEquipment(List<MESBasicObjEquipment>  objEquipments){
		for(MESBasicObjEquipment objEquipment:objEquipments)  {
			saveObjEquipment(objEquipment, null, null, null);
		}
	}
	
	@Override
	public  void excelBatchImportBaseObjEquipment(List<MESBasicObjEquipment>  objEquipments){
		for(MESBasicObjEquipment objEquipment:objEquipments)  {
			saveObjEquipment(objEquipment, null);
		}
	}
	
	
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment",desc="ec.flow.save")
	public void saveObjEquipment(MESBasicObjEquipment objEquipment, Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads){
		saveObjEquipment(objEquipment, dgLists,dgDeleteIDs,assFileUploads, null);
	}
	
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment",desc="ec.flow.save")
	public void saveObjEquipment(MESBasicObjEquipment objEquipment, Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads, String viewCode){
		saveObjEquipment(objEquipment, dgLists,dgDeleteIDs,assFileUploads, viewCode, null,null);
	}


	public void generateObjEquipmentCodes(MESBasicObjEquipment objEquipment) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		generateObjEquipmentCodes(objEquipment, false);
	}
	
	public void generateObjEquipmentCodes(MESBasicObjEquipment objEquipment, Boolean viewIsView) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
	}
	
	public void generateObjEquipmentSummarys(MESBasicObjEquipment objEquipment) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		generateObjEquipmentSummarys(objEquipment, false);
	}

	public void generateObjEquipmentSummarys(MESBasicObjEquipment objEquipment, Boolean viewIsView) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
	}
	
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment")
	public void saveObjEquipment(MESBasicObjEquipment objEquipment,Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads,String viewCode, String eventTopic,boolean... isImport){
		this.saveObjEquipment(objEquipment, dgLists,dgDeleteIDs,assFileUploads, viewCode, eventTopic,null,isImport);
	}

	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment")
	public void saveObjEquipment(MESBasicObjEquipment objEquipment,Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads,String viewCode, String eventTopic, SignatureLog signatureLog,boolean... isImport){
		boolean isNew = false;
		...
		props.put("entityCode", "MESBasic_1_factoryModel");
		String url = null;
		if(objEquipment.getId() != null && objEquipment.getId() > 0){
			if(StringUtils.isEmpty(AuditUtil.getColumnStringD()) || MESBasicObjEquipment.MODEL_CODE.equals(AuditUtil.getColumnStringD())){
		...
		if(viewCode != null && !viewCode.trim().isEmpty()){
			...
			if(events!=null && events.size()>0){
				executeGScript(entityCode, "beforeSave", events, objEquipment);
			}
		}
		ReflectUtils.filterObjectIdIsNVL(objEquipment);
		beforeSaveObjEquipment(objEquipment, viewIsView);

		if (viewIsView) {
			objEquipmentDao.saveWithRevertVersion(objEquipment);
		} else {
			if(isNew)
				objEquipmentDao.save(objEquipment);
			else
				objEquipmentDao.merge(objEquipment);
		}
		if(null != objEquipment && (StringUtils.isEmpty(AuditUtil.getColumnStringD()) || MESBasicObjEquipment.MODEL_CODE.equals(AuditUtil.getColumnStringD()))){
			AuditUtil.setColumnStringB(null == objEquipment.getId() ? "" : objEquipment.getId().toString());
			AuditUtil.setColumnStringA(null == objEquipment.getId() ? "" : objEquipment.getId().toString());
		...
		dealDatagridsSave(objEquipment,viewCode,dgLists,dgDeleteIDs,assFileUploads);
		// 一对多情况处理
		
		// 根据配置规则生成编码
		try {
			generateObjEquipmentCodes(objEquipment, viewIsView);
		} catch (Exception e) {
		...
		// 根据配置规则生成摘要
		try {
			generateObjEquipmentSummarys(objEquipment, viewIsView);
		} catch (Exception e) {
			log.error(e.getMessage(), e);
			throw new BAPException(e.getMessage(), e);
		}
		
		afterSaveObjEquipment(objEquipment, viewIsView);


		if(viewCode != null){
			if(events!=null && events.size()>0){
				executeGScript(entityCode, "afterSave", events, objEquipment);
			}
		}
		List<MESBasicObjEquipment> params = new ArrayList<MESBasicObjEquipment>();
		objEquipmentDao.flush();
		objEquipmentDao.clear();
		objEquipment = objEquipmentDao.load(objEquipment.getId());
	...
	private void executeGScript(String entityCode, String scriptType, List<Event> events, MESBasicObjEquipment objEquipment){
		for(Event e : events){
			if(e.getName().equals(scriptType)){
				if(e.getFunction()!=null && e.getFunction().length() > 0){
					try{
						...
						variables.put("objEquipment", objEquipment);
	...
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment")
	public void mergeObjEquipment(MESBasicObjEquipment objEquipment, Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads){
		ReflectUtils.filterObjectIdIsNVL(objEquipment);
		beforeSaveObjEquipment(objEquipment);
		objEquipmentDao.merge(objEquipment);
		if(null != objEquipment && (StringUtils.isEmpty(AuditUtil.getColumnStringD()) || MESBasicObjEquipment.MODEL_CODE.equals(AuditUtil.getColumnStringD()))){
			AuditUtil.setColumnStringB(null == objEquipment.getId() ? "" : objEquipment.getId().toString());
			AuditUtil.setColumnStringA(null == objEquipment.getId() ? "" : objEquipment.getId().toString());
		...
		dealDatagridsSave(objEquipment,null,dgLists,dgDeleteIDs,assFileUploads);

		afterSaveObjEquipment(objEquipment);
	}
	
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public Page<MESBasicObjEquipment> findObjEquipments(Page<MESBasicObjEquipment> page, Criterion... criterions) {
		return objEquipmentDao.findByPage(page, criterions);
	}
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public void findObjEquipments(Page<MESBasicObjEquipment> page,  String viewCode, int type, String processKey,Boolean flowBulkFlag, Boolean hasAttachment,Boolean noQueryFlag,String exportSql, Map exportMap, List<Param> params) {
		findObjEquipments(page,  viewCode, type, processKey, flowBulkFlag, hasAttachment, params, viewCode, noQueryFlag, exportSql, exportMap);
	}
	
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public void findObjEquipments(Page<MESBasicObjEquipment> page,  String viewCode, int type, String processKey,Boolean flowBulkFlag, Boolean hasAttachment, List<Param> params, String permissionCode,Boolean noQueryFlag,String exportSql, Map exportMap) {
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public void findObjEquipments(Page<MESBasicObjEquipment> page,  String viewCode, int type, String processKey,Boolean flowBulkFlag, Boolean hasAttachment, List<Param> params, String permissionCode, Boolean noQueryFlag,String exportSql, Map exportMap, Object... objects) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void commonQuery(Page<MESBasicObjEquipment> page, String viewCode, int type, String processKey, Boolean flowBulkFlag,
			...
			if (null != params && !params.isEmpty()) {
				...
				for (int i = 0; i < params.size(); i++) {
					...
					if ("dataTable-sortColKey".equals(param.getName())) {
						...
						String tableAlias = lastDotPos < 0 ? "\"objEquipment\"" : "\"" + key.substring(0, lastDotPos) + "\"";
					...
					if(type == Sql.TYPE_LIST_REFERENCE){
						if(null != crossCompanyFlag && !crossCompanyFlag && !getCurrentCompanyId().equals(1L)){
							s.append(" AND \"objEquipment\".CID in (1,").append(getCurrentCompanyId()+")");
						}
					}
	...
	//						s.append(" AND \"objEquipment\".CID = ").append(getCurrentCompanyId());
	...
	//				}
			...
			s.append(" ( \"objEquipment\".OBJ_FACTORY IN ( SELECT ID FROM factory_tbcompanystructure \"factoryModel\" ");
			//一个实体只有一个权限操作
			...
			if(needPermission){
				if(view.getType() == ViewType.REFERENCE || view.getType() == ViewType.REFTREE){
					if(view.getIsPermission() && view.getPermissionCode().trim().length() > 0){
						powerCode = "MESBasic_1_factoryModel" + "_" + view.getPermissionCode();
					}
				...
				List<Object> powerCodeList =  objEquipmentDao.createNativeQuery(powerCodeSql, powerCode).list();
				if(powerCodeList.size() > 0) {
					...
					List<Object> checkList =  objEquipmentDao.createNativeQuery(powerOperateSql, "MESBasic_1_factoryModel").list();
					if(checkList.size()>0){
						powerCode = checkList.get(0).toString();
					}
				}
					String	pc = "";
					pc = dataPermissionService.getBaseModelPowerCondition(this.creatorService.getStaffFromSession().getUser(), powerCode, "\"factoryModel\"","MESBasic_1_factoryModel","",false);
				if (pc.trim().length() > 0) {
					s.append(" WHERE (");
					s.append(pc);
			...
			if(type == Sql.TYPE_LIST_PENDING) {
				...
				if(isTreeView) {
					orderPart.append(" \"objEquipment\".LAY_REC ASC, \"objEquipment\".SORT ASC");
				} else {
					orderPart.append(" \"objEquipment\".ID DESC");
				}
			}
			...
			if (page.needCount()) {
				...
				//Long count = ((Number) objEquipmentDao.createNativeQuery(countSql, arr).uniqueResult()).longValue();
				Long count = 0l;
			    Map<String, BigDecimal> resultTotals = new HashMap<String, BigDecimal>();
			    SQLQuery query=objEquipmentDao.createNativeQuery(countSql, arr);
			...
			if(!noQueryFlag)  {
				SQLQuery query = objEquipmentDao.createNativeQuery(realSql, arr);
				if(customerSqlListMap!=null&&!customerSqlListMap.isEmpty()){
					for(String key:customerSqlListMap.keySet()){
						query.setParameterList(key, (Object[])customerSqlListMap.get(key));
					}
				}
				List<MESBasicObjEquipment> result = new ArrayList<MESBasicObjEquipment>();
				if(page.isExportFlag()) {  
					result = getResult(page, query, new PendingResultTransformer(MESBasicObjEquipment.class,objEquipmentDao,maps,true));
				}else {
					result = getResult(page, query, new PendingResultTransformer(MESBasicObjEquipment.class,objEquipmentDao,maps));
				}
				modelServiceFoundation.initCacheData();
				page.setResult(result);
				if(null != hasAttachment && hasAttachment) {
					for (MESBasicObjEquipment objEquipment : result) {
						long count = 0l;
						count = documentService.getCountByLinkIdAndType(objEquipment.getId(), "MESBasic_factoryModel_objEquipment");
						if(count > 0) {
							List<Document> documents = documentService.getByLinkIdAndType(objEquipment.getId(), "MESBasic_factoryModel_objEquipment");
							if(null != documents && !documents.isEmpty()) {
								objEquipment.setDocument(documents.get(0));
								objEquipment.setBapAttachmentInfo(documents.get(0).getName() + "@_@BAP@_@更多(" + count + ")");
							}
						}
					}
				}
	...
	private void getConfigAssoPropsResult(String viewCode, List<MESBasicObjEquipment> result) {
		getConfigAssoPropsResult(viewCode, null, result);
	}
	
	private void getConfigAssoPropsResult(String viewCode,String dataGridCode, List<MESBasicObjEquipment> result) {
		View view = null;
		...
		Map<Long, MESBasicObjEquipment> rsMap = new HashMap<Long, MESBasicObjEquipment>();
		for (MESBasicObjEquipment objEquipment : result) {
			ids.add(objEquipment.getId());
			rsMap.put(objEquipment.getId(), objEquipment);
		}
		for (Field f : fields) {
					...
					if (configMap != null && configMap.size() > 0) {
						...
						for (int index = 0; index < configList.size(); index++) {
							...
							for (int i = 0; i < count; i++) {
								rs.addAll(objEquipmentDao.createNativeQuery(sql)
	...
	private Property findAssoProperty(String origModelCode, String assoModelCode) {
		...
		List<Property> list = objEquipmentDao.findByHql(hql, new Object[] {origModelCode, assoModelCode, Property.ONE_TO_ONE, Property.MANY_TO_ONE});
		return list.get(0);
	}
	...
	public List<Object[]> mneCodeSearch( String viewCode,  int showNumber, boolean cross, List<Param> params,String refViewCode,String currentViewCode,String sqlType,String realPermissionCode){
		...
		if (null != sql && sql.length() > 0) {
				...
				if(needPermission)  {
					if(null == refView ){
						...
						if(null == layoutView  || !(layoutView.getIsPermission() && layoutView.getPermissionCode().trim().length() > 0)){
							...
							powerCode = "MESBasic_1_factoryModel_ObjEquipment" + "_" + layoutView.getPermissionCode();
							searchRefView=true;
						}
						if(null == layoutView)  {
							layoutView = getLayoutView(permissionCode);
						...
						powerCode ="MESBasic_1_factoryModel_ObjEquipment" + "_" + refView.getPermissionCode();
						searchRefView=true;
					}
					String powerCodeSql = "select m.code as code from base_MenuOperate m where m.code = ? and m.valid = 1";
					List<Object> powerCodeList =  objEquipmentDao.createNativeQuery(powerCodeSql, powerCode).list();
					if(powerCodeList.size() > 0) {
						...
						powerSql  = dataPermissionService.getBaseModelPowerCondition(this.creatorService.getStaffFromSession().getUser(), powerCode, "\"objEquipment\"","MESBasic_1_factoryModel","","MESBASIC_OBJ_EQUIPMENTS",false);
					//if(!searchRefView&&refView.getAssModel().getEntity().getWorkflowEnabled())  {
						//查询主列表视图的权限(表单类型)
						//	sb.append(" INNER JOIN WF_PENDING \"p\" ON \"p\".TABLE_INFO_ID=\"objEquipment\".TABLE_INFO_ID ");
						//	sb.append(" WHERE  \"objEquipment\".STATUS <> 0  ");
					//}
					//powerSql = dataPermissionService.getBaseModelPowerCondition(this.creatorService.getStaffFromSession().getUser(), powerCode, "\"objEquipment\"","MESBasic_1_factoryModel","","MESBASIC_OBJ_EQUIPMENTS",false);
					if(sb.length()>0) {
						sb.append(" AND ");
				...
				if(currentViewCode!=null&&currentViewCode.trim().length()>0)  {
					...
					if(view.getType() == ViewType.REFERENCE || view.getType() == ViewType.REFTREE){
						...
						if(view.getShowType().equals(ShowType.PART)){
							...
							if(view.getIsPermission() && view.getPermissionCode().trim().length() > 0){
								powerCode = "MESBasic_1_factoryModel_ObjEquipment" + "_" + view.getPermissionCode();
							}else {
								needPermission=false;
							}
						}
			...
			mnecodeSql.append("  (\"").append("objEquipment.mc\"").append(".MNE_CODE) like (?) escape '&' AND \"objEquipment\".VALID = 1");
			...
			if(!cross){
				if(isSingleMode){
					mnecodeSql.append(" AND \"objEquipment\".CID = ?");
					totalValues.add(getCurrentCompanyId());
				}else{
					//当前公司不是集团情况下查询集团和本公司数据
					if(!getCurrentCompanyId().equals(1L)){
						mnecodeSql.append(" AND (\"objEquipment\".CID = 1 OR \"objEquipment\".CID = ?)");
						totalValues.add(getCurrentCompanyId());
					}
				}
			}
			...
			if(notinValue != null){
				mnecodeSql.append(" and (\"").append("objEquipment.mc\"").append(".OBJ_EQUIPMENT) not in ("+notinValue+")");
			}
			
			SQLQuery query = objEquipmentDao.createNativeQuery(mnecodeSql.toString(), totalValues.toArray(new Object[]{}));
	...
	public String getWorkFlowInfo(String menuCode) {
		...
		SQLQuery query=objEquipmentDao.createNativeQuery(sql, menuCode);
	...
	protected String getEntityCode(){return MESBasicObjEquipment.ENTITY_CODE;}
	protected String getModuleCode(){return MESBasicObjEquipment.MODULE_CODE;}
	protected String getModelCode(){return MESBasicObjEquipment.MODEL_CODE;}
	
	
	/**
	 * 检查模型字段的唯一性约束
	 * @param objEquipment 模型实例
	 */
	public void checkUniqueConstraint(MESBasicObjEquipment objEquipment){
	}
	
	
	@Override
	public List<MESBasicObjEquipment> getObjEquipments(String sql, List<Object> params) {
		DetachedCriteria detachedCriteria = DetachedCriteria.forClass(MESBasicObjEquipment.class);
		if(params!=null){
			...
			return objEquipmentDao.findByHql("from " + MESBasicObjEquipment.JPA_NAME + " " + ((sql==null || sql.isEmpty()) ? "" : "where " + sql)) ;
		}
		return objEquipmentDao.findByCriteria(detachedCriteria);
	}
	
	
	
	@Override
	public List<MESBasicObjEquipment> findObjEquipmentsBySql(String sql, List<Object> params){
		DetachedCriteria detachedCriteria = DetachedCriteria.forClass(MESBasicObjEquipment.class);
	...
	@Override
	public List<MESBasicObjEquipment> findObjEquipmentsByHql(String hql, Object... objects){
		
		return   objEquipmentDao.findByHql(hql, objects);
	}
	
	@Override
	public MESBasicObjEquipment loadObjEquipmentByBussinessKey(MESBasicObjEquipment objEquipment){
		return loadObjEquipmentByBussinessKey(objEquipment.getId());
	}
	
	@Override
	public Page<MESBasicObjEquipment> getObjEquipments(Page<MESBasicObjEquipment> page, String sql, List<Object> params, String sort) {
		DetachedCriteria detachedCriteria = DetachedCriteria.forClass(MESBasicObjEquipment.class);
		...
		if(params!=null){
			...
			if(sql!=null){
				page = objEquipmentDao.findByPage(page, sql);
			}else{
				page = objEquipmentDao.findAllByPage(page);
			}
			return page;
		}
		page = objEquipmentDao.findByPage(page, detachedCriteria);
		return page;
	}
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public List<MESBasicObjEquipment> findByTreeDataGridFactoryModel(List<MESBasicObjEquipment> treeList){
		if(null != treeList && !treeList.isEmpty()){
			for(MESBasicObjEquipment objEquipment : treeList){
			}
		}
		return treeList;
	}
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public void findByNormalDataGridFactoryModel(Page<MESBasicObjEquipment> dgPage){
		if(null != dgPage && null != dgPage.getResult()){
			List<MESBasicObjEquipment> objEquipments = dgPage.getResult();
			for(MESBasicObjEquipment objEquipment : objEquipments){
				
			}
			dgPage.setResult(objEquipments);
		}
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public MESBasicObjEquipment loadObjEquipmentByBussinessKey(Serializable bussinessKey){
		return objEquipmentDao.findEntityByCriteria(Restrictions.eq("id", Long.valueOf(bussinessKey.toString())),Restrictions.eq("valid", true));
	}
	
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public List<MESBasicObjEquipment> findByProperty(String propertyName, Object object){
		return objEquipmentDao.findByProperty(propertyName, object);
	}
	
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public MESBasicObjEquipment findEntityByProperty(String propertyName, Object object){
		return objEquipmentDao.findEntityByProperty(propertyName, object);
	}
	...
	public void deleteByBussinessKeys(String bussinessKeys){
		if(null != bussinessKeys && bussinessKeys.trim().length() > 0){
			...
			String sql = "update " + MESBasicObjEquipment.JPA_NAME + " set valid=0 where id in (:businessKeys)";
			Query query = objEquipmentDao.createQuery(sql);
	...
	public String findValidateDatagrids(Map<String,Class> dgClassMap){
		...
		List<View> dgviews = viewServiceFoundation.findViewsByAssModelCode("MESBasic_1_factoryModel_ObjEquipment","runtime");
		try {
	...
	public void dealDatagridsSave(MESBasicObjEquipment objEquipment,String viewCode,Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads){
			...
			try {
				for(DataGrid dg:dgs){
					...
					if(dgLists!=null&&dgLists.get(dg.getName())!=null){
						...
						List dglist=(List)com.supcon.orchid.ec.utils.JSONUtil.generateObjectFromJson(dgLists.get(dg.getName()).replaceAll("\r\n", "\\\\r\\\\n"), _reflect_dgclass,objEquipmentDao.getSessionFactory());
						java.lang.reflect.Method _reflect_setMethod=_reflect_dgclass.getMethod("set"+fLTU(dg.getOrgProperty().getName()), MESBasicObjEquipment.class);
						...
						for(Object odg:dglist){
							_reflect_setMethod.invoke(odg, objEquipment);
							...
							if(!paramMap.isEmpty()){
								...
								paramMap.put("mainModelId",objEquipment.getId());	
	...
	public List<Object> getBusinessKeyData(String businessKeyName){
		...
		if(null != businessKeyName){
			String sql = "select " + businessKeyName +" from "+ MESBasicObjEquipment.TABLE_NAME +" where valid = 1";
			list = objEquipmentDao.createNativeQuery(sql).list();
		}
		return list;
	}
	...
	public List<Object> getBusinessKeyDataByBusinessKeyName(String businessKeyName){
		List<Object> list = new ArrayList<Object>();
		if(null != businessKeyName){
			String sql = "select " + businessKeyName +" from "+ MESBasicObjEquipment.TABLE_NAME;
			list = objEquipmentDao.createNativeQuery(sql).list();
		}
		return list;
	}
	...
	public Map<Object, Object> getReplaceProperty(String propertyName,String businessKey){
		...
		if(null != propertyName && null != businessKey){
			String sql = "select " + businessKey + "," + propertyName +" from "+ MESBasicObjEquipment.TABLE_NAME +" group by " + propertyName + "," + businessKey;
			list = objEquipmentDao.createNativeQuery(sql).list();
		}
		if (list != null && !list.isEmpty()) {
			for (Object[] obj : list) {
	...
	@Autowired
	private MESBasicObjEquipmentDaoImpl objEquipmentDaoImpl;
	
	
	@Override
	@Transactional(propagation = Propagation.SUPPORTS)
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment",desc="foundation.import.bussiness.info",operType="5")
	public Map<Object, Long> importBatchObjEquipment(final List<MESBasicObjEquipment> insertObjs, final List<MESBasicObjEquipment> updateObjs, 
				List<Map<String,String>> columnInfo, Map<String ,List<Map<String, Object>>> importNodeInfo, Map<String, Property> importPropInfo){
		return this.importBatchObjEquipment(insertObjs, updateObjs, columnInfo, importNodeInfo, importPropInfo,null);		
	}
	...
	public Map<Object, Long> importBatchObjEquipment(final List<MESBasicObjEquipment> insertObjs, final List<MESBasicObjEquipment> updateObjs, 
		...
		AuditUtil.setAuditDes(InternationalResource.get("foundation.import.bussiness.info.args",null,InternationalResource.get("MESBasic.modelname.randon1460950269640"),importCount));
		...
		Map<Long, MESBasicObjEquipment> oldUpdateObjsMap = new HashMap<Long, MESBasicObjEquipment>(); 
		List<Long> updateObjIdsList = new ArrayList<Long>();
		for(int updateIndex = 0; updateIndex < updateObjs.size(); updateIndex++)  {
			MESBasicObjEquipment bizObj = updateObjs.get(updateIndex);
		...
		if (updateObjIdsList.size() > 0) {
			...
			List<MESBasicObjEquipment> bizObjList = objEquipmentDao.findByCriteria(detachedCriteria);
			if (null != bizObjList) {
				for (int mIndex = 0; mIndex < bizObjList.size(); mIndex++) {
					MESBasicObjEquipment bizObj = bizObjList.get(mIndex);
		...
		final List<MESBasicObjEquipment> nmeObjs = new ArrayList<MESBasicObjEquipment>();
		...
		long id=autoGeneratorID.getNextId(MESBasicObjEquipment.TABLE_NAME,expLength,dbId);//id表只操作一次，实际id通过++来增长
		for(MESBasicObjEquipment objEquipment:insertObjs)  {
			//id = autoGeneratorID.getNextId(MESBasicObjEquipment.TABLE_NAME,1,dbId);
			if(objEquipment.getId() != null ){
				m.put(objEquipment.getId(), id);
			}else{
				m.put(id, id);
			}
			insertIds.add(id);
		...
		for(Map<String,String> map : columnMaps){
			if(map.get("type").equals("SYSTEMCODE")){
				...
				Object[] result = (Object[]) objEquipmentDao.createNativeQuery(sql, "MESBasic_1_factoryModel_ObjEquipment"+"_"+map.get("name")).uniqueResult();
				map.put("isSenior", result[0].toString());
				//map.put("multable", result[1].toString());
			}
		}
		
		objEquipmentDaoImpl.getSession().doWork(new Work() {
			@Override
			public void execute(Connection conn) throws SQLException {
				...
				if(updateObjs != null && updateObjs.size()>0){
					...
					String updateSql = "UPDATE " + MESBasicObjEquipment.TABLE_NAME + " SET ";
					...
					for(int updateIndex =0;updateIndex<updateObjs.size();updateIndex++){
						MESBasicObjEquipment objEquipment = updateObjs.get(updateIndex);
						Long id = objEquipment.getId();
						if(null != id){
							updateps.setLong(columnMaps.size()+1,id);
							for(int i=0;i<columnMaps.size();i++){
								Method method = null;
								try {
									method = objEquipment.getClass().getMethod(updateMethods.get(i));
								...
								if(null != method){
									try {
										obj = method.invoke(objEquipment);
				...
				if(insertObjs != null && insertObjs.size()>0){//新增
					...
					String insertSql = "INSERT INTO " + MESBasicObjEquipment.TABLE_NAME + " (";
					for(int i = 0;i<columnMaps.size();i++){
						String mName = columnMaps.get(i).get("name");
						String methodName = "get"+ mName.replaceFirst(mName.substring(0, 1), mName.substring(0, 1).toUpperCase());
...
//					String idSql = "select id from " + MESBasicObjEquipment.TABLE_NAME + " order by id desc";
//					Query query = objEquipmentDao.createNativeQuery(idSql).setMaxResults(1);
...
//					}
					...
					for(int insertIndex = 0; insertIndex<insertObjs.size(); insertIndex++)  {
						MESBasicObjEquipment objEquipment = insertObjs.get(insertIndex);
						...
						for (int i = 0; i < columnMaps.size(); i++) {
							Method method = null;
							try {
								method = objEquipment.getClass().getMethod(
										insertMethods.get(i));
							} catch (NoSuchMethodException | SecurityException e) {
								log.error(e.getMessage(),e);
							}
		...
		objEquipmentDaoImpl.getSession().flush();
		objEquipmentDaoImpl.getSession().clear();
		
		
		//记录导入数据日志（区分新增和修改）
		
		for(int insertIndex = 0; insertIndex < insertObjs.size(); insertIndex++)  {//新增
			MESBasicObjEquipment bizObj = insertObjs.get(insertIndex);
			objEquipmentImportService.saveImportDataLog(bizObj, null, "id", "id");
		}
		for(int updateIndex = 0; updateIndex < updateObjs.size(); updateIndex++)  {//修改
			MESBasicObjEquipment bizObj = updateObjs.get(updateIndex);
			MESBasicObjEquipment oldBizObj = oldUpdateObjsMap.get(bizObj.getId());
			objEquipmentImportService.saveImportDataLog(bizObj, oldBizObj, "id", "id");
		}
	...
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	//excel辅模型查询
	public void excelAuxModelQuery(Page<MESBasicObjEquipment> page,  String viewCode, int type, String processKey,
	...
	@SuppressWarnings("unchecked")
	private void auxModelQuery(Page<MESBasicObjEquipment> page, String viewCode, int type, String processKey, Boolean flowBulkFlag,
...
//				}
			...
			if (page.needCount()) {
				...
				Long count = 0l;
			    Map<String, BigDecimal> resultTotals = new HashMap<String, BigDecimal>();
			    List<Map<String, Object>> resultCountList = (List<Map<String, Object>>) objEquipmentDao.createNativeQuery(countSql, arr)
					.setResultTransformer(Transformers.ALIAS_TO_ENTITY_MAP).list();
			    if (null != resultCountList && !resultCountList.isEmpty()) {
					Map<String, Object> resultCounts = resultCountList.get(0);
					for (Map.Entry<String, Object> entry : resultCounts.entrySet()) {
			...
			if(!noQueryFlag)  {
				...
				modelServiceFoundation.initCacheData();*/
				List<MESBasicObjEquipment> result = getResult(page, query, new PendingResultTransformer(MESBasicObjEquipment.class,objEquipmentDao,maps));
				
				List<Map> propList = page.getProperties();
				for(Map m : propList){
					if(m.get("isCustom") != null && m.get("isCustom").equals("true") && m.get("columntype").equals("SYSTEMCODE") ){
						for(MESBasicObjEquipment model : result){
	...
	private String getDbIdName(){
		...
		String dbIDName = objEquipmentDao.createNativeQuery(sql, "MESBasic_1_factoryModel_ObjEquipment").uniqueResult().toString();
		return dbIDName;
	}
	...
	public List<String> getSystemCodeFullPathNameByEntityCode(String entityCode) {
		...
		List<String> strs = objEquipmentDao.createNativeQuery(sql, entityCode).list();
		return strs;
	}
	...
	public List<String> getRunningCustomProperties(String entityCode){
		...
		list = objEquipmentDao.createNativeQuery(sql, entityCode).list();
		return list;
	}
	...
	public String getAssProperty(String propertyCode){
		...
		assProperty = objEquipmentDao.createNativeQuery(sql,propertyCode).uniqueResult()!=null?objEquipmentDao.createNativeQuery(sql,propertyCode).uniqueResult().toString():"";
		return assProperty;
	}		
	...
	public String getPropertyModelCode(String propertyCode){
		...
		String modelCode =  objEquipmentDao.createNativeQuery(sql,propertyCode).uniqueResult().toString();
		return modelCode;
	}
	@Override
	@Transactional(propagation = Propagation.SUPPORTS)
	public  Object generateObjectFromJson(String jsonStr, Class clazz){
		return com.supcon.orchid.ec.utils.JSONUtil.generateObjectFromJson(jsonStr,clazz,objEquipmentDao.getSessionFactory());
	}
	...
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment",desc="ec.flow.save")
	public void saveObjEquipment(MESBasicObjEquipment objEquipment, DataGridService dataGridService){
		saveObjEquipment(objEquipment, dataGridService, null);
	}
	
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment",desc="ec.flow.save")
	public void saveObjEquipment(MESBasicObjEquipment objEquipment, DataGridService dataGridService, String viewCode){
		saveObjEquipment(objEquipment, dataGridService, viewCode, null);
	}
	
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment")
	public void saveObjEquipment(MESBasicObjEquipment objEquipment, DataGridService dataGridService, String viewCode, String eventTopic, boolean... isImport){
		this.saveObjEquipment(objEquipment, dataGridService, viewCode, eventTopic,null,isImport);
	}
	
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment")
	public void saveObjEquipment(MESBasicObjEquipment objEquipment, DataGridService dataGridService, String viewCode, String eventTopic,SignatureLog signatureLog, boolean... isImport){
		boolean isNew = false;
		String entityCode = "MESBasic_1_factoryModel";
		Map<String, Object> props = new HashMap<String, Object>();
		props.put("callType", "service");
		props.put("entityCode", "MESBasic_1_factoryModel");
		String url = null;
		if(null != objEquipment.getId() && objEquipment.getId() > 0){
			if(StringUtils.isEmpty(AuditUtil.getColumnStringD()) || MESBasicObjEquipment.MODEL_CODE.equals(AuditUtil.getColumnStringD())){
				AuditUtil.setAuditDes("ec.pending.edit");
				AuditUtil.setAuditOperationType("2");
			}
	...
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment")
	public Map<Object, Object> objEquipmentDataGridImport(MESBasicObjEquipment objEquipment, DataGridService dataGridService, String viewCode, String eventTopic,Property businessKey, boolean isImport){
		...
		String virturalId = objEquipment.getVirtualId();
		
		objEquipment = objEquipmentDao.load(objEquipment.getId());
		
		if(virturalId != null && virturalId.length() > 0){
			map.put(virturalId, objEquipment.getId());
		}else{
			String methodName = "get" + businessKey.getName().substring(0, 1).toUpperCase() + businessKey.getName().substring(1);
			Object bkValue = null;
			try {
				Method getBkValue = objEquipment.getClass().getMethod(methodName);
				bkValue = getBkValue.invoke(objEquipment);
			} catch (NoSuchMethodException | SecurityException | IllegalAccessException | IllegalArgumentException | InvocationTargetException e) {
				log.error(e.getMessage(), e);
			}
			map.put(bkValue, objEquipment.getId());
		}
	...
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment")
	public void mergeObjEquipment(MESBasicObjEquipment objEquipment, DataGridService dataGridService){
		ReflectUtils.filterObjectIdIsNVL(objEquipment);
		beforeSaveObjEquipment(objEquipment);
		objEquipmentDao.merge(objEquipment);
	 ...
	 */
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment",desc="foundation.common.exportExcel",operType="11")
	 ...
	 */
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment",desc="ec.print.page.print",operType="4")
	...
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjEquipment",desc="foundation.batch.save",operType="4")
	public void batchSaveObjEquipment(MESBasicObjEquipment objEquipment, DataGridService dataGridService,View view,List<Event>  events, String eventTopic, boolean... isImport){
		String entityCode = "MESBasic_1_factoryModel";
		Map<String, Object> props = new HashMap<String, Object>();
		props.put("callType", "service");
		props.put("entityCode", "MESBasic_1_factoryModel");
	...
	@Override
	public Page<MESBasicObjEquipment> getByPage(Page<MESBasicObjEquipment> page,DetachedCriteria detachedCriteria){
		return objEquipmentDao.findByPage(page, detachedCriteria);
	}
	...
	private void beforeSaveObjEquipment(MESBasicObjEquipment objEquipment, Object... objects){
		checkUniqueConstraint(objEquipment);
	/* CUSTOM CODE START(serviceimpl,beforeSave,MESBasic_1_factoryModel_ObjEquipment,MESBasic_1) */
// 自定义代码
		objEquipmentDao.flush();
		objEquipmentDao.clear();
		...
		detachedCriteria.add(Restrictions.eq("objEqu",objEquipment.getObjEqu()));
	    if(objEquipment.getId()!=null){//修改
	    	detachedCriteria.add(Restrictions.ne("id",objEquipment.getId()));
	    }
	    List<MESBasicObjEquipment> basicObjEquipments = objEquipmentDao.findByCriteria(detachedCriteria);
		
		if (null !=basicObjEquipments && !basicObjEquipments.isEmpty()){
			String equNames="";
          	String factoryName="";
			for (MESBasicObjEquipment basicObjEquipment : basicObjEquipments){
				if (null !=basicObjEquipment){
					MESBasicEquipment tempEqument=equipmentDao.load(basicObjEquipment.getObjEqu().getId());
                  if(basicObjEquipment.getObjFactory().getId().equals(objEquipment.getObjFactory().getId())){
						throw new BAPException("设备["+tempEqument.getName()+"]已存在于本模型中，不能重复添加！");
					}
					if(equNames.length()>0){
						equNames+="，"+tempEqument.getName();
                     	factoryName+=","+basicObjEquipment.getObjFactory().getName();
					}else{
						equNames=tempEqument.getName();
                     	factoryName=basicObjEquipment.getObjFactory().getName();
					}
			...
			if(equNames.length()>0){
				throw new BAPException("设备["+equNames+"]已分别存在于["+factoryName+"]模型中，不能重复添加！");
			}
		}
		
		//处理工厂模型与设备的关联关系
		if (null != objEquipment && null !=objEquipment.getObjEqu()) {
			String oldId = objEquipment.getEqus();
			if(null != oldId && oldId.trim().length() > 0){//修改
				if(objEquipment.getObjEqu().getId().longValue()!= Long.parseLong(oldId)){//关联设备改变
					objEquipment.setEqus(objEquipment.getObjEqu().getId().toString());
					
					List<MESBasicEquipment> equment = equipmentDao.findByCriteria(Restrictions.eq("valid", true),
							Restrictions.eq("id", Long.parseLong(oldId)));
					for (MESBasicEquipment equments : equment) {
						if (null != equments) {
							equments.setWorkcenter(objEquipment.getObjFactory());
							equipmentDao.save(equments);
						}
					}
					/*List<MESBasicEquipment> newequ = equipmentDao.findByCriteria(Restrictions.eq("valid", true),
							Restrictions.eq("id", Long.parseLong(objEquipment.getEqus())));
					for (MESBasicEquipment newequs : newequ) {
						newequs.setWorkcenter(objEquipment.getObjFactory());
						equipmentDao.save(newequs);
					}*/
				}
			} else {//新增
				// 查询当前设备是否已关联工厂模型
				List<MESBasicEquipment> equ = equipmentDao.findByCriteria(Restrictions.eq("valid", true),
						Restrictions.eq("id", objEquipment.getObjEqu().getId()));
				for (MESBasicEquipment objequs : equ) {
					objEquipment.setEqus(objEquipment.getObjEqu().getId().toString());//
					List<MESBasicEquipment> equment = equipmentDao.findByCriteria(Restrictions.eq("valid", true),
							Restrictions.eq("id", objEquipment.getObjEqu().getId()));
					for (MESBasicEquipment equments : equment) {
						if (null != equ && !equ.isEmpty()) {
							equments.setWorkcenter(objEquipment.getObjFactory());
							equipmentDao.save(equments);
						}
					}
		   ...
		   //如果在辅模型中清空设备，那么取冗余字段
		else if (null != objEquipment && null ==objEquipment.getObjEqu()&& null!=objEquipment.getEqus()){
			
			List<MESBasicEquipment> equ = equipmentDao.findByCriteria(Restrictions.eq("valid", true),
					Restrictions.eq("id", Long.parseLong(objEquipment.getEqus())));
			
			for (MESBasicEquipment equs:equ){
				if(null !=equ && equs.getId().toString().equals(objEquipment.getEqus())){
					equs.setWorkcenter(null);
					equipmentDao.save(equs);
					objEquipmentDao.deletePhysical(objEquipment);

				}
				else {
					equs.setWorkcenter(objEquipment.getObjFactory());
					equipmentDao.save(equs);
				}
			}
		}
		...
		if(objEquipment.getId() != null && objEquipment.getId() > 0){
			isNewObjEquipment = false;
		}
		
		//如果上载批控且不是新增
		if(factoryModelService.getBatchMode()!=null && factoryModelService.getBatchMode().size() > 0 && objEquipment.getId() != null){
			List<Object> objs = factoryModelService.checkObjEquIsUsedByProRootSet(objEquipment.getId().toString());
			if(objs != null && objs.size() > 0){
				MESBasicObjEquipment objEquipmentOld = objEquipmentDao.load(objEquipment.getId());
				if( (((objEquipmentOld.getClearType() == null && objEquipment.getClearType() != null) || (objEquipmentOld.getClearType() != null && objEquipment.getClearType() == null ) || 
						(objEquipmentOld.getClearType() != null && objEquipment.getClearType() != null && !objEquipmentOld.getClearType().getId().equals(objEquipment.getClearType().getId()))) 
						|| ((objEquipmentOld.getClearItem() == null && objEquipment.getClearItem() != null) || (objEquipmentOld.getClearItem() != null && objEquipment.getClearItem() == null ) || 
								(objEquipmentOld.getClearItem() != null && objEquipment.getClearItem() != null && objEquipmentOld.getClearItem().getId().longValue() != objEquipment.getClearItem().getId().longValue())))){
					StringBuilder errorMsm = new StringBuilder("");
					for(Object o : objs){
						errorMsm.append(o.toString());
						errorMsm.append(",");
					}
					throw new BAPException("设备已被【"+errorMsm.toString().substring(0, errorMsm.length()-1)+"】工艺路线引用，不能修改清空类型与清空位号");
				}
			}	
		}
/* CUSTOM CODE END */
	...
	private void afterSaveObjEquipment(MESBasicObjEquipment objEquipment, Object... objects){
	/* CUSTOM CODE START(serviceimpl,afterSave,MESBasic_1_factoryModel_ObjEquipment,MESBasic_1) */
// 自定义代码
		//如果上载批控
		if(factoryModelService.getBatchMode()!=null && factoryModelService.getBatchMode().size() > 0 ){
			//新增行，则新增清空信号表
			if(isNewObjEquipment && objEquipment.getClearItem() != null){
				MESBasicClearSinget clearSinget = new MESBasicClearSinget();
				clearSinget.setClearSinget(objEquipment.getClearType());
				clearSinget.setSinget(objEquipment.getClearItem());
				clearSinget.setToEquipment(objEquipment);
				clearSingetDao.save(clearSinget);
			}
			
			//如果是修改行
			if(!isNewObjEquipment){
				MESBasicClearSinget clearSinget =  clearSingetDao.findEntityByCriteria(Restrictions.eq("toEquipment", objEquipment),Restrictions.eq("valid", true));
				
				//修改时新增了清空信号
				if(clearSinget == null && objEquipment.getClearItem() != null){
					clearSinget =  new MESBasicClearSinget();
					clearSinget.setClearSinget(objEquipment.getClearType());
					clearSinget.setSinget(objEquipment.getClearItem());
					clearSinget.setToEquipment(objEquipment);
					clearSingetDao.save(clearSinget);
				...
				//修改时修改了清空信号,不管修没修改都走一下，反正不会错，但是效率不是最好的
				if(clearSinget != null && objEquipment.getClearItem() != null){
					clearSinget.setClearSinget(objEquipment.getClearType());
					clearSinget.setSinget(objEquipment.getClearItem());
					clearSinget.setToEquipment(objEquipment);
				...
				//修改时删除了清空信号,删除对应的清空信号表
				if(clearSinget != null && objEquipment.getClearItem() == null){
					clearSingetDao.delete(clearSinget.getId());
				}
			}
...
/* CUSTOM CODE END */
	...
	@Override
	public void beforeExcelImportObjEquipment(List<MESBasicObjEquipment> objEquipments, Map<String, Map<Integer, Map<Integer, String>>> errors){
	/* CUSTOM CODE START(serviceimpl,beforeExcelImport,MESBasic_1_factoryModel_ObjEquipment,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	@Override
	public void afterExcelImportObjEquipment(List<MESBasicObjEquipment> objEquipments){
	/* CUSTOM CODE START(serviceimpl,afterExcelImport,MESBasic_1_factoryModel_ObjEquipment,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	@Override
	public void beforeExcelBatchImportObjEquipment(List<MESBasicObjEquipment> objEquipments, Map<Integer, Map<Integer, String>> errors){
	/* CUSTOM CODE START(serviceimpl,beforeExcelBatchImport,MESBasic_1_factoryModel_ObjEquipment,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */	
	...
	@Override
	public void afterExcelBatchImportObjEquipment(List<MESBasicObjEquipment> objEquipments){
	/* CUSTOM CODE START(serviceimpl,afterExcelBatchImport,MESBasic_1_factoryModel_ObjEquipment,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */	
	}
	
	private void beforeDeleteObjEquipment(MESBasicObjEquipment objEquipment){
	/* CUSTOM CODE START(serviceimpl,beforeDelete,MESBasic_1_factoryModel_ObjEquipment,MESBasic_1) */
// 自定义代码
		if(!bapBaseService.canDelete(objEquipment)){//bapBaseService 每个impl实现类里面都已经定义了,直接使用
		    throw new BAPException("设备【" + objEquipment.getEquipmentNum() + "】不能被删除");
		}
/* CUSTOM CODE END */
	}
	
	private void afterDeleteObjEquipment(MESBasicObjEquipment objEquipment){
	/* CUSTOM CODE START(serviceimpl,afterDelete,MESBasic_1_factoryModel_ObjEquipment,MESBasic_1) */
//删除工厂模型与设备关系后，将设备表中相关设备的workcenter字段值改为null
		if(null != objEquipment && null != objEquipment.getObjEqu()){
			String sql = "update " + MESBasicEquipment.TABLE_NAME + " set workcenter=null where EAM_ID=? and workcenter=?";
			SQLQuery query = equipmentDao.createNativeQuery(sql, objEquipment.getObjEqu(),objEquipment.getObjFactory());
			query.executeUpdate();
		}
...
/* CUSTOM CODE END */
	...
	private void beforeRestoreObjEquipment(MESBasicObjEquipment objEquipment){
	/* CUSTOM CODE START(serviceimpl,beforeRestore,MESBasic_1_factoryModel_ObjEquipment,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	
	private void afterRestoreObjEquipment(MESBasicObjEquipment objEquipment){
	/* CUSTOM CODE START(serviceimpl,afterRestore,MESBasic_1_factoryModel_ObjEquipment,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	
	private void customGenerateCodes(MESBasicObjEquipment objEquipment, Object... objects) {
		/* CUSTOM CODE START(serviceimpl,customGenerateCodes,MESBasic_1_factoryModel_ObjEquipment,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	private void customGenerateSummarys(MESBasicObjEquipment objEquipment, Object... objects) {
		/* CUSTOM CODE START(serviceimpl,customGenerateCodes,MESBasic_1_factoryModel_ObjEquipment,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	/* CUSTOM CODE START(serviceimpl,beforeServiceDestroy,MESBasic_1_factoryModel_ObjEquipment,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	private void beforeInitBean(){
		/* CUSTOM CODE START(serviceimpl,beforeInitBean,MESBasic_1_factoryModel_ObjEquipment,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	private void afterInitBean(){
		/* CUSTOM CODE START(serviceimpl,afterInitBean,MESBasic_1_factoryModel_ObjEquipment,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	@Override
	public void beforeImportObjEquipment(List<MESBasicObjEquipment> insertObjs, List<MESBasicObjEquipment> updateObjs, 
		...
		/* CUSTOM CODE START(serviceimpl,beforeImportObjEquipment,MESBasic_1_factoryModel_ObjEquipment,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	@Override
	public void afterImportObjEquipment(List<MESBasicObjEquipment> insertObjs, List<MESBasicObjEquipment> updateObjs, 
		...
		/* CUSTOM CODE START(serviceimpl,afterImportObjEquipment,MESBasic_1_factoryModel_ObjEquipment,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	/* CUSTOM CODE START(serviceimpl,functions,MESBasic_1_factoryModel_ObjEquipment,MESBasic_1) */
// 自定义代码
	Boolean isNewObjEquipment = true;
/* CUSTOM CODE END */
}
