...
@Repository
public class MESBasicFacWareMaterialDaoImpl extends ExtendedGenericDaoImpl<MESBasicFacWareMaterial, Long> implements MESBasicFacWareMaterialDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_factoryWare_FacWareMaterial,MESBasic_1) */
// 自定义代码
