...
@Repository
public class MESBasicFunctionInfoDaoImpl extends ExtendedGenericDaoImpl<MESBasicFunctionInfo, Long> implements MESBasicFunctionInfoDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_container_FunctionInfo,MESBasic_1) */
// 自定义代码
