...
@Service("mESBasicCustomerMaterialImportService")
public class MESBasicCustomerMaterialImportServiceImpl implements MESBasicCustomerMaterialImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_customerMaterial",model="MESBasic_1_customerMaterial_CustomerMaterial",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicCustomerMaterial bizObj, MESBasicCustomerMaterial oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.randon1559177139201") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.randon1559177139201") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicCustomerMaterial bizObj, String bussinesskeyFieldName,
