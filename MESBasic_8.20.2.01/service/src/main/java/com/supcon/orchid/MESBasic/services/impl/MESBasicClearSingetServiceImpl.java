...
import com.supcon.orchid.MESBasic.services.MESBasicClearSingetImportService;
...
import com.supcon.orchid.workflow.engine.transformers.PendingResultTransformer;
import com.supcon.orchid.MESBasic.daos.impl.MESBasicClearSingetDaoImpl;
import java.lang.reflect.Method;
...
/* CUSTOM CODE START(serviceimpl,import,MESBasic_1_clearSinget_ClearSinget,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */

@Service("mESBasic_clearSingetService")
@Transactional
public class MESBasicClearSingetServiceImpl  extends BaseServiceImpl<MESBasicClearSinget> implements MESBasicClearSingetService, InitializingBean, DisposableBean {
	...
	@Resource
	private IBAPBaseService<MESBasicClearSinget> bapBaseService;
	...
	@Autowired
	private MESBasicClearSingetImportService clearSingetImportService;
	/**
	 * 根据主显示字段列表获取Map
	...
	public Map<String, Object> getMainDisplayMap(Serializable mainDisplayName, Serializable businessKeyName,List<Serializable> mainDisplayKeys) {
		String hql = "select " + mainDisplayName + ",id,"+ businessKeyName + " from " + MESBasicClearSinget.JPA_NAME + " where " + mainDisplayName + " in (:mainDisplayKeys)"  + "and VALID = 1";
		Query query =  clearSingetDao.createQuery(hql);
	...
	public Map<Serializable,Serializable> getBusinessKeyMap(Serializable businessKeyName,List<Serializable> businessKeys){
		if(businessKeyName!=null && String.valueOf(businessKeyName).length() > 0){
			String hql = "select " + businessKeyName + ",id from " + MESBasicClearSinget.JPA_NAME + " where " + businessKeyName + " in (:businessKeys)";
			Query query = clearSingetDao.createQuery(hql);
	...
	*/
	...
	public Map<String, Object> getParentNodeMap(Serializable mainDisplayName, Serializable businessKeyName, List<Serializable> serial, String queryParam) {
		...
		if(queryParam!=null && queryParam.equals("md")){
			hql = "select " + mainDisplayName + ",id,"+ businessKeyName + ",fullPathName,layNo,layRec,parentId,leaf from " + MESBasicClearSinget.JPA_NAME + " where " + mainDisplayName + " in (:serial)";
		}else if(queryParam!=null && queryParam.equals("bk")){
			hql = "select " + mainDisplayName + ",id,"+ businessKeyName + ",fullPathName,layNo,layRec,parentId,leaf from " + MESBasicClearSinget.JPA_NAME + " where " + businessKeyName + " in (:serial)";
		}
		Query query =  clearSingetDao.createQuery(hql);
		...
		/*String sql = null;
		if(queryParam!=null && queryParam.equals("md")){
			sql = "select * from " + MESBasicClearSinget.TABLE_NAME + " where " + mainDisplayName + " = ?";
		}else if(queryParam!=null && queryParam.equals("bk")){
			sql = "select * from " + MESBasicClearSinget.TABLE_NAME + " where " + businessKeyName + " = ?";
		}
		List<MESBasicClearSinget> list = (List<MESBasicClearSinget>) clearSingetDao.createNativeQuery(sql,serial.get(0)).list();
		*/
		Map<String, Object> m = new HashMap<String, Object>();
		if(queryParam!=null && queryParam.equals("md")){
			m.put("count", list.size());
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public MESBasicClearSinget getClearSinget(long id){
		return getClearSinget(id, null);
	}

	
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public MESBasicClearSinget getClearSinget(long id, String viewCode){
		MESBasicClearSinget clearSinget = clearSingetDao.load(id);
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public String getClearSingetAsJSON(long id, String include){
		MESBasicClearSinget clearSinget = clearSingetDao.load(id);
		// 一对多情况处理
		...
		return JSONPlainSerializer.serializeAsJSON(clearSinget, include, new BAPEntityTransformer());
	}
	

	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget",desc="foundation.common.delete",operType="3")
	public void deleteClearSinget(MESBasicClearSinget clearSinget){
		if(null != clearSinget && (StringUtils.isEmpty(AuditUtil.getColumnStringD()) || MESBasicClearSinget.MODEL_CODE.equals(AuditUtil.getColumnStringD()))){
			AuditUtil.setColumnStringB(null == clearSinget.getId() ? "" : clearSinget.getId().toString());
			AuditUtil.setColumnStringA(null == clearSinget.getId() ? "" : clearSinget.getId().toString());
			AuditUtil.setColumnStringC(clearSinget.getId().toString());
		}
		beforeDeleteClearSinget(clearSinget);
		clearSingetDao.delete(clearSinget);
		afterDeleteClearSinget(clearSinget);
		clearSingetDao.flush();
		List<MESBasicClearSinget> params = new ArrayList<MESBasicClearSinget>();
		params.add(clearSinget);
		Map<String, Object> props = new HashMap<String, Object>();
		props.put("callType", "service");
		props.put("entityCode", "MESBasic_1_clearSinget");
	...
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget",desc="foundation.common.delete",operType="3")
	public void deleteClearSinget(List<Long> clearSingetIds){
		deleteClearSinget(clearSingetIds, null);
	}

	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget",desc="foundation.common.delete",operType="3")
	public void deleteClearSinget(List<Long> clearSingetIds, String eventTopic) {
		List<MESBasicClearSinget> clearSingets = new ArrayList<MESBasicClearSinget>();
		for(Long clearSingetId : clearSingetIds){
			MESBasicClearSinget clearSinget = getClearSinget(clearSingetId);
			clearSingets.add(clearSinget);
			if(null != clearSinget && (StringUtils.isEmpty(AuditUtil.getColumnStringD()) || MESBasicClearSinget.MODEL_CODE.equals(AuditUtil.getColumnStringD()))){
				if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
					AuditUtil.setColumnStringA(AuditUtil.getColumnStringA() + (null == clearSinget.getId() ? "" : "," + clearSinget.getId().toString()));
				} else {
					AuditUtil.setColumnStringA(null == clearSinget.getId() ? "" : clearSinget.getId().toString());
				}
				if(!StringUtils.isEmpty(AuditUtil.getColumnStringB())){
					AuditUtil.setColumnStringB(AuditUtil.getColumnStringB() + (null == clearSinget.getId() ? "" : "," + clearSinget.getId().toString()));
				} else {
					AuditUtil.setColumnStringB(null == clearSinget.getId() ? "" : clearSinget.getId().toString());
				}
				if(!StringUtils.isEmpty(AuditUtil.getColumnStringC())){
					AuditUtil.setColumnStringC(AuditUtil.getColumnStringC() + (null == clearSinget.getId() ? "" : "," + clearSinget.getId().toString()));
				} else {
					AuditUtil.setColumnStringC(null == clearSinget.getId() ? "" : clearSinget.getId().toString());
				}
			}
		}
		
		for(MESBasicClearSinget clearSinget : clearSingets){
			beforeDeleteClearSinget(clearSinget);
		}
		 ...
		 * 增加SQL/HQL执行的数据日志记录
		 */
		if(clearSingets != null && clearSingets.size() > 0 ){
			for(MESBasicClearSinget clearSinget : clearSingets){
				...
				dataAuditLogService.saveCustomerAudit(InternationalResource.get("foundation.common.delete"),clearSinget, clearSinget.getId(), currentState.toArray(), previousState.toArray(), propertyNames.toArray(new String[propertyNames.size()]));
			}
		}
		if(clearSingetIds != null && clearSingetIds.size() > 0) {
			String hql = "update " + MESBasicClearSinget.JPA_NAME + " set valid = false where id in(:ids)";
			Query query = clearSingetDao.createQuery(hql);
			query.setParameterList("ids", clearSingetIds);
			query.executeUpdate();
		}
		...
		if(eventTopic==null){
			for(MESBasicClearSinget clearSingetz : clearSingets){
				clearSingetz.setValid(false);
				List<MESBasicClearSinget> params = new ArrayList<MESBasicClearSinget>();
				params.add(clearSingetz);
				Map<String, Object> props = new HashMap<String, Object>();
				props.put("callType", "service");
				props.put("entityCode", "MESBasic_1_clearSinget");
				props.put("eventType", "delete");
	...
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget",desc="foundation.common.delete",operType="3")
	public void deleteClearSinget(long clearSingetId, int clearSingetVersion){
		this.deleteClearSinget(clearSingetId, clearSingetVersion,null);
	}
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget",desc="foundation.common.delete",operType="3")
	public void deleteClearSinget(long clearSingetId, int clearSingetVersion,SignatureLog signatureLog){
		MESBasicClearSinget clearSinget = getClearSinget(clearSingetId);
		if(clearSinget != null && !clearSinget.isValid()){
		...
		beforeDeleteClearSinget(clearSinget);
		clearSingetDao.delete(clearSingetId, clearSingetVersion);
		afterDeleteClearSinget(clearSinget);
		clearSingetDao.flush();
		List<MESBasicClearSinget> params = new ArrayList<MESBasicClearSinget>();
		params.add(clearSinget);
		...
		if(signatureLog != null ) {
			...
			businessKey=clearSinget.getId();
			signatureLog.setTableId(clearSinget.getId());
			if(businessKey != null) {
	...
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget",desc="foundation.common.delete",operType="3")
	public void deleteClearSinget(String clearSingetIds){
		this.deleteClearSinget(clearSingetIds,null);
	}
	
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget",desc="foundation.common.delete",operType="3")
	public void deleteClearSinget(String clearSingetIds,SignatureLog signatureLog){
		deleteCollection(clearSingetIds,signatureLog);
	}
	...
	private void deleteCollection(String ids,SignatureLog signatureLog) {
		...
		for(String idVersion : idst) {
			...
			if (id != null && id.trim().length() > 0 && version != null && version.trim().length() > 0) {
				deleteClearSinget(Long.valueOf(id), Integer.valueOf(version),signatureLog);
			}
		}
		if(null != signatureLog){
			...
			String msgId="moduleCode:MESBasic_1#entityCode:MESBasic_1_clearSinget#modelCode:MESBasic_1_clearSinget_ClearSinget#timeStamp:"+String.valueOf(new Date().getTime());
			reliableMessageSenderService.sendQueue(msgId,signatureLog);
		}
	}
	
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget",desc="ec.engine.restore",operType="10")
	public void restoreClearSinget(String clearSingetIds){
		restoreCollection(clearSingetIds);
	}
	...
	public void restoreCollection(String ids) {
		...
		for(String idVersion : idst) {
			...
			if (id != null && id.trim().length() > 0) {
				restoreClearSinget(Long.valueOf(id));
			}
		}
	}
	...
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget",desc="ec.engine.restore",operType="10")
	public void restoreClearSinget(long clearSingetId){
		
		findBusinessKeyUsed(clearSingetId);	//判断业务主键是否重复
		...
		beforeRestoreClearSinget(clearSinget);
		clearSinget.setValid(true);
		clearSingetDao.update(clearSinget);
		afterRestoreClearSinget(clearSinget);
		List<MESBasicClearSinget> params = new ArrayList<MESBasicClearSinget>();
		params.add(clearSinget);
		Map<String, Object> props = new HashMap<String, Object>();
		props.put("callType", "service");
	...
	public void findBusinessKeyUsed(long clearSingetId){
		Property property = modelServiceFoundation.getBussinessProperty("MESBasic_1_clearSinget_ClearSinget");
		if(property != null){
			String propertyName = property.getColumnName();
			String sql  = "select * from " + MESBasicClearSinget.TABLE_NAME + " where valid = 1 and " + 
					propertyName + " =  (select "+ propertyName +" from "+ MESBasicClearSinget.TABLE_NAME +" where id = ? )";
			List<Object> list =  clearSingetDao.createNativeQuery(sql,clearSingetId).list();
			if(list.size() > 0){
	...
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget",desc="foundation.batch.import",operType="4")
	public  void batchImportBaseClearSinget(List<MESBasicClearSinget>  clearSingets){
		for(MESBasicClearSinget clearSinget:clearSingets)  {
			saveClearSinget(clearSinget, null, null, null);
		}
	}
	
	@Override
	public  void excelBatchImportBaseClearSinget(List<MESBasicClearSinget>  clearSingets){
		for(MESBasicClearSinget clearSinget:clearSingets)  {
			saveClearSinget(clearSinget, null);
		}
	}
	
	
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget",desc="ec.flow.save")
	public void saveClearSinget(MESBasicClearSinget clearSinget, Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads){
		saveClearSinget(clearSinget, dgLists,dgDeleteIDs,assFileUploads, null);
	}
	
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget",desc="ec.flow.save")
	public void saveClearSinget(MESBasicClearSinget clearSinget, Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads, String viewCode){
		saveClearSinget(clearSinget, dgLists,dgDeleteIDs,assFileUploads, viewCode, null,null);
	}


	public void generateClearSingetCodes(MESBasicClearSinget clearSinget) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		generateClearSingetCodes(clearSinget, false);
	}
	
	public void generateClearSingetCodes(MESBasicClearSinget clearSinget, Boolean viewIsView) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
	}
	
	public void generateClearSingetSummarys(MESBasicClearSinget clearSinget) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		generateClearSingetSummarys(clearSinget, false);
	}

	public void generateClearSingetSummarys(MESBasicClearSinget clearSinget, Boolean viewIsView) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
	}
	
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget")
	public void saveClearSinget(MESBasicClearSinget clearSinget,Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads,String viewCode, String eventTopic,boolean... isImport){
		this.saveClearSinget(clearSinget, dgLists,dgDeleteIDs,assFileUploads, viewCode, eventTopic,null,isImport);
	}

	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget")
	public void saveClearSinget(MESBasicClearSinget clearSinget,Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads,String viewCode, String eventTopic, SignatureLog signatureLog,boolean... isImport){
		boolean isNew = false;
		String entityCode = "MESBasic_1_clearSinget";
		Map<String, Object> props = new HashMap<String, Object>();
		props.put("callType", "service");
		props.put("entityCode", "MESBasic_1_clearSinget");
		String url = null;
		if(clearSinget.getId() != null && clearSinget.getId() > 0){
			if(StringUtils.isEmpty(AuditUtil.getColumnStringD()) || MESBasicClearSinget.MODEL_CODE.equals(AuditUtil.getColumnStringD())){
				AuditUtil.setAuditDes("ec.pending.edit");
				AuditUtil.setAuditOperationType("2");
			}
			props.put("eventType", "modify");
			url = "com/supcon/orchid/entities/sync/mESBasic_1_clearSinget/modify";
		}else{
			isNew = true;
			if(StringUtils.isEmpty(AuditUtil.getColumnStringD()) || MESBasicClearSinget.MODEL_CODE.equals(AuditUtil.getColumnStringD())){
			...
			url = "com/supcon/orchid/entities/sync/mESBasic_1_clearSinget/add";
		}
		...
		if(viewCode != null && !viewCode.trim().isEmpty()){
			...
			if(events!=null && events.size()>0){
				executeGScript(entityCode, "beforeSave", events, clearSinget);
			}
		}
		ReflectUtils.filterObjectIdIsNVL(clearSinget);
		beforeSaveClearSinget(clearSinget, viewIsView);

		if (viewIsView) {
			clearSingetDao.saveWithRevertVersion(clearSinget);
		} else {
			if(isNew)
				clearSingetDao.save(clearSinget);
			else
				clearSingetDao.merge(clearSinget);
		}
		if(null != clearSinget && (StringUtils.isEmpty(AuditUtil.getColumnStringD()) || MESBasicClearSinget.MODEL_CODE.equals(AuditUtil.getColumnStringD()))){
			AuditUtil.setColumnStringB(null == clearSinget.getId() ? "" : clearSinget.getId().toString());
			AuditUtil.setColumnStringA(null == clearSinget.getId() ? "" : clearSinget.getId().toString());
		...
		dealDatagridsSave(clearSinget,viewCode,dgLists,dgDeleteIDs,assFileUploads);
		// 一对多情况处理
		
		// 根据配置规则生成编码
		try {
			generateClearSingetCodes(clearSinget, viewIsView);
		} catch (Exception e) {
		...
		// 根据配置规则生成摘要
		try {
			generateClearSingetSummarys(clearSinget, viewIsView);
		} catch (Exception e) {
			log.error(e.getMessage(), e);
			throw new BAPException(e.getMessage(), e);
		}
		
		afterSaveClearSinget(clearSinget, viewIsView);


		if(viewCode != null){
			if(events!=null && events.size()>0){
				executeGScript(entityCode, "afterSave", events, clearSinget);
			}
		}
		List<MESBasicClearSinget> params = new ArrayList<MESBasicClearSinget>();
		clearSingetDao.flush();
		clearSingetDao.clear();
		clearSinget = clearSingetDao.load(clearSinget.getId());
	...
	private void executeGScript(String entityCode, String scriptType, List<Event> events, MESBasicClearSinget clearSinget){
		for(Event e : events){
			if(e.getName().equals(scriptType)){
				if(e.getFunction()!=null && e.getFunction().length() > 0){
					try{
						...
						variables.put("clearSinget", clearSinget);
	...
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget")
	public void mergeClearSinget(MESBasicClearSinget clearSinget, Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads){
		ReflectUtils.filterObjectIdIsNVL(clearSinget);
		beforeSaveClearSinget(clearSinget);
		clearSingetDao.merge(clearSinget);
		if(null != clearSinget && (StringUtils.isEmpty(AuditUtil.getColumnStringD()) || MESBasicClearSinget.MODEL_CODE.equals(AuditUtil.getColumnStringD()))){
			AuditUtil.setColumnStringB(null == clearSinget.getId() ? "" : clearSinget.getId().toString());
			AuditUtil.setColumnStringA(null == clearSinget.getId() ? "" : clearSinget.getId().toString());
		...
		dealDatagridsSave(clearSinget,null,dgLists,dgDeleteIDs,assFileUploads);

		afterSaveClearSinget(clearSinget);
	}
	
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public Page<MESBasicClearSinget> findClearSingets(Page<MESBasicClearSinget> page, Criterion... criterions) {
		return clearSingetDao.findByPage(page, criterions);
	}
	@Override
	...
	@SuppressWarnings("unchecked")
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	private MESBasicClearSingetDealInfo getDealInfoEntity(Long tableInfoId) {
		
		List<MESBasicClearSingetDealInfo> list=clearSingetDao.createQuery("from " + MESBasicClearSingetDealInfo.JPA_NAME + " where tableInfoId=?", tableInfoId).setMaxResults(1).list();
		if(list.size()>0){
			return list.get(0);
		}
		return null;
	...
	@Override
	public void saveDealInfo(MESBasicClearSingetDealInfo dealInfo) {
		clearSingetDao.saveDealInfo(dealInfo);
	}
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public int getDealInfoCount(Long tableInfoId) {
		String sql = "SELECT count(1) totalCount " + "FROM "+MESBasicClearSingetDealInfo.TABLE_NAME+" DI " + "LEFT JOIN " + User.TABLE_NAME + " U ON DI.USER_ID=U.ID " + "LEFT JOIN " + Staff.TABLE_NAME
				+ " S ON S.ID=U.STAFF_ID " + "WHERE DI.TABLE_INFO_ID = ?";
		Number list = (Number) clearSingetDao.createNativeQuery(sql, tableInfoId).uniqueResult();
	...
	public List<Object[]> findDealInfos(Long tableInfoId, boolean expandFlag) {
		String sql = "SELECT DI.TASK_DESCRIPTION ACTIVITYNAME,DI.CREATE_TIME CREATETIME ,DI.COMMENTS COMMENTS,DI.OUTCOME OUTCOME,S.NAME STAFFNAME,DI.OUTCOME_DES OUTCOME_DES,DI.ASSIGN_STAFF ASSIGNSTAFF ,DEALINFO_TYPE DEALINFOTYPE, DI.PROXY_STAFF PROXYSTAFF, DI.PENDING_CREATE_TIME PCREATETIME,  DI.SIGNATURE SIGNATURE, WT.TYPE,WTR.TYPE TRANSITIONTYPE "
				+ " FROM "+MESBasicClearSingetDealInfo.TABLE_NAME + " DI " 
		...
		if (expandFlag) {
			...
			DBTYPE dbtype = clearSingetDao.getDBType();
			if (DBTYPE.MSSQL == dbtype) {
				sql += " AND DI.COMMENTS != ''";
			}
		}
		sql += " ORDER BY DI.SORT ASC, DI.CREATE_TIME ASC, DI.ID ASC";
		List<Object[]> list = clearSingetDao.createNativeQuery(sql, tableInfoId).list();
		for(Object[] obj:list){
			if(obj[2]!=null){
	...
	public Map<String, List<Object[]>> findDealInfosGroup(Long tableInfoId, boolean expandFlag) {
		...
		groupSql.append(" FROM "
				+ MESBasicClearSingetDealInfo.TABLE_NAME
		...
		List<Object[]> groupList = clearSingetDao.createNativeQuery(groupSql.toString(), tableInfoId).list();
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public void findClearSingets(Page<MESBasicClearSinget> page,  String viewCode, int type, String processKey,Boolean flowBulkFlag, Boolean hasAttachment,Boolean noQueryFlag,String exportSql, Map exportMap, List<Param> params) {
		findClearSingets(page,  viewCode, type, processKey, flowBulkFlag, hasAttachment, params, viewCode, noQueryFlag, exportSql, exportMap);
	}
	
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public void findClearSingets(Page<MESBasicClearSinget> page,  String viewCode, int type, String processKey,Boolean flowBulkFlag, Boolean hasAttachment, List<Param> params, String permissionCode,Boolean noQueryFlag,String exportSql, Map exportMap) {
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public void findClearSingets(Page<MESBasicClearSinget> page,  String viewCode, int type, String processKey,Boolean flowBulkFlag, Boolean hasAttachment, List<Param> params, String permissionCode, Boolean noQueryFlag,String exportSql, Map exportMap, Object... objects) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void commonQuery(Page<MESBasicClearSinget> page, String viewCode, int type, String processKey, Boolean flowBulkFlag,
			...
			if (null != params && !params.isEmpty()) {
				...
				for (int i = 0; i < params.size(); i++) {
					...
					if ("dataTable-sortColKey".equals(param.getName())) {
						...
						String tableAlias = lastDotPos < 0 ? "\"clearSinget\"" : "\"" + key.substring(0, lastDotPos) + "\"";
						if("\"pending\"".equals(tableAlias)) {
							tableAlias = "\"p\"";
						}
						sortOrderByStr.append(tableAlias).append(".").append(columnName);
					...
					if(type == Sql.TYPE_LIST_REFERENCE){
						if(null != crossCompanyFlag && !crossCompanyFlag && !getCurrentCompanyId().equals(1L)){
							s.append(" AND \"clearSinget\".CID in (1,").append(getCurrentCompanyId()+")");
						}
					}
	...
	//						s.append(" AND \"clearSinget\".CID = ").append(getCurrentCompanyId());
	...
	//				}
			...
			if(needPermission){
				...
				if(view.getType() == ViewType.REFERENCE || view.getType() == ViewType.REFTREE){
					if(view.getShowType().equals(ShowType.PART)){
						...
						if(null == layoutView  || !(layoutView.getIsPermission() && layoutView.getPermissionCode().trim().length() > 0)){
							...
							powerCode = "MESBasic_1_clearSinget_ClearSinget" + "_" + layoutView.getPermissionCode();
						}
						if(null == layoutView)  {
							layoutView = getLayoutView(permissionCode);
							if(null == layoutView  || !(layoutView.getIsPermission() && layoutView.getPermissionCode().trim().length() > 0)){
						...
						if(view.getIsPermission() && view.getPermissionCode().trim().length() > 0){
							powerCode = "MESBasic_1_clearSinget_ClearSinget" + "_" + view.getPermissionCode();
						}
					}
				...
				List<Object> powerCodeList =  clearSingetDao.createNativeQuery(powerCodeSql, powerCode).list();
				if(powerCodeList.size() > 0) {
					...
					List<Object> checkList =  clearSingetDao.createNativeQuery(powerOperateSql, "MESBasic_1_clearSinget").list();
					if(checkList.size()>0){
						powerCode = checkList.get(0).toString();
					}
				}	
					String	pc = dataPermissionService.getBaseModelPowerCondition(this.creatorService.getStaffFromSession().getUser(), powerCode, "\"clearSinget\"","MESBasic_1_clearSinget",customCondition,"BATCHMANAG_CLEAR_SINGETS",false);
				if (pc.trim().length() > 0) {
					if (hasWhere){
						s.append(" AND ");
					}else{
			...
			if(null!=processKey&&!processKey.equals("")){
				if(type == Sql.TYPE_LIST_QUERY){
					...
					if(!"".equals(pendingSql)){
						s.append(" \"clearSinget\".TABLE_INFO_ID IN (  SELECT   D.TABLE_INFO_ID "+
	                      "   FROM   "+MESBasicClearSingetDealInfo.TABLE_NAME+" d "+
	                      "  WHERE   ("+pendingSql+") "+
			...
			if(queryType == 1) {
				s.append(" AND \"clearSinget\".STATUS = 99 ");
			}
			// 开始处理排序，避免在统计时带入排序条件
			...
			if(type == Sql.TYPE_LIST_PENDING) {
				...
				if(isTreeView) {
					orderPart.append(" \"clearSinget\".LAY_REC ASC, \"clearSinget\".SORT ASC");
				} else {
					orderPart.append(" \"clearSinget\".ID DESC");
				}
			}
			...
			if (page.needCount()) {
				...
				//Long count = ((Number) clearSingetDao.createNativeQuery(countSql, arr).uniqueResult()).longValue();
				Long count = 0l;
			    Map<String, BigDecimal> resultTotals = new HashMap<String, BigDecimal>();
			    SQLQuery query=clearSingetDao.createNativeQuery(countSql, arr);
			...
			if(!noQueryFlag)  {
				SQLQuery query = clearSingetDao.createNativeQuery(realSql, arr);
				if(customerSqlListMap!=null&&!customerSqlListMap.isEmpty()){
					for(String key:customerSqlListMap.keySet()){
						query.setParameterList(key, (Object[])customerSqlListMap.get(key));
					}
				}
				List<MESBasicClearSinget> result = new ArrayList<MESBasicClearSinget>();
				if(page.isExportFlag()) {  
					result = getResult(page, query, new PendingResultTransformer(MESBasicClearSinget.class,clearSingetDao,maps,true));
				}else {
					result = getResult(page, query, new PendingResultTransformer(MESBasicClearSinget.class,clearSingetDao,maps));
				}
				modelServiceFoundation.initCacheData();
				page.setResult(result);
				if(null != hasAttachment && hasAttachment) {
					for (MESBasicClearSinget clearSinget : result) {
						long count = 0l;
						count = documentService.getCountByLinkIdAndType(clearSinget.getId(), "MESBasic_clearSinget_clearSinget");
						if(count > 0) {
							List<Document> documents = documentService.getByLinkIdAndType(clearSinget.getId(), "MESBasic_clearSinget_clearSinget");
							if(null != documents && !documents.isEmpty()) {
								clearSinget.setDocument(documents.get(0));
								clearSinget.setBapAttachmentInfo(documents.get(0).getName() + "@_@BAP@_@更多(" + count + ")");
							}
						}
					}
				}
	...
	private View getLayoutView(String permissionCode) {
		if(null!=permissionCode&&permissionCode.indexOf("MESBasic_1_clearSinget")!=-1) {
				String personalCode=permissionCode.substring(permissionCode.indexOf("MESBasic_1_clearSinget")+"MESBasic_1_clearSinget".length()+1);
				if(null!=personalCode&&personalCode.trim().length()>0)  {
						return viewServiceFoundation.getViewWithPermissionCode("MESBasic_1_clearSinget",personalCode);
				}
		}
		return null;
	}
	
	private void getConfigAssoPropsResult(String viewCode, List<MESBasicClearSinget> result) {
		getConfigAssoPropsResult(viewCode, null, result);
	}
	
	private void getConfigAssoPropsResult(String viewCode,String dataGridCode, List<MESBasicClearSinget> result) {
		View view = null;
		...
		Map<Long, MESBasicClearSinget> rsMap = new HashMap<Long, MESBasicClearSinget>();
		for (MESBasicClearSinget clearSinget : result) {
			ids.add(clearSinget.getId());
			rsMap.put(clearSinget.getId(), clearSinget);
		}
		for (Field f : fields) {
					...
					if (configMap != null && configMap.size() > 0) {
						...
						for (int index = 0; index < configList.size(); index++) {
							...
							for (int i = 0; i < count; i++) {
								rs.addAll(clearSingetDao.createNativeQuery(sql)
	...
	private Property findAssoProperty(String origModelCode, String assoModelCode) {
		...
		List<Property> list = clearSingetDao.findByHql(hql, new Object[] {origModelCode, assoModelCode, Property.ONE_TO_ONE, Property.MANY_TO_ONE});
		return list.get(0);
	}
	...
	protected EntityTableInfo getTableInfo(MESBasicClearSinget clearSinget,boolean... isImport) {
		EntityTableInfo ti = new EntityTableInfo();


		ti.setOwnerStaffId(clearSinget.getOwnerStaffId());
		ti.setOwnerPositionId(clearSinget.getOwnerPositionId());
		ti.setOwnerDepartmentId(clearSinget.getOwnerDepartmentId());
		
		ti.setCreateStaff(clearSinget.getCreateStaff());
		ti.setCreateStaffId(clearSinget.getCreateStaffId());
		ti.setCreateTime(clearSinget.getCreateTime());
		ti.setDeleteStaff(clearSinget.getDeleteStaff());
		ti.setDeleteStaffId(clearSinget.getDeleteStaffId());
		ti.setDeleteTime(clearSinget.getDeleteTime());
		ti.setCreateDepartmentId(clearSinget.getCreateDepartmentId());
		ti.setModifyStaff(clearSinget.getModifyStaff());
		ti.setModifyStaffId(clearSinget.getModifyStaffId());
		ti.setCreatePositionId(clearSinget.getCreatePositionId());
		ti.setPositionLayRec(clearSinget.getPositionLayRec());
		ti.setTableNo(clearSinget.getTableNo());
		ti.setValid(true);
		ti.setTargetEntityCode("MESBasic_1_clearSinget");
		ti.setTargetTableName("BATCHMANAG_CLEAR_SINGETS");
	...
	public List<Object[]> mneCodeSearch( String viewCode,  int showNumber, boolean cross, List<Param> params,String refViewCode,String currentViewCode,String sqlType,String realPermissionCode){
		...
		if (null != sql && sql.length() > 0) {
			...
			if(refViewCode!=null&&!refViewCode.equals(""))  {
				...
				if(needPermission)  {
					if(null == refView ){
						...
						powerCode ="MESBasic_1_clearSinget_ClearSinget" + "_" + refView.getPermissionCode();
						searchRefView=true;
					}
					String powerCodeSql = "select m.code as code from base_MenuOperate m where m.code = ? and m.valid = 1";
					List<Object> powerCodeList =  clearSingetDao.createNativeQuery(powerCodeSql, powerCode).list();
					if(powerCodeList.size() > 0) {
						...
						powerSql  = dataPermissionService.getBaseModelPowerCondition(this.creatorService.getStaffFromSession().getUser(), powerCode, "\"clearSinget\"","MESBasic_1_clearSinget","","BATCHMANAG_CLEAR_SINGETS",false);
					//if(!searchRefView&&refView.getAssModel().getEntity().getWorkflowEnabled())  {
						//查询主列表视图的权限(表单类型)
						//	sb.append(" INNER JOIN WF_PENDING \"p\" ON \"p\".TABLE_INFO_ID=\"clearSinget\".TABLE_INFO_ID ");
						//	sb.append(" WHERE  \"clearSinget\".STATUS <> 0  ");
					//}
					//powerSql = dataPermissionService.getBaseModelPowerCondition(this.creatorService.getStaffFromSession().getUser(), powerCode, "\"clearSinget\"","MESBasic_1_clearSinget","","BATCHMANAG_CLEAR_SINGETS",false);
					if(sb.length()>0) {
						sb.append(" AND ");
			...
			mnecodeSql.append("  (\"").append("clearSinget.mc\"").append(".MNE_CODE) like (?) escape '&' AND \"clearSinget\".VALID = 1");
			...
			if(!cross){
				if(isSingleMode){
					mnecodeSql.append(" AND \"clearSinget\".CID = ?");
					totalValues.add(getCurrentCompanyId());
				}else{
					//当前公司不是集团情况下查询集团和本公司数据
					if(!getCurrentCompanyId().equals(1L)){
						mnecodeSql.append(" AND (\"clearSinget\".CID = 1 OR \"clearSinget\".CID = ?)");
						totalValues.add(getCurrentCompanyId());
					}
				}
			}
			...
			if(notinValue != null){
				mnecodeSql.append(" and (\"").append("clearSinget.mc\"").append(".CLEAR_SINGET) not in ("+notinValue+")");
			}
			
			SQLQuery query = clearSingetDao.createNativeQuery(mnecodeSql.toString(), totalValues.toArray(new Object[]{}));
	...
	public void afterPropertiesSet() throws Exception {
		this.beforeInitBean();
		this.counter = this.counterManager.addCounter("clearSinget", "MESBasic_1_clearSinget", "clearSinget_{1,date,yyyyMMdd}_{0,number,000}", CounterType.Daily);
		String formatStr = "";
		this.afterInitBean();
	}
	@Override
	...
	public String getWorkFlowInfo(String menuCode) {
		...
		SQLQuery query=clearSingetDao.createNativeQuery(sql, menuCode);
	...
	protected String getEntityCode(){return MESBasicClearSinget.ENTITY_CODE;}
	protected String getModuleCode(){return MESBasicClearSinget.MODULE_CODE;}
	protected String getModelCode(){return MESBasicClearSinget.MODEL_CODE;}
	
	
	/**
	 * 检查模型字段的唯一性约束
	 * @param clearSinget 模型实例
	 */
	public void checkUniqueConstraint(MESBasicClearSinget clearSinget){
	}
	
	
	@Override
	public List<MESBasicClearSinget> getClearSingets(String sql, List<Object> params) {
		DetachedCriteria detachedCriteria = DetachedCriteria.forClass(MESBasicClearSinget.class);
		if(params!=null){
			...
			return clearSingetDao.findByHql("from " + MESBasicClearSinget.JPA_NAME + " " + ((sql==null || sql.isEmpty()) ? "" : "where " + sql)) ;
		}
		return clearSingetDao.findByCriteria(detachedCriteria);
	}
	
	
	
	@Override
	public List<MESBasicClearSinget> findClearSingetsBySql(String sql, List<Object> params){
		DetachedCriteria detachedCriteria = DetachedCriteria.forClass(MESBasicClearSinget.class);
	...
	@Override
	public List<MESBasicClearSinget> findClearSingetsByHql(String hql, Object... objects){
		
		return   clearSingetDao.findByHql(hql, objects);
	}
	
	@Override
	public MESBasicClearSinget loadClearSingetByBussinessKey(MESBasicClearSinget clearSinget){
		return loadClearSingetByBussinessKey(clearSinget.getId());
	}
	
	@Override
	public Page<MESBasicClearSinget> getClearSingets(Page<MESBasicClearSinget> page, String sql, List<Object> params, String sort) {
		DetachedCriteria detachedCriteria = DetachedCriteria.forClass(MESBasicClearSinget.class);
		...
		if(params!=null){
			...
			if(sql!=null){
				page = clearSingetDao.findByPage(page, sql);
			}else{
				page = clearSingetDao.findAllByPage(page);
			}
			return page;
		}
		page = clearSingetDao.findByPage(page, detachedCriteria);
		return page;
	}
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public MESBasicClearSinget loadClearSingetByBussinessKey(Serializable bussinessKey){
		return clearSingetDao.findEntityByCriteria(Restrictions.eq("id", Long.valueOf(bussinessKey.toString())),Restrictions.eq("valid", true));
	}
	
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public List<MESBasicClearSinget> findByProperty(String propertyName, Object object){
		return clearSingetDao.findByProperty(propertyName, object);
	}
	
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public MESBasicClearSinget findEntityByProperty(String propertyName, Object object){
		return clearSingetDao.findEntityByProperty(propertyName, object);
	}
	...
	public void deleteByBussinessKeys(String bussinessKeys){
		if(null != bussinessKeys && bussinessKeys.trim().length() > 0){
			...
			String sql = "update " + MESBasicClearSinget.JPA_NAME + " set valid=0 where id in (:businessKeys)";
			Query query = clearSingetDao.createQuery(sql);
	...
	public String findValidateDatagrids(Map<String,Class> dgClassMap){
		...
		List<View> dgviews = viewServiceFoundation.findViewsByAssModelCode("MESBasic_1_clearSinget_ClearSinget","runtime");
		try {
	...
	public String findMainViewPath(){
		String mainViewPath="";
		List<View> views = viewServiceFoundation.findViewsByEntityCode("MESBasic_1_clearSinget", ViewType.VIEW);
		for(View v:views){
			if(v.getMainView()){
	...
	public void dealDatagridsSave(MESBasicClearSinget clearSinget,String viewCode,Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads){
			...
			try {
				for(DataGrid dg:dgs){
					...
					if(dgLists!=null&&dgLists.get(dg.getName())!=null){
						...
						List dglist=(List)com.supcon.orchid.ec.utils.JSONUtil.generateObjectFromJson(dgLists.get(dg.getName()).replaceAll("\r\n", "\\\\r\\\\n"), _reflect_dgclass,clearSingetDao.getSessionFactory());
						java.lang.reflect.Method _reflect_setMethod=_reflect_dgclass.getMethod("set"+fLTU(dg.getOrgProperty().getName()), MESBasicClearSinget.class);
						...
						for(Object odg:dglist){
							_reflect_setMethod.invoke(odg, clearSinget);
							...
							if(!paramMap.isEmpty()){
								...
								paramMap.put("mainModelId",clearSinget.getId());	
	...
	public List<Object> getBusinessKeyData(String businessKeyName){
		...
		if(null != businessKeyName){
			String sql = "select " + businessKeyName +" from "+ MESBasicClearSinget.TABLE_NAME +" where valid = 1";
			list = clearSingetDao.createNativeQuery(sql).list();
		}
		return list;
	}
	...
	public List<Object> getBusinessKeyDataByBusinessKeyName(String businessKeyName){
		List<Object> list = new ArrayList<Object>();
		if(null != businessKeyName){
			String sql = "select " + businessKeyName +" from "+ MESBasicClearSinget.TABLE_NAME;
			list = clearSingetDao.createNativeQuery(sql).list();
		}
		return list;
	}
	...
	public Map<Object, Object> getReplaceProperty(String propertyName,String businessKey){
		...
		if(null != propertyName && null != businessKey){
			String sql = "select " + businessKey + "," + propertyName +" from "+ MESBasicClearSinget.TABLE_NAME +" group by " + propertyName + "," + businessKey;
			list = clearSingetDao.createNativeQuery(sql).list();
		}
		if (list != null && !list.isEmpty()) {
			for (Object[] obj : list) {
	...
	@Autowired
	private MESBasicClearSingetDaoImpl clearSingetDaoImpl;
	
	
	@Override
	@Transactional(propagation = Propagation.SUPPORTS)
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget",desc="foundation.import.bussiness.info",operType="5")
	public Map<Object, Long> importBatchClearSinget(final List<MESBasicClearSinget> insertObjs, final List<MESBasicClearSinget> updateObjs, 
				List<Map<String,String>> columnInfo, Map<String ,List<Map<String, Object>>> importNodeInfo, Map<String, Property> importPropInfo){
		return this.importBatchClearSinget(insertObjs, updateObjs, columnInfo, importNodeInfo, importPropInfo,null);		
	}
	...
	public Map<Object, Long> importBatchClearSinget(final List<MESBasicClearSinget> insertObjs, final List<MESBasicClearSinget> updateObjs, 
		...
		AuditUtil.setAuditDes(InternationalResource.get("foundation.import.bussiness.info.args",null,InternationalResource.get("MESBasic.modelname.randon1554194025939"),importCount));
		...
		Map<Long, MESBasicClearSinget> oldUpdateObjsMap = new HashMap<Long, MESBasicClearSinget>(); 
		List<Long> updateObjIdsList = new ArrayList<Long>();
		for(int updateIndex = 0; updateIndex < updateObjs.size(); updateIndex++)  {
			MESBasicClearSinget bizObj = updateObjs.get(updateIndex);
		...
		if (updateObjIdsList.size() > 0) {
			...
			List<MESBasicClearSinget> bizObjList = clearSingetDao.findByCriteria(detachedCriteria);
			if (null != bizObjList) {
				for (int mIndex = 0; mIndex < bizObjList.size(); mIndex++) {
					MESBasicClearSinget bizObj = bizObjList.get(mIndex);
		...
		final List<MESBasicClearSinget> nmeObjs = new ArrayList<MESBasicClearSinget>();
		...
		long id=autoGeneratorID.getNextId(MESBasicClearSinget.TABLE_NAME,expLength,dbId);//id表只操作一次，实际id通过++来增长
		for(MESBasicClearSinget clearSinget:insertObjs)  {
			//id = autoGeneratorID.getNextId(MESBasicClearSinget.TABLE_NAME,1,dbId);
			if(clearSinget.getId() != null ){
				m.put(clearSinget.getId(), id);
			}else{
				m.put(id, id);
			}
			insertIds.add(id);
			clearSinget.setId(id);
			id++;
		}
		...
		for(Map<String,String> map : columnMaps){
			if(map.get("type").equals("SYSTEMCODE")){
				...
				Object[] result = (Object[]) clearSingetDao.createNativeQuery(sql, "MESBasic_1_clearSinget_ClearSinget"+"_"+map.get("name")).uniqueResult();
				map.put("isSenior", result[0].toString());
				//map.put("multable", result[1].toString());
			}
		}
		
		clearSingetDaoImpl.getSession().doWork(new Work() {
			@Override
			public void execute(Connection conn) throws SQLException {
				...
				if(updateObjs != null && updateObjs.size()>0){
					...
					String updateSql = "UPDATE " + MESBasicClearSinget.TABLE_NAME + " SET ";
					...
					for(int updateIndex =0;updateIndex<updateObjs.size();updateIndex++){
						MESBasicClearSinget clearSinget = updateObjs.get(updateIndex);
						Long id = clearSinget.getId();
						if(null != id){
							updateps.setLong(columnMaps.size()+1,id);
							for(int i=0;i<columnMaps.size();i++){
								Method method = null;
								try {
									method = clearSinget.getClass().getMethod(updateMethods.get(i));
				...
				if(insertObjs != null && insertObjs.size()>0){//新增
					...
					String insertSql = "INSERT INTO " + MESBasicClearSinget.TABLE_NAME + " (";
					for(int i = 0;i<columnMaps.size();i++){
						String mName = columnMaps.get(i).get("name");
						String methodName = "get"+ mName.replaceFirst(mName.substring(0, 1), mName.substring(0, 1).toUpperCase());
...
//					String idSql = "select id from " + MESBasicClearSinget.TABLE_NAME + " order by id desc";
//					Query query = clearSingetDao.createNativeQuery(idSql).setMaxResults(1);
...
//					}
					...
					for(int insertIndex = 0; insertIndex<insertObjs.size(); insertIndex++)  {
						MESBasicClearSinget clearSinget = insertObjs.get(insertIndex);
						...
						for (int i = 0; i < columnMaps.size(); i++) {
							Method method = null;
							try {
								method = clearSinget.getClass().getMethod(
										insertMethods.get(i));
							} catch (NoSuchMethodException | SecurityException e) {
								log.error(e.getMessage(),e);
							}
		...
		clearSingetDaoImpl.getSession().flush();
		clearSingetDaoImpl.getSession().clear();
		
		
		//记录导入数据日志（区分新增和修改）
		
		for(int insertIndex = 0; insertIndex < insertObjs.size(); insertIndex++)  {//新增
			MESBasicClearSinget bizObj = insertObjs.get(insertIndex);
			clearSingetImportService.saveImportDataLog(bizObj, null, "id", "id");
		}
		for(int updateIndex = 0; updateIndex < updateObjs.size(); updateIndex++)  {//修改
			MESBasicClearSinget bizObj = updateObjs.get(updateIndex);
			MESBasicClearSinget oldBizObj = oldUpdateObjsMap.get(bizObj.getId());
			clearSingetImportService.saveImportDataLog(bizObj, oldBizObj, "id", "id");
		}
	...
	public String getViewName(String modelCode){
		...
		String viewName = clearSingetDao.createNativeQuery(sql, modelCode).setMaxResults(1).uniqueResult()!=null?
				clearSingetDao.createNativeQuery(sql, modelCode).setMaxResults(1).uniqueResult().toString():"";
		return viewName;
	}
	...
	private String getDbIdName(){
		...
		String dbIDName = clearSingetDao.createNativeQuery(sql, "MESBasic_1_clearSinget_ClearSinget").uniqueResult().toString();
		return dbIDName;
	}
	...
	public List<String> getSystemCodeFullPathNameByEntityCode(String entityCode) {
		...
		List<String> strs = clearSingetDao.createNativeQuery(sql, entityCode).list();
		return strs;
	}
	...
	public List<String> getRunningCustomProperties(String entityCode){
		...
		list = clearSingetDao.createNativeQuery(sql, entityCode).list();
		return list;
	}
	...
	public String getAssProperty(String propertyCode){
		...
		assProperty = clearSingetDao.createNativeQuery(sql,propertyCode).uniqueResult()!=null?clearSingetDao.createNativeQuery(sql,propertyCode).uniqueResult().toString():"";
		return assProperty;
	}		
	...
	public String getPropertyModelCode(String propertyCode){
		...
		String modelCode =  clearSingetDao.createNativeQuery(sql,propertyCode).uniqueResult().toString();
		return modelCode;
	}
	@Override
	@Transactional(propagation = Propagation.SUPPORTS)
	public  Object generateObjectFromJson(String jsonStr, Class clazz){
		return com.supcon.orchid.ec.utils.JSONUtil.generateObjectFromJson(jsonStr,clazz,clearSingetDao.getSessionFactory());
	}
	...
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget",desc="ec.flow.save")
	public void saveClearSinget(MESBasicClearSinget clearSinget, DataGridService dataGridService){
		saveClearSinget(clearSinget, dataGridService, null);
	}
	
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget",desc="ec.flow.save")
	public void saveClearSinget(MESBasicClearSinget clearSinget, DataGridService dataGridService, String viewCode){
		saveClearSinget(clearSinget, dataGridService, viewCode, null);
	}
	
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget")
	public void saveClearSinget(MESBasicClearSinget clearSinget, DataGridService dataGridService, String viewCode, String eventTopic, boolean... isImport){
		this.saveClearSinget(clearSinget, dataGridService, viewCode, eventTopic,null,isImport);
	}
	
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget")
	public void saveClearSinget(MESBasicClearSinget clearSinget, DataGridService dataGridService, String viewCode, String eventTopic,SignatureLog signatureLog, boolean... isImport){
		boolean isNew = false;
		String entityCode = "MESBasic_1_clearSinget";
		Map<String, Object> props = new HashMap<String, Object>();
		props.put("callType", "service");
		props.put("entityCode", "MESBasic_1_clearSinget");
		String url = null;
		if(null != clearSinget.getId() && clearSinget.getId() > 0){
			if(StringUtils.isEmpty(AuditUtil.getColumnStringD()) || MESBasicClearSinget.MODEL_CODE.equals(AuditUtil.getColumnStringD())){
				AuditUtil.setAuditDes("ec.pending.edit");
				AuditUtil.setAuditOperationType("2");
			}
	...
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget")
	public Map<Object, Object> clearSingetDataGridImport(MESBasicClearSinget clearSinget, DataGridService dataGridService, String viewCode, String eventTopic,Property businessKey, boolean isImport){
		...
		String virturalId = clearSinget.getVirtualId();
		
		clearSinget = clearSingetDao.load(clearSinget.getId());
		
		if(virturalId != null && virturalId.length() > 0){
			map.put(virturalId, clearSinget.getId());
		}else{
			String methodName = "get" + businessKey.getName().substring(0, 1).toUpperCase() + businessKey.getName().substring(1);
			Object bkValue = null;
			try {
				Method getBkValue = clearSinget.getClass().getMethod(methodName);
				bkValue = getBkValue.invoke(clearSinget);
			} catch (NoSuchMethodException | SecurityException | IllegalAccessException | IllegalArgumentException | InvocationTargetException e) {
				log.error(e.getMessage(), e);
			}
			map.put(bkValue, clearSinget.getId());
		}
	...
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget")
	public void mergeClearSinget(MESBasicClearSinget clearSinget, DataGridService dataGridService){
		ReflectUtils.filterObjectIdIsNVL(clearSinget);
		beforeSaveClearSinget(clearSinget);
		clearSingetDao.merge(clearSinget);
	 ...
	 */
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget",desc="foundation.common.exportExcel",operType="11")
	 ...
	 */
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget",desc="ec.print.page.print",operType="4")
	...
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget",desc="foundation.batch.save",operType="4")
	public void batchSaveClearSinget(MESBasicClearSinget clearSinget, DataGridService dataGridService,View view,List<Event>  events, String eventTopic, boolean... isImport){
		String entityCode = "MESBasic_1_clearSinget";
		Map<String, Object> props = new HashMap<String, Object>();
		props.put("callType", "service");
		props.put("entityCode", "MESBasic_1_clearSinget");
	...
	@Override
	public Page<MESBasicClearSinget> getByPage(Page<MESBasicClearSinget> page,DetachedCriteria detachedCriteria){
		return clearSingetDao.findByPage(page, detachedCriteria);
	}
	
	
	
	public String generateTableNo(){
		this.counter.setPattern(modelServiceFoundation.getEntity("MESBasic_1_clearSinget").getPrefix()+"_{1,date,yyyyMMdd}_{0,number,000}");
		return this.counter.incrementAndGetString(new Date(),new Date());
	}
	private void beforeSaveClearSinget(MESBasicClearSinget clearSinget, Object... objects){
		checkUniqueConstraint(clearSinget);
	/* CUSTOM CODE START(serviceimpl,beforeSave,MESBasic_1_clearSinget_ClearSinget,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	
	private void afterSaveClearSinget(MESBasicClearSinget clearSinget, Object... objects){
	/* CUSTOM CODE START(serviceimpl,afterSave,MESBasic_1_clearSinget_ClearSinget,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	@Override
	public void beforeExcelImportClearSinget(List<MESBasicClearSinget> clearSingets, Map<String, Map<Integer, Map<Integer, String>>> errors){
	/* CUSTOM CODE START(serviceimpl,beforeExcelImport,MESBasic_1_clearSinget_ClearSinget,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	@Override
	public void afterExcelImportClearSinget(List<MESBasicClearSinget> clearSingets){
	/* CUSTOM CODE START(serviceimpl,afterExcelImport,MESBasic_1_clearSinget_ClearSinget,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	@Override
	public void beforeExcelBatchImportClearSinget(List<MESBasicClearSinget> clearSingets, Map<Integer, Map<Integer, String>> errors){
	/* CUSTOM CODE START(serviceimpl,beforeExcelBatchImport,MESBasic_1_clearSinget_ClearSinget,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */	
	...
	@Override
	public void afterExcelBatchImportClearSinget(List<MESBasicClearSinget> clearSingets){
	/* CUSTOM CODE START(serviceimpl,afterExcelBatchImport,MESBasic_1_clearSinget_ClearSinget,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */	
	}
	
	private void beforeDeleteClearSinget(MESBasicClearSinget clearSinget){
	/* CUSTOM CODE START(serviceimpl,beforeDelete,MESBasic_1_clearSinget_ClearSinget,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	
	private void afterDeleteClearSinget(MESBasicClearSinget clearSinget){
	/* CUSTOM CODE START(serviceimpl,afterDelete,MESBasic_1_clearSinget_ClearSinget,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	
	private void beforeRestoreClearSinget(MESBasicClearSinget clearSinget){
	/* CUSTOM CODE START(serviceimpl,beforeRestore,MESBasic_1_clearSinget_ClearSinget,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	
	private void afterRestoreClearSinget(MESBasicClearSinget clearSinget){
	/* CUSTOM CODE START(serviceimpl,afterRestore,MESBasic_1_clearSinget_ClearSinget,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	
	private void customGenerateCodes(MESBasicClearSinget clearSinget, Object... objects) {
		/* CUSTOM CODE START(serviceimpl,customGenerateCodes,MESBasic_1_clearSinget_ClearSinget,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	private void customGenerateSummarys(MESBasicClearSinget clearSinget, Object... objects) {
		/* CUSTOM CODE START(serviceimpl,customGenerateCodes,MESBasic_1_clearSinget_ClearSinget,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	/* CUSTOM CODE START(serviceimpl,beforeServiceDestroy,MESBasic_1_clearSinget_ClearSinget,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	private void beforeInitBean(){
		/* CUSTOM CODE START(serviceimpl,beforeInitBean,MESBasic_1_clearSinget_ClearSinget,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	private void afterInitBean(){
		/* CUSTOM CODE START(serviceimpl,afterInitBean,MESBasic_1_clearSinget_ClearSinget,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	@Override
	public void beforeImportClearSinget(List<MESBasicClearSinget> insertObjs, List<MESBasicClearSinget> updateObjs, 
		...
		/* CUSTOM CODE START(serviceimpl,beforeImportClearSinget,MESBasic_1_clearSinget_ClearSinget,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	@Override
	public void afterImportClearSinget(List<MESBasicClearSinget> insertObjs, List<MESBasicClearSinget> updateObjs, 
		...
		/* CUSTOM CODE START(serviceimpl,afterImportClearSinget,MESBasic_1_clearSinget_ClearSinget,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */
	}
	/* CUSTOM CODE START(serviceimpl,functions,MESBasic_1_clearSinget_ClearSinget,MESBasic_1) */
// 自定义代码
