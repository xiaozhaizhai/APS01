...
@Service("mESBasicBaseVendorClassImportService")
public class MESBasicBaseVendorClassImportServiceImpl implements MESBasicBaseVendorClassImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_baseVenderClass",model="MESBasic_1_baseVenderClass_BaseVendorClass",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicBaseVendorClass bizObj, MESBasicBaseVendorClass oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.randon1449472647159") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.randon1449472647159") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicBaseVendorClass bizObj, String bussinesskeyFieldName,
