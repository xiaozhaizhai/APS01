...
@Repository
public class MESBasicObjWareStoreDaoImpl extends ExtendedGenericDaoImpl<MESBasicObjWareStore, Long> implements MESBasicObjWareStoreDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_factoryModel_ObjWareStore,MESBasic_1) */
// 自定义代码
