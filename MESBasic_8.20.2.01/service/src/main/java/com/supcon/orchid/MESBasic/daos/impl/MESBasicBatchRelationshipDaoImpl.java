...
@Repository
public class MESBasicBatchRelationshipDaoImpl extends ExtendedGenericDaoImpl<MESBasicBatchRelationship, Long> implements MESBasicBatchRelationshipDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_batchInfo_BatchRelationship,MESBasic_1) */
// 自定义代码
