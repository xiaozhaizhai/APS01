...
@Service("mESBasicProdResetDailyImportService")
public class MESBasicProdResetDailyImportServiceImpl implements MESBasicProdResetDailyImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_product",model="MESBasic_1_product_ProdResetDaily",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicProdResetDaily bizObj, MESBasicProdResetDaily oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicProdResetDaily bizObj, String bussinesskeyFieldName,
