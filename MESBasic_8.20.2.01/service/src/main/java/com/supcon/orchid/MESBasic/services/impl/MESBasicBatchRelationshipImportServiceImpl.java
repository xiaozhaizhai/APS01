...
@Service("mESBasicBatchRelationshipImportService")
public class MESBasicBatchRelationshipImportServiceImpl implements MESBasicBatchRelationshipImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_batchInfo",model="MESBasic_1_batchInfo_BatchRelationship",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicBatchRelationship bizObj, MESBasicBatchRelationship oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicBatchRelationship bizObj, String bussinesskeyFieldName,
