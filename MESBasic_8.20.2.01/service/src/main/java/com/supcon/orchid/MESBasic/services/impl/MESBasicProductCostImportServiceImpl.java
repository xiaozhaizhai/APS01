...
@Service("mESBasicProductCostImportService")
public class MESBasicProductCostImportServiceImpl implements MESBasicProductCostImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_product",model="MESBasic_1_product_ProductCost",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicProductCost bizObj, MESBasicProductCost oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicProductCost bizObj, String bussinesskeyFieldName,
