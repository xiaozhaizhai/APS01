...
@Service("mESBasicFactoryModelImportService")
public class MESBasicFactoryModelImportServiceImpl implements MESBasicFactoryModelImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_FactoryModel",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicFactoryModel bizObj, MESBasicFactoryModel oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicFactoryModel bizObj, String bussinesskeyFieldName,
