...
@Service("mESBasicCprodAttImportService")
public class MESBasicCprodAttImportServiceImpl implements MESBasicCprodAttImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_product",model="MESBasic_1_product_CprodAtt",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicCprodAtt bizObj, MESBasicCprodAtt oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicCprodAtt bizObj, String bussinesskeyFieldName,
