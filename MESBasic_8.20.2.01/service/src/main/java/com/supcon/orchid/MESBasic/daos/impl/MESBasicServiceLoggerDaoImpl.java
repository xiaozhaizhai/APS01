...
@Repository
public class MESBasicServiceLoggerDaoImpl extends ExtendedGenericDaoImpl<MESBasicServiceLogger, Long> implements MESBasicServiceLoggerDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_backgroundServiceMonitor_ServiceLogger,MESBasic_1) */
// 自定义代码
