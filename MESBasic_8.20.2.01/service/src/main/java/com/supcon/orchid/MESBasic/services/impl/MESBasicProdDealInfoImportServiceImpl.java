...
@Service("mESBasicProdDealInfoImportService")
public class MESBasicProdDealInfoImportServiceImpl implements MESBasicProdDealInfoImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_product",model="MESBasic_1_product_ProdDealInfo",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicProdDealInfo bizObj, MESBasicProdDealInfo oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicProdDealInfo bizObj, String bussinesskeyFieldName,
