...
@Repository
public class MESBasicObjProductDaoImpl extends ExtendedGenericDaoImpl<MESBasicObjProduct, Long> implements MESBasicObjProductDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_factoryModel_ObjProduct,MESBasic_1) */
// 自定义代码
