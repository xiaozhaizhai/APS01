...
@Service("mESBasicObjBatContainerImportService")
public class MESBasicObjBatContainerImportServiceImpl implements MESBasicObjBatContainerImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjBatContainer",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicObjBatContainer bizObj, MESBasicObjBatContainer oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.radion1419232311198") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.radion1419232311198") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicObjBatContainer bizObj, String bussinesskeyFieldName,
