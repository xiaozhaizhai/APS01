...
@Service("mESBasicBatchDealInfoImportService")
public class MESBasicBatchDealInfoImportServiceImpl implements MESBasicBatchDealInfoImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_batchInfo",model="MESBasic_1_batchInfo_BatchDealInfo",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicBatchDealInfo bizObj, MESBasicBatchDealInfo oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicBatchDealInfo bizObj, String bussinesskeyFieldName,
