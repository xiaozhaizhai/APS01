...
@Service("mESBasicRoutineImportService")
public class MESBasicRoutineImportServiceImpl implements MESBasicRoutineImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_routine",model="MESBasic_1_routine_Routine",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicRoutine bizObj, MESBasicRoutine oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicRoutine bizObj, String bussinesskeyFieldName,
