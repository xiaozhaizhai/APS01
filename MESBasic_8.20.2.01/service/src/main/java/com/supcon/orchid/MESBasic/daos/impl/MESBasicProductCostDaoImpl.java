...
@Repository
public class MESBasicProductCostDaoImpl extends ExtendedGenericDaoImpl<MESBasicProductCost, Long> implements MESBasicProductCostDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_product_ProductCost,MESBasic_1) */
// 自定义代码
