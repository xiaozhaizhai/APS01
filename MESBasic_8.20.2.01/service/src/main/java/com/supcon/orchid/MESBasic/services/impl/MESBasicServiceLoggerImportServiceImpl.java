...
@Service("mESBasicServiceLoggerImportService")
public class MESBasicServiceLoggerImportServiceImpl implements MESBasicServiceLoggerImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_backgroundServiceMonitor",model="MESBasic_1_backgroundServiceMonitor_ServiceLogger",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicServiceLogger bizObj, MESBasicServiceLogger oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicServiceLogger bizObj, String bussinesskeyFieldName,
