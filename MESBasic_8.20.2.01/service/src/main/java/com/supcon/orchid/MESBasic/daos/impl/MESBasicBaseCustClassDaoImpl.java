...
@Repository
public class MESBasicBaseCustClassDaoImpl extends ExtendedGenericDaoImpl<MESBasicBaseCustClass, Long> implements MESBasicBaseCustClassDao {
	...
	public DataClassific getDataClassific(String code) {
	 ...
	 /* CUSTOM CODE START(daoimpl,functions,MESBasic_1_baseCustomer_BaseCustClass,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
}