...
@Repository
public class MESBasicMaintainLogDaoImpl extends ExtendedGenericDaoImpl<MESBasicMaintainLog, Long> implements MESBasicMaintainLogDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_container_MaintainLog,MESBasic_1) */
// 自定义代码
