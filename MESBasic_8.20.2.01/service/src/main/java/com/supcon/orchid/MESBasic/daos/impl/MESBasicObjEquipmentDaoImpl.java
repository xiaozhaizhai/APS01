...
@Repository
public class MESBasicObjEquipmentDaoImpl extends ExtendedGenericDaoImpl<MESBasicObjEquipment, Long> implements MESBasicObjEquipmentDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_factoryModel_ObjEquipment,MESBasic_1) */
// 自定义代码
