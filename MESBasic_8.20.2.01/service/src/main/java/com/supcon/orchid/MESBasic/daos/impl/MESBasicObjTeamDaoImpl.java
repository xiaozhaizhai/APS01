...
@Repository
public class MESBasicObjTeamDaoImpl extends ExtendedGenericDaoImpl<MESBasicObjTeam, Long> implements MESBasicObjTeamDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_factoryModel_ObjTeam,MESBasic_1) */
// 自定义代码
