...
@Repository
public class MESBasicConfigDaoImpl extends ExtendedGenericDaoImpl<MESBasicConfig, Long> implements MESBasicConfigDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_routine_Config,MESBasic_1) */
// 自定义代码
