...
@Service("mESBasicDataTransImportService")
public class MESBasicDataTransImportServiceImpl implements MESBasicDataTransImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_thirdDataHandler",model="MESBasic_1_thirdDataHandler_DataTrans",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicDataTrans bizObj, MESBasicDataTrans oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.radion1414977751020") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.radion1414977751020") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicDataTrans bizObj, String bussinesskeyFieldName,
