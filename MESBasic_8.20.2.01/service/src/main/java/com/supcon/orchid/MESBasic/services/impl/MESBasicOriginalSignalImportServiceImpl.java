...
@Service("mESBasicOriginalSignalImportService")
public class MESBasicOriginalSignalImportServiceImpl implements MESBasicOriginalSignalImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_originalSignal",model="MESBasic_1_originalSignal_OriginalSignal",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicOriginalSignal bizObj, MESBasicOriginalSignal oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.randon1556015436079") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.randon1556015436079") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicOriginalSignal bizObj, String bussinesskeyFieldName,
