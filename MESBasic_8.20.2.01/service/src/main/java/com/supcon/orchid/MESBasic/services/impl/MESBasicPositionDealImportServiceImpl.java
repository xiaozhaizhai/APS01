...
@Service("mESBasicPositionDealImportService")
public class MESBasicPositionDealImportServiceImpl implements MESBasicPositionDealImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_PositionDeal",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicPositionDeal bizObj, MESBasicPositionDeal oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicPositionDeal bizObj, String bussinesskeyFieldName,
