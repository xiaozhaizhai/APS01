...
@Service("mESBasicQACheckIndexImportService")
public class MESBasicQACheckIndexImportServiceImpl implements MESBasicQACheckIndexImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_checkIndex",model="MESBasic_1_checkIndex_QACheckIndex",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicQACheckIndex bizObj, MESBasicQACheckIndex oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.randon1491475975560") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.randon1491475975560") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicQACheckIndex bizObj, String bussinesskeyFieldName,
