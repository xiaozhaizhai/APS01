...
import com.supcon.orchid.MESBasic.daos.MESBasicVendorClassDao;
...
@Repository
public class MESBasicVendorClassDaoImpl extends ExtendedGenericDaoImpl<MESBasicVendorClass, Long> implements MESBasicVendorClassDao {
	...
	public DataClassific getDataClassific(String code) {
	 ...
	 /* CUSTOM CODE START(daoimpl,functions,MESBasic_1_baseVendor_VendorClass,MESBasic_1) */
// 自定义代码
