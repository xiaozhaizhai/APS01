...
@Service("mESBasicProdAttributeImportService")
public class MESBasicProdAttributeImportServiceImpl implements MESBasicProdAttributeImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_prodAttribute",model="MESBasic_1_prodAttribute_ProdAttribute",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicProdAttribute bizObj, MESBasicProdAttribute oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.randon1470292687185") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.randon1470292687185") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicProdAttribute bizObj, String bussinesskeyFieldName,
