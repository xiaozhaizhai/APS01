...
@Repository
public class MESBasicCprodAttDaoImpl extends ExtendedGenericDaoImpl<MESBasicCprodAtt, Long> implements MESBasicCprodAttDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_product_CprodAtt,MESBasic_1) */
// 自定义代码
