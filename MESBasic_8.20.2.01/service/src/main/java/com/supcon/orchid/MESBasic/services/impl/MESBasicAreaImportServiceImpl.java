...
@Service("mESBasicAreaImportService")
public class MESBasicAreaImportServiceImpl implements MESBasicAreaImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_area",model="MESBasic_1_area_Area",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicArea bizObj, MESBasicArea oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.randon1524635258631") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.randon1524635258631") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicArea bizObj, String bussinesskeyFieldName,
