...
@Repository
public class MESBasicItemSeqDaoImpl extends ExtendedGenericDaoImpl<MESBasicItemSeq, Long> implements MESBasicItemSeqDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_thirdDataHandler_ItemSeq,MESBasic_1) */
// 自定义代码
