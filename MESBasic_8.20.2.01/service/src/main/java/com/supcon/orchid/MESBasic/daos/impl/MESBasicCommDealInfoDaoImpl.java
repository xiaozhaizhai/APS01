...
@Repository
public class MESBasicCommDealInfoDaoImpl extends ExtendedGenericDaoImpl<MESBasicCommDealInfo, Long> implements MESBasicCommDealInfoDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_product_CommDealInfo,MESBasic_1) */
// 自定义代码
