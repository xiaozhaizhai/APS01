...
@Service("mESBasicProdSecUnitImportService")
public class MESBasicProdSecUnitImportServiceImpl implements MESBasicProdSecUnitImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_product",model="MESBasic_1_product_ProdSecUnit",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicProdSecUnit bizObj, MESBasicProdSecUnit oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicProdSecUnit bizObj, String bussinesskeyFieldName,
