...
@Service("mESBasicDepartmentWareImportService")
public class MESBasicDepartmentWareImportServiceImpl implements MESBasicDepartmentWareImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_factoryWare",model="MESBasic_1_factoryWare_DepartmentWare",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicDepartmentWare bizObj, MESBasicDepartmentWare oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicDepartmentWare bizObj, String bussinesskeyFieldName,
