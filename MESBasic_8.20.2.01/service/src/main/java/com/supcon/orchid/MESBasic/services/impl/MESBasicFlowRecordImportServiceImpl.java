...
@Service("mESBasicFlowRecordImportService")
public class MESBasicFlowRecordImportServiceImpl implements MESBasicFlowRecordImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_container",model="MESBasic_1_container_FlowRecord",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicFlowRecord bizObj, MESBasicFlowRecord oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicFlowRecord bizObj, String bussinesskeyFieldName,
