...
@Service("mESBasicPropertyTagsImportService")
public class MESBasicPropertyTagsImportServiceImpl implements MESBasicPropertyTagsImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_container",model="MESBasic_1_container_PropertyTags",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicPropertyTags bizObj, MESBasicPropertyTags oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicPropertyTags bizObj, String bussinesskeyFieldName,
