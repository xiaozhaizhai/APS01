...
@Service("mESBasicObjProductImportService")
public class MESBasicObjProductImportServiceImpl implements MESBasicObjProductImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjProduct",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicObjProduct bizObj, MESBasicObjProduct oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicObjProduct bizObj, String bussinesskeyFieldName,
