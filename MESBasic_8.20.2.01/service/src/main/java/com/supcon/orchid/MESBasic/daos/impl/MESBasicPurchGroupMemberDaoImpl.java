...
@Repository
public class MESBasicPurchGroupMemberDaoImpl extends ExtendedGenericDaoImpl<MESBasicPurchGroupMember, Long> implements MESBasicPurchGroupMemberDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_purch_Group_PurchGroupMember,MESBasic_1) */
// 自定义代码
