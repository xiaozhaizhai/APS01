...
@Service("mESBasicInterfaceLogImportService")
public class MESBasicInterfaceLogImportServiceImpl implements MESBasicInterfaceLogImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_pimsInterface",model="MESBasic_1_pimsInterface_InterfaceLog",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicInterfaceLog bizObj, MESBasicInterfaceLog oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.randon1426817426879") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.randon1426817426879") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicInterfaceLog bizObj, String bussinesskeyFieldName,
