...
@Repository
public class MESBasicProdResetDailyDaoImpl extends ExtendedGenericDaoImpl<MESBasicProdResetDaily, Long> implements MESBasicProdResetDailyDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_product_ProdResetDaily,MESBasic_1) */
// 自定义代码
