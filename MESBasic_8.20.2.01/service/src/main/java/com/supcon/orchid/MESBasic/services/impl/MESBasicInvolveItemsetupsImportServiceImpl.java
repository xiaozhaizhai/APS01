...
@Service("mESBasicInvolveItemsetupsImportService")
public class MESBasicInvolveItemsetupsImportServiceImpl implements MESBasicInvolveItemsetupsImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_routine",model="MESBasic_1_routine_InvolveItemsetups",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicInvolveItemsetups bizObj, MESBasicInvolveItemsetups oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.radion1415336450425") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.radion1415336450425") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicInvolveItemsetups bizObj, String bussinesskeyFieldName,
