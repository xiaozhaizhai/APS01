...
@Service("mESBasicProdattrelImportService")
public class MESBasicProdattrelImportServiceImpl implements MESBasicProdattrelImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_prodatriel",model="MESBasic_1_prodatriel_Prodattrel",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicProdattrel bizObj, MESBasicProdattrel oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.randon1482909852445") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.randon1482909852445") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicProdattrel bizObj, String bussinesskeyFieldName,
