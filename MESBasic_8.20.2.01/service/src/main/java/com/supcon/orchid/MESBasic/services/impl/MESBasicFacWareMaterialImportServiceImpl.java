...
@Service("mESBasicFacWareMaterialImportService")
public class MESBasicFacWareMaterialImportServiceImpl implements MESBasicFacWareMaterialImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_factoryWare",model="MESBasic_1_factoryWare_FacWareMaterial",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicFacWareMaterial bizObj, MESBasicFacWareMaterial oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.randon1489731859348") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.randon1489731859348") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicFacWareMaterial bizObj, String bussinesskeyFieldName,
