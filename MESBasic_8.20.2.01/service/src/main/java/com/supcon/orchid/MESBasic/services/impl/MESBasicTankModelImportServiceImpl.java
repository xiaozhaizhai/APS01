...
@Service("mESBasicTankModelImportService")
public class MESBasicTankModelImportServiceImpl implements MESBasicTankModelImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_tankModel",model="MESBasic_1_tankModel_TankModel",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicTankModel bizObj, MESBasicTankModel oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.radion1415150373047") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.radion1415150373047") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicTankModel bizObj, String bussinesskeyFieldName,
