...
@Service("mESBasicCommDealInfoImportService")
public class MESBasicCommDealInfoImportServiceImpl implements MESBasicCommDealInfoImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_product",model="MESBasic_1_product_CommDealInfo",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicCommDealInfo bizObj, MESBasicCommDealInfo oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicCommDealInfo bizObj, String bussinesskeyFieldName,
