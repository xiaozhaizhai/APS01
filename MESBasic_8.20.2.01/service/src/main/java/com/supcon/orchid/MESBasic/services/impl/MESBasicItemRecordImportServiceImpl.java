...
@Service("mESBasicItemRecordImportService")
public class MESBasicItemRecordImportServiceImpl implements MESBasicItemRecordImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_itemRecord",model="MESBasic_1_itemRecord_ItemRecord",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicItemRecord bizObj, MESBasicItemRecord oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.radion1415340239152") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.radion1415340239152") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicItemRecord bizObj, String bussinesskeyFieldName,
