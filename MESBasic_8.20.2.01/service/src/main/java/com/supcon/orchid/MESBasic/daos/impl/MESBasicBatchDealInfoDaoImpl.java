...
@Repository
public class MESBasicBatchDealInfoDaoImpl extends ExtendedGenericDaoImpl<MESBasicBatchDealInfo, Long> implements MESBasicBatchDealInfoDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_batchInfo_BatchDealInfo,MESBasic_1) */
// 自定义代码
