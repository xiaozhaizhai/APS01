...
@Service("mESBasicProdLevelImportService")
public class MESBasicProdLevelImportServiceImpl implements MESBasicProdLevelImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_product",model="MESBasic_1_product_ProdLevel",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicProdLevel bizObj, MESBasicProdLevel oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicProdLevel bizObj, String bussinesskeyFieldName,
