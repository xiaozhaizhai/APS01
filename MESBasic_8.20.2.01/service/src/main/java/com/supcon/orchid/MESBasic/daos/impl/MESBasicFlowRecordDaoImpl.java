...
@Repository
public class MESBasicFlowRecordDaoImpl extends ExtendedGenericDaoImpl<MESBasicFlowRecord, Long> implements MESBasicFlowRecordDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_container_FlowRecord,MESBasic_1) */
// 自定义代码
