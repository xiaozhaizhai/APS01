...
@Service("mESBasicObjWareStoreImportService")
public class MESBasicObjWareStoreImportServiceImpl implements MESBasicObjWareStoreImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjWareStore",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicObjWareStore bizObj, MESBasicObjWareStore oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicObjWareStore bizObj, String bussinesskeyFieldName,
