...
@Service("mESBasicItemSeqImportService")
public class MESBasicItemSeqImportServiceImpl implements MESBasicItemSeqImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_thirdDataHandler",model="MESBasic_1_thirdDataHandler_ItemSeq",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicItemSeq bizObj, MESBasicItemSeq oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicItemSeq bizObj, String bussinesskeyFieldName,
