...
@Service("mESBasicEquipmentImportService")
public class MESBasicEquipmentImportServiceImpl implements MESBasicEquipmentImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_equipManage",model="MESBasic_1_equipManage_Equipment",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicEquipment bizObj, MESBasicEquipment oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.randon1423967167580") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.randon1423967167580") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicEquipment bizObj, String bussinesskeyFieldName,
