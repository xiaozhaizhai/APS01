...
@Repository
public class MESBasicClearSingetDaoImpl extends ExtendedGenericDaoImpl<MESBasicClearSinget, Long> implements MESBasicClearSingetDao {
	@Override
	...
	@Override
	public MESBasicClearSingetDealInfo copyAndSaveDealInfo(DealInfo di) {
		MESBasicClearSingetDealInfo dealInfo = new MESBasicClearSingetDealInfo();
	...
	@Override
	public MESBasicClearSingetDealInfo copyAndSaveDealInfo(DealInfo di, MESBasicClearSinget mainObj, Staff dealStaff) {
		MESBasicClearSingetDealInfo dealInfo = copyAndSaveDealInfo(di);
	...
	public Date findLastDealInfo(Long tableInfoId, String activityName) {
		Criteria criteria = getSession().createCriteria(MESBasicClearSingetDealInfo.class);
		...
		List<MESBasicClearSingetDealInfo> dealinfo = criteria.list();
		return (dealinfo!=null&&!dealinfo.isEmpty()) ? dealinfo.get(0).getCreateTime() : null;
	}

	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_clearSinget_ClearSinget,MESBasic_1) */
// 自定义代码
