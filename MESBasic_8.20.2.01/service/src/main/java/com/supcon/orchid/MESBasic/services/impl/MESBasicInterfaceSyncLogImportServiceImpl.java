...
@Service("mESBasicInterfaceSyncLogImportService")
public class MESBasicInterfaceSyncLogImportServiceImpl implements MESBasicInterfaceSyncLogImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_interfaceSyncLog",model="MESBasic_1_interfaceSyncLog_InterfaceSyncLog",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicInterfaceSyncLog bizObj, MESBasicInterfaceSyncLog oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.randon1493192045837") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.randon1493192045837") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicInterfaceSyncLog bizObj, String bussinesskeyFieldName,
