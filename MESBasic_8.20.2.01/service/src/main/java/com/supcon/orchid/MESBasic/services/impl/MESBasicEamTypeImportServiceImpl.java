...
@Service("mESBasicEamTypeImportService")
public class MESBasicEamTypeImportServiceImpl implements MESBasicEamTypeImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_eamType",model="MESBasic_1_eamType_EamType",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicEamType bizObj, MESBasicEamType oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.randon1516068319335") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.randon1516068319335") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicEamType bizObj, String bussinesskeyFieldName,
