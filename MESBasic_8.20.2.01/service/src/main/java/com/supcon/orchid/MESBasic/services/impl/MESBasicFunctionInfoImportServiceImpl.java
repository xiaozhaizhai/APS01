...
@Service("mESBasicFunctionInfoImportService")
public class MESBasicFunctionInfoImportServiceImpl implements MESBasicFunctionInfoImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_container",model="MESBasic_1_container_FunctionInfo",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicFunctionInfo bizObj, MESBasicFunctionInfo oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.radion1415252093775") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.radion1415252093775") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicFunctionInfo bizObj, String bussinesskeyFieldName,
