...
@Repository
public class MESBasicProdSecUnitDaoImpl extends ExtendedGenericDaoImpl<MESBasicProdSecUnit, Long> implements MESBasicProdSecUnitDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_product_ProdSecUnit,MESBasic_1) */
// 自定义代码
