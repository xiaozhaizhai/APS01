...
@Service("mESBasicNodeTypeImportService")
public class MESBasicNodeTypeImportServiceImpl implements MESBasicNodeTypeImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_nodeType",model="MESBasic_1_nodeType_NodeType",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicNodeType bizObj, MESBasicNodeType oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.randon1460947272892") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.randon1460947272892") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicNodeType bizObj, String bussinesskeyFieldName,
