...
@Repository
public class MESBasicDepartmentWareDaoImpl extends ExtendedGenericDaoImpl<MESBasicDepartmentWare, Long> implements MESBasicDepartmentWareDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_factoryWare_DepartmentWare,MESBasic_1) */
// 自定义代码
