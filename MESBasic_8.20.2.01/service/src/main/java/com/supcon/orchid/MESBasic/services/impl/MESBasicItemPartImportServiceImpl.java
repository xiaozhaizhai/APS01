...
@Service("mESBasicItemPartImportService")
public class MESBasicItemPartImportServiceImpl implements MESBasicItemPartImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_itemManage",model="MESBasic_1_itemManage_ItemPart",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicItemPart bizObj, MESBasicItemPart oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicItemPart bizObj, String bussinesskeyFieldName,
