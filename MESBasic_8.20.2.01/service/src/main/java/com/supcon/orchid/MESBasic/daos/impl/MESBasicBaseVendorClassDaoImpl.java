...
@Repository
public class MESBasicBaseVendorClassDaoImpl extends TreeDaoImpl<MESBasicBaseVendorClass, Long> implements MESBasicBaseVendorClassDao {
	@Override
	...
	@Override
	public MESBasicBaseVendorClassDealInfo copyAndSaveDealInfo(DealInfo di) {
		MESBasicBaseVendorClassDealInfo dealInfo = new MESBasicBaseVendorClassDealInfo();
	...
	@Override
	public MESBasicBaseVendorClassDealInfo copyAndSaveDealInfo(DealInfo di, MESBasicBaseVendorClass mainObj, Staff dealStaff) {
		MESBasicBaseVendorClassDealInfo dealInfo = copyAndSaveDealInfo(di);
	...
	public Date findLastDealInfo(Long tableInfoId, String activityName) {
		Criteria criteria = getSession().createCriteria(MESBasicBaseVendorClassDealInfo.class);
		...
		List<MESBasicBaseVendorClassDealInfo> dealinfo = criteria.list();
		return (dealinfo!=null&&!dealinfo.isEmpty()) ? dealinfo.get(0).getCreateTime() : null;
	}

	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_baseVenderClass_BaseVendorClass,MESBasic_1) */
// 自定义代码
