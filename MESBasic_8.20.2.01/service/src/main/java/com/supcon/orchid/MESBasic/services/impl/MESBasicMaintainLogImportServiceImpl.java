...
@Service("mESBasicMaintainLogImportService")
public class MESBasicMaintainLogImportServiceImpl implements MESBasicMaintainLogImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_container",model="MESBasic_1_container_MaintainLog",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicMaintainLog bizObj, MESBasicMaintainLog oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicMaintainLog bizObj, String bussinesskeyFieldName,
