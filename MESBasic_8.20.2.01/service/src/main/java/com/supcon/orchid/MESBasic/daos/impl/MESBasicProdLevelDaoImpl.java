...
@Repository
public class MESBasicProdLevelDaoImpl extends ExtendedGenericDaoImpl<MESBasicProdLevel, Long> implements MESBasicProdLevelDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_product_ProdLevel,MESBasic_1) */
// 自定义代码
