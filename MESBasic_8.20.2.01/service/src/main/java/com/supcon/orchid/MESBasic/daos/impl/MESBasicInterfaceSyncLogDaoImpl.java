...
@Repository
public class MESBasicInterfaceSyncLogDaoImpl extends ExtendedGenericDaoImpl<MESBasicInterfaceSyncLog, Long> implements MESBasicInterfaceSyncLogDao {
	@Override
	...
	@Override
	public MESBasicInterfaceSyncLogDealInfo copyAndSaveDealInfo(DealInfo di) {
		MESBasicInterfaceSyncLogDealInfo dealInfo = new MESBasicInterfaceSyncLogDealInfo();
	...
	@Override
	public MESBasicInterfaceSyncLogDealInfo copyAndSaveDealInfo(DealInfo di, MESBasicInterfaceSyncLog mainObj, Staff dealStaff) {
		MESBasicInterfaceSyncLogDealInfo dealInfo = copyAndSaveDealInfo(di);
	...
	public Date findLastDealInfo(Long tableInfoId, String activityName) {
		Criteria criteria = getSession().createCriteria(MESBasicInterfaceSyncLogDealInfo.class);
		...
		List<MESBasicInterfaceSyncLogDealInfo> dealinfo = criteria.list();
		return (dealinfo!=null&&!dealinfo.isEmpty()) ? dealinfo.get(0).getCreateTime() : null;
	}

	/* CUSTOM CODE START(daoimpl,functions,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码
