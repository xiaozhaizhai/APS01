...
import com.supcon.orchid.MESBasic.services.MESBasicWareClassImportService;

@Service("mESBasicWareClassImportService")
public class MESBasicWareClassImportServiceImpl implements MESBasicWareClassImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_wareClass",model="MESBasic_1_wareClass_WareClass",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicWareClass bizObj, MESBasicWareClass oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.randon1516252112501") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.randon1516252112501") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicWareClass bizObj, String bussinesskeyFieldName,
