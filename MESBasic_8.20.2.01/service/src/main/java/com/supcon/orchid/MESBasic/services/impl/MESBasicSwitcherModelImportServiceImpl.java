...
@Service("mESBasicSwitcherModelImportService")
public class MESBasicSwitcherModelImportServiceImpl implements MESBasicSwitcherModelImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_routine",model="MESBasic_1_routine_SwitcherModel",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicSwitcherModel bizObj, MESBasicSwitcherModel oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicSwitcherModel bizObj, String bussinesskeyFieldName,
