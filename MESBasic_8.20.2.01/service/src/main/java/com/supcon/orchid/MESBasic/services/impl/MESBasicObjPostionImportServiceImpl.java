...
@Service("mESBasicObjPostionImportService")
public class MESBasicObjPostionImportServiceImpl implements MESBasicObjPostionImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_factoryModel",model="MESBasic_1_factoryModel_ObjPostion",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicObjPostion bizObj, MESBasicObjPostion oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicObjPostion bizObj, String bussinesskeyFieldName,
