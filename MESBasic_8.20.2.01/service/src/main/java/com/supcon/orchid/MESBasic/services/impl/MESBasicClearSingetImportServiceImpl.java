...
@Service("mESBasicClearSingetImportService")
public class MESBasicClearSingetImportServiceImpl implements MESBasicClearSingetImportService {
	...
	@Override
	@AuditLog(entity="MESBasic_1_clearSinget",model="MESBasic_1_clearSinget_ClearSinget",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MESBasicClearSinget bizObj, MESBasicClearSinget oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("MESBasic.entityname.randon1554193916613") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("MESBasic.entityname.randon1554193916613") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MESBasicClearSinget bizObj, String bussinesskeyFieldName,
