...
<#assign viewCode = 'MESBasic_1_eamType_EamType' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1516068419324')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'name' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'typeMemo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1516068698045')}</Data></Cell>
											</#if>
									...
									<#if item?length gt 0>
												...
												<#if item == 'typeMemo' || item == '*'>
													<Cell>
														...
														<#if data.typeMemo??><Data ss:Type="String"><![CDATA[${(data.typeMemo)!}]]></Data></#if>
