...
<script type="text/javascript">
	...
	function download(){
		//var url = "/MESBasic/container/container/downLoad.action?viewCode=MESBasic_1_container_newContainerList&orgName=MESBasic_1_container_newContainerList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/MESBasic/container/container/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
