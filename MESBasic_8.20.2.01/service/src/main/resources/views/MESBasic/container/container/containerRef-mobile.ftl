...
<script type="text/javascript">
	CUI.ns("MESBasic.container.container","MESBasic.container.container.containerRef");
</script>
<div class="container"  style="padding-top:10px;">
	...
	<div id="ec_MESBasic_container_container_containerRef_queryForm_inputValue">
	...
	<form onsubmit="return false" id="ec_MESBasic_container_container_containerRef_queryForm" exportUrl="/MESBasic/container/container/containerRef-query.action">
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
											...
											<#if (code_defaultValue)?has_content>
												<@mneclient formId="ec_MESBasic_container_container_containerRef_queryForm" isPrecise=true isCrossCompany=isCrossCompany value="${code_defaultValue!}" deValue="${code_defaultValue!}"   conditionfunc="MESBasic.container.container.containerRef._querycustomFunc('code')" name="code" id="ec_MESBasic_container_container_containerRef_queryForm_code" displayFieldName="code" exp="like" classStyle="form-control"  url="/MESBasic/container/container/mneClient.action" multiple=false mnewidth=260 searchClick="MESBasic.container.container.containerRef.commonQuery('query')" />
											<#else>
												<@mneclient formId="ec_MESBasic_container_container_containerRef_queryForm" isPrecise=true isCrossCompany=isCrossCompany  conditionfunc="MESBasic.container.container.containerRef._querycustomFunc('code')" name="code" id="ec_MESBasic_container_container_containerRef_queryForm_code" displayFieldName="code" exp="like" classStyle="form-control"  url="/MESBasic/container/container/mneClient.action" multiple=false mnewidth=260 searchClick="MESBasic.container.container.containerRef.commonQuery('query')" />
											</#if>
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
											...
											<#if (name_defaultValue)?has_content>
												<@mneclient formId="ec_MESBasic_container_container_containerRef_queryForm" isPrecise=true isCrossCompany=isCrossCompany value="${name_defaultValue!}" deValue="${name_defaultValue!}"   conditionfunc="MESBasic.container.container.containerRef._querycustomFunc('name')" name="name" id="ec_MESBasic_container_container_containerRef_queryForm_name" displayFieldName="name" exp="like" classStyle="form-control"  url="/MESBasic/container/container/mneClient.action" multiple=false mnewidth=260 searchClick="MESBasic.container.container.containerRef.commonQuery('query')" />
											<#else>
												<@mneclient formId="ec_MESBasic_container_container_containerRef_queryForm" isPrecise=true isCrossCompany=isCrossCompany  conditionfunc="MESBasic.container.container.containerRef._querycustomFunc('name')" name="name" id="ec_MESBasic_container_container_containerRef_queryForm_name" displayFieldName="name" exp="like" classStyle="form-control"  url="/MESBasic/container/container/mneClient.action" multiple=false mnewidth=260 searchClick="MESBasic.container.container.containerRef.commonQuery('query')" />
											</#if>
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
											...
											<input type="hidden" id="equip.id" name="equip.id" value="" />
												<@mneclient mneenable=true isPrecise=true isCrossCompany=isCrossCompany reftitle="${getText('MESBasic.viewtitle.randon1423967959681')}"  conditionfunc="MESBasic.container.container.containerRef._querycustomFunc('equip_name')" name="equip.name" id="ec_MESBasic_container_container_containerRef_queryForm_equip_name" displayFieldName="name" type="other" exp="like" classStyle="form-control" url="/MESBasic/equipManage/equipment/ref.action" clicked=true multiple=false mnewidth=260 formId="ec_MESBasic_container_container_containerRef_queryForm" searchClick="MESBasic.container.container.containerRef.commonQuery('query')" />
											
									</div>			
								</div>
							</div>
						<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 margin-bottom-5">						
				       	<@querybutton formId="ec_MESBasic_container_container_containerRef_queryForm" type="search" onclick="MESBasic.container.container.containerRef.commonQuery('query')" /> 
...
<script>
	$(function(){
		var buttons = $( 'button.btn-list', '#ec_MESBasic_container_container_containerRef_queryForm' );
		if( buttons.length > 0 ){
			// 去掉按钮间的空格
...
ec_MESBasic_container_container_containerRef_quickquery_info["equip.id"].columnName="ID";
</script>		</div>
	</div> 
...
<@datatable id="ec_MESBasic_container_container_containerRef_query" renderOverEvent="ec_MESBasic_container_container_containerRef_RenderOverEvent"  modelCode="MESBasic_1_container_Container" noPermissionKeys="code,name,containerType,equip.name,containerStatus,department.name,model.name,product.productName" hidekeyPrefix="ec_MESBasic_container_container_containerRef_query" orderMode="backstage" queryFunc=datatable_queryFunc formId="ec_MESBasic_container_container_containerRef_queryForm" firstLoad=datatable_firstLoad  exportExcel=true style="margin-left:13px;margin-right:4px;" editable=false dtPage="page" dataUrl=datatable_dataUrl transMethod="post" hidekey="['id','version','containerType.id','containerStatus.id','equip.id','department.id','model.id','product.id']" postData="&${(condition!'')}&permissionCode=${permissionCode!''}">
	<#if (Session['touchScreen']?? && Session['touchScreen']??)>
			...
			<@datacolumn   showFormat="TEXT" defaultDisplay="${code_displayDefaultType!}"  key="code"   label="${getText('MESBasic.propertydisplayName.radion1415268359829')}" textalign="left"  width=120   type="textfield"    showFormatFunc=""/>
			<#assign name_displayDefaultType  = ''>
			<@datacolumn   showFormat="TEXT" defaultDisplay="${name_displayDefaultType!}"  key="name"   label="${getText('MESBasic.propertydisplayName.radion1415268393452')}" textalign="left"  width=120   type="textfield"    showFormatFunc=""/>
			<#assign containerType_displayDefaultType  = ''>
			<@datacolumn   showFormat="SELECTCOMP" defaultDisplay="${containerType_displayDefaultType!}"  key="containerType.value"   label="${getText('MESBasic.propertydisplayName.radion1415320693399')}" textalign="left"  width=100   type="systemcode"    showFormatFunc=""/>
			...
			<@datacolumn   showFormat="SELECTCOMP" defaultDisplay="${containerStatus_displayDefaultType!}"  key="containerStatus.value"   label="${getText('MESBasic.propertydisplayName.radion1415322023968')}" textalign="left"  width=100   type="systemcode"    showFormatFunc=""/>
			<#assign department_name_displayDefaultType  = ''>
			<@datacolumn   showFormat="TEXT" defaultDisplay="${department_name_displayDefaultType!}"  key="department.name"   label="${getText('part.fzwdy.xm.mainPositionId.department.name')}" textalign="left"  width=100   type="textfield"    showFormatFunc=""/>
			<#assign model_name_displayDefaultType  = ''>
			<@datacolumn   showFormat="TEXT" defaultDisplay="${model_name_displayDefaultType!}"  key="model.name"   label="${getText('MESBasic.propertydisplayName.radion1415150519135')}" textalign="left"  width=100   type="textfield"    showFormatFunc=""/>
...
<script type="text/javascript">
	 ...
	 */
	MESBasic.container.container.containerRef.query = function(type,pageNo){
		...
		if(!checkListValid("ec_MESBasic_container_container_containerRef_queryForm")) {
				return false;
		}
		var dataPost = "";
		...
		url += "&crossCompanyFlag=${Parameters.crossCompanyFlag!}";
	 	datatable_ec_MESBasic_container_container_containerRef_query.setRequestDataUrl(url,dataPost);
		return false;
	};
	...
	foundation.common.${requestUri!}__callbackFunction = function(){
		...
		var oRows = datatable_ec_MESBasic_container_container_containerRef_query.getSelectedRow();
		if(oRows.length == 0){
		...
		try{
			if(CUI("#MESBasic_container_container_containerRef_callBackFuncName").val() != ""){
				eval(CUI("#MESBasic_container_container_containerRef_callBackFuncName").val() + "(arrObj)");
			}
		}catch(e){
		}
	};
...
MESBasic_container_container_containerRef_refresh = function(node){
	//var url = "/MESBasic/container/container/containerRef-query.action";
	//if(node.layRec){
	//	datatable_ec_MESBasic_container_container_containerRef_query.setRequestDataUrl(url,'&'+node.modelName+'.layRec=' + node.layRec,false);
	//}else{
	//	datatable_ec_MESBasic_container_container_containerRef_query.setRequestDataUrl(url,'',false);
	//}
...
MESBasic.container.container.containerRef.showLinkView = function(url,propertyId,row,formId,title,width,height,dialogType){
	...
	if(formId) {
		MESBasic.container.container.containerRef.showDialog(url,formId,title,width,height);
	}else {
		openFullScreen(url);
	}
};
...
function checkListValid(formId){return true;};
	...
	/* CUSTOM CODE START(view-REFERENCE-MESBasic_1_container_containerRef,js,MESBasic_1_container_Container,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
	</script>
  </body>
