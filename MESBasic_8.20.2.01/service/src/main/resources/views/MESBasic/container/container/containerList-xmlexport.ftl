...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="equip.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="model.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="name">
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'containerType.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415268359829')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415268393452')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'containerType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415320693399')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'equip.name' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'containerStatus.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415322023968')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'department.name' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'model.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415150519135')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'product.productName' || item == '*'>
									...
									<#if item?length gt 0>
												...
												<#if item == 'containerType.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.containerType.value)!}')}</Data>
												...
												<#if item == 'equip.name' || item == '*'>
													<Cell>
														...
														<#if data.equip.name??><Data ss:Type="String"><![CDATA[${(data.equip.name)!}]]></Data></#if>
												...
												<#if item == 'model.name' || item == '*'>
													<Cell>
														...
														<#if data.model.name??><Data ss:Type="String"><![CDATA[${(data.model.name)!}]]></Data></#if>
