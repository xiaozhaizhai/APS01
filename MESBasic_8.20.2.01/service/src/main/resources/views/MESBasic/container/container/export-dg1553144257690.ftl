 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								<#if item == 'name' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1553144942140')}</Data>
										</Cell>
								</#if>
								<#if item == 'representCode' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1553144955108')}</Data>
										</Cell>
								</#if>
								<#if item == 'code' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1553144902565')}</Data>
										</Cell>
								</#if>
					...
					<#if item?length gt 0>
								...
								<#if item == 'representCode' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.representCode)??>${(data.representCode)!}</#if></Data>
