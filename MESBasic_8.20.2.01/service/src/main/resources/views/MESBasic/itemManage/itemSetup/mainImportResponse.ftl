...
<script type="text/javascript">
	...
	function download(){
		//var url = "/MESBasic/itemManage/itemSetup/downLoad.action?viewCode=MESBasic_1_itemManage_itemList&orgName=MESBasic_1_itemManage_itemList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/MESBasic/itemManage/itemSetup/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
