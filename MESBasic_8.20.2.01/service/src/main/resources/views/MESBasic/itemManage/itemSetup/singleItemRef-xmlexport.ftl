...
<#assign viewCode = 'MESBasic_1_itemManage_ItemSetup' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="itemClass">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="itemName">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="itemNumber">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="itemPlace.placeName">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="tagType">
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'itemPlace.placeName' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'tagType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415260997658')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'itemClass.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1416380194525')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'virtualTag' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415261562719')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'itemPlace.placeName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1418607347494')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'crtValue' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415260736864')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'updatTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415260814187')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												...
												<#if item == 'itemNumber' || item == '*'>
													<Cell>
														...
														<#if data.itemNumber??><Data ss:Type="String"><![CDATA[${(data.itemNumber)!}]]></Data></#if>
												...
												<#if item == 'itemName' || item == '*'>
													<Cell>
														...
														<#if data.itemName??><Data ss:Type="String"><![CDATA[${(data.itemName)!}]]></Data></#if>
												...
												<#if item == 'itemClass.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.itemClass.value)!}')}</Data>
												...
												<#if item == 'itemPlace.placeName' || item == '*'>
													<Cell>
														...
														<#if data.itemPlace.placeName??><Data ss:Type="String"><![CDATA[${(data.itemPlace.placeName)!}]]></Data></#if>
												...
												<#if item == 'updatTime' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.updatTime??><Data ss:Type="DateTime">${(data.updatTime)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
