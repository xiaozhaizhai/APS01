 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0 && item != "checkbox">
									...
									<#if item == 'itemStatus.value' || item == 'itemStatus.id' || item == '*'>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								...
								<#if item == 'itemNumber' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415259532954')}</Data>
										</Cell>
								</#if>
								<#if item == 'itemStatus.value' || item == 'itemStatus.id' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1559183315388')}</Data>
										</Cell>
								</#if>
					...
					<#if item?length gt 0>
								...
								<#if item == 'itemNumber' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.itemNumber)??>${(data.itemNumber)!}</#if></Data>
								...
								<#if item == 'itemStatus.value' || item == 'itemStatus.id' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String">${getText('${(data.itemStatus.value)!}')}</Data>
