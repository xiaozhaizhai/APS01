...
<script type="text/javascript">
	CUI.ns("MESBasic.itemManage.itemSetup","MESBasic.itemManage.itemSetup.itemRefForContainer");
</script>
<div class="container"  style="padding-top:10px;">
	...
	<div id="ec_MESBasic_itemManage_itemSetup_itemRefForContainer_queryForm_inputValue">
	...
	<form onsubmit="return false" id="ec_MESBasic_itemManage_itemSetup_itemRefForContainer_queryForm" exportUrl="/MESBasic/itemManage/itemSetup/itemRefForContainer-query.action">
		...
		<input type="hidden" id="dataTableSortColOrder" name="dataTableSortColOrder" />
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
											...
											<#if (itemName_defaultValue)?has_content>
												<@mneclient formId="ec_MESBasic_itemManage_itemSetup_itemRefForContainer_queryForm" isPrecise=true isCrossCompany=isCrossCompany value="${itemName_defaultValue!}" deValue="${itemName_defaultValue!}"   conditionfunc="MESBasic.itemManage.itemSetup.itemRefForContainer._querycustomFunc('itemName')" name="itemName" id="ec_MESBasic_itemManage_itemSetup_itemRefForContainer_queryForm_itemName" displayFieldName="itemName" exp="like" classStyle="form-control"  url="/MESBasic/itemManage/itemSetup/mneClient.action" multiple=false mnewidth=260 searchClick="MESBasic.itemManage.itemSetup.itemRefForContainer.commonQuery('query')" />
											<#else>
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
											...
											<#if (itemNumber_defaultValue)?has_content>
												<@mneclient formId="ec_MESBasic_itemManage_itemSetup_itemRefForContainer_queryForm" isPrecise=true isCrossCompany=isCrossCompany value="${itemNumber_defaultValue!}" deValue="${itemNumber_defaultValue!}"   conditionfunc="MESBasic.itemManage.itemSetup.itemRefForContainer._querycustomFunc('itemNumber')" name="itemNumber" id="ec_MESBasic_itemManage_itemSetup_itemRefForContainer_queryForm_itemNumber" displayFieldName="itemNumber" exp="like" classStyle="form-control"  url="/MESBasic/itemManage/itemSetup/mneClient.action" multiple=false mnewidth=260 searchClick="MESBasic.itemManage.itemSetup.itemRefForContainer.commonQuery('query')" />
											<#else>
												<@mneclient formId="ec_MESBasic_itemManage_itemSetup_itemRefForContainer_queryForm" isPrecise=true isCrossCompany=isCrossCompany  conditionfunc="MESBasic.itemManage.itemSetup.itemRefForContainer._querycustomFunc('itemNumber')" name="itemNumber" id="ec_MESBasic_itemManage_itemSetup_itemRefForContainer_queryForm_itemNumber" displayFieldName="itemNumber" exp="like" classStyle="form-control"  url="/MESBasic/itemManage/itemSetup/mneClient.action" multiple=false mnewidth=260 searchClick="MESBasic.itemManage.itemSetup.itemRefForContainer.commonQuery('query')" />
											</#if>
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
											...
											<#if (code_defaultValue)?has_content>
												<@mneclient formId="ec_MESBasic_itemManage_itemSetup_itemRefForContainer_queryForm" isPrecise=true isCrossCompany=isCrossCompany value="${code_defaultValue!}" deValue="${code_defaultValue!}"   conditionfunc="MESBasic.itemManage.itemSetup.itemRefForContainer._querycustomFunc('code')" name="code" id="ec_MESBasic_itemManage_itemSetup_itemRefForContainer_queryForm_code" displayFieldName="code" exp="like" classStyle="form-control"  url="/MESBasic/itemManage/itemSetup/mneClient.action" multiple=false mnewidth=260 searchClick="MESBasic.itemManage.itemSetup.itemRefForContainer.commonQuery('query')" />
											<#else>
												<@mneclient formId="ec_MESBasic_itemManage_itemSetup_itemRefForContainer_queryForm" isPrecise=true isCrossCompany=isCrossCompany  conditionfunc="MESBasic.itemManage.itemSetup.itemRefForContainer._querycustomFunc('code')" name="code" id="ec_MESBasic_itemManage_itemSetup_itemRefForContainer_queryForm_code" displayFieldName="code" exp="like" classStyle="form-control"  url="/MESBasic/itemManage/itemSetup/mneClient.action" multiple=false mnewidth=260 searchClick="MESBasic.itemManage.itemSetup.itemRefForContainer.commonQuery('query')" />
											</#if>
						...
						<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 margin-bottom-5">						
				       	<@querybutton formId="ec_MESBasic_itemManage_itemSetup_itemRefForContainer_queryForm" type="search" onclick="MESBasic.itemManage.itemSetup.itemRefForContainer.commonQuery('query')" /> 
...
<script>
	$(function(){
		var buttons = $( 'button.btn-list', '#ec_MESBasic_itemManage_itemSetup_itemRefForContainer_queryForm' );
		if( buttons.length > 0 ){
			// 去掉按钮间的空格
...
<script type="text/javascript">
	 ...
	 */
	MESBasic.itemManage.itemSetup.itemRefForContainer.query = function(type,pageNo){
		...
		if(!checkListValid("ec_MESBasic_itemManage_itemSetup_itemRefForContainer_queryForm")) {
				return false;
		}
		var dataPost = "";
		...
		url += "&crossCompanyFlag=${Parameters.crossCompanyFlag!}";
	 	datatable_ec_MESBasic_itemManage_itemSetup_itemRefForContainer_query.setRequestDataUrl(url,dataPost);
		return false;
	};
	...
	foundation.common.${requestUri!}__callbackFunction = function(){
		...
		var oRows = datatable_ec_MESBasic_itemManage_itemSetup_itemRefForContainer_query.getSelectedRow();
		if(oRows.length == 0){
		...
		try{
			if(CUI("#MESBasic_itemManage_itemSetup_itemRefForContainer_callBackFuncName").val() != ""){
				eval(CUI("#MESBasic_itemManage_itemSetup_itemRefForContainer_callBackFuncName").val() + "(arrObj)");
			}
		}catch(e){
		}
	};
...
MESBasic_itemManage_itemSetup_itemRefForContainer_refresh = function(node){
	//var url = "/MESBasic/itemManage/itemSetup/itemRefForContainer-query.action";
	//if(node.layRec){
	//	datatable_ec_MESBasic_itemManage_itemSetup_itemRefForContainer_query.setRequestDataUrl(url,'&'+node.modelName+'.layRec=' + node.layRec,false);
	//}else{
	//	datatable_ec_MESBasic_itemManage_itemSetup_itemRefForContainer_query.setRequestDataUrl(url,'',false);
	//}
...
MESBasic.itemManage.itemSetup.itemRefForContainer.showLinkView = function(url,propertyId,row,formId,title,width,height,dialogType){
	...
	if(formId) {
		MESBasic.itemManage.itemSetup.itemRefForContainer.showDialog(url,formId,title,width,height);
	}else {
		openFullScreen(url);
	}
};
...
function checkListValid(formId){return true;};
	...
	/* CUSTOM CODE START(view-REFERENCE-MESBasic_1_itemManage_itemRefForContainer,js,MESBasic_1_itemManage_ItemSetup,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
	</script>
  </body>
