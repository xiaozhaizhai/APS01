...
<script type="text/javascript">
	CUI.ns("MESBasic.itemManage.itemSetup","MESBasic.itemManage.itemSetup.switcherOnlyRef");
</script>
<div class="container"  style="padding-top:10px;">
	...
	<div id="ec_MESBasic_itemManage_itemSetup_switcherOnlyRef_queryForm_inputValue">
	...
	<form onsubmit="return false" id="ec_MESBasic_itemManage_itemSetup_switcherOnlyRef_queryForm" exportUrl="/MESBasic/itemManage/itemSetup/switcherOnlyRef-query.action">
		...
		<input type="hidden" id="dataTableSortColOrder" name="dataTableSortColOrder" />
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
											...
											<#if (itemName_defaultValue)?has_content>
												<@mneclient formId="ec_MESBasic_itemManage_itemSetup_switcherOnlyRef_queryForm" isPrecise=true isCrossCompany=isCrossCompany value="${itemName_defaultValue!}" deValue="${itemName_defaultValue!}"   conditionfunc="MESBasic.itemManage.itemSetup.switcherOnlyRef._querycustomFunc('itemName')" name="itemName" id="ec_MESBasic_itemManage_itemSetup_switcherOnlyRef_queryForm_itemName" displayFieldName="itemName" exp="like" classStyle="form-control"  url="/MESBasic/itemManage/itemSetup/mneClient.action" multiple=false mnewidth=260 searchClick="MESBasic.itemManage.itemSetup.switcherOnlyRef.commonQuery('query')" />
											<#else>
						...
						<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 margin-bottom-5">						
				       	<@querybutton formId="ec_MESBasic_itemManage_itemSetup_switcherOnlyRef_queryForm" type="search" onclick="MESBasic.itemManage.itemSetup.switcherOnlyRef.commonQuery('query')" /> 
...
<script>
	$(function(){
		var buttons = $( 'button.btn-list', '#ec_MESBasic_itemManage_itemSetup_switcherOnlyRef_queryForm' );
		if( buttons.length > 0 ){
			// 去掉按钮间的空格
...
<script type="text/javascript">
	 ...
	 */
	MESBasic.itemManage.itemSetup.switcherOnlyRef.query = function(type,pageNo){
		...
		if(!checkListValid("ec_MESBasic_itemManage_itemSetup_switcherOnlyRef_queryForm")) {
				return false;
		}
		var dataPost = "";
		...
		url += "&crossCompanyFlag=${Parameters.crossCompanyFlag!}";
	 	datatable_ec_MESBasic_itemManage_itemSetup_switcherOnlyRef_query.setRequestDataUrl(url,dataPost);
		return false;
	};
	...
	foundation.common.${requestUri!}__callbackFunction = function(){
		...
		var oRows = datatable_ec_MESBasic_itemManage_itemSetup_switcherOnlyRef_query.getSelectedRow();
		if(oRows.length == 0){
		...
		try{
			if(CUI("#MESBasic_itemManage_itemSetup_switcherOnlyRef_callBackFuncName").val() != ""){
				eval(CUI("#MESBasic_itemManage_itemSetup_switcherOnlyRef_callBackFuncName").val() + "(arrObj)");
			}
		}catch(e){
		}
	};
...
MESBasic_itemManage_itemSetup_switcherOnlyRef_refresh = function(node){
	//var url = "/MESBasic/itemManage/itemSetup/switcherOnlyRef-query.action";
	//if(node.layRec){
	//	datatable_ec_MESBasic_itemManage_itemSetup_switcherOnlyRef_query.setRequestDataUrl(url,'&'+node.modelName+'.layRec=' + node.layRec,false);
	//}else{
	//	datatable_ec_MESBasic_itemManage_itemSetup_switcherOnlyRef_query.setRequestDataUrl(url,'',false);
	//}
...
MESBasic.itemManage.itemSetup.switcherOnlyRef.showLinkView = function(url,propertyId,row,formId,title,width,height,dialogType){
	...
	if(formId) {
		MESBasic.itemManage.itemSetup.switcherOnlyRef.showDialog(url,formId,title,width,height);
	}else {
		openFullScreen(url);
	}
};
...
function checkListValid(formId){return true;};
	...
	/* CUSTOM CODE START(view-REFERENCE-MESBasic_1_itemManage_switcherOnlyRef,js,MESBasic_1_itemManage_ItemSetup,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
	</script>
  </body>
