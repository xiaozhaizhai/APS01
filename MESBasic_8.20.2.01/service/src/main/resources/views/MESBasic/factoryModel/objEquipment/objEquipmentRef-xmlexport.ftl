...
<#assign viewCode = 'MESBasic_1_factoryModel_ObjEquipment' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'equipmentNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1551872782825')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isContainer' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1551874713234')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'clearType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1554969147072')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'objFactory.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.201904081905')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												<#if item == 'equipmentNum' || item == '*'>
													<Cell>
														...
														<#if data.equipmentNum??><Data ss:Type="String"><![CDATA[${(data.equipmentNum)!}]]></Data></#if>
												...
												<#if item == 'objFactory.name' || item == '*'>
													<Cell>
														...
														<#if data.objFactory.name??><Data ss:Type="String"><![CDATA[${(data.objFactory.name)!}]]></Data></#if>
