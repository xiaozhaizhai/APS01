...
<script type="text/javascript">
	...
	function download(){
		//var url = "/MESBasic/factoryModel/factoryModel/downLoad.action?viewCode=MESBasic_1_factoryModel_factoryListPart&orgName=MESBasic_1_factoryModel_factoryListPart-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/MESBasic/factoryModel/factoryModel/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
