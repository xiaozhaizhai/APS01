...
<#assign viewCode = 'MESBasic_1_factoryModel_FactoryModel' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="assignBatchNo.itemName">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="code">
	  		...
	  		<Style ss:ID="department.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="endItem.itemName">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="isEbr">
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'department.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'assignBatchNo.itemName' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'endItem.itemName' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion141923322393782')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'code' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'nodeType.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.entityname.randon1460947272892')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'area.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1489991460442')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'description' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1419233695132')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isEbr' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1532062897594')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'department.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('part.fzwdy.xm.mainPositionId.department.name')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'assignBatchNo.itemName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.201903131347001')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'endItem.itemName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.201903131348001')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												...
												<#if item == 'nodeType.name' || item == '*'>
													<Cell>
														...
														<#if data.nodeType.name??><Data ss:Type="String"><![CDATA[${(data.nodeType.name)!}]]></Data></#if>
												...
												<#if item == 'area.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.area.value)!}')}</Data>
												...
												<#if item == 'isEbr' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.isEbr?? && data.isEbr>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'department.name' || item == '*'>
													<Cell>
														...
														<#if data.department.name??><Data ss:Type="String"><![CDATA[${(data.department.name)!}]]></Data></#if>
												...
												<#if item == 'assignBatchNo.itemName' || item == '*'>
													<Cell>
														...
														<#if data.assignBatchNo.itemName??><Data ss:Type="String"><![CDATA[${(data.assignBatchNo.itemName)!}]]></Data></#if>
												...
												<#if item == 'endItem.itemName' || item == '*'>
													<Cell>
														...
														<#if data.endItem.itemName??><Data ss:Type="String"><![CDATA[${(data.endItem.itemName)!}]]></Data></#if>
