 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								...
								<#if item == 'code' || item == '*'>
										<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1419849767734')}</Data></Cell>
								</#if>
								<#if item == 'protype' || item == '*'>
										<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1419849784820')}</Data></Cell>
								</#if>
								<#if item == 'notes' || item == '*'>
										<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1419849814178')}</Data></Cell>
								</#if>
			...
			<Row ss:AutoFitHeight="0">
				<#list exportFieldList as item>
					<#if item?length gt 0>
								...
								<#if item == 'code' || item == '*'>
									<Cell>
									<#if checkFieldPermission('code','MESBasic_1_product_type_Producttype','MESBasic_1_product_type_Producttype_code') != 0>
								...
								<#if item == 'protype' || item == '*'>
									<Cell>
									<#if checkFieldPermission('protype','MESBasic_1_product_type_Producttype','MESBasic_1_product_type_Producttype_protype') != 0>
										<#if data.protype??><Data ss:Type="String">${(data.protype)!}</Data></#if>
									</#if>
									</Cell>
								</#if>
								<#if item == 'notes' || item == '*'>
									<Cell>
									<#if checkFieldPermission('notes','MESBasic_1_product_type_Producttype','MESBasic_1_product_type_Producttype_notes') != 0>
										<#if data.notes??><Data ss:Type="String">${(data.notes)!}</Data></#if>
									</#if>
									</Cell>
								</#if>
