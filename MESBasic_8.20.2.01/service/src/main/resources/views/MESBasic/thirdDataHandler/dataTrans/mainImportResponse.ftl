...
<script type="text/javascript">
	...
	function download(){
		//var url = "/MESBasic/thirdDataHandler/dataTrans/downLoad.action?viewCode=MESBasic_1_thirdDataHandler_dataList&orgName=MESBasic_1_thirdDataHandler_dataList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/MESBasic/thirdDataHandler/dataTrans/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
