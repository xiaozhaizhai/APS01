...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=MESBasic_1_backgroundServiceMonitor";
	openExportFrame(url);
}
...
<div id="MESBasic_backgroundServiceMonitor_serviceLogger_logHistory_attachment">	
