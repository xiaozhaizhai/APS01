 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								<#if item == 'logTime' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1429057503018')}</Data>
										</Cell>
								</#if>
								<#if item == 'logContent' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1429057525068')}</Data>
										</Cell>
								</#if>
					...
					<#if item?length gt 0>
								<#if item == 'logTime' || item == '*'>
									<Cell ss:StyleID="s8">
										...
										<#if data.logTime??><Data ss:Type="Number"><@workerdate datetime='${(data.logTime)!?string("yyyy-MM-dd HH:mm:ss")}'></@workerdate></Data></#if>
								...
								<#if item == 'logContent' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.logContent)??>${(data.logContent)!}</#if></Data>
