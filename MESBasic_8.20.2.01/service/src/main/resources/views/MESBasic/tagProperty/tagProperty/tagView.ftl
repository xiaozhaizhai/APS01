...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <#assign configTitle = getText('MESBasic.viewtitle.radion1414992724029')>
		...
		#MESBasic_tagProperty_tagProperty_tagView_form{float:left;width:100%;}
		.pd-top{padding-top:10px}
		</style>
		<script type="text/javascript">
			CUI.ns('MESBasic.tagProperty.tagProperty.tagView');
			MESBasic.tagProperty.tagProperty.tagView.currentUser = ${userJson};
			MESBasic.tagProperty.tagProperty.tagView.currentStaff = ${staffJson};
			MESBasic.tagProperty.tagProperty.tagView.currentDepartment = ${deptJson};
			MESBasic.tagProperty.tagProperty.tagView.currentPosition = ${postJson};
			MESBasic.tagProperty.tagProperty.tagView.currentCompany = ${compJson};
		</script>
    </head>
	<body>
		<@loadpanel/>
		...
		<@s.form errorBarId="workbenchErrorBar" hiddenField="tagProperty.id," onsubmitMethod="MESBasic.tagProperty.tagProperty.tagView.beforeSubmitMethod()" id="MESBasic_tagProperty_tagProperty_tagView_form" namespace="/MESBasic/tagProperty/tagProperty/tagView" action="submit?__pc__=${(Parameters.__pc__)!}&_bapFieldPermissonModelCode_=MESBasic_1_tagProperty_TagProperty&_bapFieldPermissonModelName_=TagProperty" callback="MESBasic.tagProperty.tagProperty.tagView._callBackInfo" ecform="true">
		<input type="hidden" name="bap_validate_user_id" value="${(Session.user.id)!}" />
		<div style="float:none;width:auto;" class="edit-main grid-s5m0 col-main main-wrap" id="MESBasic_tagProperty_tagProperty_tagView_main_div">
    					<div class="edit-head">
    						...
    						<div class="edit-menubar">
								<div class="fl">
									...
									<#if pendingId??>
									<div class="edit-btn" id="edit-save-btn" onclick="MESBasic.tagProperty.tagProperty.tagView.save()">
										<a class="cui-btn-l">&nbsp;</a>
									...
									<#if pendingId??>
									<div class="edit-btn"  onclick="MESBasic.tagProperty.tagProperty.tagView.proxyPending(${pendingId})">
										<a class="cui-btn-l" >&nbsp;</a>
								...
								<div class="fr">
									<ul>
										<li onMouseOver="this.style.color='#ffc001'" onMouseOut="this.style.color='#FFFFFF'"><a onclick="MESBasic.tagProperty.tagProperty.tagView.showInfoDialog('fileUpload')" <#if id??>style="position:relative\0;position:static\9\0;bottom:1px\0;"</#if>>${getHtmlText("foundation.upload.attachment")}<span id="MESBasic_tagProperty_tagProperty_tagView_form_attcount"></span></a></li>
									</ul>
								</div>
							</div>
							</#if>
    					...
    					<div class="edit-main" id="MESBasic_tagProperty_tagProperty_tagView">
    						<div class="edit-content">
								<input type="hidden" id="dealInfoGroup" name="dealInfoGroup" value="">
								<input type="hidden" name="viewselect" value="tagView">
								<input type="hidden" name="datagridKey" value="MESBasic_tagProperty_tagProperty_tagView_datagrids">
								<input type="hidden" name="viewCode" value="MESBasic_1_tagProperty_tagView">
...
<script type="text/javascript">
var attcountid = "MESBasic_tagProperty_tagProperty_tagView_form"+"_attcount";
...
<div class="edit-panes-s" style="width:98%;margin-left:10px;">
	<table class="edit-table" style="">
		...
		<tr >
					...
					<td <#if MESBasic_1_tagProperty_TagProperty_name_permit != 3>nofieldPermission="true"</#if> nullable=false class="edit-table-content"   style="text-align: left;;" >
							...
							<div class="fix-input-readonly">
								<input property_type="TEXT" name="tagProperty.name" id="tagProperty_name"  style=";" originalvalue="<#if !newObj || (tagProperty.name)?has_content>${(tagProperty.name?html)!}<#else>${tagProperty_name_defaultValue!}</#if>" value="<#if !newObj || (tagProperty.name)?has_content>${(tagProperty.name?html)!}<#else>${tagProperty_name_defaultValue!}</#if>" type="text" class="cui-noborder-input " readonly="readonly" />
							</div>
							<script type="text/javascript">
							</script>
							</#if>
					...
					<td <#if MESBasic_1_tagProperty_TagProperty_code_permit != 3>nofieldPermission="true"</#if> nullable=false class="edit-table-content"   align="left" style="text-align: left;;" >
							...
							<#else>
							<div class="fix-input-readonly">
								<input property_type="TEXT" name="tagProperty.code" id="tagProperty_code"  style=";" originalvalue="<#if !newObj || (tagProperty.code)?has_content>${(tagProperty.code?html)!}<#else>${tagProperty_code_defaultValue!}</#if>" value="<#if !newObj || (tagProperty.code)?has_content>${(tagProperty.code?html)!}<#else>${tagProperty_code_defaultValue!}</#if>" type="text" class="cui-noborder-input " readonly="readonly" />
							</div>
							<script type="text/javascript">
							</script>
							</#if>
					...
					<td <#if MESBasic_1_tagProperty_TagProperty_tagType_permit != 3>nofieldPermission="true"</#if> nullable=false class="edit-table-content"   style="text-align: left;;" >
							...
							<#else>
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange="" viewType="${viewType!}" deValue="${tagProperty_tagType_defaultValue!}" formId="MESBasic_tagProperty_tagProperty_tagView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="tagProperty.tagType.id" code="TAG_TYPE" value="${(tagProperty.tagType.id)!}"  />
									<#else>
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${tagProperty_tagType_defaultValue!}" formId="MESBasic_tagProperty_tagProperty_tagView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="tagProperty.tagType.id" code="TAG_TYPE" value="${(tagProperty.tagType.id)!}"  />
									</#if>
								<#else>
									<#if MESBasic_1_tagProperty_TagProperty_tagType_permit == 1>
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="MESBasic_tagProperty_tagProperty_tagView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="tagProperty.tagType.id" code="TAG_TYPE" value="${(tagProperty.tagType.id)!}"  />
									<#else>
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="MESBasic_tagProperty_tagProperty_tagView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="tagProperty.tagType.id" code="TAG_TYPE" value="${(tagProperty.tagType.id)!}"  />
									</#if>
								</#if>
					...
					<td <#if MESBasic_1_tagProperty_TagProperty_tattribute_permit != 3>nofieldPermission="true"</#if> nullable=false class="edit-table-content"   align="left" style="text-align: left;;" >
							...
							<#else>
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange="" viewType="${viewType!}" deValue="${tagProperty_tattribute_defaultValue!}" formId="MESBasic_tagProperty_tagProperty_tagView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="tagProperty.tattribute.id" code="TAG_ATTRIBUTE" value="${(tagProperty.tattribute.id)!}"  />
									<#else>
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${tagProperty_tattribute_defaultValue!}" formId="MESBasic_tagProperty_tagProperty_tagView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="tagProperty.tattribute.id" code="TAG_ATTRIBUTE" value="${(tagProperty.tattribute.id)!}"  />
									</#if>
								<#else>
									<#if MESBasic_1_tagProperty_TagProperty_tattribute_permit == 1>
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="MESBasic_tagProperty_tagProperty_tagView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="tagProperty.tattribute.id" code="TAG_ATTRIBUTE" value="${(tagProperty.tattribute.id)!}"  />
									<#else>
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="MESBasic_tagProperty_tagProperty_tagView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="tagProperty.tattribute.id" code="TAG_ATTRIBUTE" value="${(tagProperty.tattribute.id)!}"  />
									</#if>
								</#if>
				...
				<td class="edit-table-symbol">&nbsp;</td>
					...
					<td <#if MESBasic_1_tagProperty_TagProperty_factor_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-content"   colspan="5" align="left" style="text-align: left;;" >
							...
							<#else>
							<div class="fix-input-readonly fix-ie7-textarea"><textarea property_type="TEXT" id="tagProperty_factor" originalvalue="<#if !newObj || (tagProperty.factor)?has_content>${(tagProperty.factor?html)!}<#else>${tagProperty_factor_defaultValue?html}</#if>"  name="tagProperty.factor" class="cui-noborder-textarea cui-textarea-auto" readonly="readonly" style=";" ><#if !newObj || (tagProperty.factor)?has_content>${(tagProperty.factor)!}<#else>${tagProperty_factor_defaultValue}</#if></textarea></div>
							</#if>
				</td>
				</tr><tr >
					...
					<td <#if MESBasic_1_tagProperty_TagProperty_expression_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-content"   colspan="5" align="left" style="text-align: left;;" >
							...
							<#else>
							<div class="fix-input-readonly fix-ie7-textarea"><textarea property_type="TEXT" id="tagProperty_expression" originalvalue="<#if !newObj || (tagProperty.expression)?has_content>${(tagProperty.expression?html)!}<#else>${tagProperty_expression_defaultValue?html}</#if>"  name="tagProperty.expression" class="cui-noborder-textarea cui-textarea-auto" readonly="readonly" style=";" ><#if !newObj || (tagProperty.expression)?has_content>${(tagProperty.expression)!}<#else>${tagProperty_expression_defaultValue}</#if></textarea></div>
							</#if>
				</td>
				</tr><tr >
					...
					<td <#if MESBasic_1_tagProperty_TagProperty_remark_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-content"   colspan="5" align="left" style="text-align: left;;" >
							...
							<#else>
							<div class="fix-input-readonly fix-ie7-textarea"><textarea property_type="TEXT" id="tagProperty_remark" originalvalue="<#if !newObj || (tagProperty.remark)?has_content>${(tagProperty.remark?html)!}<#else>${tagProperty_remark_defaultValue?html}</#if>"  name="tagProperty.remark" class="cui-noborder-textarea cui-textarea-auto" readonly="readonly" style=";" ><#if !newObj || (tagProperty.remark)?has_content>${(tagProperty.remark)!}<#else>${tagProperty_remark_defaultValue}</#if></textarea></div>
							</#if>
				</td>
		</tr>
	</table>
		...
		<div id="MESBasic_tagProperty_tagProperty_tagView_dealInfo" style="display: none;margin-top:5px;">
			<ul class="edit-tabs">
				<li id="fileUploadHead" class="bar" onclick="MESBasic.tagProperty.tagProperty.tagView.showFileUpload('fileUpload')">${getText("foundation.upload.attachment")}</li>
			</ul>
			<div class="edit-panes wid-hei"  style="padding:0px;">
				<div id="fileUploadDiv" class="wid-hei"></div>
			</div>
		</div>
		<!-- CUSTOM CODE START(view-VIEW-MESBasic_1_tagProperty_tagView,html,MESBasic_1_tagProperty_TagProperty,MESBasic_1) -->
<!-- 自定义代码 -->
<!-- CUSTOM CODE END -->
			...
			$(window).resize(function(){
				...
				if (width <= 800) {
					if($("#edit_sidebar").length==0 || $("#edit_sidebar").css("display")=="none"){
						$("#MESBasic_tagProperty_tagProperty_tagView_main_div").css("width",800);
						$(".edit-head").css("width",800);
						$(".edit-workflow").css("width",800);
						$("body").css({"overflow-x":"scroll","position":"relative","zIndex":"100"});
					}else{
						$("#MESBasic_tagProperty_tagProperty_tagView_main_div").css("width",650);
					...
					if (YAHOO.env.ua.ie == "6") {
						$("#MESBasic_tagProperty_tagProperty_tagView_main_div").css("width",w1);
						$(".edit-workflow").css("width",w1);
					}else{
						$("#MESBasic_tagProperty_tagProperty_tagView_main_div").css("width","auto");
		...
		<script type="text/javascript">
			MESBasic.tagProperty.tagProperty.tagView.initCount = 0;
			MESBasic.tagProperty.tagProperty.tagView.initSize = function(nTabIndex){
				var panesHeight;
				var thisHeight;
				var h = $(window).height();
				...
				var conHeight = h-$("#MESBasic_tagProperty_tagProperty_tagView_main_div .edit-head").height()-$("#MESBasic_tagProperty_tagProperty_tagView_main_div .edit-tabs").height()<#if pendingId?? || editNew>-$("#MESBasic_tagProperty_tagProperty_tagView_main_div .edit-workflow").height()</#if>;
				panesHeight = conHeight*0.4;
				var datagrids = $('body').data('MESBasic_tagProperty_tagProperty_tagView_datagrids');
				$("#MESBasic_tagProperty_tagProperty_tagView_main_div .edit-panes-s").each(function(index){
					//多页签切换时只计算本页签下的PT高度
						...
						if(datagrids[index].length > 0) {
							...
							for(var dg=0;dg<datagrids[index].length;dg++) {
								...
								if(dgwidget) {
									...
									if(MESBasic.tagProperty.tagProperty.tagView.initCount <= 2) {
										setTimeout(function(){MESBasic.tagProperty.tagProperty.tagView.initSize();}, 200);
										MESBasic.tagProperty.tagProperty.tagView.initCount++;
									}/* else {
										MESBasic.tagProperty.tagProperty.tagView.initCount = 0;
									}*/
								}
			...
			$(function(){
				MESBasic.tagProperty.tagProperty.tagView.initSize();
				if(YAHOO.env.ua.ie == 6){
				...
				<#if businessCenterList??&&businessCenterList?size gt 0 >
					...
					$("#edit_side_btn").toggle(function(){
						if(parseInt($("#MESBasic_tagProperty_tagProperty_tagView_main_div").css("width"),10)==650){
							$("#MESBasic_tagProperty_tagProperty_tagView_main_div").css("width","800px");
						...
						//MESBasic.tagProperty.tagProperty.tagView.resizeLayout();
						//MESBasic.tagProperty.tagProperty.tagView.initSize();
						$('body').trigger('resize');
					},function(){
						if(parseInt($("#MESBasic_tagProperty_tagProperty_tagView_main_div").css("width"),10)==800){
							$("#MESBasic_tagProperty_tagProperty_tagView_main_div").css("width","650px");
				...
				$(window).resize(function(){MESBasic.tagProperty.tagProperty.tagView.initSize();});
				/*
				MESBasic.tagProperty.tagProperty.tagView.resizeLayout=function(){
		...
		MESBasic.tagProperty.tagProperty.tagView.validate = function(){
		...
		MESBasic.tagProperty.tagProperty.tagView.beforeSaveProcess = function(){
			$('input[name="tagProperty.extraCol"]').remove();
		}
		MESBasic.tagProperty.tagProperty.tagView.processDataGrid = function(){
		};
		MESBasic.tagProperty.tagProperty.tagView.save = function(){
			$('#operateType').val("submit");
			try{eval('beforeSubmitUploadForm()');}catch(e){}
			if(!MESBasic.tagProperty.tagProperty.tagView.validate()){return;}
			MESBasic.tagProperty.tagProperty.tagView.beforeSaveProcess();

			//MESBasic.tagProperty.tagProperty.tagView.processDataGrid();
			$('#MESBasic_tagProperty_tagProperty_tagView_form').submit();
		}
		
		<#if viewType != "readonly">
		window.onbeforeunload = function() {      
		        if(isFormChanged('MESBasic_tagProperty_tagProperty_tagView_form','MESBasic_tagProperty_tagProperty_tagView_datagrids')) {      
		...
		//打印
		MESBasic.tagProperty.tagProperty.tagView.print = function(){
		...
		MESBasic.tagProperty.tagProperty.tagView.saveSetting = function(){
		...
		MESBasic.tagProperty.tagProperty.tagView.printSetting = function(){
			var viewCode = $('input[name="viewCode"]').val();
			var value = "";
			var printId = 0;
			var printVersion = 0;
			if(viewCode!=undefined && viewCode!=null && viewCode!=''){
				...
				MESBasic.tagProperty.tagProperty.tagView.settingDialog = new CUI.Dialog({
					...
					buttons:[
							{	name:"${getText("ec.flow.save")}",
								handler:function(){if(MESBasic.tagProperty.tagProperty.tagView.saveSetting()){this.close();}}
							},
							{	name:"${getText("ec.flow.cancal")}",
								handler:function(){this.close()}
							}]
					})
				MESBasic.tagProperty.tagProperty.tagView.settingDialog.show();
			}
		}
		
		
		MESBasic.tagProperty.tagProperty.tagView._callBackInfo = function(res){
		...
		function dataGridBtnImgClick(sUrl,objNameCustomCondition,sTitle,sPTGridID,nRow,sFieldName,oGrid,customCallBack,crossCompany){
			...
			if(customCallBack){
				MESBasic.tagProperty.tagProperty.tagView._customCallBack = customCallBack;
			}
			MESBasic.tagProperty.tagProperty.tagView._selectEvent(objNameCustomCondition,null,sUrl,sTitle,null,null,null,crossCompany,obj);
		}
		
		MESBasic.tagProperty.tagProperty.tagView.initMnemonic_DG_IE = function(oConfig){
			var oGrid = oConfig.oGrid;
			// 获取控件PT  object
			var oPTGridEx = oGrid._DT || oGrid;
			// 存储当前操作相关信息
			MESBasic.tagProperty.tagProperty.tagView.gridEventObj = {
				"oGrid" : oGrid,
				"nRow" : oConfig.nRow - 1,
				"sKey":	oConfig.sFieldName
			}
			MESBasic.tagProperty.tagProperty.tagView._sUrl = oConfig.url;
			if(oConfig.customCallBack){
				MESBasic.tagProperty.tagProperty.tagView._customCallBack = oConfig.customCallBack;
			}
			// 自定义的表格对象
		...
		MESBasic.tagProperty.tagProperty.tagView._selectEvent = function(objName,_selectType,url,title,refparam,obj,customCallBack,crossCompanyFlag,gridEventObj,oGrid,isMultiselect){

			var callbackName="";
			var _prefix= '';
			var arr = objName.split('.');
			if(gridEventObj) {
				MESBasic.tagProperty.tagProperty.tagView.gridEventObj = gridEventObj;
				callbackName = "MESBasic.tagProperty.tagProperty.tagView.getcallBackInfo_DG_IE";
			}else if(obj!=null && obj!=""){
				if(arr.length > 1){
					_prefix = '.'+ arr[0];
				}
				callbackName = isMultiselect ? "MESBasic.tagProperty.tagProperty.tagView.getMultiselectCallBackInfo_DG" : "MESBasic.tagProperty.tagProperty.tagView.getcallBackInfo_DG";
				MESBasic.tagProperty.tagProperty.tagView._currRow = obj.parentNode.parentNode.parentNode;
			}else{
				if(arr.length > 2){
					_prefix = '.'+ arr[0] + '.'+ arr[1];
				}
				callbackName ="MESBasic.tagProperty.tagProperty.tagView.getcallBackInfo";
			}

			if(_prefix!=''){
				MESBasic.tagProperty.tagProperty.tagView._prefix = _prefix.substring(1);
			}
			
			MESBasic.tagProperty.tagProperty.tagView._oGrid = oGrid;
			MESBasic.tagProperty.tagProperty.tagView._sUrl = url;
			if(customCallBack){
				MESBasic.tagProperty.tagProperty.tagView._customCallBack = customCallBack;
			}
			if(MESBasic.tagProperty.tagProperty.tagView._querycustomFunc(objName.replace(/\./g, '_')) != null) {
				refparam = 'condition=' + encodeURIComponent(MESBasic.tagProperty.tagProperty.tagView._querycustomFunc(objName.replace(/\./g, '_')));
			}
			if(typeof MESBasic.tagProperty.tagProperty.tagView._querycustomFuncN == "function") {
				refparam += MESBasic.tagProperty.tagProperty.tagView._querycustomFuncN();
			}
			...
			MESBasic.tagProperty.tagProperty.tagView._dialog = foundation.common.select({
				pageType : 'other',
				closePage : true,
		...
		MESBasic.tagProperty.tagProperty.tagView._groupSelectEvent = function(objName,_selectType,url,title,refparam){
			if(MESBasic.tagProperty.tagProperty.tagView._querycustomFunc(objName.replace(/\./g, '_')) != null) {
				refparam = 'condition=' + encodeURIComponent(MESBasic.tagProperty.tagProperty.tagView._querycustomFunc(objName.replace(/\./g, '_')));
			}
			MESBasic.tagProperty.tagProperty.tagView._dialog = foundation.common.select({
				...
				closePage : true,
				callBackFuncName : 'MESBasic.tagProperty.tagProperty.tagView.getcallBackGroupInfo',
				url : url,
				title : title,
				params : refparam
			});
		}
		MESBasic.tagProperty.tagProperty.tagView._querycustomFunc = function(obj) {
			var str = eval("typeof(MESBasic.tagProperty.tagProperty.tagView.query_"+obj+")!='undefined'") ? eval('MESBasic.tagProperty.tagProperty.tagView.query_'+obj+'()') : null;
			return str;
		};
		MESBasic.tagProperty.tagProperty.tagView.getcallBackGroupInfo = function(obj){
			var ids = "";
			var names = "";
			...
			MESBasic.tagProperty.tagProperty.tagView._dialog.close();
		}
		MESBasic.tagProperty.tagProperty.tagView.getcallBackInfo = function(obj){
		
			obj[0] = foundation.common.getObject('MESBasic_tagProperty_tagProperty_tagView_form',obj[0], MESBasic.tagProperty.tagProperty.tagView._prefix, MESBasic.tagProperty.tagProperty.tagView._sUrl);
			CUI.commonFills('MESBasic_tagProperty_tagProperty_tagView_form',MESBasic.tagProperty.tagProperty.tagView._prefix,obj[0]);
			
			for(pro in obj[0]){
				try{
					var fname = "_callback_" + (MESBasic.tagProperty.tagProperty.tagView._prefix + "." + pro).replace(/\./g, '_')  + "_edit";
			...
			try{
				if(MESBasic.tagProperty.tagProperty.tagView._customCallBack) {
					eval(MESBasic.tagProperty.tagProperty.tagView._customCallBack);
					MESBasic.tagProperty.tagProperty.tagView._customCallBack = null;
				}
		...
		// 控件版PT回调
		MESBasic.tagProperty.tagProperty.tagView.getcallBackInfo_DG_IE = function(obj){
			if(MESBasic.tagProperty.tagProperty.tagView._customBeforeCallBack) {
				var flag = eval(MESBasic.tagProperty.tagProperty.tagView._customBeforeCallBack.split("(")[0] + "(obj)");
				if(flag === false){
					return false;
				}
			}
			var gridEventObj = MESBasic.tagProperty.tagProperty.tagView.gridEventObj;
			var rootKey = gridEventObj.sKey.split('.')[0];
			var jsonObj = foundation.common.getObjectIE(gridEventObj,obj[0],rootKey,MESBasic.tagProperty.tagProperty.tagView._sUrl);
		...
		MESBasic.tagProperty.tagProperty.tagView.getcallBackInfo_DG = function(obj){
			if(MESBasic.tagProperty.tagProperty.tagView._customBeforeCallBack) {
				var flag = eval(MESBasic.tagProperty.tagProperty.tagView._customBeforeCallBack.split("(")[0] + "(obj)");
				if(flag === false){
					return false;
			...
			for(var i=0;i<obj.length;i++){
				if(i>0){
					if($(MESBasic.tagProperty.tagProperty.tagView._currRow).next().length==0){
						MESBasic.tagProperty.tagProperty.tagView._oGrid.addNewRow();
					}	
					MESBasic.tagProperty.tagProperty.tagView._currRow = $(MESBasic.tagProperty.tagProperty.tagView._currRow).next();
					$(MESBasic.tagProperty.tagProperty.tagView._currRow).attr('isEdited',true);
				}
				obj[i] = foundation.common.getObject(MESBasic.tagProperty.tagProperty.tagView._currRow,obj[i], MESBasic.tagProperty.tagProperty.tagView._prefix, MESBasic.tagProperty.tagProperty.tagView._sUrl);
				eval("CUI.commonFills_DG(MESBasic.tagProperty.tagProperty.tagView._currRow,MESBasic.tagProperty.tagProperty.tagView._prefix,obj[i],MESBasic.tagProperty.tagProperty.tagView._oGrid)");
			}
			try{
				if(MESBasic.tagProperty.tagProperty.tagView._customCallBack) {
					eval(MESBasic.tagProperty.tagProperty.tagView._customCallBack);
		...
		MESBasic.tagProperty.tagProperty.tagView.getMultiselectCallBackInfo_DG = function(obj){
			for(var i=0;i<obj.length;i++){
				CUI.commonFillsMultiselect_DG(MESBasic.tagProperty.tagProperty.tagView._oGrid, MESBasic.tagProperty.tagProperty.tagView._currRow, MESBasic.tagProperty.tagProperty.tagView._key, MESBasic.tagProperty.tagProperty.tagView._displayFieldName, obj[i])
			}
			try{
				if(MESBasic.tagProperty.tagProperty.tagView._customCallBack) {
					eval(MESBasic.tagProperty.tagProperty.tagView._customCallBack);
		...
		MESBasic.tagProperty.tagProperty.tagView.generateInput = function(prefix, obj) {
			CUI.each(obj, function(key,value){
				if(value!=null && key!='rowHtmlObj' && key!='cellHtmlObj'){
					var name = prefix + '.' + key;
					if(typeof value == 'object') {
						MESBasic.tagProperty.tagProperty.tagView.generateInput(name, value);
					} else {
						if(value!=null&&value!='null'&&value!=undefined&&value!='') {
							CUI('input[name="' + name + '"]').remove();
							CUI('<input type="hidden" name="'+name+'" value="'+value+'">').appendTo(CUI('#MESBasic_tagProperty_tagProperty_tagView_form'));
						}
					}
				}
			});
		};
		MESBasic.tagProperty.tagProperty.tagView.proxyPending=function(pendingId){
			var url="/ec/workflow/proxyPending.action?pendingId="+pendingId;
			CUI(function(){
				MESBasic.tagProperty.tagProperty.tagView.proxyPendingDialog = new CUI.Dialog({
					...
					buttons:[
							{	name:"${getText("ec.flow.submit")}",
								handler:function(){MESBasic.tagProperty.tagProperty.tagView.saveProxyPending()}
							},
							{	name:"${getText("ec.flow.cancal")}",
								handler:function(){this.close()}
							}]
				})
				MESBasic.tagProperty.tagProperty.tagView.proxyPendingDialog.show();
			});
		};
		MESBasic.tagProperty.tagProperty.tagView.proxyType="2";//2普通委托，3全权委托
		MESBasic.tagProperty.tagProperty.tagView.saveProxyPending=function(){
			...
			MESBasic.tagProperty.tagProperty.tagView.proxyType=CUI("input[name=proxyType]:checked").val();
		...
		proxyPendingCallBackInfo=function(res){
			if(res.dealSuccessFlag == true){
				...
				setTimeout(function(){
					try{
						if(MESBasic.tagProperty.tagProperty.tagView.proxyType=='3'){
							top.opener.reload();
							window.close();
						}else{
							MESBasic.tagProperty.tagProperty.tagView.proxyPendingDialog.close();	
						}
					}catch(e){}
		...
		$(function(){
			MESBasic.tagProperty.tagProperty.tagView.onloadForProduct();
			
		});

		MESBasic.tagProperty.tagProperty.tagView.beforeSubmitMethodSettingInPage = function(){
			MESBasic.tagProperty.tagProperty.tagView.onsaveForProduct();
		};
		MESBasic.tagProperty.tagProperty.tagView.beforeSubmitMethod = function(){
			...
			var customOnsaveResult =  MESBasic.tagProperty.tagProperty.tagView.beforeSubmitMethodSettingInPage();
		...
		<script type="text/javascript">
		MESBasic.tagProperty.tagProperty.tagView.showBusinessList = function(relatingModelCode,mainEntityId,businessCenterCode,url,showType){
			...
			if(CUI(id).html() == null || $.trim(CUI(id).html()) == ""){
				CUI(id).load(url);
				setTimeout(function(){
					CUI("#MESBasic_tagProperty_tagProperty_tagView_main_div").hide();
				},500);
			}else{
				CUI("#MESBasic_tagProperty_tagProperty_tagView_main_div").hide();
			  	$('body').trigger('resize');
		...
		MESBasic.tagProperty.tagProperty.tagView.showThis = function(){
			if(!CUI("#MESBasic_tagProperty_tagProperty_tagView_main_div").is(':visible')) {
				CUI("#MESBasic_tagProperty_tagProperty_tagView_main_div").show();
		...
		MESBasic.tagProperty.tagProperty.tagView.showInfoDialog=function(mode){
			
			MESBasic.tagProperty.tagProperty.tagView.infoDialog = new CUI.Dialog({
				title: "${getText("ec.view.info.view")}",
				elementId: "MESBasic_tagProperty_tagProperty_tagView_dealInfo",
				modal:true,
				height:500,
				width: 850,
				buttons:[
			...
			MESBasic.tagProperty.tagProperty.tagView.infoDialog.show();
			if(mode=='flow'){
				CUI("#flowHead").click();
		...
		MESBasic.tagProperty.tagProperty.tagView.showFileUpload=function(){
			...
			<#else>
			CUI("#fileUploadDiv").load("/foundation/workbench/fileupload-new-init.action?readOnlyFlag=true&linkId=${fileuploadLinkId!-1}&type=${fileuploadType!'Table'}&entityCode=MESBasic_1_tagProperty");
			</#if>
			}
		}
		
		MESBasic.tagProperty.tagProperty.tagView.showDealInfo=function(){
		...
		MESBasic.tagProperty.tagProperty.tagView.showFlowInfo=function(){
		...
		MESBasic.tagProperty.tagProperty.tagView.remind=function(){
			MESBasic.tagProperty.tagProperty.tagView.remindDialog = new CUI.Dialog({
			...
			MESBasic.tagProperty.tagProperty.tagView.remindDialog.show();
		}
		waitWork_remindCallBack=function(res){
			if(res.dealSuccessFlag == true){
				...
				setTimeout(function(){
					try{MESBasic.tagProperty.tagProperty.tagView.remindDialog.close();}catch(e){}
				},1500);
			}else{
		...
		MESBasic.tagProperty.tagProperty.tagView.supervision=function(){
			MESBasic.tagProperty.tagProperty.tagView.modifyOwnerStaffDialog = new CUI.Dialog({
				...
				MESBasic.tagProperty.tagProperty.tagView.modifyOwnerStaffDialog.show();
		}
		


		/* CUSTOM CODE START(view-VIEW-MESBasic_1_tagProperty_tagView,js,MESBasic_1_tagProperty_TagProperty,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */

		MESBasic.tagProperty.tagProperty.tagView.onloadForProduct = function(){
		/* CUSTOM CODE START(view-VIEW-MESBasic_1_tagProperty_tagView,onloadForProduct,MESBasic_1_tagProperty_TagProperty,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
		}

		MESBasic.tagProperty.tagProperty.tagView.onsaveForProduct = function(){
		/* CUSTOM CODE START(view-VIEW-MESBasic_1_tagProperty_tagView,onsaveForProduct,MESBasic_1_tagProperty_TagProperty,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
		}
		...
		<div class="col-sub">
			...
			<div class="edit-sidebar-inner" style='height:1000px;'>
				<div class="sidebar-top"><a href="#"  onclick="MESBasic.tagProperty.tagProperty.tagView.showThis()">${getText("ec.view.tableInfo")}</a></div>
					...
					<ul>
						<#list businessCenterList as l>
							 <li>
								...
								<#else>
									<a href="#" onclick="MESBasic.tagProperty.tagProperty.tagView.showBusinessList('${l.relatingModel.code.replace('.','')}',${(tagProperty.id)!},'${l.code}','${l.assview.url}?${getPowerCode(l.assview.code+'_self')}','${l.assview.showType}')">${getText(l.relatingModel.entity.name)}(${(l.count)!})</a>
								</#if>
							</li>
						 </#list>
					</ul>
