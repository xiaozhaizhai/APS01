	...
	<form <#if useInBusiness?? && useInBusiness == 'yes'>style="position:relative;*z-index:1;zoom:1;"</#if> onsubmit="return false" id="ec_MESBasic_storeSet_storeSet_storeRef_queryForm" exportUrl="/MESBasic/storeSet/storeSet/storeRef-query.action">
		...
		<div id="ec_MESBasic_storeSet_storeSet_storeRef_queryForm_btn_toggle" class="quick-query-btn-toggle quick-query-btn-expand" style="display:none;" title="${getText('ec.view.expandTip')}" onclick="ec_MESBasic_storeSet_storeSet_storeRef_queryForm_expandAllCondition()" ></div>
		<#assign advFlag = getAdvClassific('MESBasic_1_storeSet_storeRef')>
		<#if advFlag?? && advFlag>
		<@dataclassific id="dataClassific" viewCode="MESBasic_1_storeSet_storeRef" formId="ec_MESBasic_storeSet_storeSet_storeRef_queryForm" dataTableId="ec_MESBasic_storeSet_storeSet_storeRef_query"   />
		</#if>
					<@quickquery unique="LAST_QUERY_ec_MESBasic_storeSet_storeSet_storeRef_queryForm" isExpandAll=true formId="ec_MESBasic_storeSet_storeSet_storeRef_queryForm" idprefix="ec_MESBasic_storeSet_storeSet_storeRef" expandType="all"  fieldcodes="MESBasic_1_storeSet_StoreSet_placeSetCode_placeSetCode:MESBasic.propertydisplayName.randon1489731651449||MESBasic_1_storeSet_StoreSet_placeSetName_placeSetName:MESBasic.propertydisplayName.randon1489731677162||MESBasic_1_wareMan_Ware_wareCode_wareId_wareCode:MESBasic.propertydisplayName.randon1484031239866||MESBasic_1_wareMan_Ware_wareName_wareId_wareName:MESBasic.propertydisplayName.randon1484031316281" > 
							<#assign placeSetCode_defaultValue  = ''>
									<#assign placeSetCode_defaultValue  = ''>
							<@queryfield formId="ec_MESBasic_storeSet_storeSet_storeRef_queryForm" code="MESBasic_1_storeSet_StoreSet_placeSetCode" showFormat="TEXT" defaultValue=placeSetCode_defaultValue  divCode="MESBasic_1_storeSet_StoreSet_placeSetCode_placeSetCode" isCustomize=true style="" > 
											<div class="fix-input">
							...
							<#assign placeSetName_defaultValue  = ''>
									<#assign placeSetName_defaultValue  = ''>
							<@queryfield formId="ec_MESBasic_storeSet_storeSet_storeRef_queryForm" code="MESBasic_1_storeSet_StoreSet_placeSetName" showFormat="TEXT" defaultValue=placeSetName_defaultValue  divCode="MESBasic_1_storeSet_StoreSet_placeSetName_placeSetName" isCustomize=true style="" > 
											<div class="fix-input">
							...
							<#assign wareId_wareCode_defaultValue  = ''>
									<#assign wareId_wareCode_defaultValue  = ''>
							<@queryfield formId="ec_MESBasic_storeSet_storeSet_storeRef_queryForm" code="MESBasic_1_wareMan_Ware_wareCode" showFormat="SELECTCOMP" defaultValue=wareId_wareCode_defaultValue  divCode="MESBasic_1_wareMan_Ware_wareCode_wareId_wareCode" isCustomize=true style="" > 
										<input type="hidden" id="wareId.id" name="wareId.id" value="" />
												<@mneclient iframe=true mneenable=true isCrossCompany=isCrossCompany isPrecise=true deValue="${wareId_wareCode_defaultValue!}" reftitle="${getText('MESBasic.viewtitle.randon1484031981880')}"  conditionfunc="MESBasic.storeSet.storeSet.storeRef._querycustomFunc('wareId_wareCode')" name="wareId.wareCode" id="ec_MESBasic_storeSet_storeSet_storeRef_queryForm_wareId_wareCode" displayFieldName="wareCode" type="other" exp="like" classStyle="cui-noborder-input" url="/MESBasic/wareMan/ware/wareRef.action"   refViewCode="MESBasic_1_wareMan_wareRef"  clicked=true multiple=false mnewidth=260 formId="ec_MESBasic_storeSet_storeSet_storeRef_queryForm" searchClick="MESBasic.storeSet.storeSet.storeRef.commonQuery('query')"   />
							</@queryfield>
							<#assign wareId_wareName_defaultValue  = ''>
									<#assign wareId_wareName_defaultValue  = ''>
							<@queryfield formId="ec_MESBasic_storeSet_storeSet_storeRef_queryForm" code="MESBasic_1_wareMan_Ware_wareName" showFormat="SELECTCOMP" defaultValue=wareId_wareName_defaultValue  divCode="MESBasic_1_wareMan_Ware_wareName_wareId_wareName" isCustomize=true style="" > 
												<@mneclient iframe=true mneenable=true isCrossCompany=isCrossCompany isPrecise=true deValue="${wareId_wareName_defaultValue!}" reftitle="${getText('MESBasic.viewtitle.randon1484031981880')}"  conditionfunc="MESBasic.storeSet.storeSet.storeRef._querycustomFunc('wareId_wareName')" name="wareId.wareName" id="ec_MESBasic_storeSet_storeSet_storeRef_queryForm_wareId_wareName" displayFieldName="wareName" type="other" exp="like" classStyle="cui-noborder-input" url="/MESBasic/wareMan/ware/wareRef.action"   refViewCode="MESBasic_1_wareMan_wareRef"  clicked=true multiple=false mnewidth=260 formId="ec_MESBasic_storeSet_storeSet_storeRef_queryForm" searchClick="MESBasic.storeSet.storeSet.storeRef.commonQuery('query')"   />
							</@queryfield>
							<div class="quick-query-buttonbar" style="margin-bottom:6px;margin-right:12px;">
						       	<@querybutton formId="ec_MESBasic_storeSet_storeSet_storeRef_queryForm" type="adv" onclick="MESBasic.storeSet.storeSet.storeRef.commonQuery('query')" onadvancedclick="advQuery('MESBasic.storeSet.storeSet.storeRef.advquery')" /> 
...
ec_MESBasic_storeSet_storeSet_storeRef_quickquery_info["MainTableName"]="MATERIAL_STORE_SETS";
...
<script>
 $(function(){
 	var advRemainDialog = $('[id="MESBasic.storeSet.storeSet.storeRef.advquery"]');
...
<div style="position:relative;z-index:10;display:none;" id="MESBasic.storeSet.storeSet.storeRef.advquery">
    <@errorbar id="adv_query_edit_bar"></@errorbar>
    <div class="advConContent">
    <form <#if useInBusiness?? && useInBusiness == 'yes'>style="position:relative;*z-index:1;zoom:1;"</#if> onsubmit="return false" id="ec_MESBasic_storeSet_storeSet_storeRef_adv_queryForm" exportUrl="/MESBasic/storeSet/storeSet/storeRef-query.action">
							<#assign placeSetCode_defaultValue  = ''>
									<#assign placeSetCode_defaultValue  = ''>
								<@advsqueryfield formId="ec_MESBasic_storeSet_storeSet_storeRef_adv_queryForm" code="MESBasic_1_storeSet_StoreSet_placeSetCode" showFormat="TEXT" defaultValue=placeSetCode_defaultValue  divCode="MESBasic_1_storeSet_StoreSet_placeSetCode_placeSetCode" isCustomize=true > 
							...
							<#assign placeSetName_defaultValue  = ''>
									<#assign placeSetName_defaultValue  = ''>
								<@advsqueryfield formId="ec_MESBasic_storeSet_storeSet_storeRef_adv_queryForm" code="MESBasic_1_storeSet_StoreSet_placeSetName" showFormat="TEXT" defaultValue=placeSetName_defaultValue  divCode="MESBasic_1_storeSet_StoreSet_placeSetName_placeSetName" isCustomize=true > 
							...
							<#assign wareId_wareCode_defaultValue  = ''>
									<#assign wareId_wareCode_defaultValue  = ''>
								<@advsqueryfield formId="ec_MESBasic_storeSet_storeSet_storeRef_adv_queryForm" code="MESBasic_1_wareMan_Ware_wareCode" showFormat="SELECTCOMP" defaultValue=wareId_wareCode_defaultValue  divCode="MESBasic_1_wareMan_Ware_wareCode_wareId_wareCode" isCustomize=true > 
							...
							<#assign wareId_wareName_defaultValue  = ''>
									<#assign wareId_wareName_defaultValue  = ''>
								<@advsqueryfield formId="ec_MESBasic_storeSet_storeSet_storeRef_adv_queryForm" code="MESBasic_1_wareMan_Ware_wareName" showFormat="SELECTCOMP" defaultValue=wareId_wareName_defaultValue  divCode="MESBasic_1_wareMan_Ware_wareName_wareId_wareName" isCustomize=true > 
							...
							<div class="quick_query_content advQuery_content">
								...
								<input type="hidden" id="modelCode" modelcode="MESBasic_1_wareMan_Ware" />
												<@mneclient iframe=true mneenable=true advresume="adv_wareId.id" isCrossCompany=isCrossCompany isPrecise=true deValue="${wareId_wareName_defaultValue!}" reftitle="${getText('MESBasic.viewtitle.randon1484031981880')}"  conditionfunc="MESBasic.storeSet.storeSet.storeRef._querycustomFunc('wareId_wareName')" name="wareId.wareName" id="adv_ec_MESBasic_storeSet_storeSet_storeRef_queryForm_wareId_wareName" displayFieldName="wareName" type="other" exp="like"  classStyle="cui-noborder-input" url="/MESBasic/wareMan/ware/wareRef.action"   refViewCode="MESBasic_1_wareMan_wareRef"  clicked=true multiple=false mnewidth=260 formId="ec_MESBasic_storeSet_storeSet_storeRef_adv_queryForm"   />
...
ec.view.newAdvQuery._customQuery= function(){
	$("[id='MESBasic.storeSet.storeSet.storeRef.advquery'] #advQueryLoading").show();
	var url="/ec/advQuery/advconfig.action?view.code="+'MESBasic_1_storeSet_storeRef'+"&entity.code="+'MESBasic_1_storeSet';
		 $.ajax({
		 url: url, 
		 cache: false,
		 async: false,
		 success:function(html){ 
		 	$("[id='MESBasic.storeSet.storeSet.storeRef.advquery'] #customquContent").html(html);
		 	$("[id='MESBasic.storeSet.storeSet.storeRef.advquery'] #advQueryLoading").hide();
		 }
	});
	onceOpen = true;
...
function changeCustomQuery(){
	if(showType == "up"){
		$('[id="MESBasic.storeSet.storeSet.storeRef.advquery"] div.customqu-content').css('display','none');
		$('[id="MESBasic.storeSet.storeSet.storeRef.advquery"] div.move-grade').css('display','none');
		// $('[id="MESBasic.storeSet.storeSet.storeRef.advquery"] span.customQuery').css('background','url("/bap/struts/css/icon_adv.png") 0 -61px no-repeat');
		$('[id="MESBasic.storeSet.storeSet.storeRef.advquery"] span.customQuery').removeClass("customQuery_down").addClass("customQuery_up");											
		$('[id="MESBasic.storeSet.storeSet.storeRef.advquery"] div.advConContent').css('height','400px');		
		showType = "down";
	}else{
		$('[id="MESBasic.storeSet.storeSet.storeRef.advquery"] div.customqu-content').css('display','block');
		$('[id="MESBasic.storeSet.storeSet.storeRef.advquery"] div.move-grade').css('display','block');
		// $('[id="MESBasic.storeSet.storeSet.storeRef.advquery"] span.customQuery').css('background','url("/bap/struts/css/icon_adv.png") 0 -144px no-repeat');
		$('[id="MESBasic.storeSet.storeSet.storeRef.advquery"] span.customQuery').removeClass("customQuery_up").addClass("customQuery_down");						
		$('[id="MESBasic.storeSet.storeSet.storeRef.advquery"] div.advConContent').css('height','130px');
		if(!onceOpen){
			customQuery();
			onceOpen = true;
		}
...
function ec_MESBasic_storeSet_storeSet_storeRef_PageInitMethod(){
}
