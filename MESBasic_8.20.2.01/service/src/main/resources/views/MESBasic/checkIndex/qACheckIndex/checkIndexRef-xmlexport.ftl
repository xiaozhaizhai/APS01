...
<#assign viewCode = 'MESBasic_1_checkIndex_QACheckIndex' />
<#assign propertyCode = '' />
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'valueKind' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'showValues' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'memoField' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1491476504907')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1491476660888')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'unitID.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.indexRef')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'valueKind' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1491478555877')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'showValues' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1491476684883')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'memoField' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1491476646332')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												...
												<#if item == 'unitID.name' || item == '*'>
													<Cell>
														...
														<#if data.unitID.name??><Data ss:Type="String"><![CDATA[${(data.unitID.name)!}]]></Data></#if>
												...
												<#if item == 'valueKind' || item == '*'>
													<Cell>
														...
														<#if data.valueKind??><Data ss:Type="String"><![CDATA[${(data.valueKind)!}]]></Data></#if>
												...
												<#if item == 'showValues' || item == '*'>
													<Cell>
														...
														<#if data.showValues??><Data ss:Type="String"><![CDATA[${(data.showValues)!}]]></Data></#if>
												...
												<#if item == 'memoField' || item == '*'>
													<Cell>
														...
														<#if data.memoField??><Data ss:Type="String"><![CDATA[${(data.memoField)!}]]></Data></#if>
