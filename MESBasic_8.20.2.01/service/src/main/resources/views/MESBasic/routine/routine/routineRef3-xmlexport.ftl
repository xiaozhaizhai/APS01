			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'srouceEqpObj.equipmentNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.201904081037001')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'destEqp.name' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'destEquObj.equipmentNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.201904081037002')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'product.productName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.201904081037')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'density' || item == '*'>
