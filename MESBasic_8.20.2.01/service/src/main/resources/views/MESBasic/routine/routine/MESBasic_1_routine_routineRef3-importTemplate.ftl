...
<Worksheet ss:Name="sheet1">
	<Table ss:ExpandedColumnCount="256" ss:ExpandedRowCount="3" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="16.5">
			...
			<Column ss:Index="3" ss:Width="100"  ss:StyleID="MESBasic_1_routine_Routine_srouceEqpObj"/>
			<Column ss:Index="4" ss:Width="100"  ss:StyleID="MESBasic_1_routine_Routine_destEquObj"/>
			<Column ss:Index="5" ss:Width="100"  ss:StyleID="MESBasic_1_routine_Routine_product"/>
			<Column ss:Index="6" ss:Width="100"  ss:StyleID="MESBasic_1_routine_Routine_density"/>
			<Column ss:Index="7" ss:Width="100"  ss:StyleID="MESBasic_1_routine_Routine_rootType"/>
			<Column ss:Index="8" ss:Width="100"  ss:StyleID="MESBasic_1_routine_Routine_desCode"/>
			<Column ss:Index="9" ss:Width="100"  ss:StyleID="MESBasic_1_routine_Routine_sourceType"/>
			<Column ss:Index="10" ss:Width="100"  ss:StyleID="MESBasic_1_routine_Routine_desContainer"/>
			<Column ss:Index="11" ss:Width="100"  ss:StyleID="MESBasic_1_routine_Routine_srcContainer"/>
			<Column ss:Index="12" ss:Width="100"  ss:StyleID="MESBasic_1_routine_Routine_routineStatus"/>
			<Column ss:Index="13" ss:Width="100"  ss:StyleID="MESBasic_1_routine_Routine_businessType"/>
			<Column ss:Index="14" ss:Width="100"  ss:StyleID="MESBasic_1_routine_Routine_desType"/>
			<Column ss:Index="15" ss:Width="100"  ss:StyleID="MESBasic_1_routine_Routine_srouce"/>
			<Column ss:Index="16" ss:Width="100"  ss:StyleID="MESBasic_1_routine_Routine_destination"/>
			<Column ss:Index="17" ss:Width="100"  ss:StyleID="MESBasic_1_routine_Routine_destEqp"/>
			<Column ss:Index="18" ss:Width="100"  ss:StyleID="MESBasic_1_routine_Routine_srouceEqp"/>
			<Column ss:Index="19" ss:Width="100"  ss:StyleID="MESBasic_1_routine_Routine_rootineUse"/>
			<Column ss:Index="20" ss:Width="100"  ss:StyleID="MESBasic_1_routine_Routine_routineStrategy"/>
			<Column ss:Index="21" ss:Width="100"  ss:StyleID="MESBasic_1_routine_Routine_srcCode"/>
	...
	<#if customStyleCodes??>
		...
		<Row ss:AutoFitHeight="0">
						...
						<Cell >
							<Data ss:Type="String">目标容器.编码</Data>
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
						...
						<Cell >
							<Data ss:Type="String">源容器.编码</Data>
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
