...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="destEqp.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="destEquObj.equipmentNum">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="name">
	  		...
	  		<Style ss:ID="srouceEqp.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="srouceEqpObj.equipmentNum">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'srouceEqp.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'srouceEqpObj.equipmentNum' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'destEqp.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'destEquObj.equipmentNum' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'srouceEqp.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1427442213645')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'srouceEqpObj.equipmentNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.201904081033001')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'destEqp.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1427442234442')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'destEquObj.equipmentNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.201904081033002')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'product.productName' || item == '*'>
									...
									<#if item?length gt 0>
												...
												<#if item == 'srouceEqp.name' || item == '*'>
													<Cell>
														...
														<#if data.srouceEqp.name??><Data ss:Type="String"><![CDATA[${(data.srouceEqp.name)!}]]></Data></#if>
												...
												<#if item == 'srouceEqpObj.equipmentNum' || item == '*'>
													<Cell>
														...
														<#if data.srouceEqpObj.equipmentNum??><Data ss:Type="String"><![CDATA[${(data.srouceEqpObj.equipmentNum)!}]]></Data></#if>
												...
												<#if item == 'destEqp.name' || item == '*'>
													<Cell>
														...
														<#if data.destEqp.name??><Data ss:Type="String"><![CDATA[${(data.destEqp.name)!}]]></Data></#if>
												...
												<#if item == 'destEquObj.equipmentNum' || item == '*'>
													<Cell>
														...
														<#if data.destEquObj.equipmentNum??><Data ss:Type="String"><![CDATA[${(data.destEquObj.equipmentNum)!}]]></Data></#if>
