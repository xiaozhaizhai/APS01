...
<#assign viewCode = 'MESBasic_1_routine_Routine' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="rootineUse">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="routineStatus">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="routineStrategy">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'routineStatus.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
											...
											<#if item == 'srcContainer.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											...
											<#if item == 'desContainer.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'desType.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
															<Column ss:Index="${count}" ss:StyleID="${item?substring(0,item?last_index_of('.'))}"  ss:Width="140"/>
														 <#else>
														    <Column ss:Index="${count}" ss:StyleID="${item}"  ss:Width="140" />
											...
											<#if item == 'routineStrategy.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
															<Column ss:Index="${count}" ss:StyleID="${item?substring(0,item?last_index_of('.'))}"  ss:Width="140"/>
														 <#else>
														    <Column ss:Index="${count}" ss:StyleID="${item}"  ss:Width="140" />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415336575756')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415336597801')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'routineStatus.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415337256452')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'rootineUse.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1423898703640')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'srcContainer.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion8415268393452')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'sourceType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415337129694')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'desContainer.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion7415268393452')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'desType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415337160653')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'routineStrategy.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415337689809')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'product.productName' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'density' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1423898372445')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'srouce' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415336723895')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'destination' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415336862554')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												...
												<#if item == 'routineStatus.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.routineStatus.value)!}')}</Data>
												...
												<#if item == 'rootineUse.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.rootineUse.value)!}')}</Data>
												...
												<#if item == 'srcContainer.name' || item == '*'>
													<Cell>
														...
														<#if data.srcContainer.name??><Data ss:Type="String"><![CDATA[${(data.srcContainer.name)!}]]></Data></#if>
												...
												<#if item == 'desContainer.name' || item == '*'>
													<Cell>
														...
														<#if data.desContainer.name??><Data ss:Type="String"><![CDATA[${(data.desContainer.name)!}]]></Data></#if>
												...
												<#if item == 'desType.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.desType.value)!}')}</Data>
												...
												<#if item == 'routineStrategy.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.routineStrategy.value)!}')}</Data>
												...
												<#if item == 'density' || item == '*'>
													<Cell>
														...
														<#if (data.density)?has_content><Data ss:Type="Number">#{(data.density)!; m2M2}</Data></#if>
												...
												<#if item == 'srouce' || item == '*'>
													<Cell>
														...
														<#if data.srouce??><Data ss:Type="String"><![CDATA[${(data.srouce)!}]]></Data></#if>
												...
												<#if item == 'destination' || item == '*'>
													<Cell>
														...
														<#if data.destination??><Data ss:Type="String"><![CDATA[${(data.destination)!}]]></Data></#if>
