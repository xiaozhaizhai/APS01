...
<script type="text/javascript">
	...
	function download(){
		//var url = "/MESBasic/routine/routine/downLoad.action?viewCode=MESBasic_1_routine_routineTankList&orgName=MESBasic_1_routine_routineTankList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/MESBasic/routine/routine/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
