...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=MESBasic_1_baseCustomer";
	openExportFrame(url);
}
...
<div id="MESBasic_baseCustomer_baseCustomer_custListPart_attachment">	
