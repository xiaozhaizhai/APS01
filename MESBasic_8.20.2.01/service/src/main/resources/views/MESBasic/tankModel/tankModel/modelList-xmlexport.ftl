...
<#assign viewCode = 'MESBasic_1_tankModel_TankModel' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415150470967')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'name' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'shape.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415150919382')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'volume' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415150645388')}</Data></Cell>
											</#if>
									...
									<#if item?length gt 0>
												...
												<#if item == 'shape.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.shape.value)!}')}</Data>
												...
												<#if item == 'volume' || item == '*'>
													<Cell>
														...
														<#if data.volume??><Data ss:Type="String"><![CDATA[${(data.volume)!}]]></Data></#if>
