...
<script type="text/javascript">
	...
	function download(){
		//var url = "/MESBasic/tankModel/tankModel/downLoad.action?viewCode=MESBasic_1_tankModel_modelList&orgName=MESBasic_1_tankModel_modelList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/MESBasic/tankModel/tankModel/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
