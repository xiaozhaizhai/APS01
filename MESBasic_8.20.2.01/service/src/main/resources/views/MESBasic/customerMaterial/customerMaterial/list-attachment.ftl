...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=MESBasic_1_customerMaterial";
	openExportFrame(url);
}
...
<div id="MESBasic_customerMaterial_customerMaterial_list_attachment">	
