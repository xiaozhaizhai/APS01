...
<script type="text/javascript">
	...
	function download(){
		//var url = "/MESBasic/customerMaterial/customerMaterial/downLoad.action?viewCode=MESBasic_1_customerMaterial_list&orgName=MESBasic_1_customerMaterial_list-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/MESBasic/customerMaterial/customerMaterial/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
