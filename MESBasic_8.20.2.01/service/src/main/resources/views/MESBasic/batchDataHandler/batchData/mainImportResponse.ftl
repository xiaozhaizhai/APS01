...
<script type="text/javascript">
	...
	function download(){
		//var url = "/MESBasic/batchDataHandler/batchData/downLoad.action?viewCode=MESBasic_1_batchDataHandler_dataList&orgName=MESBasic_1_batchDataHandler_dataList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/MESBasic/batchDataHandler/batchData/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
