...
<script type="text/javascript">
	...
	function download(){
		//var url = "/MESBasic/potDataHandler/potData/downLoad.action?viewCode=MESBasic_1_potDataHandler_dataList&orgName=MESBasic_1_potDataHandler_dataList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/MESBasic/potDataHandler/potData/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
