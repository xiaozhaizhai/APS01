...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=MESBasic_1_baseVenderClass";
	openExportFrame(url);
}
...
<div id="MESBasic_baseVenderClass_baseVendorClass_editPart_attachment">	
