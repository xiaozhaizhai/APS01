 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								...
								<#if item == 'vendorCode' || item == '*'>
										<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1435906301259')}</Data></Cell>
								</#if>
								<#if item == 'vendorName' || item == '*'>
										<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1435906340469')}</Data></Cell>
								</#if>
			...
			<Row ss:AutoFitHeight="0">
				<#list exportFieldList as item>
					<#if item?length gt 0>
								...
								<#if item == 'vendorCode' || item == '*'>
									<Cell>
									<#if checkFieldPermission('vendorCode','MESBasic_1_baseVendor_BaseVendor','MESBasic_1_baseVendor_BaseVendor_vendorCode') != 0>
										<#if data.vendorCode??><Data ss:Type="String">${(data.vendorCode)!}</Data></#if>
									</#if>
									</Cell>
								</#if>
								<#if item == 'vendorName' || item == '*'>
									<Cell>
									<#if checkFieldPermission('vendorName','MESBasic_1_baseVendor_BaseVendor','MESBasic_1_baseVendor_BaseVendor_vendorName') != 0>
										<#if data.vendorName??><Data ss:Type="String">${(data.vendorName)!}</Data></#if>
									</#if>
									</Cell>
								</#if>
