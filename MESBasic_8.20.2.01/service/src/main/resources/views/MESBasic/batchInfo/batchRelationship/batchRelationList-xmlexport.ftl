...
<#assign viewCode = 'MESBasic_1_batchInfo_BatchRelationship' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		<Style ss:ID="batchType">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="mainBatch">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="mainProduct.productCode">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="mainProduct.productName">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="partBatch">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="partProduct.productCode">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="partProduct.productName">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											<#if item == 'mainBatch' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'mainProduct.productCode' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'mainProduct.productName' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'partBatch' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'partProduct.productCode' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'partProduct.productName' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'batchType.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'mainBatch' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1490775800542')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'mainProduct.productCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion14157726448333333')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'mainProduct.productName' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'partBatch' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1490775810950')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'partProduct.productCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415772644833333')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'partProduct.productName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1415772740737344')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1490775948825')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												<#if item == 'mainBatch' || item == '*'>
													<Cell>
														...
														<#if data.mainBatch??><Data ss:Type="String"><![CDATA[${(data.mainBatch)!}]]></Data></#if>
												...
												<#if item == 'mainProduct.productCode' || item == '*'>
													<Cell>
														...
														<#if data.mainProduct.productCode??><Data ss:Type="String"><![CDATA[${(data.mainProduct.productCode)!}]]></Data></#if>
												...
												<#if item == 'mainProduct.productName' || item == '*'>
													<Cell>
														...
														<#if data.mainProduct.productName??><Data ss:Type="String"><![CDATA[${(data.mainProduct.productName)!}]]></Data></#if>
												...
												<#if item == 'partBatch' || item == '*'>
													<Cell>
														...
														<#if data.partBatch??><Data ss:Type="String"><![CDATA[${(data.partBatch)!}]]></Data></#if>
												...
												<#if item == 'partProduct.productCode' || item == '*'>
													<Cell>
														...
														<#if data.partProduct.productCode??><Data ss:Type="String"><![CDATA[${(data.partProduct.productCode)!}]]></Data></#if>
												...
												<#if item == 'partProduct.productName' || item == '*'>
													<Cell>
														...
														<#if data.partProduct.productName??><Data ss:Type="String"><![CDATA[${(data.partProduct.productName)!}]]></Data></#if>
												...
												<#if item == 'batchType.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.batchType.value)!}')}</Data>
