...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=MESBasic_1_batchInfo";
	openExportFrame(url);
}
...
<div id="MESBasic_batchInfo_batchRelationship_batchRelationList_attachment">	
