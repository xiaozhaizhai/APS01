...
<#assign viewCode = 'MESBasic_1_batchInfo_BatchDealInfo' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="dealDept.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="dealFromID">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="dealStaff.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="dealTableNo">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="dealType">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		...
	  		<Style ss:ID="sourceBatch">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="workOrderID">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'dealStaff.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'dealDept.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'dealFromID' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'dealTableNo' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'workOrderID' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1490775120800')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'sourceBatch' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1490775137187')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'amount' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1490775217283')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'dealType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1490775239593')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'dealStaff.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.staff.dimissionStaff_xls.staffName4343')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'dealDept.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1490775175784')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'dealFromID' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1490775271111')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'dealTableNo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1490775377605')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'workOrderID' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1490775427260')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'processID' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1490775392241')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'activeID' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1490775411513')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												...
												<#if item == 'sourceBatch' || item == '*'>
													<Cell>
														...
														<#if data.sourceBatch??><Data ss:Type="String"><![CDATA[${(data.sourceBatch)!}]]></Data></#if>
												...
												<#if item == 'amount' || item == '*'>
													<Cell>
														...
														<#if (data.amount)?has_content><Data ss:Type="Number">#{(data.amount)!; m6M6}</Data></#if>
												...
												<#if item == 'dealType.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.dealType.value)!}')}</Data>
												...
												<#if item == 'dealStaff.name' || item == '*'>
													<Cell>
														...
														<#if data.dealStaff.name??><Data ss:Type="String"><![CDATA[${(data.dealStaff.name)!}]]></Data></#if>
												...
												<#if item == 'dealDept.name' || item == '*'>
													<Cell>
														...
														<#if data.dealDept.name??><Data ss:Type="String"><![CDATA[${(data.dealDept.name)!}]]></Data></#if>
												...
												<#if item == 'dealFromID' || item == '*'>
													<Cell>
														...
														<#if data.dealFromID??><Data ss:Type="Number"><![CDATA[${(data.dealFromID)!}]]></Data></#if>
												...
												<#if item == 'dealTableNo' || item == '*'>
													<Cell>
														...
														<#if data.dealTableNo??><Data ss:Type="String"><![CDATA[${(data.dealTableNo)!}]]></Data></#if>
												...
												<#if item == 'workOrderID' || item == '*'>
													<Cell>
														...
														<#if data.workOrderID??><Data ss:Type="Number"><![CDATA[${(data.workOrderID)!}]]></Data></#if>
												...
												<#if item == 'processID' || item == '*'>
													<Cell>
														...
														<#if data.processID??><Data ss:Type="Number"><![CDATA[${(data.processID)!}]]></Data></#if>
												...
												<#if item == 'activeID' || item == '*'>
													<Cell>
														...
														<#if data.activeID??><Data ss:Type="Number"><![CDATA[${(data.activeID)!}]]></Data></#if>
