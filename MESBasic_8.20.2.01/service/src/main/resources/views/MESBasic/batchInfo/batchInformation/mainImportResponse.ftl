...
<script type="text/javascript">
	...
	function download(){
		//var url = "/MESBasic/batchInfo/batchInformation/downLoad.action?viewCode=MESBasic_1_batchInfo_batchInfoList&orgName=MESBasic_1_batchInfo_batchInfoList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/MESBasic/batchInfo/batchInformation/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
