...
<script type="text/javascript">
	...
	function download(){
		var url = "/MESBasic/prodtype/prodtype/downLoad.action?viewCode=MESBasic_1_prodtype_ptlist&orgName=MESBasic_1_prodtype_ptlist-import-error.xls&downloadType=mainError&time=${time}";
		window.open(url,"","");
	}
