...
<#assign viewCode = 'MESBasic_1_area_Area' />
<#assign propertyCode = '' />
								...
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'name' || item == '*'>
			 						        ...
			 						        <#assign customGeneratedFlag=false />
												<#if item == 'name' && !customGeneratedFlag >
												</#if>
											<#if item == 'areaMemo' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon15246364901901410')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon15246365213261410')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
												<#if item == 'name' && !customGeneratedFlag >
												</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'areaMemo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1524636475864')}</Data></Cell>
											</#if>
									...
									<#if item?length gt 0>
												...
												<#if item == 'areaMemo' || item == '*'>
													<Cell>
														...
														<#if data.areaMemo??><Data ss:Type="String"><![CDATA[${(data.areaMemo)!}]]></Data></#if>
