			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productBeSale' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1476755430678')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productBePropCheck' || item == '*'>
									...
									<#if item?length gt 0>
												...
												<#if item == 'productBeSale' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.productBeSale?? && data.productBeSale>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
