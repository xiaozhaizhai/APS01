<#assign exportFields = dg1470194009997Page.exportFields />
<#assign result = dg1470194009997Page.result />
			...
			<Row ss:AutoFitHeight="0">
				<#list exportFieldList as item>
					<#if item?length gt 0>
								...
								<#if item == 'productID.productName' || item == '*'>
									<Cell>
									<#if checkFieldPermission('productID.productName','MESBasic_1_product_ProdLevel','MESBasic_1_product_ProdLevel_productID||MESBasic_1_product_Product_productName') != 0>
								...
								<#if item == 'productID.productCode' || item == '*'>
									<Cell>
									<#if checkFieldPermission('productID.productCode','MESBasic_1_product_ProdLevel','MESBasic_1_product_ProdLevel_productID||MESBasic_1_product_Product_productCode') != 0>
