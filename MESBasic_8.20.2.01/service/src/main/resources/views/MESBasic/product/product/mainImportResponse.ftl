...
<script type="text/javascript">
	...
	function download(){
		//var url = "/MESBasic/product/product/downLoad.action?viewCode=MESBasic_1_product_productPart&orgName=MESBasic_1_product_productPart-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/MESBasic/product/product/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
