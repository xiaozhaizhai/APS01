...
<#assign viewCode = 'MESBasic_1_product_ProdDealInfo' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'content' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1470380337116')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'dealerID.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.staff.dimissionStaff_xls.staffName07')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'dealTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1470380397891')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
