								...
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'limsUnit.name' || item == '*'>
			 						        ...
			 						        <#assign customGeneratedFlag=false />
												<#if item == 'limsUnit.name' && !customGeneratedFlag >
												</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isKeepDate' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1470191030430')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'goodStateForDisplay' || item == '*'>
									...
									<#if item?length gt 0>
												...
												<#if item == 'isKeepDate' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.isKeepDate?? && data.isKeepDate>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
