...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="goodStateForDisplay">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="isNeedWeigh">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="limsUnit.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="pieceNum">
	  			<NumberFormat ss:Format="0.000000"/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="productBaseUnit.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		...
	  		<Style ss:ID="productCostPrice">
	  			<NumberFormat ss:Format="0.0000"/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="productListID.modifyTime">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'productBaseUnit.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'unitGroup.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'productCostPrice' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'productListID.modifyTime' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'isNeedWeigh' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'goodStateForDisplay' || item == '*'>
														 <#if item?index_of('.')!=-1>  
											...
											<#if item == 'limsUnit.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'pieceNum' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
			 						        <#assign customGeneratedFlag=false />
												<#if item == 'pieceNum' && !customGeneratedFlag >
												</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productCostPrice' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1450083900246')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productListID.modifyTime' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isNeedWeigh' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1466392576656')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'goodStateForDisplay' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batch.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.radion1416221870395')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'limsUnit.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1518140257422')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'pieceNum' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1504251291588')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
												<#if item == 'pieceNum' && !customGeneratedFlag >
												</#if>
									...
									<#if item?length gt 0>
												...
												<#if item == 'productBaseUnit.name' || item == '*'>
													<Cell>
														...
														<#if data.productBaseUnit.name??><Data ss:Type="String"><![CDATA[${(data.productBaseUnit.name)!}]]></Data></#if>
												...
												<#if item == 'unitGroup.name' || item == '*'>
													<Cell>
														...
														<#if data.unitGroup.name??><Data ss:Type="String"><![CDATA[${(data.unitGroup.name)!}]]></Data></#if>
												...
												<#if item == 'productCostPrice' || item == '*'>
													<Cell>
														...
														<#if (data.productCostPrice)?has_content><Data ss:Type="Number">#{(data.productCostPrice)!; m4M4}</Data></#if>
												...
												<#if item == 'productListID.modifyTime' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.productListID.modifyTime??><Data ss:Type="DateTime">${(data.productListID.modifyTime)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
												...
												<#if item == 'isNeedWeigh' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.isNeedWeigh?? && data.isNeedWeigh>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'goodStateForDisplay' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.goodStateForDisplay)!}')}</Data>
												...
												<#if item == 'batch.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.batch.value)!}')}</Data>
												...
												<#if item == 'limsUnit.name' || item == '*'>
													<Cell>
														...
														<#if data.limsUnit.name??><Data ss:Type="String"><![CDATA[${(data.limsUnit.name)!}]]></Data></#if>
												...
												<#if item == 'pieceNum' || item == '*'>
													<Cell>
														...
														<#if (data.pieceNum)?has_content><Data ss:Type="Number">#{(data.pieceNum)!; m6M6}</Data></#if>
