...
<script type="text/javascript">
	CUI.ns("MESBasic.product.product","MESBasic.product.product.productRefNew");
</script>
<div class="container"  style="padding-top:10px;">
	...
	<div id="ec_MESBasic_product_product_productRefNew_queryForm_inputValue">
	...
	<form onsubmit="return false" id="ec_MESBasic_product_product_productRefNew_queryForm" exportUrl="/MESBasic/product/product/productRefNew-query.action">
		...
		<input type="hidden" id="dataTableSortColOrder" name="dataTableSortColOrder" />
						...
						<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 margin-bottom-5">						
				       	<@querybutton formId="ec_MESBasic_product_product_productRefNew_queryForm" type="search" onclick="MESBasic.product.product.productRefNew.commonQuery('query')" /> 
...
<script>
	$(function(){
		var buttons = $( 'button.btn-list', '#ec_MESBasic_product_product_productRefNew_queryForm' );
		if( buttons.length > 0 ){
			// 去掉按钮间的空格
...
<script type="text/javascript">
	 ...
	 */
	MESBasic.product.product.productRefNew.query = function(type,pageNo){
		...
		if(!checkListValid("ec_MESBasic_product_product_productRefNew_queryForm")) {
				return false;
		}
		var dataPost = "";
		...
		url += "&crossCompanyFlag=${Parameters.crossCompanyFlag!}";
	 	datatable_ec_MESBasic_product_product_productRefNew_query.setRequestDataUrl(url,dataPost);
		return false;
	};
	...
	foundation.common.${requestUri!}__callbackFunction = function(){
		...
		var oRows = datatable_ec_MESBasic_product_product_productRefNew_query.getSelectedRow();
		if(oRows.length == 0){
		...
		try{
			if(CUI("#MESBasic_product_product_productRefNew_callBackFuncName").val() != ""){
				eval(CUI("#MESBasic_product_product_productRefNew_callBackFuncName").val() + "(arrObj)");
			}
		}catch(e){
		}
	};
...
MESBasic_product_product_productRefNew_refresh = function(node){
	//var url = "/MESBasic/product/product/productRefNew-query.action";
	//if(node.layRec){
	//	datatable_ec_MESBasic_product_product_productRefNew_query.setRequestDataUrl(url,'&'+node.modelName+'.layRec=' + node.layRec,false);
	//}else{
	//	datatable_ec_MESBasic_product_product_productRefNew_query.setRequestDataUrl(url,'',false);
	//}
...
MESBasic.product.product.productRefNew.showLinkView = function(url,propertyId,row,formId,title,width,height,dialogType){
	...
	if(formId) {
		MESBasic.product.product.productRefNew.showDialog(url,formId,title,width,height);
	}else {
		openFullScreen(url);
	}
};
...
function checkListValid(formId){return true;};
	...
	/* CUSTOM CODE START(view-REFERENCE-MESBasic_1_product_productRefNew,js,MESBasic_1_product_Product,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
	</script>
  </body>
