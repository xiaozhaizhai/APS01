			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productChartCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1450083819255')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productBaseUnit.name' || item == '*'>
									...
									<#if item?length gt 0>
												...
												<#if item == 'productChartCode' || item == '*'>
													<Cell>
														...
														<#if data.productChartCode??><Data ss:Type="String"><![CDATA[${(data.productChartCode)!}]]></Data></#if>
