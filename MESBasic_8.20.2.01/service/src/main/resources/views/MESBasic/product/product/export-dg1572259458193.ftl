...
<#assign showCusProps =  dgPage.showCusProps />
	...
	<Styles>
 		...
 		<Style ss:ID="s8">
  		...
  		<Style ss:ID="expireDaysForNotify">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
  		<Style ss:ID="expireDaysInterval">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
  		<Style ss:ID="reinspect">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
  		<Style ss:ID="reinspectUnit">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
 	</Styles>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0 && item != "checkbox">
									<#if item == 'reinspect' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'reinspectUnit.value' || item == 'reinspectUnit.id' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item?split('.')[0]}"/>
									</#if>
									<#if item == 'expireDaysForNotify' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'expireDaysInterval' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'demo' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								<#if item == 'reinspect' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1524758273267')}</Data>
										</Cell>
								</#if>
								<#if item == 'reinspectUnit.value' || item == 'reinspectUnit.id' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1524758365563')}</Data>
										</Cell>
								</#if>
								<#if item == 'expireDaysForNotify' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1524758580531')}</Data>
										</Cell>
								</#if>
								<#if item == 'expireDaysInterval' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1524758793705')}</Data>
										</Cell>
								</#if>
								<#if item == 'demo' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1524762539648')}</Data>
										</Cell>
								</#if>
					...
					<#if item?length gt 0>
								<#if item == 'reinspect' || item == '*'>
									<Cell>
										...
										<Data ss:Type="Number"><#if (data.reinspect)??>${(data.reinspect)!}</#if></Data>
								...
								<#if item == 'reinspectUnit.value' || item == 'reinspectUnit.id' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String">${getText('${(data.reinspectUnit.value)!}')}</Data>
								...
								<#if item == 'expireDaysForNotify' || item == '*'>
									<Cell>
										...
										<Data ss:Type="Number"><#if (data.expireDaysForNotify)??>${(data.expireDaysForNotify)!}</#if></Data>
								...
								<#if item == 'expireDaysInterval' || item == '*'>
									<Cell>
										...
										<Data ss:Type="Number"><#if (data.expireDaysInterval)??>${(data.expireDaysInterval)!}</#if></Data>
