...
<script type="text/javascript">
	...
	function download(){
		var url = "/MESBasic/factoryWare/factoryWare/downLoad.action?viewCode=MESBasic_1_factoryWare_factoryWarePart&orgName=MESBasic_1_factoryWare_factoryWarePart-import-error.xls&downloadType=mainError&time=${time}";
		window.open(url,"","");
	}
