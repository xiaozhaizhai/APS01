...
<script type="text/javascript">
	...
	function download(){
		//var url = "/MESBasic/placeManage/placeManage/downLoad.action?viewCode=MESBasic_1_placeManage_list&orgName=MESBasic_1_placeManage_list-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/MESBasic/placeManage/placeManage/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
