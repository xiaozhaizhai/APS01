...
<#assign viewCode = 'MESBasic_1_wareMan_Ware' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="storeKeeper.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="wareAddress">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="wareCode">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="wareName">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											<#if item == 'wareCode' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'wareName' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'wareAddress' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'storeKeeper.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'isCargo' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'cargoStatue.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'wareAddress' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1484031218230')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'storeKeeper.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1484031191617')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isCargo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('MESBasic.propertydisplayName.randon1484031174141')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'cargoStatue.value' || item == '*'>
									...
									<#if item?length gt 0>
												<#if item == 'wareCode' || item == '*'>
													<Cell>
														...
														<#if data.wareCode??><Data ss:Type="String"><![CDATA[${(data.wareCode)!}]]></Data></#if>
												...
												<#if item == 'wareName' || item == '*'>
													<Cell>
														...
														<#if data.wareName??><Data ss:Type="String"><![CDATA[${(data.wareName)!}]]></Data></#if>
												...
												<#if item == 'wareAddress' || item == '*'>
													<Cell>
														...
														<#if data.wareAddress??><Data ss:Type="String"><![CDATA[${(data.wareAddress)!}]]></Data></#if>
												...
												<#if item == 'storeKeeper.name' || item == '*'>
													<Cell>
														...
														<#if data.storeKeeper.name??><Data ss:Type="String"><![CDATA[${(data.storeKeeper.name)!}]]></Data></#if>
												...
												<#if item == 'isCargo' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.isCargo?? && data.isCargo>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'cargoStatue.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.cargoStatue.value)!}')}</Data>
