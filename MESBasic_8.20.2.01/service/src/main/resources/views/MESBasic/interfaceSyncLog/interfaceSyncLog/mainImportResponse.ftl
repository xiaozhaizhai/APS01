...
<script type="text/javascript">
	...
	function download(){
		//var url = "/MESBasic/interfaceSyncLog/interfaceSyncLog/downLoad.action?viewCode=MESBasic_1_interfaceSyncLog_logList&orgName=MESBasic_1_interfaceSyncLog_logList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/MESBasic/interfaceSyncLog/interfaceSyncLog/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
