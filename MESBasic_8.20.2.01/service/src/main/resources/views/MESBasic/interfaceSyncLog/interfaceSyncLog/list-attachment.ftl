...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=MESBasic_1_interfaceSyncLog";
	openExportFrame(url);
}
...
<div id="MESBasic_interfaceSyncLog_interfaceSyncLog_logList_attachment">	
