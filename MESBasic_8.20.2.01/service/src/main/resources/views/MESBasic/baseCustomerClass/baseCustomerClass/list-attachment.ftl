...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=MESBasic_1_baseCustomerClass";
	openExportFrame(url);
}
...
<div id="MESBasic_baseCustomerClass_baseCustomerClass_listCustPart_attachment">	
