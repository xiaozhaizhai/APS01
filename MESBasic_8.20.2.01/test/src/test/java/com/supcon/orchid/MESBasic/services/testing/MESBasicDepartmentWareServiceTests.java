...
import com.supcon.orchid.MESBasic.services.DepartmentWareService;

import org.easymock.EasyMock;
import org.easymock.IMocksControl;
/* CUSTOM CODE START(serviceTests,import,MESBasic_1_factoryWare_DepartmentWare,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */

public class DepartmentWareServiceTests extends AbstractOrchidServiceTests {

	@Autowired
	private DepartmentWareService departmentWareService;
	@Autowired
	...
	public void setUpData() throws Exception {
		...
		/* CUSTOM CODE START(serviceTests,beforeSetUp,MESBasic_1_factoryWare_DepartmentWare,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
	}
	...
	/* CUSTOM CODE START(serviceTests,functions,MESBasic_1_factoryWare_DepartmentWare,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
}