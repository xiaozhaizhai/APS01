...
import com.supcon.orchid.MESBasic.services.ProdattrelService;

import org.easymock.EasyMock;
import org.easymock.IMocksControl;
/* CUSTOM CODE START(serviceTests,import,MESBasic_1_prodatriel_Prodattrel,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */

public class ProdattrelServiceTests extends AbstractOrchidServiceTests {

	@Autowired
	private ProdattrelService prodattrelService;
	@Autowired
	...
	public void setUpData() throws Exception {
		...
		/* CUSTOM CODE START(serviceTests,beforeSetUp,MESBasic_1_prodatriel_Prodattrel,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
	}
	...
	/* CUSTOM CODE START(serviceTests,functions,MESBasic_1_prodatriel_Prodattrel,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
}