...
import com.supcon.orchid.MESBasic.services.PotDataService;

import org.easymock.EasyMock;
import org.easymock.IMocksControl;
/* CUSTOM CODE START(serviceTests,import,MESBasic_1_potDataHandler_PotData,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */

public class PotDataServiceTests extends AbstractOrchidServiceTests {

	@Autowired
	private PotDataService potDataService;
	@Autowired
	...
	public void setUpData() throws Exception {
		...
		/* CUSTOM CODE START(serviceTests,beforeSetUp,MESBasic_1_potDataHandler_PotData,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
	}
	...
	/* CUSTOM CODE START(serviceTests,functions,MESBasic_1_potDataHandler_PotData,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
}