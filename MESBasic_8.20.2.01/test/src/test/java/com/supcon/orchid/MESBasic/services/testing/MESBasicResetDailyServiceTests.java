...
import com.supcon.orchid.MESBasic.services.ResetDailyService;

import org.easymock.EasyMock;
import org.easymock.IMocksControl;
/* CUSTOM CODE START(serviceTests,import,MESBasic_1_resetDaily_ResetDaily,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */

public class ResetDailyServiceTests extends AbstractOrchidServiceTests {

	@Autowired
	private ResetDailyService resetDailyService;
	@Autowired
	...
	public void setUpData() throws Exception {
		...
		/* CUSTOM CODE START(serviceTests,beforeSetUp,MESBasic_1_resetDaily_ResetDaily,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	/* CUSTOM CODE START(serviceTests,functions,MESBasic_1_resetDaily_ResetDaily,MESBasic_1) */
// 自定义代码
