...
import com.supcon.orchid.MESBasic.services.S2BaseTableTypeService;

import org.easymock.EasyMock;
import org.easymock.IMocksControl;
/* CUSTOM CODE START(serviceTests,import,MESBasic_1_tableType_S2BaseTableType,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */

public class S2BaseTableTypeServiceTests extends AbstractOrchidServiceTests {

	@Autowired
	private S2BaseTableTypeService s2BaseTableTypeService;
	@Autowired
	...
	public void setUpData() throws Exception {
		...
		/* CUSTOM CODE START(serviceTests,beforeSetUp,MESBasic_1_tableType_S2BaseTableType,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	/* CUSTOM CODE START(serviceTests,functions,MESBasic_1_tableType_S2BaseTableType,MESBasic_1) */
// 自定义代码
