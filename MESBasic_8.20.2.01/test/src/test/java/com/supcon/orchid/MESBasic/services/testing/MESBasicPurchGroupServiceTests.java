...
import com.supcon.orchid.MESBasic.services.PurchGroupService;

import org.easymock.EasyMock;
import org.easymock.IMocksControl;
/* CUSTOM CODE START(serviceTests,import,MESBasic_1_purch_Group_PurchGroup,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */

public class PurchGroupServiceTests extends AbstractOrchidServiceTests {

	@Autowired
	private PurchGroupService purchGroupService;
	@Autowired
	...
	public void setUpData() throws Exception {
		...
		/* CUSTOM CODE START(serviceTests,beforeSetUp,MESBasic_1_purch_Group_PurchGroup,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
	}
	...
	/* CUSTOM CODE START(serviceTests,functions,MESBasic_1_purch_Group_PurchGroup,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
}