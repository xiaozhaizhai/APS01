...
import com.supcon.orchid.MESBasic.services.FactoryWareMateService;

import org.easymock.EasyMock;
import org.easymock.IMocksControl;
/* CUSTOM CODE START(serviceTests,import,MESBasic_1_factoryWare_FactoryWareMate,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */

public class FactoryWareMateServiceTests extends AbstractOrchidServiceTests {

	@Autowired
	private FactoryWareMateService factoryWareMateService;
	@Autowired
	...
	public void setUpData() throws Exception {
		...
		/* CUSTOM CODE START(serviceTests,beforeSetUp,MESBasic_1_factoryWare_FactoryWareMate,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	/* CUSTOM CODE START(serviceTests,functions,MESBasic_1_factoryWare_FactoryWareMate,MESBasic_1) */
// 自定义代码
