...
import com.supcon.orchid.MESBasic.services.ObjTeamService;

import org.easymock.EasyMock;
import org.easymock.IMocksControl;
/* CUSTOM CODE START(serviceTests,import,MESBasic_1_factoryModel_ObjTeam,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */

public class ObjTeamServiceTests extends AbstractOrchidServiceTests {

	@Autowired
	private ObjTeamService objTeamService;
	@Autowired
	...
	public void setUpData() throws Exception {
		...
		/* CUSTOM CODE START(serviceTests,beforeSetUp,MESBasic_1_factoryModel_ObjTeam,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
	}
	...
	/* CUSTOM CODE START(serviceTests,functions,MESBasic_1_factoryModel_ObjTeam,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
}