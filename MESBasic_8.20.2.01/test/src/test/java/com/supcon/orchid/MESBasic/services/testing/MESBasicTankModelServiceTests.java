...
import com.supcon.orchid.MESBasic.services.TankModelService;

import org.easymock.EasyMock;
import org.easymock.IMocksControl;
/* CUSTOM CODE START(serviceTests,import,MESBasic_1_tankModel_TankModel,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */

public class TankModelServiceTests extends AbstractOrchidServiceTests {

	@Autowired
	private TankModelService tankModelService;
	@Autowired
	...
	public void setUpData() throws Exception {
		...
		/* CUSTOM CODE START(serviceTests,beforeSetUp,MESBasic_1_tankModel_TankModel,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
	}
	...
	/* CUSTOM CODE START(serviceTests,functions,MESBasic_1_tankModel_TankModel,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
}