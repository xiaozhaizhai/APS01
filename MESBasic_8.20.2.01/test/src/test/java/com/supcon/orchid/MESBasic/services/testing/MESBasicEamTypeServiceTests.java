...
import com.supcon.orchid.MESBasic.services.EamTypeService;

import org.easymock.EasyMock;
import org.easymock.IMocksControl;
/* CUSTOM CODE START(serviceTests,import,MESBasic_1_eamType_EamType,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */

public class EamTypeServiceTests extends AbstractOrchidServiceTests {

	@Autowired
	private EamTypeService eamTypeService;
	@Autowired
	...
	public void setUpData() throws Exception {
		...
		/* CUSTOM CODE START(serviceTests,beforeSetUp,MESBasic_1_eamType_EamType,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	/* CUSTOM CODE START(serviceTests,functions,MESBasic_1_eamType_EamType,MESBasic_1) */
// 自定义代码
