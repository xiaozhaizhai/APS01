...
import com.supcon.orchid.MESBasic.services.CprodAttService;

import org.easymock.EasyMock;
import org.easymock.IMocksControl;
/* CUSTOM CODE START(serviceTests,import,MESBasic_1_product_CprodAtt,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */

public class CprodAttServiceTests extends AbstractOrchidServiceTests {

	@Autowired
	private CprodAttService cprodAttService;
	@Autowired
	...
	public void setUpData() throws Exception {
		...
		/* CUSTOM CODE START(serviceTests,beforeSetUp,MESBasic_1_product_CprodAtt,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
	}
	...
	/* CUSTOM CODE START(serviceTests,functions,MESBasic_1_product_CprodAtt,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
}