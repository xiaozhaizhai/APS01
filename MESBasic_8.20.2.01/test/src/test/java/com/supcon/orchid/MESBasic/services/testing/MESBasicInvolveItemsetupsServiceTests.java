...
import com.supcon.orchid.MESBasic.services.InvolveItemsetupsService;

import org.easymock.EasyMock;
import org.easymock.IMocksControl;
/* CUSTOM CODE START(serviceTests,import,MESBasic_1_routine_InvolveItemsetups,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */

public class InvolveItemsetupsServiceTests extends AbstractOrchidServiceTests {

	@Autowired
	private InvolveItemsetupsService involveItemsetupsService;
	@Autowired
	...
	public void setUpData() throws Exception {
		...
		/* CUSTOM CODE START(serviceTests,beforeSetUp,MESBasic_1_routine_InvolveItemsetups,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
	}
	...
	/* CUSTOM CODE START(serviceTests,functions,MESBasic_1_routine_InvolveItemsetups,MESBasic_1) */
// 自定义代码
/* CUSTOM CODE END */
}