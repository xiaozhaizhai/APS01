...
import com.supcon.orchid.MESBasic.services.FacWareModelService;

import org.easymock.EasyMock;
import org.easymock.IMocksControl;
/* CUSTOM CODE START(serviceTests,import,MESBasic_1_factoryWare_FacWareModel,MESBasic_1) */
// 自定义代码

/* CUSTOM CODE END */

public class FacWareModelServiceTests extends AbstractOrchidServiceTests {

	@Autowired
	private FacWareModelService facWareModelService;
	@Autowired
	...
	public void setUpData() throws Exception {
		...
		/* CUSTOM CODE START(serviceTests,beforeSetUp,MESBasic_1_factoryWare_FacWareModel,MESBasic_1) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	/* CUSTOM CODE START(serviceTests,functions,MESBasic_1_factoryWare_FacWareModel,MESBasic_1) */
// 自定义代码
