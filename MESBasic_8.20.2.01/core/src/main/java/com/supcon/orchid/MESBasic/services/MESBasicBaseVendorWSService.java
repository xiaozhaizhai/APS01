...
/* CUSTOM CODE START(wsservice,import,MESBasic_1_baseVendor_BaseVendor,MESBasic_1) */
// 自定义代码
...
public interface MESBasicBaseVendorWSService{
//-------------------主模型WS--------------------
		/**
		 * 根据业务主键获取供应商数据
		 * @param 业务主键
		...
		/**
		 * 批量新增供应商
		 * @param 供应商对象，每个供应商对象必须包含ownerStaffUUID
		 * @return jws返回对象
		 */
		@WebMethod
		public  @WebResult(name="jwsResult")JWSListResultDTO batchAddBaseVendor(
				@WebParam(name="baseVendorList")List<MESBasicBaseVendor> baseVendorList,
				@WebParam(name="ownerStaffUUID")String ownerStaffUUID);

		/**
		 * 批量修改供应商
		 * @param 供应商对象列表，每个贩卖机对象必须包含ownerStaffUUID,业务主键或者id
		 * @return jws返回对象
		 */
		@WebMethod
	...
	/* CUSTOM CODE START(wsservice,functions,MESBasic_1_baseVendor_BaseVendor,MESBasic_1) */
// 自定义代码
