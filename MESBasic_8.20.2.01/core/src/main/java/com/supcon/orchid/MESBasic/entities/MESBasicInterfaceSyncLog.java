 ...
 * 接口同步日志.
 */
@javax.persistence.Entity(name=MESBasicInterfaceSyncLog.JPA_NAME)
@Table(name = MESBasicInterfaceSyncLog.TABLE_NAME)
@BAPEntity(entityCode="MESBasic_1_interfaceSyncLog")
@XmlRootElement
@BAPModelCode(code="MESBasic_1_interfaceSyncLog_InterfaceSyncLog")
@AttributeOverrides({
		...
		/* CUSTOM CODE START(entity,attribute_overrides,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码
...
@BAPCustomComponent
@DataAudit
@XmlSeeAlso({MESBasicInterfaceSyncLogConvertor.class})
public class MESBasicInterfaceSyncLog extends com.supcon.orchid.orm.entities.AbstractEcFullEntity {
	private static final long serialVersionUID = 1L;
	public static final String MODULE_CODE = "MESBasic_1";
	public static final String ENTITY_CODE = "MESBasic_1_interfaceSyncLog";
	public static final String MODEL_CODE = "MESBasic_1_interfaceSyncLog_InterfaceSyncLog";
	public static final String DOC_TYPE = "MESBasic_interfaceSyncLog_interfaceSyncLog";
	public static final String TABLE_NAME = "interface_sync_log";
	public static final String JPA_NAME = "MESBasicInterfaceSyncLog";
	...
	/* CUSTOM CODE START(entity,functions,MESBasic_1_interfaceSyncLog_InterfaceSyncLog,MESBasic_1) */
// 自定义代码
