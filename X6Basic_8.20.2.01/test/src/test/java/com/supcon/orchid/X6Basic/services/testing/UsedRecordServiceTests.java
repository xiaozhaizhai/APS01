...
/* CUSTOM CODE START(serviceTests,import,X6Basic_1.0_meetingroom_UsedRecord,X6Basic_1.0) */
// 自定义代码
/* CUSTOM CODE END */
public class UsedRecordServiceTests extends AbstractOrchidServiceTests {
	...
	public void setUpData() throws Exception {
		...
		/* CUSTOM CODE START(serviceTests,beforeSetUp,X6Basic_1.0_meetingroom_UsedRecord,X6Basic_1.0) */
// 自定义代码
/* CUSTOM CODE END */
	}
	...
	/* CUSTOM CODE START(serviceTests,functions,X6Basic_1.0_meetingroom_UsedRecord,X6Basic_1.0) */
// 自定义代码
/* CUSTOM CODE END */
}