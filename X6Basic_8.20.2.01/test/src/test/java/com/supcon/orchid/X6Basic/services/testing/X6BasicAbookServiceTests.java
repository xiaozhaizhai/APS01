...
import com.supcon.orchid.X6Basic.services.AbookService;

import org.easymock.EasyMock;
import org.easymock.IMocksControl;
/* CUSTOM CODE START(serviceTests,import,X6Basic_1.0_addressBook_Abook,X6Basic_1.0) */
// 自定义代码
/* CUSTOM CODE END */
public class AbookServiceTests extends AbstractOrchidServiceTests {

	@Autowired
	private AbookService abookService;
	@Autowired
	...
	public void setUpData() throws Exception {
		...
		/* CUSTOM CODE START(serviceTests,beforeSetUp,X6Basic_1.0_addressBook_Abook,X6Basic_1.0) */
// 自定义代码
/* CUSTOM CODE END */
	}
	...
	/* CUSTOM CODE START(serviceTests,functions,X6Basic_1.0_addressBook_Abook,X6Basic_1.0) */
// 自定义代码
/* CUSTOM CODE END */
}