			...
			<Row ss:AutoFitHeight="0">
				<#list exportFieldList as item>
					<#if item?length gt 0>
								...
								<#if item == 'code' || item == '*'>
									<Cell>
									<#if checkFieldPermission('code','X6Basic_1.0_attMachine_AttMachine','X6Basic_1.0_attMachine_AttMachine_code') != 0>
								...
								<#if item == 'name' || item == '*'>
									<Cell>
									<#if checkFieldPermission('name','X6Basic_1.0_attMachine_AttMachine','X6Basic_1.0_attMachine_AttMachine_name') != 0>
