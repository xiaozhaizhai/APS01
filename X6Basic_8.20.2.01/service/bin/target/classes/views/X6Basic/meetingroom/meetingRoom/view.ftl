...
<@s.form id="X6Basic_meetingroom_meetingRoom_view_form" cssStyle="height:100%;" onsubmitMethod="X6Basic.meetingroom.meetingRoom.view.beforeSubmitMethod()" ecAction="/X6Basic/meetingroom/meetingRoom/view/submit.action?__pc__=${(Parameters.__pc__)!}" callback="X6Basic.meetingroom.meetingRoom.callBackInfo" ecform="true">
	...
	<div id="X6Basic_view_edit_div" style="height:100%">
		<div id="X6Basic_meetingroom_meetingRoom_view_main_div" class="edit-content-dialog">
<script type="text/javascript">
					...
					<td <#if X6Basic_1_0_meetingroom_MeetingRoom_roomSize_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-content"   style="text-align: left;;" >
							...
							<#else>
								<#if newObj>
									...
									<@systemcode onchange="" viewType="${viewType!}" deValue="${meetingRoom_roomSize_defaultValue!}" formId="X6Basic_meetingroom_meetingRoom_view_form" classStyle="cui-noborder-input" view=true cssStyle="" name="meetingRoom.roomSize.id" code="meetingSize" value="${(meetingRoom.roomSize.id)!}" />
									<#else>
									<@systemcode onchange=""  viewType="${viewType!}" deValue="${meetingRoom_roomSize_defaultValue!}" formId="X6Basic_meetingroom_meetingRoom_view_form" classStyle="cui-noborder-input" view=true cssStyle="" name="meetingRoom.roomSize.id" code="meetingSize" value="${(meetingRoom.roomSize.id)!}" />
									</#if>
								<#else>
									<#if X6Basic_1_0_meetingroom_MeetingRoom_roomSize_permit == 1>
									<@systemcode onchange=""  viewType="${viewType!}"  formId="X6Basic_meetingroom_meetingRoom_view_form" classStyle="cui-noborder-input" view=true cssStyle="" name="meetingRoom.roomSize.id" code="meetingSize" value="${(meetingRoom.roomSize.id)!}" />
									<#else>
									<@systemcode onchange=""  viewType="${viewType!}"  formId="X6Basic_meetingroom_meetingRoom_view_form" classStyle="cui-noborder-input" view=true cssStyle="" name="meetingRoom.roomSize.id" code="meetingSize" value="${(meetingRoom.roomSize.id)!}" />
									</#if>
								</#if>
					...
					<td <#if X6Basic_1_0_meetingroom_MeetingRoom_staff_base_staff_name_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
							...
							<#else>
								<#if X6Basic_1_0_meetingroom_MeetingRoom_staff_base_staff_name_permit == 1>
									<@mneclient reftitle="${getText('foundation.ec.entity.view.reference')}" conditionfunc="X6Basic.meetingroom.meetingRoom.view._querycustomFunc('meetingRoom_staff_name')" view=true value="${(meetingRoom.staff.name)!}" displayFieldName="name" name="meetingRoom.staff.name" id="meetingRoom_staff_name" type="Staff" url="/foundation/staff/common/staffListFrameset.action" clicked=true multiple=false mnewidth=260 formId="X6Basic_meetingroom_meetingRoom_view_form" editCustomCallback=";" onkeyupfuncname=";_callback_meetingRoom_staff_name(obj);" cssStyle="" isEdit=true   isCrossCompany=false/>
								<#else>
									<@mneclient reftitle="${getText('foundation.ec.entity.view.reference')}" viewType="${viewType!}" deValue="${meetingRoom_staff_name_defaultValue!}" conditionfunc="X6Basic.meetingroom.meetingRoom.view._querycustomFunc('meetingRoom_staff_name')" view=true  value="${(meetingRoom.staff.name)!}" displayFieldName="name" name="meetingRoom.staff.name" id="meetingRoom_staff_name" type="Staff" url="/foundation/staff/common/staffListFrameset.action" clicked=true multiple=false mnewidth=260 formId="X6Basic_meetingroom_meetingRoom_view_form" editCustomCallback=";" onkeyupfuncname=";_callback_meetingRoom_staff_name(obj);" cssStyle="" isEdit=true   isCrossCompany=false/>
								</#if>
					...
					<td <#if X6Basic_1_0_meetingroom_MeetingRoom_attMatching_X6Basic_1_0_attMachine_AttMachine_name_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
							...
							<#else>
								<#if X6Basic_1_0_meetingroom_MeetingRoom_attMatching_X6Basic_1_0_attMachine_AttMachine_name_permit == 1>
									<@selector cssClass="cui-noborder-input" view=true id="meetingRoom.attMatching.name" cssStyle="" name="meetingRoom.attMatching.name" value="${(meetingRoom.attMatching.name)!}" pageType="other" onclick="X6Basic.meetingroom.meetingRoom.view._selectEvent" funcparam="'meetingRoom.attMatching.name','other','/X6Basic/attMachine/attMachine/ref.action','${getText('X6Basic.viewtitle.radion1367462816202')}',null,null,'',false"  isCrossCompany=false />
								<#else>
									<@selector cssClass="cui-noborder-input" viewType="${viewType!}" deValue="${meetingRoom_attMatching_name_defaultValue!}" view=true  id="meetingRoom.attMatching.name" cssStyle="" name="meetingRoom.attMatching.name" value="${(meetingRoom.attMatching.name)!}" pageType="other" onclick="X6Basic.meetingroom.meetingRoom.view._selectEvent" funcparam="'meetingRoom.attMatching.name','other','/X6Basic/attMachine/attMachine/ref.action','${getText('X6Basic.viewtitle.radion1367462816202')}',null,null,'',false"  isCrossCompany=false />
								</#if>
			...
			X6Basic.meetingroom.meetingRoom.view.settingDialog = new CUI.Dialog({
					...
					buttons:[
							{	name:"${getText("ec.flow.save")}",
								handler:function(){if(X6Basic.meetingroom.meetingRoom.view.saveSetting()){this.close();}}
							},
...
<script type="text/javascript">
	...
	X6Basic.meetingroom.meetingRoom.view.initSize = function(nTabIndex){
		...
		var	conHeight = h-$("#X6Basic_meetingroom_meetingRoom_view_main_div .edit-tabs").height() - 6;
