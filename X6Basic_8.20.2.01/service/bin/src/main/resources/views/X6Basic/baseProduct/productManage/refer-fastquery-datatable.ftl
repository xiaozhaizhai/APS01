	...
	<form onsubmit="return false" id="ec_X6Basic_baseProduct_productManage_refer_queryForm" exportUrl="/X6Basic/baseProduct/productManage/refer-query.action">
		...
		<@dataclassific id="dataClassific" viewCode="X6Basic_1.0_baseProduct_refer" formId="ec_X6Basic_baseProduct_productManage_refer_queryForm" dataTableId="ec_X6Basic_baseProduct_productManage_refer_query" />
					...
					<@quickquery unique="LAST_QUERY_ec_X6Basic_baseProduct_productManage_refer_queryForm" formId="ec_X6Basic_baseProduct_productManage_refer_queryForm"  fieldcodes="X6Basic_1.0_baseProduct_ProductManage_code_code:X6Basic.propertydisplayName.radion1371468505565||X6Basic_1.0_baseProduct_ProductManage_name_name:X6Basic.propertydisplayName.radion1371468737467||X6Basic_1.0_baseProduct_ProductManage_unit_unit:X6Basic.propertydisplayName.radion1371468832370" > 
							<@queryfield formId="ec_X6Basic_baseProduct_productManage_refer_queryForm" code="X6Basic_1.0_baseProduct_ProductManage_code" showFormat="TEXT" divCode="X6Basic_1.0_baseProduct_ProductManage_code_code" isCustomize=true > 
							...
							<@queryfield formId="ec_X6Basic_baseProduct_productManage_refer_queryForm" code="X6Basic_1.0_baseProduct_ProductManage_name" showFormat="TEXT" divCode="X6Basic_1.0_baseProduct_ProductManage_name_name" isCustomize=true > 
							...
							<@queryfield formId="ec_X6Basic_baseProduct_productManage_refer_queryForm" code="X6Basic_1.0_baseProduct_ProductManage_unit" showFormat="TEXT" divCode="X6Basic_1.0_baseProduct_ProductManage_unit_unit" isCustomize=true > 
