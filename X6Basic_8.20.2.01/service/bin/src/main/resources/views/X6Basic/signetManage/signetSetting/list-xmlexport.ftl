 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								...
								<#if item == 'name' || item == '*'>
										<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1367133494680')}</Data></Cell>
								</#if>
								<#if item == 'userinfo.name' || item == '*'>
										<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1367133528419')}</Data></Cell>
								</#if>
			...
			<Row ss:AutoFitHeight="0">
				<#list exportFieldList as item>
					<#if item?length gt 0>
								...
								<#if item == 'name' || item == '*'>
									<Cell>
									<#if checkFieldPermission('name','X6Basic_1.0_signetManage_SignetSetting','X6Basic_1.0_signetManage_SignetSetting_name') != 0>
								...
								<#if item == 'userinfo.name' || item == '*'>
									<Cell>
									<#if checkFieldPermission('userinfo.name','X6Basic_1.0_signetManage_SignetSetting','X6Basic_1.0_signetManage_SignetSetting_userinfo||base_user_name') != 0>
										<#if data.userinfo.name??><Data ss:Type="String">${(data.userinfo.name)!}</Data></#if>
									</#if>
									</Cell>
								</#if>
