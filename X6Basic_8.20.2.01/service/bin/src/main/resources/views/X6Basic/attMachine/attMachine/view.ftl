...
<@s.form id="X6Basic_attMachine_attMachine_view_form" cssStyle="height:100%;" onsubmitMethod="X6Basic.attMachine.attMachine.view.beforeSubmitMethod()" ecAction="/X6Basic/attMachine/attMachine/view/submit.action?__pc__=${(Parameters.__pc__)!}" callback="X6Basic.attMachine.attMachine.callBackInfo" ecform="true">
	...
	<div id="X6Basic_view_edit_div" style="height:100%">
		<div id="X6Basic_attMachine_attMachine_view_main_div" class="edit-content-dialog">
<script type="text/javascript">
					...
					<td <#if X6Basic_1_0_attMachine_AttMachine_attType_permit != 3>nofieldPermission="true"</#if> nullable=true class="edit-table-content"   style="text-align: left;;" >
							...
							<#else>
								<#if newObj>
									...
									<@systemcode onchange="" viewType="${viewType!}" deValue="${attMachine_attType_defaultValue!}" formId="X6Basic_attMachine_attMachine_view_form" classStyle="cui-noborder-input" view=true cssStyle="" name="attMachine.attType.id" code="attType" value="${(attMachine.attType.id)!}" />
									<#else>
									<@systemcode onchange=""  viewType="${viewType!}" deValue="${attMachine_attType_defaultValue!}" formId="X6Basic_attMachine_attMachine_view_form" classStyle="cui-noborder-input" view=true cssStyle="" name="attMachine.attType.id" code="attType" value="${(attMachine.attType.id)!}" />
									</#if>
								<#else>
									<#if X6Basic_1_0_attMachine_AttMachine_attType_permit == 1>
									<@systemcode onchange=""  viewType="${viewType!}"  formId="X6Basic_attMachine_attMachine_view_form" classStyle="cui-noborder-input" view=true cssStyle="" name="attMachine.attType.id" code="attType" value="${(attMachine.attType.id)!}" />
									<#else>
									<@systemcode onchange=""  viewType="${viewType!}"  formId="X6Basic_attMachine_attMachine_view_form" classStyle="cui-noborder-input" view=true cssStyle="" name="attMachine.attType.id" code="attType" value="${(attMachine.attType.id)!}" />
									</#if>
								</#if>
			...
			X6Basic.attMachine.attMachine.view.settingDialog = new CUI.Dialog({
					...
					buttons:[
							{	name:"${getText("ec.flow.save")}",
								handler:function(){if(X6Basic.attMachine.attMachine.view.saveSetting()){this.close();}}
							},
...
<script type="text/javascript">
	...
	X6Basic.attMachine.attMachine.view.initSize = function(nTabIndex){
		...
		var	conHeight = h-$("#X6Basic_attMachine_attMachine_view_main_div .edit-tabs").height() - 6;
