...
<script type="text/javascript">
	...
	function download(){
		//var url = "/X6Basic/baseProduct/productManage/downLoad.action?viewCode=X6Basic_1.0_baseProduct_list&orgName=X6Basic_1.0_baseProduct_list-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/X6Basic/baseProduct/productManage/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
