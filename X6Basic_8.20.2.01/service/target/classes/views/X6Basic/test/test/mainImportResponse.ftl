...
<script type="text/javascript">
	...
	function download(){
		var url = "/X6Basic/test/test/downLoad.action?viewCode=X6Basic_1.0_test_list&orgName=X6Basic_1.0_test_list-import-error.xls&downloadType=mainError&time=${time}";
		window.open(url,"","");
	}
