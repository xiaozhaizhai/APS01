...
<#assign viewCode = 'X6Basic_1.0_syncLog_SyncLog' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="emailFlag">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="eventTopic">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="pandionFlag">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="syncStaff.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="userName">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'eventTopic' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'emailFlag' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'bbsFlag' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'pandionFlag' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'userName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1411470059302')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'eventTopic' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1411469523904')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'emailFlag' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1411471915862')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'bbsFlag' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1411471826322')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'pandionFlag' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1411471873958')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'createTime' || item == '*'>
									...
									<#if item?length gt 0>
												<#if item == 'syncStaff.name' || item == '*'>
													<Cell>
														...
														<#if data.syncStaff.name??><Data ss:Type="String"><![CDATA[${(data.syncStaff.name)!}]]></Data></#if>
												...
												<#if item == 'userName' || item == '*'>
													<Cell>
														...
														<#if data.userName??><Data ss:Type="String"><![CDATA[${(data.userName)!}]]></Data></#if>
												...
												<#if item == 'eventTopic' || item == '*'>
													<Cell>
														...
														<#if data.eventTopic??><Data ss:Type="String"><![CDATA[${(data.eventTopic)!}]]></Data></#if>
												...
												<#if item == 'emailFlag' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.emailFlag?? && data.emailFlag>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'bbsFlag' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.bbsFlag?? && data.bbsFlag>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'pandionFlag' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.pandionFlag?? && data.pandionFlag>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
