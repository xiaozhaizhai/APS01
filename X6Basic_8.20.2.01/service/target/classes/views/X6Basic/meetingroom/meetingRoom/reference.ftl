...
<div id="ec_calendar_meetingRoom_meetingRoomInfo_reference_container" >
	...
	<div id="meetingRoom_info_recordcolt" class="etv-navset" style="width: 786px; ">
		<div>
			<div class="etv-scrollbar" id="scrollbar" style="width: 776px; ">
				<ul class="etv-nav nav-scroll" style="display: block; ">
				    <li onclick="createDateTable(this)" num="0" clickFlag="true"><span class="etv-nav-span"><em class="etv-nav-em" style="width: 70px; ">空闲</em></span><span class="etv-nav-span-r"></span></li>
				    <li onclick="createDateTable(this)" num="1" clickFlag="false"><span class="etv-nav-span"><em class="etv-nav-em" style="width: 70px; ">显示所有</em></span><span class="etv-nav-span-r"></span></li>
				    <li onclick="createDateTable(this)" num="2" clickFlag="false"><span class="etv-nav-span"><em class="etv-nav-em" style="width: 70px; ">使用情况</em></span><span class="etv-nav-span-r"></span></li>
				</ul>
		</div>
		<div class="etv-content" style="margin-left:-8px; height: 485px; width: 786px; ">
			...
			<@datatable id="ec_calendar_meetingRoom_meetingRoomInfo_reference_all" firstLoad=false height=420 modelCode="X6Basic_1.0_meetingroom_MeetingRoom" renderOverEvent="ec_calendar_meetingRoom_meetingRoomInfo_reference_all_RenderOverEvent" noPermissionKeys="name,roomSize,network,whiteBoard,audio,projector,camera" hidekeyPrefix="ec_calendar_meetingRoom_meetingRoomInfo_reference_all" orderMode="backstage" queryFunc="" formId="ec_calendar_meetingRoom_meetingRoomInfo_reference_queryForm" exportExcel=false dblclick="" style="margin-left:13px;margin-right:4px;" editable=false dtPage="freeMeetingRoomPage" dataUrl="/X6Basic/meetingroom/meetingRoom/reference-all.action" transMethod="post" hidekey="['id','version']" >
				<#if flowBulkFlag?? && flowBulkFlag==true>
	    			<@datacolumn key="checkbox" type="checkbox" textalign="center" checkall="true" label="" width=30 />
	    		</#if>
				<#assign name_displayDefaultType  = ''>
			...
			<script type="text/javascript">
				 ...
				 * 
				 */
				function ec_calendar_meetingRoom_meetingRoomInfo_reference_all_RenderOverEvent(){
					YUE.removeListener( ec_calendar_meetingRoom_meetingRoomInfo_reference_allWidget._bTbody.getElementsByTagName('tr'), 'click' );
				}
			</script>
			...
			<div id="ec_calendar_meetingRoom_meetingRoomInfo_reference_useStatus" valign="top" style="border-collapse: collapse; margin: 5px 0px 5px 13px;">	
				<div style="position:relative;height:465px;">
					<div id="gantthand1" style="width:120px;position:absolute;top:41px; height: 410px;overflow: hidden; border:1px #3969a7 solid;overflow: hidden">
						<div id="gantthand-top1" style="height:22px;line-height:22px;text-align:center;position:relative;background:#fff;z-index:2;border-bottom:1px solid #1E557E;background:url('/static/meetingCalendar/img/gantthand-top-bg.gif') repeat-x;">
						 会议室
						</div>
					...
					<div id="ganttdiv1"  style="border: 1px solid #6593cf;width: 640px;height: 460px;position:absolute;top:5px; left:130px; overflow-x: scroll; overflow-y:auto;">
					</div>
				</div>					
			</div>
		</div>
...
<!-- CUSTOM HTML END -->
<script type="text/javascript">
	function bindGanttYscrollTopEvent(){
		var anim_scroll;
		var start_y = null;
		YUE.on('ganttdiv1','scroll',function(){	
			if(start_y === null){
				start_y = YUD.get('ganttdiv1').scrollTop;
			}
			// 判断是否是滚动Y轴
...
$(function(){
	...
	function createDateTable(obj){
		...
		if(obj.getAttribute("num")==0){
			...
			var clickFlag=$(obj).attr("clickFlag");
			if(clickFlag=="false"){
				ec_calendar_meetingRoom_meetingRoomInfo_reference_allWidget.setRequestDataUrl("/X6Basic/meetingroom/meetingRoom/reference-all.action","");
			}
			$(obj).attr("clickFlag","true");
	...
	function addData(id,name,type,paramDate,detailId){
		...
		if(type="meetingRoom"){
			//默认加到最后一列
			tBody.append("<tr class='handTr' trType='meetingRoom' roomName='"+name+"' roomId='"+id+"'></tr>");
			tr=$("tr[roomId='"+id+"']",$("#ganttLeft1"));
			StrCell="<td class='handTd' style='height:18px;'><div style='height:18px;text-align:center;white-space: nowrap;letter-spacing: 0.4px;overflow: hidden;text-overflow: ellipsis;padding: 0px 3px;display: block;width: 110px;' class='dg-hd-td-label' title="+name+" onclick='isSelect(this)'>"+name+"</div></td>";
	 		tr.html(StrCell);
		}
	}
	// 添加会议室到甘特图
	...
	function initGantt(){
		...
		bindGanttYscrollTopEvent();//绑定甘特图事件
	}
	// 用于控制选择之后页面参数
