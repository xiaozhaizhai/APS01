...
<script type="text/javascript">
	...
	function download(){
		//var url = "/X6Basic/accountingPeriod/accountPeriod/downLoad.action?viewCode=X6Basic_1.0_accountingPeriod_list&orgName=X6Basic_1.0_accountingPeriod_list-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/X6Basic/accountingPeriod/accountPeriod/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
