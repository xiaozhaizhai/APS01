 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0 && item != "checkbox">
									<#if item == 'month.value' || item == 'month.id' || item == '*'>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								<#if item == 'month.value' || item == 'month.id' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1400468421895')}</Data>
										</Cell>
								</#if>
								<#if item == 'startDate' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1400468386807')}</Data>
										</Cell>
								</#if>
								<#if item == 'endDate' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1400468406727')}</Data>
										</Cell>
								</#if>
								<#if item == 'isAccounted' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1400725247737')}</Data>
										</Cell>
								</#if>
					...
					<#if item?length gt 0>
								<#if item == 'month.value' || item == 'month.id' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String">${getText('${(data.month.value)!}')}</Data>
								...
								<#if item == 'isAccounted' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.isAccounted)?? && data.isAccounted>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
