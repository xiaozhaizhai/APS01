...
<form action="/X6Basic/cardStaff/cardStaffWork/importMainXls.action" target="importResponse" onsubmit="javascript:void(0);" id="ImportForm" enctype="multipart/form-data" method="post">
