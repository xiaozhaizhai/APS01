...
<#assign viewCode = 'X6Basic_1.0_syncConfig_SyncConfigs' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		<Style ss:ID="syncBBSFlag">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="syncEmailFlag">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="syncPandionFlag">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											<#if item == 'syncEmailFlag' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'syncBBSFlag' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'syncPandionFlag' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'syncEmailFlag' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1409053309514')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'syncBBSFlag' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1409053368915')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'syncPandionFlag' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1409053401279')}</Data></Cell>
											</#if>
									...
									<#if item?length gt 0>
												<#if item == 'syncEmailFlag' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.syncEmailFlag?? && data.syncEmailFlag>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'syncBBSFlag' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.syncBBSFlag?? && data.syncBBSFlag>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'syncPandionFlag' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.syncPandionFlag?? && data.syncPandionFlag>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
