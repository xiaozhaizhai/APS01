...
<#assign viewCode = 'X6Basic_1.0_spellRule_SpellRule' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1398306715753')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1398306741696')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'times' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1398306782051')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'srMemo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1398306810252')}</Data></Cell>
											</#if>
									...
									<#if item?length gt 0>
												...
												<#if item == 'times' || item == '*'>
													<Cell>
														...
														<#if data.times??><Data ss:Type="String"><![CDATA[${(data.times)!}]]></Data></#if>
												...
												<#if item == 'srMemo' || item == '*'>
													<Cell>
														...
														<#if data.srMemo??><Data ss:Type="String"><![CDATA[${(data.srMemo)!}]]></Data></#if>
