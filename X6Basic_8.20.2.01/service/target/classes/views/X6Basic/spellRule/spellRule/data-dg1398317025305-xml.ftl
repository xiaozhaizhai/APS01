...
<GridData DefaultNodeExpanded="false"   dgName="dg1398317025305" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<teamOrder
					...
					sort="true"  onPropertyChange="SpellRulePart_dg1398317025305Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
