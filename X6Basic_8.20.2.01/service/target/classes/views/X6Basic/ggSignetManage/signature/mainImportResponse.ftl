...
<script type="text/javascript">
	...
	function download(){
		//var url = "/X6Basic/ggSignetManage/signature/downLoad.action?viewCode=X6Basic_1.0_ggSignetManage_list&orgName=X6Basic_1.0_ggSignetManage_list-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/X6Basic/ggSignetManage/signature/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
