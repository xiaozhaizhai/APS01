...
<#assign viewCode = 'X6Basic_1.0_signetManage_SignetSetting' />
<#assign propertyCode = '' />
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'userinfo.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('foundation.user.name')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'singetType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1367495506000')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												...
												<#if item == 'userinfo.name' || item == '*'>
													<Cell>
														...
														<#if data.userinfo.name??><Data ss:Type="String"><![CDATA[${(data.userinfo.name)!}]]></Data></#if>
												...
												<#if item == 'singetType.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.singetType.value)!}')}</Data>
