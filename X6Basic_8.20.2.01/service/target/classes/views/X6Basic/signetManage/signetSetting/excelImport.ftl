<script type="text/javascript" src="/static/foundation/js/jquery.progressbar.js"></script>
...
<form action="/X6Basic/signetManage/signetSetting/importxls.action" target="importResponse" onsubmit="javascript:void(0);" id="ImportForm" enctype="multipart/form-data" method="post">
