...
<#assign viewCode = 'X6Basic_1.0_unitGroup_UnitGroups' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1398234552131')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'name' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'groupMemo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1398235053834')}</Data></Cell>
											</#if>
									...
									<#if item?length gt 0>
												...
												<#if item == 'groupMemo' || item == '*'>
													<Cell>
														...
														<#if data.groupMemo??><Data ss:Type="String"><![CDATA[${(data.groupMemo)!}]]></Data></#if>
