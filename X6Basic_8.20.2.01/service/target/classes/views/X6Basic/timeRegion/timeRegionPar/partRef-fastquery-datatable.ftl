	...
	<form <#if useInBusiness?? && useInBusiness == 'yes'>style="position:relative;*z-index:1;zoom:1;"</#if> onsubmit="return false" id="ec_X6Basic_timeRegion_timeRegionPar_partRef_queryForm" exportUrl="/X6Basic/timeRegion/timeRegionPar/partRef-query.action">
		...
		<div id="ec_X6Basic_timeRegion_timeRegionPar_partRef_queryForm_btn_toggle" class="quick-query-btn-toggle quick-query-btn-expand" style="display:none;" title="${getText('ec.view.expandTip')}" onclick="ec_X6Basic_timeRegion_timeRegionPar_partRef_queryForm_expandAllCondition()" ></div>
		<#assign advFlag = getAdvClassific('X6Basic_1.0_timeRegion_partRef')>
		<#if advFlag?? && advFlag>
		<@dataclassific id="dataClassific" viewCode="X6Basic_1.0_timeRegion_partRef" formId="ec_X6Basic_timeRegion_timeRegionPar_partRef_queryForm" dataTableId="ec_X6Basic_timeRegion_timeRegionPar_partRef_query"   />
		</#if>
					<@quickquery unique="LAST_QUERY_ec_X6Basic_timeRegion_timeRegionPar_partRef_queryForm" isExpandAll=true formId="ec_X6Basic_timeRegion_timeRegionPar_partRef_queryForm" idprefix="ec_X6Basic_timeRegion_timeRegionPar_partRef" expandType="all"  fieldcodes="X6Basic_1.0_timeRegion_TimeRegionPar_name_name:X6Basic.propertydisplayName.randon1459215074302||X6Basic_1.0_timeRegion_TimeRegionPar_year_year:X6Basic.propertydisplayName.randon1459215254357||X6Basic_1.0_timeRegion_TimeRegionPar_month_month:X6Basic.propertydisplayName.randon1459215052167" > 
							<#assign name_defaultValue  = ''>
									<#assign name_defaultValue  = ''>
							<@queryfield formId="ec_X6Basic_timeRegion_timeRegionPar_partRef_queryForm" code="X6Basic_1.0_timeRegion_TimeRegionPar_name" showFormat="TEXT" defaultValue=name_defaultValue  divCode="X6Basic_1.0_timeRegion_TimeRegionPar_name_name" isCustomize=true style="" > 
											<div class="fix-input">
							...
							<#assign year_defaultValue  = ''>
									<#assign year_defaultValue  = ''>
							<@queryfield formId="ec_X6Basic_timeRegion_timeRegionPar_partRef_queryForm" code="X6Basic_1.0_timeRegion_TimeRegionPar_year" showFormat="TEXT" defaultValue=year_defaultValue  divCode="X6Basic_1.0_timeRegion_TimeRegionPar_year_year" isCustomize=true style="" > 
										<div>
							...
							<#assign month_defaultValue  = ''>
									<#assign month_defaultValue  = ''>
							<@queryfield formId="ec_X6Basic_timeRegion_timeRegionPar_partRef_queryForm" code="X6Basic_1.0_timeRegion_TimeRegionPar_month" showFormat="TEXT" defaultValue=month_defaultValue  divCode="X6Basic_1.0_timeRegion_TimeRegionPar_month_month" isCustomize=true style="" > 
										<div>
									  	 	<div style="float:left;width:45%">
									  	 	<div class="fix-input"><div class="fix-search-click clearfix">
							...
							<div class="quick-query-buttonbar" style="margin-bottom:6px;margin-right:12px;">
						       	<@querybutton formId="ec_X6Basic_timeRegion_timeRegionPar_partRef_queryForm" type="adv" onclick="X6Basic.timeRegion.timeRegionPar.partRef.commonQuery('query')" onadvancedclick="advQuery('X6Basic.timeRegion.timeRegionPar.partRef.advquery')" /> 
...
ec_X6Basic_timeRegion_timeRegionPar_partRef_quickquery_info["MainTableName"]="X6BASIC_TIME_REGION_PARS";
...
<script>
 $(function(){
 	var advRemainDialog = $('[id="X6Basic.timeRegion.timeRegionPar.partRef.advquery"]');
...
<div style="position:relative;z-index:10;display:none;" id="X6Basic.timeRegion.timeRegionPar.partRef.advquery">
    <@errorbar id="adv_query_edit_bar"></@errorbar>
    <div class="advConContent">
    <form <#if useInBusiness?? && useInBusiness == 'yes'>style="position:relative;*z-index:1;zoom:1;"</#if> onsubmit="return false" id="ec_X6Basic_timeRegion_timeRegionPar_partRef_adv_queryForm" exportUrl="/X6Basic/timeRegion/timeRegionPar/partRef-query.action">
							<#assign name_defaultValue  = ''>
									<#assign name_defaultValue  = ''>
								<@advsqueryfield formId="ec_X6Basic_timeRegion_timeRegionPar_partRef_adv_queryForm" code="X6Basic_1.0_timeRegion_TimeRegionPar_name" showFormat="TEXT" defaultValue=name_defaultValue  divCode="X6Basic_1.0_timeRegion_TimeRegionPar_name_name" isCustomize=true > 
							...
							<#assign year_defaultValue  = ''>
									<#assign year_defaultValue  = ''>
								<@advsqueryfield formId="ec_X6Basic_timeRegion_timeRegionPar_partRef_adv_queryForm" code="X6Basic_1.0_timeRegion_TimeRegionPar_year" showFormat="TEXT" defaultValue=year_defaultValue  divCode="X6Basic_1.0_timeRegion_TimeRegionPar_year_year" isCustomize=true > 
							...
							<#assign month_defaultValue  = ''>
									<#assign month_defaultValue  = ''>
								<@advsqueryfield formId="ec_X6Basic_timeRegion_timeRegionPar_partRef_adv_queryForm" code="X6Basic_1.0_timeRegion_TimeRegionPar_month" showFormat="TEXT" defaultValue=month_defaultValue  divCode="X6Basic_1.0_timeRegion_TimeRegionPar_month_month" isCustomize=true > 
...
ec.view.newAdvQuery._initNewAdvQuery=function(values){
		ec.advQuery.query = new CUI.NewAdvQuery({
			...
			env: 'runtime',
			viewCode: 'X6Basic_1.0_timeRegion_partRef',
			modelCode: 'X6Basic_1.0_timeRegion_TimeRegionPar',
			modelName: 'TimeRegionPar',
			formId: 'ec_X6Basic_timeRegion_timeRegionPar_partRef_queryForm',
			olddiv: 'X6Basic.timeRegion.timeRegionPar.partRef.advquery',
			values: values,
...
ec.view.newAdvQuery._customQuery= function(){
	$("[id='X6Basic.timeRegion.timeRegionPar.partRef.advquery'] #advQueryLoading").show();
	var url="/ec/advQuery/advconfig.action?view.code="+'X6Basic_1.0_timeRegion_partRef'+"&entity.code="+'X6Basic_1.0_timeRegion';
		 $.ajax({
		 url: url, 
		 cache: false,
		 async: false,
		 success:function(html){ 
		 	$("[id='X6Basic.timeRegion.timeRegionPar.partRef.advquery'] #customquContent").html(html);
		 	$("[id='X6Basic.timeRegion.timeRegionPar.partRef.advquery'] #advQueryLoading").hide();
		 }
	});
	onceOpen = true;
...
function changeCustomQuery(){
	if(showType == "up"){
		$('[id="X6Basic.timeRegion.timeRegionPar.partRef.advquery"] div.customqu-content').css('display','none');
		$('[id="X6Basic.timeRegion.timeRegionPar.partRef.advquery"] div.move-grade').css('display','none');
		// $('[id="X6Basic.timeRegion.timeRegionPar.partRef.advquery"] span.customQuery').css('background','url("/bap/struts/css/icon_adv.png") 0 -61px no-repeat');
		$('[id="X6Basic.timeRegion.timeRegionPar.partRef.advquery"] span.customQuery').removeClass("customQuery_down").addClass("customQuery_up");											
		$('[id="X6Basic.timeRegion.timeRegionPar.partRef.advquery"] div.advConContent').css('height','400px');		
		showType = "down";
	}else{
		$('[id="X6Basic.timeRegion.timeRegionPar.partRef.advquery"] div.customqu-content').css('display','block');
		$('[id="X6Basic.timeRegion.timeRegionPar.partRef.advquery"] div.move-grade').css('display','block');
		// $('[id="X6Basic.timeRegion.timeRegionPar.partRef.advquery"] span.customQuery').css('background','url("/bap/struts/css/icon_adv.png") 0 -144px no-repeat');
		$('[id="X6Basic.timeRegion.timeRegionPar.partRef.advquery"] span.customQuery').removeClass("customQuery_up").addClass("customQuery_down");						
		$('[id="X6Basic.timeRegion.timeRegionPar.partRef.advquery"] div.advConContent').css('height','130px');
		if(!onceOpen){
			customQuery();
			onceOpen = true;
		}
...
<@datatable  colAdminFlag=colAdmFlag  superChecked=superChecked superCheckedName=superCheckedName superCheckedId=superCheckedId checkedRowsMap=checkedRowsMap id="ec_X6Basic_timeRegion_timeRegionPar_partRef_query" renderOverEvent="ec_X6Basic_timeRegion_timeRegionPar_partRef_RenderOverEvent" pageInitMethod="ec_X6Basic_timeRegion_timeRegionPar_partRef_PageInitMethod" modelCode="X6Basic_1.0_timeRegion_TimeRegionPar" noPermissionKeys="name,year,quarter,month,week,startDate,endDate" hidekeyPrefix="ec_X6Basic_timeRegion_timeRegionPar_partRef_query" orderMode="backstage" queryFunc=datatable_queryFunc formId="ec_X6Basic_timeRegion_timeRegionPar_partRef_queryForm" firstLoad=datatable_firstLoad  lockColumnCount="" dblclick="X6Basic.timeRegion.timeRegionPar.partRef.sendBackpartRef" style="margin-left:13px;margin-right:4px;" editable=false dtPage="page" dataUrl=datatable_dataUrl transMethod="post" hidekey="['id','version','layRec','valid','cid','id','name']" postData="&${(condition!'')}&permissionCode=${permissionCode!''}" throwError="X6Basic.timeRegion.timeRegionPar.partRef.showErrorMsg"   >
...
function ec_X6Basic_timeRegion_timeRegionPar_partRef_PageInitMethod(){
}
