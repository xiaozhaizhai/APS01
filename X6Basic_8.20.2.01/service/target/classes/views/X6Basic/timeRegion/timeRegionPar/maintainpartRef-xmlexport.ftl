...
<#assign viewCode = 'X6Basic_1.0_timeRegion_TimeRegionPar' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1459215074302')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'year' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1459215254357')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'quarter' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1459215116732')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'month' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1459215052167')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'week' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1459215239844')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'startDate' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1459215181902')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'endDate' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1459215032319')}</Data></Cell>
											</#if>
									...
									<#if item?length gt 0>
												...
												<#if item == 'year' || item == '*'>
													<Cell>
														...
														<#if data.year??><Data ss:Type="Number"><![CDATA[${(data.year)!}]]></Data></#if>
												...
												<#if item == 'quarter' || item == '*'>
													<Cell>
														...
														<#if data.quarter??><Data ss:Type="Number"><![CDATA[${(data.quarter)!}]]></Data></#if>
												...
												<#if item == 'month' || item == '*'>
													<Cell>
														...
														<#if data.month??><Data ss:Type="Number"><![CDATA[${(data.month)!}]]></Data></#if>
												...
												<#if item == 'week' || item == '*'>
													<Cell>
														...
														<#if data.week??><Data ss:Type="Number"><![CDATA[${(data.week)!}]]></Data></#if>
												...
												<#if item == 'startDate' || item == '*'>
													<Cell ss:StyleID="s7">
														...
														<#if data.startDate??><Data ss:Type="DateTime">${(data.startDate)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
												...
												<#if item == 'endDate' || item == '*'>
													<Cell ss:StyleID="s7">
														...
														<#if data.endDate??><Data ss:Type="DateTime">${(data.endDate)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
