								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1459214321561')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'unit.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1459214892902')}</Data></Cell>
											</#if>
