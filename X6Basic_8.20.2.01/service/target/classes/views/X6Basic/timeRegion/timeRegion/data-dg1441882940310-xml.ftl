...
<GridData DefaultNodeExpanded="false"   dgName="dg1441882940310" pageSize="${dg1441882940310Page.pageSize}" totalCount="${dg1441882940310Page.totalCount}" totalPages="${dg1441882940310Page.totalPages}" pageNo="${dg1441882940310Page.pageNo}" hasPre="${dg1441882940310Page.hasPre?string}" hasNext="${dg1441882940310Page.hasNext?string}" prePage="${dg1441882940310Page.prePage}" nextPage="${dg1441882940310Page.nextPage}">
	<thead>
				...
				<name
					sort="false"  onPropertyChange="TimeRegionPar_dg1441882940310Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<startDate
					sort="false"  onPropertyChange="TimeRegionPar_dg1441882940310Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				    onChange="TimeRegionPar_dg1441882940310Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);TimeRegionPar_dg1441882940310Widget.evalCustomFunction(nRow,sFieldName,'aa()');"
						...
						fieldPermit="1" hideButtonsOnReadOnly="true" title="${getText('ec.view.readonlytitle')}"
									  ...
									  onBlur="document.body.click()" 
									   buttonImg="Calendar" onClick="initCalender(TimeRegionPar_dg1441882940310Widget,'TimeRegionPar_dg1441882940310Widget',nRow,sFieldName)" 
									   onBtnClick="showCalender(TimeRegionPar_dg1441882940310Widget,'TimeRegionPar_dg1441882940310Widget',nRow,sFieldName)" 
									  			 control="Text" 
	...
	<tbody>
		<#list dg1441882940310Page.result as row>
		<row  onClick="TimeRegionPar_dg1441882940310Widget._DT._autoAddNewRow(nRow)" >
					<c>${(row.id)!}</c>
					<c>${(row.version)!}</c>
