<#assign exportFields = dg1441882994270Page.exportFields />
<#assign result = dg1441882994270Page.result />
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								...
								<#if item == 'name' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1441784357503')}</Data>
										</Cell>
								</#if>
								<#if item == 'startDate' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1441779162485')}</Data>
										</Cell>
								</#if>
								<#if item == 'endDate' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1441779207153')}</Data>
										</Cell>
								</#if>
								<#if item == 'year' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1441779229335')}</Data>
										</Cell>
								</#if>
								<#if item == 'quarter' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1441779338024')}</Data>
										</Cell>
								</#if>
								<#if item == 'month' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1441779301329')}</Data>
										</Cell>
								</#if>
								<#if item == 'week' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1441779320160')}</Data>
										</Cell>
								</#if>
