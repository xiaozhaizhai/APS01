...
<GridData DefaultNodeExpanded="false"   dgName="dg1441779428621" pageSize="${dg1441779428621Page.pageSize}" totalCount="${dg1441779428621Page.totalCount}" totalPages="${dg1441779428621Page.totalPages}" pageNo="${dg1441779428621Page.pageNo}" hasPre="${dg1441779428621Page.hasPre?string}" hasNext="${dg1441779428621Page.hasNext?string}" prePage="${dg1441779428621Page.prePage}" nextPage="${dg1441779428621Page.nextPage}">
	<thead>
				...
				<name
					sort="false"  onPropertyChange="TimeRegionPar_dg1441779428621Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<startDate
					sort="false"  onPropertyChange="TimeRegionPar_dg1441779428621Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				    onChange="TimeRegionPar_dg1441779428621Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);TimeRegionPar_dg1441779428621Widget.evalCustomFunction(nRow,sFieldName,'aa()');"
						...
						fieldPermit="1" hideButtonsOnReadOnly="true" title="${getText('ec.view.readonlytitle')}"
									  ...
									  onBlur="document.body.click()" 
									   buttonImg="Calendar" onClick="initCalender(TimeRegionPar_dg1441779428621Widget,'TimeRegionPar_dg1441779428621Widget',nRow,sFieldName)" 
									   onBtnClick="showCalender(TimeRegionPar_dg1441779428621Widget,'TimeRegionPar_dg1441779428621Widget',nRow,sFieldName)" 
									  			 control="Text" 
	...
	<tbody>
		<#list dg1441779428621Page.result as row>
		<row  onClick="TimeRegionPar_dg1441779428621Widget._DT._autoAddNewRow(nRow)" >
					<c>${(row.id)!}</c>
					<c>${(row.version)!}</c>
