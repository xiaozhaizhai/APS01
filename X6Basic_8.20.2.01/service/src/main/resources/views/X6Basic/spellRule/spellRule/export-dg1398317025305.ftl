 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								<#if item == 'teamOrder' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1398306959663')}</Data>
										</Cell>
								</#if>
								<#if item == 'startTime' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1398307020450')}</Data>
										</Cell>
								</#if>
								<#if item == 'endTime' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1398307050450')}</Data>
										</Cell>
								</#if>
								<#if item == 'srpMemo' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1398307069410')}</Data>
										</Cell>
								</#if>
					...
					<#if item?length gt 0>
								<#if item == 'teamOrder' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.teamOrder)??>${(data.teamOrder)!}</#if></Data>
								...
								<#if item == 'startTime' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.startTime)??>${(data.startTime)!}</#if></Data>
								...
								<#if item == 'endTime' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.endTime)??>${(data.endTime)!}</#if></Data>
								...
								<#if item == 'srpMemo' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.srpMemo)??>${(data.srpMemo)!}</#if></Data>
