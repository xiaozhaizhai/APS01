...
<title>${getText('X6Basic.viewtitle.radion1371468884635')}</title>
<@maincss/>
<@mainjs/>
<@extracss />

<!-- CUSTOM CODE START(view-EDIT-X6Basic_1.0_baseProduct_edit,head,X6Basic_1.0_baseProduct_ProductManage,X6Basic_1.0) -->
<!-- 自定义代码 -->
...
<#assign callbackName ="X6Basic.baseProduct.productManage.callBackInfo">
...
<@s.form id="X6Basic_baseProduct_productManage_edit_form" cssStyle="height:100%;" hiddenField="productManage.createStaff.id," onsubmitMethod="X6Basic.baseProduct.productManage.edit.beforeSubmitMethod()" ecAction="/X6Basic/baseProduct/productManage/edit/submit.action?__pc__=${(Parameters.__pc__)!}" callback=callbackName ecform="true">
	...
	<div id="X6Basic_edit_edit_div" style="height:100%">
		<div id="X6Basic_baseProduct_productManage_edit_main_div" class="edit-content-dialog edit-content-dialog-fullwidth">
<script type="text/javascript">
	...
	<table class="edit-table" style="">
		...
		<tr class="dialog_tr">
					...
					<td  nullable=false class="edit-table-content"   style="text-align: left;;" >
									...
									<@mneclient iframe=mneIframe!false property_type="TEXT" reftitle="${getText('foundation.ec.entity.view.reference')}" viewType="${viewType!}" deValue="${productManage_createStaff_name_defaultValue!}" conditionfunc="X6Basic.baseProduct.productManage.edit._querycustomFunc('productManage_createStaff_name')"  value="${(productManage.createStaff.name)!}" displayFieldName="name" name="productManage.createStaff.name" id="productManage_createStaff_name" type="Staff" url="/foundation/staff/common/staffListFrameset.action" clicked=true multiple=false mnewidth=260 formId="X6Basic_baseProduct_productManage_edit_form" editCustomCallback=";" refViewCode="sysbase_1.0_staff_ref" onkeyupfuncname=";_callback_productManage_createStaff_name(obj);" cssStyle="" isEdit=true     isCrossCompany=false  />
					...
					<td  nullable=true class="edit-table-content" celltype="DATETIME"  style="text-align: left;;" >
							...
							<#if newObj && !(productManage.createTime)?has_content>
								...
								<@datepicker  onchange="" property_type="DATETIME" cssClass="cui-noborder-input" name="productManage.createTime" value="${productManage_createTime_defaultValue!}" type="dateTime"  id="productManage.createTime"  cssStyle=""  />
								
							<#else>
							<#if (productManage.createTime)??>
								
								<@datepicker  onchange="" property_type="DATETIME" cssClass="cui-noborder-input" name="productManage.createTime" value="${productManage.createTime?string('yyyy-MM-dd HH:mm:ss')}" type="dateTime"  id="productManage.createTime"  cssStyle=""  />
								
							<#else>
								
								<@datepicker  onchange="" property_type="DATETIME" cssClass="cui-noborder-input" name="productManage.createTime" value="" type="dateTime" id="productManage.createTime" cssStyle="" />
					...
					<td  nullable=true class="edit-table-content"   colspan="3" style="text-align: left;;" >
							...
							<div class="fix-input fix-ie7-textarea"><textarea property_type="TEXT" id="productManage_prodMemo" originalvalue="<#if !newObj || (productManage.prodMemo)?has_content>${(productManage.prodMemo?html)!}<#else>${productManage_prodMemo_defaultValue?html}</#if>"  name="productManage.prodMemo" class="cui-noborder-textarea cui-textarea-auto" style=";" ><#if !newObj || (productManage.prodMemo)?has_content>${(productManage.prodMemo)!}<#else>${productManage_prodMemo_defaultValue}</#if></textarea></div>
...
<script type="text/javascript">
	...
	(function($){
		...
		$(function(){
			$("#X6Basic_baseProduct_productManage_edit_form ul.edit-tabs").tabs("div.edit-panes > div");
			$('#X6Basic_baseProduct_productManage_edit_form').get(0).onkeydown=function(event){event=event?event:window.event;if(event.keyCode==13){return false}};
		});
	})(jQuery);
			...
			X6Basic.baseProduct.productManage.edit.settingDialog = new CUI.Dialog({
					...
					buttons:[
							{	name:"${getText("ec.flow.save")}",
								handler:function(){if(X6Basic.baseProduct.productManage.edit.saveSetting()){this.close();}isPrintSettingDialogShow = false;}
							},
	...
	function setUpload(params){
			if($('#X6Basic_baseProduct_productManage_edit_fileupload').length == 0) {
				$('body').append('<div id="X6Basic_baseProduct_productManage_edit_fileupload"></div>');
			}
			X6Basic.baseProduct.productManage.edit.infoDialog = new CUI.Dialog({
				title: "${getText("ec.view.info.view")}",
				elementId : "X6Basic_baseProduct_productManage_edit_fileupload",
				modal:true,
				height:330,
				width: 460,
				buttons:[
			...
			var dialogId = $('#X6Basic_baseProduct_productManage_edit_fileupload_button').parents('div[id^=dialog_]:first').attr('id');
			X6Basic.baseProduct.productManage.edit.infoDialog.show();
			if($('#X6Basic_baseProduct_productManage_edit_fileupload').html() == '') {
				$('#X6Basic_baseProduct_productManage_edit_fileupload').load("/foundation/workbench/fileupload-dialog-init.action?linkId=" + params.operateRecordId + "&type=X6Basic_baseProduct_productManage&entityCode=X6Basic_1.0_baseProduct&dialogId="+dialogId);
			}
		}
	//参照复制函数
	...
	X6Basic.baseProduct.productManage.edit.referenceCopyBackInfo = function(obj){
		...
		if(isFormChanged('X6Basic_baseProduct_productManage_edit_form','X6Basic_baseProduct_productManage_edit_datagrids')){
			...
			<#if (Parameters.openType)?? && (Parameters.openType) == 'frame'>
			parent.$( X6Basic.baseProduct.productManage.edit.dialog._el ).append( '<table id="dialog-iframe-loading" style="position:absolute;left:0;top:-20px;width:100%;height:100%;text-align:center;"><tr><td><label class="datagrid-loading">正在加载...</label></td></tr></table>' );
			parent.$( '#' + X6Basic.baseProduct.productManage.edit.dialog._config.iframe, X6Basic.baseProduct.productManage.edit.dialog._dialog ).prop( 'src', '/X6Basic/baseProduct/productManage/edit.action?id=' + value +'&refId='+obj[0].id+"&__pc__=${(Parameters.__pc__)!}" + '&openType=frame' );
			<#else>
			$(X6Basic.baseProduct.productManage.edit.dialog._el).html("<table style='width:100%;height:100%;text-align:center;'><tr><td><label class='datagrid-loading'>${getHtmlText("ec.view.loading")}</label></td></tr></table>");
			CUI(X6Basic.baseProduct.productManage.edit.dialog._el).load('/X6Basic/baseProduct/productManage/edit.action?id=' + value +'&refId='+obj[0].id+"&__pc__=${(Parameters.__pc__)!}",null,function(){
					closeLoadPanel();
	...
	X6Basic.baseProduct.productManage.edit._selectEvent = function(objName,_selectType,url,title,refparam,obj,customCallBack,crossCompanyFlag,gridEventObj,oGrid,isMultiselect){
		...
		var frameName = 'X6Basic_baseProduct_productManage_edit' + '_' + extraFrameParam;
		var callbackName="";
	...
	X6Basic.baseProduct.productManage.edit.getcallBackInfo_DG_IE = function(obj){
		if(X6Basic.baseProduct.productManage.edit._customBeforeCallBack) {
			var flag = eval(X6Basic.baseProduct.productManage.edit._customBeforeCallBack.split("(")[0] + "(obj)");
			if(flag === false){
				return false;
			}
		}
...
<script type="text/javascript">
	...
	X6Basic.baseProduct.productManage.edit.initSize = function(nTabIndex){
		...
		var	conHeight = h-$("#X6Basic_baseProduct_productManage_edit_main_div .edit-tabs").outerHeight() - 6;
	...
	$(function(){
		...
		$(".edit-tabs li").click(function(){
		    ...
		    X6Basic.baseProduct.productManage.edit.initSize(index);
		});
