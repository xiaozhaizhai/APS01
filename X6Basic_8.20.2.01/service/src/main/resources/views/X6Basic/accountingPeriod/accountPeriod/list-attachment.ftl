...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=X6Basic_1.0_accountingPeriod";
	openExportFrame(url);
}
...
<div id="X6Basic_accountingPeriod_accountPeriod_list_attachment">	
