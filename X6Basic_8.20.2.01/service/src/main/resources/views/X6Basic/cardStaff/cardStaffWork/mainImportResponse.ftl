...
<script type="text/javascript">
	...
	function download(){
		var url = "/X6Basic/cardStaff/cardStaffWork/downLoad.action?viewCode=X6Basic_1.0_cardStaff_list&orgName=X6Basic_1.0_cardStaff_list-import-error.xls&downloadType=mainError&time=${time}";
		window.open(url,"","");
	}
