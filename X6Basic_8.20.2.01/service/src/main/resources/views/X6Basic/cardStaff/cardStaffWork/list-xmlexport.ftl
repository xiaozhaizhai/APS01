 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								...
								<#if item == 'cardNo' || item == '*'>
										<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1400115866733')}</Data></Cell>
								</#if>
								<#if item == 'staff.name' || item == '*'>
			...
			<Row ss:AutoFitHeight="0">
				<#list exportFieldList as item>
					<#if item?length gt 0>
								...
								<#if item == 'cardNo' || item == '*'>
									<Cell>
									<#if checkFieldPermission('cardNo','X6Basic_1.0_cardStaff_CardStaffWork','X6Basic_1.0_cardStaff_CardStaffWork_cardNo') != 0>
										<#if data.cardNo??><Data ss:Type="String">${(data.cardNo)!}</Data></#if>
									</#if>
									</Cell>
								</#if>
								<#if item == 'staff.name' || item == '*'>
									<Cell>
									<#if checkFieldPermission('staff.name','X6Basic_1.0_cardStaff_CardStaffWork','X6Basic_1.0_cardStaff_CardStaffWork_staff||base_staff_name') != 0>
										<#if data.staff.name??><Data ss:Type="String">${(data.staff.name)!}</Data></#if>
									</#if>
									</Cell>
								</#if>
