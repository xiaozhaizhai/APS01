...
<!-- CUSTOM CODE START(view-EDIT-X6Basic_1.0_meetingroom_edit,head,X6Basic_1.0_meetingroom_MeetingRoom,X6Basic_1.0) -->
<!-- 自定义代码 -->
...
<@s.form id="X6Basic_meetingroom_meetingRoom_edit_form" cssStyle="height:100%;" hiddenField="meetingRoom.attMatching.id,meetingRoom.staff.id," onsubmitMethod="X6Basic.meetingroom.meetingRoom.edit.beforeSubmitMethod()" ecAction="/X6Basic/meetingroom/meetingRoom/edit/submit.action?__pc__=${(Parameters.__pc__)!}" callback=callbackName ecform="true">
	...
	<div id="X6Basic_edit_edit_div" style="height:100%">
		<div id="X6Basic_meetingroom_meetingRoom_edit_main_div" class="edit-content-dialog edit-content-dialog-fullwidth">
<script type="text/javascript">
		...
		<tr class="dialog_tr">
					...
					<td  nullable=true class="edit-table-content"   style="text-align: left;;" >
								...
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${meetingRoom_roomSize_defaultValue!}" formId="X6Basic_meetingroom_meetingRoom_edit_form" classStyle="cui-noborder-input" ecFlag=true multable=false  name="meetingRoom.roomSize.id" code="meetingSize" value="${(meetingRoom.roomSize.id)!}"  />
									
								<#else>
									
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="X6Basic_meetingroom_meetingRoom_edit_form" classStyle="cui-noborder-input" ecFlag=true multable=false  name="meetingRoom.roomSize.id" code="meetingSize" value="${(meetingRoom.roomSize.id)!}"  />
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
									...
									<@mneclient iframe=mneIframe!false property_type="TEXT" reftitle="${getText('foundation.ec.entity.view.reference')}" viewType="${viewType!}" deValue="${meetingRoom_staff_name_defaultValue!}" conditionfunc="X6Basic.meetingroom.meetingRoom.edit._querycustomFunc('meetingRoom_staff_name')"  value="${(meetingRoom.staff.name)!}" displayFieldName="name" name="meetingRoom.staff.name" id="meetingRoom_staff_name" type="Staff" url="/foundation/staff/common/staffListFrameset.action" clicked=true multiple=false mnewidth=260 formId="X6Basic_meetingroom_meetingRoom_edit_form" editCustomCallback=";" refViewCode="sysbase_1.0_staff_ref" onkeyupfuncname=";_callback_meetingRoom_staff_name(obj);" cssStyle="" isEdit=true     isCrossCompany=false  />
				...
				<td class="edit-table-symbol">&nbsp;</td>
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
									...
									<@mneclient iframe=mneIframe!false property_type="TEXT" mneenable=false reftitle="${getText('X6Basic.viewtitle.radion1367462816202')}" viewType="${viewType!}" deValue="${meetingRoom_attMatching_name_defaultValue!}" conditionfunc="X6Basic.meetingroom.meetingRoom.edit._querycustomFunc('meetingRoom_attMatching_name')"  value="${(meetingRoom.attMatching.name)!}" displayFieldName="name" name="meetingRoom.attMatching.name" id="meetingRoom_attMatching_name" type="other" url="/X6Basic/attMachine/attMachine/ref.action" clicked=true multiple=false mnewidth=260 formId="X6Basic_meetingroom_meetingRoom_edit_form" editCustomCallback=";" refViewCode="X6Basic_1.0_attMachine_ref"  onkeyupfuncname=";_callback_meetingRoom_attMatching_name(obj);" cssStyle="" isEdit=true   isCrossCompany=false  />
					...
					<td  nullable=true class="edit-table-content"   colspan="5" align="left" style="text-align: left;;" >
							...
							<div class="fix-input fix-ie7-textarea"><textarea property_type="LONGTEXT" id="meetingRoom_memos" originalvalue="<#if !newObj || (meetingRoom.memos)?has_content>${(meetingRoom.memos?html)!}<#else>${meetingRoom_memos_defaultValue?html}</#if>"  name="meetingRoom.memos" class="cui-noborder-textarea cui-textarea-auto" style="height:80px;" ><#if !newObj || (meetingRoom.memos)?has_content>${(meetingRoom.memos)!}<#else>${meetingRoom_memos_defaultValue}</#if></textarea></div>
...
<script type="text/javascript">
	...
	(function($){
		...
		$(function(){
			$("#X6Basic_meetingroom_meetingRoom_edit_form ul.edit-tabs").tabs("div.edit-panes > div");
			$('#X6Basic_meetingroom_meetingRoom_edit_form').get(0).onkeydown=function(event){event=event?event:window.event;if(event.keyCode==13){return false}};
		});
	})(jQuery);
			...
			X6Basic.meetingroom.meetingRoom.edit.settingDialog = new CUI.Dialog({
					...
					buttons:[
							{	name:"${getText("ec.flow.save")}",
								handler:function(){if(X6Basic.meetingroom.meetingRoom.edit.saveSetting()){this.close();}isPrintSettingDialogShow = false;}
							},
	...
	function setUpload(params){
			if($('#X6Basic_meetingroom_meetingRoom_edit_fileupload').length == 0) {
				$('body').append('<div id="X6Basic_meetingroom_meetingRoom_edit_fileupload"></div>');
			}
			X6Basic.meetingroom.meetingRoom.edit.infoDialog = new CUI.Dialog({
				title: "${getText("ec.view.info.view")}",
				elementId : "X6Basic_meetingroom_meetingRoom_edit_fileupload",
				modal:true,
				height:330,
				width: 460,
				buttons:[
			...
			var dialogId = $('#X6Basic_meetingroom_meetingRoom_edit_fileupload_button').parents('div[id^=dialog_]:first').attr('id');
			X6Basic.meetingroom.meetingRoom.edit.infoDialog.show();
			if($('#X6Basic_meetingroom_meetingRoom_edit_fileupload').html() == '') {
				$('#X6Basic_meetingroom_meetingRoom_edit_fileupload').load("/foundation/workbench/fileupload-dialog-init.action?linkId=" + params.operateRecordId + "&type=X6Basic_meetingroom_meetingRoom&entityCode=X6Basic_1.0_meetingroom&dialogId="+dialogId);
			}
		}
	//参照复制函数
	...
	X6Basic.meetingroom.meetingRoom.edit.referenceCopyBackInfo = function(obj){
		...
		if(isFormChanged('X6Basic_meetingroom_meetingRoom_edit_form','X6Basic_meetingroom_meetingRoom_edit_datagrids')){
			...
			<#if (Parameters.openType)?? && (Parameters.openType) == 'frame'>
			parent.$( X6Basic.meetingroom.meetingRoom.edit.dialog._el ).append( '<table id="dialog-iframe-loading" style="position:absolute;left:0;top:-20px;width:100%;height:100%;text-align:center;"><tr><td><label class="datagrid-loading">正在加载...</label></td></tr></table>' );
			parent.$( '#' + X6Basic.meetingroom.meetingRoom.edit.dialog._config.iframe, X6Basic.meetingroom.meetingRoom.edit.dialog._dialog ).prop( 'src', '/X6Basic/meetingroom/meetingRoom/edit.action?id=' + value +'&refId='+obj[0].id+"&__pc__=${(Parameters.__pc__)!}" + '&openType=frame' );
			<#else>
			$(X6Basic.meetingroom.meetingRoom.edit.dialog._el).html("<table style='width:100%;height:100%;text-align:center;'><tr><td><label class='datagrid-loading'>${getHtmlText("ec.view.loading")}</label></td></tr></table>");
			CUI(X6Basic.meetingroom.meetingRoom.edit.dialog._el).load('/X6Basic/meetingroom/meetingRoom/edit.action?id=' + value +'&refId='+obj[0].id+"&__pc__=${(Parameters.__pc__)!}",null,function(){
					closeLoadPanel();
	...
	X6Basic.meetingroom.meetingRoom.edit._selectEvent = function(objName,_selectType,url,title,refparam,obj,customCallBack,crossCompanyFlag,gridEventObj,oGrid,isMultiselect){
		...
		var frameName = 'X6Basic_meetingroom_meetingRoom_edit' + '_' + extraFrameParam;
		var callbackName="";
	...
	X6Basic.meetingroom.meetingRoom.edit.getcallBackInfo_DG_IE = function(obj){
		if(X6Basic.meetingroom.meetingRoom.edit._customBeforeCallBack) {
			var flag = eval(X6Basic.meetingroom.meetingRoom.edit._customBeforeCallBack.split("(")[0] + "(obj)");
			if(flag === false){
				return false;
			}
		}
...
<script type="text/javascript">
	...
	X6Basic.meetingroom.meetingRoom.edit.initSize = function(nTabIndex){
		...
		var	conHeight = h-$("#X6Basic_meetingroom_meetingRoom_edit_main_div .edit-tabs").outerHeight() - 6;
	...
	$(function(){
		...
		$(".edit-tabs li").click(function(){
		    ...
		    X6Basic.meetingroom.meetingRoom.edit.initSize(index);
		});
