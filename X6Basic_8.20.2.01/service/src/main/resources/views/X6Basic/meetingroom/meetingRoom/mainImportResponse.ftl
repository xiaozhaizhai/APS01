...
<script type="text/javascript">
	...
	function download(){
		//var url = "/X6Basic/meetingroom/meetingRoom/downLoad.action?viewCode=X6Basic_1.0_meetingroom_list&orgName=X6Basic_1.0_meetingroom_list-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/X6Basic/meetingroom/meetingRoom/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
