 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								<#if item == 'code' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1398235521123')}</Data>
										</Cell>
								</#if>
								<#if item == 'name' || item == '*'>
										<Cell>
								...
								<#if item == 'isMain' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1398235666506')}</Data>
										</Cell>
								</#if>
								<#if item == 'rate' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1398235704972')}</Data>
										</Cell>
								</#if>
								<#if item == 'comments' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1398235798163')}</Data>
										</Cell>
								</#if>
					...
					<#if item?length gt 0>
								<#if item == 'code' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.code)??>${(data.code)!}</#if></Data>
								...
								<#if item == 'comments' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.comments)??>${(data.comments)!}</#if></Data>
