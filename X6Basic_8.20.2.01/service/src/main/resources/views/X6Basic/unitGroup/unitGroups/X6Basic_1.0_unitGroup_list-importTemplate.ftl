...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
	...
	<Style ss:ID="X6Basic_1.0_unitGroup_UnitGroups_code">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="X6Basic_1.0_unitGroup_UnitGroups_name">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="X6Basic_1.0_unitGroup_UnitGroups_groupMemo">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="X6Basic_1.0_unitGroup_UnitGroups_groupBapType">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="X6Basic_1.0_unitGroup_UnitGroups_groupType">
  			<NumberFormat/>
  			<Protection/>
	</Style>
...
<Worksheet ss:Name="sheet1">
	<Table ss:ExpandedColumnCount="256" ss:ExpandedRowCount="3" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="16.5">
			<Column ss:Index="1" ss:Width="100"  ss:StyleID="X6Basic_1.0_unitGroup_UnitGroups_code"/>
			<Column ss:Index="2" ss:Width="100"  ss:StyleID="X6Basic_1.0_unitGroup_UnitGroups_name"/>
			<Column ss:Index="3" ss:Width="100"  ss:StyleID="X6Basic_1.0_unitGroup_UnitGroups_groupMemo"/>
			<Column ss:Index="4" ss:Width="100"  ss:StyleID="X6Basic_1.0_unitGroup_UnitGroups_groupBapType"/>
			<Column ss:Index="5" ss:Width="100"  ss:StyleID="X6Basic_1.0_unitGroup_UnitGroups_groupType"/>
	...
	<#if customStyleCodes??>
		...
		<Row ss:AutoFitHeight="0">
						<Cell ss:StyleID="unNullable">
							<Data ss:Type="String">单位组代码</Data>
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										X6Basic_1.0_unitGroup_UnitGroups_code
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell ss:StyleID="unNullable">
							<Data ss:Type="String">单位组名称</Data>
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										X6Basic_1.0_unitGroup_UnitGroups_name
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										X6Basic_1.0_unitGroup_UnitGroups_groupMemo
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							<Data ss:Type="String"> 单位组类型</Data>
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										X6Basic_1.0_unitGroup_UnitGroups_groupBapType
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										X6Basic_1.0_unitGroup_UnitGroups_groupType
									 </ss:Data>
							</Comment>
						</Cell>
