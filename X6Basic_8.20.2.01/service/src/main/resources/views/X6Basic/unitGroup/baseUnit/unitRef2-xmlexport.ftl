...
<#assign viewCode = 'X6Basic_1.0_unitGroup_BaseUnit' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1398235521123')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'name' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'rate' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1398235704972')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isMain' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1398235666506')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'comments' || item == '*'>
													<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.radion1398235798163')}</Data></Cell>
											</#if>
									...
									<#if item?length gt 0>
												...
												<#if item == 'rate' || item == '*'>
													<Cell>
														...
														<#if (data.rate)?has_content><Data ss:Type="Number">#{(data.rate)!; m6M6}</Data></#if>
												...
												<#if item == 'isMain' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.isMain?? && data.isMain>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'comments' || item == '*'>
													<Cell>
														...
														<#if data.comments??><Data ss:Type="String"><![CDATA[${(data.comments)!}]]></Data></#if>
