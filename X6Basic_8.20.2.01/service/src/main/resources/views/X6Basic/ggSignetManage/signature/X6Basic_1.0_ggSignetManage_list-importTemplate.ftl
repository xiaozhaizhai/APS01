...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
	...
	<Style ss:ID="X6Basic_1.0_ggSignetManage_Signature_staff">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="X6Basic_1.0_ggSignetManage_Signature_description">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="X6Basic_1.0_ggSignetManage_Signature_signaturePicByte">
  			<NumberFormat/>
  			<Protection/>
	</Style>
...
<Worksheet ss:Name="sheet1">
	<Table ss:ExpandedColumnCount="256" ss:ExpandedRowCount="3" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="16.5">
			<Column ss:Index="1" ss:Width="100"  ss:StyleID="X6Basic_1.0_ggSignetManage_Signature_staff"/>
			<Column ss:Index="2" ss:Width="100"  ss:StyleID="X6Basic_1.0_ggSignetManage_Signature_description"/>
			<Column ss:Index="3" ss:Width="100"  ss:StyleID="X6Basic_1.0_ggSignetManage_Signature_signaturePicByte"/>
						...
						<Cell >
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										X6Basic_1.0_ggSignetManage_Signature_staff||base_staff_code
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										X6Basic_1.0_ggSignetManage_Signature_description
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							<Data ss:Type="String">签名（字节）</Data>
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										X6Basic_1.0_ggSignetManage_Signature_signaturePicByte
									 </ss:Data>
							</Comment>
						</Cell>
