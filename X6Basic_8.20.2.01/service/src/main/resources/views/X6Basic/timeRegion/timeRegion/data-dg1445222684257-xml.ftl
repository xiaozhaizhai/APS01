...
<GridData DefaultNodeExpanded="false"   dgName="dg1445222684257" pageSize="${dg1445222684257Page.pageSize}" totalCount="${dg1445222684257Page.totalCount}" totalPages="${dg1445222684257Page.totalPages}" pageNo="${dg1445222684257Page.pageNo}" hasPre="${dg1445222684257Page.hasPre?string}" hasNext="${dg1445222684257Page.hasNext?string}" prePage="${dg1445222684257Page.prePage}" nextPage="${dg1445222684257Page.nextPage}">
	<thead>
				...
				<name
					...
					sort="false"  onPropertyChange="TimeRegionPar_dg1445222684257Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<startDate
						style="font-color:0303B3"
					sort="false"  onPropertyChange="TimeRegionPar_dg1445222684257Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				    onChange="TimeRegionPar_dg1445222684257Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);TimeRegionPar_dg1445222684257Widget.evalCustomFunction(nRow,sFieldName,'aa()');"
						...
						fieldPermit="1" hideButtonsOnReadOnly="true" title="${getText('ec.view.readonlytitle')}"
									  ...
									  onBlur="document.body.click()" 
									   buttonImg="Calendar" onClick="initCalender(TimeRegionPar_dg1445222684257Widget,'TimeRegionPar_dg1445222684257Widget',nRow,sFieldName)" 
									   onBtnClick="showCalender(TimeRegionPar_dg1445222684257Widget,'TimeRegionPar_dg1445222684257Widget',nRow,sFieldName)" 
									  			 control="Text" 
	...
	<tbody>
		<#list dg1445222684257Page.result as row>
		<row  onClick="TimeRegionPar_dg1445222684257Widget._DT._autoAddNewRow(nRow)" >
					<c>${(row.id)!}</c>
					<c>${(row.version)!}</c>
