 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								<#if item == 'name' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1459215074302')}</Data>
										</Cell>
								</#if>
								<#if item == 'startDate' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1459215181902')}</Data>
										</Cell>
								</#if>
								<#if item == 'endDate' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1459215032319')}</Data>
										</Cell>
								</#if>
								<#if item == 'year' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1459215254357')}</Data>
										</Cell>
								</#if>
								<#if item == 'quarter' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1459215116732')}</Data>
										</Cell>
								</#if>
								<#if item == 'month' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1459215052167')}</Data>
										</Cell>
								</#if>
								<#if item == 'week' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1459215239844')}</Data>
										</Cell>
								</#if>
