...
<script type="text/javascript">
	...
	function download(){
		//var url = "/X6Basic/timeRegion/timeRegion/downLoad.action?viewCode=X6Basic_1.0_timeRegion_timeReginList&orgName=X6Basic_1.0_timeRegion_timeReginList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/X6Basic/timeRegion/timeRegion/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
