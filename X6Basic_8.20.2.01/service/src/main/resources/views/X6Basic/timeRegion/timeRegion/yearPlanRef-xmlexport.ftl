 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								...
								<#if item == 'name' || item == '*'>
										<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1441778463050')}</Data></Cell>
								</#if>
								<#if item == 'setyear' || item == '*'>
										<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1441880564502')}</Data></Cell>
								</#if>
								<#if item == 'startTime' || item == '*'>
										<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1441851237774')}</Data></Cell>
								</#if>
								<#if item == 'endTime' || item == '*'>
										<Cell><Data ss:Type="String">${getText('X6Basic.propertydisplayName.randon1441880710697')}</Data></Cell>
								</#if>
			...
			<Row ss:AutoFitHeight="0">
				<#list exportFieldList as item>
					<#if item?length gt 0>
								...
								<#if item == 'name' || item == '*'>
									<Cell>
									<#if checkFieldPermission('name','X6Basic_1.0_timeRegion_TimeRegion','X6Basic_1.0_timeRegion_TimeRegion_name') != 0>
								...
								<#if item == 'setyear' || item == '*'>
									<Cell>
									<#if checkFieldPermission('setyear','X6Basic_1.0_timeRegion_TimeRegion','X6Basic_1.0_timeRegion_TimeRegion_setyear') != 0>
										<#if data.setyear??><Data ss:Type="Number">${(data.setyear)!}</Data></#if>
									</#if>
									</Cell>
								</#if>
								<#if item == 'startTime' || item == '*'>
									<Cell ss:StyleID="s7">
									<#if checkFieldPermission('startTime','X6Basic_1.0_timeRegion_TimeRegion','X6Basic_1.0_timeRegion_TimeRegion_startTime') != 0>
								...
								<#if item == 'endTime' || item == '*'>
									<Cell ss:StyleID="s7">
									<#if checkFieldPermission('endTime','X6Basic_1.0_timeRegion_TimeRegion','X6Basic_1.0_timeRegion_TimeRegion_endTime') != 0>
