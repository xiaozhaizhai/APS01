...
<GridData DefaultNodeExpanded="false"   dgName="dg1441882994270" pageSize="${dg1441882994270Page.pageSize}" totalCount="${dg1441882994270Page.totalCount}" totalPages="${dg1441882994270Page.totalPages}" pageNo="${dg1441882994270Page.pageNo}" hasPre="${dg1441882994270Page.hasPre?string}" hasNext="${dg1441882994270Page.hasNext?string}" prePage="${dg1441882994270Page.prePage}" nextPage="${dg1441882994270Page.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<name
					...
					sort="false"  onPropertyChange="TimeRegionPar_dg1441882994270Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
					...
					sort="false"  onPropertyChange="TimeRegionPar_dg1441882994270Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
						...
						fieldPermit="1" hideButtonsOnReadOnly="true" title="${getText('ec.view.readonlytitle')}"
									  ...
									  onBlur="document.body.click()" 
									   buttonImg="Calendar" onClick="initCalender(TimeRegionPar_dg1441882994270Widget,'TimeRegionPar_dg1441882994270Widget',nRow,sFieldName)" 
									   onBtnClick="showCalender(TimeRegionPar_dg1441882994270Widget,'TimeRegionPar_dg1441882994270Widget',nRow,sFieldName)" 
									  			 control="Text" 
	...
	<tbody>
		<#list dg1441882994270Page.result as row>
		<row  onClick="TimeRegionPar_dg1441882994270Widget._DT._autoAddNewRow(nRow)" >
					<c>${(row.id)!}</c>
					<c>${(row.version)!}</c>
			<#if cpObjHideKey?? && cpObjHideKey?has_content>
