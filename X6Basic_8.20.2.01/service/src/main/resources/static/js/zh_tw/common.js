...
foundation.common.getObject = function(object,values,prefix,sUrl){
	if(values.id == undefined || values.id === '' || values.id == "請選擇") {
		return {"id" : ""};
	}
	var includes = "";
	var retFlag = true;
...
foundation.common.getObjectIE = function(object,values,prefix,sUrl){
	if(values.id == undefined || values.id === '' || values.id== "選擇") {
		return {"id" : ""};
	}
	var includes = "";
