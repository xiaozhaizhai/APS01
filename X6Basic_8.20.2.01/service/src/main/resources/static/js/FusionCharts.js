...
infosoftglobal.FusionCharts.prototype = {
	...
	getSWFHTML: function() {
		...
		hostUrl='http://'+hostUrl+'/bap/static/js/swflash.cab';
		
		//if (navigator.plugins && navigator.mimeTypes && navigator.mimeTypes.length) { 
			// netscape plugin architecture	
		if($.browser.msie){
			swfNode += '<object id="'+ this.getAttribute('id') +'" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="'+hostUrl+'" width="'+ this.getAttribute('width') +'" height="'+ this.getAttribute('height') +'">';
			...
			swfNode = '<embed type="application/x-shockwave-flash" src="'+ this.getAttribute('swf') +'" pluginspage="'+hostUrl+'" width="'+ this.getAttribute('width') +'" height="'+ this.getAttribute('height') +'"  ';
	...
	render: function(elementId){
		...
		//if((this.detectFlashVersion==1) && (this.installedVer.major < 6)){
			...
			//		window.location = "/static/js/swflash.cab";
			//	}else{
			//		return false;
			//	}
			//}else{
