...
@Service("meetingRoomImportService")
public class MeetingRoomImportServiceImpl implements MeetingRoomImportService {
	...
	@Override
	@AuditLog(entity="X6Basic_1.0_meetingroom",model="X6Basic_1.0_meetingroom_MeetingRoom",desc="保存业务信息",operType="1")
	public void saveImportDataLog(MeetingRoom bizObj, MeetingRoom oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("X6Basic.entityname.radion1366792465295") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("X6Basic.entityname.radion1366792465295") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(MeetingRoom bizObj, String bussinesskeyFieldName,
