...
@Service("x6BasicAbookImportService")
public class X6BasicAbookImportServiceImpl implements X6BasicAbookImportService {
	...
	@Override
	@AuditLog(entity="X6Basic_1.0_addressBook",model="X6Basic_1.0_addressBook_Abook",desc="保存业务信息",operType="1")
	public void saveImportDataLog(X6BasicAbook bizObj, X6BasicAbook oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("X6Basic.entityname.radion1406704951712") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("X6Basic.entityname.radion1406704951712") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(X6BasicAbook bizObj, String bussinesskeyFieldName,
