...
@Service("x6BasicPlanDailyImportService")
public class X6BasicPlanDailyImportServiceImpl implements X6BasicPlanDailyImportService {
	...
	@Override
	@AuditLog(entity="X6Basic_1.0_rangePlan",model="X6Basic_1.0_rangePlan_PlanDaily",desc="保存业务信息",operType="1")
	public void saveImportDataLog(X6BasicPlanDaily bizObj, X6BasicPlanDaily oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(X6BasicPlanDaily bizObj, String bussinesskeyFieldName,
