...
@Service("x6BasicTimeRegionImportService")
public class X6BasicTimeRegionImportServiceImpl implements X6BasicTimeRegionImportService {
	...
	@Override
	@AuditLog(entity="X6Basic_1.0_timeRegion",model="X6Basic_1.0_timeRegion_TimeRegion",desc="保存业务信息",operType="1")
	public void saveImportDataLog(X6BasicTimeRegion bizObj, X6BasicTimeRegion oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(X6BasicTimeRegion bizObj, String bussinesskeyFieldName,
