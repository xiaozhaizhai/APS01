...
@Service("x6BasicRangePlanImportService")
public class X6BasicRangePlanImportServiceImpl implements X6BasicRangePlanImportService {
	...
	@Override
	@AuditLog(entity="X6Basic_1.0_rangePlan",model="X6Basic_1.0_rangePlan_RangePlan",desc="保存业务信息",operType="1")
	public void saveImportDataLog(X6BasicRangePlan bizObj, X6BasicRangePlan oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(X6BasicRangePlan bizObj, String bussinesskeyFieldName,
