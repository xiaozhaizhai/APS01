...
@Service("x6BasicAccountPeriodPartImportService")
public class X6BasicAccountPeriodPartImportServiceImpl implements X6BasicAccountPeriodPartImportService {
	...
	@Override
	@AuditLog(entity="X6Basic_1.0_accountingPeriod",model="X6Basic_1.0_accountingPeriod_AccountPeriodPart",desc="保存业务信息",operType="1")
	public void saveImportDataLog(X6BasicAccountPeriodPart bizObj, X6BasicAccountPeriodPart oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("X6Basic.entityname.radion1400466776361") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("X6Basic.entityname.radion1400466776361") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(X6BasicAccountPeriodPart bizObj, String bussinesskeyFieldName,
