...
@Service("x6BasicSpellRuleImportService")
public class X6BasicSpellRuleImportServiceImpl implements X6BasicSpellRuleImportService {
	...
	@Override
	@AuditLog(entity="X6Basic_1.0_spellRule",model="X6Basic_1.0_spellRule_SpellRule",desc="保存业务信息",operType="1")
	public void saveImportDataLog(X6BasicSpellRule bizObj, X6BasicSpellRule oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(X6BasicSpellRule bizObj, String bussinesskeyFieldName,
