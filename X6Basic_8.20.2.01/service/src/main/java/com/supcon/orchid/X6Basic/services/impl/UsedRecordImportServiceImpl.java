...
@Service("usedRecordImportService")
public class UsedRecordImportServiceImpl implements UsedRecordImportService {
	...
	@Override
	@AuditLog(entity="X6Basic_1.0_meetingroom",model="X6Basic_1.0_meetingroom_UsedRecord",desc="保存业务信息",operType="1")
	public void saveImportDataLog(UsedRecord bizObj, UsedRecord oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(UsedRecord bizObj, String bussinesskeyFieldName,
