...
@Service("x6BasicDocumentClassesImportService")
public class X6BasicDocumentClassesImportServiceImpl implements X6BasicDocumentClassesImportService {
	...
	@Override
	@AuditLog(entity="X6Basic_1.0_documentClass",model="X6Basic_1.0_documentClass_DocumentClasses",desc="保存业务信息",operType="1")
	public void saveImportDataLog(X6BasicDocumentClasses bizObj, X6BasicDocumentClasses oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("X6Basic.entityname.radion1379485629827") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("X6Basic.entityname.radion1379485629827") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(X6BasicDocumentClasses bizObj, String bussinesskeyFieldName,
