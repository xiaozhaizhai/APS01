...
@Service("x6BasicBaseUnitImportService")
public class X6BasicBaseUnitImportServiceImpl implements X6BasicBaseUnitImportService {
	...
	@Override
	@AuditLog(entity="X6Basic_1.0_unitGroup",model="X6Basic_1.0_unitGroup_BaseUnit",desc="保存业务信息",operType="1")
	public void saveImportDataLog(X6BasicBaseUnit bizObj, X6BasicBaseUnit oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(X6BasicBaseUnit bizObj, String bussinesskeyFieldName,
