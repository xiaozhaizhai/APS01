...
@Service("x6BasicSignatureImportService")
public class X6BasicSignatureImportServiceImpl implements X6BasicSignatureImportService {
	...
	@Override
	@AuditLog(entity="X6Basic_1.0_ggSignetManage",model="X6Basic_1.0_ggSignetManage_Signature",desc="保存业务信息",operType="1")
	public void saveImportDataLog(X6BasicSignature bizObj, X6BasicSignature oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("X6Basic.entityname.radion1385013762881") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("X6Basic.entityname.radion1385013762881") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(X6BasicSignature bizObj, String bussinesskeyFieldName,
