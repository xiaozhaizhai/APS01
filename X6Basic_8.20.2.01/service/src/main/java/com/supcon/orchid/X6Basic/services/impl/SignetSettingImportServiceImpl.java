...
@Service("signetSettingImportService")
public class SignetSettingImportServiceImpl implements SignetSettingImportService {
	...
	@Override
	@AuditLog(entity="X6Basic_1.0_signetManage",model="X6Basic_1.0_signetManage_SignetSetting",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SignetSetting bizObj, SignetSetting oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("X6Basic.entityname.radion1367133380805") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("X6Basic.entityname.radion1367133380805") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(SignetSetting bizObj, String bussinesskeyFieldName,
