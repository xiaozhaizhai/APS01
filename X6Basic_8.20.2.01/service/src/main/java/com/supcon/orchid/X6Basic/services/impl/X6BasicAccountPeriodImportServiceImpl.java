...
@Service("x6BasicAccountPeriodImportService")
public class X6BasicAccountPeriodImportServiceImpl implements X6BasicAccountPeriodImportService {
	...
	@Override
	@AuditLog(entity="X6Basic_1.0_accountingPeriod",model="X6Basic_1.0_accountingPeriod_AccountPeriod",desc="保存业务信息",operType="1")
	public void saveImportDataLog(X6BasicAccountPeriod bizObj, X6BasicAccountPeriod oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(X6BasicAccountPeriod bizObj, String bussinesskeyFieldName,
