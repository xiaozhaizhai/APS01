...
@Service("x6BasicTeamInfoImportService")
public class X6BasicTeamInfoImportServiceImpl implements X6BasicTeamInfoImportService {
	...
	@Override
	@AuditLog(entity="X6Basic_1.0_teamManage",model="X6Basic_1.0_teamManage_TeamInfo",desc="保存业务信息",operType="1")
	public void saveImportDataLog(X6BasicTeamInfo bizObj, X6BasicTeamInfo oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("X6Basic.entityname.radion1398303380892") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("X6Basic.entityname.radion1398303380892") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(X6BasicTeamInfo bizObj, String bussinesskeyFieldName,
