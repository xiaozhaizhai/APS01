...
@Service("attMachineImportService")
public class AttMachineImportServiceImpl implements AttMachineImportService {
	...
	@Override
	@AuditLog(entity="X6Basic_1.0_attMachine",model="X6Basic_1.0_attMachine_AttMachine",desc="保存业务信息",operType="1")
	public void saveImportDataLog(AttMachine bizObj, AttMachine oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("X6Basic.entityname.radion1367137834700") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("X6Basic.entityname.radion1367137834700") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(AttMachine bizObj, String bussinesskeyFieldName,
