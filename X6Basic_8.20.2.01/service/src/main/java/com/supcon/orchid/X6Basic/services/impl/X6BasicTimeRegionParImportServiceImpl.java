...
@Service("x6BasicTimeRegionParImportService")
public class X6BasicTimeRegionParImportServiceImpl implements X6BasicTimeRegionParImportService {
	...
	@Override
	@AuditLog(entity="X6Basic_1.0_timeRegion",model="X6Basic_1.0_timeRegion_TimeRegionPar",desc="保存业务信息",operType="1")
	public void saveImportDataLog(X6BasicTimeRegionPar bizObj, X6BasicTimeRegionPar oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("X6Basic.entityname.randon1459213899397") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("X6Basic.entityname.randon1459213899397") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(X6BasicTimeRegionPar bizObj, String bussinesskeyFieldName,
