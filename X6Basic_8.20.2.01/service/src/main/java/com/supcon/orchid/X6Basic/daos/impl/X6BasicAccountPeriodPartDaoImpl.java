...
@Repository
public class X6BasicAccountPeriodPartDaoImpl extends ExtendedGenericDaoImpl<X6BasicAccountPeriodPart, Long> implements X6BasicAccountPeriodPartDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,X6Basic_1.0_accountingPeriod_AccountPeriodPart,X6Basic_1.0) */
// 自定义代码
