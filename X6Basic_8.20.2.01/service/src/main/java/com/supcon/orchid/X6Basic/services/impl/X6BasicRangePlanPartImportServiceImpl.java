...
@Service("x6BasicRangePlanPartImportService")
public class X6BasicRangePlanPartImportServiceImpl implements X6BasicRangePlanPartImportService {
	...
	@Override
	@AuditLog(entity="X6Basic_1.0_rangePlan",model="X6Basic_1.0_rangePlan_RangePlanPart",desc="保存业务信息",operType="1")
	public void saveImportDataLog(X6BasicRangePlanPart bizObj, X6BasicRangePlanPart oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("X6Basic.entityname.radion1398308699588") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("X6Basic.entityname.radion1398308699588") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(X6BasicRangePlanPart bizObj, String bussinesskeyFieldName,
