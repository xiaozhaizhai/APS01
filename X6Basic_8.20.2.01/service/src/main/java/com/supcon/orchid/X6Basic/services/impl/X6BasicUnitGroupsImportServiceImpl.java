...
@Service("x6BasicUnitGroupsImportService")
public class X6BasicUnitGroupsImportServiceImpl implements X6BasicUnitGroupsImportService {
	...
	@Override
	@AuditLog(entity="X6Basic_1.0_unitGroup",model="X6Basic_1.0_unitGroup_UnitGroups",desc="保存业务信息",operType="1")
	public void saveImportDataLog(X6BasicUnitGroups bizObj, X6BasicUnitGroups oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("X6Basic.entityname.radion1398233394794") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("X6Basic.entityname.radion1398233394794") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(X6BasicUnitGroups bizObj, String bussinesskeyFieldName,
