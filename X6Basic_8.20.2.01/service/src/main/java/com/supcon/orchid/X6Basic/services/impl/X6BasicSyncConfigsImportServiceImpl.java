...
@Service("x6BasicSyncConfigsImportService")
public class X6BasicSyncConfigsImportServiceImpl implements X6BasicSyncConfigsImportService {
	...
	@Override
	@AuditLog(entity="X6Basic_1.0_syncConfig",model="X6Basic_1.0_syncConfig_SyncConfigs",desc="保存业务信息",operType="1")
	public void saveImportDataLog(X6BasicSyncConfigs bizObj, X6BasicSyncConfigs oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("X6Basic.entityname.radion1409053208659") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("X6Basic.entityname.radion1409053208659") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(X6BasicSyncConfigs bizObj, String bussinesskeyFieldName,
