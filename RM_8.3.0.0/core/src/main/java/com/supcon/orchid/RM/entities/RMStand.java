 ...
 * 质量标准表.
 */
@javax.persistence.Entity(name=RMStand.JPA_NAME)
@Table(name = RMStand.TABLE_NAME)
@BAPEntity(entityCode="RM_7.5.0.0_qualityStandard")
@XmlRootElement
@BAPModelCode(code="RM_7.5.0.0_qualityStandard_Stand")
@AttributeOverrides({
		...
		/* CUSTOM CODE START(entity,attribute_overrides,RM_7.5.0.0_qualityStandard_Stand,RM_7.5.0.0) */
// 自定义代码
...
@BAPCustomComponent
@DataAudit
@XmlSeeAlso({RMStandConvertor.class})
public class RMStand extends com.supcon.orchid.orm.entities.AbstractEcFullEntity {
	private static final long serialVersionUID = 1L;
	public static final String MODULE_CODE = "RM_7.5.0.0";
	public static final String ENTITY_CODE = "RM_7.5.0.0_qualityStandard";
	public static final String MODEL_CODE = "RM_7.5.0.0_qualityStandard_Stand";
	public static final String DOC_TYPE = "RM_qualityStandard_stand";
	public static final String TABLE_NAME = "limsbasic_stands";
	public static final String JPA_NAME = "RMStand";


		private Boolean active = false; // 启用状态


		private String code ; // 编码


		private Boolean ifDefault = false; // 是否默认


		private String memoField ; // 备注


		private String name ; // 质量标准名称
    ...
    public Boolean getIfDefault() {
        return null == ifDefault ? false : ifDefault;
    }
	/**
	 * 设置是否默认.
	 * @param ifDefault 是否默认
	 */
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_qualityStandard_Stand_bigintparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_qualityStandard_Stand_bigintparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_qualityStandard_Stand_charparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_qualityStandard_Stand_charparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_qualityStandard_Stand_dateparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_qualityStandard_Stand_dateparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_qualityStandard_Stand_numberparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_qualityStandard_Stand_numberparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_qualityStandard_Stand_objparama", complex = true)
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_qualityStandard_Stand_objparamb", complex = true)
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_qualityStandard_Stand_scparama", complex = true)
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_qualityStandard_Stand_scparamb", complex = true)
	...
	/* CUSTOM CODE START(entity,functions,RM_7.5.0.0_qualityStandard_Stand,RM_7.5.0.0) */
// 自定义代码
