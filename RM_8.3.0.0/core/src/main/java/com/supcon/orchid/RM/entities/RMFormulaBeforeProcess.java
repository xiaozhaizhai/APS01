 ...
 * 前置工序.
 */
@javax.persistence.Entity(name=RMFormulaBeforeProcess.JPA_NAME)
@Table(name = RMFormulaBeforeProcess.TABLE_NAME)
@BAPEntity(entityCode="RM_7.5.0.0_formula")
@XmlRootElement
@BAPModelCode(code="RM_7.5.0.0_formula_FormulaBeforeProcess")
@AttributeOverrides({
		...
		/* CUSTOM CODE START(entity,attribute_overrides,RM_7.5.0.0_formula_FormulaBeforeProcess,RM_7.5.0.0) */
// 自定义代码
...
@BAPCustomComponent
@DataAudit
@XmlSeeAlso({RMFormulaBeforeProcessConvertor.class})
public class RMFormulaBeforeProcess extends com.supcon.orchid.orm.entities.AbstractEcPartEntity {
	private static final long serialVersionUID = 1L;
	public static final String MODULE_CODE = "RM_7.5.0.0";
	public static final String ENTITY_CODE = "RM_7.5.0.0_formula";
	public static final String MODEL_CODE = "RM_7.5.0.0_formula_FormulaBeforeProcess";
	public static final String DOC_TYPE = "RM_formula_formulaBeforeProcess";
	public static final String TABLE_NAME = "rm_formula_before_processes";
	public static final String JPA_NAME = "RMFormulaBeforeProcess";
	private RMFormulaProcess beforeProcessID;
	private RMFormulaProcess processId;
	
	private List<RMFormulaProcess> formulaProcessList;
	
	public void setFormulaProcessList(List<RMFormulaProcess> formulaProcessList){
		this.formulaProcessList = formulaProcessList;
	}
	@Transient
	public List<RMFormulaProcess> getFormulaProcessList(){
	...
	@Index(name="IDX_FORMULABEFOREPR_TABLE_ID")
	@Column
    ...
    public RMFormulaProcess getBeforeProcessID() {
        return beforeProcessID;
    }
    public void setBeforeProcessID(RMFormulaProcess beforeProcessID) {
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_FormulaBeforeProcess_bigintparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_FormulaBeforeProcess_bigintparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_FormulaBeforeProcess_charparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_FormulaBeforeProcess_charparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_FormulaBeforeProcess_dateparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_FormulaBeforeProcess_dateparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_FormulaBeforeProcess_numberparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_FormulaBeforeProcess_numberparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_FormulaBeforeProcess_objparama", complex = true)
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_FormulaBeforeProcess_objparamb", complex = true)
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_FormulaBeforeProcess_scparama", complex = true)
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_FormulaBeforeProcess_scparamb", complex = true)
	...
	/* CUSTOM CODE START(entity,functions,RM_7.5.0.0_formula_FormulaBeforeProcess,RM_7.5.0.0) */
// 自定义代码
