 ...
 * 测试方案（废）.
 */
@javax.persistence.Entity(name=RMTestProj.JPA_NAME)
@Table(name = RMTestProj.TABLE_NAME)
@BAPEntity(entityCode="RM_7.5.0.0_testProj")
@XmlRootElement
@BAPModelCode(code="RM_7.5.0.0_testProj_TestProj")
@AttributeOverrides({
		...
		/* CUSTOM CODE START(entity,attribute_overrides,RM_7.5.0.0_testProj_TestProj,RM_7.5.0.0) */
// 自定义代码
...
@BAPCustomComponent
@DataAudit
@XmlSeeAlso({RMTestProjConvertor.class})
public class RMTestProj extends com.supcon.orchid.orm.entities.AbstractEcFullEntity {
	private static final long serialVersionUID = 1L;
	public static final String MODULE_CODE = "RM_7.5.0.0";
	public static final String ENTITY_CODE = "RM_7.5.0.0_testProj";
	public static final String MODEL_CODE = "RM_7.5.0.0_testProj_TestProj";
	public static final String DOC_TYPE = "RM_testProj_testProj";
	public static final String TABLE_NAME = "limsbasic_test_projs";
	public static final String JPA_NAME = "RMTestProj";


		private String code ; // 编码


		private Boolean isDefault = false; // 是否默认方案


		private String meno ; // 备注


		private String name ; // 检测方案名称
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_testProj_TestProj_bigintparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_testProj_TestProj_bigintparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_testProj_TestProj_charparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_testProj_TestProj_charparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_testProj_TestProj_dateparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_testProj_TestProj_dateparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_testProj_TestProj_numberparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_testProj_TestProj_numberparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_testProj_TestProj_objparama", complex = true)
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_testProj_TestProj_objparamb", complex = true)
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_testProj_TestProj_scparama", complex = true)
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_testProj_TestProj_scparamb", complex = true)
	...
	/* CUSTOM CODE START(entity,functions,RM_7.5.0.0_testProj_TestProj,RM_7.5.0.0) */
// 自定义代码
