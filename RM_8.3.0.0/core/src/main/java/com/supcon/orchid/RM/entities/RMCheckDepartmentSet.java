 ...
 * 检验部门.
 */
@javax.persistence.Entity(name=RMCheckDepartmentSet.JPA_NAME)
@Table(name = RMCheckDepartmentSet.TABLE_NAME)
@BAPEntity(entityCode="RM_7.5.0.0_formula")
@XmlRootElement
@BAPModelCode(code="RM_7.5.0.0_formula_CheckDepartmentSet")
@AttributeOverrides({
		...
		/* CUSTOM CODE START(entity,attribute_overrides,RM_7.5.0.0_formula_CheckDepartmentSet,RM_7.5.0.0) */
// 自定义代码
...
@BAPCustomComponent
@DataAudit
@XmlSeeAlso({RMCheckDepartmentSetConvertor.class})
public class RMCheckDepartmentSet extends com.supcon.orchid.orm.entities.AbstractEcPartEntity {
	private static final long serialVersionUID = 1L;
	public static final String MODULE_CODE = "RM_7.5.0.0";
	public static final String ENTITY_CODE = "RM_7.5.0.0_formula";
	public static final String MODEL_CODE = "RM_7.5.0.0_formula_CheckDepartmentSet";
	public static final String DOC_TYPE = "RM_formula_checkDepartmentSet";
	public static final String TABLE_NAME = "rm_check_department_sets";
	public static final String JPA_NAME = "RMCheckDepartmentSet";
	private RMFormulaProcessActive activeID;
	private Department applyCheckDept;
	private Staff applyCheckStaff;
	private Department exeCheckDept;
	...
	@Index(name="IDX_CHECKDEPARTMENT_TABLE_ID")
	@Column
	...
	@OneToOne
	@JoinColumn(name = "APPLY_CHECK_DEPT", referencedColumnName="ID")
	@XmlJavaTypeAdapter(BAPFoundationAdapter.class)
	@Fetch(FetchMode.SELECT)
						
    public Department getApplyCheckDept() {
        return applyCheckDept;
    }
    public void setApplyCheckDept(Department applyCheckDept) {
        this.applyCheckDept = applyCheckDept;
    }
	@OneToOne
	@JoinColumn(name = "APPLY_CHECK_STAFF", referencedColumnName="ID")
	@XmlJavaTypeAdapter(BAPFoundationAdapter.class)
	@Fetch(FetchMode.SELECT)
						
    public Staff getApplyCheckStaff() {
        return applyCheckStaff;
    }
    public void setApplyCheckStaff(Staff applyCheckStaff) {
        this.applyCheckStaff = applyCheckStaff;
    }
	@OneToOne
	@JoinColumn(name = "EXE_CHECK_DEPT", referencedColumnName="ID")
	@XmlJavaTypeAdapter(BAPFoundationAdapter.class)
	@Fetch(FetchMode.SELECT)
						
    public Department getExeCheckDept() {
        return exeCheckDept;
    }
    public void setExeCheckDept(Department exeCheckDept) {
        this.exeCheckDept = exeCheckDept;
    }
	@OneToOne
	...
	@ManyToOne
	@JoinColumn(name = "FORMULAID", referencedColumnName="ID")
	@XmlJavaTypeAdapter(BAPAdapter.class)
	@Fetch(FetchMode.SELECT)
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_CheckDepartmentSet_bigintparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_CheckDepartmentSet_bigintparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_CheckDepartmentSet_charparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_CheckDepartmentSet_charparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_CheckDepartmentSet_dateparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_CheckDepartmentSet_dateparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_CheckDepartmentSet_numberparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_CheckDepartmentSet_numberparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_CheckDepartmentSet_objparama", complex = true)
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_CheckDepartmentSet_objparamb", complex = true)
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_CheckDepartmentSet_scparama", complex = true)
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formula_CheckDepartmentSet_scparamb", complex = true)
	...
	/* CUSTOM CODE START(entity,functions,RM_7.5.0.0_formula_CheckDepartmentSet,RM_7.5.0.0) */
// 自定义代码
