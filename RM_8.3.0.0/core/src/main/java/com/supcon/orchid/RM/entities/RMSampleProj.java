 ...
 * 样品模板.
 */
@javax.persistence.Entity(name=RMSampleProj.JPA_NAME)
@Table(name = RMSampleProj.TABLE_NAME)
@BAPEntity(entityCode="RM_7.5.0.0_sampleProj")
@XmlRootElement
@BAPModelCode(code="RM_7.5.0.0_sampleProj_SampleProj")
@AttributeOverrides({
		...
		/* CUSTOM CODE START(entity,attribute_overrides,RM_7.5.0.0_sampleProj_SampleProj,RM_7.5.0.0) */
// 自定义代码
...
@BAPCustomComponent
@DataAudit
@XmlSeeAlso({RMSampleProjConvertor.class})
public class RMSampleProj extends com.supcon.orchid.orm.entities.AbstractEcFullEntity {
	private static final long serialVersionUID = 1L;
	public static final String MODULE_CODE = "RM_7.5.0.0";
	public static final String ENTITY_CODE = "RM_7.5.0.0_sampleProj";
	public static final String MODEL_CODE = "RM_7.5.0.0_sampleProj_SampleProj";
	public static final String DOC_TYPE = "RM_sampleProj_sampleProj";
	public static final String TABLE_NAME = "limsbasic_sample_projs";
	public static final String JPA_NAME = "RMSampleProj";
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_sampleProj_SampleProj_bigintparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_sampleProj_SampleProj_bigintparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_sampleProj_SampleProj_charparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_sampleProj_SampleProj_charparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_sampleProj_SampleProj_dateparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_sampleProj_SampleProj_dateparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_sampleProj_SampleProj_numberparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_sampleProj_SampleProj_numberparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_sampleProj_SampleProj_objparama", complex = true)
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_sampleProj_SampleProj_objparamb", complex = true)
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_sampleProj_SampleProj_scparama", complex = true)
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_sampleProj_SampleProj_scparamb", complex = true)
	...
	/* CUSTOM CODE START(entity,functions,RM_7.5.0.0_sampleProj_SampleProj,RM_7.5.0.0) */
// 自定义代码
