 ...
 * 配方类型.
 */
@javax.persistence.Entity(name=RMFormulaType.JPA_NAME)
@Table(name = RMFormulaType.TABLE_NAME)
@BAPEntity(entityCode="RM_7.5.0.0_formulaType")
@XmlRootElement
@BAPModelCode(code="RM_7.5.0.0_formulaType_FormulaType")
@AttributeOverrides({
		...
		/* CUSTOM CODE START(entity,attribute_overrides,RM_7.5.0.0_formulaType_FormulaType,RM_7.5.0.0) */
// 自定义代码
...
@BAPCustomComponent
@DataAudit
@XmlSeeAlso({RMFormulaTypeConvertor.class})
public class RMFormulaType extends com.supcon.orchid.orm.entities.AbstractEcTreeFullEntity<RMFormulaType> {
	private static final long serialVersionUID = 1L;
	public static final String MODULE_CODE = "RM_7.5.0.0";
	public static final String ENTITY_CODE = "RM_7.5.0.0_formulaType";
	public static final String MODEL_CODE = "RM_7.5.0.0_formulaType_FormulaType";
	public static final String DOC_TYPE = "RM_formulaType_formulaType";
	public static final String TABLE_NAME = "rm_formula_types";
	public static final String JPA_NAME = "RMFormulaType";
	...
	@Index(name="index_FormulaType_code")	
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formulaType_FormulaType_bigintparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formulaType_FormulaType_bigintparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formulaType_FormulaType_charparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formulaType_FormulaType_charparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formulaType_FormulaType_dateparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formulaType_FormulaType_dateparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formulaType_FormulaType_numberparama")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formulaType_FormulaType_numberparamb")
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formulaType_FormulaType_objparama", complex = true)
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formulaType_FormulaType_objparamb", complex = true)
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formulaType_FormulaType_scparama", complex = true)
	...
	@BAPCustomComponent(code = "RM_7.5.0.0_formulaType_FormulaType_scparamb", complex = true)
	...
	/* CUSTOM CODE START(entity,functions,RM_7.5.0.0_formulaType_FormulaType,RM_7.5.0.0) */
// 自定义代码
