...
<#assign viewCode = 'RM_7.5.0.0_sampleProj_SampleProj' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1490317894319')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1490317960117')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'active' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1490317800745')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'meno' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1490317932118')}</Data></Cell>
											</#if>
