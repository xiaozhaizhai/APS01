...
<#assign viewCode = 'RM_7.5.0.0_fomulaChange_FormulaChange' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="formulaId.code">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="formulaId.edition">
	  			<NumberFormat ss:Format="0.00"/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="formulaId.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		...
	  		<Style ss:ID="modifyStaff.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="oldIsForProduct">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="oldState">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="oldUsedFor">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="state">
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'formulaId.code' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'formulaId.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'formulaId.edition' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'oldUsedFor.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
											...
											<#if item == 'oldIsForProduct' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'oldState.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
															<Column ss:Index="${count}" ss:StyleID="${item?substring(0,item?last_index_of('.'))}"  ss:Width="140"/>
														 <#else>
														    <Column ss:Index="${count}" ss:StyleID="${item}"  ss:Width="140" />
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'modifyStaff.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.staff.dimissionStaff_xls.staffName')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'createTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.common.createTime3233223')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formulaId.code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.formula.randon1488246312092')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formulaId.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.formula.randon1487075823790')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formulaId.edition' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.formula.randon122222222')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'oldUsedFor.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon14891081154817777')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'oldIsForProduct' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon14891081502167777')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'oldState.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon14891080742427777')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'changeType.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1488268014469')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'usedFor.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1488268147400')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isForProduct' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon14882681701217777')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'state.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1488268127763654321')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
												<#if item == 'state.value' && !customGeneratedFlag >
												</#if>
									...
									<#if item?length gt 0>
												...
												<#if item == 'modifyStaff.name' || item == '*'>
													<Cell>
														...
														<#if data.modifyStaff.name??><Data ss:Type="String"><![CDATA[${(data.modifyStaff.name)!}]]></Data></#if>
												...
												<#if item == 'formulaId.code' || item == '*'>
													<Cell>
														...
														<#if data.formulaId.code??><Data ss:Type="String"><![CDATA[${(data.formulaId.code)!}]]></Data></#if>
												...
												<#if item == 'formulaId.name' || item == '*'>
													<Cell>
														...
														<#if data.formulaId.name??><Data ss:Type="String"><![CDATA[${(data.formulaId.name)!}]]></Data></#if>
												...
												<#if item == 'formulaId.edition' || item == '*'>
													<Cell>
														...
														<#if (data.formulaId.edition)?has_content><Data ss:Type="Number">#{(data.formulaId.edition)!; m6M6}</Data></#if>
												...
												<#if item == 'oldUsedFor.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.oldUsedFor.value)!}')}</Data>
												...
												<#if item == 'oldIsForProduct' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.oldIsForProduct?? && data.oldIsForProduct>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'oldState.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.oldState.value)!}')}</Data>
												...
												<#if item == 'changeType.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.changeType.value)!}')}</Data>
