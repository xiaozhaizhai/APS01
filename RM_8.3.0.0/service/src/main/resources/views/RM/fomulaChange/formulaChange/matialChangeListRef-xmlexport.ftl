			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formulaId.code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.formula.randon14882463120921123')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formulaId.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.formula.randon1487075823790112331')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formulaId.edition' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.formula.randon1222222221awef')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'oldUsedFor.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.formula.randon1487076506987555434562345aaa')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'oldIsForProduct' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1489108150216777')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'oldState.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon14870764732577889ssaa13')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'changeType.value' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'usedFor.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1488268147405134')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isForProduct' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon14882681701216767')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'state.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1488268127768')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
