			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'oldUsedFor.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.formula.randon14870765069877777')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'oldIsForProduct' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'usedFor.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon14882681474007777')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isForProduct' || item == '*'>
