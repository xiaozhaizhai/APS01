			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'oldState.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1489108074242')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'state.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1488268127767')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'createStaff.name' || item == '*'>
									...
									<#if item?length gt 0>
												...
												<#if item == 'createStaff.name' || item == '*'>
													<Cell>
														...
														<#if data.createStaff.name??><Data ss:Type="String"><![CDATA[${(data.createStaff.name)!}]]></Data></#if>
