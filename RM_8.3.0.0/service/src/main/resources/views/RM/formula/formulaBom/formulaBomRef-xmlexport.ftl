...
<#assign viewCode = 'RM_7.5.0.0_formula_FormulaBom' />
<#assign propertyCode = '' />
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productId.productCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.radion14157726448331')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productId.productName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.radion14157727407371')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'property.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1490010423584')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'unitQuality' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon14872431390911')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productId.productBaseUnit.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.radion139823564048323')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isMixQuality' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1488852241781')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'phase' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1503477430704')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'sequence' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1503477288458')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'needWeigh' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon150347726245811123123')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'minQuality' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1488852437576')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'maxQuality' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1488852460357')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'lossRate' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1491544403180')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
												<#if item == 'lossRate' && !customGeneratedFlag >
												</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'meno' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1488852483896')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												...
												<#if item == 'phase' || item == '*'>
													<Cell>
														...
														<#if data.phase??><Data ss:Type="Number"><![CDATA[${(data.phase)!}]]></Data></#if>
												...
												<#if item == 'sequence' || item == '*'>
													<Cell>
														...
														<#if data.sequence??><Data ss:Type="Number"><![CDATA[${(data.sequence)!}]]></Data></#if>
