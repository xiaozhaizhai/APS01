...
<#assign showCusProps =  dgPage.showCusProps />
	...
	<Styles>
 		...
 		<Style ss:ID="s8">
  		...
  		<Style ss:ID="lflineId.id">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
  		<Style ss:ID="lflineId.name">
  			<NumberFormat/>
  			<Protection/>
  		</Style>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0 && item != "checkbox">
									...
									<#if item == 'autoReportOnFinish.value' || item == 'autoReportOnFinish.id' || item == '*'>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								<#if item == 'lflineId.name' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon201810251522003')}</Data>
										</Cell>
								</#if>
								<#if item == 'maxCapacity' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1540450260677')}</Data>
										</Cell>
								</#if>
								<#if item == 'longTime' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon201810251522002')}</Data>
										</Cell>
								</#if>
								<#if item == 'theoreYield' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1540450331203')}</Data>
										</Cell>
								</#if>
								<#if item == 'autoReportOnFinish.value' || item == 'autoReportOnFinish.id' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1540448935204')}</Data>
										</Cell>
								</#if>
								<#if item == 'meno' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1540450285384')}</Data>
										</Cell>
								</#if>
								<#if item == 'tempId' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1540450321075')}</Data>
										</Cell>
								</#if>
								<#if item == 'lflineId.id' || item == '*'>
										<Cell>
					...
					<#if item?length gt 0>
								<#if item == 'lflineId.name' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.lflineId.name)??>${(data.lflineId.name)!}</#if></Data>
								...
								<#if item == 'tempId' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.tempId)??>${(data.tempId)!}</#if></Data>
								...
								<#if item == 'lflineId.id' || item == '*'>
									<Cell>
										...
										<Data ss:Type="Number"><#if (data.lflineId.id)??>${(data.lflineId.id)!}</#if></Data>
