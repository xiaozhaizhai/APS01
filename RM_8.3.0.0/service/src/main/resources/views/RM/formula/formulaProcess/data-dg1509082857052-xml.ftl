...
<GridData DefaultNodeExpanded="false"   dgName="dg1509082857052" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<processId.name
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(FormulaProcessActive_dg1509082857052Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(FormulaProcessActive_dg1509082857052Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/RM/formula/formulaProcess/processReference.action','dg1509082857052processId.name','${getText("RM.viewtitle.randon1488596828660")}',sPTGridID,nRow,sFieldName,FormulaProcessActive_dg1509082857052Widget,null,false,false,'','RM_7.5.0.0_formula_processReference')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="FormulaProcessActive_dg1509082857052Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<product.productCode
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(FormulaProcessActive_dg1509082857052Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(FormulaProcessActive_dg1509082857052Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/product/product/refProductLayout.action','dg1509082857052product.productCode','${getText("MESBasic.viewtitle.randon1450085069587")}',sPTGridID,nRow,sFieldName,FormulaProcessActive_dg1509082857052Widget,null,false,false,'','MESBasic_1_product_refProductLayout')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="FormulaProcessActive_dg1509082857052Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<qualityStandard.name
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(FormulaProcessActive_dg1509082857052Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(FormulaProcessActive_dg1509082857052Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/RM/qualityStandard/stand/standRef.action','dg1509082857052qualityStandard.name','${getText("RM.viewtitle.randon1487596068024")}',sPTGridID,nRow,sFieldName,FormulaProcessActive_dg1509082857052Widget,null,false,false,'','RM_7.5.0.0_qualityStandard_standRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="false"  onPropertyChange="FormulaProcessActive_dg1509082857052Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
	...
	<tbody>
		...
		<row  onClick="FormulaProcessActive_dg1509082857052Widget._DT._autoAddNewRow(nRow)" >
					<c>${(row.id)!}</c>
					<c>${(row.version)!}</c>
