<!-- RM_7.5.0.0/formula/manualActiveEdit -->
...
<title>${getText('RM.viewtitle.randon1488778176925')}</title>
<@maincss/>
<@mainjs/>
<@extracss />

<!-- CUSTOM CODE START(view-EDIT-RM_7.5.0.0_formula_manualActiveEdit,head,RM_7.5.0.0_formula_FormulaProcessActive,RM_7.5.0.0) -->
<!-- 自定义代码 -->
...
<script type="text/javascript">
	CUI.ns('RM.formula.formulaProcessActive.manualActiveEdit');
</script>
<@ecStyleCss />
...
<@errorbar id="RM_formula_formulaProcessActive_manualActiveEdit_formDialogErrorBar" />
<#assign mneIframe = false>
<#if (Parameters.openType)?? && (Parameters.openType) == 'frame'>
<#assign callbackName="parent." + callbackName>
<#assign mneIframe = true>
</#if>
<@s.form id="RM_formula_formulaProcessActive_manualActiveEdit_form" cssStyle="height:100%;" hiddenField="formulaProcessActive.formulaId.id,formulaProcessActive.id,formulaProcessActive.product.id," onsubmitMethod="RM.formula.formulaProcessActive.manualActiveEdit.beforeSubmitMethod()" ecAction="/RM/formula/formulaProcessActive/manualActiveEdit/submit.action?__pc__=${(Parameters.__pc__)!}" callback=callbackName ecform="true">
	<input type="hidden" name="bap_validate_user_id" value="${(Session.user.id)!}" />
	<input type="hidden" name="operateType" value="submit">
	<input type="hidden" name="viewselect" value="manualActiveEdit">
	<input type="hidden" name="viewCode" value="RM_7.5.0.0_formula_manualActiveEdit">
	<input type="hidden" name="datagridKey" value="RM_formula_formulaProcessActive_manualActiveEdit_datagrids">
	...
	<div id="RM_manualActiveEdit_edit_div" style="height:100%">
		<div id="RM_formula_formulaProcessActive_manualActiveEdit_main_div" class="edit-content-dialog edit-content-dialog-fullwidth">
<script type="text/javascript">
var attcountid = "RM_formula_formulaProcessActive_manualActiveEdit_form"+"_attcount";
		...
		<tr class="dialog_tr">
					...
					<td  nullable=false class="edit-table-content"   align="left" style="text-align: left;;" >
						...
						<#assign formulaProcessActive_activeType_defaultValue  = 'activeType/activeType4'>
								...
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${formulaProcessActive_activeType_defaultValue!}" formId="RM_formula_formulaProcessActive_manualActiveEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="formulaProcessActive.activeType.id" code="activeType" value="${(formulaProcessActive.activeType.id)!}"  />
									
								<#else>
									
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="RM_formula_formulaProcessActive_manualActiveEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="formulaProcessActive.activeType.id" code="activeType" value="${(formulaProcessActive.activeType.id)!}"  />
								...
								<#if !(formulaProcessActive.id)?? && (formulaProcessActive.product.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('RM_formula_formulaProcessActive_manualActiveEdit_form',obj, 'formulaProcessActive.product', '/MESBasic/product/product/refProductLayout.action');
												CUI.commonFills('RM_formula_formulaProcessActive_manualActiveEdit_form', 'formulaProcessActive.product',obj,true);
											}
										});
									})(jQuery);
								</#if>
					...
					<td  nullable=true class="edit-table-content"   style="text-align: left;;" >
								...
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${formulaProcessActive_exeSystem_defaultValue!}" formId="RM_formula_formulaProcessActive_manualActiveEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false  name="formulaProcessActive.exeSystem.id" code="RMsystem" value="${(formulaProcessActive.exeSystem.id)!}"  />
									
								<#else>
									
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="RM_formula_formulaProcessActive_manualActiveEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false  name="formulaProcessActive.exeSystem.id" code="RMsystem" value="${(formulaProcessActive.exeSystem.id)!}"  />
	...
	<table class="edit-table" style="display:none;">
		...
		<tr class="dialog_tr">
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
						...
						<#assign formulaProcessActive_occurTurn_defaultValue  = 'occurTurn/occurTurn2'>
								...
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${formulaProcessActive_occurTurn_defaultValue!}" formId="RM_formula_formulaProcessActive_manualActiveEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false  name="formulaProcessActive.occurTurn.id" code="occurTurn" value="${(formulaProcessActive.occurTurn.id)!}"  />
									
								<#else>
									
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="RM_formula_formulaProcessActive_manualActiveEdit_form" classStyle="cui-noborder-input" ecFlag=true multable=false  name="formulaProcessActive.occurTurn.id" code="occurTurn" value="${(formulaProcessActive.occurTurn.id)!}"  />
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
									...
									<@mneclient iframe=mneIframe!false property_type="LONG" reftitle="${getText('RM.viewtitle.randon1514372721087')}" viewType="${viewType!}" deValue="${formulaProcessActive_formulaId_id_defaultValue!}" conditionfunc="RM.formula.formulaProcessActive.manualActiveEdit._querycustomFunc('formulaProcessActive_formulaId_id')"  value="${(formulaProcessActive.formulaId.id)!}" displayFieldName="id" name="formulaProcessActive.formulaId.id" id="formulaProcessActive_formulaId_id" type="other" url="/RM/formula/formula/formulaForSuitLine.action" clicked=true multiple=false mnewidth=260 formId="RM_formula_formulaProcessActive_manualActiveEdit_form" editCustomCallback=";" refViewCode="RM_7.5.0.0_formula_formulaForSuitLine" onkeyupfuncname=";_callback_formulaProcessActive_formulaId_id(obj);" cssStyle="" isEdit=true     isCrossCompany=false  />
								...
								<#if !(formulaProcessActive.id)?? && (formulaProcessActive.formulaId.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('RM_formula_formulaProcessActive_manualActiveEdit_form',obj, 'formulaProcessActive.formulaId', '/RM/formula/formula/formulaForSuitLine.action');
												CUI.commonFills('RM_formula_formulaProcessActive_manualActiveEdit_form', 'formulaProcessActive.formulaId',obj,true);
											}
										});
									})(jQuery);
								</#if>
		...
		<#assign cpvmInfo = ''>
			<#assign customPropList = getShowCustomProps("RM_7.5.0.0_formula_FormulaProcessActive", "RM_7.5.0.0_formula_manualActiveEdit", 'EDIT')>
				...
				<td nullable=<#if (c.nullable!false)>true<#else>false</#if> class="edit-table-content" <#if c.fieldType?? && c.fieldType == 'DATATIME'>celltype="DATATIME"</#if> <#if cspan gt 1>colspan="${colspanVal}"</#if> style="text-align:left;">
					...
					<#elseif fieldType == 'SELECTCOMP'>
						<#if columnType == 'SYSTEMCODE'>
							...
							<@systemcode property_type="${columnType}" iscustom=true showType="${fieldType}" viewType=viewType cssStyle="text-align:${c.align!}" formId="RM_formula_formulaProcessActive_manualActiveEdit_form" classStyle="cui-noborder-input" view=(c.readonly!false) cssStyle="" ecFlag=true multable=isMultable name="${elementName}" code="${(c.property.fillcontentMap.fillContent)!}" value="${formulaProcessActive[columnName]!}" seniorSystemCode=isS2 />
						<#else>
...
<#assign colAdmFlag=checkUserPermisition('ec_ptManage_list_view')>
			...
			<#if  refId?? && (refId > 0)>
				<#assign dUrl="/RM/formula/formulaProcessActive/data-dg1488778215616.action?formulaProcessActive.id=${refId!-1}&refId=${refId!-1}&datagridCode=RM_7.5.0.0_formula_manualActiveEditdg1488778215616">
			<#else>
				<#assign dUrl="/RM/formula/formulaProcessActive/data-dg1488778215616.action?formulaProcessActive.id=${(formulaProcessActive.id)!-1}&datagridCode=RM_7.5.0.0_formula_manualActiveEditdg1488778215616">
			</#if>
			...
			<#else>
				...
				<#if cpvmInfo?? && cpvmInfo?length gt 0>
					<#assign cpvmInfo = cpvmInfo?substring(1)>
					<input type="hidden" id="dg_cp_info_FormulaMixtureActive_dg1488778215616" value="${cpvmInfo!}" />
				</#if>
			
			<input type="hidden" id="dg1488778215616_id" value="FormulaMixtureActive_dg1488778215616" />
			
			<input type="hidden" id="dg1488778215616_url" value="${dUrl}" />
			
			<#assign assModelDisplayName = getText('RM.modelname.randon1487811340490')!>
			<#assign assModelDisplayName = assModelDisplayName + getText('ec.common.validate.colon') >
			<@exportexcel action="/RM/formula/formulaProcessActive/data-dg1488778215616.action?operateType=export&datagridCode=RM_7.5.0.0_formula_manualActiveEditdg1488778215616"  settingtext="" settingUrl="" prepareParams="" formId="" look="text" width=250 height=170 text="" exportPageChoose=0 dtPage="dgPage" prefix="FormulaMixtureActive_dg1488778215616" />
			<@datagrid colAdminFlag=colAdmFlag withoutConfigTable=true id="FormulaMixtureActive_dg1488778215616" viewType="${viewType}" renderOverEvent="dg1488778215616RenderOverEvent" route="${routeFlag}" formId="RM_formula_formulaProcessActive_manualActiveEdit_form" noPermissionKeys="name,exeSystem,batchSite,product.productCode,product.productName,product.productBaseUnit.name,isPlace,isMixQuality,standardQuantity,minQuality,maxQuality,lossRate,occurTurn,saveFlag,addFlag,formulaType,product.id,formulaHiddenId,processTableId,processHiddenId,channelOrManual,meno,hiddenSort" modelCode="RM_7.5.0.0_formula_FormulaMixtureActive" dataUrl="${dUrl}" postData="&dgPage.pageSize=65536" dataGridName="dg1488778215616" dtPage="dgPage"  hidekeyPrefix="dg1488778215616" hidekey="['id','version','product.id','product.productCode','product.id','product.productName','product.id','product.productBaseUnit.name','product.id','product.id'${cpObjHideKey!''}]" transMethod="post" paginator=false editable=true buttons="${buttons}"  canImportExcel=canImportExcel noPadding=true isEdit=true tabViewIndex=0 pageInitMethod="dg1488778215616PageInitMethod"  defaultNodeExpanded=nodeExpanded  cannotAddNewRow=true cannotDeleteRow=false assModelDisplayName=assModelDisplayName  activexButton="" exportExcel=exportExcel addNewRow=false   canInsertRow=false  insertRowAble=true firstLoad=firstLoad  copyRow=false  copyColumn=false  ptRealTimeLoad=0 >		
							<#assign name_displayDefaultType=''>
								<#assign name_defaultValue=''>
										<#assign name_defaultValue=''>
										  
									<@datacolumn key="name"        showFormat="TEXT" defaultValue="${(name_defaultValue!)?string}" defaultDisplay="${(name_displayDefaultType!)?string}" decimal="" editable=true type="textfield" showType="textfield" notnull=true     textalign="left"  viewUrl="" viewCode="" mneenable=false crossCompany=false viewTitle="${getText('')}"  label="${getText('RM.propertydisplayName.randon148781144242123')}" width=100 showFormatFunc=""  />
							<#assign exeSystem_displayDefaultType=''>
								<#assign exeSystem_defaultValue='RMsystem/system2'>
										 
									<@systemCodeColumn code="RMsystem" textalign="left" defaultValue="${(exeSystem_defaultValue!)?string}" key="exeSystem.id" editable=true type="selectcomp" notnull=true    onchange="FormulaMixtureActive_dg1488778215616Widget.evalCustomFunction(nRow,sFieldName,'systemCallback(nRow,sFieldName)')"  label="${getText('RM.propertydisplayName.randon149061416353245')}" width=80   />
							<#assign batchSite_displayDefaultType=''>
								<#assign batchSite_defaultValue='batchSite/batchSet1'>
										 
									<@systemCodeColumn code="batchSite" textalign="left" defaultValue="${(batchSite_defaultValue!)?string}" key="batchSite.id" editable=false type="selectcomp" notnull=true    onchange="FormulaMixtureActive_dg1488778215616Widget.evalCustomFunction(nRow,sFieldName,'batchSetChange(nRow,sFieldName)')"  label="${getText('RM.propertydisplayName.randon1487811905250')}" width=80   />
							...
							<#elseif (product_productCode_defaultValue!)?string=="currentComp">
								<#assign product_productCode_defaultValue='${compJson!}'>
									...
									<@datacolumn key="product.productCode"        showFormat="SELECTCOMP" defaultValue="${(product_productCode_defaultValue!)?string}" defaultDisplay="${(product_productCode_displayDefaultType!)?string}" decimal="" editable=true type="selectcomp" showType="selectcomp" notnull=true  callbackname="goodCallback(obj)" selectCompName="RM.formula.formulaProcessActive.manualActiveEdit"  textalign="left"  viewUrl="/MESBasic/product/product/refProductLayout.action" viewCode="MESBasic_1_product_refProductLayout" mneenable=true crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1450085069587')}"  label="${getText('MESBasic.propertydisplayName.radion1415772644833')}" width=100 showFormatFunc=""  />
							...
							<#elseif (product_productName_defaultValue!)?string=="currentComp">
								<#assign product_productName_defaultValue='${compJson!}'>
									...
									<@datacolumn key="product.productName"        showFormat="TEXT" defaultValue="${(product_productName_defaultValue!)?string}" defaultDisplay="${(product_productName_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="RM.formula.formulaProcessActive.manualActiveEdit"  textalign="left"  viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('MESBasic.propertydisplayName.radion1415772740737')}" width=100 showFormatFunc=""  />
							...
							<#elseif (product_productBaseUnit_name_defaultValue!)?string=="currentComp">
								<#assign product_productBaseUnit_name_defaultValue='${compJson!}'>
									...
									<@datacolumn key="product.productBaseUnit.name"        showFormat="TEXT" defaultValue="${(product_productBaseUnit_name_defaultValue!)?string}" defaultDisplay="${(product_productBaseUnit_name_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="RM.formula.formulaProcessActive.manualActiveEdit"  textalign="left"  viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('RM.propertydisplayName.radion1398235640483232')}" width=60 showFormatFunc=""  />
							...
							<#assign formulaType_displayDefaultType=''>
								<#assign formulaType_defaultValue='activeType/activeType2'>
										 									<@systemCodeColumn code="activeType" textalign="center" defaultValue="${(formulaType_defaultValue!)?string}" key="formulaType.id" editable=true type="selectcomp" notnull=false     label="${getText('RM.propertydisplayName.randon1487811825429')}" width=60 hiddenCol=true  />
							...
							<#elseif (product_id_defaultValue!)?string=="currentComp">
								<#assign product_id_defaultValue='${compJson!}'>
									...
									<@datacolumn key="product.id"        showFormat="TEXT" defaultValue="${(product_id_defaultValue!)?string}" defaultDisplay="${(product_id_displayDefaultType!)?string}" decimal="" editable=false type="long" showType="long" notnull=false   selectCompName="RM.formula.formulaProcessActive.manualActiveEdit"  textalign="center" hiddenCol=true viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('MESBasic.propertydisplayName.randon1449796384550')}" width=100 showFormatFunc=""  />
							<#assign formulaHiddenId_displayDefaultType=''>
								<#assign formulaHiddenId_defaultValue=''>
										<#assign formulaHiddenId_defaultValue=''>
										  
									<@datacolumn key="formulaHiddenId"        showFormat="TEXT" defaultValue="${(formulaHiddenId_defaultValue!)?string}" defaultDisplay="${(formulaHiddenId_displayDefaultType!)?string}" decimal="" editable=true type="long" showType="long" notnull=false     textalign="center" hiddenCol=true viewUrl="" viewCode="" mneenable=false crossCompany=false viewTitle="${getText('')}"  label="${getText('RM.propertydisplayName.randon1488873301480')}" width=100 showFormatFunc=""  />
							<#assign processTableId_displayDefaultType=''>
								<#assign processTableId_defaultValue=''>
										<#assign processTableId_defaultValue=''>
										  
									<@datacolumn key="processTableId"        showFormat="TEXT" defaultValue="${(processTableId_defaultValue!)?string}" defaultDisplay="${(processTableId_displayDefaultType!)?string}" decimal="" editable=true type="long" showType="long" notnull=false     textalign="center" hiddenCol=true viewUrl="" viewCode="" mneenable=false crossCompany=false viewTitle="${getText('')}"  label="${getText('RM.propertydisplayName.randon1488873435539')}" width=120 showFormatFunc=""  />
							<#assign processHiddenId_displayDefaultType=''>
								<#assign processHiddenId_defaultValue=''>
										<#assign processHiddenId_defaultValue=''>
										  
									<@datacolumn key="processHiddenId"     isCount=true   showFormat="TEXT" defaultValue="${(processHiddenId_defaultValue!)?string}" defaultDisplay="${(processHiddenId_displayDefaultType!)?string}" decimal="" editable=true type="long" showType="long" notnull=false     textalign="center" hiddenCol=true viewUrl="" viewCode="" mneenable=false crossCompany=false viewTitle="${getText('')}"  label="${getText('RM.propertydisplayName.randon1488873393499')}" width=100 showFormatFunc=""  />
			...
			<script type="text/javascript">
				function FormulaMixtureActive_dg1488778215616_check_datagridvalid(){
					//
					var errorObj =FormulaMixtureActive_dg1488778215616Widget._DT.testData();
					var errorContent='';
					if(errorObj!=null){
				...
				function savedg1488778215616DataGrid(){
					<#if  refId?? && (refId gt 0)>
					FormulaMixtureActive_dg1488778215616Widget.setAllRowEdited();
					</#if>
					// 针对需要全部更新的PT，把pt Id存到body的CHANGED_PT中，保存时，会自动保存全部数据
					var changed_pt_name = $('body').data('CHANGED_PT');
					if(changed_pt_name && changed_pt_name.indexOf('FormulaMixtureActive_dg1488778215616Widget') > -1) {
						FormulaMixtureActive_dg1488778215616Widget.setAllRowEdited();
					}
					var json = FormulaMixtureActive_dg1488778215616Widget.parseEditedData();
					$('input[name="dg1488778215616ListJson"]').remove();
					$('input[name="dgLists[\'dg1488778215616\']"]').remove();
					$('input[name="dg1488778215616ModelCode"]').remove();
					$('<input type="hidden" name="dgLists[\'dg1488778215616\']">').val(json).appendTo($('#RM_formula_formulaProcessActive_manualActiveEdit_form'));
					$('<input type="hidden" name="dg1488778215616ModelCode">').val('RM_7.5.0.0_formula_FormulaMixtureActive').appendTo($('#RM_formula_formulaProcessActive_manualActiveEdit_form'));
					//兼容旧版本提交函数
					$('<input type="hidden" name="dg1488778215616ListJson">').val(json).appendTo($('#RM_formula_formulaProcessActive_manualActiveEdit_form'));
				}
				function DT_FormulaMixtureActive_dg1488778215616_deldatagrid(){
					var deleteRows = FormulaMixtureActive_dg1488778215616Widget.deleteRows();
					...
					$.each(deleteRows, function(index, deleteRow){
						...
						if($("#dg1488778215616DeletedIds").length>0){
							$("#dg1488778215616DeletedIds")[0].value+=","+tepID;
						}else{
							CUI('<input type="hidden" id="dg1488778215616DeletedIds" name="dgDeletedIds[\'dg1488778215616\']" value="'+tepID+'">').appendTo(CUI('#RM_formula_formulaProcessActive_manualActiveEdit_form'));
						}
						//兼容旧版本提交函数
						CUI('<input type="hidden" name="dg1488778215616DeletedIds['+CUI('input[name^="dg1488778215616DeletedIds"]').length+']'+'" value="'+tepID+'">').appendTo(CUI('#RM_formula_formulaProcessActive_manualActiveEdit_form'));
					});
					return deleteRows;
				}
				function DT_FormulaMixtureActive_dg1488778215616_delTreeNodes(){
					var deleteRows = FormulaMixtureActive_dg1488778215616Widget._DT.removeTreeNode();
					if(!deleteRows || deleteRows.length == 0) {
						return false;
					}
					var delproperty = "'id','version','processActiveId.id','product.id'";
				...
				$(function($){
					var datagrids = $('body').data('RM_formula_formulaProcessActive_manualActiveEdit_datagrids');
					if(!datagrids) {
						datagrids = [];
					}
					for(var i=0;i<1;i++) {
					...
					if(datagrids[0].length>0) {
						for(var i=0;i<datagrids[0].length;i++) {
							if(datagrids[0][i] == 'FormulaMixtureActive_dg1488778215616') {
								break;
							}
							if(i==datagrids[0].length-1) {
								datagrids[0][datagrids[0].length] = 'FormulaMixtureActive_dg1488778215616';
							}
						}
					} else {
						datagrids[0][datagrids[0].length] = 'FormulaMixtureActive_dg1488778215616';
					}
					$('body').data('RM_formula_formulaProcessActive_manualActiveEdit_datagrids', datagrids);
				});
				
				var FormulaMixtureActive_dg1488778215616_importDialog = null;
				function FormulaMixtureActive_dg1488778215616_showImportDialog(){
					try{
						if(FormulaMixtureActive_dg1488778215616_importDialog!=null&&FormulaMixtureActive_dg1488778215616_importDialog.isShow==1){
							return false;
						}
						var url = "/RM/formula/formulaProcessActive/initImport.action?datagridCode=RM_7.5.0.0_formula_manualActiveEditdg1488778215616&tid=${id!}&datagridName=dg1488778215616";
							<#if canImportExcel>
								var buttonCode="RM_7.5.0.0_formula_manualActiveEditdg1488778215616_BUTTON_dgImport";
								url+="&buttonCode="+buttonCode;
							</#if>
						FormulaMixtureActive_dg1488778215616_importDialog = new CUI.Dialog({
							...
							width: '420',
							dragable:true,
							buttons:[{id:"import",name:"${getHtmlText('common.button.import')}",handler:function(){var dg = eval("FormulaMixtureActive_dg1488778215616"+"Widget");if(dg && dg.checkEdited && dg.checkEdited()){CUI.Dialog.alert("${getHtmlText('ec.view.unsavedgdata')}");}else{foundation.importExcel.submitImportForm();}}},{name:"${getHtmlText('common.button.cancel')}",id:"close",handler:function(){setTimeout(function(){$('#importResponse').remove();FormulaMixtureActive_dg1488778215616_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.Confirm')}",id:"ok",display:'hidden',handler:function(){setTimeout(function(){$('#importResponse').remove();FormulaMixtureActive_dg1488778215616_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.back')}",id:"tback",display:'hidden',handler:function(){tback();}}],
							beforeCloseEvent:function(){$('#importResponse').remove();}
						});
						FormulaMixtureActive_dg1488778215616_importDialog.show();
					}catch(e){}
				}	
				
				function FormulaMixtureActive_dg1488778215616_downLoadFile(){
					var url = "/RM/formula/formulaProcessActive/downLoad.action?datagridCode=RM_7.5.0.0_formula_manualActiveEditdg1488778215616&templateRelatedModelCode=RM_7.5.0.0_formula_manualActiveEditdg1488778215616&downloadType=template&fileName=dg1488778215616";
					window.open(url,"","");
				}
				function dg1488778215616RenderOverEvent(){
					var length=FormulaMixtureActive_dg1488778215616Widget.getRowLength();
if(Number(length)==0){
		FormulaMixtureActive_dg1488778215616Widget._DT.addNewRow();
}
FormulaMixtureActive_dg1488778215616Widget.setCellValue(0,'saveFlag',true);
FormulaMixtureActive_dg1488778215616Widget.setCellValue(0,'processHiddenId',$("input[name='formulaProcess.formId']").val());
FormulaMixtureActive_dg1488778215616Widget.setCellValue(0,'processTableId',$("input[name='formulaProcess.processTableId']").val());
FormulaMixtureActive_dg1488778215616Widget.setCellValue(0,'formulaHiddenId',$('input[name="formulaProcess.formulaHideId"]').val());


//替代数量
var isPlace=FormulaMixtureActive_dg1488778215616Widget.getCellValue(0,'isPlace');
//固定数量
var mixQua=FormulaMixtureActive_dg1488778215616Widget.getCellValue(0,'isMixQuality');
//如果替代数量为true
if(isPlace==true){
FormulaMixtureActive_dg1488778215616Widget._DT.setCellValue(0,'isMixQuality',true);

		FormulaMixtureActive_dg1488778215616Widget._DT.setCellProperty(0,'standardQuantity','readonly',true);
   			 FormulaMixtureActive_dg1488778215616Widget._DT.setCellValue(0,'standardQuantity',0);
}
				}
				function dg1488778215616PageInitMethod(nTabIndex){
					RM.formula.formulaProcessActive.manualActiveEdit.initSize(nTabIndex);
				}
			</script>
...
<!-- CUSTOM CODE START(view-EDIT-RM_7.5.0.0_formula_manualActiveEdit,html,RM_7.5.0.0_formula_FormulaProcessActive,RM_7.5.0.0) -->
<!-- 自定义代码 -->

<!-- CUSTOM CODE END -->
<script type="text/javascript" src="/bap/static/signature/${lang!}/signature.js"></script>
<script type="text/javascript">
	RM.formula.formulaProcessActive.manualActiveEdit.beforeSaveProcess = function(){}
	RM.formula.formulaProcessActive.manualActiveEdit.beforeSubmitMethod = function() {
		try{eval("savedg1488778215616DataGrid()");}catch(e){}
		try{eval('beforeSubmitUploadForm()');}catch(e){}
		try{if(RM.formula.formulaProcessActive.manualActiveEdit.beforeSubmitMethodSettingInPage()==false) return false;}catch(e){}

		var extraCol = '<extra-data>';
		$('#RM_formula_formulaProcessActive_manualActiveEdit_form').trigger('beforeSubmit');
	...
	(function($){
		...
		$(function(){
			$("#RM_formula_formulaProcessActive_manualActiveEdit_form ul.edit-tabs").tabs("div.edit-panes > div");
			$('#RM_formula_formulaProcessActive_manualActiveEdit_form').get(0).onkeydown=function(event){event=event?event:window.event;if(event.keyCode==13){return false}};
		});
	})(jQuery);
	RM.formula.formulaProcessActive.manualActiveEdit.validate = function(){
		return true;
	}
	
	
	//打印
	RM.formula.formulaProcessActive.manualActiveEdit.print = function(url){
		...
		RM.formula.formulaProcessActive.manualActiveEdit.saveSetting = function(){
		...
		RM.formula.formulaProcessActive.manualActiveEdit.printSetting = function(){
			...
			RM.formula.formulaProcessActive.manualActiveEdit.settingDialog = new CUI.Dialog({
					...
					buttons:[
							{	name:"${getText("ec.flow.save")}",
								handler:function(){if(RM.formula.formulaProcessActive.manualActiveEdit.saveSetting()){this.close();}isPrintSettingDialogShow = false;}
							},
							{	name:"${getText("ec.flow.cancal")}",
								handler:function(){this.close();isPrintSettingDialogShow = false;}
							}]
				})
				RM.formula.formulaProcessActive.manualActiveEdit.settingDialog.show();
	...
	function dataGridBtnImgClick(sUrl,objNameCustomCondition,sTitle,sPTGridID,nRow,sFieldName,oGrid,customCallBack,crossCompany){
		...
		if(customCallBack){
			RM.formula.formulaProcessActive.manualActiveEdit._customCallBack = customCallBack;
		}
		RM.formula.formulaProcessActive.manualActiveEdit._selectEvent(objNameCustomCondition,null,sUrl,sTitle,null,null,null,crossCompany,obj);
	}
	function setUpload(params){
			if($('#RM_formula_formulaProcessActive_manualActiveEdit_fileupload').length == 0) {
				$('body').append('<div id="RM_formula_formulaProcessActive_manualActiveEdit_fileupload"></div>');
			}
			RM.formula.formulaProcessActive.manualActiveEdit.infoDialog = new CUI.Dialog({
				title: "${getText("ec.view.info.view")}",
				elementId : "RM_formula_formulaProcessActive_manualActiveEdit_fileupload",
				modal:true,
				height:330,
				width: 460,
				buttons:[
			...
			var dialogId = $('#RM_formula_formulaProcessActive_manualActiveEdit_fileupload_button').parents('div[id^=dialog_]:first').attr('id');
			RM.formula.formulaProcessActive.manualActiveEdit.infoDialog.show();
			if($('#RM_formula_formulaProcessActive_manualActiveEdit_fileupload').html() == '') {
				$('#RM_formula_formulaProcessActive_manualActiveEdit_fileupload').load("/foundation/workbench/fileupload-dialog-init.action?linkId=" + params.operateRecordId + "&type=RM_formula_formulaProcessActive&entityCode=RM_7.5.0.0_formula&dialogId="+dialogId);
			}
		}
	//参照复制函数
	RM.formula.formulaProcessActive.manualActiveEdit.referenceCopy = function(objName,url, dialog){
		var callbackName ="RM.formula.formulaProcessActive.manualActiveEdit.referenceCopyBackInfo";
		RM.formula.formulaProcessActive.manualActiveEdit.dialog = dialog;
		RM.formula.formulaProcessActive.manualActiveEdit._dialog = foundation.common.select({
			pageType : 'other',
			closePage : true,
	...
	RM.formula.formulaProcessActive.manualActiveEdit.referenceCopyBackInfo = function(obj){
		if(RM.formula.formulaProcessActive.manualActiveEdit._dialog){
			RM.formula.formulaProcessActive.manualActiveEdit._dialog.close();
		}
		<#if (Parameters.openType)?? && (Parameters.openType) == 'frame'>
		
		<#else>
		createLoadPanel(false,RM.formula.formulaProcessActive.manualActiveEdit.dialog._el);
		</#if>
		
		var value = document.getElementById("id").value;
		<#if viewType != "readonly">
		if(isFormChanged('RM_formula_formulaProcessActive_manualActiveEdit_form','RM_formula_formulaProcessActive_manualActiveEdit_datagrids')){
			CUI.Dialog.confirm("${getText('ec.view.losedata')}", function(){	
				$(RM.formula.formulaProcessActive.manualActiveEdit.dialog._el).html("<table style='width:100%;height:100%;text-align:center;'><tr><td><label class='datagrid-loading'>${getHtmlText("ec.view.loading")}</label></td></tr></table>");
				CUI(RM.formula.formulaProcessActive.manualActiveEdit.dialog._el).load('/RM/formula/formulaProcessActive/manualActiveEdit.action?id=' + value +'&refId='+obj[0].id+"&__pc__=${(Parameters.__pc__)!}",null,function(){
						closeLoadPanel();
						try{
							StrutsUtilsOnLoad();
						}catch(e){}
			...
			<#if (Parameters.openType)?? && (Parameters.openType) == 'frame'>
			parent.$( RM.formula.formulaProcessActive.manualActiveEdit.dialog._el ).append( '<table id="dialog-iframe-loading" style="position:absolute;left:0;top:-20px;width:100%;height:100%;text-align:center;"><tr><td><label class="datagrid-loading">正在加载...</label></td></tr></table>' );
			parent.$( '#' + RM.formula.formulaProcessActive.manualActiveEdit.dialog._config.iframe, RM.formula.formulaProcessActive.manualActiveEdit.dialog._dialog ).prop( 'src', '/RM/formula/formulaProcessActive/manualActiveEdit.action?id=' + value +'&refId='+obj[0].id+"&__pc__=${(Parameters.__pc__)!}" + '&openType=frame' );
			<#else>
			$(RM.formula.formulaProcessActive.manualActiveEdit.dialog._el).html("<table style='width:100%;height:100%;text-align:center;'><tr><td><label class='datagrid-loading'>${getHtmlText("ec.view.loading")}</label></td></tr></table>");
			CUI(RM.formula.formulaProcessActive.manualActiveEdit.dialog._el).load('/RM/formula/formulaProcessActive/manualActiveEdit.action?id=' + value +'&refId='+obj[0].id+"&__pc__=${(Parameters.__pc__)!}",null,function(){
					closeLoadPanel();
	...
	RM.formula.formulaProcessActive.manualActiveEdit.initMnemonic_DG_IE = function(oConfig){
		var oGrid = oConfig.oGrid;
		// 获取控件PT  object
		var oPTGridEx = oGrid._DT || oGrid;
		// 存储当前操作相关信息
		RM.formula.formulaProcessActive.manualActiveEdit.gridEventObj = {
			"oGrid" : oGrid,
			"nRow" : oConfig.nRow - 1,
			"sKey":	oConfig.sFieldName
		}
		RM.formula.formulaProcessActive.manualActiveEdit._sUrl = oConfig.url;
		if(oConfig.customCallBack){
			RM.formula.formulaProcessActive.manualActiveEdit._customCallBack = oConfig.customCallBack;
		}
		// 自定义的表格对象
	...
	RM.formula.formulaProcessActive.manualActiveEdit._selectEvent = function(objName,_selectType,url,title,refparam,obj,customCallBack,crossCompanyFlag,gridEventObj,oGrid,isMultiselect){
		var extraFrameParam = objName.replace(/\./g, '_');
		var frameName = 'RM_formula_formulaProcessActive_manualActiveEdit' + '_' + extraFrameParam;
		var callbackName="";
		RM.formula.formulaProcessActive.manualActiveEdit._prefix = '';
		RM.formula.formulaProcessActive.manualActiveEdit._oGrid = oGrid;
		RM.formula.formulaProcessActive.manualActiveEdit._sUrl = url;
		if(customCallBack){
			RM.formula.formulaProcessActive.manualActiveEdit._customCallBack = customCallBack;
		}
		var arr = objName.split('.');
		if(gridEventObj) {
			RM.formula.formulaProcessActive.manualActiveEdit.gridEventObj = gridEventObj;
			callbackName = "RM.formula.formulaProcessActive.manualActiveEdit.getcallBackInfo_DG_IE";
		}else if(obj!=null && obj!=""){
			if(arr.length > 1){
				RM.formula.formulaProcessActive.manualActiveEdit._prefix = '.'+ arr[0];
			}
			callbackName = isMultiselect ? "RM.formula.formulaProcessActive.manualActiveEdit.getMultiselectCallBackInfo_DG" : "RM.formula.formulaProcessActive.manualActiveEdit.getcallBackInfo_DG";
			RM.formula.formulaProcessActive.manualActiveEdit._currRow = obj.parentNode.parentNode.parentNode;
		}else{
			if(arr.length > 2){
				RM.formula.formulaProcessActive.manualActiveEdit._prefix = '.'+ arr[0] + '.'+ arr[1];
			}
			callbackName ="RM.formula.formulaProcessActive.manualActiveEdit.getcallBackInfo";
		}
		if(RM.formula.formulaProcessActive.manualActiveEdit._prefix!=''){
			RM.formula.formulaProcessActive.manualActiveEdit._prefix = RM.formula.formulaProcessActive.manualActiveEdit._prefix.substring(1);
		}
		if(RM.formula.formulaProcessActive.manualActiveEdit._querycustomFunc(objName.replace(/\./g, '_')) != null) {
			if(refparam != null && refparam != "") {
				refparam += '&';
			} else {
			    refparam = '';
			}
			refparam += 'condition=' + encodeURIComponent(RM.formula.formulaProcessActive.manualActiveEdit._querycustomFunc(objName.replace(/\./g, '_')));
		}
		if(typeof RM.formula.formulaProcessActive.manualActiveEdit._querycustomFuncN == "function") {
				refparam += RM.formula.formulaProcessActive.manualActiveEdit._querycustomFuncN();
		}
	...
	RM.formula.formulaProcessActive.manualActiveEdit._querycustomFunc = function(obj) {
		var str = eval("typeof(RM.formula.formulaProcessActive.manualActiveEdit.query_"+obj+")!='undefined'") ? eval('RM.formula.formulaProcessActive.manualActiveEdit.query_'+obj+'()') : null;
		return str;
	
	};
	
	RM.formula.formulaProcessActive.manualActiveEdit.getcallBackInfo = function(obj){
		obj[0] = foundation.common.getObject('RM_formula_formulaProcessActive_manualActiveEdit_form',obj[0], RM.formula.formulaProcessActive.manualActiveEdit._prefix, RM.formula.formulaProcessActive.manualActiveEdit._sUrl);
		CUI.commonFills('RM_formula_formulaProcessActive_manualActiveEdit_form',RM.formula.formulaProcessActive.manualActiveEdit._prefix,obj[0]);

		try{
			if(RM.formula.formulaProcessActive.manualActiveEdit._customCallBack) {
				eval(RM.formula.formulaProcessActive.manualActiveEdit._customCallBack);
				RM.formula.formulaProcessActive.manualActiveEdit._customCallBack = null;
			}
	...
	// 控件版PT回调
	RM.formula.formulaProcessActive.manualActiveEdit.getcallBackInfo_DG_IE = function(obj){
		if(RM.formula.formulaProcessActive.manualActiveEdit._customBeforeCallBack) {
			var flag = eval(RM.formula.formulaProcessActive.manualActiveEdit._customBeforeCallBack.split("(")[0] + "(obj)");
			if(flag === false){
				return false;
			}
		}
		var gridEventObj = RM.formula.formulaProcessActive.manualActiveEdit.gridEventObj;
		var rootKey = gridEventObj.sKey.split('.')[0];
		var jsonObj = foundation.common.getObjectIE(gridEventObj,obj[0],rootKey,RM.formula.formulaProcessActive.manualActiveEdit._sUrl);
	...
	RM.formula.formulaProcessActive.manualActiveEdit.getcallBackInfo_DG = function(obj){
		if(RM.formula.formulaProcessActive.manualActiveEdit._customBeforeCallBack) {
			var flag = eval(RM.formula.formulaProcessActive.manualActiveEdit._customBeforeCallBack.split("(")[0] + "(obj)");
			if(flag === false){
				return false;
		...
		for(var i=0;i<obj.length;i++){
			if(i>0){
				if($(RM.formula.formulaProcessActive.manualActiveEdit._currRow).next().length==0){
					RM.formula.formulaProcessActive.manualActiveEdit._oGrid.addNewRow();
				}	
				RM.formula.formulaProcessActive.manualActiveEdit._currRow = $(RM.formula.formulaProcessActive.manualActiveEdit._currRow).next();
				$(RM.formula.formulaProcessActive.manualActiveEdit._currRow).attr('isEdited',true);
			}
			obj[i] = foundation.common.getObject(RM.formula.formulaProcessActive.manualActiveEdit._currRow,obj[i],RM.formula.formulaProcessActive.manualActiveEdit._prefix,RM.formula.formulaProcessActive.manualActiveEdit._sUrl);
			eval("CUI.commonFills_DG(RM.formula.formulaProcessActive.manualActiveEdit._currRow,RM.formula.formulaProcessActive.manualActiveEdit._prefix,obj[i],RM.formula.formulaProcessActive.manualActiveEdit._oGrid)");
		}
		try{
			if(RM.formula.formulaProcessActive.manualActiveEdit._customCallBack) {
				eval(RM.formula.formulaProcessActive.manualActiveEdit._customCallBack);
	...
	RM.formula.formulaProcessActive.manualActiveEdit.getMultiselectCallBackInfo_DG = function(obj){
		for(var i=0;i<obj.length;i++){
			CUI.commonFillsMultiselect_DG(RM.formula.formulaProcessActive.manualActiveEdit._oGrid, RM.formula.formulaProcessActive.manualActiveEdit._currRow, RM.formula.formulaProcessActive.manualActiveEdit._key, RM.formula.formulaProcessActive.manualActiveEdit._displayFieldName, obj[i])
		}
		try{
			if(RM.formula.formulaProcessActive.manualActiveEdit._customCallBack) {
				eval(RM.formula.formulaProcessActive.manualActiveEdit._customCallBack);
	...
	RM.formula.formulaProcessActive.manualActiveEdit.generateInput = function(prefix, obj) {
		CUI.each(obj, function(key,value){
        	if(value!=null && key!='rowHtmlObj' && key!='cellHtmlObj'){
        		var name = prefix + '.' + key;
        		if(typeof value == 'object') {
        			RM.formula.formulaProcessActive.manualActiveEdit.generateInput(name, value);
        		} else {
        			if(value!=null&&value!='null'&&value!=undefined&&value!='') {
            			CUI('input[name="' + name + '"]').remove();
            			CUI('<input type="hidden" name="'+name+'" value="'+value+'">').appendTo(CUI('#RM_formula_formulaProcessActive_manualActiveEdit_form'));
        			}
        	   	}
        	}
      	});
...
$('input[name="formulaProcessActive.activeType.value"]').val('手工投配料');
//活动名称
...
if($('#formulaProcessActive_batchPhaseID').val() != ''){
	...
	RM.formula.formulaProcessActive.manualActiveEdit.beforeSubmitMethodSettingInPage = function(){
		//名称不能为空
if($("#formulaProcessActive_name").val()==""){
   RM_formula_formulaProcessActive_manualActiveEdit_formDialogErrorBarWidget.showMessage("${getText('RM.fomula.radon1487074975311')}");
   return false;
}

//投料顺序
if($('input[name="formulaProcessActive.actOrder"]').val()=='' ){
    RM_formula_formulaProcessActive_manualActiveEdit_formDialogErrorBarWidget.showMessage("${getText('RM.fomula.radon1487074234278922')}");
	return false;
}
//表体活动名称
var activeName=FormulaMixtureActive_dg1488778215616Widget.getCellValue(0,'name');
//表体中活动名称不能为空

if(activeName==undefined || activeName==''){
   RM_formula_formulaProcessActive_manualActiveEdit_formDialogErrorBarWidget.showMessage("${getText('RM.fomula.radon1487072324')}");
   return false;
}
...
var mixQua=FormulaMixtureActive_dg1488778215616Widget.getCellValue(0,'isMixQuality')+'';
//单位数量
var standQua=FormulaMixtureActive_dg1488778215616Widget.getCellValue(0,'standardQuantity');
//上限
var maxQua=FormulaMixtureActive_dg1488778215616Widget.getCellValue(0,'maxQuality');
//下限
var minQua=FormulaMixtureActive_dg1488778215616Widget.getCellValue(0,'minQuality');
//物品编码
var productCode=FormulaMixtureActive_dg1488778215616Widget.getCellValue(0,'product.productCode');
//配料系统
var exeSystem = FormulaMixtureActive_dg1488778215616Widget.getCellValue(0,'exeSystem.id');
//配料系统不允许为空
if(exeSystem=='' || exeSystem==undefined){
	RM_formula_formulaProcessActive_manualActiveEdit_formDialogErrorBarWidget.showMessage("表体中配料系统不允许为空！");
	return false;
}
//物品不允许为空
if(productCode=='' || productCode==undefined){
	RM_formula_formulaProcessActive_manualActiveEdit_formDialogErrorBarWidget.showMessage("表体中物品不允许为空！");
	return false;
}

//单位数量不允许为空
if(standQua=='' || standQua==undefined){
	RM_formula_formulaProcessActive_manualActiveEdit_formDialogErrorBarWidget.showMessage("表体中单位数量不允许为空！");
	return false;
}
	};
...
<script type="text/javascript">
	...
	var panesHeight;
	var thisHeight;
	RM.formula.formulaProcessActive.manualActiveEdit.initCount = 0;
	RM.formula.formulaProcessActive.manualActiveEdit.initSize = function(nTabIndex){
		var panesHeight;
		var thisHeight;
		<#if (Parameters.openType)?? && (Parameters.openType) == 'frame'>
		var h = $(window.frameElement).parents('div.content').first().height();
		<#else>
		var h = $('#RM_manualActiveEdit_edit_div').parents('div.content').first().height();
		</#if>
		var datagrids = $('body').data('RM_formula_formulaProcessActive_manualActiveEdit_datagrids');	
		var	conHeight = h-$("#RM_formula_formulaProcessActive_manualActiveEdit_main_div .edit-tabs").outerHeight() - 6;
		panesHeight = conHeight*0.4;
		$("#RM_formula_formulaProcessActive_manualActiveEdit_main_div .edit-panes-s").each(function(index){
			//多页签切换时只计算本页签下的PT高度
				...
				if(datagrids[index].length > 0) {
					...
					for(var dg=0;dg<datagrids[index].length;dg++) {
						...
						if(dgwidget) {
							...
							if(RM.formula.formulaProcessActive.manualActiveEdit.initCount <= 2) {
								setTimeout(function(){RM.formula.formulaProcessActive.manualActiveEdit.initSize();}, 200);
								RM.formula.formulaProcessActive.manualActiveEdit.initCount++;
							}/* else {
								RM.formula.formulaProcessActive.manualActiveEdit.initCount = 0;
							}*/
						}
	...
	$(function(){
		RM.formula.formulaProcessActive.manualActiveEdit.initSize();
		$(".edit-tabs li").click(function(){
		    var index = $(this).index();
		    RM.formula.formulaProcessActive.manualActiveEdit.initSize(index);
		});
		$(window).bind("dialog.resize",function(){RM.formula.formulaProcessActive.manualActiveEdit.initSize();});
	});
</script>
<script type="text/javascript">
...
function isPlaceChange(nRow,sFieldName){
	...
	/* CUSTOM CODE START(view-EDIT-RM_7.5.0.0_formula_manualActiveEdit,js,RM_7.5.0.0_formula_FormulaProcessActive,RM_7.5.0.0) */
// 自定义代码
