...
<GridData DefaultNodeExpanded="false"   dgName="dg1488695660302" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<name
					...
					sort="false"  onPropertyChange="FormulaMixtureActive_dg1488695660302Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<exeSystem.id
						style="font-color:0303B3"
					sort="false"  onPropertyChange="FormulaMixtureActive_dg1488695660302Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				    onChange="FormulaMixtureActive_dg1488695660302Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);FormulaMixtureActive_dg1488695660302Widget.evalCustomFunction(nRow,sFieldName,'systemCallback(nRow,sFieldName)');"
				...
				<batchSite.id
						style="font-color:0303B3"
					sort="false"  onPropertyChange="FormulaMixtureActive_dg1488695660302Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				    onChange="FormulaMixtureActive_dg1488695660302Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);FormulaMixtureActive_dg1488695660302Widget.evalCustomFunction(nRow,sFieldName,'batchSetChange(nRow,sFieldName)');"
				...
				<product.productCode
						style="font-color:0303B3"
							onBlur="document.body.click()"
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(FormulaMixtureActive_dg1488695660302Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(FormulaMixtureActive_dg1488695660302Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/product/product/refProductLayout_kc.action','dg1488695660302product.productCode','${getText("MESBasic.viewtitle.randon1478746948423")}',sPTGridID,nRow,sFieldName,FormulaMixtureActive_dg1488695660302Widget,'productCallback(obj)',false,false,'','MESBasic_1_product_refProductLayout_kc')"
								onKeyUp="RM.formula.formulaProcessActive.channelActiveEdit.initMnemonic_DG_IE({
										'keyCode':Key,
										'oGrid':FormulaMixtureActive_dg1488695660302Widget,
										'sGridName':'FormulaMixtureActive_dg1488695660302Widget',
										'value':sParam,
										'nRow':nRow,
										...
										'funcname':'RM.formula.formulaProcessActive.channelActiveEdit.getcallBackInfo_DG_IE(obj)',
										'conditionfunc':'RM.formula.formulaProcessActive.channelActiveEdit._querycustomFunc(\'dg1488695660302product.productCode\'.replace(/\./g, \'_\'))'
				...
				<isPlace
					sort="false"  onPropertyChange="FormulaMixtureActive_dg1488695660302Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				    onChange="FormulaMixtureActive_dg1488695660302Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);FormulaMixtureActive_dg1488695660302Widget.evalCustomFunction(nRow,sFieldName,'isPlaceChange(nRow,sFieldName)');"
	...
	<tbody>
		...
		<row  onClick="FormulaMixtureActive_dg1488695660302Widget._DT._autoAddNewRow(nRow)" >
					<c>${(row.id)!}</c>
					<c>${(row.version)!}</c>
					<c>${(row.product.id)!}</c>
			<#if cpObjHideKey?? && cpObjHideKey?has_content>
