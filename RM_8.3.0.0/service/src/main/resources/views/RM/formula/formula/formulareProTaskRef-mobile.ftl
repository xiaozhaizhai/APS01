...
<script type="text/javascript">
	CUI.ns("RM.formula.formula","RM.formula.formula.formulareProTaskRef");
</script>
<div class="container"  style="padding-top:10px;">
	...
	<div id="ec_RM_formula_formula_formulareProTaskRef_queryForm_inputValue">
	...
	<form onsubmit="return false" id="ec_RM_formula_formula_formulareProTaskRef_queryForm" exportUrl="/RM/formula/formula/formulareProTaskRef-pending.action">
		...
		<input type="hidden" id="dataTableSortColOrder" name="dataTableSortColOrder" />
						<@quickquery unique="LAST_QUERY_ec_RM_formula_formula_formulareProTaskRef_queryForm" formId="ec_RM_formula_formula_formulareProTaskRef_queryForm" idprefix="ec_RM_formula_formula_formulareProTaskRef" expandType="all" expand=true fieldcodes="RM_7_5_0_0_formula_Formula_code_code:RM.propertydisplayName.randon1488246312092||RM_7_5_0_0_formula_Formula_name_name:RM.propertydisplayName.randon1487075823790||RM_7_5_0_0_formula_Formula_edition_edition:RM.propertydisplayName.randon1487139592239||MESBasic_1_product_Product_productCode_product_productCode:RM.propertydisplayName.radion1415772644833234||RM_7_5_0_0_formula_Formula_usedFor_usedFor:RM.propertydisplayName.randon1487076506987||RM_7_5_0_0_formula_Formula_state_state:RM.propertydisplayName.randon1487076473255||RM_7_5_0_0_formula_Formula_startTime_startTime:RM.propertydisplayName.randon1487076643939||RM_7_5_0_0_formula_Formula_endTime_endTime:RM.propertydisplayName.randon1487076706699||RM_7_5_0_0_formula_Formula_produceType_produceType:RM.propertydisplayName.randon1487076555894" >
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
											...
											<#if (code_defaultValue)?has_content>
												<@mneclient formId="ec_RM_formula_formula_formulareProTaskRef_queryForm" isPrecise=true isCrossCompany=isCrossCompany value="${code_defaultValue!}" deValue="${code_defaultValue!}"   conditionfunc="RM.formula.formula.formulareProTaskRef._querycustomFunc('code')" name="code" id="ec_RM_formula_formula_formulareProTaskRef_queryForm_code" displayFieldName="code" exp="equal" classStyle="form-control"  url="/RM/formula/formula/mneClient.action" multiple=false mnewidth=260 searchClick="RM.formula.formula.formulareProTaskRef.commonQuery('query')" />
											<#else>
												<@mneclient formId="ec_RM_formula_formula_formulareProTaskRef_queryForm" isPrecise=true isCrossCompany=isCrossCompany  conditionfunc="RM.formula.formula.formulareProTaskRef._querycustomFunc('code')" name="code" id="ec_RM_formula_formula_formulareProTaskRef_queryForm_code" displayFieldName="code" exp="equal" classStyle="form-control"  url="/RM/formula/formula/mneClient.action" multiple=false mnewidth=260 searchClick="RM.formula.formula.formulareProTaskRef.commonQuery('query')" />
											</#if>
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
											...
											<#if (name_defaultValue)?has_content>
												<@mneclient formId="ec_RM_formula_formula_formulareProTaskRef_queryForm" isPrecise=true isCrossCompany=isCrossCompany value="${name_defaultValue!}" deValue="${name_defaultValue!}"   conditionfunc="RM.formula.formula.formulareProTaskRef._querycustomFunc('name')" name="name" id="ec_RM_formula_formula_formulareProTaskRef_queryForm_name" displayFieldName="name" exp="like" classStyle="form-control"  url="/RM/formula/formula/mneClient.action" multiple=false mnewidth=260 searchClick="RM.formula.formula.formulareProTaskRef.commonQuery('query')" />
											<#else>
												<@mneclient formId="ec_RM_formula_formula_formulareProTaskRef_queryForm" isPrecise=true isCrossCompany=isCrossCompany  conditionfunc="RM.formula.formula.formulareProTaskRef._querycustomFunc('name')" name="name" id="ec_RM_formula_formula_formulareProTaskRef_queryForm_name" displayFieldName="name" exp="like" classStyle="form-control"  url="/RM/formula/formula/mneClient.action" multiple=false mnewidth=260 searchClick="RM.formula.formula.formulareProTaskRef.commonQuery('query')" />
											</#if>
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
											...
											<input type="hidden" id="product.id" name="product.id" value="" />
												<@mneclient mneenable=true isPrecise=true isCrossCompany=isCrossCompany reftitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  conditionfunc="RM.formula.formula.formulareProTaskRef._querycustomFunc('product_productCode')" name="product.productCode" id="ec_RM_formula_formula_formulareProTaskRef_queryForm_product_productCode" displayFieldName="productCode" type="other" exp="like" classStyle="form-control" url="/MESBasic/product/product/productRefNew.action" clicked=true multiple=false mnewidth=260 formId="ec_RM_formula_formula_formulareProTaskRef_queryForm" searchClick="RM.formula.formula.formulareProTaskRef.commonQuery('query')" />
							...
							<div mobi-dropdown-group="startTime" field-unique-code="RM_7_5_0_0_formula_Formula_startTime_startTime" class="mobi-dropdown col-xs-12 col-sm-6 col-md-4 col-lg-4 <#if (lastQuery.value)?? && lastQuery.value == "RM_7_5_0_0_formula_Formula_startTime_startTime">mobi-dropdown-active</#if>"> 
								<div class="row">
									...
									<div class="input-group">
										<span class="input-group-addon">${getText('ec.list.validate.start')}</span>
										<@datepicker type="dateTimeMin" cssClass="form-control right-border-radius" value="${startTime_defaultValue!}" deValue="${startTime_defaultValue!}"  name="startTime_start" id="startTime_start" exp="gequal"   formid="ec_RM_formula_formula_formulareProTaskRef_queryForm" />
									</div>
								</div>			
							</div>
						</div>
						<div mobi-dropdown-group="startTime" field-unique-code="RM_7_5_0_0_formula_Formula_startTime_startTime" class="mobi-dropdown col-xs-12 col-sm-6 col-md-4 col-lg-4 <#if (lastQuery.value)?? && lastQuery.value == "RM_7_5_0_0_formula_Formula_startTime_startTime">mobi-dropdown-active</#if>"> 
							<div class="row">
								...
								<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
									<div class="input-group">
										<span class="input-group-addon">${getText('ec.list.validate.end')}</span>	
										<@datepicker type="dateTimeMin" cssClass="form-control right-border-radius" value="${startTime_defaultValue!}" deValue="${startTime_defaultValue!}"  name="startTime_end" id="startTime_end" exp="lequal"   formid="ec_RM_formula_formula_formulareProTaskRef_queryForm" />
									</div>
									</div>			
								</div>
							</div>
							...
							<div mobi-dropdown-group="endTime" field-unique-code="RM_7_5_0_0_formula_Formula_endTime_endTime" class="mobi-dropdown col-xs-12 col-sm-6 col-md-4 col-lg-4 <#if (lastQuery.value)?? && lastQuery.value == "RM_7_5_0_0_formula_Formula_endTime_endTime">mobi-dropdown-active</#if>"> 
								<div class="row">
									...
									<div class="input-group">
										<span class="input-group-addon">${getText('ec.list.validate.start')}</span>
										<@datepicker type="dateTimeMin" cssClass="form-control right-border-radius" value="${endTime_defaultValue!}" deValue="${endTime_defaultValue!}"  name="endTime_start" id="endTime_start" exp="gequal"   formid="ec_RM_formula_formula_formulareProTaskRef_queryForm" />
									</div>
								</div>			
							</div>
						</div>
						<div mobi-dropdown-group="endTime" field-unique-code="RM_7_5_0_0_formula_Formula_endTime_endTime" class="mobi-dropdown col-xs-12 col-sm-6 col-md-4 col-lg-4 <#if (lastQuery.value)?? && lastQuery.value == "RM_7_5_0_0_formula_Formula_endTime_endTime">mobi-dropdown-active</#if>"> 
							<div class="row">
								...
								<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8 margin-bottom-5">
									<div class="input-group">
										<span class="input-group-addon">${getText('ec.list.validate.end')}</span>	
										<@datepicker type="dateTimeMin" cssClass="form-control right-border-radius" value="${endTime_defaultValue!}" deValue="${endTime_defaultValue!}"  name="endTime_end" id="endTime_end" exp="lequal"   formid="ec_RM_formula_formula_formulareProTaskRef_queryForm" />
									</div>
									</div>			
								</div>
							</div>
						...
						<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 margin-bottom-5">						
				       	<@querybutton formId="ec_RM_formula_formula_formulareProTaskRef_queryForm" type="search" onclick="RM.formula.formula.formulareProTaskRef.commonQuery('query')" /> 
...
<script>
	$(function(){
		var buttons = $( 'button.btn-list', '#ec_RM_formula_formula_formulareProTaskRef_queryForm' );
		if( buttons.length > 0 ){
			// 去掉按钮间的空格
...
ec_RM_formula_formula_formulareProTaskRef_quickquery_info["product.id"].columnName="ID";
...
<script type="text/javascript">
	 ...
	 */
	RM.formula.formula.formulareProTaskRef.query = function(type,pageNo){
		...
		if(!checkListValid("ec_RM_formula_formula_formulareProTaskRef_queryForm")) {
				return false;
		}
		var dataPost = "";
		...
		url += "&crossCompanyFlag=${Parameters.crossCompanyFlag!}";
	 	datatable_ec_RM_formula_formula_formulareProTaskRef_query.setRequestDataUrl(url,dataPost);
		return false;
	};
	...
	foundation.common.${requestUri!}__callbackFunction = function(){
		...
		var oRows = datatable_ec_RM_formula_formula_formulareProTaskRef_query.getSelectedRow();
		if(oRows.length == 0){
		...
		try{
			if(CUI("#RM_formula_formula_formulareProTaskRef_callBackFuncName").val() != ""){
				eval(CUI("#RM_formula_formula_formulareProTaskRef_callBackFuncName").val() + "(arrObj)");
			}
		}catch(e){
		}
	};
...
RM_formula_formula_formulareProTaskRef_refresh = function(node){
	//var url = "/RM/formula/formula/formulareProTaskRef-query.action";
	//if(node.layRec){
	//	datatable_ec_RM_formula_formula_formulareProTaskRef_query.setRequestDataUrl(url,'&'+node.modelName+'.layRec=' + node.layRec,false);
	//}else{
	//	datatable_ec_RM_formula_formula_formulareProTaskRef_query.setRequestDataUrl(url,'',false);
	//}
...
RM.formula.formula.formulareProTaskRef.showLinkView = function(url,propertyId,row,formId,title,width,height,dialogType){
	...
	if(formId) {
		RM.formula.formula.formulareProTaskRef.showDialog(url,formId,title,width,height);
	}else {
		openFullScreen(url);
	}
};
...
function checkListValid(formId){if($('#' + formId + ' input[name^="edition_start"]').val()!= null && $('#' + formId + ' input[name^="edition_start"]').val()!= ''){if(!isDecimal($('#' + formId + ' input[name^="edition_start"]').val())){workbenchErrorBarWidget.showMessage("${getText('RM.propertydisplayName.randon1487139592239')}${getText('ec.list.validate.decimal')}");return false;}}if($('#' + formId + ' input[name^="edition_end"]').val()!= null && $('#' + formId + ' input[name^="edition_end"]').val()!= ''){if(!isDecimal($('#' + formId + ' input[name^="edition_end"]').val())){workbenchErrorBarWidget.showMessage("${getText('RM.propertydisplayName.randon1487139592239')}${getText('ec.list.validate.decimal')}");return false;}}if($('#' + formId + ' input[name^="startTime_start"]').val()!= null && $('#' + formId + ' input[name^="startTime_start"]').val()!= ''){if(!isDateTime($('#' + formId + ' input[name^="startTime_start"]').val()+"")){workbenchErrorBarWidget.showMessage("${getText('RM.propertydisplayName.randon1487076643939')}${getText('ec.list.validate.datetime')}");return false;}}if($('#' + formId + ' input[name^="startTime_end"]').val()!= null && $('#' + formId + ' input[name^="startTime_end"]').val()!= ''){if(!isDateTime($('#' + formId + ' input[name^="startTime_end"]').val()+"")){workbenchErrorBarWidget.showMessage("${getText('RM.propertydisplayName.randon1487076643939')}${getText('ec.list.validate.datetime')}");return false;}}if($('#' + formId + ' input[name^="endTime_start"]').val()!= null && $('#' + formId + ' input[name^="endTime_start"]').val()!= ''){if(!isDateTime($('#' + formId + ' input[name^="endTime_start"]').val()+"")){workbenchErrorBarWidget.showMessage("${getText('RM.propertydisplayName.randon1487076706699')}${getText('ec.list.validate.datetime')}");return false;}}if($('#' + formId + ' input[name^="endTime_end"]').val()!= null && $('#' + formId + ' input[name^="endTime_end"]').val()!= ''){if(!isDateTime($('#' + formId + ' input[name^="endTime_end"]').val()+"")){workbenchErrorBarWidget.showMessage("${getText('RM.propertydisplayName.randon1487076706699')}${getText('ec.list.validate.datetime')}");return false;}}if($('#' + formId + ' input[name="startTime_start"]').val()!='' && $('#' + formId + ' input[name="startTime_end"]').val()!=''){if($('#' + formId + ' input[name="startTime_start"]').val() > $('#' + formId + ' input[name="startTime_end"]').val()){workbenchErrorBarWidget.showMessage("${getText('RM.propertydisplayName.randon1487076643939')}${getText('ec.list.validate.end')}${getText('ec.list.validate.compare')}${getText('RM.propertydisplayName.randon1487076643939')}${getText('ec.list.validate.start')}");return false;}}if($('#' + formId + ' input[name="edition_start"]').val()!='' && $('#' + formId + ' input[name="edition_end"]').val()!=''){if(parseInt($('#' + formId + ' input[name="edition_start"]').val()) > parseInt($('#' + formId + ' input[name="edition_end"]').val())){workbenchErrorBarWidget.showMessage("${getText('RM.propertydisplayName.randon1487139592239')}${getText('ec.list.validate.end')}${getText('ec.list.validate.compare')}${getText('RM.propertydisplayName.randon1487139592239')}${getText('ec.list.validate.start')}");return false;}}if($('#' + formId + ' input[name="endTime_start"]').val()!='' && $('#' + formId + ' input[name="endTime_end"]').val()!=''){if($('#' + formId + ' input[name="endTime_start"]').val() > $('#' + formId + ' input[name="endTime_end"]').val()){workbenchErrorBarWidget.showMessage("${getText('RM.propertydisplayName.randon1487076706699')}${getText('ec.list.validate.end')}${getText('ec.list.validate.compare')}${getText('RM.propertydisplayName.randon1487076706699')}${getText('ec.list.validate.start')}");return false;}}return true;};
	...
	/* CUSTOM CODE START(view-REFERENCE-RM_7.5.0.0_formula_formulareProTaskRef,js,RM_7.5.0.0_formula_Formula,RM_7.5.0.0) */
// 自定义代码
