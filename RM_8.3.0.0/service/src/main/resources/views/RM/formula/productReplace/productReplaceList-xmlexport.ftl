...
<#assign viewCode = 'RM_7.5.0.0_formula_ProductReplace' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		<Style ss:ID="formulaIds">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="newProduct.productName">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="originProduct.productName">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="replaceTime">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="replaceUser.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											<#if item == 'originProduct.productName' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'newProduct.productName' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'replaceTime' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'replaceUser.name' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'formulaIds' || item == '*'>
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'originProduct.productName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.radion201810241623001')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'newProduct.productName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.radion201810241623002')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'replaceTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1540368099250')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'replaceUser.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.radion201810241623003')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formulaIds' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1540368026295')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												<#if item == 'originProduct.productName' || item == '*'>
													<Cell>
														...
														<#if data.originProduct.productName??><Data ss:Type="String"><![CDATA[${(data.originProduct.productName)!}]]></Data></#if>
												...
												<#if item == 'newProduct.productName' || item == '*'>
													<Cell>
														...
														<#if data.newProduct.productName??><Data ss:Type="String"><![CDATA[${(data.newProduct.productName)!}]]></Data></#if>
												...
												<#if item == 'replaceTime' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.replaceTime??><Data ss:Type="DateTime">${(data.replaceTime)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
												...
												<#if item == 'replaceUser.name' || item == '*'>
													<Cell>
														...
														<#if data.replaceUser.name??><Data ss:Type="String"><![CDATA[${(data.replaceUser.name)!}]]></Data></#if>
												...
												<#if item == 'formulaIds' || item == '*'>
													<Cell>
														...
														<#if data.formulaIds??><Data ss:Type="String"><![CDATA[${(data.formulaIds)!}]]></Data></#if>
