...
<GridData DefaultNodeExpanded="false"   dgName="dg1541586261018" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<name
					...
					sort="true"  onPropertyChange="FormulaMixtureActive_dg1541586261018Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<exeSystem.id
						style="font-color:0303B3"
					sort="true"  onPropertyChange="FormulaMixtureActive_dg1541586261018Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				    onChange="FormulaMixtureActive_dg1541586261018Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);FormulaMixtureActive_dg1541586261018Widget.evalCustomFunction(nRow,sFieldName,'systemCallback(nRow,sFieldName)');"
				...
				<batchSite.id
						style="font-color:0303B3"
					sort="true"  onPropertyChange="FormulaMixtureActive_dg1541586261018Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				    onChange="FormulaMixtureActive_dg1541586261018Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);FormulaMixtureActive_dg1541586261018Widget.evalCustomFunction(nRow,sFieldName,'batchSetChange(nRow,sFieldName)');"
				...
				<product.productCode
						style="font-color:0303B3"
							onBlur="document.body.click()"
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(FormulaMixtureActive_dg1541586261018Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(FormulaMixtureActive_dg1541586261018Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/product/product/refProductLayout.action','dg1541586261018product.productCode','${getText("MESBasic.viewtitle.randon1450085069587")}',sPTGridID,nRow,sFieldName,FormulaMixtureActive_dg1541586261018Widget,'goodCallback(obj)',false,false,'','MESBasic_1_product_refProductLayout')"
								onKeyUp="RM.formula.formulaProcessActive.manualActiveView.initMnemonic_DG_IE({
										'keyCode':Key,
										'oGrid':FormulaMixtureActive_dg1541586261018Widget,
										'sGridName':'FormulaMixtureActive_dg1541586261018Widget',
										'value':sParam,
										'nRow':nRow,
										...
										'funcname':'RM.formula.formulaProcessActive.manualActiveView.getcallBackInfo_DG_IE(obj)',
										'conditionfunc':'RM.formula.formulaProcessActive.manualActiveView._querycustomFunc(\'dg1541586261018product.productCode\'.replace(/\./g, \'_\'))'
				...
				<isPlace
					sort="true"  onPropertyChange="FormulaMixtureActive_dg1541586261018Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				    onChange="FormulaMixtureActive_dg1541586261018Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);FormulaMixtureActive_dg1541586261018Widget.evalCustomFunction(nRow,sFieldName,'isPlaceChange(nRow,sFieldName)');"
				...
				<processHiddenId
					sort="true" numberproperty="sum" onPropertyChange="FormulaMixtureActive_dg1541586261018Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<#list customPropViewMappings as cpvm>
					...
					<#if cpvm.property.type == 'OBJECT'>
						...
						<#if cpvm.refView??>
							...
							onFocus="CUI.toggleClearBtn_DG_IE(FormulaMixtureActive_dg1541586261018Widget,nRow,sFieldName)"
							onBtnClick="CUI.clearCellValue_DG_IE(FormulaMixtureActive_dg1541586261018Widget,nRow,sFieldName,true)"
							subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('${viewUrl!}','dg1541586261018${cpvm.propertyLayRec}','${getText("${viewTitle}")}',sPTGridID,nRow,'${cpvm.propertyLayRec}',FormulaMixtureActive_dg1541586261018Widget,null,false,true,'${mainDisplayName},${pkName}','${viewCode}')"
							hideEditOnReadOnly="true"
						</#if>
					</#if>
						sort="true"
						onPropertyChange="FormulaMixtureActive_dg1541586261018Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
					...
					<#elseif cpvm.property.type == 'DATETIME'>
						...
						onClick="initCalender(FormulaMixtureActive_dg1541586261018Widget,'FormulaMixtureActive_dg1541586261018Widget',nRow,sFieldName,<#if cpvm.format == 'YMD_H'>'dateTimeHour'<#elseif cpvm.format == 'YMD_HM'>'dateTimeMin'<#else>'datetime'</#if>)"
						onBtnClick="showCalender(FormulaMixtureActive_dg1541586261018Widget,'FormulaMixtureActive_dg1541586261018Widget',nRow,sFieldName,<#if cpvm.format == 'YMD_H'>'dateTimeHour'<#elseif cpvm.format == 'YMD_HM'>'dateTimeMin'<#else>'datetime'</#if>)"
						control="Text"
