					...
					<#list exportFieldList as item>
						<#if item?length gt 0 && item != "checkbox">
									...
									<#assign customGeneratedFlag=false />
										<#if item == 'channelOrManual' && !customGeneratedFlag >
									...
									<#if item == 'batchPhaseID' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'copy' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'subActiveNum' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'mainActive' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								...
								<#if item == 'auto' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1487331130107232')}</Data>
										</Cell>
								</#if>
								<#if item == 'actOrder' || item == '*'>
										<Cell>
								...
								<#if item == 'ingredientsOrder' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon148733111023223')}</Data>
										</Cell>
								</#if>
								<#if item == 'execSort' || item == '*'>
										<Cell>
								...
								<#if item == 'batchSite.value' || item == 'batchSite.id' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon148733082974923')}</Data>
										</Cell>
								</#if>
								<#if item == 'exeSystem.value' || item == 'exeSystem.id' || item == '*'>
										<Cell>
								...
								<#if item == 'testProduct.code' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.viewtitle.randon1490318000877')}</Data>
										</Cell>
								</#if>
								<#if item == 'qualityStandard.code' || item == '*'>
										<Cell>
								...
								<#if item == 'pickSite.name' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon15034702500333')}</Data>
										</Cell>
								</#if>
								<#if item == 'isWatchActive' || item == '*'>
										<Cell>
								...
								<#if item == 'batchPhaseID' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1493729738415')}</Data>
										</Cell>
								</#if>
								<#if item == 'copy' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1509706675156')}</Data>
										</Cell>
								</#if>
								<#if item == 'subActiveNum' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1540270275689')}</Data>
										</Cell>
								</#if>
								<#if item == 'mainActive' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1539919567050')}</Data>
										</Cell>
								</#if>
								<#if item == 'hiddenSort' || item == '*'>
										<Cell>
					...
					<#if item?length gt 0>
								...
								<#if item == 'pickSite.name' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.pickSite.name)??>${(data.pickSite.name)!}</#if></Data>
								...
								<#if item == 'batchPhaseID' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.batchPhaseID)??>${(data.batchPhaseID)!}</#if></Data>
								...
								<#if item == 'copy' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.copy)?? && data.copy>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
								...
								<#if item == 'subActiveNum' || item == '*'>
									<Cell>
										...
										<Data ss:Type="Number"><#if (data.subActiveNum)??>${(data.subActiveNum)!}</#if></Data>
								...
								<#if item == 'mainActive' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.mainActive)?? && data.mainActive>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
