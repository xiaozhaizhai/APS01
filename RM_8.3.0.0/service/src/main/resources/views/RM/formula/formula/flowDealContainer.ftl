				...
				<table width="100%">
					<tr>
						...
						<td id="workflow_outcomes">
							...
							<a class="cui-btn-blue" onclick="RM.formula.formula.save()"><span class='btn_r'>${getText('ec.flow.save')}</span></a>
							<a class="cui-btn-green" onclick="RM.formula.formula.submit()"><span class='btn_r'>${getText('ec.flow.submit')}</span></a>
