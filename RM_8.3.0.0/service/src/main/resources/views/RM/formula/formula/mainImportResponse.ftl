...
<script type="text/javascript">
	...
	function download(){
		//var url = "/RM/formula/formula/downLoad.action?viewCode=RM_7.5.0.0_formula_formulaProdRepList&orgName=RM_7.5.0.0_formula_formulaProdRepList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/RM/formula/formula/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
