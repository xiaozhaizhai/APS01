...
<#assign viewCode = 'RM_7.5.0.0_formula_FormulaProcess' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="formulaId.batchFormulaCode">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											<#if item == 'formulaId.batchFormulaCode' || item == '*'>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formulaId.code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1488246312092201810221003001')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formulaId.edition' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487295011793')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'processType.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487074387497201810221104001')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isFirstProcess' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1540176861060')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isLastProcess' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1497849146067')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'longTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487292241411')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'meno' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487292273721')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'processTableId' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487297416937')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formulaId.tableNo' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchUnitID' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1493729983867')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												<#if item == 'formulaId.batchFormulaCode' || item == '*'>
													<Cell>
														...
														<#if data.formulaId.batchFormulaCode??><Data ss:Type="String"><![CDATA[${(data.formulaId.batchFormulaCode)!}]]></Data></#if>
												...
												<#if item == 'processType.name' || item == '*'>
													<Cell>
														...
														<#if data.processType.name??><Data ss:Type="String"><![CDATA[${(data.processType.name)!}]]></Data></#if>
												...
												<#if item == 'processTableId' || item == '*'>
													<Cell>
														...
														<#if data.processTableId??><Data ss:Type="Number"><![CDATA[${(data.processTableId)!}]]></Data></#if>
												...
												<#if item == 'batchUnitID' || item == '*'>
													<Cell>
														...
														<#if data.batchUnitID??><Data ss:Type="String"><![CDATA[${(data.batchUnitID)!}]]></Data></#if>
