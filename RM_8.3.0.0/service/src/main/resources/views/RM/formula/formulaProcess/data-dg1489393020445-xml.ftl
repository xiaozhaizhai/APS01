...
<GridData DefaultNodeExpanded="false"   dgName="dg1489393020445" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<quota
					sort="true"  onPropertyChange="PrecessStandards_dg1489393020445Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<upperLimit
					sort="true"  onPropertyChange="PrecessStandards_dg1489393020445Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				    onChange="PrecessStandards_dg1489393020445Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);PrecessStandards_dg1489393020445Widget.evalCustomFunction(nRow,sFieldName,'upChange()');"
				...
				<maxLimit
					sort="true"  onPropertyChange="PrecessStandards_dg1489393020445Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				    onChange="PrecessStandards_dg1489393020445Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);PrecessStandards_dg1489393020445Widget.evalCustomFunction(nRow,sFieldName,'mixChange()');"
				...
				<lowerLimit
					sort="true"  onPropertyChange="PrecessStandards_dg1489393020445Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				    onChange="PrecessStandards_dg1489393020445Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);PrecessStandards_dg1489393020445Widget.evalCustomFunction(nRow,sFieldName,'lowChange()');"
				...
				<loweMxLimit
					sort="true"  onPropertyChange="PrecessStandards_dg1489393020445Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				    onChange="PrecessStandards_dg1489393020445Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);PrecessStandards_dg1489393020445Widget.evalCustomFunction(nRow,sFieldName,'minChange()');"
				...
				<#list customPropViewMappings as cpvm>
					...
					<#if cpvm.property.type == 'OBJECT'>
						...
						<#if cpvm.refView??>
							...
							onFocus="CUI.toggleClearBtn_DG_IE(PrecessStandards_dg1489393020445Widget,nRow,sFieldName)"
							onBtnClick="CUI.clearCellValue_DG_IE(PrecessStandards_dg1489393020445Widget,nRow,sFieldName,true)"
							subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('${viewUrl!}','dg1489393020445${cpvm.propertyLayRec}','${getText("${viewTitle}")}',sPTGridID,nRow,'${cpvm.propertyLayRec}',PrecessStandards_dg1489393020445Widget,null,false,true,'${mainDisplayName},${pkName}','${viewCode}')"
							hideEditOnReadOnly="true"
						</#if>
					</#if>
						sort="true"
						onPropertyChange="PrecessStandards_dg1489393020445Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
					...
					<#elseif cpvm.property.type == 'DATETIME'>
						...
						onClick="initCalender(PrecessStandards_dg1489393020445Widget,'PrecessStandards_dg1489393020445Widget',nRow,sFieldName,<#if cpvm.format == 'YMD_H'>'dateTimeHour'<#elseif cpvm.format == 'YMD_HM'>'dateTimeMin'<#else>'datetime'</#if>)"
						onBtnClick="showCalender(PrecessStandards_dg1489393020445Widget,'PrecessStandards_dg1489393020445Widget',nRow,sFieldName,<#if cpvm.format == 'YMD_H'>'dateTimeHour'<#elseif cpvm.format == 'YMD_HM'>'dateTimeMin'<#else>'datetime'</#if>)"
						control="Text"
