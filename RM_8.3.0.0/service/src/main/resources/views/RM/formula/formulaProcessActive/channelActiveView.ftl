<!-- RM_7.5.0.0/formula/channelActiveView -->
...
<title>${getText('RM.viewtitle.randon1541586645850')}</title>
<@maincss/>
<@mainjs/>
<@extracss />

<!-- CUSTOM CODE START(view-VIEW-RM_7.5.0.0_formula_channelActiveView,head,RM_7.5.0.0_formula_FormulaProcessActive,RM_7.5.0.0) -->
<!-- 自定义代码 -->
...
<script type="text/javascript">
	CUI.ns('RM.formula.formulaProcessActive.channelActiveView');
</script>
<@ecStyleCss />
...
<@errorbar id="RM_formula_formulaProcessActive_channelActiveView_formDialogErrorBar" />
<#assign mneIframe = false>
<#if (Parameters.openType)?? && (Parameters.openType) == 'frame'>
<#assign callbackName="parent." + callbackName>
<#assign mneIframe = true>
</#if>
<@s.form id="RM_formula_formulaProcessActive_channelActiveView_form" cssStyle="height:100%;" hiddenField="formulaProcessActive.id,formulaProcessActive.product.id," onsubmitMethod="RM.formula.formulaProcessActive.channelActiveView.beforeSubmitMethod()" ecAction="/RM/formula/formulaProcessActive/channelActiveView/submit.action?__pc__=${(Parameters.__pc__)!}" callback=callbackName ecform="true">
	<input type="hidden" name="bap_validate_user_id" value="${(Session.user.id)!}" />
	<input type="hidden" name="operateType" value="submit">
	<input type="hidden" name="viewselect" value="channelActiveView">
	<input type="hidden" name="viewCode" value="RM_7.5.0.0_formula_channelActiveView">
	<input type="hidden" name="datagridKey" value="RM_formula_formulaProcessActive_channelActiveView_datagrids">
	...
	<div id="RM_channelActiveView_edit_div" style="height:100%">
		<div id="RM_formula_formulaProcessActive_channelActiveView_main_div" class="edit-content-dialog edit-content-dialog-fullwidth">
<script type="text/javascript">
var attcountid = "RM_formula_formulaProcessActive_channelActiveView_form"+"_attcount";
		...
		<tr class="dialog_tr">
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
						...
						<#assign formulaProcessActive_activeType_defaultValue  = 'activeType/activeType4'>
								...
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${formulaProcessActive_activeType_defaultValue!}" formId="RM_formula_formulaProcessActive_channelActiveView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="formulaProcessActive.activeType.id" code="activeType" value="${(formulaProcessActive.activeType.id)!}"  />
									
								<#else>
									
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="RM_formula_formulaProcessActive_channelActiveView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="formulaProcessActive.activeType.id" code="activeType" value="${(formulaProcessActive.activeType.id)!}"  />
								...
								<#if !(formulaProcessActive.id)?? && (formulaProcessActive.product.id)?has_content>
									(function($){
										$(function(){
											...
											if(obj.id !== '-1') {
												obj = foundation.common.getObject('RM_formula_formulaProcessActive_channelActiveView_form',obj, 'formulaProcessActive.product', '/MESBasic/product/product/refProductLayout.action');
												CUI.commonFills('RM_formula_formulaProcessActive_channelActiveView_form', 'formulaProcessActive.product',obj,true);
											}
										});
									})(jQuery);
								</#if>
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
								...
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${formulaProcessActive_exeSystem_defaultValue!}" formId="RM_formula_formulaProcessActive_channelActiveView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="formulaProcessActive.exeSystem.id" code="RMsystem" value="${(formulaProcessActive.exeSystem.id)!}"  />
									
								<#else>
									
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="RM_formula_formulaProcessActive_channelActiveView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="formulaProcessActive.exeSystem.id" code="RMsystem" value="${(formulaProcessActive.exeSystem.id)!}"  />
...
<style>
	...
	<table class="edit-table" style="display:none">
		...
		<tr class="dialog_tr">
						...
						<#assign formulaProcessActive_fromContainer_defaultValue  = 'fromContainer/fromContainer1'>
								...
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${formulaProcessActive_fromContainer_defaultValue!}" formId="RM_formula_formulaProcessActive_channelActiveView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="formulaProcessActive.fromContainer.id" code="fromContainer" value="${(formulaProcessActive.fromContainer.id)!}"  />
									
								<#else>
									
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="RM_formula_formulaProcessActive_channelActiveView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="formulaProcessActive.fromContainer.id" code="fromContainer" value="${(formulaProcessActive.fromContainer.id)!}"  />
					...
					<td  nullable=true class="edit-table-content"   align="left" style="text-align: left;;" >
						...
						<#assign formulaProcessActive_occurTurn_defaultValue  = 'occurTurn/occurTurn2'>
								...
								<#if newObj>
									...
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}" deValue="${formulaProcessActive_occurTurn_defaultValue!}" formId="RM_formula_formulaProcessActive_channelActiveView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="formulaProcessActive.occurTurn.id" code="occurTurn" value="${(formulaProcessActive.occurTurn.id)!}"  />
									
								<#else>
									
									<@systemcode property_type="SYSTEMCODE" showType="SELECTCOMP" onchange=""  viewType="${viewType!}"  formId="RM_formula_formulaProcessActive_channelActiveView_form" classStyle="cui-noborder-input" ecFlag=true multable=false view=true cssStyle="" name="formulaProcessActive.occurTurn.id" code="occurTurn" value="${(formulaProcessActive.occurTurn.id)!}"  />
		...
		<#assign cpvmInfo = ''>
			<#assign customPropList = getShowCustomProps("RM_7.5.0.0_formula_FormulaProcessActive", "RM_7.5.0.0_formula_channelActiveView", 'EDIT')>
				...
				<td nullable=<#if (c.nullable!false)>true<#else>false</#if> class="edit-table-content" <#if c.fieldType?? && c.fieldType == 'DATATIME'>celltype="DATATIME"</#if> <#if cspan gt 1>colspan="${colspanVal}"</#if> style="text-align:left;">
					...
					<#elseif fieldType == 'SELECTCOMP'>
						<#if columnType == 'SYSTEMCODE'>
							...
							<@systemcode property_type="${columnType}" iscustom=true showType="${fieldType}" viewType=viewType cssStyle="text-align:${c.align!}" formId="RM_formula_formulaProcessActive_channelActiveView_form" classStyle="cui-noborder-input" view=true cssStyle="" ecFlag=true multable=isMultable name="${elementName}" code="${(c.property.fillcontentMap.fillContent)!}" value="${formulaProcessActive[columnName]!}" seniorSystemCode=isS2 />
						<#else>
...
<#assign colAdmFlag=checkUserPermisition('ec_ptManage_list_view')>
			...
			<#if  refId?? && (refId > 0)>
				<#assign dUrl="/RM/formula/formulaProcessActive/data-dg1541586768241.action?formulaProcessActive.id=${refId!-1}&refId=${refId!-1}&datagridCode=RM_7.5.0.0_formula_channelActiveViewdg1541586768241">
			<#else>
				<#assign dUrl="/RM/formula/formulaProcessActive/data-dg1541586768241.action?formulaProcessActive.id=${(formulaProcessActive.id)!-1}&datagridCode=RM_7.5.0.0_formula_channelActiveViewdg1541586768241">
			</#if>
			...
			<#else>
				...
				<#if cpvmInfo?? && cpvmInfo?length gt 0>
					<#assign cpvmInfo = cpvmInfo?substring(1)>
					<input type="hidden" id="dg_cp_info_FormulaMixtureActive_dg1541586768241" value="${cpvmInfo!}" />
				</#if>
			
			<input type="hidden" id="dg1541586768241_id" value="FormulaMixtureActive_dg1541586768241" />
			
			<input type="hidden" id="dg1541586768241_url" value="${dUrl}" />
			
			<#assign assModelDisplayName = getText('RM.modelname.randon1487811340490')!>
			<#assign assModelDisplayName = assModelDisplayName + getText('ec.common.validate.colon') >
			<@exportexcel action="/RM/formula/formulaProcessActive/data-dg1541586768241.action?operateType=export&datagridCode=RM_7.5.0.0_formula_channelActiveViewdg1541586768241"  settingtext="" settingUrl="" prepareParams="" formId="" look="text" width=250 height=170 text="" exportPageChoose=0 dtPage="dgPage" prefix="FormulaMixtureActive_dg1541586768241" />
			<@datagrid colAdminFlag=colAdmFlag withoutConfigTable=true id="FormulaMixtureActive_dg1541586768241" viewType="${viewType}" renderOverEvent="dg1541586768241RenderOverEvent" route="${routeFlag}" formId="RM_formula_formulaProcessActive_channelActiveView_form" noPermissionKeys="name,ingredientsOrder,exeSystem,batchSite,product.productCode,product.productName,product.productBaseUnit.name,isPlace,isMixQuality,standardQuantity,minQuality,maxQuality,lossRate,formulaType,occurTurn,saveFlag,addFlag,channelOrManual,meno" modelCode="RM_7.5.0.0_formula_FormulaMixtureActive" dataUrl="${dUrl}" postData="&dgPage.pageSize=65536" dataGridName="dg1541586768241" dtPage="dgPage"  hidekeyPrefix="dg1541586768241" hidekey="['id','version','product.id','product.productCode','product.id','product.productName','product.id','product.productBaseUnit.name'${cpObjHideKey!''}]" transMethod="post" paginator=false editable=false  buttons="${buttons}" noPadding=true isEdit=true tabViewIndex=0 pageInitMethod="dg1541586768241PageInitMethod"  defaultNodeExpanded=nodeExpanded  cannotAddNewRow=false cannotDeleteRow=true assModelDisplayName=assModelDisplayName  activexButton="" exportExcel=exportExcel addNewRow=true   canInsertRow=false  insertRowAble=true firstLoad=firstLoad  copyRow=false  copyColumn=false  ptRealTimeLoad=0 >		
							<#assign name_displayDefaultType=''>
								<#assign name_defaultValue=''>
										<#assign name_defaultValue=''>
										 
									<@datacolumn key="name"        showFormat="TEXT" defaultValue="${(name_defaultValue!)?string}" defaultDisplay="${(name_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false     textalign="left"  viewUrl="" viewCode="" mneenable=false crossCompany=false viewTitle="${getText('')}"  label="${getText('RM.propertydisplayName.randon1487811442421223')}" width=100 showFormatFunc=""  />
							...
							<#elseif (product_productName_defaultValue!)?string=="currentComp">
								<#assign product_productName_defaultValue='${compJson!}'>
									...
									<@datacolumn key="product.productName"        showFormat="TEXT" defaultValue="${(product_productName_defaultValue!)?string}" defaultDisplay="${(product_productName_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="RM.formula.formulaProcessActive.channelActiveView"  textalign="left"  viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('MESBasic.propertydisplayName.radion1415772740737')}" width=100 showFormatFunc=""  />
							...
							<#elseif (product_productBaseUnit_name_defaultValue!)?string=="currentComp">
								<#assign product_productBaseUnit_name_defaultValue='${compJson!}'>
									...
									<@datacolumn key="product.productBaseUnit.name"        showFormat="TEXT" defaultValue="${(product_productBaseUnit_name_defaultValue!)?string}" defaultDisplay="${(product_productBaseUnit_name_displayDefaultType!)?string}" decimal="" editable=false type="textfield" showType="textfield" notnull=false   selectCompName="RM.formula.formulaProcessActive.channelActiveView"  textalign="left"  viewUrl="/MESBasic/product/product/productRefNew.action" viewCode="MESBasic_1_product_productRefNew" mneenable=false crossCompany=false viewTitle="${getText('MESBasic.viewtitle.randon1475137145215')}"  label="${getText('RM.propertydisplayName.radion139823564048323')}" width=60 showFormatFunc=""  />
							<#assign isPlace_displayDefaultType=''>
								<#assign isPlace_defaultValue=''>
									...
									<@datacolumn key="isPlace"        showFormat="CHECKBOX" defaultValue="${(isPlace_defaultValue!)?string}" defaultDisplay="${(isPlace_displayDefaultType!)?string}" onchange="FormulaMixtureActive_dg1541586768241Widget.evalCustomFunction(nRow,sFieldName,'isPlaceChange(nRow,sFieldName)')" decimal="" editable=false type="boolean" showType="checkbox" notnull=false     textalign="center"  viewUrl="" viewCode="" mneenable=false crossCompany=false viewTitle="${getText('')}"  label="${getText('RM.propertydisplayName.randon1487812026631')}" width=60 showFormatFunc=""  />
							...
							<#assign formulaType_displayDefaultType=''>
								<#assign formulaType_defaultValue='activeType/activeType2'>
										 									<@systemCodeColumn code="activeType" textalign="center" defaultValue="${(formulaType_defaultValue!)?string}" key="formulaType.id" editable=false type="selectcomp" notnull=false     label="${getText('RM.propertydisplayName.randon1487811825429')}" width=80 hiddenCol=true  />
								...
								<#else>
									...
									<#if cpvmColumnType == 'OBJECT'>
										<#if cpvm.refView??>
											...
											<#assign selectCompName = 'RM.formula.formulaProcessActive.channelActiveView'>
										</#if>
										<#assign pkName = ''>
										<#assign mainDisplayName = ''>
			...
			<script type="text/javascript">
				function FormulaMixtureActive_dg1541586768241_check_datagridvalid(){
					//
					var errorObj =FormulaMixtureActive_dg1541586768241Widget._DT.testData();
					var errorContent='';
					if(errorObj!=null){
				...
				function savedg1541586768241DataGrid(){
					<#if  refId?? && (refId gt 0)>
					FormulaMixtureActive_dg1541586768241Widget.setAllRowEdited();
					</#if>
					// 针对需要全部更新的PT，把pt Id存到body的CHANGED_PT中，保存时，会自动保存全部数据
					var changed_pt_name = $('body').data('CHANGED_PT');
					if(changed_pt_name && changed_pt_name.indexOf('FormulaMixtureActive_dg1541586768241Widget') > -1) {
						FormulaMixtureActive_dg1541586768241Widget.setAllRowEdited();
					}
					var json = FormulaMixtureActive_dg1541586768241Widget.parseEditedData();
					$('input[name="dg1541586768241ListJson"]').remove();
					$('input[name="dgLists[\'dg1541586768241\']"]').remove();
					$('input[name="dg1541586768241ModelCode"]').remove();
					$('<input type="hidden" name="dgLists[\'dg1541586768241\']">').val(json).appendTo($('#RM_formula_formulaProcessActive_channelActiveView_form'));
					$('<input type="hidden" name="dg1541586768241ModelCode">').val('RM_7.5.0.0_formula_FormulaMixtureActive').appendTo($('#RM_formula_formulaProcessActive_channelActiveView_form'));
					//兼容旧版本提交函数
					$('<input type="hidden" name="dg1541586768241ListJson">').val(json).appendTo($('#RM_formula_formulaProcessActive_channelActiveView_form'));
				}
				function DT_FormulaMixtureActive_dg1541586768241_deldatagrid(){
					var deleteRows = FormulaMixtureActive_dg1541586768241Widget.deleteRows();
					...
					$.each(deleteRows, function(index, deleteRow){
						...
						if($("#dg1541586768241DeletedIds").length>0){
							$("#dg1541586768241DeletedIds")[0].value+=","+tepID;
						}else{
							CUI('<input type="hidden" id="dg1541586768241DeletedIds" name="dgDeletedIds[\'dg1541586768241\']" value="'+tepID+'">').appendTo(CUI('#RM_formula_formulaProcessActive_channelActiveView_form'));
						}
						//兼容旧版本提交函数
						CUI('<input type="hidden" name="dg1541586768241DeletedIds['+CUI('input[name^="dg1541586768241DeletedIds"]').length+']'+'" value="'+tepID+'">').appendTo(CUI('#RM_formula_formulaProcessActive_channelActiveView_form'));
					});
					return deleteRows;
				}
				function DT_FormulaMixtureActive_dg1541586768241_delTreeNodes(){
					var deleteRows = FormulaMixtureActive_dg1541586768241Widget._DT.removeTreeNode();
					if(!deleteRows || deleteRows.length == 0) {
						return false;
					}
					var delproperty = "'id','version','processActiveId.id','product.id'";
				...
				$(function($){
					var datagrids = $('body').data('RM_formula_formulaProcessActive_channelActiveView_datagrids');
					if(!datagrids) {
						datagrids = [];
					}
					for(var i=0;i<1;i++) {
					...
					if(datagrids[0].length>0) {
						for(var i=0;i<datagrids[0].length;i++) {
							if(datagrids[0][i] == 'FormulaMixtureActive_dg1541586768241') {
								break;
							}
							if(i==datagrids[0].length-1) {
								datagrids[0][datagrids[0].length] = 'FormulaMixtureActive_dg1541586768241';
							}
						}
					} else {
						datagrids[0][datagrids[0].length] = 'FormulaMixtureActive_dg1541586768241';
					}
					$('body').data('RM_formula_formulaProcessActive_channelActiveView_datagrids', datagrids);
				});
				
				var FormulaMixtureActive_dg1541586768241_importDialog = null;
				function FormulaMixtureActive_dg1541586768241_showImportDialog(){
					try{
						if(FormulaMixtureActive_dg1541586768241_importDialog!=null&&FormulaMixtureActive_dg1541586768241_importDialog.isShow==1){
							return false;
						}
						var url = "/RM/formula/formulaProcessActive/initImport.action?datagridCode=RM_7.5.0.0_formula_channelActiveViewdg1541586768241&tid=${id!}&datagridName=dg1541586768241";
							<#if canImportExcel>
								var buttonCode="RM_7.5.0.0_formula_channelActiveViewdg1541586768241_BUTTON_dgImport";
								url+="&buttonCode="+buttonCode;
							</#if>
						FormulaMixtureActive_dg1541586768241_importDialog = new CUI.Dialog({
							...
							width: '420',
							dragable:true,
							buttons:[{id:"import",name:"${getHtmlText('common.button.import')}",handler:function(){var dg = eval("FormulaMixtureActive_dg1541586768241"+"Widget");if(dg && dg.checkEdited && dg.checkEdited()){CUI.Dialog.alert("${getHtmlText('ec.view.unsavedgdata')}");}else{foundation.importExcel.submitImportForm();}}},{name:"${getHtmlText('common.button.cancel')}",id:"close",handler:function(){setTimeout(function(){$('#importResponse').remove();FormulaMixtureActive_dg1541586768241_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.Confirm')}",id:"ok",display:'hidden',handler:function(){setTimeout(function(){$('#importResponse').remove();FormulaMixtureActive_dg1541586768241_importDialog.close();}, 200);}},{name:"${getHtmlText('common.button.back')}",id:"tback",display:'hidden',handler:function(){tback();}}],
							beforeCloseEvent:function(){$('#importResponse').remove();}
						});
						FormulaMixtureActive_dg1541586768241_importDialog.show();
					}catch(e){}
				}	
				
				function FormulaMixtureActive_dg1541586768241_downLoadFile(){
					var url = "/RM/formula/formulaProcessActive/downLoad.action?datagridCode=RM_7.5.0.0_formula_channelActiveViewdg1541586768241&templateRelatedModelCode=RM_7.5.0.0_formula_channelActiveViewdg1541586768241&downloadType=template&fileName=dg1541586768241";
					window.open(url,"","");
				}
				function dg1541586768241RenderOverEvent(){
				}
				function dg1541586768241PageInitMethod(nTabIndex){
					RM.formula.formulaProcessActive.channelActiveView.initSize(nTabIndex);
				}
			</script>
...
<!-- CUSTOM CODE START(view-VIEW-RM_7.5.0.0_formula_channelActiveView,html,RM_7.5.0.0_formula_FormulaProcessActive,RM_7.5.0.0) -->
<!-- 自定义代码 -->

<!-- CUSTOM CODE END -->
<script type="text/javascript" src="/bap/static/signature/${lang!}/signature.js"></script>
<script type="text/javascript">
	RM.formula.formulaProcessActive.channelActiveView.beforeSaveProcess = function(){}
	RM.formula.formulaProcessActive.channelActiveView.beforeSubmitMethod = function() {
		try{eval("savedg1541586768241DataGrid()");}catch(e){}
		try{eval('beforeSubmitUploadForm()');}catch(e){}
		try{if(RM.formula.formulaProcessActive.channelActiveView.beforeSubmitMethodSettingInPage()==false) return false;}catch(e){}

		var extraCol = '<extra-data>';
		$('#RM_formula_formulaProcessActive_channelActiveView_form').trigger('beforeSubmit');
	...
	(function($){
		...
		$(function(){
			$("#RM_formula_formulaProcessActive_channelActiveView_form ul.edit-tabs").tabs("div.edit-panes > div");
			$('#RM_formula_formulaProcessActive_channelActiveView_form').get(0).onkeydown=function(event){event=event?event:window.event;if(event.keyCode==13){return false}};
		});
	})(jQuery);
	RM.formula.formulaProcessActive.channelActiveView.validate = function(){
		return true;
	}
	
	
	//打印
	RM.formula.formulaProcessActive.channelActiveView.print = function(url){
		...
		RM.formula.formulaProcessActive.channelActiveView.saveSetting = function(){
		...
		RM.formula.formulaProcessActive.channelActiveView.printSetting = function(){
			...
			RM.formula.formulaProcessActive.channelActiveView.settingDialog = new CUI.Dialog({
					...
					buttons:[
							{	name:"${getText("ec.flow.save")}",
								handler:function(){if(RM.formula.formulaProcessActive.channelActiveView.saveSetting()){this.close();}isPrintSettingDialogShow = false;}
							},
							{	name:"${getText("ec.flow.cancal")}",
								handler:function(){this.close();isPrintSettingDialogShow = false;}
							}]
				})
				RM.formula.formulaProcessActive.channelActiveView.settingDialog.show();
	...
	function dataGridBtnImgClick(sUrl,objNameCustomCondition,sTitle,sPTGridID,nRow,sFieldName,oGrid,customCallBack,crossCompany){
		...
		if(customCallBack){
			RM.formula.formulaProcessActive.channelActiveView._customCallBack = customCallBack;
		}
		RM.formula.formulaProcessActive.channelActiveView._selectEvent(objNameCustomCondition,null,sUrl,sTitle,null,null,null,crossCompany,obj);
	}
	function setUpload(params){
			if($('#RM_formula_formulaProcessActive_channelActiveView_fileupload').length == 0) {
				$('body').append('<div id="RM_formula_formulaProcessActive_channelActiveView_fileupload"></div>');
			}
			RM.formula.formulaProcessActive.channelActiveView.infoDialog = new CUI.Dialog({
				title: "${getText("ec.view.info.view")}",
				elementId : "RM_formula_formulaProcessActive_channelActiveView_fileupload",
				modal:true,
				height:330,
				width: 460,
				buttons:[
			...
			var dialogId = $('#RM_formula_formulaProcessActive_channelActiveView_fileupload_button').parents('div[id^=dialog_]:first').attr('id');
			RM.formula.formulaProcessActive.channelActiveView.infoDialog.show();
			if($('#RM_formula_formulaProcessActive_channelActiveView_fileupload').html() == '') {
				$('#RM_formula_formulaProcessActive_channelActiveView_fileupload').load("/foundation/workbench/fileupload-dialog-init.action?linkId=" + params.operateRecordId + "&type=RM_formula_formulaProcessActive&entityCode=RM_7.5.0.0_formula&dialogId="+dialogId);
			}
		}
	//参照复制函数
	RM.formula.formulaProcessActive.channelActiveView.referenceCopy = function(objName,url, dialog){
		var callbackName ="RM.formula.formulaProcessActive.channelActiveView.referenceCopyBackInfo";
		RM.formula.formulaProcessActive.channelActiveView.dialog = dialog;
		RM.formula.formulaProcessActive.channelActiveView._dialog = foundation.common.select({
			pageType : 'other',
			closePage : true,
	...
	RM.formula.formulaProcessActive.channelActiveView.referenceCopyBackInfo = function(obj){
		if(RM.formula.formulaProcessActive.channelActiveView._dialog){
			RM.formula.formulaProcessActive.channelActiveView._dialog.close();
		}
		<#if (Parameters.openType)?? && (Parameters.openType) == 'frame'>
		
		<#else>
		createLoadPanel(false,RM.formula.formulaProcessActive.channelActiveView.dialog._el);
		</#if>
		
		var value = document.getElementById("id").value;
		<#if viewType != "readonly">
		if(isFormChanged('RM_formula_formulaProcessActive_channelActiveView_form','RM_formula_formulaProcessActive_channelActiveView_datagrids')){
			CUI.Dialog.confirm("${getText('ec.view.losedata')}", function(){	
				$(RM.formula.formulaProcessActive.channelActiveView.dialog._el).html("<table style='width:100%;height:100%;text-align:center;'><tr><td><label class='datagrid-loading'>${getHtmlText("ec.view.loading")}</label></td></tr></table>");
				CUI(RM.formula.formulaProcessActive.channelActiveView.dialog._el).load('/RM/formula/formulaProcessActive/channelActiveView.action?id=' + value +'&refId='+obj[0].id+"&__pc__=${(Parameters.__pc__)!}",null,function(){
						closeLoadPanel();
						try{
							StrutsUtilsOnLoad();
						}catch(e){}
			...
			<#if (Parameters.openType)?? && (Parameters.openType) == 'frame'>
			parent.$( RM.formula.formulaProcessActive.channelActiveView.dialog._el ).append( '<table id="dialog-iframe-loading" style="position:absolute;left:0;top:-20px;width:100%;height:100%;text-align:center;"><tr><td><label class="datagrid-loading">正在加载...</label></td></tr></table>' );
			parent.$( '#' + RM.formula.formulaProcessActive.channelActiveView.dialog._config.iframe, RM.formula.formulaProcessActive.channelActiveView.dialog._dialog ).prop( 'src', '/RM/formula/formulaProcessActive/channelActiveView.action?id=' + value +'&refId='+obj[0].id+"&__pc__=${(Parameters.__pc__)!}" + '&openType=frame' );
			<#else>
			$(RM.formula.formulaProcessActive.channelActiveView.dialog._el).html("<table style='width:100%;height:100%;text-align:center;'><tr><td><label class='datagrid-loading'>${getHtmlText("ec.view.loading")}</label></td></tr></table>");
			CUI(RM.formula.formulaProcessActive.channelActiveView.dialog._el).load('/RM/formula/formulaProcessActive/channelActiveView.action?id=' + value +'&refId='+obj[0].id+"&__pc__=${(Parameters.__pc__)!}",null,function(){
					closeLoadPanel();
	...
	RM.formula.formulaProcessActive.channelActiveView.initMnemonic_DG_IE = function(oConfig){
		var oGrid = oConfig.oGrid;
		// 获取控件PT  object
		var oPTGridEx = oGrid._DT || oGrid;
		// 存储当前操作相关信息
		RM.formula.formulaProcessActive.channelActiveView.gridEventObj = {
			"oGrid" : oGrid,
			"nRow" : oConfig.nRow - 1,
			"sKey":	oConfig.sFieldName
		}
		RM.formula.formulaProcessActive.channelActiveView._sUrl = oConfig.url;
		if(oConfig.customCallBack){
			RM.formula.formulaProcessActive.channelActiveView._customCallBack = oConfig.customCallBack;
		}
		// 自定义的表格对象
	...
	RM.formula.formulaProcessActive.channelActiveView._selectEvent = function(objName,_selectType,url,title,refparam,obj,customCallBack,crossCompanyFlag,gridEventObj,oGrid,isMultiselect){
		var extraFrameParam = objName.replace(/\./g, '_');
		var frameName = 'RM_formula_formulaProcessActive_channelActiveView' + '_' + extraFrameParam;
		var callbackName="";
		RM.formula.formulaProcessActive.channelActiveView._prefix = '';
		RM.formula.formulaProcessActive.channelActiveView._oGrid = oGrid;
		RM.formula.formulaProcessActive.channelActiveView._sUrl = url;
		if(customCallBack){
			RM.formula.formulaProcessActive.channelActiveView._customCallBack = customCallBack;
		}
		var arr = objName.split('.');
		if(gridEventObj) {
			RM.formula.formulaProcessActive.channelActiveView.gridEventObj = gridEventObj;
			callbackName = "RM.formula.formulaProcessActive.channelActiveView.getcallBackInfo_DG_IE";
		}else if(obj!=null && obj!=""){
			if(arr.length > 1){
				RM.formula.formulaProcessActive.channelActiveView._prefix = '.'+ arr[0];
			}
			callbackName = isMultiselect ? "RM.formula.formulaProcessActive.channelActiveView.getMultiselectCallBackInfo_DG" : "RM.formula.formulaProcessActive.channelActiveView.getcallBackInfo_DG";
			RM.formula.formulaProcessActive.channelActiveView._currRow = obj.parentNode.parentNode.parentNode;
		}else{
			if(arr.length > 2){
				RM.formula.formulaProcessActive.channelActiveView._prefix = '.'+ arr[0] + '.'+ arr[1];
			}
			callbackName ="RM.formula.formulaProcessActive.channelActiveView.getcallBackInfo";
		}
		if(RM.formula.formulaProcessActive.channelActiveView._prefix!=''){
			RM.formula.formulaProcessActive.channelActiveView._prefix = RM.formula.formulaProcessActive.channelActiveView._prefix.substring(1);
		}
		if(RM.formula.formulaProcessActive.channelActiveView._querycustomFunc(objName.replace(/\./g, '_')) != null) {
			if(refparam != null && refparam != "") {
				refparam += '&';
			} else {
			    refparam = '';
			}
			refparam += 'condition=' + encodeURIComponent(RM.formula.formulaProcessActive.channelActiveView._querycustomFunc(objName.replace(/\./g, '_')));
		}
		if(typeof RM.formula.formulaProcessActive.channelActiveView._querycustomFuncN == "function") {
				refparam += RM.formula.formulaProcessActive.channelActiveView._querycustomFuncN();
		}
	...
	RM.formula.formulaProcessActive.channelActiveView._querycustomFunc = function(obj) {
		var str = eval("typeof(RM.formula.formulaProcessActive.channelActiveView.query_"+obj+")!='undefined'") ? eval('RM.formula.formulaProcessActive.channelActiveView.query_'+obj+'()') : null;
		return str;
	
	};
	
	RM.formula.formulaProcessActive.channelActiveView.getcallBackInfo = function(obj){
		obj[0] = foundation.common.getObject('RM_formula_formulaProcessActive_channelActiveView_form',obj[0], RM.formula.formulaProcessActive.channelActiveView._prefix, RM.formula.formulaProcessActive.channelActiveView._sUrl);
		CUI.commonFills('RM_formula_formulaProcessActive_channelActiveView_form',RM.formula.formulaProcessActive.channelActiveView._prefix,obj[0]);

		try{
			if(RM.formula.formulaProcessActive.channelActiveView._customCallBack) {
				eval(RM.formula.formulaProcessActive.channelActiveView._customCallBack);
				RM.formula.formulaProcessActive.channelActiveView._customCallBack = null;
			}
	...
	// 控件版PT回调
	RM.formula.formulaProcessActive.channelActiveView.getcallBackInfo_DG_IE = function(obj){
		if(RM.formula.formulaProcessActive.channelActiveView._customBeforeCallBack) {
			var flag = eval(RM.formula.formulaProcessActive.channelActiveView._customBeforeCallBack.split("(")[0] + "(obj)");
			if(flag === false){
				return false;
			}
		}
		var gridEventObj = RM.formula.formulaProcessActive.channelActiveView.gridEventObj;
		var rootKey = gridEventObj.sKey.split('.')[0];
		var jsonObj = foundation.common.getObjectIE(gridEventObj,obj[0],rootKey,RM.formula.formulaProcessActive.channelActiveView._sUrl);
	...
	RM.formula.formulaProcessActive.channelActiveView.getcallBackInfo_DG = function(obj){
		if(RM.formula.formulaProcessActive.channelActiveView._customBeforeCallBack) {
			var flag = eval(RM.formula.formulaProcessActive.channelActiveView._customBeforeCallBack.split("(")[0] + "(obj)");
			if(flag === false){
				return false;
		...
		for(var i=0;i<obj.length;i++){
			if(i>0){
				if($(RM.formula.formulaProcessActive.channelActiveView._currRow).next().length==0){
					RM.formula.formulaProcessActive.channelActiveView._oGrid.addNewRow();
				}	
				RM.formula.formulaProcessActive.channelActiveView._currRow = $(RM.formula.formulaProcessActive.channelActiveView._currRow).next();
				$(RM.formula.formulaProcessActive.channelActiveView._currRow).attr('isEdited',true);
			}
			obj[i] = foundation.common.getObject(RM.formula.formulaProcessActive.channelActiveView._currRow,obj[i],RM.formula.formulaProcessActive.channelActiveView._prefix,RM.formula.formulaProcessActive.channelActiveView._sUrl);
			eval("CUI.commonFills_DG(RM.formula.formulaProcessActive.channelActiveView._currRow,RM.formula.formulaProcessActive.channelActiveView._prefix,obj[i],RM.formula.formulaProcessActive.channelActiveView._oGrid)");
		}
		try{
			if(RM.formula.formulaProcessActive.channelActiveView._customCallBack) {
				eval(RM.formula.formulaProcessActive.channelActiveView._customCallBack);
	...
	RM.formula.formulaProcessActive.channelActiveView.getMultiselectCallBackInfo_DG = function(obj){
		for(var i=0;i<obj.length;i++){
			CUI.commonFillsMultiselect_DG(RM.formula.formulaProcessActive.channelActiveView._oGrid, RM.formula.formulaProcessActive.channelActiveView._currRow, RM.formula.formulaProcessActive.channelActiveView._key, RM.formula.formulaProcessActive.channelActiveView._displayFieldName, obj[i])
		}
		try{
			if(RM.formula.formulaProcessActive.channelActiveView._customCallBack) {
				eval(RM.formula.formulaProcessActive.channelActiveView._customCallBack);
	...
	RM.formula.formulaProcessActive.channelActiveView.generateInput = function(prefix, obj) {
		CUI.each(obj, function(key,value){
        	if(value!=null && key!='rowHtmlObj' && key!='cellHtmlObj'){
        		var name = prefix + '.' + key;
        		if(typeof value == 'object') {
        			RM.formula.formulaProcessActive.channelActiveView.generateInput(name, value);
        		} else {
        			if(value!=null&&value!='null'&&value!=undefined&&value!='') {
            			CUI('input[name="' + name + '"]').remove();
            			CUI('<input type="hidden" name="'+name+'" value="'+value+'">').appendTo(CUI('#RM_formula_formulaProcessActive_channelActiveView_form'));
        			}
        	   	}
        	}
      	});
	};
	RM.formula.formulaProcessActive.channelActiveView.beforeSubmitMethodSettingInPage = function(){
	};
...
<script type="text/javascript">
	...
	var panesHeight;
	var thisHeight;
	RM.formula.formulaProcessActive.channelActiveView.initCount = 0;
	RM.formula.formulaProcessActive.channelActiveView.initSize = function(nTabIndex){
		var panesHeight;
		var thisHeight;
		<#if (Parameters.openType)?? && (Parameters.openType) == 'frame'>
		var h = $(window.frameElement).parents('div.content').first().height();
		<#else>
		var h = $('#RM_channelActiveView_edit_div').parents('div.content').first().height();
		</#if>
		var datagrids = $('body').data('RM_formula_formulaProcessActive_channelActiveView_datagrids');	
		var	conHeight = h-$("#RM_formula_formulaProcessActive_channelActiveView_main_div .edit-tabs").outerHeight() - 6;
		panesHeight = conHeight*0.4;
		$("#RM_formula_formulaProcessActive_channelActiveView_main_div .edit-panes-s").each(function(index){
			//多页签切换时只计算本页签下的PT高度
				...
				if(datagrids[index].length > 0) {
					...
					for(var dg=0;dg<datagrids[index].length;dg++) {
						...
						if(dgwidget) {
							...
							if(RM.formula.formulaProcessActive.channelActiveView.initCount <= 2) {
								setTimeout(function(){RM.formula.formulaProcessActive.channelActiveView.initSize();}, 200);
								RM.formula.formulaProcessActive.channelActiveView.initCount++;
							}/* else {
								RM.formula.formulaProcessActive.channelActiveView.initCount = 0;
							}*/
						}
	...
	$(function(){
		RM.formula.formulaProcessActive.channelActiveView.initSize();
		$(".edit-tabs li").click(function(){
		    var index = $(this).index();
		    RM.formula.formulaProcessActive.channelActiveView.initSize(index);
		});
		$(window).bind("dialog.resize",function(){RM.formula.formulaProcessActive.channelActiveView.initSize();});
	});
</script>
<script type="text/javascript">
...
function isPlaceChange(nRow,sFieldName){
	...
	/* CUSTOM CODE START(view-VIEW-RM_7.5.0.0_formula_channelActiveView,js,RM_7.5.0.0_formula_FormulaProcessActive,RM_7.5.0.0) */
// 自定义代码
