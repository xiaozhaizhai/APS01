...
<#assign viewCode = 'RM_7.5.0.0_formula_FormulaProcessActive' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487330156499')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'exeOrder' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487330171009')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isReplace' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487331060176')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'auto' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487331130107')}</Data></Cell>
											</#if>
							...
							<Row ss:AutoFitHeight="0">
								<#list exportFieldList as item>
									<#if item?length gt 0>
												<#if item == 'name' || item == '*'>
													<Cell>
													<#if checkFieldPermission('name','RM_7.5.0.0_formula_FormulaProcessActive','RM_7.5.0.0_formula_FormulaProcessActive_name') != 0>
												...
												<#if item == 'exeOrder' || item == '*'>
													<Cell>
													<#if checkFieldPermission('exeOrder','RM_7.5.0.0_formula_FormulaProcessActive','RM_7.5.0.0_formula_FormulaProcessActive_exeOrder') != 0>
														<#if data.exeOrder??><Data ss:Type="Number"><![CDATA[${(data.exeOrder)!}]]></Data></#if>
													</#if>
													</Cell>
												</#if>
												<#if item == 'isReplace' || item == '*'>
													<Cell>
													<#if checkFieldPermission('isReplace','RM_7.5.0.0_formula_FormulaProcessActive','RM_7.5.0.0_formula_FormulaProcessActive_isReplace') != 0>
												...
												<#if item == 'auto' || item == '*'>
													<Cell>
													<#if checkFieldPermission('auto','RM_7.5.0.0_formula_FormulaProcessActive','RM_7.5.0.0_formula_FormulaProcessActive_auto') != 0>
								...
								<#if item??>
									<#if item.name?index_of(".")!=-1>
											...
											<Cell  ss:StyleID="${item.styleid}" >
												<#if checkFieldPermission('${(item.name)!}','RM_7.5.0.0_formula_FormulaProcessActive','${(item.propertyCode)!}') != 0>
