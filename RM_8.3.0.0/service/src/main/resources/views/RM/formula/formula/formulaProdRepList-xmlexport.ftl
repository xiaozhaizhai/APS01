			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'product.productCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.radion201810241608001')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'product.productName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.radion201810241608002')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'produceType.value' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formulaType.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon201810241612001')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'usedFor.value' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'state.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1490010654922')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'startTime' || item == '*'>
