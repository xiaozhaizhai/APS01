...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="batchFormulaCode">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="batchOverOnFinish">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="code">
	  		...
	  		<Style ss:ID="feedCondition">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="feedingMode">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="formulaType.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="isAnaly">
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'produceType.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
											...
											<#if item == 'feedingMode.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
															<Column ss:Index="${count}" ss:StyleID="${item?substring(0,item?last_index_of('.'))}"  ss:Width="140"/>
														 <#else>
														    <Column ss:Index="${count}" ss:StyleID="${item}"  ss:Width="140" />
											...
											<#if item == 'batchFormulaCode' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'batchOverOnFinish' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											...
											<#if item == 'advanceCharge' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'feedCondition' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											...
											<#if item == 'isDafault' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
			 						        <#assign customGeneratedFlag=false />
												<#if item == 'isDafault' && !customGeneratedFlag >
												</#if>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'editions' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1559551386338')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'edition' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formulaType.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon14975782324784345')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isForProduct' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'feedingMode.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1539745788276')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchContral' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487076619868')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchFormulaCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1508738820280')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchOverOnFinish' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1539746774380')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'autoReportOnFinish.value' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'advanceCharge' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1539745679956')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'feedCondition' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1539745761905')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'state.value' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isAnaly' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1543394889719')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isDafault' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487076833537')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
												<#if item == 'isDafault' && !customGeneratedFlag >
												</#if>
									...
									<#if item?length gt 0>
												...
												<#if item == 'editions' || item == '*'>
													<Cell>
														...
														<#if data.editions??><Data ss:Type="String"><![CDATA[${(data.editions)!}]]></Data></#if>
												...
												<#if item == 'produceType.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.produceType.value)!}')}</Data>
												...
												<#if item == 'formulaType.name' || item == '*'>
													<Cell>
														...
														<#if data.formulaType.name??><Data ss:Type="String"><![CDATA[${(data.formulaType.name)!}]]></Data></#if>
												...
												<#if item == 'feedingMode.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.feedingMode.value)!}')}</Data>
												...
												<#if item == 'batchFormulaCode' || item == '*'>
													<Cell>
														...
														<#if data.batchFormulaCode??><Data ss:Type="String"><![CDATA[${(data.batchFormulaCode)!}]]></Data></#if>
												...
												<#if item == 'batchOverOnFinish' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.batchOverOnFinish?? && data.batchOverOnFinish>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'advanceCharge' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.advanceCharge?? && data.advanceCharge>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'feedCondition' || item == '*'>
													<Cell>
														...
														<#if data.feedCondition??><Data ss:Type="String"><![CDATA[${(data.feedCondition)!}]]></Data></#if>
												...
												<#if item == 'isDafault' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.isDafault?? && data.isDafault>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
