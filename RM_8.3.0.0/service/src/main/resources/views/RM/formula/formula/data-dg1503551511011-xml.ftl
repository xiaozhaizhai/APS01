...
<GridData DefaultNodeExpanded="false"   dgName="dg1503551511011" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<property.id
					sort="false"  onPropertyChange="FormulaBom_dg1503551511011Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<productId.productCode
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(FormulaBom_dg1503551511011Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(FormulaBom_dg1503551511011Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/product/product/productRefNew.action','dg1503551511011productId.productCode','${getText("MESBasic.viewtitle.randon1475137145215")}',sPTGridID,nRow,sFieldName,FormulaBom_dg1503551511011Widget,null,false,false,'','MESBasic_1_product_productRefNew')"
				...
				<minQuality
					sort="false"  onPropertyChange="FormulaBom_dg1503551511011Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				    onChange="FormulaBom_dg1503551511011Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);FormulaBom_dg1503551511011Widget.evalCustomFunction(nRow,sFieldName,'minQuaChange(nRow,sFieldName)');"
				...
				<maxQuality
					sort="false"  onPropertyChange="FormulaBom_dg1503551511011Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				    onChange="FormulaBom_dg1503551511011Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);FormulaBom_dg1503551511011Widget.evalCustomFunction(nRow,sFieldName,'maxQuaChange(nRow,sFieldName)');"
				...
				<#list customPropViewMappings as cpvm>
					...
					<#if cpvm.property.type == 'OBJECT'>
						...
						<#if cpvm.refView??>
							...
							onFocus="CUI.toggleClearBtn_DG_IE(FormulaBom_dg1503551511011Widget,nRow,sFieldName)"
							onBtnClick="CUI.clearCellValue_DG_IE(FormulaBom_dg1503551511011Widget,nRow,sFieldName,true)"
							subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('${viewUrl!}','dg1503551511011${cpvm.propertyLayRec}','${getText("${viewTitle}")}',sPTGridID,nRow,'${cpvm.propertyLayRec}',FormulaBom_dg1503551511011Widget,null,false,true,'${mainDisplayName},${pkName}','${viewCode}')"
							hideEditOnReadOnly="true"
						</#if>
					</#if>
						sort="false"
						onPropertyChange="FormulaBom_dg1503551511011Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
					...
					<#elseif cpvm.property.type == 'DATETIME'>
						...
						onClick="initCalender(FormulaBom_dg1503551511011Widget,'FormulaBom_dg1503551511011Widget',nRow,sFieldName,<#if cpvm.format == 'YMD_H'>'dateTimeHour'<#elseif cpvm.format == 'YMD_HM'>'dateTimeMin'<#else>'datetime'</#if>)"
						onBtnClick="showCalender(FormulaBom_dg1503551511011Widget,'FormulaBom_dg1503551511011Widget',nRow,sFieldName,<#if cpvm.format == 'YMD_H'>'dateTimeHour'<#elseif cpvm.format == 'YMD_HM'>'dateTimeMin'<#else>'datetime'</#if>)"
						control="Text"
	...
	<tbody>
		...
		<row  onClick="FormulaBom_dg1503551511011Widget._DT._autoAddNewRow(nRow)" >
					<c>${(row.id)!}</c>
					<c>${(row.version)!}</c>
