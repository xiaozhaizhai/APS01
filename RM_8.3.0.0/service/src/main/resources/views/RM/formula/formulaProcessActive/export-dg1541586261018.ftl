 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0 && item != "checkbox">
									...
									<#if item == 'formulaHiddenId' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'processTableId' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'processHiddenId' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								<#if item == 'name' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon148781144242123')}</Data>
										</Cell>
								</#if>
								<#if item == 'exeSystem.value' || item == 'exeSystem.id' || item == '*'>
										<Cell>
								...
								<#if item == 'product.productBaseUnit.name' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.radion1398235640483232')}</Data>
										</Cell>
								</#if>
								<#if item == 'isPlace' || item == '*'>
										<Cell>
								...
								<#if item == 'formulaHiddenId' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1488873301480')}</Data>
										</Cell>
								</#if>
								<#if item == 'processTableId' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1488873435539')}</Data>
										</Cell>
								</#if>
								<#if item == 'processHiddenId' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1488873393499')}</Data>
										</Cell>
								</#if>
								<#if item == 'channelOrManual' || item == '*'>
										<Cell>
								...
								<#if item == 'hiddenSort' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1540005328359')}</Data>
										</Cell>
								</#if>
					...
					<#if item?length gt 0>
								...
								<#if item == 'formulaHiddenId' || item == '*'>
									<Cell>
										...
										<Data ss:Type="Number"><#if (data.formulaHiddenId)??>${(data.formulaHiddenId)!}</#if></Data>
								...
								<#if item == 'processTableId' || item == '*'>
									<Cell>
										...
										<Data ss:Type="Number"><#if (data.processTableId)??>${(data.processTableId)!}</#if></Data>
								...
								<#if item == 'processHiddenId' || item == '*'>
									<Cell>
										...
										<Data ss:Type="Number"><#if (data.processHiddenId)??>${(data.processHiddenId)!}</#if></Data>
