 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								<#if item == 'name' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1487140986526')}</Data>
										</Cell>
								</#if>
								<#if item == 'processType.name' || item == '*'>
										<Cell>
								...
								<#if item == 'longTime' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1487141047976')}</Data>
										</Cell>
								</#if>
