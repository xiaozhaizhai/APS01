 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0 && item != "checkbox">
									...
									<#if item == 'headTempId' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
									<#if item == 'lineId.id' || item == '*'>
												<Column ss:Index="${count}" ss:StyleID="${item}"/>
									</#if>
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								<#if item == 'puprocessId.name' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon201810251524')}</Data>
										</Cell>
								</#if>
								<#if item == 'processUnitIDUnitId' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1540450620913')}</Data>
										</Cell>
								</#if>
								<#if item == 'pmemo' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1540450885661')}</Data>
										</Cell>
								</#if>
								<#if item == 'headId.id' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.common.ID.201810251529001')}</Data>
										</Cell>
								</#if>
								<#if item == 'headTempId' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1540450847015')}</Data>
										</Cell>
								</#if>
								<#if item == 'lineId.id' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.ID.201810251030002')}</Data>
										</Cell>
								</#if>
					...
					<#if item?length gt 0>
								<#if item == 'puprocessId.name' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.puprocessId.name)??>${(data.puprocessId.name)!}</#if></Data>
								...
								<#if item == 'headTempId' || item == '*'>
									<Cell>
										...
										<Data ss:Type="Number"><#if (data.headTempId)??>${(data.headTempId)!}</#if></Data>
								...
								<#if item == 'lineId.id' || item == '*'>
									<Cell>
										...
										<Data ss:Type="Number"><#if (data.lineId.id)??>${(data.lineId.id)!}</#if></Data>
