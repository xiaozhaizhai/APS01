...
<#assign viewCode = 'RM_7.5.0.0_formula_PrecessStandards' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'quota' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487331350188')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'stValue' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487331365964')}</Data></Cell>
											</#if>
									...
									<#if item?length gt 0>
												<#if item == 'quota' || item == '*'>
													<Cell>
														...
														<#if data.quota??><Data ss:Type="String"><![CDATA[${(data.quota)!}]]></Data></#if>
