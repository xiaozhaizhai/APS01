...
<GridData DefaultNodeExpanded="false"   dgName="dg1489393020282" pageSize="${dgPage.pageSize}" totalCount="${dgPage.totalCount}" totalPages="${dgPage.totalPages}" pageNo="${dgPage.pageNo}" hasPre="${dgPage.hasPre?string}" hasNext="${dgPage.hasNext?string}" prePage="${dgPage.prePage}" nextPage="${dgPage.nextPage}">
	<thead>
		...
		<#if cpObjHideKey?? && cpObjHideKey?has_content>
			...
			<#list cpObjHideKey?split(',') as k>
				...
				<name
					sort="true"  onPropertyChange="FormulaProcessActive_dg1489393020282Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<fromContainer.id
					...
					showFormat="SELECTCOMP" 
						type="SELECTCOMP" 
					width="70">来自容器</fromContainer.id>
				<#assign isRef = false >
				...
				<product.productCode
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(FormulaProcessActive_dg1489393020282Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(FormulaProcessActive_dg1489393020282Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/MESBasic/product/product/productRefNew.action','dg1489393020282product.productCode','${getText("MESBasic.viewtitle.randon1475137145215")}',sPTGridID,nRow,sFieldName,FormulaProcessActive_dg1489393020282Widget,null,false,false,'','MESBasic_1_product_productRefNew')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="FormulaProcessActive_dg1489393020282Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
					...
					showFormat="SELECTCOMP" 
						type="SELECTCOMP" 
					width="80">物品编码</product.productCode>
				<#assign isRef = false >
				...
				<ingredientsOrder
					...
					showFormat="TEXT" 
						type="INTEGER" 
					width="80">配料顺序</ingredientsOrder>
				<#assign isRef = false >
				...
				<testProduct.code
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(FormulaProcessActive_dg1489393020282Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(FormulaProcessActive_dg1489393020282Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/RM/testProj/testProj/testProjSIRef.action','dg1489393020282testProduct.code','${getText("RM.viewtitle.randon1487596519107")}',sPTGridID,nRow,sFieldName,FormulaProcessActive_dg1489393020282Widget,null,false,false,'','RM_7.5.0.0_testProj_testProjSIRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="FormulaProcessActive_dg1489393020282Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
					...
					showFormat="SELECTCOMP" 
						type="SELECTCOMP" 
					width="80">检测方案</testProduct.code>
				<#assign isRef = false >
				...
				<qualityStandard.code
								<#assign isRef = true >
					onFocus="CUI.toggleClearBtn_DG_IE(FormulaProcessActive_dg1489393020282Widget,nRow,sFieldName)" onBtnClick="CUI.clearCellValue_DG_IE(FormulaProcessActive_dg1489393020282Widget,nRow,sFieldName)"  subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('/RM/qualityStandard/stand/standRef.action','dg1489393020282qualityStandard.code','${getText("RM.viewtitle.randon1487596068024")}',sPTGridID,nRow,sFieldName,FormulaProcessActive_dg1489393020282Widget,null,false,false,'','RM_7.5.0.0_qualityStandard_standRef')"
									readOnly="true" hideEditOnReadOnly="true"
					sort="true"  onPropertyChange="FormulaProcessActive_dg1489393020282Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
				...
				<finalInspection
					...
					showFormat="CHECKBOX" 
						type="CHECKBOX" 
					width="100">完工检验</finalInspection>
				<#assign customPropViewMappings = getShowCustomProps("RM_7.5.0.0_formula_FormulaProcessActive", "RM_7.5.0.0_formula_processActiveViewdg1489393020282", "DATAGRID", "formulaProcessActive")>
				<#list customPropViewMappings as cpvm>
					...
					<#if cpvm.property.type == 'OBJECT'>
						...
						<#if cpvm.refView??>
							...
							onFocus="CUI.toggleClearBtn_DG_IE(FormulaProcessActive_dg1489393020282Widget,nRow,sFieldName)"
							onBtnClick="CUI.clearCellValue_DG_IE(FormulaProcessActive_dg1489393020282Widget,nRow,sFieldName,true)"
							subBtnImg="Find" onSubBtnClick="dataGridBtnImgClick('${viewUrl!}','dg1489393020282${cpvm.propertyLayRec}','${getText("${viewTitle}")}',sPTGridID,nRow,'${cpvm.propertyLayRec}',FormulaProcessActive_dg1489393020282Widget,null,false,true,'${mainDisplayName},${pkName}','${viewCode}')"
							hideEditOnReadOnly="true"
						</#if>
					</#if>
						sort="true"
						onPropertyChange="FormulaProcessActive_dg1489393020282Widget._DT.activeEditRow(sPTGridID,nRow,sFieldName);"
					...
					<#elseif cpvm.property.type == 'DATETIME'>
						...
						onClick="initCalender(FormulaProcessActive_dg1489393020282Widget,'FormulaProcessActive_dg1489393020282Widget',nRow,sFieldName,<#if cpvm.format == 'YMD_H'>'dateTimeHour'<#elseif cpvm.format == 'YMD_HM'>'dateTimeMin'<#else>'datetime'</#if>)"
						onBtnClick="showCalender(FormulaProcessActive_dg1489393020282Widget,'FormulaProcessActive_dg1489393020282Widget',nRow,sFieldName,<#if cpvm.format == 'YMD_H'>'dateTimeHour'<#elseif cpvm.format == 'YMD_HM'>'dateTimeMin'<#else>'datetime'</#if>)"
						control="Text"
