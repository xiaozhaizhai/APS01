...
<#assign viewCode = 'RM_7.5.0.0_pickSite_PickSite' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1503470023639')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1503470250033')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'active' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1503469992676')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'distrib' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1503470097787')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'meno' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1503470187510')}</Data></Cell>
											</#if>
									...
									<#if item?length gt 0>
												...
												<#if item == 'distrib' || item == '*'>
													<Cell>
														...
														<#if data.distrib??><Data ss:Type="String"><![CDATA[${(data.distrib)!}]]></Data></#if>
