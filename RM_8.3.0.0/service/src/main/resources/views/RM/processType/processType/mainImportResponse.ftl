...
<script type="text/javascript">
	...
	function download(){
		//var url = "/RM/processType/processType/downLoad.action?viewCode=RM_7.5.0.0_processType_processTypeList&orgName=RM_7.5.0.0_processType_processTypeList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/RM/processType/processType/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
