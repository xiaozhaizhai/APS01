...
<#assign viewCode = 'RM_7.5.0.0_formulaBOM_FormulaBomMain' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formulaBomCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1555499118719')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'product.productCode' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'edtion' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1555499319210')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isUse' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1555499342065')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'demo' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1555499368535')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												<#if item == 'formulaBomCode' || item == '*'>
													<Cell>
														...
														<#if data.formulaBomCode??><Data ss:Type="String"><![CDATA[${(data.formulaBomCode)!}]]></Data></#if>
												...
												<#if item == 'edtion' || item == '*'>
													<Cell>
														...
														<#if data.edtion??><Data ss:Type="String"><![CDATA[${(data.edtion)!}]]></Data></#if>
												...
												<#if item == 'isUse' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.isUse?? && data.isUse>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
