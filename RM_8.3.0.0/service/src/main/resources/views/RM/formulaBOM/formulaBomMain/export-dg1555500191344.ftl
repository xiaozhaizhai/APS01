 		...
 		<Style ss:ID="s8">
  		...
  		<Style ss:ID="preNum">
  			...
  			<Protection/>
			 						    	...
			 						    	<#assign customPropList = showCusProps.get("formulaBomMaterial")  />
											<#-- 排布自定义字段 -->
					...
					<#list exportFieldList as item>
						<#if item?length gt 0 && item != "checkbox">
									...
									<#assign customGeneratedFlag=false />
										<#if item == 'demo' && !customGeneratedFlag >
 				...
 				<#if !exportFields?contains(',*,')>
					<#list exportFieldList as item>
						<#if item?length gt 0>
								<#if item == 'material.productCode' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertyshowName.randon1555500336194.flag')}</Data>
										</Cell>
								</#if>
								<#if item == 'material.productName' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertyshowName.randon1555500342833.flag')}</Data>
										</Cell>
								</#if>
								<#if item == 'isMaxNum' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1555499494815')}</Data>
										</Cell>
								</#if>
								<#if item == 'preNum' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1555499568096')}</Data>
										</Cell>
								</#if>
								<#if item == 'minNum' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1555499550251')}</Data>
										</Cell>
								</#if>
								<#if item == 'maxNum' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1555499520595')}</Data>
										</Cell>
								</#if>
								<#if item == 'demo' || item == '*'>
										<Cell>
											<Data ss:Type="String">${getText('RM.propertydisplayName.randon1555499580716')}</Data>
										</Cell>
								</#if>
								<#assign customGeneratedFlag=false />
									<#if item == 'demo' && !customGeneratedFlag >
					...
					<#if item?length gt 0>
								...
								<#if item == 'isMaxNum' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.isMaxNum)?? && data.isMaxNum>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
								...
								<#if item == 'preNum' || item == '*'>
									<Cell>
										...
										<#if (data.preNum)?has_content><Data ss:Type="Number">#{(data.preNum)!; m3M3}</Data></#if>
								...
								<#if item == 'minNum' || item == '*'>
									<Cell>
										...
										<#if (data.minNum)?has_content><Data ss:Type="Number">#{(data.minNum)!; m3M3}</Data></#if>
								...
								<#if item == 'maxNum' || item == '*'>
									<Cell>
										...
										<#if (data.maxNum)?has_content><Data ss:Type="Number">#{(data.maxNum)!; m3M3}</Data></#if>
								...
								<#if item == 'demo' || item == '*'>
									<Cell>
										...
										<Data ss:Type="String"><#if (data.demo)??>${(data.demo)!}</#if></Data>
