...
<script type="text/javascript">
	...
	function download(){
		//var url = "/RM/formulaBOM/formulaBomMain/downLoad.action?viewCode=RM_7.5.0.0_formulaBOM_formulaBomList&orgName=RM_7.5.0.0_formulaBOM_formulaBomList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/RM/formulaBOM/formulaBomMain/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
