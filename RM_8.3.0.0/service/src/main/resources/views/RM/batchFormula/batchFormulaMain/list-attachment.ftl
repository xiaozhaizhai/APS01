...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=RM_7.5.0.0_batchFormula";
	openExportFrame(url);
}
...
<div id="RM_batchFormula_batchFormulaMain_batchFormulaList_attachment">	
