...
<#assign viewCode = 'RM_7.5.0.0_batchFormula_SynchroLog' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchFormulaId' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1546051605003')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'message' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1546051618185')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'flag' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1546051591049')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'modiTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1546502440269')}</Data></Cell>
											</#if>
									...
									<#if item?length gt 0>
												...
												<#if item == 'message' || item == '*'>
													<Cell>
														...
														<#if data.message??><Data ss:Type="String"><![CDATA[${(data.message)!}]]></Data></#if>
												...
												<#if item == 'flag' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.flag?? && data.flag>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'modiTime' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.modiTime??><Data ss:Type="DateTime">${(data.modiTime)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
