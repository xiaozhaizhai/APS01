...
<#assign viewCode = 'RM_7.5.0.0_batchFormula_BatchFormulaMain' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'batchFormulaId' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1546051384996')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formulaCode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1546051436101')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productName' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1546051455738')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'modTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1546051250463')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'edition' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1546051278782')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'origin.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1546051350391')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'runMode' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1546051486232')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'remark' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1546051474183')}</Data></Cell>
											</#if>
									...
									<#if item?length gt 0>
												<#if item == 'batchFormulaId' || item == '*'>
													<Cell>
														...
														<#if data.batchFormulaId??><Data ss:Type="String"><![CDATA[${(data.batchFormulaId)!}]]></Data></#if>
												...
												<#if item == 'formulaCode' || item == '*'>
													<Cell>
														...
														<#if data.formulaCode??><Data ss:Type="String"><![CDATA[${(data.formulaCode)!}]]></Data></#if>
												...
												<#if item == 'modTime' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.modTime??><Data ss:Type="DateTime">${(data.modTime)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
												...
												<#if item == 'edition' || item == '*'>
													<Cell>
														...
														<#if data.edition??><Data ss:Type="Number"><![CDATA[${(data.edition)!}]]></Data></#if>
												...
												<#if item == 'origin.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.origin.value)!}')}</Data>
												...
												<#if item == 'runMode' || item == '*'>
													<Cell>
														...
														<#if data.runMode??><Data ss:Type="String"><![CDATA[${(data.runMode)!}]]></Data></#if>
