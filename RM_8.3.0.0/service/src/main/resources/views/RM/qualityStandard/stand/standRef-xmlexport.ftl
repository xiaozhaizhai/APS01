...
<#assign viewCode = 'RM_7.5.0.0_qualityStandard_Stand' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487595424436')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487595139633')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'productID.productName' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'createStaff.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.staff.dimissionStaff_xls.staffName232')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'createTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.common.createTime232')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'memoField' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487595641436')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
