...
<#assign viewCode = 'RM_7.5.0.0_interfaceService_InterfaceSyncLog' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="logIsIgnore">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="logOperate">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="logSynFlag">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="logType">
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											<#if item == 'logType' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'logTypeDes' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'logFault' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'logOperate' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'logDate' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="140"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'logSynFlag' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'logIsIgnore' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'logID' || item == '*'>
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'logType' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1493192959999')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'logTypeDes' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1493192987615')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'logFault' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1493192813775')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'logOperate' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1493192888108')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'logDate' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1493192794447')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'logSynFlag' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1493192941908')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'logIsIgnore' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1493192863868')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'logID' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1493192845294')}</Data></Cell>
											</#if>
									...
									<#if item?length gt 0>
												<#if item == 'logType' || item == '*'>
													<Cell>
														...
														<#if data.logType??><Data ss:Type="String"><![CDATA[${(data.logType)!}]]></Data></#if>
												...
												<#if item == 'logTypeDes' || item == '*'>
													<Cell>
														...
														<#if data.logTypeDes??><Data ss:Type="String"><![CDATA[${(data.logTypeDes)!}]]></Data></#if>
												...
												<#if item == 'logFault' || item == '*'>
													<Cell>
														...
														<#if data.logFault??><Data ss:Type="String"><![CDATA[${(data.logFault)!}]]></Data></#if>
												...
												<#if item == 'logOperate' || item == '*'>
													<Cell>
														...
														<#if data.logOperate??><Data ss:Type="String"><![CDATA[${(data.logOperate)!}]]></Data></#if>
												...
												<#if item == 'logDate' || item == '*'>
													<Cell ss:StyleID="s8">
														...
														<#if data.logDate??><Data ss:Type="DateTime">${(data.logDate)!?string("yyyy-MM-dd'T'HH:mm:ss.SSS")}</Data></#if>
												...
												<#if item == 'logSynFlag' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.logSynFlag?? && data.logSynFlag>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'logIsIgnore' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String"><#if data.logIsIgnore?? && data.logIsIgnore>${getText('common.radio.true')}<#else>${getText('common.radio.false')}</#if></Data>
												...
												<#if item == 'logID' || item == '*'>
													<Cell>
														...
														<#if data.logID??><Data ss:Type="String"><![CDATA[${(data.logID)!}]]></Data></#if>
