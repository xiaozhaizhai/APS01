...
<script type="text/javascript">
	...
	function download(){
		//var url = "/RM/interfaceService/interfaceSyncLog/downLoad.action?viewCode=RM_7.5.0.0_interfaceService_logList&orgName=RM_7.5.0.0_interfaceService_logList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/RM/interfaceService/interfaceSyncLog/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
