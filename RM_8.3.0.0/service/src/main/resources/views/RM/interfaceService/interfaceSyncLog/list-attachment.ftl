...
function downloadSingle(id){
	var url = "/foundation/workbench/download.action?id="+id + "&entityCode=RM_7.5.0.0_interfaceService";
	openExportFrame(url);
}
...
<div id="RM_interfaceService_interfaceSyncLog_logList_attachment">	
