...
<#assign viewCode = 'RM_7.5.0.0_suitedLine_LineFormula' />
<#assign propertyCode = '' />
...
<?xml version="1.0"?>
	...
	<Styles>
		...
		<#if !customerFlag>
	  		...
	  		<Style ss:ID="formulaId.produceType">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
	  		<Style ss:ID="lineId.name">
	  			<NumberFormat/>
	  			<Protection/>
	  		</Style>
		 				...
		 				<#if !exportFields?contains(',*,')>
							<#list exportFieldList as item>
								<#if item?length gt 0 && item != "checkbox">
											...
											<#if item == 'formulaId.produceType.value' || item == '*'>
														 <#if item?index_of('.')!=-1>  
											...
											<#if item == 'theoreYield' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'maxCapacity' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
											</#if>
											<#if item == 'autoReportOnFinish.value' || item == '*'>
			 						        ...
			 						        <#assign customGeneratedFlag=false />
												<#if item == 'autoReportOnFinish.value' && !customGeneratedFlag >
												</#if>
											<#if item == 'meno' || item == '*'>
														<Column ss:Index="${count}" ss:StyleID="${item}"   ss:Width="70"/>
													<#assign count = count + 1>
			 				...
			 				<#if !exportFields?contains(',*,')>
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formulaId.code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487140953580')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'formulaId.name' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'lineId.name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487927739693')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'longTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487927827167')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'theoreYield' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487927965341')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'maxCapacity' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487927891234')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'autoReportOnFinish.value' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1554975104606')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
												<#if item == 'autoReportOnFinish.value' && !customGeneratedFlag >
												</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'meno' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487927995051')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												...
												<#if item == 'formulaId.produceType.value' || item == '*'>
													<Cell>
														...
														<Data ss:Type="String">${getText('${(data.formulaId.produceType.value)!}')}</Data>
												...
												<#if item == 'lineId.name' || item == '*'>
													<Cell>
														...
														<#if data.lineId.name??><Data ss:Type="String"><![CDATA[${(data.lineId.name)!}]]></Data></#if>
												...
												<#if item == 'theoreYield' || item == '*'>
													<Cell>
														...
														<#if (data.theoreYield)?has_content><Data ss:Type="Number">#{(data.theoreYield)!; m6M6}</Data></#if>
												...
												<#if item == 'maxCapacity' || item == '*'>
													<Cell>
														...
														<#if (data.maxCapacity)?has_content><Data ss:Type="Number">#{(data.maxCapacity)!; m6M6}</Data></#if>
