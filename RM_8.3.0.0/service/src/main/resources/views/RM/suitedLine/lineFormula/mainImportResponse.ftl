...
<script type="text/javascript">
	...
	function download(){
		//var url = "/RM/suitedLine/lineFormula/downLoad.action?viewCode=RM_7.5.0.0_suitedLine_suitedLineList&orgName=RM_7.5.0.0_suitedLine_suitedLineList-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/RM/suitedLine/lineFormula/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
