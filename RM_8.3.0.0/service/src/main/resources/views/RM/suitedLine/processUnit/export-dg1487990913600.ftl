			...
			<Row ss:AutoFitHeight="0">
				<#list exportFieldList as item>
					<#if item?length gt 0>
								<#if item == 'processId.name' || item == '*'>
									<Cell>
									<#if checkFieldPermission('processId.name','RM_7.5.0.0_suitedLine_ProcessUnit','RM_7.5.0.0_suitedLine_ProcessUnit_processId||RM_7.5.0.0_formula_FormulaProcess_name') != 0>
								...
								<#if item == 'processUnitIDUnitId' || item == '*'>
									<Cell>
									<#if checkFieldPermission('processUnitIDUnitId','RM_7.5.0.0_suitedLine_ProcessUnit','-RM_7.5.0.0_suitedLine_ProcessUnit_id-RM_7.5.0.0_suitedLine_ProcessUnitChoice_processUnitID-||RM_7.5.0.0_suitedLine_ProcessUnitChoice_unitId-MESBasic_1_factoryModel_FactoryModel') != 0>
								...
								<#if item == 'pmemo' || item == '*'>
									<Cell>
									<#if checkFieldPermission('pmemo','RM_7.5.0.0_suitedLine_ProcessUnit','RM_7.5.0.0_suitedLine_ProcessUnit_pmemo') != 0>
