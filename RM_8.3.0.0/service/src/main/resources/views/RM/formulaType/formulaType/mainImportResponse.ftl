...
<script type="text/javascript">
	...
	function download(){
		//var url = "/RM/formulaType/formulaType/downLoad.action?viewCode=RM_7.5.0.0_formulaType_typePart&orgName=RM_7.5.0.0_formulaType_typePart-import-error.xls&downloadType=mainError&time=${time}";
		var url = "/RM/formulaType/formulaType/downLoad.action?viewCode=" 
			+ $('#viewCode').val()
			+ "&orgName="
			+ $('#viewCode').val()
