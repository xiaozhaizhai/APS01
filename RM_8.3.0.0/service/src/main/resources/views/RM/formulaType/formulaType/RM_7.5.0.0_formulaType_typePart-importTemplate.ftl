...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
	...
	<Style ss:ID="RM_7.5.0.0_formulaType_FormulaType_code">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="RM_7.5.0.0_formulaType_FormulaType_name">
  			<NumberFormat/>
  			<Protection/>
	</Style>
	<Style ss:ID="RM_7.5.0.0_formulaType_FormulaType_createTime">
  			<NumberFormat ss:Format="yyyy-mm-dd\ HH:mm:ss"/>
  			<Protection/>
	</Style>
	<Style ss:ID="RM_7.5.0.0_formulaType_FormulaType_remark">
  			<NumberFormat/>
  			<Protection/>
	</Style>
...
<Worksheet ss:Name="sheet1">
	<Table ss:ExpandedColumnCount="256" ss:ExpandedRowCount="3" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="16.5">
			<Column ss:Index="1" ss:Width="100"  ss:StyleID="RM_7.5.0.0_formulaType_FormulaType_code"/>
			<Column ss:Index="2" ss:Width="100"  ss:StyleID="RM_7.5.0.0_formulaType_FormulaType_name"/>
			<Column ss:Index="3" ss:Width="100"  ss:StyleID="RM_7.5.0.0_formulaType_FormulaType_createTime"/>
			<Column ss:Index="4" ss:Width="100"  ss:StyleID="RM_7.5.0.0_formulaType_FormulaType_remark"/>
						...
						<Cell ss:StyleID="unNullable">
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										RM_7.5.0.0_formulaType_FormulaType_code
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										RM_7.5.0.0_formulaType_FormulaType_name
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										RM_7.5.0.0_formulaType_FormulaType_createTime
									 </ss:Data>
							</Comment>
						</Cell>
						<Cell >
							...
							<Comment ss:Author="">
									 <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
										RM_7.5.0.0_formulaType_FormulaType_remark
									 </ss:Data>
							</Comment>
						</Cell>
