...
<#assign viewCode = 'RM_7.5.0.0_testProj_TestProj' />
<#assign propertyCode = '' />
								...
								<#list exportFieldList as item>
									<#if item?length gt 0>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'code' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487596384862')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'name' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487596428462')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'testType' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487596442871')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'isDefault' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.propertydisplayName.randon1487596400473')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
											<#if item == 'createStaff.name' || item == '*'>
			 							...
			 							<#assign customGeneratedFlag=false />
											<#if item == 'createTime' || item == '*'>
													<Cell><Data ss:Type="String">${getText('RM.common.createTime2323')}</Data></Cell>
											</#if>
			 							<#assign customGeneratedFlag=false />
									...
									<#if item?length gt 0>
												...
												<#if item == 'testType' || item == '*'>
													<Cell>
														...
														<#if data.testType??><Data ss:Type="String"><![CDATA[${(data.testType)!}]]></Data></#if>
