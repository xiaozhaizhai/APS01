...
@Service("rMFormulaMixtureActiveImportService")
public class RMFormulaMixtureActiveImportServiceImpl implements RMFormulaMixtureActiveImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_formula",model="RM_7.5.0.0_formula_FormulaMixtureActive",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMFormulaMixtureActive bizObj, RMFormulaMixtureActive oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(RMFormulaMixtureActive bizObj, String bussinesskeyFieldName,
