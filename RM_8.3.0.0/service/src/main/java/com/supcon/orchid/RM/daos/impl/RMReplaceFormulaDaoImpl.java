...
@Repository
public class RMReplaceFormulaDaoImpl extends ExtendedGenericDaoImpl<RMReplaceFormula, Long> implements RMReplaceFormulaDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,RM_7.5.0.0_formula_ReplaceFormula,RM_7.5.0.0) */
// 自定义代码
