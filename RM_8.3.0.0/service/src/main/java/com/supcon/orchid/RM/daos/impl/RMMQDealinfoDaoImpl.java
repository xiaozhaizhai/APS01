...
@Repository
public class RMMQDealinfoDaoImpl extends ExtendedGenericDaoImpl<RMMQDealinfo, Long> implements RMMQDealinfoDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,RM_7.5.0.0_interfaceService_MQDealinfo,RM_7.5.0.0) */
// 自定义代码
