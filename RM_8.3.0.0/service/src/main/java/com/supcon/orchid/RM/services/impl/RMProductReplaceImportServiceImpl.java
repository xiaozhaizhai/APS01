...
@Service("rMProductReplaceImportService")
public class RMProductReplaceImportServiceImpl implements RMProductReplaceImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_formula",model="RM_7.5.0.0_formula_ProductReplace",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMProductReplace bizObj, RMProductReplace oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(RMProductReplace bizObj, String bussinesskeyFieldName,
