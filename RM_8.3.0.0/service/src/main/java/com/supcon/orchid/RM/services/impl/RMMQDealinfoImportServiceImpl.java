...
@Service("rMMQDealinfoImportService")
public class RMMQDealinfoImportServiceImpl implements RMMQDealinfoImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_interfaceService",model="RM_7.5.0.0_interfaceService_MQDealinfo",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMMQDealinfo bizObj, RMMQDealinfo oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(RMMQDealinfo bizObj, String bussinesskeyFieldName,
