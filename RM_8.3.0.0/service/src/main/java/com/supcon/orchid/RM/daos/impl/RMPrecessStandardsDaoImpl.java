...
@Repository
public class RMPrecessStandardsDaoImpl extends ExtendedGenericDaoImpl<RMPrecessStandards, Long> implements RMPrecessStandardsDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,RM_7.5.0.0_formula_PrecessStandards,RM_7.5.0.0) */
// 自定义代码
