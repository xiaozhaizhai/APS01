...
@Repository
public class RMForProcessUnitDaoImpl extends ExtendedGenericDaoImpl<RMForProcessUnit, Long> implements RMForProcessUnitDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,RM_7.5.0.0_formula_ForProcessUnit,RM_7.5.0.0) */
// 自定义代码
