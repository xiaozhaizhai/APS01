...
@Service("rMPickSiteImportService")
public class RMPickSiteImportServiceImpl implements RMPickSiteImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_pickSite",model="RM_7.5.0.0_pickSite_PickSite",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMPickSite bizObj, RMPickSite oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("RM.entityname.randon1503469599671") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("RM.entityname.randon1503469599671") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(RMPickSite bizObj, String bussinesskeyFieldName,
