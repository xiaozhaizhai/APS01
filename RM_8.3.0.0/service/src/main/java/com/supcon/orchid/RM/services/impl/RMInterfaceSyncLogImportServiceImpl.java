...
@Service("rMInterfaceSyncLogImportService")
public class RMInterfaceSyncLogImportServiceImpl implements RMInterfaceSyncLogImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_interfaceService",model="RM_7.5.0.0_interfaceService_InterfaceSyncLog",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMInterfaceSyncLog bizObj, RMInterfaceSyncLog oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("RM.entityname.randon1493169918607") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("RM.entityname.randon1493169918607") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(RMInterfaceSyncLog bizObj, String bussinesskeyFieldName,
