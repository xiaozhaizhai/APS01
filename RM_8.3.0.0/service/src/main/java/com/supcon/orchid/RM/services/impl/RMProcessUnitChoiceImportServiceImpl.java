...
@Service("rMProcessUnitChoiceImportService")
public class RMProcessUnitChoiceImportServiceImpl implements RMProcessUnitChoiceImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_suitedLine",model="RM_7.5.0.0_suitedLine_ProcessUnitChoice",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMProcessUnitChoice bizObj, RMProcessUnitChoice oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("RM.entityname.randon1487926386366") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("RM.entityname.randon1487926386366") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(RMProcessUnitChoice bizObj, String bussinesskeyFieldName,
