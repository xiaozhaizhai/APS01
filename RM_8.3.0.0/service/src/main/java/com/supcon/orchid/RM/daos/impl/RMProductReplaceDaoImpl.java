...
@Repository
public class RMProductReplaceDaoImpl extends ExtendedGenericDaoImpl<RMProductReplace, Long> implements RMProductReplaceDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,RM_7.5.0.0_formula_ProductReplace,RM_7.5.0.0) */
// 自定义代码
