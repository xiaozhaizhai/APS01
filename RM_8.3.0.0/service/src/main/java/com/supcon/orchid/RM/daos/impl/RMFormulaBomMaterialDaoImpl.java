...
@Repository
public class RMFormulaBomMaterialDaoImpl extends ExtendedGenericDaoImpl<RMFormulaBomMaterial, Long> implements RMFormulaBomMaterialDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,RM_7.5.0.0_formulaBOM_FormulaBomMaterial,RM_7.5.0.0) */
// 自定义代码
