...
@Service("rMFormulaTypeImportService")
public class RMFormulaTypeImportServiceImpl implements RMFormulaTypeImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_formulaType",model="RM_7.5.0.0_formulaType_FormulaType",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMFormulaType bizObj, RMFormulaType oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("RM.entityname.randon1497577629830") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("RM.entityname.randon1497577629830") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(RMFormulaType bizObj, String bussinesskeyFieldName,
