...
@Service("rMFormulaProcessActiveImportService")
public class RMFormulaProcessActiveImportServiceImpl implements RMFormulaProcessActiveImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_formula",model="RM_7.5.0.0_formula_FormulaProcessActive",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMFormulaProcessActive bizObj, RMFormulaProcessActive oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(RMFormulaProcessActive bizObj, String bussinesskeyFieldName,
