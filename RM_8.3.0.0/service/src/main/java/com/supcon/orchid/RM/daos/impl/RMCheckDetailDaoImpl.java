...
@Repository
public class RMCheckDetailDaoImpl extends ExtendedGenericDaoImpl<RMCheckDetail, Long> implements RMCheckDetailDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,RM_7.5.0.0_formula_CheckDetail,RM_7.5.0.0) */
// 自定义代码
