...
@Repository
public class RMFormulaMixtureActiveDaoImpl extends ExtendedGenericDaoImpl<RMFormulaMixtureActive, Long> implements RMFormulaMixtureActiveDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,RM_7.5.0.0_formula_FormulaMixtureActive,RM_7.5.0.0) */
// 自定义代码
