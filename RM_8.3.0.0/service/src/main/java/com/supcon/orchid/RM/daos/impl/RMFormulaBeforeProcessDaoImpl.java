...
@Repository
public class RMFormulaBeforeProcessDaoImpl extends ExtendedGenericDaoImpl<RMFormulaBeforeProcess, Long> implements RMFormulaBeforeProcessDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,RM_7.5.0.0_formula_FormulaBeforeProcess,RM_7.5.0.0) */
// 自定义代码
