...
@Service("rMFormulaBomMaterialImportService")
public class RMFormulaBomMaterialImportServiceImpl implements RMFormulaBomMaterialImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_formulaBOM",model="RM_7.5.0.0_formulaBOM_FormulaBomMaterial",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMFormulaBomMaterial bizObj, RMFormulaBomMaterial oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("RM.entityname.randon1555498361162") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("RM.entityname.randon1555498361162") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(RMFormulaBomMaterial bizObj, String bussinesskeyFieldName,
