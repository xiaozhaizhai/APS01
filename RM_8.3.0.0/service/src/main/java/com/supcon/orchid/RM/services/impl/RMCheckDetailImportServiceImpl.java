...
@Service("rMCheckDetailImportService")
public class RMCheckDetailImportServiceImpl implements RMCheckDetailImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_formula",model="RM_7.5.0.0_formula_CheckDetail",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMCheckDetail bizObj, RMCheckDetail oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(RMCheckDetail bizObj, String bussinesskeyFieldName,
