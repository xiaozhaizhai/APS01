...
@Service("rMProcessPointImportService")
public class RMProcessPointImportServiceImpl implements RMProcessPointImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_suitedLine",model="RM_7.5.0.0_suitedLine_ProcessPoint",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMProcessPoint bizObj, RMProcessPoint oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(RMProcessPoint bizObj, String bussinesskeyFieldName,
