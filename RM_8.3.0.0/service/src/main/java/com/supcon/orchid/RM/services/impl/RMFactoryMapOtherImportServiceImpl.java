...
@Service("rMFactoryMapOtherImportService")
public class RMFactoryMapOtherImportServiceImpl implements RMFactoryMapOtherImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_interfaceService",model="RM_7.5.0.0_interfaceService_FactoryMapOther",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMFactoryMapOther bizObj, RMFactoryMapOther oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(RMFactoryMapOther bizObj, String bussinesskeyFieldName,
