...
@Repository
public class RMProcessUnitDaoImpl extends ExtendedGenericDaoImpl<RMProcessUnit, Long> implements RMProcessUnitDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,RM_7.5.0.0_suitedLine_ProcessUnit,RM_7.5.0.0) */
// 自定义代码
