...
@Service("rMProcessUnitImportService")
public class RMProcessUnitImportServiceImpl implements RMProcessUnitImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_suitedLine",model="RM_7.5.0.0_suitedLine_ProcessUnit",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMProcessUnit bizObj, RMProcessUnit oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(RMProcessUnit bizObj, String bussinesskeyFieldName,
