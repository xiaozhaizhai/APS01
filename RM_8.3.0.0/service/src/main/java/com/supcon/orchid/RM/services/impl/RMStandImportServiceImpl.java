...
@Service("rMStandImportService")
public class RMStandImportServiceImpl implements RMStandImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_qualityStandard",model="RM_7.5.0.0_qualityStandard_Stand",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMStand bizObj, RMStand oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("RM.entityname.randon1487594970448") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("RM.entityname.randon1487594970448") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(RMStand bizObj, String bussinesskeyFieldName,
