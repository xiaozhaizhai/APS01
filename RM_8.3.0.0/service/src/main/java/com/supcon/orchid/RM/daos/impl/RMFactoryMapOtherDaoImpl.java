...
@Repository
public class RMFactoryMapOtherDaoImpl extends ExtendedGenericDaoImpl<RMFactoryMapOther, Long> implements RMFactoryMapOtherDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,RM_7.5.0.0_interfaceService_FactoryMapOther,RM_7.5.0.0) */
// 自定义代码
