...
@Service("rMCheckDepartmentSetImportService")
public class RMCheckDepartmentSetImportServiceImpl implements RMCheckDepartmentSetImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_formula",model="RM_7.5.0.0_formula_CheckDepartmentSet",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMCheckDepartmentSet bizObj, RMCheckDepartmentSet oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(RMCheckDepartmentSet bizObj, String bussinesskeyFieldName,
