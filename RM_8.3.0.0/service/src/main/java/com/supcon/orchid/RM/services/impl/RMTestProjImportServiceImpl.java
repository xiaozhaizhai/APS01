...
import com.supcon.orchid.RM.services.RMTestProjImportService;

@Service("rMTestProjImportService")
public class RMTestProjImportServiceImpl implements RMTestProjImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_testProj",model="RM_7.5.0.0_testProj_TestProj",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMTestProj bizObj, RMTestProj oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("RM.entityname.randon1487596283533") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("RM.entityname.randon1487596283533") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(RMTestProj bizObj, String bussinesskeyFieldName,
