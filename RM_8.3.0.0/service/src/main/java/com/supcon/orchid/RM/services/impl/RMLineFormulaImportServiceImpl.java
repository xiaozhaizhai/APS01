...
@Service("rMLineFormulaImportService")
public class RMLineFormulaImportServiceImpl implements RMLineFormulaImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_suitedLine",model="RM_7.5.0.0_suitedLine_LineFormula",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMLineFormula bizObj, RMLineFormula oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(RMLineFormula bizObj, String bussinesskeyFieldName,
