...
@Service("rMFormulaBomMainImportService")
public class RMFormulaBomMainImportServiceImpl implements RMFormulaBomMainImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_formulaBOM",model="RM_7.5.0.0_formulaBOM_FormulaBomMain",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMFormulaBomMain bizObj, RMFormulaBomMain oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(RMFormulaBomMain bizObj, String bussinesskeyFieldName,
