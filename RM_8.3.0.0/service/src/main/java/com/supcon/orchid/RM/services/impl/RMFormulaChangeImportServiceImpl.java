...
@Service("rMFormulaChangeImportService")
public class RMFormulaChangeImportServiceImpl implements RMFormulaChangeImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_fomulaChange",model="RM_7.5.0.0_fomulaChange_FormulaChange",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMFormulaChange bizObj, RMFormulaChange oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("RM.entityname.randon1488267707733") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("RM.entityname.randon1488267707733") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(RMFormulaChange bizObj, String bussinesskeyFieldName,
