...
@Repository
public class RMCheckDetailItemSetupsDaoImpl extends ExtendedGenericDaoImpl<RMCheckDetailItemSetups, Long> implements RMCheckDetailItemSetupsDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,RM_7.5.0.0_formula_CheckDetailItemSetups,RM_7.5.0.0) */
// 自定义代码
