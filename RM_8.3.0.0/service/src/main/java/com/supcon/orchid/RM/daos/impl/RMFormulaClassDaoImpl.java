...
@Repository
public class RMFormulaClassDaoImpl extends ExtendedGenericDaoImpl<RMFormulaClass, Long> implements RMFormulaClassDao {
	...
	public DataClassific getDataClassific(String code) {
	 ...
	 /* CUSTOM CODE START(daoimpl,functions,RM_7.5.0.0_formula_FormulaClass,RM_7.5.0.0) */
// 自定义代码
/* CUSTOM CODE END */
}