...
@Repository
public class RMForLineFormulaDaoImpl extends ExtendedGenericDaoImpl<RMForLineFormula, Long> implements RMForLineFormulaDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,RM_7.5.0.0_formula_ForLineFormula,RM_7.5.0.0) */
// 自定义代码
