...
@Service("rMProcessTypeImportService")
public class RMProcessTypeImportServiceImpl implements RMProcessTypeImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_processType",model="RM_7.5.0.0_processType_ProcessType",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMProcessType bizObj, RMProcessType oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("RM.entityname.randon1487074302235") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("RM.entityname.randon1487074302235") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(RMProcessType bizObj, String bussinesskeyFieldName,
