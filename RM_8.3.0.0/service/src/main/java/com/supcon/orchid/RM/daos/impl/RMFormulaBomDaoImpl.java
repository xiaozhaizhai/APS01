...
@Repository
public class RMFormulaBomDaoImpl extends ExtendedGenericDaoImpl<RMFormulaBom, Long> implements RMFormulaBomDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,RM_7.5.0.0_formula_FormulaBom,RM_7.5.0.0) */
// 自定义代码
