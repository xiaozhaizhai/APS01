...
@Service("rMProductMapOtherImportService")
public class RMProductMapOtherImportServiceImpl implements RMProductMapOtherImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_interfaceService",model="RM_7.5.0.0_interfaceService_ProductMapOther",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMProductMapOther bizObj, RMProductMapOther oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(RMProductMapOther bizObj, String bussinesskeyFieldName,
