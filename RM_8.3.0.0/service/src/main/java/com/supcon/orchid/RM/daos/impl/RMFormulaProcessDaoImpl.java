...
@Repository
public class RMFormulaProcessDaoImpl extends ExtendedGenericDaoImpl<RMFormulaProcess, Long> implements RMFormulaProcessDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,RM_7.5.0.0_formula_FormulaProcess,RM_7.5.0.0) */
// 自定义代码
