...
@Repository
public class RMCheckDepartmentSetDaoImpl extends ExtendedGenericDaoImpl<RMCheckDepartmentSet, Long> implements RMCheckDepartmentSetDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,RM_7.5.0.0_formula_CheckDepartmentSet,RM_7.5.0.0) */
// 自定义代码
