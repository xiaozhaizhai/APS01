...
@Repository
public class RMProcessUnitChoiceDaoImpl extends ExtendedGenericDaoImpl<RMProcessUnitChoice, Long> implements RMProcessUnitChoiceDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,RM_7.5.0.0_suitedLine_ProcessUnitChoice,RM_7.5.0.0) */
// 自定义代码
