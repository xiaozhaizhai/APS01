...
@Service("rMSynchroLogImportService")
public class RMSynchroLogImportServiceImpl implements RMSynchroLogImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_batchFormula",model="RM_7.5.0.0_batchFormula_SynchroLog",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMSynchroLog bizObj, RMSynchroLog oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(RMSynchroLog bizObj, String bussinesskeyFieldName,
