...
@Service("rMBatchFactoryImportService")
public class RMBatchFactoryImportServiceImpl implements RMBatchFactoryImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_batchFormula",model="RM_7.5.0.0_batchFormula_BatchFactory",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMBatchFactory bizObj, RMBatchFactory oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(RMBatchFactory bizObj, String bussinesskeyFieldName,
