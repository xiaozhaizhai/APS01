...
@Service("rMForProcessUnitChoiceImportService")
public class RMForProcessUnitChoiceImportServiceImpl implements RMForProcessUnitChoiceImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_formula",model="RM_7.5.0.0_formula_ForProcessUnitChoice",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMForProcessUnitChoice bizObj, RMForProcessUnitChoice oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(RMForProcessUnitChoice bizObj, String bussinesskeyFieldName,
