...
@Service("rMSampleProjImportService")
public class RMSampleProjImportServiceImpl implements RMSampleProjImportService {
	...
	@Override
	@AuditLog(entity="RM_7.5.0.0_sampleProj",model="RM_7.5.0.0_sampleProj_SampleProj",desc="保存业务信息",operType="1")
	public void saveImportDataLog(RMSampleProj bizObj, RMSampleProj oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("RM.entityname.randon1490317690671") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("RM.entityname.randon1490317690671") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(RMSampleProj bizObj, String bussinesskeyFieldName,
