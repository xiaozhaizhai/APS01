...
import com.supcon.orchid.RM.services.PickSiteService;

import org.easymock.EasyMock;
import org.easymock.IMocksControl;
/* CUSTOM CODE START(serviceTests,import,RM_7.5.0.0_pickSite_PickSite,RM_7.5.0.0) */
// 自定义代码
/* CUSTOM CODE END */

public class PickSiteServiceTests extends AbstractOrchidServiceTests {

	@Autowired
	private PickSiteService pickSiteService;
	@Autowired
	...
	public void setUpData() throws Exception {
		...
		/* CUSTOM CODE START(serviceTests,beforeSetUp,RM_7.5.0.0_pickSite_PickSite,RM_7.5.0.0) */
// 自定义代码
/* CUSTOM CODE END */
	}
	...
	/* CUSTOM CODE START(serviceTests,functions,RM_7.5.0.0_pickSite_PickSite,RM_7.5.0.0) */
// 自定义代码
/* CUSTOM CODE END */
}